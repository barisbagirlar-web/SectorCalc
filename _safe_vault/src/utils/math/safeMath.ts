...
// SectorCalc — Güvenli Matematik Katmanı (Claude Opus)
// Tüm floating-point işlemleri bu katmandan geçer.
// NaN, Infinity, -0 → null döner. Asla 0 döndürmez.
// ============================================================
...
Big.RM = 1;    // round mode: ROUND_DOWN (mühendislik standardı)

export type SafeNumber = number | null;

export class SafeMath {
  // ── Üs alma: negatif baz + kesirli üs → null ──────────────
  ...
  // ── Güvenli giriş doğrulama ────────────────────────────────
  // Kullanıcı inputunu parse eder. "abc" → null, "3.14" → 3.14
  ...
  // ── Sonuç formatlama ───────────────────────────────────────
  // null gelirse kullanıcıya "—" göster, asla "0" değil
  static format(
    value: SafeNumber,
    decimals = 2,
    fallback = "—"
