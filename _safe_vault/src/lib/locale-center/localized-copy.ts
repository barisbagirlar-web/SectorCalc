...
} from "@/lib/locale-center/locale-dictionary";
import type { LocaleCopyParams, LocaleMessageKey } from "@/lib/locale-center/locale-types";
import { ROOT_LOCALE, type SupportedLocale } from "@/lib/locale-center/locale-config";
