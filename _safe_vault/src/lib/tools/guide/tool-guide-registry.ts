...
} from "@/lib/tool-guides/premium-input-guide-specs";
import type { ToolGuideSpec as LegacyToolGuideSpec } from "@/lib/tool-guides/tool-guide-spec";
import type { ToolGuideSpec } from "@/lib/tools/guide/tool-guide-types";
