...
export const LOGISTICS_ROUTE_LOSS_SCHEMA: PremiumCalculatorSchema = {
  ...
  name: "Lojistik Rota Kaybı", name_i18n: {"en":"Lojistik Rota Kaybi","tr":"Lojistik Rota Kaybı"}, sectorSlug: "logistics-transport", category: "cost",
  ...
  inputs: [
    { id: "idealDistance", label: "İdeal Mesafe", label_i18n: {"en":"Point-to-point distance","tr":"İdeal Mesafe"}, type: "number", unit: "km", required: true, smartDefault: 100, validation: { min: 1 }, helper: "", expertMeaning: "Point-to-point distance", expertMeaning_i18n: {"en":"Point-to-point distance","tr":"i̇deal mesafe"} },
  ...
  outputs: [
    { id: "driftPct", label: "Sapma Oranı", label_i18n: {"en":"Sapma Oran","tr":"Sapma Oranı"}, unit: "%", format: "percentage" },
    { id: "fuelWaste", label: "Yakıt İsrafı", label_i18n: {"en":"Yakt Israf","tr":"Yakıt İsrafı"}, unit: "USD/sefer", format: "currency" },
    { id: "timeWaste", label: "Zaman Kaybı", label_i18n: {"en":"Zaman Kayb","tr":"Zaman Kaybı"}, unit: "USD/sefer", format: "currency" },
    { id: "routeEfficiency", label: "Rota Verimi", label_i18n: {"en":"Rota Verimi","tr":"Rota Verimi"}, unit: "%", format: "percentage" },
    { id: "totalRouteLoss", label: "Toplam Rota Kaybı", label_i18n: {"en":"Toplam Rota Kayb","tr":"Toplam Rota Kaybı"}, unit: "USD/sefer", format: "currency" },
  ],
