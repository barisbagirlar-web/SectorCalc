...
const FIELDS: Record<string,FieldDef> = {
  ...
  "n_logistics_cost_pct": { label:"Logistics cost", def:8.0, hard:[0,100], ref:[2,25], refUnit:"%", hint:"Freight, warehousing, fulfillment as % of price (canonical: raw percent number, e.g. 8 = 8%).", src:"logistics cost allocation", grp:2 },
  "n_service_cost_pct": { label:"Service/support cost", def:5.0, hard:[0,100], ref:[1,20], refUnit:"%", hint:"Customer service and support cost as % of price (canonical: raw percent number, e.g. 5 = 5%).", src:"support cost allocation", grp:2 },
  "n_return_rate_pct": { label:"Return rate", def:3.0, hard:[0,100], ref:[0,15], refUnit:"%", hint:"Fraction of units returned (canonical: raw percent number, e.g. 3 = 3%).", src:"returns log", grp:2 },
  "n_target_margin": { label:"Target margin", def:35.0, hard:[0,100], ref:[15,60], refUnit:"%", hint:"The margin target for this SKU (canonical: raw percent number, e.g. 35 = 35%; note this differs from job-quote-builder's target_margin, which is ratio-scale).", src:"pricing policy", grp:3 },
