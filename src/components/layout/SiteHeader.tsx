...
const LOCALES = [
  ...
  { code: 'tr', label: 'Turkish',   short: 'TR', dir: 'ltr' },
  { code: 'de', label: 'German',  short: 'DE', dir: 'ltr' },
  { code: 'fr', label: 'French', short: 'FR', dir: 'ltr' },
  { code: 'es', label: 'Spanish',  short: 'ES', dir: 'ltr' },
  { code: 'ar', label: 'Arabic',  short: 'AR', dir: 'rtl' },
];
