          ...
          <nav className="sc-ft-nav" aria-label="Footer navigation">
            <div className="sc-ft-nav-col">
              ...
              <div className="sc-ft-nav-links">
                ...
                <Link href="/premium-tools" className="sc-ft-nav-link">
                  {dict.links.proAnalysis} <span className="sc-ft-badge">New</span>
                </Link>
                <Link href="/premium-tools" className="sc-ft-nav-link">{dict.links.aiInterpretation}</Link>
                <Link href="/premium-tools" className="sc-ft-nav-link">{dict.links.scenarioComparison}</Link>
                <Link href="/premium-tools" className="sc-ft-nav-link">{dict.links.pdfReports}</Link>
