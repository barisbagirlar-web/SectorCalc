...
const slaLevelClasses: Record<FollowUpSlaLevel, string> = {
  ok: "border-slate/20 bg-off-white/80 text-slate",
  watch: "border-amber/30 bg-amber/10 text-amber",
  urgent: "border-soft-red/30 bg-soft-red/10 text-soft-red",
  done: "border-emerald-600/20 bg-emerald-50 text-emerald-800",
};
