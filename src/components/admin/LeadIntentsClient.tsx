...
export function LeadIntentsClient() {
  ...
  return (
    <div className="space-y-8">
      ...
      {!firebaseConfigured && (
        <div
          className="rounded-xl border border-professional-blue/20 bg-professional-blue/5 px-5 py-4 text-sm text-deep-navy"
          role="status"
        >
      ...
      <section
        className="rounded-xl border border-slate/20 bg-white p-5 shadow-card sm:p-6"
      ...
      {loading ? (
        <p className="text-sm text-slate">Loading lead intents…</p>
      ) : filteredLeads.length === 0 ? (
        <div className="rounded-xl border border-dashed border-slate/25 bg-white px-6 py-12 text-center shadow-card">
        ...
        <>
          <div className="hidden overflow-x-auto rounded-xl border border-slate/20 bg-white shadow-card md:block">
            <table className="w-full min-w-[1280px] text-left text-sm">
              <thead>
                <tr className="border-b border-slate/15 bg-off-white text-xs font-semibold uppercase tracking-wider text-slate">
      ...
      <div className="space-y-4 p-5">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div className="min-w-0 flex-1">
            ...
            <p className="text-sm text-slate">{lead.company}</p>
          </div>
        ...
        <dl className="grid grid-cols-[minmax(0,7rem)_1fr] gap-x-3 gap-y-3 text-sm">
          ...
          <dt className="text-slate">Intent</dt>
