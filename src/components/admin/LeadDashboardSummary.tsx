...
function DistributionBlock({
  ...
  return (
    <div className="rounded-xl border border-slate/20 bg-white p-4 shadow-card sm:p-5">
      <h3 className="text-xs font-semibold uppercase tracking-wider text-slate">
        {title}
      </h3>
      {items.length === 0 ? (
        <p className="mt-3 text-sm text-slate">{emptyLabel}</p>
      ) : (
    ...
    >
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <DistributionBlock
          ...
          emptyLabel="Henüz lead yok."
        />
        <div className="rounded-xl border border-slate/20 bg-white p-4 shadow-card sm:p-5 lg:col-span-1">
          <h3 className="text-xs font-semibold uppercase tracking-wider text-slate">
            Attribution (top 5)
          </h3>
