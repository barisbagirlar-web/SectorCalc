...
export function SectorMarginLanding({ config }: SectorMarginLandingProps) {
 ...
 <li key={leak} className="sc-card text-sm leading-relaxed text-text-secondary">
 {leak}
 </li>
 ))}
 </ul>
 ...
 <section className="border-b border-border-subtle bg-bg-primary py-12 sm:py-14 sc-section">
 <Container size="narrow">
