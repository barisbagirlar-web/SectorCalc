...
export function ProUpsellBanner() {
 ...
 <SparklesIcon className="h-6 w-6 text-ink-black" aria-hidden />
 ...
 <Link
 href="/pricing"
 className="inline-flex min-h-[44px] items-center justify-center rounded-sm bg-ink-black px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-black"
 >
 {t("proUpsellCta")}
 </Link>
 </div>
