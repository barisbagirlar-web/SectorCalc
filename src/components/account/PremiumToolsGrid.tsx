        ...
        {revenueTools.map((tool) => {
          ...
          return (
            <li key={tool.paidSlug}>
              <article className="rounded-xl border border-border-subtle bg-white p-5 shadow-card">
                ...
                <Link
                  href={href}
                  className="mt-4 inline-flex min-h-[44px] items-center justify-center rounded-lg border border-border-subtle px-4 text-sm font-semibold text-text-primary transition-colors hover:border-accent-teal hover:text-accent-teal"
                >
                  {ctaLabel}
                </Link>
              </article>
