...
export const PLANS: Plan[] = [
  {
    ...
    perCredit: 1.99,
    savingPct: 0,
    paddlePriceId: process.env.NEXT_PUBLIC_PRICE_ID_TRY_IT ?? '',
  ...
  },
  {
    ...
    perCredit: 1.00,
    savingPct: 50,
    paddlePriceId: process.env.NEXT_PUBLIC_PRICE_ID_ESSENTIALS ?? '',
  ...
  },
  {
    ...
    perCredit: 0.53,
    savingPct: 73,
    paddlePriceId: process.env.NEXT_PUBLIC_PRICE_ID_POPULAR ?? '',
  ...
  },
  {
    ...
    perCredit: 0.40,
    savingPct: 80,
    paddlePriceId: process.env.NEXT_PUBLIC_PRICE_ID_TEAMS ?? '',
  ...
  },
  {
    ...
    perCredit: 0.25,
    savingPct: 87,
    paddlePriceId: process.env.NEXT_PUBLIC_PRICE_ID_BEST_VALUE ?? '',
