...
/**
 * P7 domain-specific DeepSeek prompt packs — calculation-grade guidance per industrial domain.
 * Used by domain-prompt-dispatcher; keep mjs mirror in sync.
 */
export const P7_DOMAIN_PROMPT_PACKS: Readonly<Record<DomainPromptId, string>> = {
