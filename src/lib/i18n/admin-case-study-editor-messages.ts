...
const TR: AdminCaseStudyEditorMessages = {
  ...
  pageTitle: "Yeni başarı hikayesi",
  pageSubtitle: "Hikayeni tek kutuya yapıştır; AI alanları otomatik doldursun.",
  backToList: "Listeye dön",
  storyLabel: "Hikayeni yaz (AI otomatik ayrıştıracak)",
  storyPlaceholder: `Örnek:
Bir CNC atölyesinde OEE %18 idi.
Setup süresi 45 dakikaydı, fire oranı %8'di.
SectorCalc OEE Duruş Hesaplayıcı ve SMED Changeover Optimizer kullanıldı.
Sonuç: OEE %61'e çıktı, setup 12 dakikaya indi, fire %3'e düştü.
Yıllık tasarruf 850.000 TL oldu.
Müşteri: Ali Yılmaz, Üretim Müdürü, İzmir CNC Atölyesi`,
  parseButton: "Hikayeyi Dönüştür",
  parsing: "Ayrıştırılıyor…",
  advancedEditor: "Gelişmiş editör",
  parseHint: "AI; Challenge, Solution, Results ve metrikleri otomatik çıkarır.",
  parsedSectionTitle: "AI tarafından doldurulan alanlar (istersen düzelt)",
  fieldTitle: "Başlık",
  fieldIndustry: "Sektör",
  fieldCountry: "Ülke",
  fieldCity: "Şehir",
  fieldChallenge: "Zorluk (Challenge)",
  fieldSolution: "Çözüm (Solution)",
  fieldResults: "Sonuçlar (Metrikler)",
  metricName: "Metrik adı",
  metricBefore: "Önce",
  metricAfter: "Sonra",
  removeMetric: "Metrik satırını sil",
  addMetric: "Metrik ekle",
  fieldTestimonial: "Müşteri görüşü",
  testimonialPlaceholder: "Müşteri sözü…",
  publishButton: "Yayınla",
  publishing: "Yayınlanıyor (6 dil)…",
  sourceLocaleLabel: "Hikaye dili",
  errorEmptyStory: "Lütfen hikayeyi yazın.",
  errorTitleRequired: "Başlık zorunludur.",
  errorSession: "Yönetici oturumu bulunamadı. Lütfen tekrar giriş yapın.",
  errorParseFailed: "Hikaye ayrıştırılamadı.",
  errorConnection: "Bağlantı hatası. Lütfen tekrar deneyin.",
  errorPublishFailed: "Yayınlanamadı.",
  successParsed: "Hikaye ayrıştırıldı. Gerekirse düzenleyip yayınlayın.",
  successPublished: "Başarı hikayesi 6 dilde yayınlandı.",
  apiError: {
    TEXT_TOO_SHORT: "Hikaye çok kısa. En az 20 karakter girin.",
    TEXT_TOO_LONG: "Hikaye çok uzun.",
    PARSE_FAILED: "Hikaye ayrıştırılamadı. Lütfen tekrar deneyin.",
    MISSING_API_KEY: "DeepSeek API anahtarı yapılandırılmamış.",
    UNAUTHORIZED: "Yetkisiz erişim.",
    TRANSLATION_FAILED: "Tüm dillere çeviri yapılamadı.",
  },
};
...
const DE: AdminCaseStudyEditorMessages = {
  ...
  pageSubtitle: "Geschichte in ein Feld einfügen — KI füllt die Felder automatisch aus.",
  ...
  parsedSectionTitle: "KI-ausgefüllte Felder (bei Bedarf bearbeiten)",
  fieldTitle: "Titel",
  fieldIndustry: "Branche",
  fieldCountry: "Land",
  fieldCity: "Stadt",
  fieldChallenge: "Herausforderung",
  fieldSolution: "Lösung",
  ...
  publishing: "Veröffentlichen (6 Sprachen)…",
  ...
  errorPublishFailed: "Veröffentlichung fehlgeschlagen.",
  successParsed: "Geschichte analysiert. Bei Bedarf bearbeiten und veröffentlichen.",
  successPublished: "Erfolgsgeschichte in allen 6 Sprachen veröffentlicht.",
  apiError: {
    ...
    MISSING_API_KEY: "DeepSeek API-Schlüssel nicht konfiguriert.",
    UNAUTHORIZED: "Nicht autorisiert.",
    TRANSLATION_FAILED: "Übersetzung in alle Sprachen fehlgeschlagen.",
  },
};
