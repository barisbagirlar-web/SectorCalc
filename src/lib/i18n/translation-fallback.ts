...
export const FALLBACK_MAP: Record<string, string> = {
  ...
  "calculationFeedback.modalTitle": "Submit Calculation Feedback",
  "calculationFeedback.close": "Close",
  "calculationFeedback.issueTypeLabel": "Issue Type",
  "calculationFeedback.messageLabel": "Message (detailed description)",
  "calculationFeedback.emailLabel": "Your Email Address (optional)",
  "calculationFeedback.submitting": "Submitting...",
  "calculationFeedback.submit": "Submit Feedback",
  "calculationFeedback.success": "Thank you! Your feedback has been submitted successfully.",
  "calculationFeedback.error.messageTooShort": "Please provide a more detailed message (minimum 10 characters).",
  "calculationFeedback.error.submitFailed": "Failed to submit feedback. Please try again.",
  "calculationFeedback.issueTypes.wrong_result": "Wrong calculation result",
  "calculationFeedback.issueTypes.missing_input": "Missing input field",
  "calculationFeedback.issueTypes.unit_issue": "Incorrect measurement unit",
  "calculationFeedback.issueTypes.unclear_explanation": "Unclear explanation or methodology",
  "calculationFeedback.issueTypes.sector_assumption_issue": "Incorrect sector assumption",
  "calculationFeedback.issueTypes.improvement_request": "Feature/improvement suggestion",
  "calculationFeedback.issueTypes.other": "Other issue / General feedback",

  // ─── Feedback Panel & Dialog ──────────────────────────────────────
  "feedback.title": "FEEDBACK & CORRECTIONS",
  "feedback.subtitle": "Spotted an issue or have a calculation correction?",
  "feedback.formulaObjectionNote": "If you believe a formula, factor, or standard citation is incorrect, please detail the exact change and references.",
  "feedback.trustTraceNote": "Every submission is logged to the verification queue and reviewed by our engineering audit team.",
  "feedback.visibilityNote": "Your input helps improve calculations for all users.",
  "feedback.openButton": "Open Feedback Form",
  "feedback.closeButton": "Cancel / Close",
  "feedback.message.label": "Detailed Message *",
  "feedback.message.placeholder": "Describe the issue or correction in detail...",
  "feedback.suggestedInput.label": "Suggested Input Parameter",
  "feedback.dataSourceUrl.label": "Data Source or Standard Citation URL",
  "feedback.submit": "Submit Correction",
  "feedback.submitting": "Submitting...",
  "feedback.error.tooShort": "Message is too short.",
  "feedback.error.tooLong": "Message is too long.",
  "feedback.error.validation": "Please check the highlighted fields.",
  "feedback.error.rateLimited": "Too many submissions. Please try again later.",
  "feedback.error.submitFailed": "Failed to submit feedback. Please try again.",
  "feedback.kind.label": "Feedback Kind",
  "feedback.kind.selectPlaceholder": "Select feedback type...",
  "feedback.kind.formula_objection": "Formula Objection / Correction",
  "feedback.kind.wrong_result": "Incorrect Calculation Result",
  "feedback.kind.missing_input": "Missing Input Parameter",
  "feedback.kind.improvement_request": "Feature or Calculation Improvement Request",
  "feedback.kind.sector_adjustment": "Sector Specific Adjustment Suggestion",
  "feedback.kind.data_source_suggestion": "Data Source or Reference Standard suggestion",
  "feedback.kind.usability_issue": "Usability / Display Issue",
  "feedback.kind.other": "Other Feedback",
  "feedback.success.title": "Feedback Submitted",
  "feedback.success.description": "Thank you for helping improve calculation trust bounds. Our engineering team has logged this item to the queue.",
  "feedback.sectorContext.label": "Sector Context (e.g. standards, region, norms)",
  "feedback.suggestedFormulaChange.label": "Suggested Formula or Factor Change",
  "feedback.expectedBehavior.label": "Expected Behavior",
  "feedback.actualBehavior.label": "Actual Behavior",

  // ─── Verification Queue Button ────────────────────────────────────
  "verificationQueue.reportIssue": "Report an Issue",
  "verificationQueue.submitted": "Thank you. Your issue has been logged to the verification queue.",
  "verificationQueue.title": "Report a Calculation Issue",
  "verificationQueue.description": "If you've spotted an incorrect result or a bug, report it below for engineering audit.",
  "verificationQueue.issueTypeLabel": "Issue Type",
  "verificationQueue.type.wrong_result": "Wrong calculation result",
  "verificationQueue.type.missing_input": "Missing input field",
  "verificationQueue.type.unit_issue": "Incorrect measurement unit",
  "verificationQueue.type.unclear_explanation": "Unclear explanation or methodology",
  "verificationQueue.type.sector_assumption_issue": "Incorrect sector assumption",
  "verificationQueue.type.improvement_request": "Feature/improvement suggestion",
  "verificationQueue.type.other": "Other issue / General feedback",
  "verificationQueue.messageLabel": "Message (detailed description)",
  "verificationQueue.messagePlaceholder": "Describe what is wrong or needs improvement...",
  "verificationQueue.emailLabel": "Your Email (optional)",
  "verificationQueue.emailPlaceholder": "you@example.com",
  "verificationQueue.cancel": "Cancel",
  "verificationQueue.send": "Submit",
  "verificationQueue.submitting": "Submitting...",
  "verificationQueue.submitError": "Failed to submit. Please try again.",
  "verificationQueue.rateLimited": "Too many submissions. Please try again later.",

  // ─── Free Tool Report Form ─────────────────────────────────────────
  "generatedTool.freeForm.reportModalTitle": "Report a Calculation Issue",
  "generatedTool.freeForm.reportSuccess": "Thank you! Your report has been submitted to our audit queue.",
  "generatedTool.freeForm.reportClose": "Close",
  "generatedTool.freeForm.reportCategoryLabel": "Issue Category",
  "generatedTool.freeForm.reportCategoryFormula": "Wrong Calculation / Formula Error",
  "generatedTool.freeForm.reportCategoryMissingInput": "Missing Input Parameter",
  "generatedTool.freeForm.reportCategoryUnit": "Incorrect Unit",
  "generatedTool.freeForm.reportCategoryUi": "Display / UI Bug",
  "generatedTool.freeForm.reportCategoryOther": "Other Issue",
  "generatedTool.freeForm.reportDescriptionLabel": "Details of the Issue",
  "generatedTool.freeForm.reportDescriptionPlaceholder": "Describe the issue or wrong output in detail...",
  "generatedTool.freeForm.reportCancel": "Cancel",
  "generatedTool.freeForm.reportSubmit": "Submit Report",
  "generatedTool.freeForm.reportSubmitting": "Submitting...",
  "generatedTool.freeForm.reportMessageTooShort": "Please describe the issue with at least 10 characters.",
  "generatedTool.freeForm.reportSubmitFailed": "Failed to submit. Please try again.",

  // ─── Premium Tool Report Form ──────────────────────────────────────
  "generatedTool.premiumForm.reportModalTitle": "Report a Calculation Issue",
  "generatedTool.premiumForm.reportSuccess": "Thank you! Your report has been submitted to our audit queue.",
  "generatedTool.premiumForm.reportClose": "Close",
  "generatedTool.premiumForm.reportCategoryLabel": "Issue Category",
  "generatedTool.premiumForm.reportCategoryFormula": "Wrong Calculation / Formula Error",
  "generatedTool.premiumForm.reportCategoryMissingInput": "Missing Input Parameter",
  "generatedTool.premiumForm.reportCategoryUnit": "Incorrect Unit",
  "generatedTool.premiumForm.reportCategoryUi": "Display / UI Bug",
  "generatedTool.premiumForm.reportCategoryOther": "Other Issue",
  "generatedTool.premiumForm.reportDescriptionLabel": "Details of the Issue",
  "generatedTool.premiumForm.reportDescriptionPlaceholder": "Describe the issue or wrong output in detail...",
  "generatedTool.premiumForm.reportCancel": "Cancel",
  "generatedTool.premiumForm.reportSubmit": "Submit Report",
  "generatedTool.premiumForm.reportSubmitting": "Submitting...",
  "generatedTool.premiumForm.reportMessageTooShort": "Please describe the issue with at least 10 characters.",
  "generatedTool.premiumForm.reportSubmitFailed": "Failed to submit. Please try again.",
