...
import { FIRE_SYSTEM_FLOW_HYDRANT_CALCULATOR_INPUT_KEYS } from "@/lib/premium-schema/calculators/fire-system-flow-hydrant-calculator-validation";

const PREMIUM_SCHEMA_DISCLAIMER =
  "Technical simulation only — not financial, legal, safety, or professional advice. Verify assumptions before business decisions.";

const REQUIRED_INPUTS = [...FIRE_SYSTEM_FLOW_HYDRANT_CALCULATOR_INPUT_KEYS];
const OUTPUTS = [
  "flowDemandLpm",
  "hydrantCount",
  "summaryLevel",
