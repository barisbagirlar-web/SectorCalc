...
import { INVENTORY_CARRYING_COST_EOQ_CALCULATOR_INPUT_KEYS } from "@/lib/premium-schema/calculators/inventory-carrying-cost-eoq-calculator-validation";

const PREMIUM_SCHEMA_DISCLAIMER =
  "Technical simulation only — not financial, legal, safety, or professional advice. Verify assumptions before business decisions.";

const REQUIRED_INPUTS = [...INVENTORY_CARRYING_COST_EOQ_CALCULATOR_INPUT_KEYS];
const OUTPUTS = [
  "eoqUnits",
  "annualCarryingCost",
  "summaryLevel",
