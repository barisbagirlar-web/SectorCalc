...
import { CBAM_EXPOSURE_QUICK_CHECK_INPUT_KEYS } from "@/lib/premium-schema/calculators/cbam-exposure-quick-check-validation";

const PREMIUM_SCHEMA_DISCLAIMER =
  "Technical simulation only — not financial, legal, safety, or professional advice. Verify assumptions before business decisions.";

const REQUIRED_INPUTS = [...CBAM_EXPOSURE_QUICK_CHECK_INPUT_KEYS];
const OUTPUTS = [
  "totalExposure",
  "cbamCost",
  "unitCbamCost",
