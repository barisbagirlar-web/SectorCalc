...
const SEMANTIC_ALIAS_RULES: readonly SemanticAliasRule[] = [
  ...
  {
    slug: "cnc-quote-risk-analyzer",
    contractVariableIds: ["riskMargin"],
    ontologyVariableId: "riskBufferPercent",
    confidence: "strong",
    reason: "Contract riskMargin maps to fixture risk buffer percent.",
  },
  {
    slug: "cnc-quote-risk-analyzer",
    contractVariableIds: ["toolCost"],
    ontologyVariableId: "toolingCost",
    confidence: "strong",
    reason: "Tooling cost field naming differs between contract and fixture.",
  },
  {
    slug: "cnc-quote-risk-analyzer",
  ...
  {
    slug: "cnc-quote-risk-analyzer",
    contractVariableIds: ["quantity"],
    ontologyVariableId: "quantity",
    confidence: "strong",
    reason: "Quantity field naming matches between contract and fixture when both are present.",
  },
  {
    slug: "cnc-quote-risk-analyzer",
