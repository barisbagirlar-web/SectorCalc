...
import type { CalculationOntology, FormulaNode } from "@/lib/formula-governance/calculation-ontology/ontology-types";
...
export type CalculationIntelligenceLoopResult = {
  ...
  readonly requirement: import("@/lib/formula-governance/requirement-engine/requirement-engine-types").RequirementSolveResult;
