...
export type SolveRequiredInputsParams = {
  readonly ontology: import("@/lib/formula-governance/calculation-ontology/ontology-types").CalculationOntology;
  readonly goalId: string;
  readonly knownInputs: KnownInputs;
};

export type ResolveInverseRequirementParams = {
  readonly formulaNode: import("@/lib/formula-governance/calculation-ontology/ontology-types").FormulaNode;
