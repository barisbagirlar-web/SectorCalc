...
export const phase2RevenueTools: AdditionalRevenueTool[] = [
  build({
    ...
    seoKeywords: ["fertilizer dosage calculator", "crop yield loss", "gübre dozaj"],
  ...
  build({
    ...
    seoKeywords: ["carbon footprint calculator", "CBAM compliance", "karbon ayak izi"],
  ...
  build({
    ...
    seoKeywords: ["home renovation calculator", "ev tadilat hesabı"],
