...
import { getLiveKpiDecision, type LiveKpiDecision } from "@/lib/infrastructure/analytics/live-kpi-decision";
...
import { rankCampaignsByRevenueIntent } from "@/lib/features/campaigns/campaign-revenue-score";
import type { RevenueEventRecord } from "@/lib/infrastructure/analytics/revenue-funnel";
