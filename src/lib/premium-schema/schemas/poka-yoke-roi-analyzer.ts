...
export const POKA_YOKE_ROI_ANALYZER_SCHEMA: PremiumCalculatorSchema = {
  ...
  name: "Poka-Yoke Yatırım Getirisi", name_i18n: {"en":"Poka-Yoke Yatirim Getirisi","tr":"Poka-Yoke Yatırım Getirisi"}, sectorSlug: "quality", category: "cost",
  ...
  inputs: [
    { id: "currentDefectRate", label: "Mevcut Hata Oranı", label_i18n: {"en":"Current defect rate percentage","tr":"Mevcut Hata Oranı"}, type: "number", unit: "%", required: true, smartDefault: 5, validation: { min: 0.01 }, helper: "", expertMeaning: "Current defect rate percentage", expertMeaning_i18n: {"en":"Current defect rate percentage","tr":"mevcut hata oranı"} },
    { id: "productionVolume", label: "Üretim Hacmi", label_i18n: {"en":"Annual production volume","tr":"Üretim Hacmi"}, type: "number", unit: "adet/yıl", required: true, smartDefault: 100000, validation: { min: 1 }, helper: "", expertMeaning: "Annual production volume", expertMeaning_i18n: {"en":"Annual production volume","tr":"üretim hacmi"} },
    ...
    { id: "pokaYokeInvestment", label: "Poka-Yoke Yatırımı", label_i18n: {"en":"Total Poka-Yoke implementation cost","tr":"Poka-Yoke Yatırımı"}, type: "number", unit: "USD", required: true, smartDefault: 25000, validation: { min: 1 }, helper: "", expertMeaning: "Total Poka-Yoke implementation cost", expertMeaning_i18n: {"en":"Total Poka-Yoke implementation cost","tr":"poka-yoke yatırımı"} },
    { id: "newDefectRate", label: "Hedef Hata Oranı", label_i18n: {"en":"Target defect rate after Poka-Yoke","tr":"Hedef Hata Oranı"}, type: "number", unit: "%", required: true, smartDefault: 1, validation: { min: 0 }, helper: "", expertMeaning: "Target defect rate after Poka-Yoke", expertMeaning_i18n: {"en":"Target defect rate after Poka-Yoke","tr":"hedef hata oranı"} },
    { id: "usefulLife", label: "Faydalı Ömür", label_i18n: {"en":"Expected useful life of solution","tr":"Faydalı Ömür"}, type: "number", unit: "yıl", required: false, smartDefault: 5, validation: { min: 1 }, helper: "", expertMeaning: "Expected useful life of solution", expertMeaning_i18n: {"en":"Expected useful life of solution","tr":"faydalı ömür"} },
  ],
  outputs: [
    { id: "currentDefectRate", label: "Mevcut Hata Oranı", label_i18n: {"en":"Mevcut Hata Oran","tr":"Mevcut Hata Oranı"}, unit: "%", format: "number" },
    { id: "defectCostAnnual", label: "Yıllık Hata Maliyeti", label_i18n: {"en":"Yllk Hata Maliyeti","tr":"Yıllık Hata Maliyeti"}, unit: "USD/yıl", format: "currency", isBigNumber: true },
    { id: "pokaYokeCost", label: "Poka-Yoke Maliyeti", label_i18n: {"en":"Poka-Yoke Maliyeti","tr":"Poka-Yoke Maliyeti"}, unit: "USD", format: "currency" },
    { id: "newDefectRate", label: "Yeni Hata Oranı", label_i18n: {"en":"Yeni Hata Oran","tr":"Yeni Hata Oranı"}, unit: "%", format: "number" },
    { id: "pokaYokeSavings", label: "Yıllık Tasarruf", label_i18n: {"en":"Yllk Tasarruf","tr":"Yıllık Tasarruf"}, unit: "USD/yıl", format: "currency", isBigNumber: true },
    { id: "pokaYokeRoi", label: "Yatırım Getirisi (ROI)", label_i18n: {"en":"Yatrm Getirisi (ROI)","tr":"Yatırım Getirisi (ROI)"}, unit: "%", format: "number" },
    { id: "pokaYokePayback", label: "Geri Ödeme Süresi", label_i18n: {"en":"Geri Odeme Suresi","tr":"Geri Ödeme Süresi"}, unit: "ay", format: "number" },
  ],
