...
export const SCAFFOLD_RENTAL_SCHEMA: PremiumCalculatorSchema = {
  ...
  name: "İskele Kiralama & Süre Optimizasyonu", name_i18n: {"en":"İskele Kiralama & Süre Optimizasyonu","tr":"İskele Kiralama & Süre Optimizasyonu"}, sectorSlug: "construction", category: "cost",
  ...
  inputs: [
    { id: "buildingPerimeter", label: "Bina Çevresi", label_i18n: {"en":"Bina Çevresi","tr":"Bina Çevresi"}, type: "number", unit: "m", required: true, smartDefault: 80, validation: { min: 1 }, helper: "", expertMeaning: "Building perimeter", expertMeaning_i18n: {"en":"Building perimeter","tr":"Building perimeter"} },
    { id: "buildingHeight", label: "Bina Yüksekliği", label_i18n: {"en":"Bina Yüksekliği","tr":"Bina Yüksekliği"}, type: "number", unit: "m", required: true, smartDefault: 15, validation: { min: 1 }, helper: "", expertMeaning: "Building height", expertMeaning_i18n: {"en":"Building height","tr":"Building height"} },
    { id: "rentalRatePerM2", label: "m² Kiralama Bedeli", label_i18n: {"en":"m² Kiralama Bedeli","tr":"m² Kiralama Bedeli"}, type: "number", unit: "USD/m²/ay", required: true, smartDefault: 8, validation: { min: 0 }, helper: "", expertMeaning: "Monthly rental rate per m²", expertMeaning_i18n: {"en":"Monthly rental rate per m²","tr":"Monthly rental rate per m²"} },
    { id: "rentalDuration", label: "Kiralama Süresi", label_i18n: {"en":"Kiralama Süresi","tr":"Kiralama Süresi"}, type: "number", unit: "ay", required: true, smartDefault: 6, validation: { min: 0.5 }, helper: "", expertMeaning: "Rental duration", expertMeaning_i18n: {"en":"Rental duration","tr":"Rental duration"} },
    { id: "erectionRate", label: "Montaj İşçilik (m² başına)", label_i18n: {"en":"Montaj İşçilik (m² başına)","tr":"Montaj İşçilik (m² başına)"}, type: "number", unit: "USD/m²", required: false, smartDefault: 5, validation: { min: 0 }, helper: "", expertMeaning: "Erection labor rate per m²", expertMeaning_i18n: {"en":"Erection labor rate per m²","tr":"Erection labor rate per m²"} },
    { id: "dismantleRate", label: "Söküm İşçilik (m² başına)", label_i18n: {"en":"Söküm İşçilik (m² başına)","tr":"Söküm İşçilik (m² başına)"}, type: "number", unit: "USD/m²", required: false, smartDefault: 3, validation: { min: 0 }, helper: "", expertMeaning: "Dismantle labor rate per m²", expertMeaning_i18n: {"en":"Dismantle labor rate per m²","tr":"Dismantle labor rate per m²"} },
    { id: "transportCost", label: "Nakliye Maliyeti", label_i18n: {"en":"Nakliye Maliyeti","tr":"Nakliye Maliyeti"}, type: "number", unit: "USD", required: false, smartDefault: 2000, validation: { min: 0 }, helper: "", expertMeaning: "Transport cost", expertMeaning_i18n: {"en":"Transport cost","tr":"Transport cost"} },
    { id: "overrunCost", label: "Süre Aşımı Maliyeti", label_i18n: {"en":"Süre Aşımı Maliyeti","tr":"Süre Aşımı Maliyeti"}, type: "number", unit: "USD", required: false, smartDefault: 1500, validation: { min: 0 }, helper: "", expertMeaning: "Overrun extension cost", expertMeaning_i18n: {"en":"Overrun extension cost","tr":"Overrun extension cost"} },
  ],
  outputs: [
