...
export const PRICE_ELASTICITY_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "pctPriceChange", label: "Fiyat Değişim Yüzdesi", label_i18n: {"en":"Fiyat Değişim Yüzdesi","tr":"Fiyat Değişim Yüzdesi"}, type: "number", unit: "%", required: true, smartDefault: 10, validation: { min: -100, max: 500 }, helper: "", expertMeaning: "Price change percentage", expertMeaning_i18n: {"en":"Price change percentage","tr":"Price change percentage"} },
    { id: "pctDemandChange", label: "Talep Değişim Yüzdesi", label_i18n: {"en":"Talep Değişim Yüzdesi","tr":"Talep Değişim Yüzdesi"}, type: "number", unit: "%", required: true, smartDefault: -5, validation: { min: -100, max: 500 }, helper: "", expertMeaning: "Demand change percentage", expertMeaning_i18n: {"en":"Demand change percentage","tr":"Demand change percentage"} },
    { id: "varCost", label: "Değişken Maliyet", label_i18n: {"en":"Değişken Maliyet","tr":"Değişken Maliyet"}, type: "number", unit: "USD", required: true, smartDefault: 25, validation: { min: 0 }, helper: "", expertMeaning: "Variable cost per unit", expertMeaning_i18n: {"en":"Variable cost per unit","tr":"Variable cost per unit"} },
    { id: "fixedCost", label: "Sabit Maliyet", label_i18n: {"en":"Sabit Maliyet","tr":"Sabit Maliyet"}, type: "number", unit: "USD", required: false, smartDefault: 100000, validation: { min: 0 }, helper: "", expertMeaning: "Fixed costs", expertMeaning_i18n: {"en":"Fixed costs","tr":"Fixed costs"} },
    { id: "cannibRate", label: "Kanibalizasyon Oranı", label_i18n: {"en":"Kanibalizasyon Oranı","tr":"Kanibalizasyon Oranı"}, type: "number", unit: "%", required: false, smartDefault: 0, validation: { min: 0, max: 100 }, helper: "", expertMeaning: "Cannibalization rate", expertMeaning_i18n: {"en":"Cannibalization rate","tr":"Cannibalization rate"} },
