...
export const NOISE_VIBRATION_COST_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    { id: "noiseLevelDb", label: "Gürültü Seviyesi", label_i18n: {"en":"Gürültü Seviyesi","tr":"Gürültü Seviyesi"}, type: "number", unit: "dB(A)", required: true, smartDefault: 88, validation: { min: 30, max: 130 }, helper: "", expertMeaning: "Noise exposure level", expertMeaning_i18n: {"en":"Noise exposure level","tr":"Noise exposure level"} },
    { id: "exposureHours", label: "Günlük Maruziyet Süresi", label_i18n: {"en":"Günlük Maruziyet Süresi","tr":"Günlük Maruziyet Süresi"}, type: "number", unit: "saat/gün", required: true, smartDefault: 8, validation: { min: 0.5, max: 16 }, helper: "", expertMeaning: "Daily exposure hours", expertMeaning_i18n: {"en":"Daily exposure hours","tr":"Daily exposure hours"} },
    { id: "numWorkers", label: "Maruz Kalan Çalışan Sayısı", label_i18n: {"en":"Maruz Kalan Çalışan Sayısı","tr":"Maruz Kalan Çalışan Sayısı"}, type: "number", unit: "kişi", required: true, smartDefault: 15, validation: { min: 1 }, helper: "", expertMeaning: "Number of exposed workers", expertMeaning_i18n: {"en":"Number of exposed workers","tr":"Number of exposed workers"} },
    { id: "vibrationRms", label: "Titreşim RMS Değeri", label_i18n: {"en":"Titreşim RMS Değeri","tr":"Titreşim RMS Değeri"}, type: "number", unit: "m/s²", required: true, smartDefault: 2.5, validation: { min: 0, max: 50 }, helper: "", expertMeaning: "Vibration RMS level", expertMeaning_i18n: {"en":"Vibration RMS level","tr":"Vibration RMS level"} },
    { id: "vibrationDailyHours", label: "Titreşim Günlük Süre", label_i18n: {"en":"Titreşim Günlük Süre","tr":"Titreşim Günlük Süre"}, type: "number", unit: "saat/gün", required: false, smartDefault: 4, validation: { min: 0.1, max: 16 }, helper: "", expertMeaning: "Daily vibration exposure hours", expertMeaning_i18n: {"en":"Daily vibration exposure hours","tr":"Daily vibration exposure hours"} },
    { id: "avgWorkerSalary", label: "Ortalama Çalışan Maaşı", label_i18n: {"en":"Ortalama Çalışan Maaşı","tr":"Ortalama Çalışan Maaşı"}, type: "number", unit: "USD/yıl", required: true, smartDefault: 35000, validation: { min: 1 }, helper: "", expertMeaning: "Average annual salary", expertMeaning_i18n: {"en":"Average annual salary","tr":"Average annual salary"} },
    { id: "mitigationInvestment", label: "Azaltma Yatırımı", label_i18n: {"en":"Azaltma Yatırımı","tr":"Azaltma Yatırımı"}, type: "number", unit: "USD", required: false, smartDefault: 40000, validation: { min: 0 }, helper: "", expertMeaning: "Noise/vibration mitigation cost", expertMeaning_i18n: {"en":"Noise/vibration mitigation cost","tr":"Noise/vibration mitigation cost"} },
  ],
  outputs: [
    { id: "noiseExposure", label: "Gürültü Maruziyet Skoru", label_i18n: {"en":"Gürültü Maruziyet Skoru","tr":"Gürültü Maruziyet Skoru"}, unit: "dB(A)×saat", format: "number" },
    { id: "vibrationLevel", label: "Titreşim Seviyesi", label_i18n: {"en":"Titreşim Seviyesi","tr":"Titreşim Seviyesi"}, unit: "m/s²", format: "number" },
    { id: "healthCost", label: "Sağlık Maliyeti (Gürültü)", label_i18n: {"en":"Sağlık Maliyeti (Gürültü)","tr":"Sağlık Maliyeti (Gürültü)"}, unit: "USD/yıl", format: "currency" },
    { id: "productivityLoss", label: "Verimlilik Kaybı", label_i18n: {"en":"Verimlilik Kaybı","tr":"Verimlilik Kaybı"}, unit: "USD/yıl", format: "currency" },
