...
export const AmbalajMalzemesiDegisimiVeMaliyetEtkiCalculator_SCHEMA: PremiumCalculatorSchema = {
  id: "ambalaj-malzemesi-degisimi-ve-maliyet-etki-calculator",
  name: "Ambalaj Malzemesi Degisimi Ve Maliyet Etki",
