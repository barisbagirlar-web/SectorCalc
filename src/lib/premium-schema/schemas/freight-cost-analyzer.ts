...
export const FREIGHT_COST_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    { id: "grossWeight", label: "Brüt Ağırlık", label_i18n: {"en":"Brüt Ağırlık","tr":"Brüt Ağırlık"}, type: "number", unit: "kg", required: true, smartDefault: 1500, validation: { min: 0.1 }, helper: "", expertMeaning: "Gross weight in kg", expertMeaning_i18n: {"en":"Gross weight in kg","tr":"Gross weight in kg"} },
    ...
    { id: "bunkerPct", label: "Bunker Ek Yüzdesi", label_i18n: {"en":"Bunker Ek Yüzdesi","tr":"Bunker Ek Yüzdesi"}, type: "number", unit: "%", required: true, smartDefault: 15, validation: { min: 0, max: 100 }, helper: "", expertMeaning: "Bunker surcharge percentage", expertMeaning_i18n: {"en":"Bunker surcharge percentage","tr":"Bunker surcharge percentage"} },
    { id: "terminalFee", label: "Terminal İşlem Ücreti", label_i18n: {"en":"Terminal İşlem Ücreti","tr":"Terminal İşlem Ücreti"}, type: "number", unit: "USD", required: true, smartDefault: 200, validation: { min: 0 }, helper: "", expertMeaning: "Terminal handling fee", expertMeaning_i18n: {"en":"Terminal handling fee","tr":"Terminal handling fee"} },
    { id: "customsFee", label: "Gümrük Ücreti", label_i18n: {"en":"Gümrük Ücreti","tr":"Gümrük Ücreti"}, type: "number", unit: "USD", required: true, smartDefault: 150, validation: { min: 0 }, helper: "", expertMeaning: "Customs clearance fee", expertMeaning_i18n: {"en":"Customs clearance fee","tr":"Customs clearance fee"} },
  ],
  outputs: [
    { id: "chargeableWeight", label: "Taşınabilir Ağırlık", label_i18n: {"en":"Taşınabilir Ağırlık","tr":"Taşınabilir Ağırlık"}, unit: "kg", format: "number" },
    { id: "baseFreight", label: "Baz Navlun Bedeli", label_i18n: {"en":"Baz Navlun Bedeli","tr":"Baz Navlun Bedeli"}, unit: "USD", format: "currency" },
    { id: "bunkerSurcharge", label: "Bunker Ek Ücreti", label_i18n: {"en":"Bunker Ek Ücreti","tr":"Bunker Ek Ücreti"}, unit: "USD", format: "currency" },
    { id: "terminalCost", label: "Terminal Maliyeti", label_i18n: {"en":"Terminal Maliyeti","tr":"Terminal Maliyeti"}, unit: "USD", format: "currency" },
    { id: "customsCost", label: "Gümrük Maliyeti", label_i18n: {"en":"Gümrük Maliyeti","tr":"Gümrük Maliyeti"}, unit: "USD", format: "currency" },
    ...
    { id: "costPerUnit", label: "Birim Başına Navlun", label_i18n: {"en":"Birim Başına Navlun","tr":"Birim Başına Navlun"}, unit: "USD/kg", format: "currency" },
  ],
