...
export const FACTORY_LAYOUT_SCHEMA: PremiumCalculatorSchema = {
  ...
  name: "Fabrika Yerleşim Mesafe & Akış Analizi", name_i18n: {"en":"Fabrika Yerleşim Mesafe & Akış Analizi","tr":"Fabrika Yerleşim Mesafe & Akış Analizi"}, sectorSlug: "sheet-metal", category: "measurement",
  ...
  inputs: [
    ...
    { id: "costPerDist", label: "Birim Taşıma Maliyeti", label_i18n: {"en":"Birim Taşıma Maliyeti","tr":"Birim Taşıma Maliyeti"}, type: "number", unit: "USD/m", required: true, smartDefault: 0.5, validation: { min: 0 }, helper: "", expertMeaning: "Cost per unit distance", expertMeaning_i18n: {"en":"Cost per unit distance","tr":"Cost per unit distance"} },
    { id: "equipmentArea", label: "Ekipman Alanı", label_i18n: {"en":"Ekipman Alanı","tr":"Ekipman Alanı"}, type: "number", unit: "m²", required: false, smartDefault: 800, validation: { min: 0 }, helper: "", expertMeaning: "Total equipment footprint", expertMeaning_i18n: {"en":"Total equipment footprint","tr":"Total equipment footprint"} },
    { id: "facilityArea", label: "Tesis Alanı", label_i18n: {"en":"Tesis Alanı","tr":"Tesis Alanı"}, type: "number", unit: "m²", required: false, smartDefault: 2000, validation: { min: 0 }, helper: "", expertMeaning: "Total facility area", expertMeaning_i18n: {"en":"Total facility area","tr":"Total facility area"} },
    { id: "matHandlingCost", label: "Malzeme Taşıma Maliyeti", label_i18n: {"en":"Malzeme Taşıma Maliyeti","tr":"Malzeme Taşıma Maliyeti"}, type: "number", unit: "USD", required: false, smartDefault: 15000, validation: { min: 0 }, helper: "", expertMeaning: "Material handling cost", expertMeaning_i18n: {"en":"Material handling cost","tr":"Material handling cost"} },
    ...
    { id: "congestionCost", label: "Sıkışıklık Maliyeti", label_i18n: {"en":"Sıkışıklık Maliyeti","tr":"Sıkışıklık Maliyeti"}, type: "number", unit: "USD", required: false, smartDefault: 5000, validation: { min: 0 }, helper: "", expertMeaning: "Congestion cost", expertMeaning_i18n: {"en":"Congestion cost","tr":"Congestion cost"} },
  ],
  outputs: [
    { id: "totalFlowCost", label: "Toplam Akış Maliyeti", label_i18n: {"en":"Toplam Akış Maliyeti","tr":"Toplam Akış Maliyeti"}, unit: "USD", format: "currency" },
    { id: "spaceUtilization", label: "Alan Kullanım Oranı", label_i18n: {"en":"Alan Kullanım Oranı","tr":"Alan Kullanım Oranı"}, unit: "%", format: "percentage" },
    { id: "totalLayoutCost", label: "Toplam Yerleşim Maliyeti", label_i18n: {"en":"Toplam Yerleşim Maliyeti","tr":"Toplam Yerleşim Maliyeti"}, unit: "USD", format: "currency", isBigNumber: true },
  ],
