...
export const VACUUM_LEAK_SCHEMA: PremiumCalculatorSchema = {
  ...
  name: "Vakum Kaçağı Enerji Maliyeti", name_i18n: {"en":"Vakum Kaçağı Enerji Maliyeti","tr":"Vakum Kaçağı Enerji Maliyeti"}, sectorSlug: "energy-carbon", category: "cost",
  ...
  inputs: [
    { id: "leakRate", label: "Kaçak Debisi", label_i18n: {"en":"Kaçak Debisi","tr":"Kaçak Debisi"}, type: "number", unit: "L/dk", required: true, smartDefault: 50, validation: { min: 0.1 }, helper: "", expertMeaning: "Vacuum leak rate", expertMeaning_i18n: {"en":"Vacuum leak rate","tr":"Vacuum leak rate"} },
    { id: "systemPressure", label: "Sistem Basıncı", label_i18n: {"en":"Sistem Basıncı","tr":"Sistem Basıncı"}, type: "number", unit: "kPa", required: true, smartDefault: 80, validation: { min: 1 }, helper: "", expertMeaning: "System vacuum pressure", expertMeaning_i18n: {"en":"System vacuum pressure","tr":"System vacuum pressure"} },
    { id: "operatingHours", label: "Çalışma Saati / Yıl", label_i18n: {"en":"Çalışma Saati / Yıl","tr":"Çalışma Saati / Yıl"}, type: "number", unit: "saat", required: true, smartDefault: 8760, validation: { min: 1 }, helper: "", expertMeaning: "Annual operating hours", expertMeaning_i18n: {"en":"Annual operating hours","tr":"Annual operating hours"} },
    ...
    { id: "numLeaks", label: "Kaçak Sayısı", label_i18n: {"en":"Kaçak Sayısı","tr":"Kaçak Sayısı"}, type: "number", unit: "adet", required: false, smartDefault: 5, validation: { min: 1 }, helper: "", expertMeaning: "Number of identified leaks", expertMeaning_i18n: {"en":"Number of identified leaks","tr":"Number of identified leaks"} },
    { id: "motorPower", label: "Vakum Pompa Gücü", label_i18n: {"en":"Vakum Pompa Gücü","tr":"Vakum Pompa Gücü"}, type: "number", unit: "kW", required: false, smartDefault: 7.5, validation: { min: 0.1 }, helper: "", expertMeaning: "Vacuum pump motor power", expertMeaning_i18n: {"en":"Vacuum pump motor power","tr":"Vacuum pump motor power"} },
    { id: "capacityWaste", label: "Kapasite Kaybı", label_i18n: {"en":"Kapasite Kaybı","tr":"Kapasite Kaybı"}, type: "number", unit: "%", required: false, smartDefault: 15, validation: { min: 0, max: 100 }, helper: "", expertMeaning: "Capacity wasted due to leaks", expertMeaning_i18n: {"en":"Capacity wasted due to leaks","tr":"Capacity wasted due to leaks"} },
  ],
  outputs: [
    { id: "vacuumLeakRate", label: "Toplam Kaçak Debisi", label_i18n: {"en":"Toplam Kaçak Debisi","tr":"Toplam Kaçak Debisi"}, unit: "L/dk", format: "number" },
    { id: "vacuumLeakCost", label: "Kaçak Enerji Maliyeti", label_i18n: {"en":"Kaçak Enerji Maliyeti","tr":"Kaçak Enerji Maliyeti"}, unit: "USD/yıl", format: "currency" },
    { id: "vacuumCapacityWaste", label: "Kapasite İsrafı", label_i18n: {"en":"Kapasite İsrafı","tr":"Kapasite İsrafı"}, unit: "%", format: "percentage" },
