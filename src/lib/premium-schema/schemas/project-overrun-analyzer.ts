...
export const PROJECT_OVERRUN_ANALYZER_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    { id: "plannedValue", label: "Planlanan Değer (PV)", label_i18n: {"en":"Planned Value (PV)","tr":"Planlanan Değer (PV)", type: "number", unit: "USD", required: true, smartDefault: 1000000, validation: { min: 1 }, helper: "", expertMeaning: "Planned Value (budget)", expertMeaning_i18n: {"en":"Planned Value (budget)","tr":"Planned Value (budget)" },
    { id: "earnedValue", label: "Kazanılan Değer (EV)", label_i18n: {"en":"Earned Value (EV)","tr":"Kazanılan Değer (EV)", type: "number", unit: "USD", required: true, smartDefault: 750000, validation: { min: 0 }, helper: "", expertMeaning: "Earned Value (work completed)", expertMeaning_i18n: {"en":"Earned Value (work completed)","tr":"Earned Value (work completed)" },
    { id: "actualCost", label: "Gerçekleşen Maliyet (AC)", label_i18n: {"en":"Actual Cost (AC)","tr":"Gerçekleşen Maliyet (AC)", type: "number", unit: "USD", required: true, smartDefault: 800000, validation: { min: 0 }, helper: "", expertMeaning: "Actual Cost incurred", expertMeaning_i18n: {"en":"Actual Cost incurred","tr":"Actual Cost incurred" },
    { id: "scheduleDays", label: "Planlanan Süre", label_i18n: {"en":"Planned Duration","tr":"Planlanan Süre", type: "number", unit: "gün", required: true, smartDefault: 200, validation: { min: 1 }, helper: "", expertMeaning: "Planned schedule duration", expertMeaning_i18n: {"en":"Planned schedule duration","tr":"Planned schedule duration" },
    { id: "actualDays", label: "Gerçekleşen Süre", label_i18n: {"en":"Actual Duration","tr":"Gerçekleşen Süre", type: "number", unit: "gün", required: false, smartDefault: 160, validation: { min: 0 }, helper: "", expertMeaning: "Actual elapsed days", expertMeaning_i18n: {"en":"Actual elapsed days","tr":"Actual elapsed days" },
    { id: "riskProbability", label: "Risk Olasılığı", label_i18n: {"en":"Risk Probability","tr":"Risk Olasılığı", type: "number", unit: "%", required: false, smartDefault: 25, validation: { min: 0, max: 100 }, helper: "", expertMeaning: "Probability of risk events", expertMeaning_i18n: {"en":"Probability of risk events","tr":"Probability of risk events" },
    ...
    { id: "mitigationCost", label: "Azaltma Maliyeti", label_i18n: {"en":"Mitigation Cost","tr":"Azaltma Maliyeti", type: "number", unit: "USD", required: false, smartDefault: 15000, validation: { min: 0 }, helper: "", expertMeaning: "Cost to mitigate risks", expertMeaning_i18n: {"en":"Cost to mitigate risks","tr":"Cost to mitigate risks" },
  ],
  outputs: [
