...
export const BID_RISK_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "laborUncertainty", label: "İşçilik Belirsizlik Oranı", label_i18n: {"en":"Labor Uncertainty Rate","tr":"İşçilik Belirsizlik Oranı", type: "number", unit: "%", required: true, smartDefault: 8, validation: { min: 0, max: 100 }, helper: "", expertMeaning: "Labor uncertainty", expertMeaning_i18n: {"en":"Labor uncertainty","tr":"Labor uncertainty" },
    ...
    { id: "numCompetitors", label: "Rakip Sayısı", label_i18n: {"en":"Number of Competitors","tr":"Rakip Sayısı", type: "number", unit: "adet", required: false, smartDefault: 5, validation: { min: 0 }, helper: "", expertMeaning: "Number of competing bidders", expertMeaning_i18n: {"en":"Number of competing bidders","tr":"Number of competing bidders" },
    { id: "yourBidPrice", label: "Sizin Teklif Fiyatınız", label_i18n: {"en":"Your Bid Price","tr":"Sizin Teklif Fiyatınız", type: "number", unit: "USD", required: false, smartDefault: 240000, validation: { min: 0 }, helper: "", expertMeaning: "Your bid price", expertMeaning_i18n: {"en":"Your bid price","tr":"Your bid price" },
  ],
  outputs: [
