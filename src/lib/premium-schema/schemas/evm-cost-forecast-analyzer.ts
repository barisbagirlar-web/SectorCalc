...
export const EVM_FORECAST_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    { id: "bac", label: "BAC (Bütçelenen Tamamlanma)", label_i18n: {"en":"BAC (Budget at Completion)","tr":"BAC (Bütçelenen Tamamlanma)", type: "number", unit: "USD", required: true, smartDefault: 1000000, validation: { min: 1 }, helper: "", expertMeaning: "Budget at completion", expertMeaning_i18n: {"en":"Budget at completion","tr":"Budget at completion" },
    { id: "plannedValue", label: "PV (Planlanan Değer)", label_i18n: {"en":"PV (Planned Value)","tr":"PV (Planlanan Değer)", type: "number", unit: "USD", required: true, smartDefault: 500000, validation: { min: 0 }, helper: "", expertMeaning: "Planned value to date", expertMeaning_i18n: {"en":"Planned value to date","tr":"Planned value to date" },
    { id: "earnedValue", label: "EV (Kazanılan Değer)", label_i18n: {"en":"EV (Earned Value)","tr":"EV (Kazanılan Değer)", type: "number", unit: "USD", required: true, smartDefault: 450000, validation: { min: 0 }, helper: "", expertMeaning: "Earned value to date", expertMeaning_i18n: {"en":"Earned value to date","tr":"Earned value to date" },
    { id: "actualCost", label: "AC (Gerçek Maliyet)", label_i18n: {"en":"AC (Actual Cost)","tr":"AC (Gerçek Maliyet)", type: "number", unit: "USD", required: true, smartDefault: 520000, validation: { min: 0 }, helper: "", expertMeaning: "Actual cost to date", expertMeaning_i18n: {"en":"Actual cost to date","tr":"Actual cost to date" },
    { id: "varianceReason", label: "Varyans Nedeni", label_i18n: {"en":"Variance Cause","tr":"Varyans Nedeni", type: "select", unit: "", enumValues: ["verimlilik", "malzeme", "işçilik", "kapsam", "diğer"], required: false, smartDefault: "verimlilik", helper: "", expertMeaning: "Primary variance cause", expertMeaning_i18n: {"en":"Primary variance cause","tr":"Primary variance cause" },
