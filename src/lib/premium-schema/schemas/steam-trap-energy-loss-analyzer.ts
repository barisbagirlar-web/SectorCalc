...
export const STEAM_TRAP_ENERGY_LOSS_ANALYZER: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "replacementCost", label: "Değişim Maliyeti", label_i18n: {"en":"Replacement Cost","tr":"Değişim Maliyeti"}, type: "number", unit: "USD/adet", required: false, smartDefault: 350, validation: { min: 1 }, helper: "", expertMeaning: "Replacement cost per trap", expertMeaning_i18n: {"en":"Replacement cost per trap","tr":"Replacement cost per trap"} },
  ],
  outputs: [
    ...
    { id: "roi", label: "Onarım Yatırım Getirisi", label_i18n: {"en":"Repair ROI","tr":"Onarım Yatırım Getirisi"}, unit: "%", format: "percentage" },
  ],
