  ...
  inputs: [
    {
      ...
      smartDefault: 120000,
      validation: { min: 0 },
      helper: "Up-front project or equipment cost.",
      expertMeaning: "Cash outflow at period zero.",
    },
    {
      id: "annualCashFlow",
      ...
      smartDefault: 28000,
      validation: { min: 0 },
      helper: "Expected annual benefit after investment.",
      expertMeaning: "Constant annual inflow used in screening model.",
    },
    {
      ...
      helper: "Required return or cost of capital.",
      expertMeaning: "Rate used in NPV discounting.",
    },
    {
      id: "horizonYears",
      label: "Horizon",
      ...
      helper: "Analysis period in years.",
      expertMeaning: "Number of annual cash-flow periods modeled.",
    },
  ],
