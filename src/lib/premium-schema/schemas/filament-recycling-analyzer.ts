...
export const FILAMENT_RECYCLING_SCHEMA: PremiumCalculatorSchema = {
  ...
  name: "Filament Geri Dönüşüm Ekonomisi Analizi", name_i18n: {"en":"Filament Geri Dönüşüm Ekonomisi Analizi","tr":"Filament Geri Dönüşüm Ekonomisi Analizi"}, sectorSlug: "sheet-metal", category: "cost",
  ...
  inputs: [
    { id: "virginPrice", label: "Saf Filament Fiyatı", label_i18n: {"en":"Saf Filament Fiyatı","tr":"Saf Filament Fiyatı"}, type: "number", unit: "USD/kg", required: true, smartDefault: 25, validation: { min: 0 }, helper: "", expertMeaning: "Virgin filament price", expertMeaning_i18n: {"en":"Virgin filament price","tr":"Virgin filament price"} },
    { id: "virginScrapPct", label: "Saf Fire Oranı", label_i18n: {"en":"Saf Fire Oranı","tr":"Saf Fire Oranı"}, type: "number", unit: "%", required: false, smartDefault: 5, validation: { min: 0, max: 100 }, helper: "", expertMeaning: "Virgin material scrap rate", expertMeaning_i18n: {"en":"Virgin material scrap rate","tr":"Virgin material scrap rate"} },
    ...
    { id: "sortCost", label: "Ayırma Maliyeti", label_i18n: {"en":"Ayırma Maliyeti","tr":"Ayırma Maliyeti"}, type: "number", unit: "USD/kg", required: false, smartDefault: 2, validation: { min: 0 }, helper: "", expertMeaning: "Sorting cost per kg", expertMeaning_i18n: {"en":"Sorting cost per kg","tr":"Sorting cost per kg"} },
    ...
    { id: "recyclingYield", label: "Geri Dönüşüm Verimi", label_i18n: {"en":"Geri Dönüşüm Verimi","tr":"Geri Dönüşüm Verimi"}, type: "number", unit: "%", required: true, smartDefault: 80, validation: { min: 1, max: 100 }, helper: "", expertMeaning: "Recycling process yield", expertMeaning_i18n: {"en":"Recycling process yield","tr":"Recycling process yield"} },
    { id: "productionVolume", label: "Yıllık Üretim Hacmi", label_i18n: {"en":"Yıllık Üretim Hacmi","tr":"Yıllık Üretim Hacmi"}, type: "number", unit: "kg", required: false, smartDefault: 5000, validation: { min: 0 }, helper: "", expertMeaning: "Annual production volume", expertMeaning_i18n: {"en":"Annual production volume","tr":"Annual production volume"} },
    { id: "capex", label: "Yatırım (Capex)", label_i18n: {"en":"Yatırım (Capex)","tr":"Yatırım (Capex)"}, type: "number", unit: "USD", required: false, smartDefault: 50000, validation: { min: 0 }, helper: "", expertMeaning: "Recycling equipment capex", expertMeaning_i18n: {"en":"Recycling equipment capex","tr":"Recycling equipment capex"} },
  ],
  outputs: [
    ...
    { id: "recycledCost", label: "Geri Dönüşüm Maliyeti", label_i18n: {"en":"Geri Dönüşüm Maliyeti","tr":"Geri Dönüşüm Maliyeti"}, unit: "USD/kg", format: "currency" },
    { id: "roi", label: "Geri Dönüşüm ROI", label_i18n: {"en":"Geri Dönüşüm ROI","tr":"Geri Dönüşüm ROI"}, unit: "%", format: "percentage", isBigNumber: true },
  ],
