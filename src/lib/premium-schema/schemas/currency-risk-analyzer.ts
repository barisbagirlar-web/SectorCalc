...
export const CURRENCY_RISK_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    { id: "fxRevenue", label: "Döviz Gelir", label_i18n: {"en":"Döviz Gelir","tr":"Döviz Gelir"}, type: "number", unit: "USD", required: true, smartDefault: 1000000, validation: { min: 0 }, helper: "", expertMeaning: "FX revenue", expertMeaning_i18n: {"en":"FX revenue","tr":"FX revenue"} },
    { id: "fxCost", label: "Döviz Gider", label_i18n: {"en":"Döviz Gider","tr":"Döviz Gider"}, type: "number", unit: "USD", required: true, smartDefault: 600000, validation: { min: 0 }, helper: "", expertMeaning: "FX cost", expertMeaning_i18n: {"en":"FX cost","tr":"FX cost"} },
    { id: "fxPair", label: "Döviz Çifti", label_i18n: {"en":"Döviz Çifti","tr":"Döviz Çifti"}, type: "select", unit: "", enumValues: ["USD/TRY", "EUR/USD", "EUR/TRY", "GBP/USD", "USD/JPY"], required: true, smartDefault: "USD/TRY", helper: "", expertMeaning: "Currency pair", expertMeaning_i18n: {"en":"Currency pair","tr":"Currency pair"} },
    ...
    { id: "hedgeRatio", label: "Hedge Oranı", label_i18n: {"en":"Hedge Oranı","tr":"Hedge Oranı"}, type: "number", unit: "", required: false, smartDefault: 0.5, validation: { min: 0, max: 1 }, helper: "", expertMeaning: "Hedge ratio", expertMeaning_i18n: {"en":"Hedge ratio","tr":"Hedge ratio"} },
    { id: "forwardPoints", label: "Forward Puanı", label_i18n: {"en":"Forward Puanı","tr":"Forward Puanı"}, type: "number", unit: "", required: false, smartDefault: 0.02, validation: { min: 0 }, helper: "", expertMeaning: "Forward premium/discount", expertMeaning_i18n: {"en":"Forward premium/discount","tr":"Forward premium/discount"} },
  ...
  outputs: [
    { id: "fxExposure", label: "Net Döviz Pozisyonu", label_i18n: {"en":"Net Döviz Pozisyonu","tr":"Net Döviz Pozisyonu"}, unit: "USD", format: "currency" },
    ...
    { id: "unhedgedVaR", label: "Hedge Edilmemiş VaR", label_i18n: {"en":"Hedge Edilmemiş VaR","tr":"Hedge Edilmemiş VaR"}, unit: "USD", format: "currency" },
