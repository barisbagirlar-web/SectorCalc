...
export const MACHINE_ECONOMIC_LIFE_SCHEMA: PremiumCalculatorSchema = {
  ...
  name: "Makine Ekonomik Ömrü Analizi", name_i18n: {"en":"Makine Ekonomik Ömrü Analizi","tr":"Makine Ekonomik Ömrü Analizi"}, sectorSlug: "cnc-manufacturing", category: "cost",
  ...
  inputs: [
    { id: "purchaseCost", label: "Satın Alma Maliyeti", label_i18n: {"en":"Satın Alma Maliyeti","tr":"Satın Alma Maliyeti"}, type: "number", unit: "USD", required: true, smartDefault: 150000, validation: { min: 1 }, helper: "", expertMeaning: "Initial purchase cost", expertMeaning_i18n: {"en":"Initial purchase cost","tr":"Initial purchase cost"} },
    { id: "residualValue", label: "Hurda/İkinci El Değeri", label_i18n: {"en":"Hurda/İkinci El Değeri","tr":"Hurda/İkinci El Değeri"}, type: "number", unit: "USD", required: true, smartDefault: 15000, validation: { min: 0 }, helper: "", expertMeaning: "Resale or scrap value", expertMeaning_i18n: {"en":"Resale or scrap value","tr":"Resale or scrap value"} },
    { id: "lifeYears", label: "Fiziksel Ömür (yıl)", label_i18n: {"en":"Fiziksel Ömür (yıl)","tr":"Fiziksel Ömür (yıl)"}, type: "number", unit: "yıl", required: true, smartDefault: 10, validation: { min: 1, max: 50 }, helper: "", expertMeaning: "Physical life in years", expertMeaning_i18n: {"en":"Physical life in years","tr":"Physical life in years"} },
    { id: "annualOperatingCost", label: "Yıllık İşletme Maliyeti", label_i18n: {"en":"Yıllık İşletme Maliyeti","tr":"Yıllık İşletme Maliyeti"}, type: "number", unit: "USD/yıl", required: true, smartDefault: 25000, validation: { min: 0 }, helper: "", expertMeaning: "Annual operating cost", expertMeaning_i18n: {"en":"Annual operating cost","tr":"Annual operating cost"} },
    { id: "discountRate", label: "İskonto Oranı", label_i18n: {"en":"İskonto Oranı","tr":"İskonto Oranı"}, type: "number", unit: "%", required: true, smartDefault: 12, validation: { min: 0, max: 100 }, helper: "", expertMeaning: "Discount rate for NPV", expertMeaning_i18n: {"en":"Discount rate for NPV","tr":"Discount rate for NPV"} },
    { id: "annualEnergy", label: "Yıllık Enerji Maliyeti", label_i18n: {"en":"Yıllık Enerji Maliyeti","tr":"Yıllık Enerji Maliyeti"}, type: "number", unit: "USD/yıl", required: false, smartDefault: 8000, validation: { min: 0 }, helper: "", expertMeaning: "Annual energy cost", expertMeaning_i18n: {"en":"Annual energy cost","tr":"Annual energy cost"} },
  ],
  outputs: [
    { id: "euacCapital", label: "EUAC (Sermaye)", label_i18n: {"en":"EUAC (Sermaye)","tr":"EUAC (Sermaye)"}, unit: "USD/yıl", format: "currency" },
    { id: "euacOperating", label: "EUAC (İşletme)", label_i18n: {"en":"EUAC (İşletme)","tr":"EUAC (İşletme)"}, unit: "USD/yıl", format: "currency" },
    { id: "totalEuac", label: "Toplam EUAC", label_i18n: {"en":"Toplam EUAC","tr":"Toplam EUAC"}, unit: "USD/yıl", format: "currency" },
    { id: "economicLife", label: "Ekonomik Ömür", label_i18n: {"en":"Ekonomik Ömür","tr":"Ekonomik Ömür"}, unit: "yıl", format: "number" },
  ],
