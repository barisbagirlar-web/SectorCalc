...
export const TRANSPORT_MODE_RISK_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "airTransitDays", label: "Hava Transit Süresi", label_i18n: {"en":"Air transit days","tr":"Hava Transit Süresi"}, type: "number", unit: "gün", required: true, smartDefault: 2, validation: { min: 0 }, helper: "", expertMeaning: "Air transit days", expertMeaning_i18n: {"en":"Air transit days","tr":"hava transit süresi"} },
    { id: "seaTransitDays", label: "Deniz Transit Süresi", label_i18n: {"en":"Sea transit days","tr":"Deniz Transit Süresi"}, type: "number", unit: "gün", required: true, smartDefault: 20, validation: { min: 0 }, helper: "", expertMeaning: "Sea transit days", expertMeaning_i18n: {"en":"Sea transit days","tr":"deniz transit süresi"} },
    { id: "roadTransitDays", label: "Kara Transit Süresi", label_i18n: {"en":"Road transit days","tr":"Kara Transit Süresi"}, type: "number", unit: "gün", required: true, smartDefault: 5, validation: { min: 0 }, helper: "", expertMeaning: "Road transit days", expertMeaning_i18n: {"en":"Road transit days","tr":"kara transit süresi"} },
    { id: "dailyCostOfDelay", label: "Gecikme Günlük Maliyeti", label_i18n: {"en":"Daily cost of delay","tr":"Gecikme Günlük Maliyeti"}, type: "number", unit: "USD/gün", required: false, smartDefault: 200, validation: { min: 0 }, helper: "", expertMeaning: "Daily cost of delay", expertMeaning_i18n: {"en":"Daily cost of delay","tr":"gecikme günlük maliyeti"} },
    { id: "cargoValue", label: "Kargo Değeri", label_i18n: {"en":"Total cargo value","tr":"Kargo Değeri"}, type: "number", unit: "USD", required: false, smartDefault: 100000, validation: { min: 0 }, helper: "", expertMeaning: "Total cargo value", expertMeaning_i18n: {"en":"Total cargo value","tr":"kargo değeri"} },
  ],
  outputs: [
    { id: "transportAir", label: "Hava Taşıma Maliyeti", label_i18n: {"en":"Hava Tasma Maliyeti","tr":"Hava Taşıma Maliyeti"}, unit: "USD", format: "currency" },
    { id: "transportSea", label: "Deniz Taşıma Maliyeti", label_i18n: {"en":"Deniz Tasma Maliyeti","tr":"Deniz Taşıma Maliyeti"}, unit: "USD", format: "currency" },
    { id: "transportRoad", label: "Kara Taşıma Maliyeti", label_i18n: {"en":"Kara Tasma Maliyeti","tr":"Kara Taşıma Maliyeti"}, unit: "USD", format: "currency" },
    { id: "transitTimeCost", label: "Transit Süre Maliyeti", label_i18n: {"en":"Transit Sure Maliyeti","tr":"Transit Süre Maliyeti"}, unit: "USD", format: "currency" },
