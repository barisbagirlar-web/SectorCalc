...
export const SMED_CHANGEOVER_OPTIMIZER_ANALYZER: PremiumCalculatorSchema = {
  ...
  name: "SMED Değişim Süresi Optimizasyonu", name_i18n: {"en":"SMED Değişim Süresi Optimizasyonu","tr":"SMED Değişim Süresi Optimizasyonu"}, sectorSlug: "cnc-manufacturing", category: "cost",
  ...
  inputs: [
    { id: "currentChangeoverTime", label: "Mevcut Değişim Süresi", label_i18n: {"en":"Mevcut Değişim Süresi","tr":"Mevcut Değişim Süresi"}, type: "number", unit: "dakika", required: true, smartDefault: 45, validation: { min: 1 }, helper: "", expertMeaning: "Current changeover time in minutes", expertMeaning_i18n: {"en":"Current changeover time in minutes","tr":"Current changeover time in minutes"} },
    { id: "changeoversPerMonth", label: "Aylık Değişim Sayısı", label_i18n: {"en":"Aylık Değişim Sayısı","tr":"Aylık Değişim Sayısı"}, type: "number", unit: "adet", required: true, smartDefault: 30, validation: { min: 1 }, helper: "", expertMeaning: "Changeovers per month", expertMeaning_i18n: {"en":"Changeovers per month","tr":"Changeovers per month"} },
    { id: "targetChangeoverTime", label: "Hedef Değişim Süresi", label_i18n: {"en":"Hedef Değişim Süresi","tr":"Hedef Değişim Süresi"}, type: "number", unit: "dakika", required: false, smartDefault: 15, validation: { min: 1 }, helper: "", expertMeaning: "Target changeover time after SMED", expertMeaning_i18n: {"en":"Target changeover time after SMED","tr":"Target changeover time after SMED"} },
    ...
    { id: "operatorCount", label: "Operatör Sayısı", label_i18n: {"en":"Operatör Sayısı","tr":"Operatör Sayısı"}, type: "number", unit: "adet", required: false, smartDefault: 2, validation: { min: 1 }, helper: "", expertMeaning: "Operators during changeover", expertMeaning_i18n: {"en":"Operators during changeover","tr":"Operators during changeover"} },
  ...
  outputs: [
    { id: "capacityRecovered", label: "Kazanılan Kapasite", label_i18n: {"en":"Kazanılan Kapasite","tr":"Kazanılan Kapasite"}, unit: "saat/yıl", format: "number", isBigNumber: true },
    { id: "financialGain", label: "Finansal Kazanç", label_i18n: {"en":"Finansal Kazanç","tr":"Finansal Kazanç"}, unit: "USD/yıl", format: "currency" },
    { id: "roi", label: "Yatırım Getirisi (ROI)", label_i18n: {"en":"Yatırım Getirisi (ROI)","tr":"Yatırım Getirisi (ROI)"}, unit: "%", format: "percentage" },
  ],
