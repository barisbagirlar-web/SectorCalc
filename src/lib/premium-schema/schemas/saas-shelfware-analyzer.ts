...
export const SAAS_SHELFWARE_ANALYZER: PremiumCalculatorSchema = {
  ...
  name: "SaaS Shelfware Analizi", name_i18n: {"en":"SaaS Shelfware Analizi","tr":"SaaS Shelfware Analizi"}, sectorSlug: "financial-planning", category: "cost",
  painStatement: "Kullanılmayan veya eksik kullanılan SaaS lisansları bütçede görünmeyen büyük bir kayıp oluşturur ve şirketler yıllık lisans maliyetinin %30'una kadarını boşa harcar.", painStatement_i18n: {"en":"Kullanılmayan veya eksik kullanılan SaaS lisansları bütçede görünmeyen büyük bir kayıp oluşturur ve şirketler yıllık lisans maliyetinin %30'una kadarını boşa harcar.","tr":"Kullanılmayan veya eksik kullanılan SaaS lisansları bütçede görünmeyen büyük bir kayıp oluşturur ve şirketler yıllık lisans maliyetinin %30'una kadarını boşa harcar."},
  inputs: [
  ...
  outputs: [
    { id: "shelfwarePct", label: "Shelfware Oranı", label_i18n: {"en":"Shelfware Oranı","tr":"Shelfware Oranı"}, unit: "%", format: "percentage" },
  ...
  thresholds: [{ fieldId: "shelfwarePct", warning: 20, critical: 40, direction: "higher_is_bad", warningMessage: "Shelfware oranı >%20 — lisans optimizasyonu önerilir.", warningMessage_i18n: {"en":"Shelfware oranı >%20 — lisans optimizasyonu önerilir.","tr":"Shelfware oranı >%20 — lisans optimizasyonu önerilir."}, criticalMessage: "Shelfware oranı >%40 — acil lisans denetimi ve iptal gerekli.", criticalMessage_i18n: {"en":"Shelfware oranı >%40 — acil lisans denetimi ve iptal gerekli.","tr":"Shelfware oranı >%40 — acil lisans denetimi ve iptal gerekli."} }],
  formulaPipeline: [
  ...
  reportTemplate: { title: "SaaS Shelfware Raporu", title_i18n: {"en":"SaaS Shelfware Raporu","tr":"SaaS Shelfware Raporu"}, sections: ["executive_summary", "loss_breakdown", "thresholds", "action_plan", "assumptions"], exportFormats: ["pdf", "excel"] },
  assumptions: { hiddenLossMultiplier: 1.1, volatilityPercent: 10, targetMarginPercent: 15, assumptionNotes: ["Shelfware % = (lisans − aktif) / lisans × 100.", "Maliyet = (lisans − aktif) × koltuk maliyeti × 12.", "Düşük kullanım eşiği altındaki kullanıcılar shelfware kabul edilir."],assumptionNotes_i18n:[{"en":"Shelfware % = (lisans − aktif) / lisans × 100.","tr":"Shelfware % = (lisans − aktif) / lisans × 100."},{"en":"Maliyet = (lisans − aktif) × koltuk maliyeti × 12.","tr":"Maliyet = (lisans − aktif) × koltuk maliyeti × 12."},{"en":"Düşük kullanım eşiği altındaki kullanıcılar shelfware kabul edilir.","tr":"Düşük kullanım eşiği altındaki kullanıcılar shelfware kabul edilir."}] },
};
