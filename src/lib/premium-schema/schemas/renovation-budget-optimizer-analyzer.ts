...
export const RENOVATION_BUDGET_SCHEMA: PremiumCalculatorSchema = {
  ...
  painStatement: "Yenileme projelerinde bütçe planlaması yapılmazsa beklenmeyen maliyet aşımları ve düşük yatırım getirisi oluşur. Her kalemin optimize edilmesi gerekir.", painStatement_i18n: {"en":"Without budget planning in renovation projects, unexpected cost overruns and low investment returns occur. Each item needs to be optimized.","tr":"Yenileme projelerinde bütçe planlaması yapılmazsa beklenmeyen maliyet aşımları ve düşük yatırım getirisi oluşur. Her kalemin optimize edilmesi gerekir."},
  inputs: [
