...
export const PersonelDevamsizlikMaliyetiHesaplama_SCHEMA: PremiumCalculatorSchema = {
  id: "personel-devamsizlik-maliyeti-hesaplama",
  name: "Personel Devamsızlık Maliyeti Calculation",
