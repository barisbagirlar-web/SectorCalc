...
export const HVAC_CAPACITY_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "deltaTemp", label: "Sıcaklık Farkı (ΔT)", label_i18n: {"en":"Sıcaklık Farkı (ΔT)","tr":"Sıcaklık Farkı (ΔT)"}, type: "number", unit: "°F", required: true, smartDefault: 20, validation: { min: 0.1 }, helper: "", expertMeaning: "Temperature difference", expertMeaning_i18n: {"en":"Temperature difference","tr":"Temperature difference"} },
    { id: "deltaHumidity", label: "Nem Farkı (ΔW)", label_i18n: {"en":"Nem Farkı (ΔW)","tr":"Nem Farkı (ΔW)"}, type: "number", unit: "gr/lb", required: false, smartDefault: 30, validation: { min: 0 }, helper: "", expertMeaning: "Humidity ratio difference", expertMeaning_i18n: {"en":"Humidity ratio difference","tr":"Humidity ratio difference"} },
    { id: "eer", label: "EER (Enerji Verimlilik Oranı)", label_i18n: {"en":"EER (Enerji Verimlilik Oranı)","tr":"EER (Enerji Verimlilik Oranı)"}, type: "number", unit: "BTU/W", required: true, smartDefault: 12, validation: { min: 1 }, helper: "", expertMeaning: "Energy Efficiency Ratio", expertMeaning_i18n: {"en":"Energy Efficiency Ratio","tr":"Energy Efficiency Ratio"} },
    { id: "operatingHours", label: "Yıllık Çalışma Saati", label_i18n: {"en":"Yıllık Çalışma Saati","tr":"Yıllık Çalışma Saati"}, type: "number", unit: "saat/yıl", required: false, smartDefault: 2000, validation: { min: 0 }, helper: "", expertMeaning: "Annual operating hours", expertMeaning_i18n: {"en":"Annual operating hours","tr":"Annual operating hours"} },
  ...
  outputs: [
    { id: "sensible", label: "Duyulur Isı", label_i18n: {"en":"Duyulur Isı","tr":"Duyulur Isı"}, unit: "BTU/saat", format: "number" },
    { id: "totalBtu", label: "Toplam Isı Yükü", label_i18n: {"en":"Toplam Isı Yükü","tr":"Toplam Isı Yükü"}, unit: "BTU/saat", format: "number" },
    { id: "tons", label: "Kapasite (Ton)", label_i18n: {"en":"Kapasite (Ton)","tr":"Kapasite (Ton)"}, unit: "ton", format: "number" },
    { id: "annualCost", label: "Yıllık Enerji Maliyeti", label_i18n: {"en":"Yıllık Enerji Maliyeti","tr":"Yıllık Enerji Maliyeti"}, unit: "USD/yıl", format: "currency", isBigNumber: true },
  ],
