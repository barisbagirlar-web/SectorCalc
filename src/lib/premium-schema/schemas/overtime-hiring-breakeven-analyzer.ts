...
export const OVERTIME_HIRING_BREAKEVEN_SCHEMA: PremiumCalculatorSchema = {
  ...
  name: "Fazla Mesai vs İşe Alma Başabaş", name_i18n: {"en":"Fazla Mesai vs ise Alma Basabas","tr":"Fazla Mesai vs İşe Alma Başabaş"}, sectorSlug: "cnc-manufacturing", category: "cost",
  ...
  inputs: [
    ...
    { id: "hiringCost", label: "İşe Alma Maliyeti", label_i18n: {"en":"Total hiring cost per worker","tr":"İşe Alma Maliyeti"}, type: "number", unit: "USD", required: true, smartDefault: 3500, validation: { min: 1 }, helper: "", expertMeaning: "Total hiring cost per worker", expertMeaning_i18n: {"en":"Total hiring cost per worker","tr":"i̇şe alma maliyeti"} },
  ...
  outputs: [
    ...
    { id: "hiringTotalCost", label: "Toplam İşe Alma Maliyeti", label_i18n: {"en":"Toplam Ise Alma Maliyeti","tr":"Toplam İşe Alma Maliyeti"}, unit: "USD", format: "currency" },
    { id: "annualNewHireCost", label: "Yıllık Yeni İşçi Maliyeti", label_i18n: {"en":"Yllk Yeni Isci Maliyeti","tr":"Yıllık Yeni İşçi Maliyeti"}, unit: "USD/yıl", format: "currency" },
    { id: "breakevenHours", label: "Başabaş Eşik Saati", label_i18n: {"en":"Basabas Esik Saati","tr":"Başabaş Eşik Saati"}, unit: "saat/ay", format: "number", isBigNumber: true },
