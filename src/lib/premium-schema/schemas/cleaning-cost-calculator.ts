...
export const CleaningCostCalculator_SCHEMA: PremiumCalculatorSchema = {
  id: "cleaning-cost-calculator",
  name: "Cleaning Cost Calculator",
  sectorSlug: "general-industrial",
  category: "cost",
  painStatement: "Standard construction and field service cost estimation (RSMeans, ASTM E2516)",
  ...
  assumptions: {
    ...
    assumptionNotes: [
      ...
      "Labor hours are direct labor only",
