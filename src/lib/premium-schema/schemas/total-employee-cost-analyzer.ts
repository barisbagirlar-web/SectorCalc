...
export const TOTAL_EMPLOYEE_COST_SCHEMA: PremiumCalculatorSchema = {
  ...
  name: "Toplam Çalışan Maliyeti Analizi", name_i18n: {"en":"Toplam Çalışan Maliyeti Analizi","tr":"Toplam Çalışan Maliyeti Analizi"}, sectorSlug: "financial-planning", category: "cost",
  ...
  inputs: [
    { id: "numEmployees", label: "Çalışan Sayısı", label_i18n: {"en":"Çalışan Sayısı","tr":"Çalışan Sayısı"}, type: "number", unit: "kişi", required: true, smartDefault: 50, validation: { min: 1 }, helper: "", expertMeaning: "Number of employees", expertMeaning_i18n: {"en":"Number of employees","tr":"Number of employees"} },
    { id: "avgGrossSalary", label: "Ortalama Brüt Maaş", label_i18n: {"en":"Ortalama Brüt Maaş","tr":"Ortalama Brüt Maaş"}, type: "number", unit: "USD/ay", required: true, smartDefault: 2500, validation: { min: 1 }, helper: "", expertMeaning: "Average monthly gross salary", expertMeaning_i18n: {"en":"Average monthly gross salary","tr":"Average monthly gross salary"} },
    { id: "employerPayrollTax", label: "İşveren Payı Oranı", label_i18n: {"en":"İşveren Payı Oranı","tr":"İşveren Payı Oranı"}, type: "number", unit: "%", required: true, smartDefault: 22, validation: { min: 0, max: 100 }, helper: "", expertMeaning: "Employer payroll tax rate", expertMeaning_i18n: {"en":"Employer payroll tax rate","tr":"Employer payroll tax rate"} },
    { id: "benefitsCostPerEmployee", label: "Yan Haklar (Çalışan Başına)", label_i18n: {"en":"Yan Haklar (Çalışan Başına)","tr":"Yan Haklar (Çalışan Başına)"}, type: "number", unit: "USD/ay", required: true, smartDefault: 400, validation: { min: 0 }, helper: "", expertMeaning: "Monthly benefits per employee", expertMeaning_i18n: {"en":"Monthly benefits per employee","tr":"Monthly benefits per employee"} },
    { id: "trainingCostPerEmployee", label: "Eğitim Maliyeti (Çalışan Başına)", label_i18n: {"en":"Eğitim Maliyeti (Çalışan Başına)","tr":"Eğitim Maliyeti (Çalışan Başına)"}, type: "number", unit: "USD/yıl", required: false, smartDefault: 500, validation: { min: 0 }, helper: "", expertMeaning: "Annual training cost per employee", expertMeaning_i18n: {"en":"Annual training cost per employee","tr":"Annual training cost per employee"} },
    { id: "avgWorkHoursPerMonth", label: "Aylık Çalışma Saati", label_i18n: {"en":"Aylık Çalışma Saati","tr":"Aylık Çalışma Saati"}, type: "number", unit: "saat/ay", required: false, smartDefault: 176, validation: { min: 1 }, helper: "", expertMeaning: "Average monthly work hours", expertMeaning_i18n: {"en":"Average monthly work hours","tr":"Average monthly work hours"} },
  ],
  outputs: [
    { id: "totalEmployeeCost", label: "Toplam Çalışan Maliyeti", label_i18n: {"en":"Toplam Çalışan Maliyeti","tr":"Toplam Çalışan Maliyeti"}, unit: "USD/ay", format: "currency", isBigNumber: true },
    { id: "employeeCostPerHour", label: "Çalışan Saatlik Maliyeti", label_i18n: {"en":"Çalışan Saatlik Maliyeti","tr":"Çalışan Saatlik Maliyeti"}, unit: "USD/saat", format: "currency" },
  ],
