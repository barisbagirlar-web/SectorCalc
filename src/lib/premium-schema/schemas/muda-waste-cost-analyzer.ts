...
export const MUDA_WASTE_COST_SCHEMA: PremiumCalculatorSchema = {
  ...
  name: "Muda Atık Maliyet Analizi", name_i18n: {"en":"Muda Atık Maliyet Analizi","tr":"Muda Atık Maliyet Analizi"}, sectorSlug: "quality", category: "cost",
  ...
  inputs: [
    { id: "overproductionCost", label: "Aşırı Üretim Maliyeti", label_i18n: {"en":"Aşırı Üretim Maliyeti","tr":"Aşırı Üretim Maliyeti"}, type: "number", unit: "USD/yıl", required: true, smartDefault: 25000, validation: { min: 0 }, helper: "", expertMeaning: "Overproduction waste cost", expertMeaning_i18n: {"en":"Overproduction waste cost","tr":"Overproduction waste cost"} },
    { id: "waitingCost", label: "Bekleme Maliyeti", label_i18n: {"en":"Bekleme Maliyeti","tr":"Bekleme Maliyeti"}, type: "number", unit: "USD/yıl", required: true, smartDefault: 15000, validation: { min: 0 }, helper: "", expertMeaning: "Waiting waste cost", expertMeaning_i18n: {"en":"Waiting waste cost","tr":"Waiting waste cost"} },
    { id: "transportCost", label: "Gereksiz Taşıma Maliyeti", label_i18n: {"en":"Gereksiz Taşıma Maliyeti","tr":"Gereksiz Taşıma Maliyeti"}, type: "number", unit: "USD/yıl", required: true, smartDefault: 12000, validation: { min: 0 }, helper: "", expertMeaning: "Unnecessary transport cost", expertMeaning_i18n: {"en":"Unnecessary transport cost","tr":"Unnecessary transport cost"} },
    { id: "overprocessingCost", label: "Gereksiz İşlem Maliyeti", label_i18n: {"en":"Gereksiz İşlem Maliyeti","tr":"Gereksiz İşlem Maliyeti"}, type: "number", unit: "USD/yıl", required: true, smartDefault: 10000, validation: { min: 0 }, helper: "", expertMeaning: "Overprocessing waste cost", expertMeaning_i18n: {"en":"Overprocessing waste cost","tr":"Overprocessing waste cost"} },
    { id: "inventoryCost", label: "Fazla Stok Maliyeti", label_i18n: {"en":"Fazla Stok Maliyeti","tr":"Fazla Stok Maliyeti"}, type: "number", unit: "USD/yıl", required: true, smartDefault: 20000, validation: { min: 0 }, helper: "", expertMeaning: "Excess inventory cost", expertMeaning_i18n: {"en":"Excess inventory cost","tr":"Excess inventory cost"} },
    { id: "motionCost", label: "Gereksiz Hareket Maliyeti", label_i18n: {"en":"Gereksiz Hareket Maliyeti","tr":"Gereksiz Hareket Maliyeti"}, type: "number", unit: "USD/yıl", required: true, smartDefault: 8000, validation: { min: 0 }, helper: "", expertMeaning: "Unnecessary motion cost", expertMeaning_i18n: {"en":"Unnecessary motion cost","tr":"Unnecessary motion cost"} },
    { id: "defectCost", label: "Hata/Defo Maliyeti", label_i18n: {"en":"Hata/Defo Maliyeti","tr":"Hata/Defo Maliyeti"}, type: "number", unit: "USD/yıl", required: true, smartDefault: 30000, validation: { min: 0 }, helper: "", expertMeaning: "Defect/rework cost", expertMeaning_i18n: {"en":"Defect/rework cost","tr":"Defect/rework cost"} },
  ],
  outputs: [
