...
export const MUDA_WASTE_COST_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "inventoryCost", label: "Fazla Stok Maliyeti", label_i18n: {"en":"Excess Inventory Cost","tr":"Fazla Stok Maliyeti", type: "number", unit: "USD/yıl", required: true, smartDefault: 20000, validation: { min: 0 }, helper: "", expertMeaning: "Excess inventory cost", expertMeaning_i18n: {"en":"Excess inventory cost","tr":"Excess inventory cost" },
    ...
    { id: "defectCost", label: "Hata/Defo Maliyeti", label_i18n: {"en":"Defect/Rework Cost","tr":"Hata/Defo Maliyeti", type: "number", unit: "USD/yıl", required: true, smartDefault: 30000, validation: { min: 0 }, helper: "", expertMeaning: "Defect/rework cost", expertMeaning_i18n: {"en":"Defect/rework cost","tr":"Defect/rework cost" },
  ],
  outputs: [
