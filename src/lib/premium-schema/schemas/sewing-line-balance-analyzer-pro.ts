...
export const SEWING_LINE_BALANCE_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "availableTime", label: "Vardiya Süresi", label_i18n: {"en":"Shift Duration","tr":"Vardiya Süresi"}, type: "number", unit: "dak", required: true, smartDefault: 450, validation: { min: 1 }, helper: "", expertMeaning: "Available shift minutes", expertMeaning_i18n: {"en":"Available shift minutes","tr":"Available shift minutes"} },
    ...
    { id: "operatorCount", label: "Operatör Sayısı", label_i18n: {"en":"Number of Operators","tr":"Operatör Sayısı"}, type: "number", unit: "", required: false, smartDefault: 5, validation: { min: 1 }, helper: "", expertMeaning: "Number of operators", expertMeaning_i18n: {"en":"Number of operators","tr":"Number of operators"} },
    { id: "targetEfficiency", label: "Hedef Verim", label_i18n: {"en":"Hedef Verim","tr":"Hedef Verim"}, type: "number", unit: "%", required: false, smartDefault: 85, validation: { min: 0, max: 100 }, helper: "", expertMeaning: "Target line efficiency", expertMeaning_i18n: {"en":"Target line efficiency","tr":"Hedef hat verimliliği"} },
    { id: "defectRate", label: "Hata Oranı", label_i18n: {"en":"Defect Rate","tr":"Hata Oranı"}, type: "number", unit: "%", required: false, smartDefault: 3, validation: { min: 0, max: 100 }, helper: "", expertMeaning: "Defect rate", expertMeaning_i18n: {"en":"Defect rate","tr":"Defect rate"} },
