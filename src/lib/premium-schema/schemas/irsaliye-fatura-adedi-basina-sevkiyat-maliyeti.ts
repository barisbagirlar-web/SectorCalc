...
export const IrsaliyeFaturaAdediBasinaSevkiyatMaliyeti_SCHEMA: PremiumCalculatorSchema = {
  id: "irsaliye-fatura-adedi-basina-sevkiyat-maliyeti",
  name: "İrsaliye — Fatura Adedi Başına Sevkiyat Maliyeti",
  sectorSlug: "general-industrial",
  category: "cost",
  painStatement: "Logistics cost accounting standard",
  ...
  assumptions: {
    ...
    assumptionNotes: [
      "Average speed is assumed constant at 60 km/h for driver time calculation",
