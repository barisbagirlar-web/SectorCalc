...
export const REPAIR_SHOP_QUOTE_SCHEMA: PremiumCalculatorSchema = {
  ...
  name: "Tamirhane Parça Teklif Analizi", name_i18n: {"en":"Tamirhane Parça Teklif Analizi","tr":"Tamirhane Parça Teklif Analizi"}, sectorSlug: "financial-planning", category: "cost",
  painStatement: "Tamirhane tekliflerinde işçilik, parça ve kar marjı şeffaf olmadığında maliyet kontrolü kaybolur.", painStatement_i18n: {"en":"Tamirhane tekliflerinde işçilik, parça ve kar marjı şeffaf olmadığında maliyet kontrolü kaybolur.","tr":"Tamirhane tekliflerinde işçilik, parça ve kar marjı şeffaf olmadığında maliyet kontrolü kaybolur."},
  inputs: [
  ...
  thresholds: [{ fieldId: "grossProfitPct", warning: 30, critical: 15, direction: "lower_is_bad", warningMessage: "Kar marjı < %30 — maliyet yapısı gözden geçirilmeli.", warningMessage_i18n: {"en":"Kar marjı < %30 — maliyet yapısı gözden geçirilmeli.","tr":"Kar marjı < %30 — maliyet yapısı gözden geçirilmeli."}, criticalMessage: "Kar marjı < %15 — teklif zarar ediyor olabilir.", criticalMessage_i18n: {"en":"Kar marjı < %15 — teklif zarar ediyor olabilir.","tr":"Kar marjı < %15 — teklif zarar ediyor olabilir."} }],
  formulaPipeline: [
