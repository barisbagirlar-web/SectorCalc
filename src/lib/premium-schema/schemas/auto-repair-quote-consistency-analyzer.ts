...
export const AUTO_REPAIR_QUOTE_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    { id: "quote1Total", label: "Teklif 1 Toplam", label_i18n: {"en":"Quote 1 Total","tr":"Teklif 1 Toplam"}, type: "number", unit: "USD", required: true, smartDefault: 850, validation: { min: 0 }, helper: "", expertMeaning: "Quote 1 total amount", expertMeaning_i18n: {"en":"Quote 1 total amount","tr":"Teklif 1 toplam tutarı"} },
    { id: "quote2Total", label: "Teklif 2 Toplam", label_i18n: {"en":"Quote 2 Total","tr":"Teklif 2 Toplam"}, type: "number", unit: "USD", required: true, smartDefault: 950, validation: { min: 0 }, helper: "", expertMeaning: "Quote 2 total amount", expertMeaning_i18n: {"en":"Quote 2 total amount","tr":"Teklif 2 toplam tutarı"} },
    { id: "quote3Total", label: "Teklif 3 Toplam", label_i18n: {"en":"Quote 3 Total","tr":"Teklif 3 Toplam"}, type: "number", unit: "USD", required: true, smartDefault: 900, validation: { min: 0 }, helper: "", expertMeaning: "Quote 3 total amount", expertMeaning_i18n: {"en":"Quote 3 total amount","tr":"Teklif 3 toplam tutarı"} },
    { id: "partQuotedPrice", label: "Parça Teklif Fiyatı", label_i18n: {"en":"Part Quote Price","tr":"Parça Teklif Fiyatı"}, type: "number", unit: "USD", required: true, smartDefault: 320, validation: { min: 0 }, helper: "", expertMeaning: "Quoted part price", expertMeaning_i18n: {"en":"Quoted part price","tr":"Teklif edilen parça fiyatı"} },
    { id: "partMarketPrice", label: "Parça Piyasa Fiyatı", label_i18n: {"en":"Part Market Price","tr":"Parça Piyasa Fiyatı"}, type: "number", unit: "USD", required: true, smartDefault: 300, validation: { min: 0 }, helper: "", expertMeaning: "Market average part price", expertMeaning_i18n: {"en":"Market average part price","tr":"Piyasa ortalama parça fiyatı"} },
    { id: "partsQuantity", label: "Parça Miktarı", label_i18n: {"en":"Part Quantity","tr":"Parça Miktarı"}, type: "number", unit: "adet", required: false, smartDefault: 1, validation: { min: 1 }, helper: "", expertMeaning: "Number of parts", expertMeaning_i18n: {"en":"Number of parts","tr":"Parça sayısı"} },
    { id: "quotedLaborHours", label: "Teklif Edilen İşçilik Saati", label_i18n: {"en":"Quoted Labor Hours","tr":"Teklif Edilen İşçilik Saati"}, type: "number", unit: "saat", required: true, smartDefault: 3.5, validation: { min: 0 }, helper: "", expertMeaning: "Quoted labor hours", expertMeaning_i18n: {"en":"Quoted labor hours","tr":"Teklif edilen işçilik saati"} },
    { id: "standardLaborHours", label: "Standart İşçilik Saati", label_i18n: {"en":"Standard Labor Hours","tr":"Standart İşçilik Saati"}, type: "number", unit: "saat", required: true, smartDefault: 3, validation: { min: 0 }, helper: "", expertMeaning: "Standard labor hours per job", expertMeaning_i18n: {"en":"Standard labor hours per job","tr":"İş başına standart işçilik saati"} },
