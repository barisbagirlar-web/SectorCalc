...
export const RECIPE_COST_CHECK_ANALYZER_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "ingredientCostPerKg", label: "İçindekiler Birim Maliyeti", label_i18n: {"en":"Ingredient Unit Cost","tr":"İçindekiler Birim Maliyeti"}, type: "number", unit: "USD/kg", required: true, smartDefault: 8.5, validation: { min: 0.01 }, helper: "", expertMeaning: "Ingredient cost per kg", expertMeaning_i18n: {"en":"Ingredient cost per kg","tr":"Ingredient cost per kg"} },
