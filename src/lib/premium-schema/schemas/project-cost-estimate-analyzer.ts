...
export const PROJECT_COST_ESTIMATE_ANALYZER_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    { id: "directLabor", label: "Direkt İşçilik", label_i18n: {"en":"Direct Labor","tr":"Direkt İşçilik"}, type: "number", unit: "USD", required: true, smartDefault: 150000, validation: { min: 0 }, helper: "", expertMeaning: "Direct labor costs", expertMeaning_i18n: {"en":"Direct labor costs","tr":"Direkt işçilik maliyetleri"} },
    { id: "directMaterial", label: "Direkt Malzeme", label_i18n: {"en":"Direct Material","tr":"Direkt Malzeme"}, type: "number", unit: "USD", required: true, smartDefault: 350000, validation: { min: 0 }, helper: "", expertMeaning: "Direct material costs", expertMeaning_i18n: {"en":"Direct material costs","tr":"Direkt malzeme maliyetleri"} },
    { id: "equipment", label: "Ekipman", label_i18n: {"en":"Equipment","tr":"Ekipman"}, type: "number", unit: "USD", required: true, smartDefault: 100000, validation: { min: 0 }, helper: "", expertMeaning: "Equipment costs", expertMeaning_i18n: {"en":"Equipment costs","tr":"Ekipman maliyetleri"} },
    { id: "subcontractor", label: "Taşeron", label_i18n: {"en":"Subcontractor","tr":"Taşeron"}, type: "number", unit: "USD", required: true, smartDefault: 200000, validation: { min: 0 }, helper: "", expertMeaning: "Subcontractor costs", expertMeaning_i18n: {"en":"Subcontractor costs","tr":"Taşeron maliyetleri"} },
    { id: "overheadPercent", label: "Genel Gider Oranı", label_i18n: {"en":"Overhead Rate","tr":"Genel Gider Oranı"}, type: "number", unit: "%", required: true, smartDefault: 15, validation: { min: 0, max: 50 }, helper: "", expertMeaning: "Overhead percentage", expertMeaning_i18n: {"en":"Overhead percentage","tr":"Genel gider yüzdesi"} },
    { id: "contingencyPercent", label: "Beklenmeyen Gider Oranı", label_i18n: {"en":"Contingency Rate","tr":"Beklenmeyen Gider Oranı"}, type: "number", unit: "%", required: false, smartDefault: 10, validation: { min: 0, max: 50 }, helper: "", expertMeaning: "Contingency percentage", expertMeaning_i18n: {"en":"Contingency percentage","tr":"Beklenmeyen gider yüzdesi"} },
    { id: "actualCost", label: "Gerçekleşen Maliyet", label_i18n: {"en":"Actual Cost","tr":"Gerçekleşen Maliyet"}, type: "number", unit: "USD", required: false, smartDefault: 900000, validation: { min: 0 }, helper: "", expertMeaning: "Actual cost incurred", expertMeaning_i18n: {"en":"Actual cost incurred","tr":"Gerçekleşen maliyet"} },
  ],
  outputs: [
    { id: "projectDirectLabor", label: "Direkt İşçilik", label_i18n: {"en":"Direct Labor","tr":"Direkt İşçilik"}, unit: "USD", format: "currency" },
    { id: "projectDirectMaterial", label: "Direkt Malzeme", label_i18n: {"en":"Direct Material","tr":"Direkt Malzeme"}, unit: "USD", format: "currency" },
    { id: "projectEquipment", label: "Ekipman", label_i18n: {"en":"Equipment","tr":"Ekipman"}, unit: "USD", format: "currency" },
