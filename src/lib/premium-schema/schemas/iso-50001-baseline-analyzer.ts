...
export const ISO50001_BASELINE_SCHEMA: PremiumCalculatorSchema = {
  ...
  name: "ISO 50001 Enerji Baz Çizgisi & CUSUM Analizi", name_i18n: {"en":"ISO 50001 Energy Baseline & CUSUM Analysis","tr":"ISO 50001 Enerji Baz Çizgisi & CUSUM Analizi"}, sectorSlug: "sheet-metal", category: "energy",
  painStatement: "ISO 50001 kapsamında EnPI ve CUSUM analizi yapılmadan enerji performansı izlenemez ve iyileştirme kanıtlanamaz.", painStatement_i18n: {"en":"Without EnPI and CUSUM analysis under ISO 50001, energy performance cannot be monitored and improvement cannot be verified.","tr":"ISO 50001 kapsamında EnPI ve CUSUM analizi yapılmadan enerji performansı izlenemez ve iyileştirme kanıtlanamaz."},
  inputs: [
  ...
  outputs:  [
    { id: "enpi", label: "EnPI (Enerji Yoğunluğu)", label_i18n: {"en":"EnPI (Energy Intensity)","tr":"EnPI (Enerji Yoğunluğu)"}, unit: "kWh/ton", format: "number" },
    { id: "cusum", label: "CUSUM (Gerçek-Tahmin)", label_i18n: {"en":"CUSUM (Actual-Predicted)","tr":"CUSUM (Gerçek-Tahmin)"}, unit: "kWh", format: "number" },
    { id: "savings", label: "Enerji Tasarrufu", label_i18n: {"en":"Energy Savings","tr":"Enerji Tasarrufu"}, unit: "kWh/yıl", format: "number", isBigNumber: true },
  ],
  thresholds: [{ fieldId: "enpi", warning: 550, critical: 650, direction: "higher_is_bad", warningMessage: "EnPI > 550 — enerji yoğunluğu yüksek, iyileştirme fırsatı var.", warningMessage_i18n: {"en":"EnPI > 550 — energy intensity high, improvement opportunity exists.","tr":"EnPI > 550 — enerji yoğunluğu yüksek, iyileştirme fırsatı var."}, criticalMessage: "EnPI > 650 — enerji verimliliği kritik seviyede.", criticalMessage_i18n: {"en":"EnPI > 650 — energy efficiency at critical level.","tr":"EnPI > 650 — enerji verimliliği kritik seviyede."} }],
  formulaPipeline: [
