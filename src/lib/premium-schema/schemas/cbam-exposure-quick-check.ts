  ...
  inputs: [
    {
      ...
      smartDefault: 120,
      validation: { min: 0 },
      helper: "Embedded emissions tonnage for the shipment or batch.",
      expertMeaning: "Product embedded emissions before CBAM adjustment.",
    },
    {
      ...
      smartDefault: 85,
      validation: { min: 0 },
      helper: "Assumed CBAM certificate price per tonne.",
      expertMeaning: "Reference certificate price assumption.",
    },
    {
      id: "eurTryRate",
      label: "EUR/TRY rate",
      ...
      smartDefault: 35,
      validation: { min: 0.01 },
      helper: "Exchange rate used to convert EUR exposure to TRY.",
      expertMeaning: "FX assumption for local currency exposure.",
    },
    {
      id: "productQuantity",
      ...
      smartDefault: 1000,
      validation: { min: 1 },
      helper: "Units in the shipment or production batch.",
      expertMeaning: "Quantity denominator for unit CBAM cost.",
    },
    {
      id: "adminCost",
      label: "Admin cost",
      ...
      smartDefault: 2500,
      validation: { min: 0 },
      helper: "Documentation and compliance admin overhead.",
      expertMeaning: "Flat admin cost added to certificate exposure.",
    },
  ],
