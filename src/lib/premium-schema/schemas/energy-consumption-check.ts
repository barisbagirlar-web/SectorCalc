...
export const EnergyConsumptionCheck_SCHEMA: PremiumCalculatorSchema = {
  id: "energy-consumption-check",
  name: "Energy Consumption Check",
  sectorSlug: "general-industrial",
  category: "energy",
  painStatement: "Industrial energy management and cost accounting",
  ...
  assumptions: {
    ...
    assumptionNotes: [
      ...
      "No seasonal variation in consumption",
    ],
  },
};
