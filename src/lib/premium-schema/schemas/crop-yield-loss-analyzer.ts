...
export const CROP_YIELD_LOSS_SCHEMA: PremiumCalculatorSchema = {
  ...
  name: "Mahsul Verim Kaybı Analizörü", name_i18n: {"en":"Mahsul Verim Kaybı Analizörü","tr":"Mahsul Verim Kaybı Analizörü"}, sectorSlug: "food", category: "measurement",
  ...
  inputs: [
    ...
    { id: "envFactor", label: "Çevre Faktörü", label_i18n: {"en":"Çevre Faktörü","tr":"Çevre Faktörü"}, type: "number", unit: "", required: false, smartDefault: 0.8, validation: { min: 0, max: 1 }, helper: "", expertMeaning: "Environment factor", expertMeaning_i18n: {"en":"Environment factor","tr":"Environment factor"} },
    ...
    { id: "pestLossPct", label: "Zararlı Kaybı", label_i18n: {"en":"Zararlı Kaybı","tr":"Zararlı Kaybı"}, type: "number", unit: "%", required: false, smartDefault: 5, validation: { min: 0, max: 100 }, helper: "", expertMeaning: "Pest damage percentage", expertMeaning_i18n: {"en":"Pest damage percentage","tr":"Pest damage percentage"} },
    { id: "weatherLossPct", label: "Hava Kaybı", label_i18n: {"en":"Hava Kaybı","tr":"Hava Kaybı"}, type: "number", unit: "%", required: false, smartDefault: 8, validation: { min: 0, max: 100 }, helper: "", expertMeaning: "Weather stress percentage", expertMeaning_i18n: {"en":"Weather stress percentage","tr":"Weather stress percentage"} },
    { id: "nutrientLossPct", label: "Besin Kaybı", label_i18n: {"en":"Besin Kaybı","tr":"Besin Kaybı"}, type: "number", unit: "%", required: false, smartDefault: 7, validation: { min: 0, max: 100 }, helper: "", expertMeaning: "Nutrient deficiency", expertMeaning_i18n: {"en":"Nutrient deficiency","tr":"Nutrient deficiency"} },
    { id: "marketPrice", label: "Piyasa Fiyatı", label_i18n: {"en":"Piyasa Fiyatı","tr":"Piyasa Fiyatı"}, type: "number", unit: "USD/kg", required: true, smartDefault: 2.5, validation: { min: 0 }, helper: "", expertMeaning: "Market price", expertMeaning_i18n: {"en":"Market price","tr":"Market price"} },
    { id: "interventionCost", label: "Müdahale Maliyeti", label_i18n: {"en":"Müdahale Maliyeti","tr":"Müdahale Maliyeti"}, type: "number", unit: "USD", required: false, smartDefault: 500, validation: { min: 0 }, helper: "", expertMeaning: "Intervention cost", expertMeaning_i18n: {"en":"Intervention cost","tr":"Intervention cost"} },
  ],
  outputs: [
    { id: "potentialYield", label: "Potansiyel Verim", label_i18n: {"en":"Potansiyel Verim","tr":"Potansiyel Verim"}, unit: "kg", format: "number" },
    { id: "actualYield", label: "Gerçek Verim", label_i18n: {"en":"Gerçek Verim","tr":"Gerçek Verim"}, unit: "kg/da", format: "number" },
    { id: "yieldGap", label: "Verim Farkı", label_i18n: {"en":"Verim Farkı","tr":"Verim Farkı"}, unit: "kg/da", format: "number" },
    { id: "financialLoss", label: "Finansal Kayıp", label_i18n: {"en":"Finansal Kayıp","tr":"Finansal Kayıp"}, unit: "USD/da", format: "currency" },
    { id: "roiIntervention", label: "Müdahale ROI", label_i18n: {"en":"Müdahale ROI","tr":"Müdahale ROI"}, unit: "", format: "number" },
  ],
