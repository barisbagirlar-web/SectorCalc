...
export const FuelTravelCalculator_SCHEMA: PremiumCalculatorSchema = {
  id: "fuel-travel-calculator",
  name: "Fuel Travel Calculator",
  sectorSlug: "general-industrial",
  category: "route",
  painStatement: "Transportation cost engineering",
  ...
  assumptions: {
    ...
    assumptionNotes: [
      "Average speed assumed constant at 60 km/h for driver time calculation",
