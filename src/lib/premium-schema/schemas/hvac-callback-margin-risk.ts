  ...
  inputs: [
    {
      ...
      smartDefault: 64000,
      validation: { min: 0 },
      helper: "Contract or bid revenue for the HVAC project.",
    ...
    },
    {
      ...
      smartDefault: 4200,
      validation: { min: 0 },
      helper: "Extra duct material and labor versus estimate.",
      expertMeaning: "Duct scope drift not in base price.",
    },
    {
      ...
      expertMeaning: "Commissioning time often under-quoted.",
    },
    {
      id: "laborRate",
      label: "Labor rate",
      ...
      smartDefault: 55,
      validation: { min: 0 },
      helper: "Fully loaded HVAC field labor rate.",
      expertMeaning: "Hourly cost on commissioning exposure.",
    },
    {
      ...
      helper: "Expected callback cost as percent of revenue.",
      expertMeaning: "Historical callback band for similar projects.",
    },
  ],
