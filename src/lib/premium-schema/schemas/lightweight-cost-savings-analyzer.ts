...
export const LIGHTWEIGHT_COST_SCHEMA: PremiumCalculatorSchema = {
  ...
  name: "Hafifletme Maliyet Tasarrufu Analizi", name_i18n: {"en":"Lightweight Cost Savings Analysis","tr":"Hafifletme Maliyet Tasarrufu Analizi"}, sectorSlug: "sheet-metal", category: "cost",
  painStatement: "Parça hafifletmenin yakıt, payload ve malzeme primi etkisini hesaplamadan yapılan malzeme değişikliği beklenen tasarrufu sağlamayabilir.", painStatement_i18n: {"en":"Without calculating the fuel, payload, and material premium impact of part lightweighting, material changes may not deliver expected savings.","tr":"Parça hafifletmenin yakıt, payload ve malzeme primi etkisini hesaplamadan yapılan malzeme değişikliği beklenen tasarrufu sağlamayabilir."},
  inputs: [
  ...
  outputs:  [
    { id: "weightReduction", label: "Ağırlık Azaltma", label_i18n: {"en":"Weight Reduction","tr":"Ağırlık Azaltma"}, unit: "kg", format: "number" },
    { id: "fuelSavings", label: "Yakıt Tasarrufu (Yıllık)", label_i18n: {"en":"Fuel Savings (Annual)","tr":"Yakıt Tasarrufu (Yıllık)"}, unit: "USD/yıl", format: "currency" },
    { id: "payloadGain", label: "Payload Gelir Artışı", label_i18n: {"en":"Payload Revenue Gain","tr":"Payload Gelir Artışı"}, unit: "USD/yıl", format: "currency" },
    { id: "netSavings", label: "Net Tasarruf (Ömür Boyu)", label_i18n: {"en":"Net Savings (Lifecycle)","tr":"Net Tasarruf (Ömür Boyu)"}, unit: "USD", format: "currency", isBigNumber: true },
  ],
  thresholds: [{ fieldId: "netSavings", warning: 5000, critical: 0, direction: "lower_is_bad", warningMessage: "Net tasarruf < $5000 — hafifletme yatırımı sorgulanmalı.", warningMessage_i18n: {"en":"Net savings < $5000 — lightweight investment should be questioned.","tr":"Net tasarruf < $5000 — hafifletme yatırımı sorgulanmalı."}, criticalMessage: "Net tasarruf ≤ $0 — hafifletme ekonomik değil.", criticalMessage_i18n: {"en":"Net savings ≤ $0 — lightweighting is not economical.","tr":"Net tasarruf ≤ $0 — hafifletme ekonomik değil."} }],
  formulaPipeline: [
