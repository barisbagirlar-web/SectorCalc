...
export const ASME_VESSEL_SCHEMA: PremiumCalculatorSchema = {
  ...
  name: "Basınç Vessel Kalınlık Analizi (ASME BPVC)", name_i18n: {"en":"Basınç Vessel Kalınlık Analizi (ASME BPVC)","tr":"Basınç Vessel Kalınlık Analizi (ASME BPVC)"}, sectorSlug: "sheet-metal", category: "measurement",
  ...
  inputs: [
    { id: "internalPressure", label: "İç Basınç (P)", label_i18n: {"en":"İç Basınç (P)","tr":"İç Basınç (P)"}, type: "number", unit: "MPa", required: true, smartDefault: 1.5, validation: { min: 0.001 }, helper: "", expertMeaning: "Internal design pressure", expertMeaning_i18n: {"en":"Internal design pressure","tr":"Internal design pressure"} },
    { id: "innerRadius", label: "İç Yarıçap (R)", label_i18n: {"en":"İç Yarıçap (R)","tr":"İç Yarıçap (R)"}, type: "number", unit: "mm", required: true, smartDefault: 500, validation: { min: 1 }, helper: "", expertMeaning: "Inside radius of vessel", expertMeaning_i18n: {"en":"Inside radius of vessel","tr":"Inside radius of vessel"} },
    { id: "innerDiameter", label: "İç Çap (D)", label_i18n: {"en":"İç Çap (D)","tr":"İç Çap (D)"}, type: "number", unit: "mm", required: false, smartDefault: 1000, validation: { min: 1 }, helper: "", expertMeaning: "Inside diameter (for heads)", expertMeaning_i18n: {"en":"Inside diameter (for heads)","tr":"Inside diameter (for heads)"} },
    ...
    { id: "stressAllowable", label: "İzin Verilen Gerilme (S)", label_i18n: {"en":"İzin Verilen Gerilme (S)","tr":"İzin Verilen Gerilme (S)"}, type: "number", unit: "MPa", required: true, smartDefault: 138, validation: { min: 1 }, helper: "", expertMeaning: "Allowable stress per ASME II-D", expertMeaning_i18n: {"en":"Allowable stress per ASME II-D","tr":"Allowable stress per ASME II-D"} },
    { id: "jointEfficiency", label: "Kaynak Verimi (E)", label_i18n: {"en":"Kaynak Verimi (E)","tr":"Kaynak Verimi (E)"}, type: "number", unit: "", required: true, smartDefault: 0.85, validation: { min: 0, max: 1 }, helper: "", expertMeaning: "Joint efficiency per UW-12", expertMeaning_i18n: {"en":"Joint efficiency per UW-12","tr":"Joint efficiency per UW-12"} },
    { id: "corrosionAllowance", label: "Korozyon Payı (C_A)", label_i18n: {"en":"Korozyon Payı (C_A)","tr":"Korozyon Payı (C_A)"}, type: "number", unit: "mm", required: true, smartDefault: 2, validation: { min: 0 }, helper: "", expertMeaning: "Corrosion allowance", expertMeaning_i18n: {"en":"Corrosion allowance","tr":"Corrosion allowance"} },
    { id: "vesselLength", label: "Kapak Uzunluğu", label_i18n: {"en":"Kapak Uzunluğu","tr":"Kapak Uzunluğu"}, type: "number", unit: "mm", required: false, smartDefault: 2000, validation: { min: 0 }, helper: "", expertMeaning: "Vessel cylindrical length", expertMeaning_i18n: {"en":"Vessel cylindrical length","tr":"Vessel cylindrical length"} },
    { id: "materialDensity", label: "Malzeme Yoğunluğu", label_i18n: {"en":"Malzeme Yoğunluğu","tr":"Malzeme Yoğunluğu"}, type: "number", unit: "kg/m³", required: false, smartDefault: 7850, validation: { min: 0 }, helper: "", expertMeaning: "Material density", expertMeaning_i18n: {"en":"Material density","tr":"Material density"} },
    { id: "crownRadiusMm", label: "Taç Yarıçapı (L) — Torisferik", label_i18n: {"en":"Taç Yarıçapı (L) — Torisferik","tr":"Taç Yarıçapı (L) — Torisferik"}, type: "number", unit: "mm", required: false, smartDefault: 1000, validation: { min: 0 }, helper: "", expertMeaning: "Crown radius for torispherical head", expertMeaning_i18n: {"en":"Crown radius for torispherical head","tr":"Crown radius for torispherical head"} },
    { id: "knuckleRadiusMm", label: "Büküm Yarıçapı (r) — Torisferik", label_i18n: {"en":"Büküm Yarıçapı (r) — Torisferik","tr":"Büküm Yarıçapı (r) — Torisferik"}, type: "number", unit: "mm", required: false, smartDefault: 100, validation: { min: 0 }, helper: "", expertMeaning: "Knuckle radius for torispherical head", expertMeaning_i18n: {"en":"Knuckle radius for torispherical head","tr":"Knuckle radius for torispherical head"} },
  ],
  outputs: [
