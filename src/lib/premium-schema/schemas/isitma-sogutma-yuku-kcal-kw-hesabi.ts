...
export const IsitmaSogutmaYukuKcalKwHesabi_SCHEMA: PremiumCalculatorSchema = {
  id: "isitma-sogutma-yuku-kcal-kw-hesabi",
  name: "Isıtma — Soğutma Yükü (Kcal/KW) Calculation",
  sectorSlug: "general-industrial",
  category: "cost",
  painStatement: "ASHRAE Handbook – Fundamentals, Chapter 18 (Nonresidential Cooling and Heating Load Calculation)",
  ...
  inputs: [
    {
      ...
      expertMeaning: "Heating/cooling power",
    },
    {
      id: "runtimeHours",
      label: "Daily runtime",
  ...
  assumptions: {
    ...
    assumptionNotes: [
      ...
      "Constant outdoor temperature (design conditions)",
      "No part-load degradation",
    ],
  },
};
