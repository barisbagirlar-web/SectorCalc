...
export const TemizlikMalzemesiSarfiyatHesabi_SCHEMA: PremiumCalculatorSchema = {
  id: "temizlik-malzemesi-sarfiyat-hesabi",
  name: "Temizlik Malzemesi Sarfiyat Calculation",
