...
export const GeriDonusumGelirMaliyetHesabi_SCHEMA: PremiumCalculatorSchema = {
  id: "geri-donusum-gelir-maliyet-hesabi",
  name: "Geri Dönüşüm Gelir — Maliyet Calculation",
