...
export const COMPRESSED_AIR_LEAK_SCHEMA: PremiumCalculatorSchema = {
  ...
  name: "Kompresör Kaçağı Maliyet", name_i18n: {"en":"Kompresör Kaçağı Maliyet","tr":"Kompresör Kaçağı Maliyet"}, sectorSlug: "cnc-manufacturing", category: "energy",
  ...
  inputs: [
    { id: "leakDiameter", label: "Kaçak Çapı", label_i18n: {"en":"Kaçak Çapı","tr":"Kaçak Çapı"}, type: "number", unit: "mm", required: true, smartDefault: 2, validation: { min: 0.1 }, helper: "", expertMeaning: "Orifice diameter", expertMeaning_i18n: {"en":"Orifice diameter","tr":"Orifice diameter"} },
    { id: "linePressure", label: "Hat Basıncı", label_i18n: {"en":"Hat Basıncı","tr":"Hat Basıncı"}, type: "number", unit: "bar", required: true, smartDefault: 7, validation: { min: 1 }, helper: "", expertMeaning: "Line pressure", expertMeaning_i18n: {"en":"Line pressure","tr":"Line pressure"} },
    { id: "leakCount", label: "Kaçak Sayısı", label_i18n: {"en":"Kaçak Sayısı","tr":"Kaçak Sayısı"}, type: "number", unit: "", required: true, smartDefault: 5, validation: { min: 1 }, helper: "", expertMeaning: "Number of leaks", expertMeaning_i18n: {"en":"Number of leaks","tr":"Number of leaks"} },
    { id: "compressorEff", label: "Kompresör Verimi", label_i18n: {"en":"Kompresör Verimi","tr":"Kompresör Verimi"}, type: "number", unit: "", required: false, smartDefault: 0.85, validation: { min: 0, max: 1 }, helper: "", expertMeaning: "Compressor efficiency", expertMeaning_i18n: {"en":"Compressor efficiency","tr":"Compressor efficiency"} },
    { id: "operatingHours", label: "Yıllık Çalışma Saati", label_i18n: {"en":"Yıllık Çalışma Saati","tr":"Yıllık Çalışma Saati"}, type: "number", unit: "saat", required: true, smartDefault: 8000, validation: { min: 1 }, helper: "", expertMeaning: "Annual operating hours", expertMeaning_i18n: {"en":"Annual operating hours","tr":"Annual operating hours"} },
    ...
    { id: "gridEF", label: "Emisyon Faktörü", label_i18n: {"en":"Emisyon Faktörü","tr":"Emisyon Faktörü"}, type: "number", unit: "tCO2e/MWh", required: false, smartDefault: 0.45, validation: { min: 0 }, helper: "", expertMeaning: "Grid emission factor", expertMeaning_i18n: {"en":"Grid emission factor","tr":"Grid emission factor"} },
  ...
  outputs: [
    { id: "leakFlow", label: "Kaçak Debisi", label_i18n: {"en":"Kaçak Debisi","tr":"Kaçak Debisi"}, unit: "CFM", format: "number" },
    { id: "powerLoss", label: "Güç Kaybı", label_i18n: {"en":"Güç Kaybı","tr":"Güç Kaybı"}, unit: "kW", format: "number" },
    { id: "annualEnergyLoss", label: "Yıllık Enerji Kaybı", label_i18n: {"en":"Yıllık Enerji Kaybı","tr":"Yıllık Enerji Kaybı"}, unit: "kWh", format: "number" },
    { id: "costPerLeak", label: "Kaçak Başı Maliyet", label_i18n: {"en":"Kaçak Başı Maliyet","tr":"Kaçak Başı Maliyet"}, unit: "USD/yıl", format: "currency" },
    { id: "totalLeakCost", label: "Toplam Kaçak Maliyeti", label_i18n: {"en":"Toplam Kaçak Maliyeti","tr":"Toplam Kaçak Maliyeti"}, unit: "USD/yıl", format: "currency", isBigNumber: true },
    { id: "carbonEmissions", label: "Karbon Emisyonu", label_i18n: {"en":"Karbon Emisyonu","tr":"Karbon Emisyonu"}, unit: "tCO2e", format: "number" },
    { id: "paybackMonths", label: "Tamir Geri Ödeme", label_i18n: {"en":"Tamir Geri Ödeme","tr":"Tamir Geri Ödeme"}, unit: "ay", format: "duration" },
  ],
