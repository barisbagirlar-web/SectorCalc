...
export const FABRIC_CUTTING_SCHEMA: PremiumCalculatorSchema = {
  ...
  name: "Kumaş Kesim Optimize Edici", name_i18n: {"en":"Kumaş Kesim Optimize Edici","tr":"Kumaş Kesim Optimize Edici"}, sectorSlug: "textile", category: "cost",
  ...
  inputs: [
    { id: "fabricWidth", label: "Kumaş Eni", label_i18n: {"en":"Kumaş Eni","tr":"Kumaş Eni"}, type: "number", unit: "m", required: true, smartDefault: 1.5, validation: { min: 0.1 }, helper: "", expertMeaning: "Fabric width", expertMeaning_i18n: {"en":"Fabric width","tr":"Fabric width"} },
    ...
    { id: "patternAreas", label: "Parça Alanları", label_i18n: {"en":"Parça Alanları","tr":"Parça Alanları"}, type: "number", unit: "m²", array: true, required: true, validation: { min: 0 }, helper: "", expertMeaning: "Pattern piece areas", expertMeaning_i18n: {"en":"Pattern piece areas","tr":"Pattern piece areas"} },
    ...
    { id: "pricePerMeter", label: "Metretül Fiyatı", label_i18n: {"en":"Metretül Fiyatı","tr":"Metretül Fiyatı"}, type: "number", unit: "USD/m", required: true, smartDefault: 12, validation: { min: 0 }, helper: "", expertMeaning: "Fabric price per meter", expertMeaning_i18n: {"en":"Fabric price per meter","tr":"Fabric price per meter"} },
    { id: "spliceOverlap", label: "Bindirme Payı", label_i18n: {"en":"Bindirme Payı","tr":"Bindirme Payı"}, type: "number", unit: "m", required: false, smartDefault: 0.05, validation: { min: 0 }, helper: "", expertMeaning: "Splicing overlap length", expertMeaning_i18n: {"en":"Splicing overlap length","tr":"Splicing overlap length"} },
    { id: "splices", label: "Birleştirme Sayısı", label_i18n: {"en":"Birleştirme Sayısı","tr":"Birleştirme Sayısı"}, type: "number", unit: "", required: false, smartDefault: 0, validation: { min: 0 }, helper: "", expertMeaning: "Number of fabric splices", expertMeaning_i18n: {"en":"Number of fabric splices","tr":"Number of fabric splices"} },
  ...
  outputs: [
    ...
    { id: "fabricRequired", label: "Gerekli Kumaş", label_i18n: {"en":"Gerekli Kumaş","tr":"Gerekli Kumaş"}, unit: "m", format: "number" },
    { id: "fabricCost", label: "Kumaş Maliyeti", label_i18n: {"en":"Kumaş Maliyeti","tr":"Kumaş Maliyeti"}, unit: "USD", format: "currency" },
    { id: "utilGain", label: "Verim İyileştirme Kazancı", label_i18n: {"en":"Verim İyileştirme Kazancı","tr":"Verim İyileştirme Kazancı"}, unit: "USD", format: "currency" },
