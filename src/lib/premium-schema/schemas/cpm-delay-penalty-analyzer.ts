...
export const CPM_DELAY_SCHEMA: PremiumCalculatorSchema = {
  ...
  name: "CPM Gecikme Cezası & EOT Talep Analizi", name_i18n: {"en":"CPM Gecikme Cezası & EOT Talep Analizi","tr":"CPM Gecikme Cezası & EOT Talep Analizi"}, sectorSlug: "construction", category: "cost",
  ...
  inputs: [
    { id: "plannedDuration", label: "Planlanan Süre", label_i18n: {"en":"Planlanan Süre","tr":"Planlanan Süre"}, type: "number", unit: "gün", required: true, smartDefault: 200, validation: { min: 1 }, helper: "", expertMeaning: "Planned project duration", expertMeaning_i18n: {"en":"Planned project duration","tr":"Planned project duration"} },
    { id: "actualDuration", label: "Gerçek Süre", label_i18n: {"en":"Gerçek Süre","tr":"Gerçek Süre"}, type: "number", unit: "gün", required: true, smartDefault: 240, validation: { min: 1 }, helper: "", expertMeaning: "Actual project duration", expertMeaning_i18n: {"en":"Actual project duration","tr":"Actual project duration"} },
    ...
    { id: "forceMajeure", label: "Mücbir Sebep Günü", label_i18n: {"en":"Mücbir Sebep Günü","tr":"Mücbir Sebep Günü"}, type: "number", unit: "gün", required: false, smartDefault: 5, validation: { min: 0 }, helper: "", expertMeaning: "Force majeure days", expertMeaning_i18n: {"en":"Force majeure days","tr":"Force majeure days"} },
    { id: "ownerCaused", label: "İşveren Kaynaklı Gecikme", label_i18n: {"en":"İşveren Kaynaklı Gecikme","tr":"İşveren Kaynaklı Gecikme"}, type: "number", unit: "gün", required: false, smartDefault: 10, validation: { min: 0 }, helper: "", expertMeaning: "Employer-caused delay", expertMeaning_i18n: {"en":"Employer-caused delay","tr":"Employer-caused delay"} },
    { id: "dailyPenalty", label: "Günlük Gecikme Cezası", label_i18n: {"en":"Günlük Gecikme Cezası","tr":"Günlük Gecikme Cezası"}, type: "number", unit: "USD/gün", required: true, smartDefault: 5000, validation: { min: 0 }, helper: "", expertMeaning: "Daily liquidated damages", expertMeaning_i18n: {"en":"Daily liquidated damages","tr":"Daily liquidated damages"} },
    { id: "accelerationCost", label: "Hızlandırma Maliyeti", label_i18n: {"en":"Hızlandırma Maliyeti","tr":"Hızlandırma Maliyeti"}, type: "number", unit: "USD", required: false, smartDefault: 15000, validation: { min: 0 }, helper: "", expertMeaning: "Crashing/acceleration cost", expertMeaning_i18n: {"en":"Crashing/acceleration cost","tr":"Crashing/acceleration cost"} },
    { id: "effFactor", label: "Verimlilik Faktörü", label_i18n: {"en":"Verimlilik Faktörü","tr":"Verimlilik Faktörü"}, type: "number", unit: "%", required: false, smartDefault: 80, validation: { min: 0, max: 100 }, helper: "", expertMeaning: "Efficiency factor", expertMeaning_i18n: {"en":"Efficiency factor","tr":"Efficiency factor"} },
  ...
  outputs: [
    ...
    { id: "liquidatedDamages", label: "Sıvılaştırılmış Tazminat", label_i18n: {"en":"Sıvılaştırılmış Tazminat","tr":"Sıvılaştırılmış Tazminat"}, unit: "USD", format: "currency" },
    { id: "netPenalty", label: "Net Ceza", label_i18n: {"en":"Net Ceza","tr":"Net Ceza"}, unit: "USD", format: "currency" },
    { id: "eotClaim", label: "EOT Talep Hakkı", label_i18n: {"en":"EOT Talep Hakkı","tr":"EOT Talep Hakkı"}, unit: "gün", format: "number", isBigNumber: true },
  ],
  thresholds: [
