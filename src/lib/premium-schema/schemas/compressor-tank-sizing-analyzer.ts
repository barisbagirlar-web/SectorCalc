...
export const COMPRESSOR_TANK_SCHEMA: PremiumCalculatorSchema = {
  ...
  name: "Kompresör Tankı Boyutlandırma", name_i18n: {"en":"Kompresör Tankı Boyutlandırma","tr":"Kompresör Tankı Boyutlandırma"}, sectorSlug: "cnc-manufacturing", category: "measurement",
  ...
  inputs: [
    { id: "airFlow", label: "Kompresör Debisi Q", label_i18n: {"en":"Kompresör Debisi Q","tr":"Kompresör Debisi Q"}, type: "number", unit: "m³/dk", required: true, smartDefault: 2, validation: { min: 0.01 }, helper: "", expertMeaning: "Free air delivery", expertMeaning_i18n: {"en":"Free air delivery","tr":"Free air delivery"} },
    { id: "maxPressure", label: "Maksimum Basınç", label_i18n: {"en":"Maksimum Basınç","tr":"Maksimum Basınç"}, type: "number", unit: "bar", required: true, smartDefault: 10, validation: { min: 1 }, helper: "", expertMeaning: "Cut-out pressure", expertMeaning_i18n: {"en":"Cut-out pressure","tr":"Cut-out pressure"} },
    { id: "minPressure", label: "Minimum Basınç", label_i18n: {"en":"Minimum Basınç","tr":"Minimum Basınç"}, type: "number", unit: "bar", required: true, smartDefault: 7, validation: { min: 1 }, helper: "", expertMeaning: "Cut-in pressure", expertMeaning_i18n: {"en":"Cut-in pressure","tr":"Cut-in pressure"} },
    { id: "fillTimeTarget", label: "Hedef Dolum Süresi", label_i18n: {"en":"Hedef Dolum Süresi","tr":"Hedef Dolum Süresi"}, type: "number", unit: "sn", required: true, smartDefault: 30, validation: { min: 1 }, helper: "", expertMeaning: "Target fill time", expertMeaning_i18n: {"en":"Target fill time","tr":"Target fill time"} },
    ...
    { id: "pricePerLiter", label: "Tank Litre Fiyatı", label_i18n: {"en":"Tank Litre Fiyatı","tr":"Tank Litre Fiyatı"}, type: "number", unit: "USD/L", required: false, smartDefault: 0.5, validation: { min: 0 }, helper: "", expertMeaning: "Tank cost per liter", expertMeaning_i18n: {"en":"Tank cost per liter","tr":"Tank cost per liter"} },
  ...
  outputs: [
    ...
    { id: "cycleTime", label: "Çevrim Süresi", label_i18n: {"en":"Çevrim Süresi","tr":"Çevrim Süresi"}, unit: "dk", format: "duration" },
    { id: "cyclesPerHour", label: "Saatteki Çevrim", label_i18n: {"en":"Saatteki Çevrim","tr":"Saatteki Çevrim"}, unit: "çevrim/saat", format: "number" },
    { id: "motorStartCheck", label: "Motor Start Kontrolü", label_i18n: {"en":"Motor Start Kontrolü","tr":"Motor Start Kontrolü"}, unit: "", format: "score" },
