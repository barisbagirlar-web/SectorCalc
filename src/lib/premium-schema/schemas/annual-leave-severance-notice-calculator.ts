  ...
  inputs: [
    {
      ...
      smartDefault: 4200,
      validation: { min: 0 },
      helper: "Monthly gross pay used for screening.",
      expertMeaning: "Base salary before employer burden.",
    },
    {
      ...
      helper: "Payroll taxes and employer contributions.",
      expertMeaning: "Burden applied to gross salary.",
    },
    {
      id: "yearsOfService",
      ...
      helper: "Completed service years for severance screening.",
      expertMeaning: "Tenure factor in severance estimate.",
    },
    {
      ...
      helper: "Policy weeks credited per service year.",
      expertMeaning: "Configurable severance policy factor.",
    },
    {
      id: "noticeWeeks",
      label: "Notice weeks",
      ...
      smartDefault: 4,
      validation: { min: 0, max: 52 },
      helper: "Notice period length in weeks.",
      expertMeaning: "Notice cost screening factor.",
    },
  ],
