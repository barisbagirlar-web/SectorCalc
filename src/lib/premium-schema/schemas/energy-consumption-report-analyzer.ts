...
export const ENERGY_CONSUMPTION_SCHEMA: PremiumCalculatorSchema = {
  ...
  name: "Enerji Tüketim Raporu & PF Analizi", name_i18n: {"en":"Enerji Tüketim Raporu & PF Analizi","tr":"Enerji Tüketim Raporu & PF Analizi"}, sectorSlug: "sheet-metal", category: "energy",
  ...
  inputs: [
    { id: "activeKwh", label: "Aktif Tüketim (kWh)", label_i18n: {"en":"Aktif Tüketim (kWh)","tr":"Aktif Tüketim (kWh)"}, type: "number", unit: "kWh", required: true, smartDefault: 100000, validation: { min: 0 }, helper: "", expertMeaning: "Active energy consumption", expertMeaning_i18n: {"en":"Active energy consumption","tr":"Active energy consumption"} },
    { id: "reactiveKvarh", label: "Reaktif Tüketim (kVArh)", label_i18n: {"en":"Reaktif Tüketim (kVArh)","tr":"Reaktif Tüketim (kVArh)"}, type: "number", unit: "kVArh", required: true, smartDefault: 40000, validation: { min: 0 }, helper: "", expertMeaning: "Reactive energy consumption", expertMeaning_i18n: {"en":"Reactive energy consumption","tr":"Reactive energy consumption"} },
    ...
    { id: "pfThreshold", label: "PF Ceza Eşiği", label_i18n: {"en":"PF Ceza Eşiği","tr":"PF Ceza Eşiği"}, type: "number", unit: "%", required: false, smartDefault: 95, validation: { min: 50, max: 100 }, helper: "", expertMeaning: "Power factor threshold", expertMeaning_i18n: {"en":"Power factor threshold","tr":"Power factor threshold"} },
    ...
    { id: "demandRate", label: "Güç Bedeli", label_i18n: {"en":"Güç Bedeli","tr":"Güç Bedeli"}, type: "number", unit: "USD/kW", required: false, smartDefault: 10, validation: { min: 0 }, helper: "", expertMeaning: "Demand charge rate", expertMeaning_i18n: {"en":"Demand charge rate","tr":"Demand charge rate"} },
    ...
    { id: "emisFactor", label: "Emisyon Faktörü", label_i18n: {"en":"Emisyon Faktörü","tr":"Emisyon Faktörü"}, type: "number", unit: "kgCO₂/kWh", required: false, smartDefault: 0.4, validation: { min: 0 }, helper: "", expertMeaning: "CO2 emission factor", expertMeaning_i18n: {"en":"CO2 emission factor","tr":"CO2 emission factor"} },
    { id: "carbonPrice", label: "Karbon Fiyatı", label_i18n: {"en":"Karbon Fiyatı","tr":"Karbon Fiyatı"}, type: "number", unit: "USD/ton", required: false, smartDefault: 50, validation: { min: 0 }, helper: "", expertMeaning: "Carbon price per ton", expertMeaning_i18n: {"en":"Carbon price per ton","tr":"Carbon price per ton"} },
  ],
  outputs: [
    { id: "powerFactor", label: "Güç Faktörü (PF)", label_i18n: {"en":"Güç Faktörü (PF)","tr":"Güç Faktörü (PF)"}, unit: "", format: "percentage" },
