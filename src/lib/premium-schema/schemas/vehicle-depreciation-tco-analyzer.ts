...
const TAX_COUNTRY_OPTIONS = [
  ...
  { value: "TR", label: "Türkiye", label_i18n: {"en":"Türkiye","tr":"Türkiye"} }, { value: "UK", label: "United Kingdom", label_i18n: {"en":"United Kingdom","tr":"United Kingdom"} },
] as const;
...
export const VEHICLE_DEPRECIATION_SCHEMA: PremiumCalculatorSchema = {
  ...
  name: "Araç Amortismanı & TCO Analizi", name_i18n: {"en":"Araç Amortismanı & TCO Analizi","tr":"Araç Amortismanı & TCO Analizi"}, sectorSlug: "logistics-transport", category: "cost",
  ...
  inputs: [
    ...
    { id: "salvageValue", label: "Kalıntı Değer", label_i18n: {"en":"Kalıntı Değer","tr":"Kalıntı Değer"}, type: "number", unit: "USD", required: true, smartDefault: 10000, validation: { min: 0 }, helper: "Aracın ekonomik ömrü sonundaki tahmini değeri.", helper_i18n: {"en":"Aracın ekonomik ömrü sonundaki tahmini değeri.","tr":"Aracın ekonomik ömrü sonundaki tahmini değeri."}, expertMeaning: "Residual value at end of life", expertMeaning_i18n: {"en":"Residual value at end of life","tr":"Residual value at end of life"} },
    { id: "usefulLife", label: "Faydalı Ömür", label_i18n: {"en":"Faydalı Ömür","tr":"Faydalı Ömür"}, type: "number", unit: "yıl", required: true, smartDefault: 5, validation: { min: 1, max: 30 }, helper: "", expertMeaning: "Depreciation period", expertMeaning_i18n: {"en":"Depreciation period","tr":"Depreciation period"} },
    { id: "annualKm", label: "Yıllık Km Beklentisi", label_i18n: {"en":"Yıllık Km Beklentisi","tr":"Yıllık Km Beklentisi"}, type: "number", unit: "km/yıl", required: false, smartDefault: 30000, validation: { min: 0 }, helper: "", expertMeaning: "For UoP method", expertMeaning_i18n: {"en":"For UoP method","tr":"For UoP method"} },
    ...
    { id: "depreciationMethod", label: "Amortisman Yöntemi", label_i18n: {"en":"Amortisman Yöntemi","tr":"Amortisman Yöntemi"}, type: "select", unit: "", required: true, smartDefault: "SL", options: [...DEPRECIATION_METHOD_OPTIONS], helper: "", expertMeaning: "SL, DB, MACRS or UoP", expertMeaning_i18n: {"en":"SL, DB, MACRS or UoP","tr":"SL, DB, MACRS or UoP"} },
    ...
    { id: "wacc", label: "İskonto Oranı (WACC)", label_i18n: {"en":"İskonto Oranı (WACC)","tr":"İskonto Oranı (WACC)"}, type: "number", unit: "%", required: true, smartDefault: 10, validation: { min: 0, max: 100 }, helper: "", expertMeaning: "Discount rate for PV", expertMeaning_i18n: {"en":"Discount rate for PV","tr":"Discount rate for PV"} },
    { id: "annualOpCost", label: "Yıllık İşletme Maliyeti", label_i18n: {"en":"Yıllık İşletme Maliyeti","tr":"Yıllık İşletme Maliyeti"}, type: "number", unit: "USD", required: false, smartDefault: 5000, validation: { min: 0 }, helper: "", expertMeaning: "Insurance, registration, tires", expertMeaning_i18n: {"en":"Insurance, registration, tires","tr":"Insurance, registration, tires"} },
    { id: "annualMaintCost", label: "Yıllık Bakım Maliyeti", label_i18n: {"en":"Yıllık Bakım Maliyeti","tr":"Yıllık Bakım Maliyeti"}, type: "number", unit: "USD", required: false, smartDefault: 3000, validation: { min: 0 }, helper: "", expertMeaning: "Repairs, maintenance", expertMeaning_i18n: {"en":"Repairs, maintenance","tr":"Repairs, maintenance"} },
  ],
  outputs: [
    { id: "slAnnual", label: "SL Yıllık Amortisman", label_i18n: {"en":"SL Yıllık Amortisman","tr":"SL Yıllık Amortisman"}, unit: "USD", format: "currency" },
    { id: "slMonthly", label: "SL Aylık Amortisman", label_i18n: {"en":"SL Aylık Amortisman","tr":"SL Aylık Amortisman"}, unit: "USD", format: "currency" },
    { id: "dbRate", label: "DB Yıllık Oran", label_i18n: {"en":"DB Yıllık Oran","tr":"DB Yıllık Oran"}, unit: "%", format: "percentage" },
    { id: "taxShieldAnnual", label: "Yıllık Vergi Kalkanı", label_i18n: {"en":"Yıllık Vergi Kalkanı","tr":"Yıllık Vergi Kalkanı"}, unit: "USD", format: "currency" },
