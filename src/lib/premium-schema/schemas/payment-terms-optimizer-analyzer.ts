...
export const PAYMENT_TERMS_OPTIMIZER_SCHEMA: PremiumCalculatorSchema = {
  ...
  name: "Ödeme Vadesi Optimizasyonu", name_i18n: {"en":"Ödeme Vadesi Optimizasyonu","tr":"Ödeme Vadesi Optimizasyonu"}, sectorSlug: "financial-planning", category: "cost",
  ...
  inputs: [
    ...
    { id: "proposedTerms", label: "Önerilen Vade", label_i18n: {"en":"Önerilen Vade","tr":"Önerilen Vade"}, type: "number", unit: "gün", required: true, smartDefault: 30, validation: { min: 1 }, helper: "", expertMeaning: "Proposed payment terms in days", expertMeaning_i18n: {"en":"Proposed payment terms in days","tr":"Proposed payment terms in days"} },
    { id: "badDebtRate", label: "Şüpheli Alacak Oranı", label_i18n: {"en":"Şüpheli Alacak Oranı","tr":"Şüpheli Alacak Oranı"}, type: "number", unit: "%", required: false, smartDefault: 2.5, validation: { min: 0 }, helper: "", expertMeaning: "Historical bad debt rate", expertMeaning_i18n: {"en":"Historical bad debt rate","tr":"Historical bad debt rate"} },
    { id: "discountRate", label: "Erken Ödeme İskonto Oranı", label_i18n: {"en":"Erken Ödeme İskonto Oranı","tr":"Erken Ödeme İskonto Oranı"}, type: "number", unit: "%", required: false, smartDefault: 2, validation: { min: 0 }, helper: "", expertMeaning: "Early payment discount rate", expertMeaning_i18n: {"en":"Early payment discount rate","tr":"Early payment discount rate"} },
    { id: "discountTakeRate", label: "İskonto Kullanım Oranı", label_i18n: {"en":"İskonto Kullanım Oranı","tr":"İskonto Kullanım Oranı"}, type: "number", unit: "%", required: false, smartDefault: 30, validation: { min: 0, max: 100 }, helper: "", expertMeaning: "Percentage of customers taking discount", expertMeaning_i18n: {"en":"Percentage of customers taking discount","tr":"Percentage of customers taking discount"} },
  ],
  outputs: [
    { id: "dso", label: "Alacak Tahsil Süresi (DSO)", label_i18n: {"en":"Alacak Tahsil Süresi (DSO)","tr":"Alacak Tahsil Süresi (DSO)"}, unit: "gün", format: "number" },
    { id: "carryingCostAr", label: "Alacak Taşıma Maliyeti", label_i18n: {"en":"Alacak Taşıma Maliyeti","tr":"Alacak Taşıma Maliyeti"}, unit: "USD/yıl", format: "currency" },
    { id: "badDebtExpense", label: "Şüpheli Alacak Gideri", label_i18n: {"en":"Şüpheli Alacak Gideri","tr":"Şüpheli Alacak Gideri"}, unit: "USD/yıl", format: "currency" },
    { id: "discountCost", label: "İskonto Maliyeti", label_i18n: {"en":"İskonto Maliyeti","tr":"İskonto Maliyeti"}, unit: "USD/yıl", format: "currency" },
    { id: "cashFlowImpact", label: "Nakit Akış Etkisi", label_i18n: {"en":"Nakit Akış Etkisi","tr":"Nakit Akış Etkisi"}, unit: "USD", format: "currency", isBigNumber: true },
    { id: "npvTerms", label: "Vade Değişimi Net Bugünkü Değer", label_i18n: {"en":"Vade Değişimi Net Bugünkü Değer","tr":"Vade Değişimi Net Bugünkü Değer"}, unit: "USD", format: "currency", isBigNumber: true },
  ],
