...
// ── AI TOKEN MALİYET (5 formulas) ──
  ...
  },
  {
    ...
    const cost_Trad = num(inputs, "cost_Trad") || 0;
    const cost_DT = num(inputs, "cost_DT") || 0;
  ...
  },
  {
    ...
    const actOperators = num(inputs, "actOperators");
    const sqrt = num(inputs, "sqrt") || 0;
    const cycle_i = num(inputs, "cycle_i") || 0;
  ...
  },
  {
    ...
    const Cost = num(inputs, "Cost");
    const pokaYoke_Cost = num(inputs, "pokaYoke_Cost") || 0;
  ...
  // ── Project Maliyet Tahmin (8 formulas) ──
  {
    ...
    const i = num(inputs, "i");
    const rate = num(inputs, "rate");
    const hours_i = num(inputs, "hours_i") || 0;
    const rate_i = num(inputs, "rate_i") || 0;
  ...
  },
  {
    ...
    const j = num(inputs, "j");
    const price = num(inputs, "price");
    const quantity_j = num(inputs, "quantity_j") || 0;
    const price_j = num(inputs, "price_j") || 0;
  ...
  },
  {
    ...
    const pumpEff = num(inputs, "pumpEff");
    const p_Atmospheric = num(inputs, "p_Atmospheric") || 0;
  ...
  },
  {
    ...
    const kW = num(inputs, "kW");
    const operatingHours = num(inputs, "operatingHours");
    const powerLoss_kW = num(inputs, "powerLoss_kW") || 0;
  ...
  // ── Vsm finansal Dönüştürücü (6 formulas) ──
  {
    ...
    const wIP_Inventory = num(inputs, "wIP_Inventory") || 0;
