...
export const PREMIUM_SCHEMA_SLUG_MAP: Readonly<Record<string, string>> = {
  "cnc-quote-risk-analyzer": "cnc-quote-risk-analyzer",
  ...
  "sheet-metal-quote-risk-tool": "sheet-metal-quote-risk-tool",
  ...
  "welding-bid-risk-analyzer": "welding-bid-risk-analyzer",
  "millwork-bid-risk-analyzer": "textile-fabric-waste-risk",
  "signage-bid-safe-price-tool": "signage-bid-safe-price-tool",
  "auto-shop-margin-leak-detector": "auto-repair-comeback-cost",
  "hvac-project-margin-guard": "hvac-project-margin-guard",
  "panel-shop-margin-verdict": "electrical-panel-rework-cost",
  "plumbing-job-margin-verdict": "plumbing-job-margin-verdict",
  "landscaping-contract-profit-tool": "landscaping-contract-profit-tool",
