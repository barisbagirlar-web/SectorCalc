...
import { CLV_CAC_SCHEMA } from "@/lib/premium-schema/schemas/clv-cac-ratio-analyzer";
import { CNC_CYCLE_TIME_SCHEMA } from "@/lib/premium-schema/schemas/cnc-cycle-time-analyzer";
import { CNC_MACHINING_COST_SCHEMA } from "@/lib/premium-schema/schemas/cnc-machining-cost-analyzer";
import { CPK_PPM_SCHEMA } from "@/lib/premium-schema/schemas/cpk-ppm-converter-analyzer";
import { CPM_DELAY_SCHEMA } from "@/lib/premium-schema/schemas/cpm-delay-penalty-analyzer";
import { ROOF_AREA_SCHEMA } from "@/lib/premium-schema/schemas/roof-area-load-analyzer";
import { BOTTLENECK_INVESTMENT_SCHEMA } from "@/lib/premium-schema/schemas/bottleneck-investment-analyzer";
import { SMED_CHANGEOVER_SCHEMA } from "@/lib/premium-schema/schemas/smed-changeover-matrix-analyzer";
import { WAREHOUSE_LAYOUT_SCHEMA } from "@/lib/premium-schema/schemas/warehouse-layout-analyzer";
import { ABSENTEEISM_COST_SCHEMA } from "@/lib/premium-schema/schemas/absenteeism-cost-analyzer";
import { DIGITAL_TWIN_COST_SCHEMA } from "@/lib/premium-schema/schemas/digital-twin-cost-analyzer";
import { SEWING_LINE_BALANCE_SCHEMA } from "@/lib/premium-schema/schemas/sewing-line-balance-analyzer-pro";
import { DYE_RECIPE_COST_SCHEMA } from "@/lib/premium-schema/schemas/dye-recipe-cost-analyzer";
import { ENERGY_CONSUMPTION_SCHEMA } from "@/lib/premium-schema/schemas/energy-consumption-report-analyzer";
import { INFLATION_ESCALATION_SCHEMA } from "@/lib/premium-schema/schemas/inflation-escalation-analyzer";
import { ENVIRONMENTAL_WASTE_SCHEMA } from "@/lib/premium-schema/schemas/environmental-waste-cost-analyzer";
import { EOQ_INVENTORY_SCHEMA } from "@/lib/premium-schema/schemas/eoq-inventory-optimizer-analyzer";
import { EVM_FORECAST_SCHEMA } from "@/lib/premium-schema/schemas/evm-cost-forecast-analyzer";
import { FACTORY_LAYOUT_SCHEMA } from "@/lib/premium-schema/schemas/factory-layout-distance-analyzer";
import { INTEREST_RATE_RISK_SCHEMA } from "@/lib/premium-schema/schemas/interest-rate-risk-analyzer";
import { FILAMENT_RECYCLING_SCHEMA } from "@/lib/premium-schema/schemas/filament-recycling-analyzer";
import { PRICE_ELASTICITY_SCHEMA } from "@/lib/premium-schema/schemas/price-elasticity-analyzer";
import { FLEXIBLE_MFG_ROI_SCHEMA } from "@/lib/premium-schema/schemas/flexible-manufacturing-roi-analyzer";
import { GAGE_RNR_COST_SCHEMA } from "@/lib/premium-schema/schemas/gage-rnr-cost-analyzer";
import { FOOD_WASTE_MARGIN_SCHEMA } from "@/lib/premium-schema/schemas/food-waste-margin-analyzer";
import { FERTILIZER_DOSAGE_SCHEMA } from "@/lib/premium-schema/schemas/fertilizer-dosage-analyzer";
import { HACCP_DEVIATION_SCHEMA } from "@/lib/premium-schema/schemas/haccp-deviation-cost-analyzer";
import { VOLUMETRIC_WEIGHT_SCHEMA } from "@/lib/premium-schema/schemas/volumetric-weight-chargeable-analyzer";
import { LIGHTWEIGHT_COST_SCHEMA } from "@/lib/premium-schema/schemas/lightweight-cost-savings-analyzer";
import { SCRAP_OPTIMIZE_SCHEMA } from "@/lib/premium-schema/schemas/scrap-rate-optimize-analyzer";
import { HVAC_CAPACITY_SCHEMA } from "@/lib/premium-schema/schemas/hvac-capacity-analyzer";
import { HYDRAULIC_LOSS_SCHEMA } from "@/lib/premium-schema/schemas/hydraulic-system-loss-analyzer";
import { HEAT_EXCHANGER_FOULING_SCHEMA } from "@/lib/premium-schema/schemas/heat-exchanger-fouling-analyzer";
import { ISO50001_BASELINE_SCHEMA } from "@/lib/premium-schema/schemas/iso-50001-baseline-analyzer";
import { IRR_INVESTMENT_SCHEMA } from "@/lib/premium-schema/schemas/irr-investment-analyzer";
import { FEED_COST_SCHEMA } from "@/lib/premium-schema/schemas/feed-cost-formulation-analyzer";
import { SCAFFOLD_RENTAL_SCHEMA } from "@/lib/premium-schema/schemas/scaffold-rental-cost-analyzer";
import { SPC_LIMIT_SCHEMA } from "@/lib/premium-schema/schemas/spc-limit-control-analyzer";
import { MACHINING_STRATEGY_SCHEMA } from "@/lib/premium-schema/schemas/machining-strategy-analyzer";
import { KAIZEN_SAVINGS_SCHEMA } from "@/lib/premium-schema/schemas/kaizen-savings-tracker-analyzer";
// ── Batch 3 (Tools 31-40) imports ──
import { PRODUCT_COMPLEXITY_SCHEMA } from "@/lib/premium-schema/schemas/product-complexity-hidden-cost-analyzer";
import { VACUUM_LEAK_SCHEMA } from "@/lib/premium-schema/schemas/vacuum-leak-energy-analyzer";
import { SHIFT_COST_EFFICIENCY_SCHEMA } from "@/lib/premium-schema/schemas/shift-cost-efficiency-analyzer";
import { VSM_FINANCIAL_SCHEMA } from "@/lib/premium-schema/schemas/vsm-financial-converter-analyzer";
import { WPS_PREHEAT_SCHEMA } from "@/lib/premium-schema/schemas/wps-preheat-temperature-analyzer";
import { FUEL_ROUTE_DRIFT_SCHEMA } from "@/lib/premium-schema/schemas/fuel-route-drift-analyzer";
import { FIRE_HYDRANT_SCHEMA } from "@/lib/premium-schema/schemas/fire-hydrant-flow-analyzer";
import { RENOVATION_BUDGET_SCHEMA } from "@/lib/premium-schema/schemas/renovation-budget-optimizer-analyzer";
import { RENEWABLE_ENERGY_IRR_SCHEMA } from "@/lib/premium-schema/schemas/renewable-energy-irr-analyzer";
import { ROI_NPV_SCHEMA } from "@/lib/premium-schema/schemas/roi-npv-analyzer";
// ── Batch 4 (Tools 101-140) imports ──
import { BEAM_WEIGHT_SCHEMA } from "@/lib/premium-schema/schemas/beam-weight-analyzer";
import { BID_RISK_SCHEMA } from "@/lib/premium-schema/schemas/bid-risk-analyzer";
import { CARBON_FOOTPRINT_CHECK_SCHEMA } from "@/lib/premium-schema/schemas/carbon-footprint-check-analyzer";
import { CASH_FLOW_GAP_SCHEMA } from "@/lib/premium-schema/schemas/cash-flow-gap-analyzer";
import { CLEANING_BID_OPTIMIZER_SCHEMA } from "@/lib/premium-schema/schemas/cleaning-bid-optimizer-analyzer";
import { COMPRESSED_AIR_LEAK_SCHEMA } from "@/lib/premium-schema/schemas/compressed-air-leak-analyzer";
import { COMPRESSOR_TANK_SCHEMA } from "@/lib/premium-schema/schemas/compressor-tank-sizing-analyzer";
import { CONTAINER_LOAD_SCHEMA } from "@/lib/premium-schema/schemas/container-load-analyzer";
import { CONTRACT_INCENTIVE_ANALYZER } from "@/lib/premium-schema/schemas/contract-incentive-analyzer";
import { CROP_YIELD_LOSS_SCHEMA } from "@/lib/premium-schema/schemas/crop-yield-loss-analyzer";
import { CURRENCY_RISK_SCHEMA } from "@/lib/premium-schema/schemas/currency-risk-analyzer";
import { CUT_FILL_BALANCE_SCHEMA } from "@/lib/premium-schema/schemas/cut-fill-balance-analyzer";
import { CUTTING_TOOL_LIFE_SCHEMA } from "@/lib/premium-schema/schemas/cutting-tool-life-analyzer";
import { DAIRY_PROFIT_DETECTOR_ANALYZER } from "@/lib/premium-schema/schemas/dairy-profit-detector-analyzer";
import { DELIVERY_COST_SCHEMA } from "@/lib/premium-schema/schemas/delivery-cost-analyzer";
import { DEMAND_FORECAST_STOCK_SCHEMA } from "@/lib/premium-schema/schemas/demand-forecast-stock-analyzer";
import { FABRIC_CUTTING_SCHEMA } from "@/lib/premium-schema/schemas/fabric-cutting-optimizer-analyzer";
import { FREIGHT_COST_SCHEMA } from "@/lib/premium-schema/schemas/freight-cost-analyzer";
import { HOURLY_RATE_ANALYZER } from "@/lib/premium-schema/schemas/hourly-rate-analyzer";
import { INVENTORY_TURNOVER_RISK_ANALYZER } from "@/lib/premium-schema/schemas/inventory-turnover-risk-analyzer";
import { IRRIGATION_COST_CHECK_ANALYZER } from "@/lib/premium-schema/schemas/irrigation-cost-check-analyzer";
import { KWH_COST_SCHEMA } from "@/lib/premium-schema/schemas/kwh-cost-analyzer";
import { LEARNING_CURVE_TIME_ANALYZER_SCHEMA } from "@/lib/premium-schema/schemas/learning-curve-time-analyzer";
import { LOGISTICS_ROUTE_LOSS_SCHEMA } from "@/lib/premium-schema/schemas/logistics-route-loss-analyzer";
import { MACHINE_ECONOMIC_LIFE_SCHEMA } from "@/lib/premium-schema/schemas/machine-economic-life-analyzer";
import { MATERIAL_REPLACEMENT_COST_SCHEMA } from "@/lib/premium-schema/schemas/material-replacement-cost-analyzer";
import { MOQ_STOCK_BALANCE_SCHEMA } from "@/lib/premium-schema/schemas/moq-stock-balance-analyzer";
import { MTBF_MTTR_FINANCIAL_SCHEMA } from "@/lib/premium-schema/schemas/mtbf-mttr-financial-analyzer";
import { MUDA_WASTE_COST_SCHEMA } from "@/lib/premium-schema/schemas/muda-waste-cost-analyzer";
import { NOISE_VIBRATION_COST_SCHEMA } from "@/lib/premium-schema/schemas/noise-vibration-cost-analyzer";
import { OEE_DOWNTIME_SCHEMA } from "@/lib/premium-schema/schemas/oee-downtime-analyzer";
import { OFFICE_SUPPLIES_COST_SCHEMA } from "@/lib/premium-schema/schemas/office-supplies-cost-analyzer";
import { OVERTIME_HIRING_BREAKEVEN_SCHEMA } from "@/lib/premium-schema/schemas/overtime-hiring-breakeven-analyzer";
import { PALLET_RACK_OPTIMIZER_SCHEMA } from "@/lib/premium-schema/schemas/pallet-rack-optimizer-analyzer";
import { PAYMENT_TERMS_OPTIMIZER_SCHEMA } from "@/lib/premium-schema/schemas/payment-terms-optimizer-analyzer";
import { POKA_YOKE_ROI_ANALYZER_SCHEMA } from "@/lib/premium-schema/schemas/poka-yoke-roi-analyzer";
import { PORTION_COST_ANALYZER_SCHEMA } from "@/lib/premium-schema/schemas/portion-cost-analyzer";
import { PROJECT_COST_ESTIMATE_ANALYZER_SCHEMA } from "@/lib/premium-schema/schemas/project-cost-estimate-analyzer";
import { PROJECT_OVERRUN_ANALYZER_SCHEMA } from "@/lib/premium-schema/schemas/project-overrun-analyzer";
import { QUALITY_COST_PAF_SCHEMA } from "@/lib/premium-schema/schemas/quality-cost-paf-analyzer";
import { RECIPE_COST_CHECK_ANALYZER_SCHEMA } from "@/lib/premium-schema/schemas/recipe-cost-check-analyzer";
import { RECURRING_COST_SCHEMA } from "@/lib/premium-schema/schemas/recurring-cost-analyzer";
import { REPAIR_SHOP_QUOTE_SCHEMA } from "@/lib/premium-schema/schemas/repair-shop-quote-analyzer";
import { RESTAURANT_MENU_MARGIN_LEAK_SCHEMA } from "@/lib/premium-schema/schemas/restaurant-menu-margin-leak-analyzer";
import { ROBOT_VS_MANUAL_ANALYZER_SCHEMA } from "@/lib/premium-schema/schemas/robot-vs-manual-analyzer";
import { ROUTE_COST_ANALYZER_SCHEMA } from "@/lib/premium-schema/schemas/route-cost-analyzer";
import { ROUTE_OPTIMIZATION_ANALYZER } from "@/lib/premium-schema/schemas/route-optimization-analyzer";
import { SAAS_SHELFWARE_ANALYZER } from "@/lib/premium-schema/schemas/saas-shelfware-analyzer";
import { SAMPLE_SIZE_INDUSTRIAL_ANALYZER_SCHEMA } from "@/lib/premium-schema/schemas/sample-size-industrial-analyzer";
import { SEED_RATE_SCHEMA } from "@/lib/premium-schema/schemas/seed-rate-analyzer";
import { SHOP_HOURLY_RATE_SCHEMA } from "@/lib/premium-schema/schemas/shop-hourly-rate-analyzer";
import { SMED_CHANGEOVER_OPTIMIZER_ANALYZER } from "@/lib/premium-schema/schemas/smed-changeover-optimizer-analyzer";
import { SPC_SIGNAL_DELAY_ANALYZER } from "@/lib/premium-schema/schemas/spc-signal-delay-analyzer";
import { STEAM_TRAP_ENERGY_LOSS_ANALYZER } from "@/lib/premium-schema/schemas/steam-trap-energy-loss-analyzer";
import { SUBCONTRACTOR_MARGIN_LEAK_SCHEMA } from "@/lib/premium-schema/schemas/subcontractor-margin-leak-analyzer";
import { SUPPLIER_CURRENCY_RISK_SCHEMA } from "@/lib/premium-schema/schemas/supplier-currency-risk-analyzer";
import { SUPPLIER_PERFORMANCE_TCO_ANALYZER } from "@/lib/premium-schema/schemas/supplier-performance-tco-analyzer";
import { SUPPLY_CHAIN_DISRUPTION_SCHEMA } from "@/lib/premium-schema/schemas/supply-chain-disruption-analyzer";
import { TAGUCHI_QUALITY_LOSS_ANALYZER } from "@/lib/premium-schema/schemas/taguchi-quality-loss-analyzer";
import { TAKT_TIME_FLEXIBILITY_SCHEMA } from "@/lib/premium-schema/schemas/takt-time-flexibility-analyzer";
import { TEXTILE_WASTE_RISK_SCHEMA } from "@/lib/premium-schema/schemas/textile-waste-risk-analyzer";
import { TOOL_WEAR_COST_ANALYZER } from "@/lib/premium-schema/schemas/tool-wear-cost-analyzer";
import { TOTAL_EMPLOYEE_COST_SCHEMA } from "@/lib/premium-schema/schemas/total-employee-cost-analyzer";
import { TRANSFER_PRICING_OPTIMIZER_SCHEMA } from "@/lib/premium-schema/schemas/transfer-pricing-optimizer-analyzer";
import { TRANSPORT_MODE_RISK_SCHEMA } from "@/lib/premium-schema/schemas/transport-mode-risk-analyzer";
import { WATER_USAGE_OPTIMIZER_ANALYZER } from "@/lib/premium-schema/schemas/water-usage-optimizer-analyzer";
import { WELD_COST_ANALYSIS_SCHEMA } from "@/lib/premium-schema/schemas/weld-cost-analysis-analyzer";
import { WELD_STRENGTH_SCHEMA } from "@/lib/premium-schema/schemas/weld-strength-analyzer";
import { WELD_VOLUME_COST_SCHEMA } from "@/lib/premium-schema/schemas/weld-volume-cost-analyzer";
import { WIND_TURBINE_INVESTMENT_ANALYZER } from "@/lib/premium-schema/schemas/wind-turbine-investment-analyzer";
