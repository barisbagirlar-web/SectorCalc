export type IsitmaSogutmaYukuKcalKwHesabiInputs = {
  powerKw: number;
  runtimeHours: number;
...
export type IsitmaSogutmaYukuKcalKwHesabiValidationResult =
  | { ok: true; errors: []; warnings: string[] }
  | { ok: false; errors: string[]; warnings: string[] };

export const ISITMA_SOGUTMA_YUKU_KCAL_KW_HESABI_INPUT_KEYS: readonly (keyof IsitmaSogutmaYukuKcalKwHesabiInputs)[] = [
  "powerKw",
  "runtimeHours",
...
const INPUT_LABELS: Record<keyof IsitmaSogutmaYukuKcalKwHesabiInputs, string> = {
  powerKw: "powerKw",
...
function collectInputErrors(inputs: IsitmaSogutmaYukuKcalKwHesabiInputs): string[] {
  const errors: string[] = [];

  for (const key of ISITMA_SOGUTMA_YUKU_KCAL_KW_HESABI_INPUT_KEYS) {
...
function collectWarnings(inputs: IsitmaSogutmaYukuKcalKwHesabiInputs): string[] {
...
export function validateIsitmaSogutmaYukuKcalKwHesabiInputs(inputs: IsitmaSogutmaYukuKcalKwHesabiInputs): IsitmaSogutmaYukuKcalKwHesabiValidationResult {
