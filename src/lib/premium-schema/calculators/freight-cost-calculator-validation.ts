export type FreightCostCalculatorInputs = {
  distanceKm: number;
  tripCount: number;
...
export type FreightCostCalculatorValidationResult =
  | { ok: true; errors: []; warnings: string[] }
  | { ok: false; errors: string[]; warnings: string[] };

export const FREIGHT_COST_CALCULATOR_INPUT_KEYS: readonly (keyof FreightCostCalculatorInputs)[] = [
  "distanceKm",
  "tripCount",
  "vehicleLoadCapacity",
  "loadFactorPercent",
...
const INPUT_LABELS: Record<keyof FreightCostCalculatorInputs, string> = {
...
function collectInputErrors(inputs: FreightCostCalculatorInputs): string[] {
  const errors: string[] = [];

  for (const key of FREIGHT_COST_CALCULATOR_INPUT_KEYS) {
...
function collectWarnings(inputs: FreightCostCalculatorInputs): string[] {
...
export function validateFreightCostCalculatorInputs(inputs: FreightCostCalculatorInputs): FreightCostCalculatorValidationResult {
