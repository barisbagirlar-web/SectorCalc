export type KwhCostCalculatorInputs = {
  powerKw: number;
  runtimeHours: number;
...
export type KwhCostCalculatorValidationResult =
  | { ok: true; errors: []; warnings: string[] }
  | { ok: false; errors: string[]; warnings: string[] };

export const KWH_COST_CALCULATOR_INPUT_KEYS: readonly (keyof KwhCostCalculatorInputs)[] = [
  "powerKw",
  "runtimeHours",
...
const INPUT_LABELS: Record<keyof KwhCostCalculatorInputs, string> = {
  powerKw: "powerKw",
...
function collectInputErrors(inputs: KwhCostCalculatorInputs): string[] {
  const errors: string[] = [];

  for (const key of KWH_COST_CALCULATOR_INPUT_KEYS) {
...
function collectWarnings(inputs: KwhCostCalculatorInputs): string[] {
...
export function validateKwhCostCalculatorInputs(inputs: KwhCostCalculatorInputs): KwhCostCalculatorValidationResult {
