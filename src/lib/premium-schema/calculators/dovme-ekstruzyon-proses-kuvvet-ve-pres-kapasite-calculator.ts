...
import {
  validateDovmeEkstruzyonProsesKuvvetVePresKapasiteCalculatorInputs,
  type DovmeEkstruzyonProsesKuvvetVePresKapasiteCalculatorInputs,
} from "@/lib/premium-schema/calculators/dovme-ekstruzyon-proses-kuvvet-ve-pres-kapasite-calculator-validation";
...
function resolveMappedValue(
  sourceKey: string,
  userInputs: DovmeEkstruzyonProsesKuvvetVePresKapasiteCalculatorInputs,
  computed: Record<string, number>,
): number {
  if (sourceKey in computed) {
    return computed[sourceKey] ?? 0;
  }
  return userInputs[sourceKey as keyof DovmeEkstruzyonProsesKuvvetVePresKapasiteCalculatorInputs] as number;
}

function runFormulaPipeline(inputs: DovmeEkstruzyonProsesKuvvetVePresKapasiteCalculatorInputs): Record<string, number> {
...
export function calculateDovmeEkstruzyonProsesKuvvetVePresKapasiteCalculator(inputs: DovmeEkstruzyonProsesKuvvetVePresKapasiteCalculatorInputs): {
