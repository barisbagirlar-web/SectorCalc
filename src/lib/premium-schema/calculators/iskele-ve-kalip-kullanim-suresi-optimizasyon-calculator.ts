...
import {
  validateIskeleVeKalipKullanimSuresiOptimizasyonCalculatorInputs,
  type IskeleVeKalipKullanimSuresiOptimizasyonCalculatorInputs,
} from "@/lib/premium-schema/calculators/iskele-ve-kalip-kullanim-suresi-optimizasyon-calculator-validation";
...
function resolveMappedValue(
  sourceKey: string,
  userInputs: IskeleVeKalipKullanimSuresiOptimizasyonCalculatorInputs,
  computed: Record<string, number>,
): number {
  if (sourceKey in computed) {
    return computed[sourceKey] ?? 0;
  }
  return userInputs[sourceKey as keyof IskeleVeKalipKullanimSuresiOptimizasyonCalculatorInputs] as number;
}

function runFormulaPipeline(inputs: IskeleVeKalipKullanimSuresiOptimizasyonCalculatorInputs): Record<string, number> {
...
export function calculateIskeleVeKalipKullanimSuresiOptimizasyonCalculator(inputs: IskeleVeKalipKullanimSuresiOptimizasyonCalculatorInputs): {
