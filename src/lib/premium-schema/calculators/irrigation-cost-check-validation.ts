export type IrrigationCostCheckInputs = {
...
export type IrrigationCostCheckValidationResult =
  | { ok: true; errors: []; warnings: string[] }
  | { ok: false; errors: string[]; warnings: string[] };

export const IRRIGATION_COST_CHECK_INPUT_KEYS: readonly (keyof IrrigationCostCheckInputs)[] = [
  "productionQuantity",
  "unitMaterialCost",
  "scrapRatePercent",
  "directLaborCost",
...
const INPUT_LABELS: Record<keyof IrrigationCostCheckInputs, string> = {
...
function collectInputErrors(inputs: IrrigationCostCheckInputs): string[] {
  const errors: string[] = [];

  for (const key of IRRIGATION_COST_CHECK_INPUT_KEYS) {
...
function collectWarnings(inputs: IrrigationCostCheckInputs): string[] {
...
export function validateIrrigationCostCheckInputs(inputs: IrrigationCostCheckInputs): IrrigationCostCheckValidationResult {
