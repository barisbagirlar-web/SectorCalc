export type FuelTravelCalculatorInputs = {
  distanceKm: number;
  tripCount: number;
...
export type FuelTravelCalculatorValidationResult =
  | { ok: true; errors: []; warnings: string[] }
  | { ok: false; errors: string[]; warnings: string[] };

export const FUEL_TRAVEL_CALCULATOR_INPUT_KEYS: readonly (keyof FuelTravelCalculatorInputs)[] = [
  "distanceKm",
  "tripCount",
  "vehicleLoadCapacity",
  "loadFactorPercent",
...
const INPUT_LABELS: Record<keyof FuelTravelCalculatorInputs, string> = {
...
function collectInputErrors(inputs: FuelTravelCalculatorInputs): string[] {
  const errors: string[] = [];

  for (const key of FUEL_TRAVEL_CALCULATOR_INPUT_KEYS) {
...
function collectWarnings(inputs: FuelTravelCalculatorInputs): string[] {
...
export function validateFuelTravelCalculatorInputs(inputs: FuelTravelCalculatorInputs): FuelTravelCalculatorValidationResult {
