export type CropYieldCalculatorInputs = {
...
export type CropYieldCalculatorValidationResult =
  | { ok: true; errors: []; warnings: string[] }
  | { ok: false; errors: string[]; warnings: string[] };

export const CROP_YIELD_CALCULATOR_INPUT_KEYS: readonly (keyof CropYieldCalculatorInputs)[] = [
  "inputQuantity",
  "outputQuantity",
  "yieldPercent",
  "rawMaterialCost",
...
const INPUT_LABELS: Record<keyof CropYieldCalculatorInputs, string> = {
...
function collectInputErrors(inputs: CropYieldCalculatorInputs): string[] {
  const errors: string[] = [];

  for (const key of CROP_YIELD_CALCULATOR_INPUT_KEYS) {
...
function collectWarnings(inputs: CropYieldCalculatorInputs): string[] {
...
export function validateCropYieldCalculatorInputs(inputs: CropYieldCalculatorInputs): CropYieldCalculatorValidationResult {
