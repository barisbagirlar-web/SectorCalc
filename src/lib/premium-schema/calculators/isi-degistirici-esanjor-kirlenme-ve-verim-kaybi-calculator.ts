...
import {
  validateIsiDegistiriciEsanjorKirlenmeVeVerimKaybiCalculatorInputs,
  type IsiDegistiriciEsanjorKirlenmeVeVerimKaybiCalculatorInputs,
} from "@/lib/premium-schema/calculators/isi-degistirici-esanjor-kirlenme-ve-verim-kaybi-calculator-validation";
...
function resolveMappedValue(
  sourceKey: string,
  userInputs: IsiDegistiriciEsanjorKirlenmeVeVerimKaybiCalculatorInputs,
  computed: Record<string, number>,
): number {
  if (sourceKey in computed) {
    return computed[sourceKey] ?? 0;
  }
  return userInputs[sourceKey as keyof IsiDegistiriciEsanjorKirlenmeVeVerimKaybiCalculatorInputs] as number;
}

function runFormulaPipeline(inputs: IsiDegistiriciEsanjorKirlenmeVeVerimKaybiCalculatorInputs): Record<string, number> {
...
export function calculateIsiDegistiriciEsanjorKirlenmeVeVerimKaybiCalculator(inputs: IsiDegistiriciEsanjorKirlenmeVeVerimKaybiCalculatorInputs): {
