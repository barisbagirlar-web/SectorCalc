...
import {
  validateGecisGradeChangeOffSpecVeYikamaKayipCalculatorInputs,
  type GecisGradeChangeOffSpecVeYikamaKayipCalculatorInputs,
} from "@/lib/premium-schema/calculators/gecis-grade-change-off-spec-ve-yikama-kayip-calculator-validation";
...
function resolveMappedValue(
  sourceKey: string,
  userInputs: GecisGradeChangeOffSpecVeYikamaKayipCalculatorInputs,
  computed: Record<string, number>,
): number {
  if (sourceKey in computed) {
    return computed[sourceKey] ?? 0;
  }
  return userInputs[sourceKey as keyof GecisGradeChangeOffSpecVeYikamaKayipCalculatorInputs] as number;
}

function runFormulaPipeline(inputs: GecisGradeChangeOffSpecVeYikamaKayipCalculatorInputs): Record<string, number> {
...
export function calculateGecisGradeChangeOffSpecVeYikamaKayipCalculator(inputs: GecisGradeChangeOffSpecVeYikamaKayipCalculatorInputs): {
