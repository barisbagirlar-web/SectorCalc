...
import {
  validateTemizlikVeHijyenKimyasalTuketimOptimizasyonCalculatorInputs,
  type TemizlikVeHijyenKimyasalTuketimOptimizasyonCalculatorInputs,
} from "@/lib/premium-schema/calculators/temizlik-ve-hijyen-kimyasal-tuketim-optimizasyon-calculator-validation";
...
function resolveMappedValue(
  sourceKey: string,
  userInputs: TemizlikVeHijyenKimyasalTuketimOptimizasyonCalculatorInputs,
  computed: Record<string, number>,
): number {
  if (sourceKey in computed) {
    return computed[sourceKey] ?? 0;
  }
  return userInputs[sourceKey as keyof TemizlikVeHijyenKimyasalTuketimOptimizasyonCalculatorInputs] as number;
}

function runFormulaPipeline(inputs: TemizlikVeHijyenKimyasalTuketimOptimizasyonCalculatorInputs): Record<string, number> {
...
export function calculateTemizlikVeHijyenKimyasalTuketimOptimizasyonCalculator(inputs: TemizlikVeHijyenKimyasalTuketimOptimizasyonCalculatorInputs): {
