export type TalepTahminHatasiVeStokStokYokluguMaliyetCalculatorInputs = {
...
export type TalepTahminHatasiVeStokStokYokluguMaliyetCalculatorValidationResult =
  | { ok: true; errors: []; warnings: string[] }
  | { ok: false; errors: string[]; warnings: string[] };

export const TALEP_TAHMIN_HATASI_VE_STOK_STOK_YOKLUGU_MALIYET_CALCULATOR_INPUT_KEYS: readonly (keyof TalepTahminHatasiVeStokStokYokluguMaliyetCalculatorInputs)[] = [
...
const INPUT_LABELS: Record<keyof TalepTahminHatasiVeStokStokYokluguMaliyetCalculatorInputs, string> = {
...
function collectInputErrors(inputs: TalepTahminHatasiVeStokStokYokluguMaliyetCalculatorInputs): string[] {
  const errors: string[] = [];

  for (const key of TALEP_TAHMIN_HATASI_VE_STOK_STOK_YOKLUGU_MALIYET_CALCULATOR_INPUT_KEYS) {
...
function collectWarnings(inputs: TalepTahminHatasiVeStokStokYokluguMaliyetCalculatorInputs): string[] {
...
export function validateTalepTahminHatasiVeStokStokYokluguMaliyetCalculatorInputs(inputs: TalepTahminHatasiVeStokStokYokluguMaliyetCalculatorInputs): TalepTahminHatasiVeStokStokYokluguMaliyetCalculatorValidationResult {
