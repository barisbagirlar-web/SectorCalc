export type UnitCostCalculatorInputs = {
...
export type UnitCostCalculatorValidationResult =
  | { ok: true; errors: []; warnings: string[] }
  | { ok: false; errors: string[]; warnings: string[] };

export const UNIT_COST_CALCULATOR_INPUT_KEYS: readonly (keyof UnitCostCalculatorInputs)[] = [
  "productionQuantity",
  "unitMaterialCost",
  "scrapRatePercent",
...
const INPUT_LABELS: Record<keyof UnitCostCalculatorInputs, string> = {
...
function collectInputErrors(inputs: UnitCostCalculatorInputs): string[] {
  const errors: string[] = [];

  for (const key of UNIT_COST_CALCULATOR_INPUT_KEYS) {
...
function collectWarnings(inputs: UnitCostCalculatorInputs): string[] {
...
export function validateUnitCostCalculatorInputs(inputs: UnitCostCalculatorInputs): UnitCostCalculatorValidationResult {
