...
import {
  validateRestoranTabakMaliyetiVePorsiyonOptimizasyonCalculatorInputs,
  type RestoranTabakMaliyetiVePorsiyonOptimizasyonCalculatorInputs,
} from "@/lib/premium-schema/calculators/restoran-tabak-maliyeti-ve-porsiyon-optimizasyon-calculator-validation";
...
function resolveMappedValue(
  sourceKey: string,
  userInputs: RestoranTabakMaliyetiVePorsiyonOptimizasyonCalculatorInputs,
  computed: Record<string, number>,
): number {
  if (sourceKey in computed) {
    return computed[sourceKey] ?? 0;
  }
  return userInputs[sourceKey as keyof RestoranTabakMaliyetiVePorsiyonOptimizasyonCalculatorInputs] as number;
}

function runFormulaPipeline(inputs: RestoranTabakMaliyetiVePorsiyonOptimizasyonCalculatorInputs): Record<string, number> {
...
export function calculateRestoranTabakMaliyetiVePorsiyonOptimizasyonCalculator(inputs: RestoranTabakMaliyetiVePorsiyonOptimizasyonCalculatorInputs): {
