export type YemekTabldotMaliyetHesaplamaInputs = {
...
export type YemekTabldotMaliyetHesaplamaValidationResult =
  | { ok: true; errors: []; warnings: string[] }
  | { ok: false; errors: string[]; warnings: string[] };

export const YEMEK_TABLDOT_MALIYET_HESAPLAMA_INPUT_KEYS: readonly (keyof YemekTabldotMaliyetHesaplamaInputs)[] = [
  "productionQuantity",
  "unitMaterialCost",
  "scrapRatePercent",
  "directLaborCost",
...
const INPUT_LABELS: Record<keyof YemekTabldotMaliyetHesaplamaInputs, string> = {
...
function collectInputErrors(inputs: YemekTabldotMaliyetHesaplamaInputs): string[] {
  const errors: string[] = [];

  for (const key of YEMEK_TABLDOT_MALIYET_HESAPLAMA_INPUT_KEYS) {
...
function collectWarnings(inputs: YemekTabldotMaliyetHesaplamaInputs): string[] {
...
export function validateYemekTabldotMaliyetHesaplamaInputs(inputs: YemekTabldotMaliyetHesaplamaInputs): YemekTabldotMaliyetHesaplamaValidationResult {
