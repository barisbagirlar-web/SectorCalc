export type GeriDonusumGelirMaliyetHesabiInputs = {
...
export type GeriDonusumGelirMaliyetHesabiValidationResult =
  | { ok: true; errors: []; warnings: string[] }
  | { ok: false; errors: string[]; warnings: string[] };

export const GERI_DONUSUM_GELIR_MALIYET_HESABI_INPUT_KEYS: readonly (keyof GeriDonusumGelirMaliyetHesabiInputs)[] = [
  "productionQuantity",
  "unitMaterialCost",
  "scrapRatePercent",
  "directLaborCost",
...
const INPUT_LABELS: Record<keyof GeriDonusumGelirMaliyetHesabiInputs, string> = {
...
function collectInputErrors(inputs: GeriDonusumGelirMaliyetHesabiInputs): string[] {
  const errors: string[] = [];

  for (const key of GERI_DONUSUM_GELIR_MALIYET_HESABI_INPUT_KEYS) {
...
function collectWarnings(inputs: GeriDonusumGelirMaliyetHesabiInputs): string[] {
...
export function validateGeriDonusumGelirMaliyetHesabiInputs(inputs: GeriDonusumGelirMaliyetHesabiInputs): GeriDonusumGelirMaliyetHesabiValidationResult {
