...
import {
  validateEgitimYatirimiVeVerimlilikArtisiGeriDonusCalculatorInputs,
  type EgitimYatirimiVeVerimlilikArtisiGeriDonusCalculatorInputs,
} from "@/lib/premium-schema/calculators/egitim-yatirimi-ve-verimlilik-artisi-geri-donus-calculator-validation";
...
function resolveMappedValue(
  sourceKey: string,
  userInputs: EgitimYatirimiVeVerimlilikArtisiGeriDonusCalculatorInputs,
  computed: Record<string, number>,
): number {
  if (sourceKey in computed) {
    return computed[sourceKey] ?? 0;
  }
  return userInputs[sourceKey as keyof EgitimYatirimiVeVerimlilikArtisiGeriDonusCalculatorInputs] as number;
}

function runFormulaPipeline(inputs: EgitimYatirimiVeVerimlilikArtisiGeriDonusCalculatorInputs): Record<string, number> {
...
export function calculateEgitimYatirimiVeVerimlilikArtisiGeriDonusCalculator(inputs: EgitimYatirimiVeVerimlilikArtisiGeriDonusCalculatorInputs): {
