export type OtoServisIsEmriVeYedekParcaTeklifTutarlilikCalculatorInputs = {
...
export type OtoServisIsEmriVeYedekParcaTeklifTutarlilikCalculatorValidationResult =
  | { ok: true; errors: []; warnings: string[] }
  | { ok: false; errors: string[]; warnings: string[] };

export const OTO_SERVIS_IS_EMRI_VE_YEDEK_PARCA_TEKLIF_TUTARLILIK_CALCULATOR_INPUT_KEYS: readonly (keyof OtoServisIsEmriVeYedekParcaTeklifTutarlilikCalculatorInputs)[] = [
  "productionQuantity",
  "unitMaterialCost",
  "scrapRatePercent",
  "directLaborCost",
...
const INPUT_LABELS: Record<keyof OtoServisIsEmriVeYedekParcaTeklifTutarlilikCalculatorInputs, string> = {
...
function collectInputErrors(inputs: OtoServisIsEmriVeYedekParcaTeklifTutarlilikCalculatorInputs): string[] {
  const errors: string[] = [];

  for (const key of OTO_SERVIS_IS_EMRI_VE_YEDEK_PARCA_TEKLIF_TUTARLILIK_CALCULATOR_INPUT_KEYS) {
...
function collectWarnings(inputs: OtoServisIsEmriVeYedekParcaTeklifTutarlilikCalculatorInputs): string[] {
...
export function validateOtoServisIsEmriVeYedekParcaTeklifTutarlilikCalculatorInputs(inputs: OtoServisIsEmriVeYedekParcaTeklifTutarlilikCalculatorInputs): OtoServisIsEmriVeYedekParcaTeklifTutarlilikCalculatorValidationResult {
