export type FuelConsumptionCalculatorInputs = {
  distanceKm: number;
  tripCount: number;
...
export type FuelConsumptionCalculatorValidationResult =
  | { ok: true; errors: []; warnings: string[] }
  | { ok: false; errors: string[]; warnings: string[] };

export const FUEL_CONSUMPTION_CALCULATOR_INPUT_KEYS: readonly (keyof FuelConsumptionCalculatorInputs)[] = [
  "distanceKm",
  "tripCount",
  "vehicleLoadCapacity",
  "loadFactorPercent",
...
const INPUT_LABELS: Record<keyof FuelConsumptionCalculatorInputs, string> = {
...
function collectInputErrors(inputs: FuelConsumptionCalculatorInputs): string[] {
  const errors: string[] = [];

  for (const key of FUEL_CONSUMPTION_CALCULATOR_INPUT_KEYS) {
...
function collectWarnings(inputs: FuelConsumptionCalculatorInputs): string[] {
...
export function validateFuelConsumptionCalculatorInputs(inputs: FuelConsumptionCalculatorInputs): FuelConsumptionCalculatorValidationResult {
