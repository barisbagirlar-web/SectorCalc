/**
 * Premium schema catalog — public-facing adapter for premium analyzer vitrines.
...
const INDUSTRY_SLUG_ANALYZERS: Partial<Record<IndustrySlug, readonly string[]>> = {
  ...
  "3d-printing-service": ["calibration-drift-risk"],
  construction: [
  ...
  ecommerce: ["cloud-api-cost-overrun", "retail-inventory-turnover-risk"],
  ...
  "energy-carbon": ["energy-peak-cost", "carbon-footprint-compliance-risk", "energy-compressor-leak-cost"],
