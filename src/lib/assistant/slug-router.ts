...
import { getAiToolIndexRecord } from "@/lib/ai/tool-search-index";
import { checkGuardrails } from "@/lib/assistant/guardrails";
import { matchTools } from "@/lib/assistant/knowledge";
import { stripLocaleFromPath } from "@/lib/i18n/locale-routing";
import {
  REGENERATION_FREE_SLUGS,
  REGENERATION_PREMIUM_SLUGS,
} from "@/lib/generated-tools/regeneration-slug-lists";
