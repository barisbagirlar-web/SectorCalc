import { normalizeGeneratedSelectOptions } from "@/lib/features/generated-tools/select-options";
import { normalizeGeneratedI18nText } from "@/lib/features/generated-tools/resolve-i18n-text";
import { inferUnitFromOutputKey } from "@/lib/features/generated-tools/resolve-output-unit";
import type {
...
function normalizeGeneratedToolInputFromRaw(entry: unknown): GeneratedToolInput | null {
  ...
  return {
    ...
    confidence_label: asString(record.confidence_label) || undefined,
    reference: asString(record.reference) || undefined,
    unit_family: asString(record.unit_family) || undefined,
