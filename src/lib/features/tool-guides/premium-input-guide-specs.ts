...
} from "@/lib/features/tool-guides/shape-dimension-guide-meta";
import {
...
const PREMIUM_PILOT_SPECS: readonly ToolGuideSpec[] = [
  {
    ...
    inputMap: [
      { inputKey: "setupTime", visualRole: "driver", nodeId: "setup-time" },
      { inputKey: "cycleTime", visualRole: "primary", nodeId: "cycle-time" },
      { inputKey: "quantity", visualRole: "primary", nodeId: "quantity" },
  ...
  },
  {
    ...
    descriptionKey: "inputGuide.costBreakdown.description",
    inputMap: [
      { inputKey: "areaSize", visualRole: "primary", nodeId: "area-size" },
