...
import { getDefaultCurrencyForRegion, getDefaultLocaleForRegion, getDefaultUnitSystemForRegion, getRegionConfig } from "@/lib/features/regional/regions";
import type { RegionalEngineCode, RegionalCurrencyCode, UnitSystemId } from "@/lib/features/regional/types";
