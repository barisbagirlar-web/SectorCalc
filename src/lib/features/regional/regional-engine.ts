import { LOCALE_DEFINITIONS } from "@/lib/infrastructure/i18n/locale-config";
...
import { getRegionConfig, resolveRegionalCode, resolveRegionalCodeFromLegacy } from "@/lib/features/regional/regions";
import { getDefaultCurrency, getDefaultUnitSystem, resolveLocaleForRegion } from "@/lib/features/regional/regional-defaults";
import { getRegionalBenchmark, getRegionalParameterOptions } from "@/lib/features/regional/regional-parameters";
import { formatOutputValue } from "@/lib/features/regional/regional-formatting";
import { normalizeInputValue } from "@/lib/features/regional/unit-conversions";
import { getAvailableUnitsForQuantity, getDefaultDisplayUnitForQuantity, mapFieldKeyToQuantityType } from "@/lib/features/regional/unit-systems";
import type { FormatOutputValueInput, FormatOutputValueResult, NormalizeInputValueInput, NormalizeInputValueResult, RegionalCalculationContext, RegionalEngineCode, RegionalParameterResult, RegionalSmartFormInputExtension } from "@/lib/features/regional/types";

export { getRegionConfig, resolveRegionalCode, resolveRegionalCodeFromLegacy } from "@/lib/features/regional/regions";
export { getDefaultUnitSystem, getDefaultCurrency } from "@/lib/features/regional/regional-defaults";
export { getAvailableUnitsForQuantity, getDefaultDisplayUnitForQuantity, mapFieldKeyToQuantityType } from "@/lib/features/regional/unit-systems";
export { normalizeInputValue, validateUnitForQuantity } from "@/lib/features/regional/unit-conversions";
export { formatOutputValue, formatRegionalCurrency } from "@/lib/features/regional/regional-formatting";
export { getRegionalParameterOptions, getRegionalBenchmark } from "@/lib/features/regional/regional-parameters";
