import type { UnitDimension } from "@/lib/core/units/unit-definitions";
import type { QuantityType, RegionalEngineCode, UnitSystemId } from "@/lib/features/regional/types";
import { getDefaultUnitSystemForRegion } from "@/lib/features/regional/regions";
