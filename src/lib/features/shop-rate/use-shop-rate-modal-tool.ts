...
import { loadClientCalculator } from "@/lib/features/generated-tools/client-calculator-loader";
import type { GeneratedCalculatorModule, GeneratedToolSchema } from "@/lib/features/generated-tools/types";
import { SHOP_RATE_MODAL_CALCULATOR } from "@/lib/features/shop-rate/modal-calculator";
import {
  SHOP_RATE_MODAL_SLUG,
  SHOP_RATE_SCHEMA_PUBLIC_PATH,
} from "@/lib/features/shop-rate/types";
import type { z } from "zod";
import shopRateSchemaFallback from "@/lib/features/shop-rate/shop-rate-hourly-cost-calculator-schema.json";
