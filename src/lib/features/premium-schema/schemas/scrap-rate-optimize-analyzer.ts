...
export const SCRAP_OPTIMIZE_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    { id: "scrapQty", label: "Scrap Quantity", label_i18n: {"en":"Scrap Quantity"}, type: "number", unit: "adet/yıl", required: true, smartDefault: 5000, validation: { min: 0 }, helper: "", expertMeaning: "Annual scrap quantity", expertMeaning_i18n: {"en":"Annual scrap quantity"} },
  ...
  outputs: [
    ...
    { id: "totalScrapCost", label: "Total Scrap Cost", label_i18n: {"en":"Total Scrap Cost"}, unit: "USD/yıl", format: "currency", isBigNumber: true },
  ],
