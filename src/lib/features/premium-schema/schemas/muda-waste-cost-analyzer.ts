...
export const MUDA_WASTE_COST_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "transportCost", label: "Unnecessary Transport Cost", label_i18n: {"en":"Unnecessary Transport Cost"}, type: "number", unit: "USD/yıl", required: true, smartDefault: 12000, validation: { min: 0 }, helper: "", expertMeaning: "Unnecessary transport cost", expertMeaning_i18n: {"en":"Unnecessary transport cost"} },
    { id: "overprocessingCost", label: "Overprocessing Cost", label_i18n: {"en":"Overprocessing Cost"}, type: "number", unit: "USD/yıl", required: true, smartDefault: 10000, validation: { min: 0 }, helper: "", expertMeaning: "Overprocessing waste cost", expertMeaning_i18n: {"en":"Overprocessing waste cost"} },
  ...
  outputs: [
    { id: "mudaOverproduction", label: "Asr Uretim Israf", label_i18n: {"en":"Asr Production Waste"}, unit: "USD/yıl", format: "currency" },
    { id: "mudaWaiting", label: "Bekleme Israf", label_i18n: {"en":"Bekleme Waste"}, unit: "USD/yıl", format: "currency" },
    { id: "mudaTransport", label: "Tasma Israf", label_i18n: {"en":"Carrying Waste"}, unit: "USD/yıl", format: "currency" },
    { id: "mudaOverprocessing", label: "Gereksiz Islem Israf", label_i18n: {"en":"Gereksiz Islem Waste"}, unit: "USD/yıl", format: "currency" },
    { id: "mudaInventory", label: "Stok Israf", label_i18n: {"en":"Inventory Waste"}, unit: "USD/yıl", format: "currency" },
    { id: "mudaMotion", label: "Hareket Israf", label_i18n: {"en":"Hareket Waste"}, unit: "USD/yıl", format: "currency" },
