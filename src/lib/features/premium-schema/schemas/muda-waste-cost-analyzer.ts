...
export const MUDA_WASTE_COST_SCHEMA: PremiumCalculatorSchema = {
  ...
  outputs: [
    { id: "mudaOverproduction", label: "Aşırı Üretim İsrafı", label_i18n: {"en":"Asr Uretim Israf","tr":"Aşırı Üretim İsrafı"}, unit: "USD/yıl", format: "currency" },
    { id: "mudaWaiting", label: "Bekleme İsrafı", label_i18n: {"en":"Bekleme Israf","tr":"Bekleme İsrafı"}, unit: "USD/yıl", format: "currency" },
    { id: "mudaTransport", label: "Taşıma İsrafı", label_i18n: {"en":"Tasma Israf","tr":"Taşıma İsrafı"}, unit: "USD/yıl", format: "currency" },
    { id: "mudaOverprocessing", label: "Gereksiz İşlem İsrafı", label_i18n: {"en":"Gereksiz Islem Israf","tr":"Gereksiz İşlem İsrafı"}, unit: "USD/yıl", format: "currency" },
    { id: "mudaInventory", label: "Stok İsrafı", label_i18n: {"en":"Stok Israf","tr":"Stok İsrafı"}, unit: "USD/yıl", format: "currency" },
    { id: "mudaMotion", label: "Hareket İsrafı", label_i18n: {"en":"Hareket Israf","tr":"Hareket İsrafı"}, unit: "USD/yıl", format: "currency" },
    { id: "mudaDefects", label: "Hata İsrafı", label_i18n: {"en":"Hata Israf","tr":"Hata İsrafı"}, unit: "USD/yıl", format: "currency" },
