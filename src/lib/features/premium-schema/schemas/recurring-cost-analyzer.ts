...
export const RECURRING_COST_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "expectedLifeYears", label: "Beklenen Proje Omru", label_i18n: {"en":"Expected Project Life"}, type: "number", unit: "yil", required: true, smartDefault: 5, validation: { min: 1 }, helper: "", expertMeaning: "Expected benefit life in years", expertMeaning_i18n: {"en":"Expected benefit life in years"} },
  ...
  outputs: [
    { id: "recurringAnnualCost", label: "Annual Recurring Cost", label_i18n: {"en":"Annual Recurring Cost"}, unit: "USD/yil", format: "currency" },
    ...
    { id: "rootCausePayback", label: "Kok Neden Geri Odeme Suresi", label_i18n: {"en":"Root Cause Payback Period"}, unit: "ay", format: "number" },
  ],
