...
export const FERTILIZER_DOSAGE_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "convFactor", label: "ppm to kg/ha conversion", label_i18n: {"en":"PPM to kg/ha conversion"}, type: "number", unit: "", required: false, smartDefault: 2.24, validation: { min: 0 }, helper: "", expertMeaning: "ppm to kg/ha conversion", expertMeaning_i18n: {"en":"PPM to kg/ha conversion"} },
