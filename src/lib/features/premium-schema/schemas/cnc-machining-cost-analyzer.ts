...
export const CNC_MACHINING_COST_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    { id: "rawVolume", label: "Raw Material Volume", label_i18n: {"en":"Raw Material Volume"}, type: "number", unit: "cm3", required: true, smartDefault: 500, validation: { min: 0.1 }, helper: "", expertMeaning: "Raw material volume per part", expertMeaning_i18n: {"en":"Raw material volume per part"} },
    { id: "density", label: "Material Density", label_i18n: {"en":"Material Density"}, type: "number", unit: "g/cm3", required: true, smartDefault: 7.85, validation: { min: 0.1 }, helper: "", expertMeaning: "Material density", expertMeaning_i18n: {"en":"Material density"} },
    { id: "pricePerKg", label: "Price per Kg", label_i18n: {"en":"Price per Kg"}, type: "number", unit: "currency", required: true, smartDefault: 2, validation: { min: 0.01 }, helper: "", expertMeaning: "Material price per kg", expertMeaning_i18n: {"en":"Material price per kg"} },
    { id: "scrapRate", label: "Scrap Rate", label_i18n: {"en":"Scrap Rate"}, type: "number", unit: "percent", required: false, smartDefault: 5, validation: { min: 0, max: 100 }, helper: "", expertMeaning: "Material scrap rate", expertMeaning_i18n: {"en":"Material scrap rate"} },
