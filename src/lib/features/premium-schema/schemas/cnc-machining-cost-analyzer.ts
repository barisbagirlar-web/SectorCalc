...
export const CNC_MACHINING_COST_SCHEMA: PremiumCalculatorSchema = {
  ...
  outputs: [
    ...
    { id: "machiningCost", label: "Isleme Maliyeti", label_i18n: {"en":"Isleme Cost"}, unit: "USD", format: "currency" },
    ...
    { id: "overheadCost", label: "Genel Gider", label_i18n: {"en":"Genel Expense"}, unit: "USD", format: "currency" },
    { id: "totalUnitCost", label: "Toplam Birim Maliyet", label_i18n: {"en":"Total Unit Cost"}, unit: "USD", format: "currency", isBigNumber: true },
  ],
  thresholds: [
