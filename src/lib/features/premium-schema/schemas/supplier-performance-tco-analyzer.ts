...
export const SUPPLIER_PERFORMANCE_TCO_ANALYZER: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "leadTimeDays", label: "Teslim Suresi", label_i18n: {"en":"Delivery Lead Time"}, type: "number", unit: "gun", required: false, smartDefault: 14, validation: { min: 1 }, helper: "", expertMeaning: "Delivery lead time in days", expertMeaning_i18n: {"en":"Delivery lead time in days"} },
