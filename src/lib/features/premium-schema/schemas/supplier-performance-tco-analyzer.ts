...
export const SUPPLIER_PERFORMANCE_TCO_ANALYZER: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "annualVolume", label: "Annual Volume", label_i18n: {"en":"Annual Volume"}, type: "number", unit: "adet", required: true, smartDefault: 50000, validation: { min: 1 }, helper: "", expertMeaning: "Annual purchase volume", expertMeaning_i18n: {"en":"Annual purchase volume"} },
    ...
    { id: "holdingCostPct", label: "Inventory Holding Cost Rate", label_i18n: {"en":"Inventory Holding Cost Rate"}, type: "number", unit: "%/yıl", required: false, smartDefault: 20, validation: { min: 0, max: 100 }, helper: "", expertMeaning: "Annual holding cost as % of unit price", expertMeaning_i18n: {"en":"Annual holding cost as % of unit price"} },
