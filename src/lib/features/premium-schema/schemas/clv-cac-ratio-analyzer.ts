...
export const CLV_CAC_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "lifespan", label: "Average customer lifespan (years)", label_i18n: {"en":"Average customer lifespan (years)"}, type: "number", unit: "yıl", required: true, smartDefault: 3, validation: { min: 0.5 }, helper: "", expertMeaning: "Average customer lifespan (years)", expertMeaning_i18n: {"en":"Average customer lifespan (years)"} },
    ...
    { id: "newCustomers", label: "New customers acquired", label_i18n: {"en":"New customers acquired"}, type: "number", unit: "kişi", required: true, smartDefault: 200, validation: { min: 1 }, helper: "", expertMeaning: "New customers acquired", expertMeaning_i18n: {"en":"New customers acquired"} },
  ...
  outputs: [
    { id: "clv", label: "CLV (Brüt)", label_i18n: {"en":"CLV (Gross)"}, unit: "USD", format: "currency" },
    { id: "gmClv", label: "Brüt Marj CLV", label_i18n: {"en":"Gross Margin CLV"}, unit: "USD", format: "currency" },
