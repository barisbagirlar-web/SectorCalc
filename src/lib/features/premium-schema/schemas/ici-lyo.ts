...
export const ICI_LYO_SCHEMA: PremiumCalculatorSchema = {
  id: "ici-lyo",
  name: "Lyophilization Cycle Lock Calculator",
  sectorSlug: "industrial",
  category: "industrial",
  legacyPaidSlug: "ici-lyo",
  ...
  inputs: [
    { id: "expectedValue", label: "expected batch value or cycle yield value", type: "number", required: true, unit: "unit", helper: "Enter expected batch value or cycle yield value", expertMeaning: "expected batch value or cycle yield value" },
    { id: "uncertaintySigma", label: "collapse temperature / drying cycle uncertainty", type: "number", required: true, unit: "unit", helper: "Enter collapse temperature / drying cycle uncertainty", expertMeaning: "collapse temperature / drying cycle uncertainty" },
    { id: "downsideLoss", label: "batch loss and release delay exposure", type: "number", required: true, unit: "unit", helper: "Enter batch loss and release delay exposure", expertMeaning: "batch loss and release delay exposure" },
    { id: "delayCost", label: "cost of delaying release or redesigning cycle", type: "number", required: true, unit: "unit", helper: "Enter cost of delaying release or redesigning cycle", expertMeaning: "cost of delaying release or redesigning cycle" },
    { id: "irreversibleCapex", label: "locked batch and cycle cost", type: "number", required: true, unit: "unit", helper: "Enter locked batch and cycle cost", expertMeaning: "locked batch and cycle cost" },
  ...
  reportTemplate: {
    title: "Lyophilization Cycle Lock Calculator Report",
