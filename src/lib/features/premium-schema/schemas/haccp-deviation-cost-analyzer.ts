...
export const HACCP_DEVIATION_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "labCost", label: "Laboratuvar Maliyeti", label_i18n: {"en":"Laboratuvar Cost"}, type: "number", unit: "USD/örnek", required: true, smartDefault: 50, validation: { min: 0 }, helper: "", expertMeaning: "Lab cost per sample", expertMeaning_i18n: {"en":"Lab cost per sample"} },
