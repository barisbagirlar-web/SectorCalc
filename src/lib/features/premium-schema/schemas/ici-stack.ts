...
export const ICI_STACK_SCHEMA: PremiumCalculatorSchema = {
  id: "ici-stack",
  name: "Electrolyzer Stack Replacement Timing Calculator",
  sectorSlug: "industrial",
  category: "industrial",
  legacyPaidSlug: "ici-stack",
  ...
  inputs: [
    ...
    { id: "delayCost", label: "cost of operating degraded stack", type: "number", required: true, unit: "unit", helper: "Enter cost of operating degraded stack", expertMeaning: "cost of operating degraded stack" },
    { id: "irreversibleCapex", label: "stack replacement CAPEX locked", type: "number", required: true, unit: "unit", helper: "Enter stack replacement CAPEX locked", expertMeaning: "stack replacement CAPEX locked" },
  ...
  reportTemplate: {
    title: "Electrolyzer Stack Replacement Timing Calculator Report",
