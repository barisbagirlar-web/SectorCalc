...
export const ICI_DECOM_NUKE_SCHEMA: PremiumCalculatorSchema = {
  id: "ici-decom-nuke",
  name: "Nuclear and Offshore Decommissioning Timing Calculator",
  sectorSlug: "industrial",
  category: "industrial",
  legacyPaidSlug: "ici-decom-nuke",
  ...
  inputs: [
    { id: "expectedValue", label: "expected decommissioning cost", type: "number", required: true, unit: "unit", helper: "Enter expected decommissioning cost", expertMeaning: "expected decommissioning cost" },
    { id: "uncertaintySigma", label: "residual risk and cost tail uncertainty", type: "number", required: true, unit: "unit", helper: "Enter residual risk and cost tail uncertainty", expertMeaning: "residual risk and cost tail uncertainty" },
    { id: "downsideLoss", label: "containment breach exposure", type: "number", required: true, unit: "unit", helper: "Enter containment breach exposure", expertMeaning: "containment breach exposure" },
    { id: "delayCost", label: "cost of deferral and containment", type: "number", required: true, unit: "unit", helper: "Enter cost of deferral and containment", expertMeaning: "cost of deferral and containment" },
    { id: "irreversibleCapex", label: "decommissioning CAPEX locked", type: "number", required: true, unit: "unit", helper: "Enter decommissioning CAPEX locked", expertMeaning: "decommissioning CAPEX locked" },
  ...
  reportTemplate: {
    title: "Nuclear and Offshore Decommissioning Timing Calculator Report",
