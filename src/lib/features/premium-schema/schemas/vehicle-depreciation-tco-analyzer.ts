...
export const VEHICLE_DEPRECIATION_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "salvageValue", label: "Residual value at end of life", label_i18n: {"en":"Residual value at end of life"}, type: "number", unit: "USD", required: true, smartDefault: 10000, validation: { min: 0 }, helper: "Aracın ekonomik ömrü sonundaki tahmini değeri.", helper_i18n: {"en":"Estimated value of the asset at the end of its economic life."}, expertMeaning: "Residual value at end of life", expertMeaning_i18n: {"en":"Residual value at end of life"} },
