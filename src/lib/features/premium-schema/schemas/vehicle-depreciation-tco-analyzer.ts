...
export const VEHICLE_DEPRECIATION_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "depreciationMethod", label: "SL, DB, MACRS or UoP", label_i18n: {"en":"SL, DB, MACRS or UoP"}, type: "select", unit: "", required: true, smartDefault: "SL", options: [...DEPRECIATION_METHOD_OPTIONS], helper: "", expertMeaning: "SL, DB, MACRS or UoP", expertMeaning_i18n: {"en":"SL, DB, MACRS or UoP"} },
