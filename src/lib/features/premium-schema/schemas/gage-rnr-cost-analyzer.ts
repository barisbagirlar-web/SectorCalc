...
export const GAGE_RNR_COST_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "tv", label: "TV (Total Varyans)", label_i18n: {"en":"TV (Total Varyans)"}, type: "number", unit: "", required: true, smartDefault: 0.015, validation: { min: 0.001 }, helper: "", expertMeaning: "Total variation", expertMeaning_i18n: {"en":"Total variation"} },
