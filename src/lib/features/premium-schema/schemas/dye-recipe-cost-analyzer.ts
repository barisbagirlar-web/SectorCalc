...
export const DYE_RECIPE_COST_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    { id: "bathRatio", label: "Liquor ratio (liquid:goods)", label_i18n: {"en":"Liquor ratio (liquid:goods)"}, type: "number", unit: "scalar", required: true, smartDefault: 10, validation: { min: 1 }, helper: "", expertMeaning: "Liquor ratio (liquid:goods)", expertMeaning_i18n: {"en":"Liquor ratio (liquid:goods)"} },
