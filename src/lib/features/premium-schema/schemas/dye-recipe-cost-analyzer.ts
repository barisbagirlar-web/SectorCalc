...
export const DYE_RECIPE_COST_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "waterTariff", label: "Su Tarifesi", label_i18n: {"en":"Water Tarifesi"}, type: "number", unit: "USD/m³", required: false, smartDefault: 3, validation: { min: 0 }, helper: "", expertMeaning: "Water cost per m³", expertMeaning_i18n: {"en":"Water cost per m³"} },
