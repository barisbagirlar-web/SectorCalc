...
export const CROP_YIELD_LOSS_SCHEMA: PremiumCalculatorSchema = {
  ...
  painStatement: "Verim kaybı ve finansal etkisi hesaplanmazsa, tarımsal müdahale kararları gecikir ve kayıp büyür.", painStatement_i18n: {"en":"Efficiency Loss ve finansal etkisi if not calculated, tarımsal intervention kararları delays ve kayıp büyür."},
  inputs: [
  ...
  thresholds: [{ fieldId: "yieldGap", warning: 100, critical: 300, direction: "higher_is_bad", warningMessage: "Verim farkı > 100 kg/da — müdahale değerlendirilmeli.", warningMessage_i18n: {"en":"Efficiency farkı > 100 kg/da — intervention değerlendirilmeli."}, criticalMessage: "Verim farkı > 300 kg/da — acil önlem gerekli.", criticalMessage_i18n: {"en":"Efficiency farkı > 300 kg/da — urgent measure gerekli."} }],
  formulaPipeline: [
