...
export const CROP_YIELD_LOSS_SCHEMA: PremiumCalculatorSchema = {
  ...
  painStatement: "Verim kaybı ve finansal etkisi hesaplanmazsa, tarımsal müdahale kararları gecikir ve kayıp büyür.", painStatement_i18n: {"en":"If Efficiency Loss and its financial impact are not calculated, agricultural intervention decisions are delayed and losses grow."},
  inputs: [
  ...
  outputs: [
    ...
    { id: "roiIntervention", label: "Müdahale ROI", label_i18n: {"en":"intervention ROI"}, unit: "", format: "number" },
  ],
  thresholds: [{ fieldId: "yieldGap", warning: 100, critical: 300, direction: "higher_is_bad", warningMessage: "Verim farkı > 100 kg/da — müdahale değerlendirilmeli.", warningMessage_i18n: {"en":"Efficiency difference > 100 kg/da — intervention should be evaluated."}, criticalMessage: "Verim farkı > 300 kg/da — acil önlem gerekli.", criticalMessage_i18n: {"en":"Efficiency difference > 300 kg/da — urgent measure required."} }],
  formulaPipeline: [
  ...
  assumptions: { hiddenLossMultiplier: 1.15, volatilityPercent: 15, targetMarginPercent: 20, assumptionNotes: ["Potansiyel = Genetik × Çevre.", "Verim farkı = Potansiyel - Gerçek.", "Müdahale ROI = (Geri kazanılan - Maliyet) / Maliyet."],assumptionNotes_i18n:[{"en":"Potential = Genetic × Environment."},{"en":"Yield difference = Potential - Actual."},{"en":"Intervention ROI = (Recovered - Cost) / Cost."}] },
};
