...
export const BOLT_TORQUE_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "torqueCoefficient", label: "Friction Coefficient (K)", label_i18n: {"en":"Friction Coefficient (K)"}, type: "number", unit: "scalar", required: true, smartDefault: 0.2, validation: { min: 0.05, max: 0.5 }, helper: "", expertMeaning: "Nut factor (typically 0.15-0.25)", expertMeaning_i18n: {"en":"Nut factor (typically 0.15-0.25)"} },
    { id: "grade", label: "Material Grade", label_i18n: {"en":"Material Grade"}, type: "select", unit: "scalar", required: true, smartDefault: "8.8", options: [...GRADE_OPTIONS], helper: "", expertMeaning: "Bolt grade per ISO 898", expertMeaning_i18n: {"en":"Bolt grade per ISO 898"} },
  ...
  outputs: [
    ...
    { id: "preloadForce", label: "Ongerilme Kuvveti (F)", label_i18n: {"en":"Ongerilme Kuvveti (F)"}, unit: "kN", format: "number" },
