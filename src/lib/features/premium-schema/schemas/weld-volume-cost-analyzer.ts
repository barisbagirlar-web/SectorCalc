...
export const WELD_VOLUME_COST_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "depEff", label: "Biriktirme Efficiency", label_i18n: {"en":"Biriktirme Efficiency"}, type: "number", unit: "scalar", required: false, smartDefault: 0.8, validation: { min: 0, max: 1 }, helper: "", expertMeaning: "Deposition efficiency", expertMeaning_i18n: {"en":"Deposition efficiency"} },
    ...
    { id: "machineEff", label: "Makine Efficiency", label_i18n: {"en":"Makine Efficiency"}, type: "number", unit: "scalar", required: false, smartDefault: 0.85, validation: { min: 0, max: 1 }, helper: "", expertMeaning: "Machine efficiency", expertMeaning_i18n: {"en":"Machine efficiency"} },
