...
export const WELD_VOLUME_COST_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "machineEff", label: "Makine Verimi", label_i18n: {"en":"Makine Efficiency"}, type: "number", unit: "", required: false, smartDefault: 0.85, validation: { min: 0, max: 1 }, helper: "", expertMeaning: "Machine efficiency", expertMeaning_i18n: {"en":"Machine efficiency"} },
    ...
    { id: "laborRate", label: "Labor cost per hour", label_i18n: {"en":"Labor cost per hour"}, type: "number", unit: "USD/saat", required: true, smartDefault: 35, validation: { min: 0 }, helper: "", expertMeaning: "Labor cost per hour", expertMeaning_i18n: {"en":"Labor cost per hour"} },
  ],
  outputs: [
    { id: "weldArea", label: "Kesit Alan", label_i18n: {"en":"Kesit Alan"}, unit: "mm²", format: "number" },
    { id: "weldVolume", label: "Kaynak Hacmi", label_i18n: {"en":"resource Volume"}, unit: "mm³", format: "number" },
    { id: "depositedWeight", label: "Biriktirilen Agrlk", label_i18n: {"en":"Biriktirilen Weight"}, unit: "kg", format: "number" },
