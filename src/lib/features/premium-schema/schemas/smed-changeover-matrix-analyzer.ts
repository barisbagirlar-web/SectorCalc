...
export const SMED_CHANGEOVER_SCHEMA: PremiumCalculatorSchema = {
  ...
  name: "SMED Değişim Matrisi & EBQ Analizi", name_i18n: {"en":"SMED Degisim Matrisi & EBQ Analizi","tr":"SMED Değişim Matrisi & EBQ Analizi"}, sectorSlug: "cnc-manufacturing", category: "measurement",
