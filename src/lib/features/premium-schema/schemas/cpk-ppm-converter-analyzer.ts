...
export const CPK_PPM_SCHEMA: PremiumCalculatorSchema = {
  ...
  outputs: [
    ...
    { id: "expectedDefectsDaily", label: "Tahmini Günlük Hata", label_i18n: {"en":"Estimated Daily Error"}, unit: "adet/gün", format: "number", isBigNumber: true },
  ],
  thresholds: [
    { fieldId: "cpk", warning: 1.33, critical: 1.0, direction: "lower_is_bad", warningMessage: "Cpk < 1.33 — proses iyileştirme gerekiyor.", warningMessage_i18n: {"en":"Cpk < 1.33 — proses improvement gerekiyor."}, criticalMessage: "Cpk < 1.0 — proses yetersiz, acil aksiyon.", criticalMessage_i18n: {"en":"Cpk < 1.0 — proses insufficient, urgent aksiyon."} },
  ],
  formulaPipeline: [
