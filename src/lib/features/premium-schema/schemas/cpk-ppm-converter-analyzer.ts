...
export const CPK_PPM_SCHEMA: PremiumCalculatorSchema = {
  ...
  name: "CPK → PPM & Sigma Seviye Dönüştürücü", name_i18n: {"en":"CPK → PPM & Sigma Seviye Donusturucu"}, sectorSlug: "cnc-manufacturing", category: "measurement",
  ...
  inputs: [
    ...
    { id: "mean", label: "Proses Ortalaması", label_i18n: {"en":"Process mean"}, type: "number", unit: "", required: true, smartDefault: 10.0, validation: { min: 0 }, helper: "", expertMeaning: "Process mean", expertMeaning_i18n: {"en":"Process mean"} },
    { id: "stdDev", label: "Standart Sapma", label_i18n: {"en":"Standart Sapma"}, type: "number", unit: "", required: true, smartDefault: 0.015, validation: { min: 0.0001 }, helper: "", expertMeaning: "Process standard deviation", expertMeaning_i18n: {"en":"Process standard deviation"} },
    ...
    { id: "dailyVolume", label: "Günlük Üretim Hacmi", label_i18n: {"en":"Daily production volume"}, type: "number", unit: "adet", required: false, smartDefault: 1000, validation: { min: 0 }, helper: "", expertMeaning: "Daily production volume", expertMeaning_i18n: {"en":"Daily production volume"} },
  ],
  outputs: [
    ...
    { id: "totalPpm", label: "Toplam PPM", label_i18n: {"en":"Toplam PPM"}, unit: "", format: "number" },
    { id: "sigmaShort", label: "Sigma Seviyesi (Kısa Dönem)", label_i18n: {"en":"Sigma Seviyesi (Ksa Donem)"}, unit: "", format: "number" },
    { id: "expectedDefectsDaily", label: "Tahmini Günlük Hata", label_i18n: {"en":"Tahmini Gunluk Hata"}, unit: "adet/gün", format: "number", isBigNumber: true },
  ],
  thresholds: [
    { fieldId: "cpk", warning: 1.33, critical: 1.0, direction: "lower_is_bad", warningMessage: "Cpk < 1.33 — proses iyileştirme gerekiyor.", warningMessage_i18n: {"en":"Cpk < 1.33 — proses iyileştirme gerekiyor."}, criticalMessage: "Cpk < 1.0 — proses yetersiz, acil aksiyon.", criticalMessage_i18n: {"en":"Cpk < 1.0 — proses yetersiz, acil aksiyon."} },
  ],
  formulaPipeline: [
