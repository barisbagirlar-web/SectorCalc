...
export const SAAS_SHELFWARE_ANALYZER: PremiumCalculatorSchema = {
  ...
  inputs: [
    { id: "totalLicenses", label: "Total License Count", label_i18n: {"en":"Total License Count"}, type: "number", unit: "adet", required: true, smartDefault: 500, validation: { min: 1 }, helper: "", expertMeaning: "Total active licenses", expertMeaning_i18n: {"en":"Total active licenses"} },
  ...
  assumptions: { hiddenLossMultiplier: 1.1, volatilityPercent: 10, targetMarginPercent: 15, assumptionNotes: ["Shelfware % = (lisans − aktif) / lisans × 100.", "Maliyet = (lisans − aktif) × koltuk maliyeti × 12.", "Users below low usage threshold are considered shelfware."],assumptionNotes_i18n:[{"en":"Shelfware % = (licenses − active) / licenses × 100."},{"en":"Cost = (licenses − active) × seat cost × 12."},{"en":"Users below low usage threshold are considered shelfware."}] },
};
