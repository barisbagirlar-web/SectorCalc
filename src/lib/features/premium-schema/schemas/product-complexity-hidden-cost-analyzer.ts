...
export const PRODUCT_COMPLEXITY_SCHEMA: PremiumCalculatorSchema = {
  ...
  thresholds: [
    { fieldId: "hiddenCostComplexity", warning: 50000, critical: 150000, direction: "higher_is_bad", warningMessage: "Gizli maliyet > $50K — ürün gruplaması ve standardizasyon önerilir.", warningMessage_i18n: {"en":"Latent cost > $50K — product grouping and standardization are recommended."}, criticalMessage: "Gizli maliyet > $150K — acil portföy sadeleştirmesi gerekli.", criticalMessage_i18n: {"en":"Latent cost > $150K — urgent portfolio simplification is required."} },
    { fieldId: "complexityIndex", warning: 50, critical: 80, direction: "higher_is_bad", warningMessage: "Karmaşıklık endeksi > 50 — üretim hücreleri gözden geçirilmeli.", warningMessage_i18n: {"en":"Complexity index > 50 — production cells should be reviewed."}, criticalMessage: "Karmaşıklık endeksi > 80 — ürün mimarisi yeniden tasarlanmalı.", criticalMessage_i18n: {"en":"Complexity index > 80 — product architecture must be redesigned."} },
  ],
  formulaPipeline: [
