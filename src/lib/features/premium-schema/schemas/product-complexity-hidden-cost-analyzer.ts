...
export const PRODUCT_COMPLEXITY_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "complexityScore", label: "Engineering complexity rating", label_i18n: {"en":"Engineering complexity rating"}, type: "number", unit: "scalar", required: false, smartDefault: 5, validation: { min: 1, max: 10 }, helper: "", expertMeaning: "Engineering complexity rating", expertMeaning_i18n: {"en":"Engineering complexity rating"} },
