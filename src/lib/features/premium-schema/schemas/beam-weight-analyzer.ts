...
export const BEAM_WEIGHT_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    { id: "profileType", label: "Profile Type", label_i18n: {"en":"Profile Type"}, type: "select", unit: "", enumValues: ["HEA", "HEB", "IPE", "UPN", "kutu"], required: true, smartDefault: "HEA", helper: "", expertMeaning: "Steel profile type", expertMeaning_i18n: {"en":"Steel profile type"} },
    ...
    { id: "quantity", label: "Quantity", label_i18n: {"en":"Quantity"}, type: "number", unit: "", required: false, smartDefault: 10, validation: { min: 1 }, helper: "", expertMeaning: "Number of beams", expertMeaning_i18n: {"en":"Number of beams"} },
