...
export const FUEL_ROUTE_DRIFT_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "numTrips", label: "Annual trip count", label_i18n: {"en":"Annual trip count"}, type: "number", unit: "sefer/yıl", required: true, smartDefault: 250, validation: { min: 1 }, helper: "", expertMeaning: "Annual trip count", expertMeaning_i18n: {"en":"Annual trip count"} },
    ...
    { id: "fleetSize", label: "Fleet size", label_i18n: {"en":"Fleet size"}, type: "number", unit: "araç", required: false, smartDefault: 10, validation: { min: 1 }, helper: "", expertMeaning: "Fleet size", expertMeaning_i18n: {"en":"Fleet size"} },
  ],
  outputs: [
    ...
    { id: "idleFuelCost", label: "Route Fuel Cost", label_i18n: {"en":"Route Fuel Cost"}, unit: "USD/yıl", format: "currency" },
