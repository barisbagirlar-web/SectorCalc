...
export const DOWNTIME_COST_ANALYZER_SCHEMA: PremiumCalculatorSchema = {
  ...
  painStatement: "The actual cost of unplanned downtime includes not only lost production but also labor, energy, quality, and customer penalties. This tool calculates the 6-component total downtime cost.", painStatement_i18n: {"en":"The actual cost of unplanned downtime includes not only lost production but also labor, energy, quality, and customer penalties. This tool calculates the 6-component total downtime cost."},
  inputs: [
    { id: "downtimeHours", label: "Total downtime hours", label_i18n: {"en":"Total downtime hours"}, type: "number", unit: "hours", required: true, smartDefault: 4, validation: { min: 0 }, helper: "", expertMeaning: "Total downtime hours", expertMeaning_i18n: {"en":"Total downtime hours"} },
    { id: "affectedWorkers", label: "Number of idle workers", label_i18n: {"en":"Number of idle workers"}, type: "number", unit: "people", required: true, smartDefault: 5, validation: { min: 0 }, helper: "", expertMeaning: "Number of idle workers", expertMeaning_i18n: {"en":"Number of idle workers"} },
    { id: "avgHourlyRate", label: "Average wage rate", label_i18n: {"en":"Average wage rate"}, type: "number", unit: "USD/hour", required: true, smartDefault: 25, validation: { min: 0 }, helper: "", expertMeaning: "Average wage rate", expertMeaning_i18n: {"en":"Average wage rate"} },
    { id: "lineCapacityPerHour", label: "Line Capacity", label_i18n: {"en":"Line Capacity"}, type: "number", unit: "units/hour", required: true, smartDefault: 100, validation: { min: 0 }, helper: "", expertMeaning: "Production line capacity per hour", expertMeaning_i18n: {"en":"Production line capacity per hour"} },
    ...
    { id: "overtimeHours", label: "Overtime Hours", label_i18n: {"en":"Overtime Hours"}, type: "number", unit: "hours", required: false, smartDefault: 2, validation: { min: 0 }, helper: "", expertMeaning: "Recovery overtime hours", expertMeaning_i18n: {"en":"Recovery overtime hours"} },
    { id: "overtimeRate", label: "Overtime hourly rate (1.5x)", label_i18n: {"en":"Overtime hourly rate (1.5x)"}, type: "number", unit: "USD/hour", required: false, smartDefault: 37.5, validation: { min: 0 }, helper: "", expertMeaning: "Overtime hourly rate (1.5x)", expertMeaning_i18n: {"en":"Overtime hourly rate (1.5x)"} },
    { id: "startupScrapUnits", label: "Startup Scrap", label_i18n: {"en":"Startup Scrap"}, type: "number", unit: "units", required: false, smartDefault: 20, validation: { min: 0 }, helper: "", expertMeaning: "Scrap after restart", expertMeaning_i18n: {"en":"Scrap after restart"} },
    ...
    { id: "mtbfHours", label: "MTBF", label_i18n: {"en":"MTBF"}, type: "number", unit: "hours", required: false, smartDefault: 8760, validation: { min: 0 }, helper: "", expertMeaning: "Mean Time Between Failures", expertMeaning_i18n: {"en":"Mean Time Between Failures"} },
  ],
  outputs: [
