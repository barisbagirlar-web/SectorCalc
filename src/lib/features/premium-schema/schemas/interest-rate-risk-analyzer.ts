...
export const INTEREST_RATE_RISK_SCHEMA: PremiumCalculatorSchema = {
  ...
  outputs: [
    ...
    { id: "shockImpact", label: "Şok Etkisi (100bps)", label_i18n: {"en":"Sok Etkisi (100bps)","tr":"Şok Etkisi (100bps)"}, unit: "USD", format: "currency" },
    { id: "eveChange", label: "EVE Değişimi", label_i18n: {"en":"EVE Degisimi","tr":"EVE Değişimi"}, unit: "USD", format: "currency" },
