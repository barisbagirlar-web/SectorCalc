...
export const INTEREST_RATE_RISK_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "zScore", label: "Confidence z-score", label_i18n: {"en":"Confidence z-score"}, type: "number", unit: "scalar", required: false, smartDefault: 2.33, validation: { min: 0, max: 4 }, helper: "", expertMeaning: "Confidence z-score", expertMeaning_i18n: {"en":"Confidence z-score"} },
