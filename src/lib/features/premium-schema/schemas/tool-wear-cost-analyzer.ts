...
export const TOOL_WEAR_COST_ANALYZER: PremiumCalculatorSchema = {
  ...
  inputs: [
    { id: "toolCost", label: "Tool Unit Cost", label_i18n: {"en":"Tool Unit Cost"}, type: "number", unit: "USD/takim", required: true, smartDefault: 50, validation: { min: 0.01 }, helper: "", expertMeaning: "Cost per tool", expertMeaning_i18n: {"en":"Cost per tool"} },
    { id: "toolLifeParts", label: "Tool Life", label_i18n: {"en":"Tool Life"}, type: "number", unit: "parca", required: true, smartDefault: 500, validation: { min: 1 }, helper: "", expertMeaning: "Parts produced per tool life", expertMeaning_i18n: {"en":"Parts produced per tool life"} },
    ...
    { id: "numToolsPerYear", label: "Annual Tool Usage", label_i18n: {"en":"Annual Tool Usage"}, type: "number", unit: "adet/yil", required: false, smartDefault: 100, validation: { min: 1 }, helper: "", expertMeaning: "Number of tools used per year", expertMeaning_i18n: {"en":"Number of tools used per year"} },
  ],
  outputs: [
    { id: "toolingCostPerPart", label: "Parca Bas Takm Maliyeti", label_i18n: {"en":"Parts Bas Takm Cost"}, unit: "USD/parca", format: "currency" },
    { id: "toolingTotal", label: "Toplam Takm Maliyeti", label_i18n: {"en":"Total Takm Cost"}, unit: "USD/yil", format: "currency", isBigNumber: true },
    { id: "prematureFailureCost", label: "Erken Krlma Maliyeti", label_i18n: {"en":"Erken Krlma Cost"}, unit: "USD/yil", format: "currency" },
  ],
