...
export const CNC_CYCLE_TIME_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "toothCount", label: "Number of Teeth (z)", label_i18n: {"en":"Number of Teeth (z)"}, type: "number", unit: "scalar", required: true, smartDefault: 4, validation: { min: 1 }, helper: "", expertMeaning: "Number of teeth", expertMeaning_i18n: {"en":"Number of teeth"} },
    ...
    { id: "cutLength", label: "Cutting Length (L)", label_i18n: {"en":"Cutting Length (L)"}, type: "number", unit: "mm", required: true, smartDefault: 100, validation: { min: 1 }, helper: "", expertMeaning: "Cutting path length", expertMeaning_i18n: {"en":"Cutting path length"} },
    ...
    { id: "toolChanges", label: "Number of Tool Changes", label_i18n: {"en":"Number of Tool Changes"}, type: "number", unit: "scalar", required: false, smartDefault: 2, validation: { min: 0 }, helper: "", expertMeaning: "Number of tool changes", expertMeaning_i18n: {"en":"Number of tool changes"} },
    ...
    { id: "plannedTime", label: "Planned Production Time", label_i18n: {"en":"Planned Production Time"}, type: "number", unit: "dak", required: false, smartDefault: 480, validation: { min: 0 }, helper: "", expertMeaning: "Planned production time", expertMeaning_i18n: {"en":"Planned production time"} },
    ...
    { id: "totalParts", label: "Total Parts", label_i18n: {"en":"Total Parts"}, type: "number", unit: "units", required: false, smartDefault: 100, validation: { min: 0 }, helper: "", expertMeaning: "Total parts produced", expertMeaning_i18n: {"en":"Total parts produced"} },
  ],
  outputs: [
    { id: "cutTime", label: "Cutting Time (T_cut)", label_i18n: {"en":"Cutting Time (T_cut)"}, unit: "dak", format: "number" },
    { id: "totalCycleTime", label: "Total Cycle Time", label_i18n: {"en":"Total Cycle Time"}, unit: "dak", format: "number" },
    { id: "cyclePerPart", label: "Time Per Part", label_i18n: {"en":"Time Per Part"}, unit: "min/unit", format: "number" },
