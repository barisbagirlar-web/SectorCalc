...
export const SEED_RATE_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "seedUnitCost", label: "Seed Unit Cost", label_i18n: {"en":"Seed Unit Cost"}, type: "number", unit: "USD/kg", required: true, smartDefault: 3, validation: { min: 0.01 }, helper: "", expertMeaning: "Seed cost per kg", expertMeaning_i18n: {"en":"Seed cost per kg"} },
    ...
    { id: "desiredStandCount", label: "Target Plant Count", label_i18n: {"en":"Target Plant Count"}, type: "number", unit: "units/acre", required: false, smartDefault: 5000, validation: { min: 0 }, helper: "", expertMeaning: "Target plant stand per decare", expertMeaning_i18n: {"en":"Target plant stand per decare"} },
  ],
  outputs: [
