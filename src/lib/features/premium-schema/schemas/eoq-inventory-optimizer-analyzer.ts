...
export const EOQ_INVENTORY_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "zScore", label: "Z-Skor (Servis level)", label_i18n: {"en":"Z-Skor (Servis level)"}, type: "number", unit: "", required: false, smartDefault: 1.65, validation: { min: 0, max: 4 }, helper: "", expertMeaning: "Z-score for 95% service", expertMeaning_i18n: {"en":"Z-score for 95% service"} },
