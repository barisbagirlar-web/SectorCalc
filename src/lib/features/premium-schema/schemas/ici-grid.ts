...
export const ICI_GRID_SCHEMA: PremiumCalculatorSchema = {
  id: "ici-grid",
  name: "Grid Injection Capacity Commitment Calculator",
  sectorSlug: "industrial",
  category: "industrial",
  legacyPaidSlug: "ici-grid",
  ...
  inputs: [
    { id: "expectedValue", label: "expected injection capacity", type: "number", required: true, unit: "unit", helper: "Enter expected injection capacity", expertMeaning: "expected injection capacity" },
    { id: "uncertaintySigma", label: "capacity / stability / curtailment uncertainty", type: "number", required: true, unit: "unit", helper: "Enter capacity / stability / curtailment uncertainty", expertMeaning: "capacity / stability / curtailment uncertainty" },
    { id: "downsideLoss", label: "curtailment loss exposure", type: "number", required: true, unit: "unit", helper: "Enter curtailment loss exposure", expertMeaning: "curtailment loss exposure" },
    { id: "delayCost", label: "cost of waiting for queue position", type: "number", required: true, unit: "unit", helper: "Enter cost of waiting for queue position", expertMeaning: "cost of waiting for queue position" },
    { id: "irreversibleCapex", label: "grid upgrade CAPEX locked", type: "number", required: true, unit: "unit", helper: "Enter grid upgrade CAPEX locked", expertMeaning: "grid upgrade CAPEX locked" },
  ...
  reportTemplate: {
    title: "Grid Injection Capacity Commitment Calculator Report",
