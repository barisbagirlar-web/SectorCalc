...
export const TRANSFER_PRICING_OPTIMIZER_SCHEMA: PremiumCalculatorSchema = {
  ...
  thresholds: [{ fieldId: "transferTaxImpact", warning: 30000, critical: 75000, direction: "higher_is_bad", warningMessage: "Vergi etkisi > $30K — transfer fiyatı optimize edilmeli.", warningMessage_i18n: {"en":"tax etkisi > $30K — transfer fiyatı optimize edilmeli."}, criticalMessage: "Vergi etkisi > $75K — vergi danışmanlığı önerilir.", criticalMessage_i18n: {"en":"tax etkisi > $75K — tax danışmanlığı önerilir."} }],
  formulaPipeline: [
