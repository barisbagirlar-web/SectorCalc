...
export const ICI_INFRA_LIFE_SCHEMA: PremiumCalculatorSchema = {
  id: "ici-infra-life",
  name: "Infrastructure Remaining Life Commitment Calculator",
  sectorSlug: "industrial",
  category: "industrial",
  legacyPaidSlug: "ici-infra-life",
  ...
  inputs: [
    { id: "expectedValue", label: "expected remaining life", type: "number", required: true, unit: "unit", helper: "Enter expected remaining life", expertMeaning: "expected remaining life" },
    { id: "uncertaintySigma", label: "fatigue and deterioration uncertainty", type: "number", required: true, unit: "unit", helper: "Enter fatigue and deterioration uncertainty", expertMeaning: "fatigue and deterioration uncertainty" },
    { id: "downsideLoss", label: "serviceability failure exposure", type: "number", required: true, unit: "unit", helper: "Enter serviceability failure exposure", expertMeaning: "serviceability failure exposure" },
    { id: "delayCost", label: "cost of user restriction", type: "number", required: true, unit: "unit", helper: "Enter cost of user restriction", expertMeaning: "cost of user restriction" },
    { id: "irreversibleCapex", label: "renewal CAPEX locked", type: "number", required: true, unit: "unit", helper: "Enter renewal CAPEX locked", expertMeaning: "renewal CAPEX locked" },
  ...
  reportTemplate: {
    title: "Infrastructure Remaining Life Commitment Calculator Report",
