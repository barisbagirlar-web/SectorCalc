...
export const AI_TOKEN_COST_ANALYZER_SCHEMA: PremiumCalculatorSchema = {
  ...
  outputs: [
    { id: "dailyBasePromptCost", label: "Günlük Prompt Maliyeti", label_i18n: {"en":"Daily Prompt Cost"}, unit: "USD", format: "currency" },
    { id: "dailyBaseCompletionCost", label: "Günlük Completion Maliyeti", label_i18n: {"en":"Daily Completion Cost"}, unit: "USD", format: "currency" },
    { id: "dailyCacheNetCost", label: "Günlük Cache Net Maliyeti", label_i18n: {"en":"Daily Cache Net Cost"}, unit: "USD", format: "currency" },
    { id: "dailyBaseCost", label: "Günlük Toplam Baz Maliyet", label_i18n: {"en":"Daily Total Base Cost"}, unit: "USD", format: "currency" },
