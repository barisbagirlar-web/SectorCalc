...
export const BID_RISK_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "numCompetitors", label: "Number of Competitors", label_i18n: {"en":"Number of Competitors"}, type: "number", unit: "adet", required: false, smartDefault: 5, validation: { min: 0 }, helper: "", expertMeaning: "Number of competing bidders", expertMeaning_i18n: {"en":"Number of competing bidders"} },
