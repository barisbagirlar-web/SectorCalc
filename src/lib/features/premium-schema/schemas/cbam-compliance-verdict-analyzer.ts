...
export const CBAM_COMPLIANCE_SCHEMA: PremiumCalculatorSchema = {
  ...
  thresholds: [
    ...
    { fieldId: "financialLiability", warning: 25000, critical: 75000, direction: "higher_is_bad", warningMessage: "Yükümlülük > $25K — fiyatlama stratejisi gözden geçirilmeli.", warningMessage_i18n: {"en":"obligation > $25K — fiyatlama stratejisi gözden geçirilmeli."}, criticalMessage: "Yükümlülük > $75K — alternatif tedarikçi değerlendirilmeli.", criticalMessage_i18n: {"en":"obligation > $75K — alternatif supplier değerlendirilmeli."} },
  ],
  formulaPipeline: [
