...
export const CALIBRATION_DRIFT_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    { id: "lastCalibrationError", label: "Last Calibration Error", label_i18n: {"en":"Last Calibration Error"}, type: "number", unit: "scalar", required: true, smartDefault: 0.5, validation: { min: 0 }, helper: "", expertMeaning: "Last calibration deviation", expertMeaning_i18n: {"en":"Last calibration deviation"} },
    { id: "previousCalibrationError", label: "Previous Calibration Error", label_i18n: {"en":"Previous Calibration Error"}, type: "number", unit: "scalar", required: true, smartDefault: 0.2, validation: { min: 0 }, helper: "", expertMeaning: "Previous calibration deviation", expertMeaning_i18n: {"en":"Previous calibration deviation"} },
    ...
    { id: "baseUncertainty", label: "Base Uncertainty", label_i18n: {"en":"Base Uncertainty"}, type: "number", unit: "scalar", required: true, smartDefault: 0.3, validation: { min: 0 }, helper: "", expertMeaning: "Base measurement uncertainty", expertMeaning_i18n: {"en":"Base measurement uncertainty"} },
    { id: "toleranceLimit", label: "Tolerance Limit", label_i18n: {"en":"Tolerance Limit"}, type: "number", unit: "scalar", required: true, smartDefault: 1.0, validation: { min: 0.001 }, helper: "", expertMeaning: "Specification tolerance", expertMeaning_i18n: {"en":"Specification tolerance"} },
    { id: "criticalityLevel", label: "Criticality Level (1-5)", label_i18n: {"en":"Criticality Level (1-5)"}, type: "number", unit: "scalar", required: true, smartDefault: 3, validation: { min: 1, max: 5 }, helper: "", expertMeaning: "Criticality rating", expertMeaning_i18n: {"en":"Criticality rating"} },
    { id: "usageFrequency", label: "Usage Frequency (1-5)", label_i18n: {"en":"Usage Frequency (1-5)"}, type: "number", unit: "scalar", required: false, smartDefault: 4, validation: { min: 1, max: 5 }, helper: "", expertMeaning: "Frequency of use", expertMeaning_i18n: {"en":"Frequency of use"} },
    ...
    { id: "environmentalFactor", label: "Environmental Factor", label_i18n: {"en":"Environmental Factor"}, type: "number", unit: "scalar", required: false, smartDefault: 0.1, validation: { min: 0 }, helper: "", expertMeaning: "Environmental contribution", expertMeaning_i18n: {"en":"Environmental contribution"} },
  ...
  outputs: [
    ...
    { id: "currentUncertainty", label: "Guncel Olcum Belirsizligi", label_i18n: {"en":"Guncel Olcum Belirsizligi"}, unit: "scalar", format: "number" },
    { id: "riskScore", label: "Kalibrasyon Risk Skoru", label_i18n: {"en":"Kalibrasyon Risk Skoru"}, unit: "scalar", format: "score" },
