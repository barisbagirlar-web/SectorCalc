...
export const CALIBRATION_DRIFT_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "timeBetweenCalibrations", label: "Time Between Calibrations", label_i18n: {"en":"Time Between Calibrations"}, type: "number", unit: "gun", required: true, smartDefault: 180, validation: { min: 1 }, helper: "", expertMeaning: "Days between calibrations", expertMeaning_i18n: {"en":"Days between calibrations"} },
    { id: "timeSinceLastCalibration", label: "Time Since Last Calibration", label_i18n: {"en":"Time Since Last Calibration"}, type: "number", unit: "gun", required: false, smartDefault: 90, validation: { min: 0 }, helper: "", expertMeaning: "Days since last calibration", expertMeaning_i18n: {"en":"Days since last calibration"} },
    ...
    { id: "standardCalibrationInterval", label: "Standard Calibration Interval", label_i18n: {"en":"Standard Calibration Interval"}, type: "number", unit: "gun", required: false, smartDefault: 365, validation: { min: 1 }, helper: "", expertMeaning: "Manufacturer recommended interval", expertMeaning_i18n: {"en":"Manufacturer recommended interval"} },
  ...
  outputs: [
    ...
    { id: "optimalInterval", label: "Optimal Kalibrasyon Aralg", label_i18n: {"en":"Optimal Kalibrasyon Aralg"}, unit: "gun", format: "number" },
