...
export const CUT_FILL_BALANCE_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "swellFactor", label: "Material swell factor", label_i18n: {"en":"Material swell factor"}, type: "number", unit: "", required: false, smartDefault: 1.25, validation: { min: 1 }, helper: "", expertMeaning: "Material swell factor", expertMeaning_i18n: {"en":"Material swell factor"} },
