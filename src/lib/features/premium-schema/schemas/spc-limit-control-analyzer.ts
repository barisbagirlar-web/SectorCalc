...
export const SPC_LIMIT_SCHEMA: PremiumCalculatorSchema = {
  ...
  formulaPipeline: [
    ...
    { formulaId: "measurement.spc_ucl_x", inputMap: { xBarBar: "xBarAvg", a2: "subgroupSize", rBar: "rBar" }, outputId: "uclX" },
    { formulaId: "measurement.spc_lcl_x", inputMap: { xBarBar: "xBarAvg", a2: "subgroupSize", rBar: "rBar" }, outputId: "lclX" },
    { formulaId: "measurement.spc_sigma_estimate", inputMap: { rBar: "rBar", d2: "subgroupSize" }, outputId: "sigmaEstimate" },
    { formulaId: "measurement.spc_cp", inputMap: { usl: "usl", lsl: "lsl", sigma: "sigmaEstimate" }, outputId: "cp" },
  ],
