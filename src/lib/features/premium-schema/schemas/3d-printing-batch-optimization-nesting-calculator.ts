...
export const THREE_B_PRINTING_BATCH_NESTING_SCHEMA: PremiumCalculatorSchema = {
  id: "3d-printing-batch-optimization-nesting-calculator",
  legacyPaidSlug: "3d-printing-batch-optimization-nesting-calculator",
