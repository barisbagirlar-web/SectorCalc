...
export const AUTO_SHOP_MARGIN_LEAK_SCHEMA: PremiumCalculatorSchema = {
  ...
  painStatement: "Small deviations in Parts and labor margin in auto repair shops turn into annual leakage of hundreds of thousands of dollars. This tool analyzes Margin structure and calculates annual leakage.", painStatement_i18n: {"en":"Small deviations in Parts and labor margin in auto repair shops turn into annual leakage of hundreds of thousands of dollars. This tool analyzes Margin structure and calculates annual leakage."},
  inputs: [
    ...
    { id: "inventoryShrinkage", label: "Inventory Shrinkage", label_i18n: {"en":"Inventory Shrinkage"}, type: "number", unit: "USD", required: false, smartDefault: 2000, validation: { min: 0 }, helper: "", expertMeaning: "Inventory shrinkage/loss", expertMeaning_i18n: {"en":"Inventory shrinkage/loss"} },
    { id: "totalFlagHours", label: "Flag Hours", label_i18n: {"en":"Flag Hours"}, type: "number", unit: "hours", required: true, smartDefault: 800, validation: { min: 0 }, helper: "", expertMeaning: "Total billed hours", expertMeaning_i18n: {"en":"Total billed hours"} },
    { id: "totalAvailableHours", label: "Available Hours", label_i18n: {"en":"Available Hours"}, type: "number", unit: "hours", required: false, smartDefault: 1000, validation: { min: 0 }, helper: "", expertMeaning: "Total available technician hours", expertMeaning_i18n: {"en":"Total available technician hours"} },
    { id: "totalOpEx", label: "Total OpEx", label_i18n: {"en":"Total OpEx"}, type: "number", unit: "USD", required: false, smartDefault: 35000, validation: { min: 0 }, helper: "", expertMeaning: "Total operating expenses", expertMeaning_i18n: {"en":"Total operating expenses"} },
    ...
    { id: "netMarginInput", label: "Net Margin (%)", label_i18n: {"en":"Net Margin (%)"}, type: "number", unit: "%", required: true, smartDefault: 8, validation: { min: 0, max: 100 }, helper: "Your current net profit margin.", helper_i18n: {"en":"Your current net profit margin."}, expertMeaning: "Current Net profit margin percentage", expertMeaning_i18n: {"en":"Current Net profit margin percentage"} },
  ],
  outputs: [
    ...
    { id: "netMargin", label: "Net Margin", label_i18n: {"en":"Net Margin"}, unit: "%", format: "percentage" },
