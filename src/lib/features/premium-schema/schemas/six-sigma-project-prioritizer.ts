...
export const SIX_SIGMA_PRIORITIZER_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    { id: "productionVolume", label: "Units produced", label_i18n: {"en":"Units produced"}, type: "number", unit: "units", required: true, smartDefault: 100000, validation: { min: 1 }, helper: "", expertMeaning: "Units produced", expertMeaning_i18n: {"en":"Units produced"} },
    { id: "defectiveUnits", label: "Defect count", label_i18n: {"en":"Defect count"}, type: "number", unit: "units", required: true, smartDefault: 5000, validation: { min: 0 }, helper: "", expertMeaning: "Defect count", expertMeaning_i18n: {"en":"Defect count"} },
    { id: "opportunitiesPerUnit", label: "Opportunities per unit", label_i18n: {"en":"Opportunities per unit"}, type: "number", unit: "scalar", required: true, smartDefault: 1, validation: { min: 1 }, helper: "", expertMeaning: "Opportunities per unit", expertMeaning_i18n: {"en":"Opportunities per unit"} },
    ...
    { id: "preventionCost", label: "Training, FMEA, SPC", label_i18n: {"en":"Training, FMEA, SPC"}, type: "number", unit: "USD", required: false, smartDefault: 10000, validation: { min: 0 }, helper: "", expertMeaning: "Training, FMEA, SPC", expertMeaning_i18n: {"en":"Training, FMEA, SPC"} },
    { id: "currentZBench", label: "Current Z_bench", label_i18n: {"en":"Current Z_bench"}, type: "number", unit: "scalar", required: false, smartDefault: 3, validation: { min: 0, max: 6 }, helper: "", expertMeaning: "Current sigma benchmark", expertMeaning_i18n: {"en":"Current sigma benchmark"} },
    { id: "targetSigmaLevel", label: "Hedef Sigma", label_i18n: {"en":"Hedef Sigma"}, type: "number", unit: "scalar", required: true, smartDefault: 5, validation: { min: 1, max: 6 }, helper: "", expertMeaning: "Target sigma level", expertMeaning_i18n: {"en":"Target sigma level"} },
    { id: "safetyImpact", label: "Safety score", label_i18n: {"en":"Safety score"}, type: "number", unit: "scalar", required: false, smartDefault: 5, validation: { min: 1, max: 10 }, helper: "", expertMeaning: "Safety score", expertMeaning_i18n: {"en":"Safety score"} },
    { id: "customerImpact", label: "Customer impact score", label_i18n: {"en":"Customer impact score"}, type: "number", unit: "scalar", required: false, smartDefault: 7, validation: { min: 1, max: 10 }, helper: "", expertMeaning: "Customer impact score", expertMeaning_i18n: {"en":"Customer impact score"} },
    { id: "recoveryProbability", label: "Probability of recovery", label_i18n: {"en":"Probability of recovery"}, type: "number", unit: "scalar", required: false, smartDefault: 0.5, validation: { min: 0, max: 1 }, helper: "", expertMeaning: "Probability of recovery", expertMeaning_i18n: {"en":"Probability of recovery"} },
    { id: "implementationEase", label: "Ease of implementation", label_i18n: {"en":"Ease of implementation"}, type: "number", unit: "scalar", required: false, smartDefault: 5, validation: { min: 1, max: 10 }, helper: "", expertMeaning: "Ease of implementation", expertMeaning_i18n: {"en":"Ease of implementation"} },
  ],
  outputs: [
    { id: "dpmo", label: "DPMO", label_i18n: {"en":"DPMO"}, unit: "scalar", format: "number" },
    { id: "yield", label: "Yield", label_i18n: {"en":"Yield"}, unit: "%", format: "percentage" },
    { id: "zBench", label: "Z_bench", label_i18n: {"en":"Z_bench"}, unit: "scalar", format: "number" },
    { id: "sigmaLevel", label: "Sigma Level", label_i18n: {"en":"Sigma Level"}, unit: "scalar", format: "number" },
