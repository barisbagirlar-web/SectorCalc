...
export const SIX_SIGMA_PRIORITIZER_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "currentZBench", label: "Current Z_bench", label_i18n: {"en":"Current Z_bench"}, type: "number", unit: "", required: false, smartDefault: 3, validation: { min: 0, max: 6 }, helper: "", expertMeaning: "Current sigma benchmark", expertMeaning_i18n: {"en":"Current sigma benchmark"} },
    ...
    { id: "safetyImpact", label: "Safety score", label_i18n: {"en":"Safety score"}, type: "number", unit: "", required: false, smartDefault: 5, validation: { min: 1, max: 10 }, helper: "", expertMeaning: "Safety score", expertMeaning_i18n: {"en":"Safety score"} },
