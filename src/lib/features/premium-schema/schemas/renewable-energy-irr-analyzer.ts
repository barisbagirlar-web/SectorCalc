...
export const RENEWABLE_ENERGY_IRR_SCHEMA: PremiumCalculatorSchema = {
  ...
  thresholds: [
    { fieldId: "renewableNpv", warning: 0, critical: -50000, direction: "lower_is_bad", warningMessage: "NPV pozitif değil — yatırım fizibilitesi zayıf.", warningMessage_i18n: {"en":"NPV pozitif değil — Investment fizibilitesi zayıf."}, criticalMessage: "NPV < -$50K — yatırım yapılmamalı, alternatifler değerlendirilmeli.", criticalMessage_i18n: {"en":"NPV < -$50K — Investment yapılmamalı, alternatifler değerlendirilmeli."} },
    { fieldId: "renewableLcoe", warning: 0.12, critical: 0.20, direction: "higher_is_bad", warningMessage: "LCOE > $0.12/kWh — şebeke paritesi riski var.", warningMessage_i18n: {"en":"LCOE > $0.12/kWh — şebeke paritesi riski var."}, criticalMessage: "LCOE > $0.20/kWh — proje ekonomik olarak sürdürülemez.", criticalMessage_i18n: {"en":"LCOE > $0.20/kWh — proje economical olarak sürdürülemez."} },
    { fieldId: "renewableIrr", warning: 8, critical: 5, direction: "lower_is_bad", warningMessage: "IRR < %8 — iskonto oranının altında getiri.", warningMessage_i18n: {"en":"IRR < %8 — Discount oranının altında getiri."}, criticalMessage: "IRR < %5 — alternatif yatırımlar daha cazip.", criticalMessage_i18n: {"en":"IRR < %5 — alternatif yatırımlar daha cazip."} },
  ],
  formulaPipeline: [
