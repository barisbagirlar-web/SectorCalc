...
export const BREAK_EVEN_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "unitPrice", label: "Unit Selling Price", label_i18n: {"en":"Unit Selling Price"}, type: "number", unit: "USD", required: true, smartDefault: 50, validation: { min: 0.01 }, helper: "Ürün başına satış fiyatı.", helper_i18n: {"en":"Ürün başına satış fiyatı."}, expertMeaning: "Selling price per unit", expertMeaning_i18n: {"en":"Selling price per unit"} },
    { id: "actualSalesUnits", label: "Current Sales Volume", label_i18n: {"en":"Current Sales Volume"}, type: "number", unit: "adet", required: true, smartDefault: 3000, validation: { min: 0 }, helper: "Mevcut satış adedi.", helper_i18n: {"en":"Mevcut satış adedi."}, expertMeaning: "Actual sales volume", expertMeaning_i18n: {"en":"Actual sales volume"} },
    ...
    { id: "netOpIncome", label: "Net Operating Income", label_i18n: {"en":"Net Operating Income"}, type: "number", unit: "USD", required: false, smartDefault: 10000, validation: { min: 0 }, helper: "Katkı marjı - sabit giderler.", helper_i18n: {"en":"Katkı marjı - sabit giderler."}, expertMeaning: "Net operating income", expertMeaning_i18n: {"en":"Net operating income"} },
