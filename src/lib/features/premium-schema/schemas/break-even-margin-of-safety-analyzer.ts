...
export const BREAK_EVEN_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    { id: "fixedCosts", label: "Fixed Costs", label_i18n: {"en":"Fixed Costs"}, type: "number", unit: "USD", required: true, smartDefault: 50000, validation: { min: 1 }, helper: "Total fixed expenses such as rent, salary, insurance.", helper_i18n: {"en":"Total fixed expenses such as rent, salary, insurance."}, expertMeaning: "Total fixed costs", expertMeaning_i18n: {"en":"Total fixed costs"} },
    { id: "unitVariableCost", label: "Unit Variable Cost", label_i18n: {"en":"Unit Variable Cost"}, type: "number", unit: "USD", required: true, smartDefault: 30, validation: { min: 0.01 }, helper: "Variable cost per unit (raw material, labor).", helper_i18n: {"en":"Variable cost per unit (raw material, labor)."}, expertMeaning: "Variable cost per unit", expertMeaning_i18n: {"en":"Variable cost per unit"} },
    { id: "unitPrice", label: "Unit Selling Price", label_i18n: {"en":"Unit Selling Price"}, type: "number", unit: "USD", required: true, smartDefault: 50, validation: { min: 0.01 }, helper: "Selling price per product.", helper_i18n: {"en":"Selling price per product."}, expertMeaning: "Selling price per unit", expertMeaning_i18n: {"en":"Selling price per unit"} },
    { id: "actualSalesUnits", label: "Current Sales Volume", label_i18n: {"en":"Current Sales Volume"}, type: "number", unit: "units", required: true, smartDefault: 3000, validation: { min: 0 }, helper: "Current sales quantity.", helper_i18n: {"en":"Current sales quantity."}, expertMeaning: "Actual sales volume", expertMeaning_i18n: {"en":"Actual sales volume"} },
    { id: "actualRevenue", label: "Current Revenue", label_i18n: {"en":"Current Revenue"}, type: "number", unit: "USD", required: false, smartDefault: 150000, validation: { min: 0 }, helper: "Total revenue.", helper_i18n: {"en":"Total revenue."}, expertMeaning: "Actual revenue", expertMeaning_i18n: {"en":"Actual revenue"} },
    { id: "targetProfit", label: "Target Profit", label_i18n: {"en":"Target Profit"}, type: "number", unit: "USD", required: false, smartDefault: 50000, validation: { min: 0 }, helper: "Target profit to be achieved.", helper_i18n: {"en":"Target profit to be achieved."}, expertMeaning: "Target profit amount", expertMeaning_i18n: {"en":"Target profit amount"} },
    { id: "contributionMarginTotal", label: "Total Contribution Margin", label_i18n: {"en":"Total Contribution Margin"}, type: "number", unit: "USD", required: false, smartDefault: 60000, validation: { min: 0 }, helper: "(Unit price - BM) × sales quantity.", helper_i18n: {"en":"(Unit price - BM) × sales quantity."}, expertMeaning: "Total contribution margin", expertMeaning_i18n: {"en":"Total contribution margin"} },
    { id: "netOpIncome", label: "Net Operating Income", label_i18n: {"en":"Net Operating Income"}, type: "number", unit: "USD", required: false, smartDefault: 10000, validation: { min: 0 }, helper: "Contribution margin - fixed expenses.", helper_i18n: {"en":"Contribution margin - fixed expenses."}, expertMeaning: "Net operating income", expertMeaning_i18n: {"en":"Net operating income"} },
    { id: "unitCm", label: "Unit Contribution Margin", label_i18n: {"en":"Unit Contribution Margin"}, type: "number", unit: "USD", required: false, smartDefault: 20, validation: { min: 0 }, helper: "Unit price - unit variable cost.", helper_i18n: {"en":"Unit price - unit variable cost."}, expertMeaning: "Unit contribution margin", expertMeaning_i18n: {"en":"Unit contribution margin"} },
  ],
  outputs: [
    { id: "bepUnits", label: "Break-Even Point (Units)", label_i18n: {"en":"Break-Even Point (Units)"}, unit: "units", format: "number" },
