...
export const CHATTER_SCHEMA: PremiumCalculatorSchema = {
  ...
  painStatement: "Chatter (vibration) in CNC machining increases surface roughness, raising out-of-tolerance Parts and Scrap rate. This tool calculates surface quality loss based on cutting parameters.", painStatement_i18n: {"en":"Chatter (vibration) in CNC machining increases surface roughness, raising out-of-tolerance Parts and Scrap rate. This tool calculates surface quality loss based on cutting parameters."},
  inputs: [
    ...
    { id: "spindleRpm", label: "Rotation (n)", label_i18n: {"en":"Rotation (n)"}, type: "number", unit: "rpm", required: true, smartDefault: 3000, validation: { min: 1 }, helper: "", expertMeaning: "Spindle speed", expertMeaning_i18n: {"en":"Spindle speed"} },
    ...
    { id: "toothCount", label: "Number of cutting teeth", label_i18n: {"en":"Number of cutting teeth"}, type: "number", unit: "scalar", required: true, smartDefault: 4, validation: { min: 1 }, helper: "", expertMeaning: "Number of cutting teeth", expertMeaning_i18n: {"en":"Number of cutting teeth"} },
  ...
  outputs: [
    ...
    { id: "actualRa", label: "Actual Yuzey Puruzlulugu (Ra)", label_i18n: {"en":"Actual Yuzey Puruzlulugu (Ra)"}, unit: "µm", format: "number" },
