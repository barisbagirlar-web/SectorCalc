...
export const WATER_USAGE_OPTIMIZER_ANALYZER: PremiumCalculatorSchema = {
  ...
  outputs: [
    { id: "waterIntensity", label: "Water Yogunlugu", label_i18n: {"en":"Water Yogunlugu"}, unit: "m³/ton", format: "number" },
  ...
  reportTemplate: { title: "Water Utilization optimization Raporu", title_i18n: {"en":"Water Utilization optimization Raporu"}, sections: ["executive_summary", "loss_breakdown", "thresholds", "action_plan", "assumptions"], exportFormats: ["pdf", "excel"] },
  assumptions: { hiddenLossMultiplier: 1.1, volatilityPercent: 10, targetMarginPercent: 15, assumptionNotes: [],assumptionNotes_i18n:[{"en":"Water intensity = total consumption / production quantity."},{"en":"Savings = (current − target) intensity × production."},{"en":"Waste water cost is applied to the portion equal to the waste water ratio of total water."}] },
};
