...
export const ABSENTEEISM_COST_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    { id: "absentHours", label: "Total Lost Hours", label_i18n: {"en":"Total Lost Hours"}, type: "number", unit: "hours", required: true, smartDefault: 500, validation: { min: 0 }, helper: "", expertMeaning: "Total absentee hours", expertMeaning_i18n: {"en":"Total absentee hours"} },
    { id: "hourlyRate", label: "Hourly Wage", label_i18n: {"en":"Hourly Wage"}, type: "number", unit: "USD", required: true, smartDefault: 20, validation: { min: 0 }, helper: "", expertMeaning: "Average hourly wage", expertMeaning_i18n: {"en":"Average hourly wage"} },
    ...
    { id: "replaceOtHours", label: "Overtime Hours", label_i18n: {"en":"Overtime Hours"}, type: "number", unit: "hours", required: false, smartDefault: 150, validation: { min: 0 }, helper: "", expertMeaning: "Overtime replacement hours", expertMeaning_i18n: {"en":"Overtime replacement hours"} },
    { id: "regularRate", label: "Regular Hourly Rate", label_i18n: {"en":"Regular Hourly Rate"}, type: "number", unit: "USD", required: false, smartDefault: 20, validation: { min: 0 }, helper: "", expertMeaning: "Regular hourly rate", expertMeaning_i18n: {"en":"Regular hourly rate"} },
    { id: "otRate", label: "Overtime Rate", label_i18n: {"en":"Overtime Rate"}, type: "number", unit: "USD", required: false, smartDefault: 30, validation: { min: 0 }, helper: "", expertMeaning: "Overtime hourly rate", expertMeaning_i18n: {"en":"Overtime hourly rate"} },
    { id: "tempHours", label: "Temp Worker Hours", label_i18n: {"en":"Temp Worker Hours"}, type: "number", unit: "hours", required: false, smartDefault: 200, validation: { min: 0 }, helper: "", expertMeaning: "Temporary worker hours", expertMeaning_i18n: {"en":"Temporary worker hours"} },
    ...
    { id: "absentEvents", label: "Absentee Event Count", label_i18n: {"en":"Absentee Event Count"}, type: "number", unit: "units", required: false, smartDefault: 50, validation: { min: 0 }, helper: "", expertMeaning: "Number of absentee events", expertMeaning_i18n: {"en":"Number of absentee events"} },
    { id: "hrTime", label: "HR Processing Time", label_i18n: {"en":"HR Processing Time"}, type: "number", unit: "hours", required: false, smartDefault: 1, validation: { min: 0 }, helper: "", expertMeaning: "HR processing hours per event", expertMeaning_i18n: {"en":"HR processing hours per event"} },
