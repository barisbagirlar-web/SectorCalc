...
export const TEXTILE_WASTE_RISK_SCHEMA: PremiumCalculatorSchema = {
  ...
  painStatement: "Tekstil uretiminde kumas atigi ve fire orani kontrol edilmezse hammadde maliyeti ve cevresel kayip artar.", painStatement_i18n: {"en":"If fabric waste and waste rate are not controlled in textile production, raw material cost and environmental loss increase."},
  inputs: [
  ...
  outputs: [
    ...
    { id: "preConsumerWaste", label: "Pre-Consumption Waste Cost", label_i18n: {"en":"Pre-Consumption Waste Cost"}, unit: "USD/yil", format: "currency" },
    { id: "netWasteCost", label: "Net Waste Cost", label_i18n: {"en":"Net Waste Cost"}, unit: "USD/yil", format: "currency", isBigNumber: true },
    { id: "wasteRiskScore", label: "Atk Risk Skoru", label_i18n: {"en":"Waste Risk Skoru"}, unit: "", format: "score" },
  ],
  thresholds: [{ fieldId: "textileWasteRate", warning: 10, critical: 20, direction: "higher_is_bad", warningMessage: "Atik orani > %10 — kesim optimizasyonu onerilir.", warningMessage_i18n: {"en":"Waste rate > 10% — cutting optimization is recommended."}, criticalMessage: "Atik orani > %20 — kalip ve kesim sureci yenilenmeli.", criticalMessage_i18n: {"en":"Waste rate > 20% — pattern and cutting process should be renewed."} }],
  formulaPipeline: [
