...
export const HOURLY_RATE_ANALYZER: PremiumCalculatorSchema = {
  ...
  thresholds: [{ fieldId: "burdenedHourlyRate", warning: 50, critical: 80, direction: "higher_is_bad", warningMessage: "Yüklü saatlik ücret >$50 — maliyet avantajı azalıyor.", warningMessage_i18n: {"en":"Yüklü Hourly Rate >$50 — Cost avantajı azalıyor."}, criticalMessage: "Yüklü saatlik ücret >$80 — rekabetçi fiyatlama zorlaşır.", criticalMessage_i18n: {"en":"Yüklü Hourly Rate >$80 — rekabetçi fiyatlama zorlaşır."} }],
  formulaPipeline: [
