...
export const FREIGHT_COST_SCHEMA: PremiumCalculatorSchema = {
  ...
  painStatement: "Navlun maliyetinde ağırlık, bunker, terminal ve gümrük kalemleri ayrı hesaplanmazsa gerçek lojistik maliyeti gizli kalır.", painStatement_i18n: {"en":"Navlun maliyetinde ağırlık, bunker, terminal ve gümrük kalemleri ayrı hesaplanmazsa gerçek lojistik maliyeti gizli kalır."},
  inputs: [
    { id: "grossWeight", label: "Brüt Ağırlık", label_i18n: {"en":"Gross weight in kg"}, type: "number", unit: "kg", required: true, smartDefault: 1500, validation: { min: 0.1 }, helper: "", expertMeaning: "Gross weight in kg", expertMeaning_i18n: {"en":"Gross weight in kg"} },
    ...
    { id: "baseRate", label: "Navlun Baz Fiyat", label_i18n: {"en":"Navlun Baz Fiyat"}, type: "number", unit: "USD/kg", required: true, smartDefault: 2.5, validation: { min: 0.01 }, helper: "", expertMeaning: "Base freight rate per kg", expertMeaning_i18n: {"en":"Base freight rate per kg"} },
    ...
    { id: "terminalFee", label: "Terminal İşlem Ücreti", label_i18n: {"en":"Terminal handling fee"}, type: "number", unit: "USD", required: true, smartDefault: 200, validation: { min: 0 }, helper: "", expertMeaning: "Terminal handling fee", expertMeaning_i18n: {"en":"Terminal handling fee"} },
  ...
  outputs: [
    { id: "chargeableWeight", label: "Taşınabilir Ağırlık", label_i18n: {"en":"Tasnabilir Agrlk"}, unit: "kg", format: "number" },
    { id: "baseFreight", label: "Baz Navlun Bedeli", label_i18n: {"en":"Baz Navlun Bedeli"}, unit: "USD", format: "currency" },
    { id: "bunkerSurcharge", label: "Bunker Ek Ücreti", label_i18n: {"en":"Bunker Ek Ucreti"}, unit: "USD", format: "currency" },
    { id: "terminalCost", label: "Terminal Maliyeti", label_i18n: {"en":"Terminal Maliyeti"}, unit: "USD", format: "currency" },
    { id: "customsCost", label: "Gümrük Maliyeti", label_i18n: {"en":"Gumruk Maliyeti"}, unit: "USD", format: "currency" },
    { id: "totalFreightCost", label: "Toplam Navlun Maliyeti", label_i18n: {"en":"Toplam Navlun Maliyeti"}, unit: "USD", format: "currency" },
    { id: "costPerUnit", label: "Birim Başına Navlun", label_i18n: {"en":"Birim Basna Navlun"}, unit: "USD/kg", format: "currency" },
  ],
