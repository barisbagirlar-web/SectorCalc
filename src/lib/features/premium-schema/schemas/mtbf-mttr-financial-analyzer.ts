...
export const MTBF_MTTR_FINANCIAL_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "operatingHours", label: "Annual operating hours", label_i18n: {"en":"Annual operating hours"}, type: "number", unit: "saat/yıl", required: true, smartDefault: 8000, validation: { min: 1 }, helper: "", expertMeaning: "Annual operating hours", expertMeaning_i18n: {"en":"Annual operating hours"} },
  ...
  outputs: [
    ...
    { id: "expectedDowntime", label: "Beklenen Durma Süresi", label_i18n: {"en":"Expected Durma Duration"}, unit: "saat/yıl", format: "number" },
