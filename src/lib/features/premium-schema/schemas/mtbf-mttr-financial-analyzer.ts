...
export const MTBF_MTTR_FINANCIAL_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "improvedMtbf", label: "İyileştirilmiş MTBF (opsiyonel)", label_i18n: {"en":"Target MTBF after improvement","tr":"İyileştirilmiş MTBF (opsiyonel)"}, type: "number", unit: "saat", required: false, smartDefault: 800, validation: { min: 1 }, helper: "", expertMeaning: "Target MTBF after improvement", expertMeaning_i18n: {"en":"Target MTBF after improvement","tr":"i̇yileştirilmiş mtbf (opsiyonel)"} },
  ],
  outputs: [
    { id: "availability", label: "Kullanılabilirlik Oranı", label_i18n: {"en":"Kullanlabilirlik Oran","tr":"Kullanılabilirlik Oranı"}, unit: "%", format: "number" },
    { id: "expectedDowntime", label: "Beklenen Durma Süresi", label_i18n: {"en":"Beklenen Durma Suresi","tr":"Beklenen Durma Süresi"}, unit: "saat/yıl", format: "number" },
    { id: "downtimeCost", label: "Durma Maliyeti", label_i18n: {"en":"Durma Maliyeti","tr":"Durma Maliyeti"}, unit: "USD/yıl", format: "currency" },
    { id: "totalReliabilityCost", label: "Toplam Güvenilirlik Maliyeti", label_i18n: {"en":"Toplam Guvenilirlik Maliyeti","tr":"Toplam Güvenilirlik Maliyeti"}, unit: "USD/yıl", format: "currency" },
    { id: "roiPercent", label: "ROI (İyileştirme)", label_i18n: {"en":"ROI (Iyilestirme)","tr":"ROI (İyileştirme)"}, unit: "%", format: "number", isBigNumber: true },
  ],
