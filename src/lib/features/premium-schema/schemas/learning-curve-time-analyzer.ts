...
export const LEARNING_CURVE_TIME_ANALYZER_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "hourlyRate", label: "Saatlik İşçilik Maliyeti", label_i18n: {"en":"Labor cost per hour","tr":"Saatlik İşçilik Maliyeti"}, type: "number", unit: "USD/saat", required: false, smartDefault: 35, validation: { min: 1 }, helper: "", expertMeaning: "Labor cost per hour", expertMeaning_i18n: {"en":"Labor cost per hour","tr":"saatlik i̇şçilik maliyeti"} },
  ],
  outputs: [
    { id: "learningRate", label: "Öğrenme Oranı", label_i18n: {"en":"Ogrenme Oran","tr":"Öğrenme Oranı"}, unit: "%", format: "number" },
    { id: "learningSlope", label: "Öğrenme Eğimi", label_i18n: {"en":"Ogrenme Egimi","tr":"Öğrenme Eğimi"}, unit: "", format: "number" },
    { id: "timeN", label: "n. Birim Süresi", label_i18n: {"en":"n. Birim Suresi","tr":"n. Birim Süresi"}, unit: "saat", format: "number" },
    { id: "cumulativeTimeN", label: "Kümülatif Toplam Süre", label_i18n: {"en":"Kumulatif Toplam Sure","tr":"Kümülatif Toplam Süre"}, unit: "saat", format: "number", isBigNumber: true },
    { id: "averageTimeN", label: "Ortalama Birim Süresi", label_i18n: {"en":"Ortalama Birim Suresi","tr":"Ortalama Birim Süresi"}, unit: "saat", format: "number" },
    { id: "learningCostN", label: "n. Birim Maliyeti", label_i18n: {"en":"n. Birim Maliyeti","tr":"n. Birim Maliyeti"}, unit: "USD", format: "currency" },
    { id: "breakevenUnit", label: "Başabaş Birimi", label_i18n: {"en":"Basabas Birimi","tr":"Başabaş Birimi"}, unit: "adet", format: "number" },
  ],
