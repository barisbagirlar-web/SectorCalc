...
export const LEARNING_CURVE_TIME_ANALYZER_SCHEMA: PremiumCalculatorSchema = {
  ...
  painStatement: "Tekrarlı üretimde öğrenme etkisi hesaplanmazsa işçilik süreleri ve maliyetler olduğundan yüksek tahmin edilir.", painStatement_i18n: {"en":"Tekrarlı üretimde öğrenme etkisi if not calculated işçilik süreleri ve maliyetler olduğundan high Estimate edilir."},
  inputs: [
  ...
  thresholds: [{ fieldId: "timeN", warning: 20, critical: 10, direction: "lower_is_bad", warningMessage: "Birim süre < 20 saat — öğrenme etkisi düşük.", warningMessage_i18n: {"en":"Unit Time < 20 saat — öğrenme etkisi düşük."}, criticalMessage: "Birim süre < 10 saat — süreç iyileştirme gerekli.", criticalMessage_i18n: {"en":"Unit Time < 10 saat — süreç improvement gerekli."} }],
  formulaPipeline: [
