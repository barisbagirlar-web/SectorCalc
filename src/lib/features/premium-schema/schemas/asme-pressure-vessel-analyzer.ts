...
export const ASME_VESSEL_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "headType", label: "Head Type", label_i18n: {"en":"Head Type"}, type: "select", unit: "scalar", required: true, smartDefault: "cylindrical", options: [...HEAD_TYPE_OPTIONS], helper: "", expertMeaning: "ASME head type", expertMeaning_i18n: {"en":"ASME head type"} },
    { id: "material", label: "Material", label_i18n: {"en":"Material"}, type: "select", unit: "scalar", required: true, smartDefault: "SA516_70", options: [...MATERIAL_OPTIONS], helper: "", expertMeaning: "Vessel material grade", expertMeaning_i18n: {"en":"Vessel material grade"} },
    ...
    { id: "jointEfficiency", label: "Joint Efficiency (E)", label_i18n: {"en":"Joint Efficiency (E)"}, type: "number", unit: "scalar", required: true, smartDefault: 0.85, validation: { min: 0, max: 1 }, helper: "", expertMeaning: "Joint efficiency per UW-12", expertMeaning_i18n: {"en":"Joint efficiency per UW-12"} },
