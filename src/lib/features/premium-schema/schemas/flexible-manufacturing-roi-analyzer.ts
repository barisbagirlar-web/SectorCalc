...
export const FLEXIBLE_MFG_ROI_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "totalTime", label: "Total development time", label_i18n: {"en":"Total development time"}, type: "number", unit: "days", required: false, smartDefault: 100, validation: { min: 0 }, helper: "", expertMeaning: "Total development time", expertMeaning_i18n: {"en":"Total development time"} },
    ...
    { id: "productionVolume", label: "Annual production volume", label_i18n: {"en":"Annual production volume"}, type: "number", unit: "units", required: false, smartDefault: 50000, validation: { min: 0 }, helper: "", expertMeaning: "Annual production volume", expertMeaning_i18n: {"en":"Annual production volume"} },
    ...
    { id: "scrapReduction", label: "Scrap Azaltma Tasarrufu", label_i18n: {"en":"Scrap Azaltma Tasarrufu"}, type: "number", unit: "USD", required: false, smartDefault: 10000, validation: { min: 0 }, helper: "", expertMeaning: "Scrap reduction savings", expertMeaning_i18n: {"en":"Scrap reduction savings"} },
