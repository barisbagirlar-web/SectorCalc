...
export const FLEXIBLE_MFG_ROI_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "ttmReduction", label: "TTM Azaltma (gun)", label_i18n: {"en":"Time-to-market reduction"}, type: "number", unit: "gun", required: false, smartDefault: 20, validation: { min: 0 }, helper: "", expertMeaning: "Time-to-market reduction", expertMeaning_i18n: {"en":"Time-to-market reduction"} },
    { id: "totalTime", label: "Total development time", label_i18n: {"en":"Total development time"}, type: "number", unit: "gun", required: false, smartDefault: 100, validation: { min: 0 }, helper: "", expertMeaning: "Total development time", expertMeaning_i18n: {"en":"Total development time"} },
  ...
  thresholds: [{ fieldId: "roi", warning: 30, critical: 15, direction: "lower_is_bad", warningMessage: "ROI < %30 — yatirim fizibilitesi sorgulanmali.", warningMessage_i18n: {"en":"ROI < %30 — Investment feasibility should be questioned."}, criticalMessage: "ROI < %15 — dedicated sistem daha avantajli olabilir.", criticalMessage_i18n: {"en":"ROI < %15 — A dedicated system may be more advantageous."} }],
  formulaPipeline: [
