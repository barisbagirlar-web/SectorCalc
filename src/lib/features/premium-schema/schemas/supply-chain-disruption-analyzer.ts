...
export const SUPPLY_CHAIN_DISRUPTION_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "recoveryDays", label: "Toparlanma Suresi", label_i18n: {"en":"Recovery Time"}, type: "number", unit: "gun", required: true, smartDefault: 30, validation: { min: 1 }, helper: "", expertMeaning: "Recovery time in days", expertMeaning_i18n: {"en":"Recovery time in days"} },
    ...
    { id: "downtimeCostPerDay", label: "Gunluk Kesinti Maliyeti", label_i18n: {"en":"Daily Disruption Cost"}, type: "number", unit: "USD/gun", required: false, smartDefault: 5000, validation: { min: 0 }, helper: "", expertMeaning: "Cost per disruption day", expertMeaning_i18n: {"en":"Cost per disruption day"} },
  ],
  outputs: [
    { id: "riskExposureSc", label: "Risk-Based Exposure", label_i18n: {"en":"Risk-Based Exposure"}, unit: "USD/yil", format: "currency" },
    { id: "revenueLossSc", label: "Estimated Revenue Loss", label_i18n: {"en":"Estimated Revenue Loss"}, unit: "USD/yil", format: "currency" },
    { id: "riskAdjustedCostSc", label: "Risk-Adjusted Total Cost", label_i18n: {"en":"Risk-Adjusted Total Cost"}, unit: "USD/yil", format: "currency", isBigNumber: true },
