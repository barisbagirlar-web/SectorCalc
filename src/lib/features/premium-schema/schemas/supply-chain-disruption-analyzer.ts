...
export const SUPPLY_CHAIN_DISRUPTION_SCHEMA: PremiumCalculatorSchema = {
  ...
  outputs: [
    { id: "riskExposureSc", label: "Risk-Based Exposure", label_i18n: {"en":"Risk-Based Exposure"}, unit: "USD/yıl", format: "currency" },
    { id: "revenueLossSc", label: "Estimated Revenue Loss", label_i18n: {"en":"Estimated Revenue Loss"}, unit: "USD/yıl", format: "currency" },
    { id: "riskAdjustedCostSc", label: "Risk-Adjusted Total Cost", label_i18n: {"en":"Risk-Adjusted Total Cost"}, unit: "USD/yıl", format: "currency", isBigNumber: true },
