...
export const ROUTE_OPTIMIZATION_ANALYZER: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "workingDaysPerYear", label: "Annual Working Days", label_i18n: {"en":"Annual Working Days"}, type: "number", unit: "gün", required: false, smartDefault: 260, validation: { min: 1 }, helper: "", expertMeaning: "Working days per year", expertMeaning_i18n: {"en":"Working days per year"} },
  ],
  outputs: [
    ...
    { id: "totalSavings", label: "Toplam Tasarruf", label_i18n: {"en":"Total Tasarruf"}, unit: "USD/yıl", format: "currency", isBigNumber: true },
  ],
