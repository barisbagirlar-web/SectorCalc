...
export const ICI_CURE_SCHEMA: PremiumCalculatorSchema = {
  id: "ici-cure",
  name: "Autoclave Composite Cure Lock Calculator",
  sectorSlug: "industrial",
  category: "industrial",
  legacyPaidSlug: "ici-cure",
  ...
  inputs: [
    { id: "expectedValue", label: "expected cure margin", type: "number", required: true, unit: "unit", helper: "Enter expected cure margin", expertMeaning: "expected cure margin" },
    { id: "uncertaintySigma", label: "temperature / pressure uncertainty", type: "number", required: true, unit: "unit", helper: "Enter temperature / pressure uncertainty", expertMeaning: "temperature / pressure uncertainty" },
    { id: "downsideLoss", label: "scrap and structural failure exposure", type: "number", required: true, unit: "unit", helper: "Enter scrap and structural failure exposure", expertMeaning: "scrap and structural failure exposure" },
    { id: "delayCost", label: "cost of reprocessing delay", type: "number", required: true, unit: "unit", helper: "Enter cost of reprocessing delay", expertMeaning: "cost of reprocessing delay" },
    { id: "irreversibleCapex", label: "part release cost", type: "number", required: true, unit: "unit", helper: "Enter part release cost", expertMeaning: "part release cost" },
  ...
  reportTemplate: {
    title: "Autoclave Composite Cure Lock Calculator Report",
