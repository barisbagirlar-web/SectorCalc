...
export const WIND_TURBINE_INVESTMENT_ANALYZER: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "opexPerYear", label: "Annual OPEX", label_i18n: {"en":"Annual OPEX"}, type: "number", unit: "USD/yıl", required: true, smartDefault: 75000, validation: { min: 1 }, helper: "", expertMeaning: "Annual OPEX", expertMeaning_i18n: {"en":"Annual OPEX"} },
  ...
  outputs: [
    { id: "aep", label: "Yllk Enerji Uretimi (AEP)", label_i18n: {"en":"Annual energy Uretimi (AEP)"}, unit: "MWh/yıl", format: "number", isBigNumber: true },
    { id: "annualRevenue", label: "Yllk Gelir", label_i18n: {"en":"Annual Income"}, unit: "USD/yıl", format: "currency" },
