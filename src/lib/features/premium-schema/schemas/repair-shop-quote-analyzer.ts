...
export const REPAIR_SHOP_QUOTE_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "hourlyRate", label: "Hourly Labor Rate", label_i18n: {"en":"Hourly Labor Rate"}, type: "number", unit: "USD/hour", required: true, smartDefault: 65, validation: { min: 1 }, helper: "", expertMeaning: "Hourly labor rate", expertMeaning_i18n: {"en":"Hourly labor rate"} },
    ...
    { id: "overheadCost", label: "Overhead Cost", label_i18n: {"en":"Overhead Cost"}, type: "number", unit: "USD", required: false, smartDefault: 80, validation: { min: 0 }, helper: "", expertMeaning: "Overhead cost", expertMeaning_i18n: {"en":"Overhead cost"} },
  ],
  outputs: [
  ...
  formulaPipeline: [
    ...
    { formulaId: "cost.effective_labor_rate", inputMap: {
      ...
      ,
        ...
        flagHours: "laborHours"}, outputId: "effectiveLaborRate" },
