...
export const ICI_TAILINGS_SCHEMA: PremiumCalculatorSchema = {
  id: "ici-tailings",
  name: "Tailings Dam Stability Commitment Calculator",
  sectorSlug: "industrial",
  category: "industrial",
  legacyPaidSlug: "ici-tailings",
  ...
  inputs: [
    { id: "expectedValue", label: "expected factor of safety", type: "number", required: true, unit: "unit", helper: "Enter expected factor of safety", expertMeaning: "expected factor of safety" },
    { id: "uncertaintySigma", label: "stress and climate uncertainty", type: "number", required: true, unit: "unit", helper: "Enter stress and climate uncertainty", expertMeaning: "stress and climate uncertainty" },
    { id: "downsideLoss", label: "consequence class exposure", type: "number", required: true, unit: "unit", helper: "Enter consequence class exposure", expertMeaning: "consequence class exposure" },
    { id: "delayCost", label: "cost of operational delay", type: "number", required: true, unit: "unit", helper: "Enter cost of operational delay", expertMeaning: "cost of operational delay" },
    { id: "irreversibleCapex", label: "reinforcement CAPEX locked", type: "number", required: true, unit: "unit", helper: "Enter reinforcement CAPEX locked", expertMeaning: "reinforcement CAPEX locked" },
  ...
  reportTemplate: {
    title: "Tailings Dam Stability Commitment Calculator Report",
