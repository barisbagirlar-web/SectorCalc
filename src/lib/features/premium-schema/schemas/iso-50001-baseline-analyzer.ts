...
export const ISO50001_BASELINE_SCHEMA: PremiumCalculatorSchema = {
  ...
  painStatement: "Under ISO 50001, energy performance cannot be monitored and improvement cannot be proven without EnPI and CUSUM analysis.", painStatement_i18n: {"en":"Under ISO 50001, energy performance cannot be monitored and improvement cannot be proven without EnPI and CUSUM analysis."},
  inputs: [
    { id: "totalEnergy", label: "Total energy consumption", label_i18n: {"en":"Total energy consumption"}, type: "number", unit: "kWh", required: true, smartDefault: 5000000, validation: { min: 0 }, helper: "", expertMeaning: "Total energy consumption", expertMeaning_i18n: {"en":"Total energy consumption"} },
    { id: "productionVolume", label: "Production volume", label_i18n: {"en":"Production volume"}, type: "number", unit: "ton", required: true, smartDefault: 10000, validation: { min: 0.1 }, helper: "", expertMeaning: "Production volume", expertMeaning_i18n: {"en":"Production volume"} },
    ...
    { id: "degreeDays", label: "Degree days", label_i18n: {"en":"Degree days"}, type: "number", unit: "DD", required: false, smartDefault: 2000, validation: { min: 0 }, helper: "", expertMeaning: "Degree days", expertMeaning_i18n: {"en":"Degree days"} },
    ...
    { id: "predictedConsumption", label: "Predicted consumption", label_i18n: {"en":"Predicted consumption"}, type: "number", unit: "kWh", required: false, smartDefault: 5100000, validation: { min: 0 }, helper: "", expertMeaning: "Predicted consumption", expertMeaning_i18n: {"en":"Predicted consumption"} },
