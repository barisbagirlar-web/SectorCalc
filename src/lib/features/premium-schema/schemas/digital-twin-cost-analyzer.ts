...
export const DIGITAL_TWIN_COST_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "physicalCycle", label: "Physical prototyping cycle (days)", label_i18n: {"en":"Physical prototyping cycle (days)"}, type: "number", unit: "gün", required: false, smartDefault: 30, validation: { min: 0 }, helper: "", expertMeaning: "Physical prototyping cycle (days)", expertMeaning_i18n: {"en":"Physical prototyping cycle (days)"} },
    { id: "digitalCycle", label: "Digital simulation cycle (days)", label_i18n: {"en":"Digital simulation cycle (days)"}, type: "number", unit: "gün", required: false, smartDefault: 10, validation: { min: 0 }, helper: "", expertMeaning: "Digital simulation cycle (days)", expertMeaning_i18n: {"en":"Digital simulation cycle (days)"} },
