...
export const TAGUCHI_QUALITY_LOSS_ANALYZER: PremiumCalculatorSchema = {
  ...
  inputs: [
    { id: "targetValue", label: "Target Value", label_i18n: {"en":"Target Value"}, type: "number", unit: "scalar", required: true, smartDefault: 10, validation: { min: 0.01 }, helper: "", expertMeaning: "Nominal target value", expertMeaning_i18n: {"en":"Nominal target value"} },
    { id: "tolerance", label: "Tolerance", label_i18n: {"en":"Tolerance"}, type: "number", unit: "scalar", required: true, smartDefault: 1, validation: { min: 0.01 }, helper: "", expertMeaning: "Specification tolerance (±)", expertMeaning_i18n: {"en":"Specification tolerance (±)"} },
    ...
    { id: "processMean", label: "Process Mean", label_i18n: {"en":"Process Mean"}, type: "number", unit: "scalar", required: true, smartDefault: 10.3, validation: { min: 0.01 }, helper: "", expertMeaning: "Actual process mean", expertMeaning_i18n: {"en":"Actual process mean"} },
    { id: "processStdDev", label: "Process Standard Deviation", label_i18n: {"en":"Process Standard Deviation"}, type: "number", unit: "scalar", required: true, smartDefault: 0.4, validation: { min: 0.001 }, helper: "", expertMeaning: "Process standard deviation", expertMeaning_i18n: {"en":"Process standard deviation"} },
    ...
    { id: "specLower", label: "Lower Specification Limit", label_i18n: {"en":"Lower Specification Limit"}, type: "number", unit: "scalar", required: false, smartDefault: 9, validation: { min: 0.01 }, helper: "", expertMeaning: "Lower specification limit", expertMeaning_i18n: {"en":"Lower specification limit"} },
    { id: "specUpper", label: "Upper Specification Limit", label_i18n: {"en":"Upper Specification Limit"}, type: "number", unit: "scalar", required: false, smartDefault: 11, validation: { min: 0.01 }, helper: "", expertMeaning: "Upper specification limit", expertMeaning_i18n: {"en":"Upper specification limit"} },
  ],
  outputs: [
