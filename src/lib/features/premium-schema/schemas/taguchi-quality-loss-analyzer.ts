...
export const TAGUCHI_QUALITY_LOSS_ANALYZER: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "specUpper", label: "Ust Spesifikasyon Limiti", label_i18n: {"en":"Upper Specification Limit"}, type: "number", unit: "", required: false, smartDefault: 11, validation: { min: 0.01 }, helper: "", expertMeaning: "Upper specification limit", expertMeaning_i18n: {"en":"Upper specification limit"} },
  ],
  outputs: [
