...
export const TAGUCHI_QUALITY_LOSS_ANALYZER: PremiumCalculatorSchema = {
  ...
  inputs: [
    ...
    { id: "annualProductionVolume", label: "Annual Production Volume", label_i18n: {"en":"Annual Production Volume"}, type: "number", unit: "adet", required: true, smartDefault: 100000, validation: { min: 1 }, helper: "", expertMeaning: "Annual production volume", expertMeaning_i18n: {"en":"Annual production volume"} },
  ...
  outputs: [
    { id: "taguchiLossPerUnit", label: "Taguchi Loss per Unit", label_i18n: {"en":"Taguchi Loss per Unit"}, unit: "USD/adet", format: "currency" },
  ],
