...
export const PRICE_ELASTICITY_SCHEMA: PremiumCalculatorSchema = {
  ...
  inputs: [
    { id: "currentPrice", label: "Current Price", label_i18n: {"en":"Current Price"}, type: "number", unit: "USD", required: true, smartDefault: 50, validation: { min: 0.01 }, helper: "", expertMeaning: "Current product price", expertMeaning_i18n: {"en":"Current product price"} },
    { id: "currentDemand", label: "Current Demand", label_i18n: {"en":"Current Demand"}, type: "number", unit: "units", required: true, smartDefault: 10000, validation: { min: 1 }, helper: "", expertMeaning: "Current demand quantity", expertMeaning_i18n: {"en":"Current demand quantity"} },
    ...
    { id: "fixedCost", label: "Fixed Cost", label_i18n: {"en":"Fixed Cost"}, type: "number", unit: "USD", required: false, smartDefault: 100000, validation: { min: 0 }, helper: "", expertMeaning: "Fixed costs", expertMeaning_i18n: {"en":"Fixed costs"} },
