...
> = {
  ...
  "cost.minimum_safe_price": {
    ...
    requiredInputs: ["targetMarginPercent", "p90Cost"],
    outputHint: "currency",
  },
  ...
  "cost.discounted_clv": { description: "Discounted cumulative CLV over 5 years with retention and discount rate.", requiredInputs: ["retention", "discountRate", "clv"], outputHint: "currency" },
  ...
  "measurement.roof_footprint": { description: "Building footprint area from length and width.", requiredInputs: ["roofLength", "roofWidth"], outputHint: "number" },
  ...
  "measurement.smed_ebq": { description: "Economic batch quantity from demand, setup, and holding cost.", requiredInputs: ["annualDemand", "setupCost", "holdingCost"], outputHint: "number" },
  ...
  "cost.smed_annual_savings": { description: "Annual savings from SMED time reduction.", requiredInputs: ["totalSetup", "targetSetup", "changeoverFreq", "machineRate"], outputHint: "currency" },
  ...
  "measurement.warehouse_pallet_positions": { description: "Pallet positions from storage area and pallet footprint.", requiredInputs: ["warehouseFootprint", "palletFootprint", "aisleFactor"], outputHint: "number" },
  ...
  "math.dot_product": { description: "Dot product of two arrays.", requiredInputs: [], outputHint: "number" },
  "cost.dye_material_cost": { description: "Dye material cost from concentration and prices.", requiredInputs: ["bathRatio", "fabricWeight"], outputHint: "currency" },
  ...
  "measurement.price_elasticity": { description: "Price elasticity of demand.", requiredInputs: ["pctDemandChange", "pctPriceChange"], outputHint: "number" },
  ...
  "measurement.lightweight_weight_red": { description: "Weight reduction from lightweight design.", requiredInputs: ["originalMass", "lightweightMass"], outputHint: "number" },
  ...
  "measurement.hvac_sensible": { description: "Sensible heat load in BTU/h.", requiredInputs: ["cfm", "deltaTemp"], outputHint: "number" },
  "measurement.hvac_latent": { description: "Latent heat load in BTU/h.", requiredInputs: ["cfm", "deltaHumidity"], outputHint: "number" },
  "measurement.hvac_total_load": { description: "Total cooling load in BTU/h.", requiredInputs: ["sensible", "latent"], outputHint: "number" },
  "measurement.hvac_tons": { description: "Cooling capacity in tons.", requiredInputs: ["totalBtu"], outputHint: "number" },
  ...
  "energy.enpi": { description: "Energy performance indicator (energy per unit volume).", requiredInputs: ["totalEnergy", "productionVolume"], outputHint: "number" },
  "energy.enpi_cusum": { description: "CUSUM energy savings.", requiredInputs: ["predicted", "actual"], outputHint: "number" },
  "cost.irr_simple": { description: "Net present value of cash flow stream.", requiredInputs: ["discountRate", "initialInv"], outputHint: "currency" },
  "cost.irr_approx": { description: "Simple IRR approximation.", requiredInputs: ["initialInv"], outputHint: "number" },
  "cost.feed_base_cost": { description: "Base feed cost per ton from inclusion rates and prices.", requiredInputs: [], outputHint: "currency" },
  ...
  "measurement.scaffold_area": { description: "Scaffold surface area.", requiredInputs: ["buildingPerimeter", "buildingHeight"], outputHint: "number" },
  "cost.scaffold_total": { description: "Total scaffold cost including rental, erection, dismantling, and transport.", requiredInputs: ["rental", "laborCost", "transportCost", "overrunCost"], outputHint: "currency" },
  "measurement.spc_x_bar_avg": { description: "Average of subgroup means for X-bar chart.", requiredInputs: [], outputHint: "number" },
  "measurement.spc_r_bar": { description: "Average range for R chart.", requiredInputs: [], outputHint: "number" },
  "measurement.machining_mrr": { description: "Material removal rate.", requiredInputs: ["cuttingSpeed", "feedPerRev", "depthOfCut"], outputHint: "number" },
  "measurement.machining_power": { description: "Machining power required.", requiredInputs: ["mrr", "specificEnergy"], outputHint: "number" },
  ...
  "cost.escalation_contingency": { description: "Escalation contingency based on confidence factor.", requiredInputs: ["baseAdjusted", "confidenceFactor"], outputHint: "currency" },
  "cost.escalation_real_discount": { description: "Real discount rate derived from nominal and inflation.", requiredInputs: ["nominalRate", "generalInflation"], outputHint: "number" },
  "cost.feed_cost_per_kg": { description: "Feed cost per kg live weight including all cost factors.", requiredInputs: ["baseCost", "procCost", "addCost", "pelletCost", "shrinkRate", "fcr"], outputHint: "currency" },
  ...
  "cost.lightweight_fuel_savings": { description: "Annual fuel savings from weight reduction.", requiredInputs: ["weightReduction", "fuelFactor", "annualDistance", "fuelPrice"], outputHint: "currency" },
  "cost.lightweight_net_savings": { description: "Net lifecycle savings from lightweight design.", requiredInputs: ["fuelSavings", "payloadGain", "productLife", "materialPremium", "toolDelta"], outputHint: "currency" },
  "cost.lightweight_payload_gain": { description: "Payload revenue gain from weight reduction.", requiredInputs: ["weightReduction", "revenuePerKg"], outputHint: "currency" },
  "cost.ltv_cac": { description: "LTV / CAC ratio for customer profitability.", requiredInputs: ["discountedClv", "cac"], outputHint: "number" },
  "cost.npv": { description: "Net present value of cash flow stream.", requiredInputs: ["discountRate", "initialInv"], outputHint: "currency" },
  ...
  "cost.profitability_index": { description: "Profitability index (PI) of investment.", requiredInputs: ["discountRate", "initialInv", "initialInvestment", "npv", "npvInvestment", "annualCashFlowNpv", "netProfit", "annualCashflow", "revenueAnnual", "operatingCostAnnual", "lifeYearsNpv", "projectLifeYears", "purchaseResidualAmt", "residualValue"], outputHint: "number" },
  "cost.scaffold_rental": { description: "Scaffold rental cost from area, rate, and duration.", requiredInputs: ["scaffoldArea", "rentalRatePerM2", "rentalDuration"], outputHint: "currency" },
  "cost.scaffold_labor": { description: "Scaffold erection and dismantling labor cost.", requiredInputs: ["scaffoldArea", "erectionRate", "dismantleRate"], outputHint: "currency" },
  "energy.cusum": { description: "CUSUM energy savings (predicted - actual).", requiredInputs: ["actualConsumption", "predictedConsumption"], outputHint: "number" },
  ...
  "energy.energy_savings": { description: "Energy savings from baseline.", requiredInputs: ["predictedConsumption", "actualConsumption"], outputHint: "number" },
  ...
  "energy.fouling_cost": { description: "Energy penalty cost from fouling.", requiredInputs: ["pumpEff", "boilerEff", "deltaPIncrease", "flowM3h", "operatingHours", "fuelCost", "heatLoss"], outputHint: "currency" },
  ...
  "measurement.machining_strategy_check": { description: "Machining strategy feasibility check (1=pass, 0=fail).", requiredInputs: ["mrr", "specificEnergy", "noseRadius", "roughnessTol"], outputHint: "score" },
  "measurement.machining_tool_life": { description: "Taylor tool life estimation.", requiredInputs: ["taylorC", "cuttingSpeed", "taylorN", "feedPerRev", "taylorM"], outputHint: "duration" },
  "measurement.sewing_line_efficiency": { description: "Sewing line balance efficiency percentage.", requiredInputs: ["cycleTotal", "actualOperators", "taktTime"], outputHint: "percentage" },
  "measurement.smed_capacity_gain": { description: "SMED capacity gain as ratio.", requiredInputs: ["totalSetup", "targetSetup", "changeoverFreq", "availableTime"], outputHint: "number" },
  "measurement.spc_cp": { description: "Process capability index Cp.", requiredInputs: ["usl", "lsl", "sigmaEstimate"], outputHint: "number" },
  "measurement.spc_lcl_x": { description: "X-bar chart lower control limit.", requiredInputs: ["xBarAvg", "a2Const", "rBar"], outputHint: "number" },
  "measurement.spc_sigma_estimate": { description: "Sigma estimate from average range.", requiredInputs: ["rBar", "d2Const"], outputHint: "number" },
  "measurement.spc_ucl_x": { description: "X-bar chart upper control limit.", requiredInputs: ["xBarAvg", "a2Const", "rBar"], outputHint: "number" },
  "measurement.volumetric_chargeable": { description: "Chargeable weight based on volumetric vs gross.", requiredInputs: ["length", "width", "height", "gross"], outputHint: "number" },
  "measurement.warehouse_pick_efficiency": { description: "Pick efficiency lines per travel time.", requiredInputs: ["pickLines", "travelTime"], outputHint: "number" },
  "measurement.warehouse_throughput_cap": { description: "Door throughput capacity.", requiredInputs: ["doorCount", "turnaroundLoad", "turnaroundUnload"], outputHint: "number" },
  ...
  "cost.weld_filler_cost": { description: "Filler metal cost from electrode weight.", requiredInputs: ["weldWeight", "fillerPrice"], outputHint: "currency" },
  ...
  "measurement.fabric_marker_eff": { description: "Fabric marker efficiency from net to gross area.", requiredInputs: ["netArea", "grossArea", "fabricWidth"], outputHint: "number" },
  "measurement.fabric_required": { description: "Fabric required adjusted for marker efficiency.", requiredInputs: ["netArea", "markerEff", "endLoss"], outputHint: "number" },
  ...
  "measurement.route_drift_pct": { description: "Route drift as percentage over planned distance.", requiredInputs: ["actualDistance", "idealDistance"], outputHint: "percentage" },
  "cost.route_fuel_waste": { description: "Fuel waste cost from excess route distance.", requiredInputs: ["actualDistance", "idealDistance", "fuelConsumption", "fuelPrice"], outputHint: "currency" },
  "cost.route_time_waste": { description: "Time waste cost from excess route time.", requiredInputs: ["actualDistance", "idealDistance", "avgSpeed"], outputHint: "currency" },
  "measurement.route_efficiency": { description: "Route efficiency ratio (planned / actual).", requiredInputs: ["idealDistance", "actualDistance"], outputHint: "number" },
  "cost.route_total_loss": { description: "Total route loss from fuel and time waste.", requiredInputs: ["fuelWaste", "timeWaste"], outputHint: "currency" },
  "cost.shop_direct_labor": { description: "Direct labor cost for shop operations.", requiredInputs: ["technicianWages"], outputHint: "currency" },
  "cost.shop_indirect_labor": { description: "Indirect labor cost for shop operations.", requiredInputs: ["managerWages", "adminWages"], outputHint: "currency" },
  "cost.shop_overhead": { description: "Shop overhead cost based on labor.", requiredInputs: ["rent", "utilities", "insurance", "tools", "depreciation"], outputHint: "currency" },
  "cost.shop_total_cost": { description: "Total shop cost (direct + indirect + overhead).", requiredInputs: ["directLabor", "indirectLabor", "overhead"], outputHint: "currency" },
  "cost.shop_billable_hours": { description: "Billable hours from total hours and chargeable percentage.", requiredInputs: ["totalAvailableHours", "utilizationRate"], outputHint: "number" },
  "cost.shop_effective_margin": { description: "Effective shop margin percentage.", requiredInputs: ["actualBillingRate", "shopHourlyRate"], outputHint: "percentage" },
  ...
  "cost.machine_euac_capital": { description: "Equivalent uniform annual capital cost.", requiredInputs: ["purchaseCost", "residualValue", "discountRate", "lifeYears"], outputHint: "currency" },
  "cost.machine_euac_operating": { description: "Equivalent uniform annual operating cost.", requiredInputs: ["annualOperatingCost", "annualMaintenance", "annualEnergy"], outputHint: "currency" },
  ...
  "cost.tco_current": { description: "Current total cost of ownership.", requiredInputs: ["currentMaterialCost", "currentMaterialWeight", "productionVolume"], outputHint: "currency" },
  "cost.tco_alternative": { description: "Alternative total cost of ownership.", requiredInputs: ["alternativeMaterialCost", "alternativeWeight", "productionVolume"], outputHint: "currency" },
  "cost.tco_weight_savings": { description: "Weighted TCO savings across multiple units.", requiredInputs: ["currentMaterialWeight", "alternativeWeight", "productionVolume"], outputHint: "currency" },
  "cost.tco_net_benefit": { description: "Net TCO benefit from switching.", requiredInputs: ["currentTco", "alternativeTco", "toolingCost"], outputHint: "currency" },
  "measurement.tco_payback": { description: "TCO payback period from premium and net benefit.", requiredInputs: ["toolingCost", "netBenefit"], outputHint: "number" },
  "cost.eoq_moq_penalty": { description: "Penalty from MOQ exceeding EOQ quantity.", requiredInputs: ["moqQty", "optimalQty", "unitCost"], outputHint: "currency" },
  "cost.moq_price_break_savings": { description: "Savings from MOQ price break discount.", requiredInputs: ["priceBreakQty", "priceBreakUnitPrice", "unitCost"], outputHint: "currency" },
  ...
  "measurement.moq_optimal_qty": { description: "Optimal order quantity considering MOQ constraint.", requiredInputs: ["actualDemand", "moqQty"], outputHint: "number" },
  "measurement.availability_mtbf": { description: "Equipment availability from MTBF and MTTR.", requiredInputs: ["mtbfHours", "mttrHours"], outputHint: "number" },
  ...
  "cost.downtime_cost_mtbf": { description: "Cost of expected downtime.", requiredInputs: ["expectedDowntime", "machineHourlyCost"], outputHint: "currency" },
  "cost.reliability_total_cost": { description: "Total reliability cost including downtime, repair, and lost production.", requiredInputs: ["downtimeCost"], outputHint: "currency" },
  "cost.reliability_roi": { description: "ROI of reliability improvement investment.", requiredInputs: ["downtimeCost", "mtbfHours", "improvedMtbf", "improvementInvestment"], outputHint: "percentage" },
  ...
  "measurement.noise_exposure": { description: "Noise exposure dose as percentage of limit.", requiredInputs: ["noiseLevelDb", "exposureHours"], outputHint: "percentage" },
  "measurement.vibration_rms": { description: "Vibration RMS exposure level.", requiredInputs: ["vibrationRms", "vibrationDailyHours"], outputHint: "number" },
  "cost.noise_health_cost": { description: "Health cost from noise exposure.", requiredInputs: ["numWorkers", "avgWorkerSalary"], outputHint: "currency" },
  "cost.noise_productivity_loss": { description: "Productivity loss from noise exposure.", requiredInputs: ["noiseLevelDb", "numWorkers", "avgWorkerSalary"], outputHint: "currency" },
  "cost.noise_rework_cost": { description: "Rework cost attributed to noise-related errors.", requiredInputs: ["noiseLevelDb", "vibrationLevel"], outputHint: "currency" },
  "cost.noise_mitigation_roi": { description: "ROI of noise mitigation investments.", requiredInputs: ["healthCost", "productivityLoss", "reworkCost", "mitigationInvestment", "mitigationCost"], outputHint: "percentage" },
  ...
  "cost.office_consumption_rate": { description: "Monthly consumption rate from annual usage.", requiredInputs: ["monthlyConsumption"], outputHint: "number" },
  "cost.office_annual_cost": { description: "Annual ordering cost from EOQ model.", requiredInputs: ["consumptionRate", "unitPrice"], outputHint: "currency" },
  "cost.office_carrying_cost": { description: "Annual carrying cost of office inventory.", requiredInputs: ["currentOrderQty", "unitPrice"], outputHint: "currency" },
  "cost.office_stockout_cost": { description: "Stockout cost from lost margin.", requiredInputs: ["stockoutRate", "stockoutCostPerUnit"], outputHint: "currency" },
  "cost.office_eoq": { description: "Economic order quantity for office supplies.", requiredInputs: ["consumptionRate", "orderCost", "holdingRate"], outputHint: "number" },
  "cost.office_waste_pct": { description: "Office waste percentage from total ordered.", requiredInputs: ["currentOrderQty", "optimalEoq"], outputHint: "percentage" },
  "cost.office_optimization_savings": { description: "Savings from office inventory optimization.", requiredInputs: ["currentOrderQty", "optimalEoq"], outputHint: "currency" },
  ...
  "measurement.ot_hire_decision": { description: "OT vs hire decision (1=hire, 0=OT).", requiredInputs: ["overtimeHoursPerMonth", "breakevenHours"], outputHint: "score" },
  ...
  "cost.carrying_cost_ar": { description: "Carrying cost of accounts receivable.", requiredInputs: ["avgReceivables", "costOfCapital"], outputHint: "currency" },
  "cost.bad_debt_expense": { description: "Bad debt expense from credit sales and bad debt rate.", requiredInputs: ["annualRevenue", "badDebtRate"], outputHint: "currency" },
  "cost.discount_cost": { description: "Cost of early payment discounts taken.", requiredInputs: ["annualRevenue", "discountRate"], outputHint: "currency" },
  "measurement.cash_flow_impact_terms": { description: "Cash flow impact from payment terms change.", requiredInputs: ["currentTerms", "proposedTerms", "annualRevenue"], outputHint: "currency" },
  ...
  "measurement.learning_rate": { description: "Learning curve rate from percentage of previous.", requiredInputs: ["learningRate"], outputHint: "number" },
  "measurement.learning_slope": { description: "Learning curve slope (b factor).", requiredInputs: ["learningRate"], outputHint: "number" },
  "measurement.time_n": { description: "Time to produce the nth unit.", requiredInputs: ["firstUnitTime", "targetUnit", "learningRate"], outputHint: "duration" },
  "measurement.cumulative_time_n": { description: "Cumulative time for n units under learning curve.", requiredInputs: ["firstUnitTime", "targetUnit", "learningRate"], outputHint: "duration" },
  "measurement.average_time_n": { description: "Average time per unit under learning curve.", requiredInputs: ["cumulativeTimeN", "targetUnit"], outputHint: "duration" },
  "cost.learning_cost_n": { description: "Labor cost for the nth unit.", requiredInputs: ["timeN", "hourlyRate"], outputHint: "currency" },
  ...
  "measurement.sample_infinite": { description: "Sample size for infinite population.", requiredInputs: ["confidenceLevel", "marginError", "estimatedProportion"], outputHint: "number" },
  "measurement.sample_finite": { description: "Sample size adjusted for finite population.", requiredInputs: ["sampleInfinite", "populationSize"], outputHint: "number" },
  "measurement.sample_continuous": { description: "Sample size for continuous data.", requiredInputs: ["confidenceLevel", "marginError", "estimatedProportion"], outputHint: "number" },
  "measurement.sample_power_adj": { description: "Power-adjusted sample size.", requiredInputs: ["sampleFinite", "power", "effectSize"], outputHint: "number" },
  "measurement.sample_design_effect": { description: "Design effect for cluster sampling.", requiredInputs: ["clusterSize", "designEffect"], outputHint: "number" },
  "measurement.sample_final_n": { description: "Final sample size adjusted for design effect.", requiredInputs: ["sampleDesignEffect", "designEffect"], outputHint: "number" },
  ...
  "cost.rack_cost_per_position": { description: "Cost per pallet position in rack system.", requiredInputs: ["costPerPosition", "numberOfLevels"], outputHint: "currency" },
  ...
  "cost.ingredient_cost_portion": { description: "Ingredient cost per portion.", requiredInputs: ["ingredientCost"], outputHint: "currency" },
  "cost.yield_adjusted_cost": { description: "Yield-adjusted ingredient cost per portion.", requiredInputs: ["ingredientCostPortion", "yieldPercent"], outputHint: "currency" },
  "cost.portion_labor_cost": { description: "Labor cost per portion.", requiredInputs: ["laborCostPerPortion"], outputHint: "currency" },
  "cost.portion_overhead": { description: "Overhead cost per portion.", requiredInputs: ["overheadPerPortion"], outputHint: "currency" },
  ...
  "cost.project_direct_labor": { description: "Project direct labor cost.", requiredInputs: ["directLabor"], outputHint: "currency" },
  "cost.project_direct_material": { description: "Project direct material cost.", requiredInputs: ["directMaterial"], outputHint: "currency" },
  "cost.project_equipment": { description: "Project equipment cost.", requiredInputs: ["equipment"], outputHint: "currency" },
  "cost.project_subcontractor": { description: "Project subcontractor cost including mobilization.", requiredInputs: ["subcontractor"], outputHint: "currency" },
  "cost.project_overhead": { description: "Project overhead based on direct costs.", requiredInputs: ["directLabor", "directMaterial", "equipment", "subcontractor", "overheadPercent"], outputHint: "currency" },
  "cost.project_contingency": { description: "Project contingency allowance.", requiredInputs: ["directLabor", "directMaterial", "equipment", "subcontractor", "projectOverhead", "contingencyPercent"], outputHint: "currency" },
  "cost.project_total_estimate": { description: "Total project cost estimate.", requiredInputs: ["projectDirectLabor", "projectDirectMaterial", "projectEquipment", "projectSubcontractor", "projectOverhead", "projectContingency"], outputHint: "currency" },
  ...
  "cost.recipe_theoretical": { description: "Theoretical recipe cost at standard yield.", requiredInputs: ["recipeQty", "ingredientCostPerKg"], outputHint: "currency" },
  "cost.recipe_actual": { description: "Actual recipe cost incurred.", requiredInputs: ["actualUsage", "ingredientCostPerKg"], outputHint: "currency" },
  ...
  "cost.recipe_yield_loss_cost": { description: "Cost of recipe yield loss.", requiredInputs: ["recipeQty", "actualUsage", "ingredientCostPerKg"], outputHint: "currency" },
  ...
  "cost.recipe_cost_per_kg": { description: "Recipe cost per kg of output.", requiredInputs: ["recipeActual", "actualUsage"], outputHint: "currency" },
  "cost.restaurant_theoretical_food": { description: "Theoretical food cost from sales and ideal percentage.", requiredInputs: ["theoreticalFoodCost"], outputHint: "currency" },
  "cost.restaurant_actual_food": { description: "Actual food cost from inventory and purchases.", requiredInputs: ["actualFoodCost"], outputHint: "currency" },
  ...
  "measurement.restaurant_variance_pct": { description: "Food cost variance as percentage of actual.", requiredInputs: ["restaurantVariance", "theoreticalFoodCost"], outputHint: "percentage" },
  "cost.restaurant_waste_cost": { description: "Waste cost from discarded ingredients.", requiredInputs: ["wasteAmount"], outputHint: "currency" },
  "cost.restaurant_theft_loss": { description: "Loss from theft of ingredients.", requiredInputs: ["theftLoss"], outputHint: "currency" },
  "measurement.restaurant_ideal_margin": { description: "Ideal restaurant margin percentage.", requiredInputs: ["theoreticalFoodCost", "revenue"], outputHint: "percentage" },
  "measurement.restaurant_actual_margin": { description: "Actual restaurant margin percentage.", requiredInputs: ["actualFoodCost", "revenue"], outputHint: "percentage" },
  "cost.manual_cost_annual": { description: "Annual cost of manual operations.", requiredInputs: ["manualLaborCost", "numWorkers"], outputHint: "currency" },
  "cost.robot_cost_annual": { description: "Annual cost of robot operations.", requiredInputs: ["robotInvestment", "robotLife", "robotMaintenance", "robotEnergy"], outputHint: "currency" },
  "measurement.robot_output": { description: "Annual robot output in units.", requiredInputs: ["robotOutput"], outputHint: "number" },
  "measurement.manual_output": { description: "Annual manual output in units.", requiredInputs: ["manualOutput", "numWorkers"], outputHint: "number" },
  ...
  "cost.robot_roi_analyzer": { description: "ROI of robot automation vs manual.", requiredInputs: ["manualCostAnnual", "robotCostAnnual", "robotInvestment"], outputHint: "percentage" },
  ...
  "cost.route_distance_cost": { description: "Route cost based on distance traveled.", requiredInputs: ["distance", "fuelCostPerKm"], outputHint: "currency" },
  "cost.route_time_cost": { description: "Route cost based on travel time.", requiredInputs: ["distance", "avgSpeed"], outputHint: "currency" },
  "cost.route_toll_cost": { description: "Route cost from tolls and passes.", requiredInputs: ["tollCost"], outputHint: "currency" },
  "cost.route_maintenance_cost": { description: "Route maintenance cost based on distance.", requiredInputs: ["distance", "maintenancePerKm"], outputHint: "currency" },
  "cost.route_overhead_cost": { description: "Route overhead cost based on distance.", requiredInputs: ["distance", "overheadPercent"], outputHint: "currency" },
  "cost.route_total_cost_simple": { description: "Total route cost including distance, time, tolls, maintenance, and overhead.", requiredInputs: ["routeDistanceCost", "routeTimeCost", "routeTollCost", "routeMaintenanceCost", "routeOverhead"], outputHint: "currency" },
  "measurement.route_cost_per_km": { description: "Route cost per kilometer.", requiredInputs: ["routeTotalCost", "distance"], outputHint: "currency" },
  "measurement.route_cost_per_drop": { description: "Route cost per delivery drop.", requiredInputs: ["routeTotalCost", "numberOfDrops"], outputHint: "currency" },
  "yield.gap_value": {
  ...
  "route.distance_drift_cost": {
    ...
    requiredInputs: ["actualDistanceKm", "plannedDistanceKm", "fuelCostPerKm"],
    outputHint: "currency",
  },
  "cost.sum2": {
  ...
  "energy.compressor_leak_kwh": {
    ...
    requiredInputs: ["compressorKw", "operatingHours", "leakPercent"],
    outputHint: "number",
  },
  "cost.annualize": {
  ...
  "cost.method_crossover_quantity": {
    ...
    requiredInputs: ["unitB", "unitA", "fixedA", "fixedB"],
    outputHint: "number",
  },
  ...
  "lean.score_gap_percent": {
    ...
    requiredInputs: ["targetScore", "currentScore"],
    outputHint: "percentage",
  },
  ...
  "layout.rect_bed_utilization_pct": {
    ...
    requiredInputs: ["bedWidth", "bedDepth", "partsPerRow", "partsPerColumn", "partWidth", "partDepth"],
    outputHint: "percentage",
  },
  ...
  "inventory.eoq_units": {
    ...
    requiredInputs: ["unitCost", "carryingCostPercent", "annualDemand", "orderCost"],
    outputHint: "number",
  },
  ...
  "calibration.tolerance_status": {
    ...
    requiredInputs: ["tolerance", "actual", "target"],
    outputHint: "percentage",
  },
  ...
  "measurement.vessel_wall_thickness": {
    ...
    requiredInputs: ["designPressureBar", "diameterMm", "allowableStressMpa"],
    outputHint: "number",
  },
  "cost.sum3": {
  ...
  "finance.payback_years": {
    ...
    requiredInputs: ["annualSavings", "initialInvestment"],
    outputHint: "number",
  },
  "finance.simple_npv": {
    description: "NPV with fixed annual cash flow and discount rate.",
    requiredInputs: ["initialCost", "cashFlowYears1to5", "discountRate"],
    outputHint: "currency",
  },
  ...
  "fluid.darcy_friction_factor": {
    ...
    requiredInputs: ["reynoldsNumber", "relativeRoughness"],
    outputHint: "number",
  },
  ...
  // ── TOOL 2: Six Sigma ──
  "stats.dpmo": { description: "DPMO = (defects / (units × opportunities)) × 1M.", requiredInputs: ["units", "opportunities", "defects"], outputHint: "number" },
  "stats.yield_rate": { description: "Yield = 1 - (defects / (units × opportunities)).", requiredInputs: ["units", "opportunities", "defects"], outputHint: "percentage" },
  ...
  "depreciation.tco": { description: "TCO = acquisition + PV(op+maint) - PV(residual).", requiredInputs: ["acquisitionCost", "annualOpCost", "annualMaintCost", "fuelCostPerYear", "residualValue", "discountRate", "usefulLife"], outputHint: "currency" },
  ...
  "cost.comeback_direct": { description: "Direct comeback = labor + parts + opportunity.", requiredInputs: ["comebackOrders", "avgDiagnosisMinutes", "avgRepairMinutes", "laborRate", "avgWastedPartsValue", "bayOccupancyHours", "revenuePerBayHour"], outputHint: "currency" },
  ...
  "measurement.concrete_volume_total": { description: "Total concrete volume from slab/footing/column/wall geometry.", requiredInputs: ["slabLength", "slabWidth", "slabThickness", "footingLength", "footingWidth", "footingDepth", "footingCount", "columnDiameter", "columnHeight", "columnCount", "wallLength", "wallHeight", "wallThickness", "wasteFactor"], outputHint: "number" },
  ...
  "measurement.route_efficiency_score": { description: "Route efficiency as theoretical minimum over actual distance.", requiredInputs: ["nearestNeighborDist", "clarkeWrightDist"], outputHint: "number" },
  "cost.route_total_savings": { description: "Total routing savings from baseline minus optimized cost.", requiredInputs: ["totalDistance", "fuelCostPerKm"], outputHint: "currency" },
  ...
  "cost.wind_lcoe": { description: "Levelized cost of energy for wind turbine.", requiredInputs: ["costPerMW", "opexAnnual", "projectLife", "annualGeneration", "lifeYears"], outputHint: "currency" },
  "cost.wind_npv": { description: "Net present value of wind turbine investment.", requiredInputs: ["annualGeneration", "discountRate", "projectLife", "wacc", "costPerMW"], outputHint: "currency" },
  ...
  "cost.saas_shelfware_cost": { description: "Cost of unused SaaS licenses.", requiredInputs: ["totalLicenses", "activeUsers"], outputHint: "currency" },
  ...
  "measurement.smed_capacity_recovered": { description: "Capacity recovered from SMED setup reduction.", requiredInputs: ["currentChangeoverTime", "targetChangeoverTime", "changeoversPerMonth"], outputHint: "number" },
  "cost.smed_financial_gain": { description: "Financial gain from SMED capacity recovery.", requiredInputs: ["capacityRecovered", "machineHourlyRate", "operatorCount"], outputHint: "currency" },
  "cost.smed_roi": { description: "ROI of SMED investment.", requiredInputs: ["financialGain", "smedImplementationCost", "smedInvestment"], outputHint: "percentage" },
  ...
  "measurement.spc_arl_in_control": { description: "Average run length when process is in control.", requiredInputs: ["controlLimit"], outputHint: "number" },
  ...
  "cost.spc_delay_cost": { description: "Cost of delayed SPC signal detection.", requiredInputs: ["arlOutOfControl", "sampleSize", "productionRate", "costPerDefect"], outputHint: "currency" },
  "measurement.steam_loss_rate": { description: "Steam loss rate through orifice.", requiredInputs: ["holeDiameter", "steamPressure"], outputHint: "number" },
  "cost.steam_trap_annual_loss": { description: "Annual cost of steam loss through failed trap.", requiredInputs: ["steamLossRate", "operatingHoursPerYear", "steamCost", "faultyTraps"], outputHint: "currency" },
  "cost.steam_trap_roi": { description: "ROI of steam trap repair.", requiredInputs: ["faultyTraps", "replacementCost", "annualLoss"], outputHint: "percentage" },
  "measurement.inventory_turnover_ratio": { description: "Inventory turnover ratio from COGS and average inventory.", requiredInputs: ["annualCogs", "avgInventory"], outputHint: "number" },
  "measurement.dsi_days": { description: "Days sales of inventory (DSI).", requiredInputs: ["daysInPeriod", "inventoryTurnoverRatio"], outputHint: "number" },
  ...
  "measurement.water_intensity": { description: "Water consumption per unit of production.", requiredInputs: ["totalWaterUse", "productionOutput"], outputHint: "number" },
  "cost.water_savings_total": { description: "Total water savings from baseline minus actual consumption.", requiredInputs: ["waterIntensity", "targetWaterIntensity"], outputHint: "number" },
  "cost.water_cost_savings": { description: "Monetary savings from reduced water use.", requiredInputs: ["waterSavingsTotal", "waterCostPerM3", "wastewaterCostPerM3"], outputHint: "currency" },
  "cost.water_roi": { description: "ROI of water conservation project.", requiredInputs: ["waterCostSavings", "efficiencyInvestment", "equipmentCost", "installationCost"], outputHint: "percentage" },
  "measurement.irrigation_water_req": { description: "Irrigation water requirement from ETc, area, and effective rainfall.", requiredInputs: ["cropWaterNeed", "area", "rainfall"], outputHint: "number" },
  "cost.irrigation_energy_cost": { description: "Energy cost for irrigation pumping.", requiredInputs: ["pumpPower", "pumpHours", "electricityCost"], outputHint: "currency" },
  "cost.irrigation_total_cost": { description: "Total irrigation cost including energy, maintenance, labor, and depreciation.", requiredInputs: ["irrigationEnergyCost", "irrigationWaterReq", "laborCost", "depreciation"], outputHint: "currency" },
  "cost.supplier_tco": { description: "Total cost of ownership for a supplier.", requiredInputs: ["unitPrice", "defectRate", "freightCostPerUnit", "leadTimeDays", "holdingCostPct", "inspectionCostPerUnit"], outputHint: "currency" },
  ...
  "measurement.cycle_flexibility": { description: "Cycle flexibility ratio of takt time over actual cycle time.", requiredInputs: ["cycleTime"], outputHint: "number" },
  ...
  "cost.quote_total": { description: "Total repair quote from parts, labor, and overhead.", requiredInputs: ["partsCost", "laborHours", "hourlyRate"], outputHint: "currency" },
  "cost.gross_profit_pct": { description: "Gross profit percentage on repair work.", requiredInputs: ["quoteTotal", "quoteTotalOut"], outputHint: "percentage" },
  "measurement.quoted_margin": { description: "Quoted margin percentage on subcontract work.", requiredInputs: ["quotedAmount", "actualCost"], outputHint: "percentage" },
  "measurement.actual_margin": { description: "Actual margin percentage achieved.", requiredInputs: ["contractMargin", "actualCost"], outputHint: "percentage" },
  ...
  "cost.transit_time_cost": { description: "Transit time cost from days, capital cost, and cargo value.", requiredInputs: ["transitDays", "cargoValue", "costOfCapital"], outputHint: "currency" },
  ...
  "cost.risk_exposure_sc": { description: "Supply chain risk exposure from supplier spend and disruption probability.", requiredInputs: ["annualRevenue", "disruptionProbability"], outputHint: "currency" },
  "cost.revenue_loss_sc": { description: "Revenue loss from supply chain disruption.", requiredInputs: ["recoveryDays", "annualRevenue", "revenueAtRisk"], outputHint: "currency" },
  ...
  "cost.recurring_annual_cost": { description: "Annualized recurring cost from monthly cost.", requiredInputs: ["monthlyRecurringCost"], outputHint: "currency" },
  "cost.present_value_recurring": { description: "Present value of recurring costs over time.", requiredInputs: ["recurringAnnualCost", "discountRate", "expectedLifeYears"], outputHint: "currency" },
  "cost.npv_elimination": { description: "NPV of eliminating recurring cost.", requiredInputs: ["presentValueRecurring", "eliminationProjectCost"], outputHint: "currency" },
  "cost.root_cause_payback": { description: "Payback period for root cause fix investment.", requiredInputs: ["eliminationProjectCost", "recurringAnnualCost"], outputHint: "number" },
  "measurement.textile_waste_rate": { description: "Textile waste rate as percentage of total material.", requiredInputs: ["fabricWaste", "fabricUsed"], outputHint: "percentage" },
  "cost.pre_consumer_waste": { description: "Cost of pre-consumer textile waste.", requiredInputs: ["fabricWaste", "fabricUnitCost"], outputHint: "currency" },
  "cost.net_waste_cost": { description: "Net textile waste cost after recycling revenue.", requiredInputs: ["preConsumerWaste", "recycleRevenue"], outputHint: "currency" },
  "measurement.waste_risk_score": { description: "Textile waste risk score relative to industry benchmark.", requiredInputs: ["textileWasteRate", "netWasteCost"], outputHint: "number" },
  ...
  "measurement.seed_requirement": { description: "Seed requirement from area and seeding rate.", requiredInputs: ["fieldArea", "seedPerDecare"], outputHint: "number" },
  "cost.seed_cost_total": { description: "Total seed cost from requirement and price.", requiredInputs: ["seedRequirement", "seedUnitCost"], outputHint: "currency" },
  "cost.seed_financial_loss": { description: "Financial loss from poor seed germination.", requiredInputs: ["germinationRate", "wasteRateSeeds", "seedCostTotal"], outputHint: "currency" },
  "cost.total_employee_cost": { description: "Total employee cost including salary, employer costs, bonus, training, and benefits.", requiredInputs: ["avgGrossSalary", "employerPayrollTax", "benefitsCostPerEmployee", "trainingCostPerEmployee"], outputHint: "currency" },
  "cost.employee_cost_per_hour": { description: "Employee cost per working hour.", requiredInputs: ["totalEmployeeCost", "avgWorkHoursPerMonth"], outputHint: "currency" },
  "cost.transfer_tax_impact": { description: "Tax impact from transfer price vs market price.", requiredInputs: ["transferPrice", "armLengthPrice", "entityATaxRate"], outputHint: "currency" },
  "cost.transfer_global_profit": { description: "Global profit after transfer tax adjustment.", requiredInputs: ["transferPrice", "armLengthPrice", "transferTaxImpact"], outputHint: "currency" },
  "measurement.complexity_index": { description: "Product complexity index from unique vs total parts.", requiredInputs: ["numSkus", "numPartsPerSku"], outputHint: "number" },
  ...
  "measurement.vacuum_leak_rate": { description: "Vacuum leak rate from pressure drop, volume, and test duration.", requiredInputs: ["leakRate", "numLeaks"], outputHint: "number" },
  ...
  "measurement.vacuum_capacity_waste": { description: "Vacuum capacity wasted by leaks.", requiredInputs: ["capacityWaste", "motorPower"], outputHint: "percentage" },
  "cost.shift_total_cost": { description: "Total shift cost from workers, hours, and rate.", requiredInputs: ["workersPerShift", "shiftHours", "hourlyWage"], outputHint: "currency" },
  "measurement.shift_efficiency": { description: "Shift efficiency from actual vs max output.", requiredInputs: ["dailyOutput"], outputHint: "percentage" },
  "cost.shift_cost_per_unit": { description: "Shift cost per unit produced.", requiredInputs: ["shiftTotalCost", "dailyOutput"], outputHint: "currency" },
  ...
  "measurement.renewable_annual_gen": { description: "Annual renewable energy generation from capacity and capacity factor.", requiredInputs: ["annualGeneration", "degradationRate"], outputHint: "number" },
  ...
  "cost.roi_investment": { description: "Return on investment from net profit and investment.", requiredInputs: ["initialInvestment", "netProfit", "annualCashFlowNpv", "annualCashflow", "revenueAnnual", "operatingCostAnnual", "projectLifeYears", "purchaseResidualAmt", "residualValue"], outputHint: "percentage" },
  "cost.npv_investment": { description: "Net present value of investment.", requiredInputs: ["initialInvestment", "discountRateNpv", "discountRate", "annualCashFlowNpv", "netProfit", "annualCashflow", "revenueAnnual", "operatingCostAnnual", "lifeYearsNpv", "projectLifeYears", "purchaseResidualAmt", "residualValue"], outputHint: "currency" },
  "cost.irr_investment": { description: "Internal rate of return proxy from cash flow ratio.", requiredInputs: ["initialInvestment", "annualCashFlowNpv", "netProfit", "annualCashflow", "revenueAnnual", "operatingCostAnnual", "projectLifeYears", "lifeYearsNpv", "purchaseResidualAmt", "residualValue"], outputHint: "percentage" },
  "cost.payback_period_inv": { description: "Payback period for investment in years.", requiredInputs: ["initialInvestment", "annualCashFlowNpv", "netProfit", "annualCashflow", "revenueAnnual", "operatingCostAnnual"], outputHint: "number" },
  ...
  "measurement.waste_percentage": { description: "Waste percentage from waste over total.", requiredInputs: ["hiddenCostComplexity", "numSkus"], outputHint: "percentage" },
  ...
  "measurement.crack_risk_score": { description: "Crack risk score from carbon equivalent vs threshold.", requiredInputs: ["carbonEquivalent", "materialThickness"], outputHint: "number" },
  ...
  "measurement.renewable_payback": { description: "Payback period from investment and annual cash flow.", requiredInputs: ["installationCost", "annualGeneration"], outputHint: "number" },
  "measurement.dso": { description: "Days sales outstanding from AR and annual revenue.", requiredInputs: ["avgReceivables", "annualRevenue"], outputHint: "number" },
  ...
  "measurement.machine_economic_life": { description: "Machine economic life from operating cost, salvage factor, and holding cost rate.", requiredInputs: ["purchaseCost", "purchaseResidualAmt", "discountRate"], outputHint: "number" },
  ...
  "measurement.schedule_delay": { description: "Schedule delay from planned duration and EV.", requiredInputs: ["actualDays", "scheduleDays", "spi"], outputHint: "number" },
  ...
  "cost.robot_roi": { description: "ROI of robot automation including error cost.", requiredInputs: ["manualCostAnnual", "robotCostAnnual", "robotInvestment"], outputHint: "percentage" },
  ...
  "calculateIrreversibilityPenalty": { description: "Calculates irreversible capital penalty.", requiredInputs: ["irreversibleCapex", "recoveryValue", "regulatoryOrSafetyCriticality"], outputHint: "currency" },
  "calculateWaitOptionValue": { description: "Calculates value of waiting option.", requiredInputs: ["irreversibleCapex", "uncertaintySigma", "decisionHorizon", "delayCost"], outputHint: "currency" },
