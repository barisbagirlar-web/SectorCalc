...
import type { BatchInputDesignAuditResult } from "@/lib/features/formula-governance/input-design-audit/input-design-audit-types";
...
import {
  ...
  isMetadataBlocker,
} from "@/lib/features/formula-governance/input-design-audit/migration-plan/governance-coverage";
import { selectFirstControlledPatchBatch } from "@/lib/features/formula-governance/input-design-audit/migration-plan/first-patch-batch-selector";
import {
  resolveCanPatchWithoutUIBreak,
  resolveMigrationPriority,
  resolveMigrationRiskLevel,
} from "@/lib/features/formula-governance/input-design-audit/migration-plan/migration-risk";
import type {
  BatchMigrationPlan,
  MigrationPatchLevel,
...
} from "@/lib/features/formula-governance/input-design-audit/controlled-input-patch/controlled-input-design-status";
