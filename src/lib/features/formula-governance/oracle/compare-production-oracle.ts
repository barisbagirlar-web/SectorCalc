...
import { getProductionFormulaLocator } from "@/lib/features/formula-governance/oracle/production-formula-locator";
import {
...
} from "@/lib/features/formula-governance/oracle/compare-business-operations-oracle";
import {
  isBatchFreeComparisonSlug,
  runAllBatchFreeOracleComparisonAudits,
  runBatchFreeOracleComparisonAudit,
} from "@/lib/features/formula-governance/oracle/compare-batch-free-oracle";
import {
  isBatchFreeBatch2ComparisonSlug,
  runAllBatchFreeBatch2OracleComparisonAudits,
  runBatchFreeBatch2OracleComparisonAudit,
} from "@/lib/features/formula-governance/oracle/compare-batch-free-batch2-oracle";
import {
  isBatchPremiumComparisonSlug,
  runAllBatchPremiumOracleComparisonAudits,
  runBatchPremiumOracleComparisonAudit,
} from "@/lib/features/formula-governance/oracle/compare-batch-premium-oracle";
import {
  isBatchPremiumBatch3ComparisonSlug,
  runAllBatchPremiumBatch3OracleComparisonAudits,
  runBatchPremiumBatch3OracleComparisonAudit,
} from "@/lib/features/formula-governance/oracle/compare-batch-premium-batch3-oracle";
import {
  isBatchPremiumSchemaComparisonSlug,
  runAllBatchPremiumSchemaOracleComparisonAudits,
  runBatchPremiumSchemaOracleComparisonAudit,
} from "@/lib/features/formula-governance/oracle/compare-batch-premium-schema-oracle";
import {
  isBatchTrafficCatalogComparisonSlug,
  runAllBatchTrafficCatalogOracleComparisonAudits,
  runBatchTrafficCatalogOracleComparisonAudit,
} from "@/lib/features/formula-governance/oracle/compare-batch-traffic-catalog-oracle";
import {
  isRoadmapFreeBatchComparisonSlug,
  runAllRoadmapFreeBatchOracleComparisonAudits,
  runRoadmapFreeBatchOracleComparisonAudit,
} from "@/lib/features/formula-governance/oracle/compare-roadmap-free-batch-oracle";
import {
...
} from "@/lib/features/formula-governance/oracle/compare-premium-schema-extended-oracle";
...
export function auditOracleComparisonForSlug(slug: string): OracleComparisonAuditSummary | null {
  ...
  if (isBatchFreeBatch2ComparisonSlug(slug)) {
    return runBatchFreeBatch2OracleComparisonAudit(slug);
  }
  if (isBatchPremiumBatch3ComparisonSlug(slug)) {
    return runBatchPremiumBatch3OracleComparisonAudit(slug);
  }
  if (isBatchPremiumSchemaComparisonSlug(slug)) {
    return runBatchPremiumSchemaOracleComparisonAudit(slug);
  }
  if (isBatchTrafficCatalogComparisonSlug(slug)) {
    return runBatchTrafficCatalogOracleComparisonAudit(slug);
  }
