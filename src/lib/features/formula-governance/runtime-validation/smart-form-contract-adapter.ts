...
import { resolveFieldUnitMetadata } from "@/lib/core/units/canonical-unit-normalizer";
import type { UnitSystem } from "@/lib/core/units/unit-definitions";
import { enrichLoanPaymentRegionalDisplay } from "@/lib/features/regional/pilot/loan-payment-regional-pilot";
import type { RegionalSmartFormInputExtension } from "@/lib/features/regional/types";
import { resolveFreeToolFieldDisplay, resolveSmartFormDecisionGoal } from "@/lib/infrastructure/i18n/free-tool-form-i18n";
