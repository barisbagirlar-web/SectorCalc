...
export type BuildOntologyAliasMapParams = {
  readonly contractOntology: import("@/lib/features/formula-governance/calculation-ontology/ontology-types").CalculationOntology;
  readonly fixtureOntology: import("@/lib/features/formula-governance/calculation-ontology/ontology-types").CalculationOntology;
  readonly slug: string;
};
