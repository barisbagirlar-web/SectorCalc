...
export const SEO_REFRESH_PRIORITY: readonly SeoRefreshPriorityItem[] = [
  {
    path: "/en/seo/manufacturing-cost-calculators",
    type: "seo_landing",
    priority: "tier_1",
  ...
  {
    path: "/en/seo/construction-cost-calculators",
    type: "seo_landing",
    priority: "tier_1",
  ...
  {
    path: "/en/seo/logistics-route-calculators",
    type: "seo_landing",
    priority: "tier_1",
  ...
  {
    path: "/en/seo/energy-carbon-calculators",
    type: "seo_landing",
    priority: "tier_1",
  ...
  {
    path: "/en/guides/what-is-oee-and-how-to-calculate-it",
    type: "guide",
    priority: "tier_1",
  ...
  {
    path: "/en/guides/how-to-calculate-scrap-rate",
    type: "guide",
    priority: "tier_1",
  ...
  {
    path: "/en/guides/how-to-use-area-converter",
    type: "guide",
    priority: "tier_1",
  ...
  {
    path: "/en/tools/free/area-converter",
    type: "free_tool",
    priority: "tier_1",
  ...
  {
    path: "/en/tools/free/oee-calculator",
    type: "free_tool",
    priority: "tier_1",
  ...
  {
    path: "/en/tools/free/concrete-volume-calculator",
    type: "free_tool",
    priority: "tier_1",
  ...
  {
    path: "/en/tools/premium-schema/cnc-oee-loss",
  ...
  {
    path: "/en/tools/premium-schema/carbon-footprint-compliance-risk",
    type: "premium_analyzer",
    priority: "tier_1",
