 ...
 * ISO 9001 / ECMI / TÜV-certifiable translation policy.
 */
...
export const PDF_LABELS: Record<SupportedLocale, PdfReportLabels> = {
  ...
  tr: {
    ...
    inputValue: "Girilen Değer",
    assumptions: "Mühendislik Varsayımları",
    methodology: "Metodoloji ve Standartlar",
    usageNote: "Kullanım Anlaşması",
    legalNote: "Yasal Uyarı",
    simulationNotice:
      "Teknik karar destek simülasyonu — mali, hukuki, tıbbi veya mühendislik danışmanlığı değildir.",
    trustTrace: "Güven İzi",
    verifiedReport:
      "Bu raporun bütünlüğü aşağıdaki adreste kriptografik olarak doğrulanabilir.",
    critical: "Kritik",
    warning: "Uyarı",
    acceptable: "Kabul Edilebilir",
    safe: "Sınırlar İçinde",
    notAvailable: "Mevcut değil",
    noDrivers: "Önemli görünmeyen kayıp kalemi tespit edilmedi.",
    noThresholds: "Tüm eşikler kabul edilebilir sınırlar içindedir.",
    noInputs: "Girdiler analiz oturumu sırasında kaydedilmiştir.",
    analysisChart: "Etki Analizi",
    impactDistribution: "Kayıp Kalemleri Dağılımı",
    severityDistribution: "Eşik Şiddet Dağılımı",
  ...
  de: {
    ...
    simulationNotice:
      "Technische Entscheidungsunterstützung — keine Finanz-, Rechts-, Medizin- oder Ingenieurberatung.",
