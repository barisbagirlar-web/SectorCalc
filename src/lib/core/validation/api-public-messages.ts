...
export const API_PUBLIC_MESSAGES = assertCompleteCatalog({
  rateLimitError: {
    ...
    tr: "Istek limiti asildi",
    de: "Rate-Limit uberschritten",
  ...
  rateLimitMessage: {
    ...
    tr: "Cok fazla calculation istegi gonderildi. Lutfen kisa sure sonra tekrar deneyin.",
    de: "Zu viele Berechnungsanfragen. Bitte versuchen Sie es in Kurze erneut.",
  ...
  invalidBodyError: {
    ...
    tr: "Gecersiz istek govdesi",
    de: "Ungultiger Anfragekorper",
  ...
  invalidBodyMessage: {
    ...
    tr: 'Istek govdesi bir "inputs" nesnesi icermelidir.',
    de: 'Der Anfragekorper muss ein "inputs"-Objekt enthalten.',
  ...
  toolNotFoundMessage: {
    ...
    tr: '"{slug}" slug degeri icin hesaplama araci bulunamadi.',
    de: 'Kein Rechner fur Slug "{slug}" gefunden.',
  ...
  schemaNotFoundError: {
    ...
    tr: "Dogrulama semasi bulunamadi",
  ...
  schemaNotFoundMessage: {
    ...
    tr: '"{slug}" aracinin dogrulama semasi yuklenemedi.',
    de: 'Validierungsschema fur "{slug}" konnte nicht geladen werden.',
  ...
  invalidInputError: {
    ...
    tr: "Gecersiz girdi parametreleri (AI halusinasyonu tespit edildi)",
    de: "Ungultige Eingabeparameter (KI-Halluzination erkannt)",
  ...
  unknownInputFieldMessage: {
    ...
    tr: '"{slug}" araci icin bilinmeyen girdi alani: "{field}".',
    de: 'Unbekanntes Eingabefeld "{field}" fur Tool "{slug}".',
  ...
  engineNotFoundError: {
    ...
    tr: "Calculation motoru bulunamadi",
  ...
  engineNotFoundMessage: {
    ...
    tr: '"{slug}" aracinin hesaplama motoru bulunamadi.',
    de: 'Berechnungsengine fur "{slug}" wurde nicht gefunden.',
  ...
  invalidResultError: {
    ...
    tr: "Calculation gecersiz sonuc uretti (NaN/Infinity)",
    de: "Berechnung lieferte ungultiges Ergebnis (NaN/Infinity)",
  ...
  invalidResultMessage: {
    ...
    tr: "Lutfen girdi valuelerinizi kontrol edin ve tekrar deneyin.",
    de: "Bitte uberprufen Sie Ihre Eingabewerte und versuchen Sie es erneut.",
  ...
  engineFailedError: {
    ...
    tr: "Motor yurutme hatasi",
    de: "Engine-Ausfuhrung fehlgeschlagen",
  ...
  engineFailedMessage: {
    ...
    tr: '"{slug}" araci calistirilamadi. Slug ve girdi formatini dogrulayin.',
    de: 'Rechner "{slug}" konnte nicht ausgefuhrt werden. Slug und Eingabeformat prufen.',
  ...
  botNotFoundBody: {
    en: "No calculator found for slug `{slug}`.",
    tr: "`{slug}` slug valuei icin calculation araci bulunamadi.",
    de: "Kein Rechner fur Slug `{slug}` gefunden.",
    fr: "Aucun calculateur trouvé pour le slug `{slug}`.",
    es: "No se encontró calculadora para el slug `{slug}`.",
    ar: "لم يتم العثور على حاسبة للمعرّف `{slug}`.",
  ...
  botUsageNote: {
    ...
    tr: "SectorCalc sektore ozel calculatorlar ve karar support ciktilari sunar. Sonuclar teknik simulasyonlardir; finansal, hukuki, tibbi veya muhendislik tavsiyesi degildir. Is kararlarindan once dogrulayin.",
    de: "SectorCalc bietet branchenspezifische Rechner und Entscheidungsunterstutzung. Ergebnisse sind technische Simulationen — keine Finanz-, Rechts-, Medizin- oder Ingenieurberatung. Vor Geschäftsentscheidungen verifizieren.",
