...
const METHODOLOGY_TEMPLATES: Record<string, (p: MethodologyTemplateParams) => string> = {
  ...
  ar: (p) =>
    `يستخدم النموذج ${p.inputCount} معلمة إدخال عبر ${p.formulaCount} صيغة. المدخلات الرئيسية: ${p.inputNames}. جميع الصيغ حتمية ومتسقة الوحدات. تحقق من الافتراضات مقابل ظروف التشغيل الفعلية قبل اتخاذ القرارات التجارية.`,
};
