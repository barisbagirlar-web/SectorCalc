...
describe("revenue funnel", () => {
  test("free_tool_open score düşük", () => {
  ...
  test("premium_unlock_click score yüksek", () => {
  ...
  test("pricing_cta_click score daha yüksek", () => {
  ...
  test("beta_partner_submit hot sinyal üretir", () => {
  ...
  test("scoreRevenueIntent empty events cold döner", () => {
  ...
  test("scoreRevenueIntent hot eventlerde hot döner", () => {
    const summary = scoreRevenueIntent([
  ...
  test("rankCampaigns empty events crash yapmaz", () => {
  ...
  test("premium revenue score empty events crash yapmaz", () => {
  ...
  test("recommended fixes boş değil", () => {
