...
const PREMIUM_ROADMAP_I18N: Record<AppLocale, PremiumRoadmapCopy> = {
  ...
  tr: {
    eyebrow: "Stratejik yol haritası",
    title: "Stratejik Premium Hesaplayıcı Yol Haritası",
    subtitle:
      "SectorCalc stratejik kataloğundaki yayında ve planlanan premium hesaplayıcılar. Yayında olanlar mevcut hesaplayıcıyı açar; planlananlar yayınlanana kadar yalnızca yol haritasında görünür.",
    phaseFilterLabel: "Faz",
    statusFilterLabel: "Durum",
    phaseAll: "Tüm fazlar",
    phase1: "Faz 1 — Öncelikli Premium Hesaplayıcılar",
    phase2: "Faz 2 — Operasyonel Karar Hesaplayıcıları",
    phase3: "Faz 3 — Trafik ve Otorite Hesaplayıcıları",
    phase4: "Faz 4 — Niş Teknik Hesaplayıcılar",
    phaseBadge: (phase) => `Faz ${phase}`,
    statusAll: "Tümü",
    statusLive: "Yayında",
    statusPlanned: "Planlandı",
    scoreLabel: (score) => `Puan ${score}`,
    ctaOpen: "Hesaplayıcıyı aç",
    ctaComingSoon: "Yakında",
    noResults: "Bu filtrelere uyan hesaplayıcı yok.",
    categories: {
