...
const FORM_TO_SCHEMA_INPUT: Record<string, string> = {
  planned_operating_hours: "n_planned_operating_hours",
  utilization_percent: "n_utilization_percent",
  planned_downtime_percent: "n_planned_downtime_percent",
  purchase_price: "n_purchase_price",
  residual_value: "n_residual_value",
  economic_life_years: "n_economic_life_years",
  maintenance_cost: "n_maintenance_cost",
  insurance_tax_cost: "n_insurance_tax_cost",
  facility_allocation: "n_facility_allocation",
  machine_power_kw: "n_machine_power_kw",
  electricity_price: "n_electricity_price",
  consumables_cost_per_hour: "n_consumables_cost_per_hour",
  tooling_cost_per_hour: "n_tooling_cost_per_hour",
  ...
  financing_cost_percent: "n_financing_cost_percent",
  other_annual_fixed_cost: "n_other_annual_fixed_cost",
  annual_production_volume: "n_annual_production_volume",
  cycle_time_seconds: "n_cycle_time_seconds",
  setup_time_minutes: "n_setup_time_minutes",
  average_batch_quantity: "n_average_batch_quantity",
};
