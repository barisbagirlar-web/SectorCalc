...
const FORM_TO_SCHEMA_INPUT: Record<string, string> = {
  ...
  annual_unallocated_overhead: "annual_unallocated_overhead",
  ...
  tooling_consumables_cost_per_batch: "tooling_consumables_cost_per_batch",
  external_processing_cost_per_batch: "external_processing_cost_per_batch",
  packaging_cost_per_batch: "packaging_cost_per_batch",
  freight_cost_per_batch: "freight_cost_per_batch",
  other_job_cost_per_batch: "other_job_cost_per_batch",
  contingency_percent: "contingency_percent",
  current_quote_per_unit: "current_quote_per_unit",
};
