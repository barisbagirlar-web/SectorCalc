...
describe("break-even input order independence", () => {
  it("returns the same result regardless of object insertion order", async () => {
    ...
    const forward = calculate(Object.fromEntries(entries));
    const reverse = calculate(Object.fromEntries([...entries].reverse()));
