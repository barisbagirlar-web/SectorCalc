// SectorCalc PRO Engine Governance — Canonical Normalized Sample Inputs
// Values in this file are formula-layer values after server unit normalization.
// They are used only for deterministic golden/property/health checks.
...
export const PRO_SAMPLE_INPUTS: Record<string, Record<string, number>> = {
  ...
  "receivables-cost-payment-term-addendum": {
    n_machine_rate: 100000,
    n_cycle_time: 60,
    n_batch_quantity: 120,
    n_material_cost: 12,
    n_overhead_rate: 20,
    n_defect_or_loss_cost: 500,
    n_source_confidence_ratio: 0.9,
  },
  "setup-time-reduction-roi-smed": {
    n_machine_rate: 85,
    n_setup_time: 1800,
    n_batch_quantity: 600,
    n_labor_rate: 45,
    n_overhead_rate: 35000,
    n_annual_volume: 200,
    n_source_confidence_ratio: 0.9,
  },
  ...
  "machine-investment-feasibility-buy-lease-keep": {
    ...
    n_annual_volume: 50000,
    n_labor_rate: 100000,
    n_overhead_rate: 20000,
    n_defect_or_loss_cost: 80000,
