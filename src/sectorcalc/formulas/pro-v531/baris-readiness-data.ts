...
export const BLOCKED_SOURCE_REQUIRED_TOOLS: BarisReadinessRecord[] = [
  { tool_key: "pressure-vessel-wall-thickness-mawp-hydrotest-package", tool_id: "PRO_004", category: "BLOCKED_SOURCE_REQUIRED", reason: "Requires ASME BPVC Section VIII joint efficiency table (UW-12) and allowable stress values by material grade." },
  { tool_key: "pressure-relief-valve-sizing-sheet-api-520", tool_id: "PRO_003", category: "BLOCKED_SOURCE_REQUIRED", reason: "Requires API 520 Part 1 discharge coefficient tables (Kd, Kb, Kc, Kv) by valve type." },
  { tool_key: "fillet-weld-sizing-verification-sheet-ec3-aws-d11", tool_id: "PRO_012", category: "BLOCKED_SOURCE_REQUIRED", reason: "Requires AWS D1.1 Table 2 design strengths and EC3 weld resistance factors." },
  { tool_key: "structural-connection-verification-dossier-ec3-aisc", tool_id: "PRO_011", category: "BLOCKED_SOURCE_REQUIRED", reason: "Requires EC3 and AISC 360 connection capacity tables." },
  { tool_key: "bolted-connection-verifier", tool_id: "PRO_013", category: "BLOCKED_SOURCE_REQUIRED", reason: "Requires EN 1993-1-8/AISC/VDI 2230 bolt grade tables." },
  { tool_key: "bolt-torque-preload-spec-card-vdi-2230", tool_id: "PRO_022", category: "BLOCKED_SOURCE_REQUIRED", reason: "Requires VDI 2230 friction coefficient tables." },
  { tool_key: "lifting-rigging-crane-plan-suite", tool_id: "PRO_005", category: "BLOCKED_SOURCE_REQUIRED", reason: "Requires ASME B30/EN 13155 load charts." },
  { tool_key: "gdt-fit-clearance-calculator-iso-286", tool_id: "PRO_042", category: "BLOCKED_SOURCE_REQUIRED", reason: "Requires ISO 286 tolerance grade tables." },
  { tool_key: "tolerance-stack-up-root-cause-report-wc-rss", tool_id: "PRO_006", category: "BLOCKED_SOURCE_REQUIRED", reason: "Requires ISO GPS/ASME Y14.5 tolerance definitions." },
  { tool_key: "measurement-uncertainty-budget-gum-iso-17025", tool_id: "PRO_008", category: "BLOCKED_SOURCE_REQUIRED", reason: "Requires JCGM GUM coverage factor tables." },
  { tool_key: "first-article-inspection-report-builder-as9102-lite", tool_id: "PRO_010", category: "BLOCKED_SOURCE_REQUIRED", reason: "Requires AS9102 form templates." },
  { tool_key: "compressed-air-leak-energy-audit-report-iso-11011", tool_id: "PRO_009", category: "BLOCKED_SOURCE_REQUIRED", reason: "Requires ISO 11011 audit class tables." },
  { tool_key: "cbam-definitive-period-compliance-package", tool_id: "PRO_001", category: "BLOCKED_SOURCE_REQUIRED", reason: "Requires EU CBAM emission benchmarks." },
  { tool_key: "cbam-cost-exposure-hedging-forecaster", tool_id: "PRO_007", category: "BLOCKED_SOURCE_REQUIRED", reason: "Requires EU CBAM certificate price scenarios." },
  { tool_key: "cbam-supplier-emissions-data-sheet", tool_id: "PRO_021", category: "BLOCKED_SOURCE_REQUIRED", reason: "Requires EU CBAM default emission values." }
];
