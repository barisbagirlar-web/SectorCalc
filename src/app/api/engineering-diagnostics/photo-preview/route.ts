...
export async function POST(req: Request) {
  try {
    ...
    /* ── 4. Validate each photo (RM-16: strip EXIF, hash, apply TTL) ── */
    ...
    /* ── 5. Call OpenAI for visual observation only (RM-18) ── */
    ...
    /* ── 6. Parse + validate AI output against constraints (RM-18) ── */
