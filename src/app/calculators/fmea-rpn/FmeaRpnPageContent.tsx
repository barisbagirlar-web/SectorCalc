...
function buildFmeaJsonLd(): Record<string, unknown> {
  return {
    ...
    "@graph": [
      ...
      { "@type": "SoftwareApplication", "@id": `${siteUrl}/calculators/fmea-rpn#softwareapplication`, name: "FMEA RPN Calculator", applicationCategory: "EngineeringApplication", operatingSystem: "Web", url: `${siteUrl}/calculators/fmea-rpn`, description: "Educational calculator for traditional FMEA Risk Priority Number scoring using Severity, Occurrence and Detection.", publisher: { "@id": `${siteUrl}/#organization` }, offers: { "@type": "Offer", price: "0", priceCurrency: "USD" }, isBasedOn: { "@type": "CreativeWork", name: "IEC 60812:2018 — Failure modes and effects analysis (FMEA and FMECA)", url: "https://webstore.iec.ch/en/publication/26359" }, mentions: [ { "@type": "DefinedTerm", name: "Risk Priority Number", inDefinedTermSet: "IEC 60812" }, { "@type": "DefinedTerm", name: "Severity", inDefinedTermSet: "IEC 60812" }, { "@type": "DefinedTerm", name: "Occurrence", inDefinedTermSet: "IEC 60812" }, { "@type": "DefinedTerm", name: "Detection", inDefinedTermSet: "IEC 60812" } ] },
