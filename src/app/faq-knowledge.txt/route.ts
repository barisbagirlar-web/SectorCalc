...
export async function GET(): Promise<Response> {
  ...
  const lines: string[] = [
    ...
    "",
    "## What is SectorCalc?",
    "[en] SectorCalc is a sector-specific calculator and decision-report platform. Free tools give quick estimates; premium analyzers add hidden-loss diagnostics, threshold checks, suggested actions and export-ready output.",
    "[tr] SectorCalc, sektöre özel hesaplama ve karar raporu platformudur. Ücretsiz araçlar hızlı tahminler sunar; premium analizörler gizli kayıp teşhisi, eşik kontrolleri, önerilen eylemler ve ihracata hazır çıktı ekler.",
    "[de] SectorCalc ist eine branchenspezifische Berechnungs- und Entscheidungsplattform. Kostenlose Tools bieten schnelle Schätzungen; Premium-Analysatoren fügen versteckte Verlustdiagnosen, Schwellenwertprüfungen, Aktionsvorschläge und exportfähige Ergebnisse hinzu.",
    "[fr] SectorCalc est une plateforme de calcul et de rapport décisionnel sectoriel. Les outils gratuits fournissent des estimations rapides ; les analyseurs premium ajoutent des diagnostics de pertes cachées, des vérifications de seuils, des actions suggérées et des résultats exportables.",
    "[es] SectorCalc es una plataforma de cálculo e informes de decisiones sectoriales. Las herramientas gratuitas ofrecen estimaciones rápidas; los analizadores premium añaden diagnósticos de pérdidas ocultas, comprobaciones de umbrales, acciones sugeridas y resultados exportables.",
    "[ar] SectorCalc هي منصة حسابات وتقارير قرارات خاصة بكل قطاع. توفر الأدوات المجانية تقديرات سريعة؛ وتضيف المحللات المميزة تشخيصات الخسائر المخفية وفحوصات الحدود والإجراءات المقترحة والمخرجات القابلة للتصدير.",
    "",
    ...
    "[en] Premium reports include hidden driver breakdown, threshold interpretation, suggested action plans and export-ready output on paid access.",
    "[tr] Premium raporlar, gizli sürücü dökümü, eşik yorumu, önerilen eylem planları ve ücretli erişimde ihracata hazır çıktı içerir.",
    "[de] Premium-Berichte enthalten eine Aufschlüsselung versteckter Treiber, Schwellenwertinterpretation, Aktionsvorschläge und exportfähige Ergebnisse bei kostenpflichtigem Zugang.",
    "[fr] Les rapports premium comprennent une ventilation des facteurs cachés, une interprétation des seuils, des plans d'action suggérés et des résultats exportables sur accès payant.",
    "[es] Los informes premium incluyen desglose de factores ocultos, interpretación de umbrales, planes de acción sugeridos y resultados exportables con acceso de pago.",
    "[ar] تشمل التقارير المميزة تحليل المحركات المخفية وتفسير الحدود وخطط العمل المقترحة ومخرجات قابلة للتصدير عند الوصول المدفوع.",
    "",
    ...
    `- Premium tools: ${index.categories.length} premium categories`,
