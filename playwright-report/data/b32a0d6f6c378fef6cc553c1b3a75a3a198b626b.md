...
- Name: tools-smoke.spec.ts >> E2E Free Tools UI Smoke Test >> Calculates correctly for Free Tool: 0-100-kmh-acceleration-calculator
- Location: e2e/tools-smoke.spec.ts:38:9
...
Call log:
  - waiting for locator('button:has-text("Generate Report"), button:has-text("Calculate"), .btn-exec')
...
- generic [active] [ref=e1]:
  ...
  - alert [ref=e11]
  - main [ref=e12]:
    - heading "errorPageTitle" [level=1] [ref=e13]
    - paragraph [ref=e14]: errorPageDescription
    - generic [ref=e15]:
      - button "pageTryAgain" [ref=e16] [cursor=pointer]
      - link "calculatorLibraryLink" [ref=e17] [cursor=pointer]:
        - /url: /calculator-library
```
