...
- Name: tools-smoke.spec.ts >> E2E Premium Tools UI Smoke Test >> Calculates correctly for Premium Tool: 3d-printing-support-structure-post-processing-cost-calculator
...
```ts
  ...
  69 |       await page.goto(`/pro-tools/${slug}`);
  70 |       
