...
const FIXES = {
  "scaffold-rental-cost-analyzer.ts": [
    [`"en":"Monthly rental rate per m²","tr":"Monthly rental rate per m²"`, `"en":"Monthly rental rate per m²","tr":"Aylık m² kiralama bedeli"`],
    [`"en":"Transport cost","tr":"Transport cost"`, `"en":"Transport cost","tr":"Nakliye maliyeti"`],
  ],
  "sewing-line-balance-analyzer-pro.ts": [
    [`"en":"Available shift minutes","tr":"Available shift minutes"`, `"en":"Available shift minutes","tr":"Kullanılabilir vardiya dakikası"`],
    [`"en":"Number of operators","tr":"Number of operators"`, `"en":"Number of operators","tr":"Operatör sayısı"`],
    [`"en":"Defect rate","tr":"Defect rate"`, `"en":"Defect rate","tr":"Hata oranı"`],
  ],
  ...
  "supplier-currency-risk-analyzer.ts": [
    [`"en":"Currency volatility rate","tr":"Currency volatility rate"`, `"en":"Currency volatility rate","tr":"Kur volatilite oranı"`],
    [`"en":"Cost of hedging","tr":"Cost of hedging"`, `"en":"Cost of hedging","tr":"Korunma maliyeti"`],
  ],
