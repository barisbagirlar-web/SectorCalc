...
const DICT_PATH = path.join(ROOT, "archive/migration-only/data/turkish-to-english-dictionary.json");
...
const SECTOR_MAP = {
  ...
  "Energy ve Güç Sistemleri": "Energy and Power Systems",
  ...
  "Kimya ve Process": "Chemical and Process",
  ...
  "Tax ve Muhasebe": "Tax and Accounting",
  "Çelik Yapı": "Steel Structures",
  "Hydraulic ve Pnömatik": "Hydraulics and Pneumatics",
  "İleri Fizik ve Kuantum": "Advanced Physics and Quantum",
  "İleri Fizik, Kuantum ve Energy": "Advanced Physics, Quantum and Energy",
  ...
  "Yangın, Elektrik ve Elektronik": "Waste, Electrical and Electronics",
