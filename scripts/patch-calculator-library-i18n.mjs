...
const CALCULATOR_LIBRARY = {
  ...
  tr: {
    metaTitle: "Account Makinesi Kütüphanesi — SectorCalc",
    metaDescription:
      "SectorCalc genel account makinesi katalog kaynakları: LLMs dizini, sektör araç listeleri ve katalog girişleri.",
    title: "Account Makinesi Kütüphanesi",
    lead: "SectorCalc sektörel account makineleri için machine okunur dizinler ve katalog giriş noktaları.",
    ...
    faqLabel: "faq-knowledge.txt",
    servicesLabel: "services-products.txt",
    freeToolsLabel: "Ücretsiz account makineleri",
    premiumToolsLabel: "Premium account makineleri",
