...
const TR_EN_MAP = {
  ...
  "CONCRETE HACMİ": "CONCRETE VOLUME",
  "HACMİ": "VOLUME",
  "MARUZİYET": "EXPOSURE",
  "UYUMLULUK": "COMPLIANCE",
  "YÜZEY ": "SURFACE ",
  "KALİTE": "QUALITY",
  "CIVATE Torque": "BOLT TORQUE",
  " CİRO ": " TURNOVER ",
  ...
  SOSYAL_SAFETY_FORMULU: "SOCIAL_SECURITY_FORMULA",
