...
const FORMULA_DEFS = [
  ...
  { id:'F021', name:'Profit per batch',                     uses:['n_target_revenue_margin_percent','n_batch_quantity'],                                                     out:'out_profit_per_batch',                     role:'PRIMARY' },
  ...
  { id:'F029', name:'Current profit per batch',             uses:['n_current_quote_per_unit','n_batch_quantity'],                                                           out:'out_current_profit_per_batch',             role:'INTERMEDIATE' },
  { id:'F030', name:'Achieved revenue margin',              uses:['n_current_quote_per_unit','n_batch_quantity'],                                                           out:'out_achieved_margin_percent',              role:'DIAGNOSTIC' },
