...
const LABEL = {
  "Kurulum Maliyeti":"Installation Cost","Yıllık İşletme Maliyeti":"Annual Operating Cost",
  "Proje Ömrü":"Project Life","İskonto Oranı":"Discount Rate",
  "Teşvik / Sübvansiyon":"Incentive / Subsidy",
  "Satış Fiyatı":"Selling Price","Birim Değişken Maliyet":"Unit Variable Cost",
  "Sabit Maliyet":"Fixed Cost","Müşteri Sayısı":"Customer Count",
  "Talep Miktarı":"Demand Quantity","Fiyat Değişimi (%)":"Price Change (%)",
  "Esneklik Katsayısı":"Elasticity Coefficient",
  "Ortalama Sipariş Bedeli":"Average Order Value",
  ...
  "Malzeme Fire Oranı":"Material Waste Rate",
  "Otel Oda Sayısı":"Number of Hotel Rooms","Doluluk Oranı":"Occupancy Rate",
  "Ortalama Oda Fiyatı":"Average Room Rate",
  "Yiyecek Maliyeti (%)":"Food Cost (%)","İşçilik Maliyeti (%)":"Labor Cost (%)",
  ...
  "Planlı Duruş":"Planned Downtime","Günlük Hedef Adet":"Daily Target Quantity",
  "Hedef Verim":"Target Efficiency","Teorik Operatör":"Theoretical Operator",
  "Gerçek Operatör":"Actual Operator","Hat Verimliliği":"Line Efficiency",
  "Toplam SMV":"Total SMV","Toplam SMV (Tüm Operasyonlar)":"Total SMV (All Operations)",
  "Gelir":"Revenue","Tahmini Fire":"Estimated Waste",
  "Hırsızlık / Zaiyat":"Theft / Shrinkage","Mutfak Sapması":"Kitchen Variance",
  "Sapma Oranı":"Variance Rate","Fire Maliyeti":"Waste Cost",
  "Zaiyat Maliyeti":"Shrinkage Cost","İdeal Marj":"Ideal Margin",
  "Gerçekleşen Maliyet":"Actual Cost","Teklif Edilen Tutar":"Quoted Amount",
  ...
  "Toplam Fatura Tutarı (Döviz)":"Total Invoice (Foreign Currency)",
  "Güncel Kur":"Current Rate","Beklenen Kur Değişimi":"Expected Rate Shift",
  "Kur Volatilitesi":"Currency Volatility","Korunma Maliyeti":"Hedging Cost",
  ...
  "Eğim Açısı":"Pitch Angle","Saçak Payı":"Eaves Overhang",
  "Malzeme Ağırlığı":"Material Weight",
};

// expertMeaning_i18n.tr: English→Turkish
const EXPERT = {
  "Total installation cost":"Toplam kurulum maliyeti",
  "Annual O&M cost":"Yıllık işletme ve bakım maliyeti",
  "Project economic life":"Proje ekonomik ömrü",
  "Discount rate for NPV":"NPV için iskonto oranı",
  "Fixed costs":"Sabit maliyetler",
  "Overhead cost":"Genel gider maliyeti",
  "Material waste factor":"Malzeme fire faktörü",
  "Theoretical (ideal) food cost":"Teorik (ideal) yiyecek maliyeti",
  "Total food revenue":"Toplam yiyecek geliri",
  "Estimated waste cost":"Tahmini fire maliyeti",
  "Quoted subcontractor amount":"Teklif edilen taşeron tutarı",
  "Unit price":"Birim fiyat",
  "Cost of hedging":"Korunma maliyeti",
  "Currency volatility rate":"Kur volatilite oranı",
};

// painStatement_i18n.en: Turkish→English
const PAIN = {
  "Yüksek ürün çeşitliliği ve karmaşık tasarımlar, operasyonel gizli maliyetleri artırır. Her bir SKU'nun gerçek kârlılığı bilinmezse kaynak israfı kaçınılmazdır.":"High product variety and complex designs increase hidden operational costs. Without knowing each SKU's true profitability, resource waste is inevitable.",
  "Çatı alanı ve yük hesabı yapılmadan malzeme siparişi ve statik analiz hatalı olur.":"Without calculating roof area and load, material orders and structural analysis will be incorrect.",
  "İskele kiralama süresi ve alanı optimize edilmezse gereksiz kira, işçilik ve nakliye maliyeti oluşur.":"If scaffold rental duration and area are not optimized, unnecessary rent, labor, and transportation costs occur.",
  ...
  "Taşeron teklif marjı ile gerçekleşen marj arasındaki fark kontrol edilmezse proje kârlılığı sessizce erir.":"If the difference between quoted subcontractor margin and actual margin is not monitored, project profitability silently erodes.",
  "Yabancı para tedarikçilerinde kur dalgalanması maliyeti hesaplanmazsa beklenmedik zararlar oluşur.":"If the cost of exchange rate fluctuations is not calculated for foreign currency suppliers, unexpected losses occur.",
  "Yenilenebilir enerji yatırımlarında IRR, NPV ve LCOE hesaplanmazsa yatırımın gerçek getirisi ve fizibilitesi bilinemez. Yanlış kararlar büyük sermaye kaybına yol açar.":"Without calculating IRR, NPV, and LCOE for renewable energy investments, the true return and feasibility remain unknown. Wrong decisions lead to significant capital loss.",
};

// title_i18n.en: Turkish→English
const TITLE = {
  "Ürün Karmaşıklığı Gizli Maliyet Raporu":"Product Complexity Hidden Cost Report",
};
