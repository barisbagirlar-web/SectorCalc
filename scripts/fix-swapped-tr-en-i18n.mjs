...
const TURKISH_WORDS = new Set([
  "kaynak", "aktivite", "aktiviteleri", "mesafe", "kalınlık", "malzeme",
  "yoğunluk", "değer", "birim", "süre", "maruziyet", "zırhlama",
  "katsayı", "gama", "sabit", "hedef", "nokta", "olan",
  "kaynağın", "cinsinden", "kullanılan", "örneğin", "kurşun",
  "yarı", "değer", "azaltan", "toplam", "radyoaktif", "curie",
  "parti", "büyüklük", "adedi", "hesaplanacak", "kart",
  "üretim", "firesi", "yüzdesi", "hammadde", "kilogram",
  "fiyatı", "maliyeti", "bakım", "lastik", "rutin",
  "ortalama", "harcama", "onarım", "yakıt", "verimlilik",
  "galon", "sahip", "olma", "tahmin", "etmek", "cari",
  ...
  "dönüşüm", "yaparken", "sadece", "kullanılır", "akışkan",
  "karakter", "sayısı", "bayt", "kodlanan", "ekler",
  "dahil", "ürün", "miktarı", "toplam", "istenen",
  "şeker", "yüzdesi", "saflık", "oranı", "maliyeti",
  "başına", "parti", "sayısı", "üretilecek",
  "açık", "döngü", "sıfır", "kutup", "reel", "sanal",
