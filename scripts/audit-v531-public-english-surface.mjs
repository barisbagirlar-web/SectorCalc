...
const TURKISH_ONLY = new Set([
  "maliyet", "sure", "süre", "agirlik", "ağırlık", "oran",
  "adet", "birim", "alan", "hacim", "basinc", "basınç", "sicaklik", "sıcaklık",
  "verim", "kapasite", "iscilik", "işçilik", "malzeme", "uzunluk", "genislik",
  "genişlik", "yukseklik", "yükseklik", "derinlik", "yaricap", "yarıçap",
  "kesit", "hiz", "hız", "ivme", "sure", "süre", "baslangic", "başlangıç",
  "bitis", "bitiş", "cikti", "çıktı", "girdi", "sonuc", "sonuç", "ortalama",
  "standart", "sapma", "katsayi", "katsayı", "deger", "değer", "tutar", "hisse",
  "tahvil", "odeme", "ödeme", "miktar", "toplam", "fiyat", "direnc", "direnç",
  "gerilim", "akim", "akım", "taksit", "faiz", "kazanc", "zarar", "gelir",
  "gider", "dönem", "donem", "kira", "stok", "teslimat", "kalite", "musteri",
  "müşteri", "tedarikci", "tedarikçi", "calisan", "calışan", "uretim", "üretim",
  "yay", "rulman", "yatak", "kasnak", "kayis", "kayış", "zincir", "bant",
  "silindir", "valf", "pompa", "kompresor", "motor", "pervane",
  "kanat", "diyafram", "debimetre", "egim", "eğim", "egme", "bukulme",
  "bükülme", "burkulma", "burulma", "kolon", "kiris", "kiriş", "doseme",
  "döşeme", "temel", "duvar", "perde", "catı", "cati", "çatı", "kubbe",
  "kemer", "donati", "donatı", "beton", "celik", "çelik", "ahsap", "ahşap",
  "vites", "disli", "dişli", "mill", "mil", "torna", "freze", "talaş", "tala",
  "parca", "parça", "urun", "ürün", "imalat", "kaynak",
  "randiman", "randıman", "hizmet", "satis", "satış", "siparis", "sipariş",
  "butce", "bütçe", "yatirim", "yatırım", "finans", "kredi", "borc", "borç",
  "alacak", "kondansator", "kondansatör", "sarj", "şarj", "batarya",
  "pil", "bobin", "anapara", "prim", "indirim", "vergi", "proje", "plan",
  "cizelge", "çizelge", "takvim", "mevcut", "guncel", "güncel", "hesapla",
  "kullanici", "kullanıcı", "bilgi", "veri", "rapor", "kayit", "kayıt",
  "durum", "seviye", "tip", "tur", "tür", "ozellik", "özellik", "nitelik",
  ...
  "cozunurluk", "çözünürlük", "ort", "yillik", "yıllık", "aylik", "aylık",
  "gunluk", "günluk", "günlük", "haftalik", "haftalık", "saatlik",
  "sarfiyat", "ruzgar", "ruzgâr", "rüzgar", "rüzgâr", "dip", "katsayisi",
  "kutupsal", "atalet", "donem", "dönem", "anapara", "baslangic", "başlangıç",
  "bitis", "bitiş", "yil", "yıl", "refVoltaj", "bitSayisi",
  "uzama", "sehim", "ceyrek", "çeyrek", "esik", "eşik", "doyum", "akma",
  "kopma", "dayanim", "dayanım", "mukavemet", "cozum",
  "anasayfa", "sayfa", "icerik", "içerik", "nakit", "saatlik", "zarar",
]);
