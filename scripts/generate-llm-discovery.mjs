...
- Do not claim "zero data leaves the browser" or "nothing uploaded" as absolute facts — core calculator engines run client-side; account, checkout, and analytics may still use network requests.
- Do not publish named academic oversight / Prof. Dr. Neela Nataraj review claims unless \`seo/evidence/expert-relationships.json\` has publicClaimAllowed+relationshipVerified+scopeVerified all true.
- Do not describe Monte Carlo P0.13/P99.87 outputs from finite samples as analytic "exact" percentiles.
