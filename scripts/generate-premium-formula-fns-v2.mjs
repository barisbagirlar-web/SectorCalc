...
const EXISTING_SLUG_MAP = {
  ...
  "CIVATE Torque": "bolt-torque-preload-analyzer",
  ...
  "CLV / CAC Ratio": "clv-cac-ratio-analyzer",
  ...
  "ENERJİ TÜKETİM Report": "energy-consumption-report-analyzer",
  "Inflation ESKALASYON": "inflation-escalation-analyzer",
  ...
  "FAİZ Ratio RİSKİ": "interest-rate-risk-analyzer",
  ...
  "HURDA Ratio OPTİMİZE": "scrap-rate-optimize-analyzer",
  ...
  "İÇ VERİM Ratio IRR": "irr-investment-analyzer",
  ...
  "Quality Cost PAF": "quality-cost-paf-analyzer",
  "Karbon Ayak izi Check": "carbon-footprint-check-analyzer",
  "Resource Volume ve Cost": "weld-volume-cost-analyzer",
  "Resource Cost": "weld-cost-analysis-analyzer",
  ...
  "Machine Economic Ömrü": "machine-economic-life-analyzer",
  ...
  "Navlun Cost": "freight-cost-analyzer",
  ...
  "Su Useımı Optimize Edici": "water-usage-optimizer-analyzer",
  ...
  "Takım Aşınma Cost": "tool-wear-cost-analyzer",
  ...
  "Supply Zinciri Kesintisi Risk Değerlendirmesi": "supply-chain-disruption-analyzer",
  "Supplyçi Döviz Kuru Riski": "supplier-currency-risk-analyzer",
  ...
  "Teslimat Cost": "delivery-cost-analyzer",
  "Tohum Ratioı": "seed-rate-analyzer",
  "Total Çalışan Cost": "total-employee-cost-analyzer",
