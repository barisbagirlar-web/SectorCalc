...
const NEXT_CONFIG_REDIRECTS = [
  ...
  { source: "/:locale/premium-tools", destination: "/:locale/pricing", permanent: true },
  { source: "/tools/premium/:slug", destination: "/pricing?tool=:slug", permanent: true },
  { source: "/:locale/tools/premium/:slug", destination: "/:locale/pricing?tool=:slug", permanent: true },
  { source: "/tools/premium-schema/:slug", destination: "/pricing?tool=:slug", permanent: true },
  { source: "/:locale/tools/premium-schema/:slug", destination: "/:locale/pricing?tool=:slug", permanent: true },
