...
const LABELS = {
  ...
  "chemistry-science": { en: "Chemistry", tr: "Chemical", de: "Chemie", fr: "Chimie", es: "Química", ar: "الكيمياء" },
...
const DESCRIPTIONS = {
  ...
  "food-cooking": { en: "Recipe scaling, baking, beverage and kitchen cost math.", tr: "Tarif ölçekleme, fırıncılık ve mutfak cost.", de: "Rezeptskalierung, Backen und Küchenkosten.", fr: "Recettes, pâtisserie et coûts cuisine.", es: "Recetas, horneado y costos de cocina.", ar: "وصفات ومخبوزات وتكاليف المطبخ." },
  ...
  "education-academic": { en: "GPA, test scores, reading level and academic planning.", tr: "GPA, sınav puanları ve akademik planning.", de: "GPA, Testergebnisse und Studienplanung.", fr: "GPA, scores de tests et planification.", es: "GPA, exámenes y planificación académica.", ar: "المعدل ودرجات الاختبارات والتخطيط الأكاديمي." },
