...
export const section2: ToolDef[] = [
  // 55. Mortgage Taksit
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "kredi", lt: "Kredi Tutarı (₺)", le: "Loan Amount (USD)", u: "USD", d: 1000000, ct: "Çekilen konut kredisi anaparası.", ce: "Mortgage principal." },
  ...
  // 56. Mortgage Karşılaştırma
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "kredi1", lt: "1. Kredi Tutarı (₺)", le: "Loan 1 Amount (USD)", u: "USD", d: 1000000, ct: "Birinci kredi teklifinin tutarı.", ce: "First loan amount." },
      { id: "faiz1", lt: "1. Faiz (%)", le: "Loan 1 Interest (%)", u: "%", d: 12, ct: "Birinci kredinin faiz oranı.", ce: "First loan interest rate." },
      { id: "kredi2", lt: "2. Kredi Tutarı (₺)", le: "Loan 2 Amount (USD)", u: "USD", d: 1000000, ct: "İkinci kredi teklifinin tutarı.", ce: "Second loan amount." },
    ...
    op: "sonuc", ou: "USD", ok: ["sonuc", "taksit1", "taksit2"],
  ...
  // 57. Mortgage Geri Ödeme Tablosu
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "kredi", lt: "Kredi Tutarı (₺)", le: "Loan Amount (USD)", u: "USD", d: 1000000, ct: "Konut kredisi anaparası.", ce: "Mortgage principal." },
  ...
  // 58. Mortgage Puanları (Points)
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "kredi", lt: "Kredi Tutarı (₺)", le: "Loan Amount (USD)", u: "USD", d: 1000000, ct: "Konut kredisi tutarı.", ce: "Mortgage amount." },
      { id: "puanOrani", lt: "Puan Oranı (%)", le: "Points Rate (%)", u: "%", d: 2, ct: "Peşin ödenen puan yüzdesi.", ce: "Prepaid points percentage." },
      { id: "aylikTasarruf", lt: "Aylık Faiz Tasarrufu (₺)", le: "Monthly Interest Saving (USD)", u: "USD", d: 500, ct: "Düşük faiz sayesinde aylık tasarruf.", ce: "Monthly saving from lower rate." },
    ],
  ...
  // 59. Mortgage Refinansman
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "eskiTaksit", lt: "Eski Aylık Taksit (₺)", le: "Old Monthly Payment (USD)", u: "USD", d: 12000, ct: "Mevcut kredinin aylık taksiti.", ce: "Current monthly payment." },
      { id: "yeniTaksit", lt: "Yeni Aylık Taksit (₺)", le: "New Monthly Payment (USD)", u: "USD", d: 10000, ct: "Refinansman sonrası aylık taksit.", ce: "New payment after refinancing." },
      { id: "kapatmaMasrafi", lt: "Kapatma Masrafı (₺)", le: "Closing Cost (USD)", u: "USD", d: 30000, ct: "Refinansman için ödenen toplam masraf.", ce: "Total refinancing costs." },
    ],
  ...
  // 60. Nakit Çıkışlı Refinansman
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "mulkDegeri", lt: "Mülk Değeri (₺)", le: "Property Value (USD)", u: "USD", d: 1500000, ct: "Evin güncel piyasa değeri.", ce: "Current property value." },
      { id: "kalanBorc", lt: "Kalan Borç (₺)", le: "Remaining Debt (USD)", u: "USD", d: 500000, ct: "Mevcut kredi bakiyesi.", ce: "Current mortgage balance." },
      { id: "yeniKredi", lt: "Yeni Kredi Tutarı (₺)", le: "New Loan Amount (USD)", u: "USD", d: 1000000, ct: "Yeni çekilen toplam kredi.", ce: "Total new loan to draw." },
      { id: "masraf", lt: "Masraflar (₺)", le: "Closing Costs (USD)", u: "USD", d: 30000, ct: "Kapatma ve işlem masrafları.", ce: "Closing and processing costs." },
    ],
    f: { ltv: "(yeniKredi / Math.max(1, mulkDegeri)) * 100", sonuc: "yeniKredi - kalanBorc - masraf" },
    op: "sonuc", ou: "USD", ok: ["ltv", "sonuc"],
    ol: { ltv: "LTV Oranı (%)", sonuc: "Net Nakit Çıkış" },
  },
  // 61. Ev Alım Gücü
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "aylikGelir", lt: "Aylık Gelir (₺)", le: "Monthly Income (USD)", u: "USD", d: 50000, ct: "Brüt aylık gelir.", ce: "Gross monthly income." },
      ...
      { id: "aylikBorc", lt: "Mevcut Aylık Borç (₺)", le: "Existing Monthly Debt (USD)", u: "USD", d: 5000, ct: "Kredi kartı, taşıt kredisi gibi mevcut borçlar.", ce: "Existing monthly debt obligations." },
  ...
  // 62. Kira vs Satın Alma
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "evFiyati", lt: "Ev Fiyatı (₺)", le: "Home Price (USD)", u: "USD", d: 2000000, ct: "Satın alınacak evin fiyatı.", ce: "Home purchase price." },
      { id: "yillikKira", lt: "Yıllık Kira (₺)", le: "Annual Rent (USD)", u: "USD", d: 120000, ct: "Aynı evin yıllık kira bedeli.", ce: "Annual rent for same property." },
    ],
  ...
  // 63. Cap Rate
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "yillikNetGelir", lt: "Yıllık Net Kira Geliri (₺)", le: "Annual Net Rental Income (USD)", u: "USD", d: 120000, ct: "Giderler düşüldükten sonraki net kira geliri.", ce: "Net rental income after expenses." },
      { id: "mulkDegeri", lt: "Mülk Değeri (₺)", le: "Property Value (USD)", u: "USD", d: 1500000, ct: "Gayrimenkulün piyasa değeri.", ce: "Property market value." },
    ],
  ...
  // 64. Cash-on-Cash
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "yillikNakitAks", lt: "Yıllık Nakit Akışı (₺)", le: "Annual Cash Flow (USD)", u: "USD", d: 60000, ct: "Kredi ödemesi sonrası yıllık nakit akışı.", ce: "Annual cash flow after debt service." },
      { id: "toplamNakitYatirim", lt: "Toplam Nakit Yatırım (₺)", le: "Total Cash Invested (USD)", u: "USD", d: 300000, ct: "Peşinat ve masraflar dahil toplam nakit çıkışı.", ce: "Total cash outlay including down payment and costs." },
    ],
  ...
  // 65. BRRRR
  {
    slug: "brrrr-investment-calculator",
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "alim", lt: "Alım Fiyatı (₺)", le: "Purchase Price (USD)", u: "USD", d: 500000, ct: "Mülkün satın alma fiyatı.", ce: "Property purchase price." },
      { id: "rehab", lt: "Yenileme Maliyeti (₺)", le: "Rehab Cost (USD)", u: "USD", d: 150000, ct: "Tadilat ve yenileme giderleri.", ce: "Renovation costs." },
      { id: "deger", lt: "Yenilenmiş Değer (₺)", le: "After-Repair Value (USD)", u: "USD", d: 800000, ct: "Tadilat sonrası mülk değeri.", ce: "Post-renovation property value." },
      { id: "kredi", lt: "Kredi Tutarı (₺)", le: "Refinance Loan (USD)", u: "USD", d: 600000, ct: "Refinansman ile çekilen kredi.", ce: "Cash-out refinance loan." },
      { id: "kira", lt: "Aylık Kira (₺)", le: "Monthly Rent (USD)", u: "USD", d: 8000, ct: "Aylık kira geliri.", ce: "Monthly rental income." },
    ],
    f: { zorunluSermaye: "alim + rehab - kredi", coc: "((kira * 12) / Math.max(1, (alim + rehab - kredi))) * 100", sonuc: "((deger - (alim + rehab)) / Math.max(1, (alim + rehab))) * 100" },
    op: "sonuc", ou: "%", ok: ["zorunluSermaye", "coc", "sonuc"],
    ol: { zorunluSermaye: "Sermaye (₺)", coc: "Nakit Getiri (%)", sonuc: "Toplam Getiri (%)" },
  },
  // 66. Kiralık Gayrimenkul Analizi
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "brutKira", lt: "Brüt Aylık Kira (₺)", le: "Gross Monthly Rent (USD)", u: "USD", d: 10000, ct: "Toplam aylık kira geliri.", ce: "Total monthly rental income." },
      { id: "bosluk", lt: "Boşluk Oranı (%)", le: "Vacancy Rate (%)", u: "%", d: 5, mn: 0, mx: 100, ct: "Yıllık boş geçen süre oranı.", ce: "Annual vacancy percentage." },
      { id: "isletme", lt: "Aylık İşletme Gideri (₺)", le: "Monthly Operating Cost (USD)", u: "USD", d: 2000, ct: "Vergi, sigorta, bakım giderleri.", ce: "Taxes, insurance, maintenance." },
      { id: "kredi", lt: "Aylık Kredi Taksiti (₺)", le: "Monthly Mortgage (USD)", u: "USD", d: 5000, ct: "Kredinin aylık geri ödemesi.", ce: "Monthly debt service." },
    ],
  ...
  // 67. Emlak Komisyonu
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "satisBedeli", lt: "Satış Bedeli (₺)", le: "Sale Price (USD)", u: "USD", d: 1500000, ct: "Gayrimenkul satış fiyatı.", ce: "Property sale price." },
  ...
  // 68. Kapanış Maliyetleri
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "krediTutari", lt: "Kredi Tutarı (₺)", le: "Loan Amount (USD)", u: "USD", d: 1000000, ct: "Çekilen kredi anaparası.", ce: "Loan principal." },
      ...
      { id: "sabitUcretler", lt: "Sabit Ücretler (₺)", le: "Fixed Fees (USD)", u: "USD", d: 10000, ct: "Ekspertiz, ipotek tescili gibi sabit ücretler.", ce: "Fixed costs like appraisal and filing fees." },
    ],
  ...
  // 69. HELOC
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "evDegeri", lt: "Ev Değeri (₺)", le: "Home Value (USD)", u: "USD", d: 1500000, ct: "Evin güncel piyasa değeri.", ce: "Current home market value." },
      { id: "kalanBorc", lt: "Kalan Borç (₺)", le: "Remaining Mortgage (USD)", u: "USD", d: 500000, ct: "Mevcut mortgage bakiyesi.", ce: "Current mortgage balance." },
  ...
  // 70. PMI
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "krediTutari", lt: "Kredi Tutarı (₺)", le: "Loan Amount (USD)", u: "USD", d: 1000000, ct: "Konut kredisi anaparası.", ce: "Mortgage principal." },
  ...
  // 71. FHA Kredisi
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "kredi", lt: "Kredi Tutarı (₺)", le: "Loan Amount (USD)", u: "USD", d: 1000000, ct: "FHA kredi tutarı.", ce: "FHA loan amount." },
    ...
    op: "sonuc", ou: "USD", ok: ["pesin", "sonuc"],
  ...
  // 72. VA Kredisi
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "kredi", lt: "Kredi Tutarı (₺)", le: "Loan Amount (USD)", u: "USD", d: 1000000, ct: "VA kredi tutarı.", ce: "VA loan amount." },
