...
export const section1: ToolDef[] = [
  // 1. Yüzde Kuralı
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "aylikKira", lt: "Aylık Kira (₺)", le: "Monthly Rent (USD)", u: "USD", d: 10000, ct: "Mülkten elde edilen aylık brüt kira geliri.", ce: "Monthly gross rental income from the property." },
      { id: "mulkDegeri", lt: "Mülk Değeri (₺)", le: "Property Value (USD)", u: "USD", d: 1000000, ct: "Gayrimenkulün güncel piyasa değeri.", ce: "Current market value of the real estate property." },
    ],
  ...
  {
    slug: "1031-exchange-cash-out-calculator",
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "satisFiyati", lt: "Satış Fiyatı (₺)", le: "Sale Price (USD)", u: "USD", d: 2000000, ct: "Eski mülkün satış fiyatı.", ce: "Sale price of relinquished property." },
      { id: "kalanBorc", lt: "Kalan Borç (₺)", le: "Remaining Debt (USD)", u: "USD", d: 500000, ct: "Satılan mülkün kalan ipotek borcu.", ce: "Remaining mortgage balance." },
      { id: "yeniYatirim", lt: "Yeni Yatırım (₺)", le: "New Investment (USD)", u: "USD", d: 1800000, ct: "Yeni mülkün toplam maliyeti.", ce: "Total cost of replacement property." },
    ],
    f: { nakitCikis: "satisFiyati - kalanBorc", sonuc: "Math.max(0, (satisFiyati - kalanBorc) - yeniYatirim)" },
    op: "sonuc", ou: "USD", ok: ["sonuc", "nakitCikis"],
  ...
  // 3. 50/30/20
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "netGelir", lt: "Net Gelir (₺)", le: "Net Income (USD)", u: "USD", d: 30000, ct: "Vergi sonrası aylık net gelir.", ce: "Monthly net income after taxes." },
    ],
    f: { ihtiyac: "netGelir * 0.5", istek: "netGelir * 0.3", sonuc: "netGelir * 0.2" },
    op: "sonuc", ou: "USD", ok: ["ihtiyac", "istek", "sonuc"],
  ...
  // 4. Amortisman
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "bedel", lt: "Varlık Bedeli (₺)", le: "Asset Cost (USD)", u: "USD", d: 50000, ct: "Varlığın satın alma maliyeti.", ce: "Purchase cost of asset." },
      { id: "kalinti", lt: "Kalıntı Değer (₺)", le: "Salvage Value (USD)", u: "USD", d: 5000, ct: "Varlığın ömür sonu tahmini değeri.", ce: "Estimated end-of-life value." },
    ...
    op: "sonuc", ou: "USD", ok: ["sonuc", "dogrusal"],
  ...
  // 5. Yıllık Gelir (Annuity)
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "anapara", lt: "Anapara (₺)", le: "Principal (USD)", u: "USD", d: 500000, ct: "Anüiteye yatırılan toplam ana para.", ce: "Total principal invested." },
  ...
  {
    slug: "retirement-payout-calculator",
    dt: "Emeklilik birikiminin yıllık dağıtım tutarını hesaplar.",
    de: "Calculate the annual payout from a retirement savings pool.",
    cat, st, ld, sa,
    inputs: [
      { id: "birikim", lt: "Toplam Birikim (₺)", le: "Total Savings (USD)", u: "USD", d: 1000000, ct: "Emeklilikte biriken toplam fon.", ce: "Total accumulated retirement fund." },
  ...
  // 7. APR
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "kredi", lt: "Kredi Tutarı (₺)", le: "Loan Amount (USD)", u: "USD", d: 50000, ct: "Çekilen toplam kredi anaparası.", ce: "Total loan principal." },
      ...
      { id: "masraf", lt: "Toplam Masraf (₺)", le: "Total Fees (USD)", u: "USD", d: 1500, ct: "Dosya, ekspertiz ve sigorta masrafları.", ce: "Origination, appraisal and insurance fees." },
    ],
  ...
  // 8. Varlık Dağılımı
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "portfoy", lt: "Toplam Portföy (₺)", le: "Total Portfolio (USD)", u: "USD", d: 500000, ct: "Yatırım portföyünün toplam değeri.", ce: "Total investment portfolio value." },
  ...
  // 10. Basit Faiz
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "anapara", lt: "Anapara (₺)", le: "Principal (USD)", u: "USD", d: 10000, ct: "Faiz hesaplanacak ana para.", ce: "Principal amount for interest calculation." },
  ...
  // 11. Bileşik Faiz
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "anapara", lt: "Anapara (₺)", le: "Principal (USD)", u: "USD", d: 10000, ct: "Başlangıç yatırım tutarı.", ce: "Initial investment amount." },
  ...
  // 13. Sürekli Bileşik
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "anapara", lt: "Anapara (₺)", le: "Principal (USD)", u: "USD", d: 10000, ct: "Başlangıç yatırım tutarı.", ce: "Initial investment." },
  ...
  // 15. Tahvil Fiyat ve Getiri
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "nominal", lt: "Nominal Değer (₺)", le: "Face Value (USD)", u: "USD", d: 1000, ct: "Tahvilin vade sonu anapara değeri.", ce: "Bond's par value at maturity." },
  ...
  // 16. Temettü Vergisi
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "temettu", lt: "Brüt Temettü (₺)", le: "Gross Dividend (USD)", u: "USD", d: 10000, ct: "Vergi kesintisi öncesi temettü tutarı.", ce: "Dividend amount before tax." },
  ...
  // 17. DRIP
  {
    ...
    inputs: [
      ...
      { id: "temettu", lt: "Hisse Başı Temettü (₺)", le: "Dividend Per Share (USD)", u: "USD", d: 2, ct: "Hisse başına ödenen yıllık temettü.", ce: "Annual dividend per share." },
      { id: "fiyat", lt: "Hisse Fiyatı (₺)", le: "Share Price (USD)", u: "USD", d: 50, ct: "Hisse senedinin güncel fiyatı.", ce: "Current share price." },
  ...
  // 18. Hisse Senedi Getirisi
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "alis", lt: "Alış Fiyatı (₺)", le: "Buy Price (USD)", u: "USD", d: 50, ct: "Hisse senedinin satın alma fiyatı.", ce: "Purchase price per share." },
      { id: "satis", lt: "Satış Fiyatı (₺)", le: "Sell Price (USD)", u: "USD", d: 75, ct: "Hisse senedinin satış fiyatı.", ce: "Sale price per share." },
      { id: "temettu", lt: "Alınan Temettü (₺)", le: "Dividends Received (USD)", u: "USD", d: 5, ct: "Dönem boyunca alınan temettü.", ce: "Dividends received during holding period." },
    ],
  ...
  // 19. Yıllık Getiri
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "baslangic", lt: "Başlangıç Değeri (₺)", le: "Starting Value (USD)", u: "USD", d: 10000, ct: "Dönem başı yatırım değeri.", ce: "Investment value at start of period." },
      { id: "bitis", lt: "Bitiş Değeri (₺)", le: "Ending Value (USD)", u: "USD", d: 20000, ct: "Dönem sonu yatırım değeri.", ce: "Investment value at end of period." },
  ...
  // 20. CAGR
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "ilkDeger", lt: "İlk Değer (₺)", le: "Initial Value (USD)", u: "USD", d: 10000, ct: "Dönem başındaki yatırım değeri.", ce: "Value at the beginning of the period." },
      { id: "sonDeger", lt: "Son Değer (₺)", le: "Final Value (USD)", u: "USD", d: 20000, ct: "Dönem sonundaki yatırım değeri.", ce: "Value at the end of the period." },
  ...
  // 21. ROI
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "netKar", lt: "Net Kâr (₺)", le: "Net Profit (USD)", u: "USD", d: 25000, ct: "Yatırımdan elde edilen toplam net kâr.", ce: "Total net profit from investment." },
      { id: "maliyet", lt: "Toplam Maliyet (₺)", le: "Total Cost (USD)", u: "USD", d: 100000, ct: "Yatırım için yapılan toplam harcama.", ce: "Total investment expenditure." },
    ],
  ...
  // 22. NPV
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "nakit1", lt: "1. Yıl Nakit Akışı (₺)", le: "Year 1 Cash Flow (USD)", u: "USD", d: 30000, ct: "Projenin ilk yıl nakit akışı.", ce: "First year cash flow." },
      { id: "nakit2", lt: "2. Yıl Nakit Akışı (₺)", le: "Year 2 Cash Flow (USD)", u: "USD", d: 40000, ct: "Projenin ikinci yıl nakit akışı.", ce: "Second year cash flow." },
      { id: "nakit3", lt: "3. Yıl Nakit Akışı (₺)", le: "Year 3 Cash Flow (USD)", u: "USD", d: 50000, ct: "Projenin üçüncü yıl nakit akışı.", ce: "Third year cash flow." },
      { id: "nakit4", lt: "4. Yıl Nakit Akışı (₺)", le: "Year 4 Cash Flow (USD)", u: "USD", d: 35000, ct: "Projenin dördüncü yıl nakit akışı.", ce: "Fourth year cash flow." },
      { id: "nakit5", lt: "5. Yıl Nakit Akışı (₺)", le: "Year 5 Cash Flow (USD)", u: "USD", d: 30000, ct: "Projenin beşinci yıl nakit akışı.", ce: "Fifth year cash flow." },
      ...
      { id: "yatirim", lt: "Başlangıç Yatırımı (₺)", le: "Initial Investment (USD)", u: "USD", d: 100000, ct: "Projenin başlangıç yatırım tutarı.", ce: "Initial project investment." },
    ],
  ...
  // 23. IRR (simplified approximation)
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "yatirim", lt: "Başlangıç Yatırımı (₺)", le: "Initial Investment (USD)", u: "USD", d: 100000, ct: "Projenin başlangıç yatırım maliyeti.", ce: "Initial project cost." },
      { id: "ortalamaNakit", lt: "Ortalama Yıllık Nakit Akışı (₺)", le: "Avg Annual Cash Flow (USD)", u: "USD", d: 35000, ct: "Projenin ortalama yıllık nakit girişi.", ce: "Average annual cash inflow." },
      { id: "yil", lt: "Proje Süresi (Yıl)", le: "Project Life (Years)", u: "years", d: 5, mn: 1, ct: "Projenin ekonomik ömrü.", ce: "Project's economic life." },
    ],
    f: { sonuc: "(Math.pow(1 + ortalamaNakit / Math.max(1, yatirim), 1 / Math.max(1, yil)) - 1) * 100" },
    op: "sonuc", ou: "%", ok: ["sonuc"],
    ol: { sonuc: "IRR (İç Verim Oranı - Yaklaşık)" },
  },
  // 24. İskontolu Geri Ödeme
  {
    slug: "discounted-payback-calculator",
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "yatirim", lt: "Başlangıç Yatırımı (₺)", le: "Initial Investment (USD)", u: "USD", d: 100000, ct: "Toplam başlangıç yatırımı.", ce: "Total upfront investment." },
      { id: "nakit1", lt: "1. Yıl Nakit (₺)", le: "Year 1 Cash Flow (USD)", u: "USD", d: 30000, ct: "İlk yıl nakit girişi.", ce: "First year cash inflow." },
      { id: "nakit2", lt: "2. Yıl Nakit (₺)", le: "Year 2 Cash Flow (USD)", u: "USD", d: 30000, ct: "İkinci yıl nakit girişi.", ce: "Second year cash inflow." },
      { id: "nakit3", lt: "3. Yıl Nakit (₺)", le: "Year 3 Cash Flow (USD)", u: "USD", d: 30000, ct: "Üçüncü yıl nakit girişi.", ce: "Third year cash inflow." },
  ...
  // 25. PI
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "gelecekNakitBD", lt: "Gelecek Nakit BD (₺)", le: "Future Cash Flows PV (USD)", u: "USD", d: 150000, ct: "Tüm gelecek nakit akışlarının bugünkü değeri.", ce: "Present value of all future cash flows." },
      { id: "yatirim", lt: "Başlangıç Yatırımı (₺)", le: "Initial Investment (USD)", u: "USD", d: 100000, ct: "Projenin başlangıç maliyeti.", ce: "Initial project cost." },
    ],
  ...
  // 26. WACC
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "E", lt: "Özsermaye (₺)", le: "Equity (USD)", u: "USD", d: 1000000, ct: "Şirketin toplam özsermayesi.", ce: "Total equity value." },
      { id: "D", lt: "Borç (₺)", le: "Debt (USD)", u: "USD", d: 500000, ct: "Şirketin toplam borcu.", ce: "Total debt." },
  ...
  // 27. CAPM
  {
    slug: "capm-cost-of-equity-calculator",
  ...
  // 28. DCF
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "fcf1", lt: "1. Yıl FCF (₺)", le: "Year 1 FCF (USD)", u: "USD", d: 100000, ct: "Birinci yıl serbest nakit akışı.", ce: "First year free cash flow." },
      { id: "fcf2", lt: "2. Yıl FCF (₺)", le: "Year 2 FCF (USD)", u: "USD", d: 110000, ct: "İkinci yıl serbest nakit akışı.", ce: "Second year free cash flow." },
      { id: "fcf3", lt: "3. Yıl FCF (₺)", le: "Year 3 FCF (USD)", u: "USD", d: 121000, ct: "Üçüncü yıl serbest nakit akışı.", ce: "Third year free cash flow." },
      { id: "fcf4", lt: "4. Yıl FCF (₺)", le: "Year 4 FCF (USD)", u: "USD", d: 133100, ct: "Dördüncü yıl serbest nakit akışı.", ce: "Fourth year free cash flow." },
      { id: "fcf5", lt: "5. Yıl FCF (₺)", le: "Year 5 FCF (USD)", u: "USD", d: 146410, ct: "Beşinci yıl serbest nakit akışı.", ce: "Fifth year free cash flow." },
  ...
  // 29. FCFE/FCFF
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "netKar", lt: "Net Kâr (₺)", le: "Net Income (USD)", u: "USD", d: 150000, ct: "Dönem net kârı.", ce: "Net profit for the period." },
      { id: "amortisman", lt: "Amortisman (₺)", le: "Depreciation (USD)", u: "USD", d: 30000, ct: "Dönem amortisman gideri.", ce: "Period depreciation expense." },
      { id: "isletmeSermayesi", lt: "İşletme Sermayesi Değişimi (₺)", le: "Working Capital Change (USD)", u: "USD", d: 10000, ct: "Net işletme sermayesindeki artış.", ce: "Increase in net working capital." },
      { id: "capex", lt: "Sermaye Harcaması (₺)", le: "CapEx (USD)", u: "USD", d: 40000, ct: "Duran varlık yatırımları.", ce: "Capital expenditures on fixed assets." },
      { id: "borc", lt: "Net Borç Değişimi (₺)", le: "Net Debt Change (USD)", u: "USD", d: 20000, ct: "Yeni borç - anapara ödemesi.", ce: "New debt issuance minus principal payments." },
    ],
    f: { fcff: "netKar + amortisman - isletmeSermayesi - capex", sonuc: "netKar + amortisman - isletmeSermayesi - capex + borc" },
    op: "sonuc", ou: "USD", ok: ["fcff", "sonuc"],
  ...
  // 30. EBITDA
  {
    ...
    inputs: [
      { id: "netKar", lt: "Net Kâr (₺)", le: "Net Income (USD)", u: "USD", d: 150000, ct: "Dönem net kârı.", ce: "Net profit for the period." },
      { id: "faiz", lt: "Faiz Gideri (₺)", le: "Interest Expense (USD)", u: "USD", d: 20000, ct: "Dönem faiz giderleri.", ce: "Period interest expenses." },
      { id: "vergi", lt: "Vergi Gideri (₺)", le: "Tax Expense (USD)", u: "USD", d: 45000, ct: "Dönem vergi gideri.", ce: "Period tax expense." },
      { id: "amortisman", lt: "Amortisman (₺)", le: "Depreciation (USD)", u: "USD", d: 30000, ct: "Dönem amortisman gideri.", ce: "Period depreciation expense." },
    ],
  ...
  // 31. P/E
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "hisseFiyati", lt: "Hisse Fiyatı (₺)", le: "Share Price (USD)", u: "USD", d: 100, ct: "Hisse senedinin güncel piyasa fiyatı.", ce: "Current market price per share." },
      { id: "hisseBasiKar", lt: "Hisse Başı Kâr (₺)", le: "Earnings Per Share (USD)", u: "USD", d: 5, ct: "Şirketin hisse başına düşen net kârı.", ce: "Net earnings per share." },
    ],
  ...
  // 32. P/B
  {
    slug: "pb-ratio-calculator",
    dt: "Piyasanın şirketin defter değerine biçtiği primi (PD/DD) hesaplar.",
    de: "Calculate the price-to-book (P/B) ratio.",
    cat, st, ld, sa,
    inputs: [
      { id: "piyasaDegeri", lt: "Piyasa Değeri (₺)", le: "Market Cap (USD)", u: "USD", d: 5000000, ct: "Şirketin toplam piyasa değeri.", ce: "Total market capitalization." },
      { id: "ozsermaye", lt: "Özsermaye (₺)", le: "Shareholders Equity (USD)", u: "USD", d: 3000000, ct: "Şirketin defter değeri.", ce: "Book value of shareholders equity." },
    ],
  ...
  // 33. P/S
  {
    slug: "ps-ratio-calculator",
    dt: "1 birimlik satış için ödenen piyasa bedelini (F/S) hesaplar.",
    de: "Calculate the price-to-sales (P/S) ratio.",
    cat, st, ld, sa,
    inputs: [
      { id: "piyasaDegeri", lt: "Piyasa Değeri (₺)", le: "Market Cap (USD)", u: "USD", d: 5000000, ct: "Şirketin toplam piyasa değeri.", ce: "Market capitalization." },
      { id: "toplamSatislar", lt: "Toplam Satışlar (₺)", le: "Total Revenue (USD)", u: "USD", d: 4000000, ct: "Şirketin yıllık toplam satış geliri.", ce: "Annual total revenue." },
    ],
  ...
  // 34. ROE DuPont
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "netKar", lt: "Net Kâr (₺)", le: "Net Income (USD)", u: "USD", d: 150000, ct: "Dönem net kârı.", ce: "Net income for the period." },
      { id: "satislar", lt: "Satışlar (₺)", le: "Sales (USD)", u: "USD", d: 2000000, ct: "Toplam satış geliri.", ce: "Total sales revenue." },
      { id: "varliklar", lt: "Toplam Varlıklar (₺)", le: "Total Assets (USD)", u: "USD", d: 3000000, ct: "Şirketin toplam aktif büyüklüğü.", ce: "Total assets." },
      { id: "ozsermaye", lt: "Özsermaye (₺)", le: "Equity (USD)", u: "USD", d: 1500000, ct: "Toplam özsermaye.", ce: "Total shareholders equity." },
    ],
  ...
  // 35. ROIC
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "nopat", lt: "NOPAT (₺)", le: "NOPAT (USD)", u: "USD", d: 200000, ct: "Vergi sonrası net faaliyet kârı.", ce: "Net operating profit after tax." },
      { id: "yatirilanSermaye", lt: "Yatırılan Sermaye (₺)", le: "Invested Capital (USD)", u: "USD", d: 1500000, ct: "Toplam yatırılmış sermaye.", ce: "Total invested capital." },
    ],
  ...
  // 36. EVA
  {
    ...
    inputs: [
      { id: "nopat", lt: "NOPAT (₺)", le: "NOPAT (USD)", u: "USD", d: 200000, ct: "Vergi sonrası net faaliyet kârı.", ce: "Net operating profit after tax." },
      { id: "sermaye", lt: "Yatırılan Sermaye (₺)", le: "Invested Capital (USD)", u: "USD", d: 1500000, ct: "Toplam yatırılmış sermaye.", ce: "Total capital employed." },
      { id: "wacc", lt: "WACC (%)", le: "WACC (%)", u: "%", d: 12, ct: "Ağırlıklı ortalama sermaye maliyeti.", ce: "Weighted average cost of capital." },
    ],
  ...
  // 40. Max Drawdown
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "zirveDeger", lt: "Zirve Değer (₺)", le: "Peak Value (USD)", u: "USD", d: 100000, ct: "Portföyün en yüksek değeri.", ce: "Highest portfolio value." },
      { id: "dipDeger", lt: "Dip Değer (₺)", le: "Trough Value (USD)", u: "USD", d: 70000, ct: "Portföyün en düşük değeri.", ce: "Lowest portfolio value." },
    ],
  ...
  {
    slug: "portfolio-optimization-calculator",
  ...
  // 42. Yatırım Fonu Getirisi
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "baslangicNAV", lt: "Dönem Başı NAV (₺)", le: "Start NAV (USD)", u: "USD", d: 10, ct: "Dönem başındaki fon pay fiyatı.", ce: "Fund unit price at period start." },
      { id: "bitisNAV", lt: "Dönem Sonu NAV (₺)", le: "End NAV (USD)", u: "USD", d: 12, ct: "Dönem sonundaki fon pay fiyatı.", ce: "Fund unit price at period end." },
      { id: "dagitim", lt: "Dağıtım (₺)", le: "Distribution (USD)", u: "USD", d: 0.5, ct: "Dönem boyunca dağıtılan temettü.", ce: "Dividend distributed during period." },
    ],
  ...
  // 43. ETF Getirisi
  {
    slug: "etf-return-calculator",
    dt: "Yönetim ücreti düşülmüş net ETF getirisini hesaplar.",
    de: "Calculate net ETF return after management expense ratio.",
    cat, st, ld, sa,
    inputs: [
      { id: "alisFiyati", lt: "Alış Fiyatı (₺)", le: "Purchase Price (USD)", u: "USD", d: 100, ct: "ETF alış fiyatı.", ce: "ETF purchase price." },
      { id: "satisFiyati", lt: "Satış Fiyatı (₺)", le: "Sell Price (USD)", u: "USD", d: 115, ct: "ETF satış fiyatı.", ce: "ETF sell price." },
      { id: "temettu", lt: "Temettü (₺)", le: "Dividend (USD)", u: "USD", d: 2, ct: "Dönem boyunca dağıtılan temettü.", ce: "Dividend distributed." },
  ...
  // 44. Futures
  {
    slug: "futures-profit-calculator",
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "girisFiyati", lt: "Giriş Fiyatı (₺)", le: "Entry Price (USD)", u: "USD", d: 100, ct: "Kontratın açılış fiyatı.", ce: "Contract entry price." },
      { id: "cikisFiyati", lt: "Çıkış Fiyatı (₺)", le: "Exit Price (USD)", u: "USD", d: 105, ct: "Kontratın kapanış fiyatı.", ce: "Contract exit price." },
  ...
  // 45. Black-Scholes (simplified)
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "S", lt: "Spot Fiyat (₺)", le: "Spot Price (USD)", u: "USD", d: 100, ct: "Dayanak varlığın güncel fiyatı.", ce: "Current underlying asset price." },
      { id: "K", lt: "Kullanım Fiyatı (₺)", le: "Strike Price (USD)", u: "USD", d: 110, ct: "Opsiyonun kullanım fiyatı.", ce: "Option strike price." },
  ...
  // 46. Forex
  {
    ...
    inputs: [
      ...
      { id: "pipDegeri", lt: "Pip Değeri (₺)", le: "Pip Value (USD)", u: "USD", d: 10, ct: "Her pip'in TL karşılığı.", ce: "TRY value per pip." },
  ...
  // 47. Kripto Kârı
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "alis", lt: "Alış Fiyatı (₺)", le: "Buy Price (USD)", u: "USD", d: 1000, ct: "Kripto paranın alış fiyatı.", ce: "Cryptocurrency buy price." },
      { id: "satis", lt: "Satış Fiyatı (₺)", le: "Sell Price (USD)", u: "USD", d: 1500, ct: "Kripto paranın satış fiyatı.", ce: "Cryptocurrency sell price." },
  ...
  {
    slug: "inflation-adjustment-calculator",
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "nominalDeger", lt: "Nominal Değer (₺)", le: "Nominal Value (USD)", u: "USD", d: 10000, ct: "Bugünkü para değeri.", ce: "Current nominal money value." },
  ...
  // 51. Fırsat Maliyeti
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "tercihEdilenGetiri", lt: "Tercih Edilen Getiri (₺)", le: "Chosen Return (USD)", u: "USD", d: 15000, ct: "Seçilen yatırımın getirisi.", ce: "Return of the chosen investment." },
      { id: "vazgecilenGetiri", lt: "Vazgeçilen Getiri (₺)", le: "Foregone Return (USD)", u: "USD", d: 25000, ct: "Alternatif yatırımın getirisi.", ce: "Return of the alternative investment." },
    ],
  ...
  // 52. Sermaye Kazancı Vergisi
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "satis", lt: "Satış Bedeli (₺)", le: "Sale Proceeds (USD)", u: "USD", d: 500000, ct: "Varlığın satış bedeli.", ce: "Asset sale proceeds." },
      { id: "alis", lt: "Alış Bedeli (₺)", le: "Cost Basis (USD)", u: "USD", d: 300000, ct: "Varlığın satın alma maliyeti.", ce: "Asset purchase cost." },
      { id: "vergiOrani", lt: "Vergi Oranı (%)", le: "Tax Rate (%)", u: "%", d: 15, mn: 0, mx: 100, ct: "Sermaye kazancı vergi oranı.", ce: "Capital gains tax rate." },
      { id: "istisna", lt: "İstisna Tutarı (₺)", le: "Exemption Amount (USD)", u: "USD", d: 0, ct: "Vergiden muaf kısım.", ce: "Tax-free allowance." },
    ],
  ...
  // 53. Emlak Vergisi
  {
    ...
    cat, st, ld, sa,
    inputs: [
      { id: "rayicBedel", lt: "Rayiç Bedel (₺)", le: "Assessed Value (USD)", u: "USD", d: 500000, ct: "Taşınmazın vergi değeri.", ce: "Property's tax-assessed value." },
