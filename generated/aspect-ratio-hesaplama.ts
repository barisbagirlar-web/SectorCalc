// Auto-generated from aspect-ratio-hesaplama-schema.json
import * as z from 'zod';

export interface Aspect_ratio_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Aspect_ratio_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Aspect_ratio_hesaplamaInput): Record<string, number> {
...
export function calculateAspect_ratio_hesaplama(input: Aspect_ratio_hesaplamaInput): Aspect_ratio_hesaplamaOutput {
...
export interface Aspect_ratio_hesaplamaOutput {
...
export const Aspect_ratio_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
