// Auto-generated from rf-deger-hesaplama-schema.json
import * as z from 'zod';

export interface Rf_deger_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Rf_deger_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Rf_deger_hesaplamaInput): Record<string, number> {
...
export function calculateRf_deger_hesaplama(input: Rf_deger_hesaplamaInput): Rf_deger_hesaplamaOutput {
...
export interface Rf_deger_hesaplamaOutput {
...
export const Rf_deger_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
