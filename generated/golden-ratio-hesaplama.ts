// Auto-generated from golden-ratio-hesaplama-schema.json
import * as z from 'zod';

export interface Golden_ratio_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Golden_ratio_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Golden_ratio_hesaplamaInput): Record<string, number> {
...
export function calculateGolden_ratio_hesaplama(input: Golden_ratio_hesaplamaInput): Golden_ratio_hesaplamaOutput {
...
export interface Golden_ratio_hesaplamaOutput {
...
export const Golden_ratio_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
