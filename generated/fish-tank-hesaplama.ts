// Auto-generated from fish-tank-hesaplama-schema.json
import * as z from 'zod';

export interface Fish_tank_hesaplamaInput {
  innerPressure: number;
  dataConfidence?: number;
}

export const Fish_tank_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Fish_tank_hesaplamaInput): Record<string, number> {
...
export function calculateFish_tank_hesaplama(input: Fish_tank_hesaplamaInput): Fish_tank_hesaplamaOutput {
...
export interface Fish_tank_hesaplamaOutput {
...
export const Fish_tank_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "Pa",
