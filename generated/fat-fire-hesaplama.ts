// Auto-generated from fat-fire-hesaplama-schema.json
import * as z from 'zod';

export interface Fat_fire_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Fat_fire_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Fat_fire_hesaplamaInput): Record<string, number> {
...
export function calculateFat_fire_hesaplama(input: Fat_fire_hesaplamaInput): Fat_fire_hesaplamaOutput {
...
export interface Fat_fire_hesaplamaOutput {
...
export const Fat_fire_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
