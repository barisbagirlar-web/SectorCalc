// Auto-generated from guc-hesaplama-schema.json
import * as z from 'zod';

export interface Guc_hesaplamaInput {
  powerValue: number;
  timeDuration: number;
  dataConfidence?: number;
}

export const Guc_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Guc_hesaplamaInput): Record<string, number> {
...
export function calculateGuc_hesaplama(input: Guc_hesaplamaInput): Guc_hesaplamaOutput {
...
export interface Guc_hesaplamaOutput {
...
export const Guc_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "W",
