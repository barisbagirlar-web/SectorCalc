// Auto-generated from dilution-hesaplama-schema.json
import * as z from 'zod';

export interface Dilution_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Dilution_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Dilution_hesaplamaInput): Record<string, number> {
...
export function calculateDilution_hesaplama(input: Dilution_hesaplamaInput): Dilution_hesaplamaOutput {
...
export interface Dilution_hesaplamaOutput {
...
export const Dilution_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
