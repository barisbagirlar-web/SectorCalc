// Auto-generated from kar-marj-hesaplama-schema.json
import * as z from 'zod';

export interface Kar_marj_hesaplamaInput {
  revenueAmount: number;
  costAmount: number;
  dataConfidence?: number;
}

export const Kar_marj_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Kar_marj_hesaplamaInput): Record<string, number> {
...
export function calculateKar_marj_hesaplama(input: Kar_marj_hesaplamaInput): Kar_marj_hesaplamaOutput {
...
export interface Kar_marj_hesaplamaOutput {
...
export const Kar_marj_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
