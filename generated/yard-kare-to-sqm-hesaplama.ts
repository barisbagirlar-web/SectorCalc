// Auto-generated from yard-kare-to-sqm-hesaplama-schema.json
import * as z from 'zod';

export interface Yard_kare_to_sqm_hesaplamaInput {
  lengthValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Yard_kare_to_sqm_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Yard_kare_to_sqm_hesaplamaInput): Record<string, number> {
...
export function calculateYard_kare_to_sqm_hesaplama(input: Yard_kare_to_sqm_hesaplamaInput): Yard_kare_to_sqm_hesaplamaOutput {
...
export interface Yard_kare_to_sqm_hesaplamaOutput {
...
export const Yard_kare_to_sqm_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "m",
