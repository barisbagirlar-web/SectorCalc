// Auto-generated from fluoride-hesaplama-schema.json
import * as z from 'zod';

export interface Fluoride_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Fluoride_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Fluoride_hesaplamaInput): Record<string, number> {
...
export function calculateFluoride_hesaplama(input: Fluoride_hesaplamaInput): Fluoride_hesaplamaOutput {
...
export interface Fluoride_hesaplamaOutput {
...
export const Fluoride_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
