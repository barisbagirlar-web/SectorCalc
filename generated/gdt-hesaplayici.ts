// Auto-generated from gdt-hesaplayici-schema.json
import * as z from 'zod';

export interface Gdt_hesaplayiciInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Gdt_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Gdt_hesaplayiciInput): Record<string, number> {
...
export function calculateGdt_hesaplayici(input: Gdt_hesaplayiciInput): Gdt_hesaplayiciOutput {
...
export interface Gdt_hesaplayiciOutput {
...
export const Gdt_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "",
