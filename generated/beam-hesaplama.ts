// Auto-generated from beam-hesaplama-schema.json
import * as z from 'zod';

export interface Beam_hesaplamaInput {
  loadValue: number;
  dataConfidence?: number;
}

export const Beam_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Beam_hesaplamaInput): Record<string, number> {
...
export function calculateBeam_hesaplama(input: Beam_hesaplamaInput): Beam_hesaplamaOutput {
...
export interface Beam_hesaplamaOutput {
...
export const Beam_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "kN",
