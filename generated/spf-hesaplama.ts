// Auto-generated from spf-hesaplama-schema.json
import * as z from 'zod';

export interface Spf_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Spf_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Spf_hesaplamaInput): Record<string, number> {
...
export function calculateSpf_hesaplama(input: Spf_hesaplamaInput): Spf_hesaplamaOutput {
...
export interface Spf_hesaplamaOutput {
...
export const Spf_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
