// Auto-generated from shortest-yol-hesaplama-schema.json
import * as z from 'zod';

export interface Shortest_yol_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Shortest_yol_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Shortest_yol_hesaplamaInput): Record<string, number> {
...
export function calculateShortest_yol_hesaplama(input: Shortest_yol_hesaplamaInput): Shortest_yol_hesaplamaOutput {
...
export interface Shortest_yol_hesaplamaOutput {
...
export const Shortest_yol_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
