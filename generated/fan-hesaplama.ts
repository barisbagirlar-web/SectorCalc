// Auto-generated from fan-hesaplama-schema.json
import * as z from 'zod';

export interface Fan_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Fan_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Fan_hesaplamaInput): Record<string, number> {
...
export function calculateFan_hesaplama(input: Fan_hesaplamaInput): Fan_hesaplamaOutput {
...
export interface Fan_hesaplamaOutput {
...
export const Fan_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
