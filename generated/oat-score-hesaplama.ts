// Auto-generated from oat-score-hesaplama-schema.json
import * as z from 'zod';

export interface Oat_score_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Oat_score_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Oat_score_hesaplamaInput): Record<string, number> {
...
export function calculateOat_score_hesaplama(input: Oat_score_hesaplamaInput): Oat_score_hesaplamaOutput {
...
export interface Oat_score_hesaplamaOutput {
...
export const Oat_score_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
