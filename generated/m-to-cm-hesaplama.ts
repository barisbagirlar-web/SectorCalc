// Auto-generated from m-to-cm-hesaplama-schema.json
import * as z from 'zod';

export interface M_to_cm_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const M_to_cm_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: M_to_cm_hesaplamaInput): Record<string, number> {
...
export function calculateM_to_cm_hesaplama(input: M_to_cm_hesaplamaInput): M_to_cm_hesaplamaOutput {
...
export interface M_to_cm_hesaplamaOutput {
...
export const M_to_cm_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
