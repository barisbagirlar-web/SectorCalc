// Auto-generated from gate-score-hesaplama-schema.json
import * as z from 'zod';

export interface Gate_score_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Gate_score_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Gate_score_hesaplamaInput): Record<string, number> {
...
export function calculateGate_score_hesaplama(input: Gate_score_hesaplamaInput): Gate_score_hesaplamaOutput {
...
export interface Gate_score_hesaplamaOutput {
...
export const Gate_score_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
