// Auto-generated from slums-hesaplama-schema.json
import * as z from 'zod';

export interface Slums_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Slums_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Slums_hesaplamaInput): Record<string, number> {
...
export function calculateSlums_hesaplama(input: Slums_hesaplamaInput): Slums_hesaplamaOutput {
...
export interface Slums_hesaplamaOutput {
...
export const Slums_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
