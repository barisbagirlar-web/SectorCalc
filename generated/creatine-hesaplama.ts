// Auto-generated from creatine-hesaplama-schema.json
import * as z from 'zod';

export interface Creatine_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Creatine_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Creatine_hesaplamaInput): Record<string, number> {
...
export function calculateCreatine_hesaplama(input: Creatine_hesaplamaInput): Creatine_hesaplamaOutput {
...
export interface Creatine_hesaplamaOutput {
...
export const Creatine_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
