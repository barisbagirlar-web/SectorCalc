// Auto-generated from half-life-reaction-hesaplama-schema.json
import * as z from 'zod';

export interface Half_life_reaction_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Half_life_reaction_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Half_life_reaction_hesaplamaInput): Record<string, number> {
...
export function calculateHalf_life_reaction_hesaplama(input: Half_life_reaction_hesaplamaInput): Half_life_reaction_hesaplamaOutput {
...
export interface Half_life_reaction_hesaplamaOutput {
...
export const Half_life_reaction_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
