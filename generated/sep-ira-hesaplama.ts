// Auto-generated from sep-ira-hesaplama-schema.json
import * as z from 'zod';

export interface Sep_ira_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Sep_ira_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Sep_ira_hesaplamaInput): Record<string, number> {
...
export function calculateSep_ira_hesaplama(input: Sep_ira_hesaplamaInput): Sep_ira_hesaplamaOutput {
...
export interface Sep_ira_hesaplamaOutput {
...
export const Sep_ira_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
