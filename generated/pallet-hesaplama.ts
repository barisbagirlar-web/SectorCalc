// Auto-generated from pallet-hesaplama-schema.json
import * as z from 'zod';

export interface Pallet_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Pallet_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pallet_hesaplamaInput): Record<string, number> {
...
export function calculatePallet_hesaplama(input: Pallet_hesaplamaInput): Pallet_hesaplamaOutput {
...
export interface Pallet_hesaplamaOutput {
...
export const Pallet_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
