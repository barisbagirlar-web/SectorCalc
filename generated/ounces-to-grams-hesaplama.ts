// Auto-generated from ounces-to-grams-hesaplama-schema.json
import * as z from 'zod';

export interface Ounces_to_grams_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Ounces_to_grams_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ounces_to_grams_hesaplamaInput): Record<string, number> {
...
export function calculateOunces_to_grams_hesaplama(input: Ounces_to_grams_hesaplamaInput): Ounces_to_grams_hesaplamaOutput {
...
export interface Ounces_to_grams_hesaplamaOutput {
...
export const Ounces_to_grams_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
