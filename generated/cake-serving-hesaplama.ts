// Auto-generated from cake-serving-hesaplama-schema.json
import * as z from 'zod';

export interface Cake_serving_hesaplamaInput {
  servingSize: number;
  ingredientAmount: number;
  dataConfidence?: number;
}

export const Cake_serving_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cake_serving_hesaplamaInput): Record<string, number> {
...
export function calculateCake_serving_hesaplama(input: Cake_serving_hesaplamaInput): Cake_serving_hesaplamaOutput {
...
export interface Cake_serving_hesaplamaOutput {
...
export const Cake_serving_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "g",
