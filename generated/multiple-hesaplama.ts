// Auto-generated from multiple-hesaplama-schema.json
import * as z from 'zod';

export interface Multiple_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Multiple_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Multiple_hesaplamaInput): Record<string, number> {
...
export function calculateMultiple_hesaplama(input: Multiple_hesaplamaInput): Multiple_hesaplamaOutput {
...
export interface Multiple_hesaplamaOutput {
...
export const Multiple_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
