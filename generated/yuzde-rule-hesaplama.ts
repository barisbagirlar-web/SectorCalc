// Auto-generated from yuzde-rule-hesaplama-schema.json
import * as z from 'zod';

export interface Yuzde_rule_hesaplamaInput {
  totalValue: number;
  percentage: number;
  dataConfidence?: number;
}

export const Yuzde_rule_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Yuzde_rule_hesaplamaInput): Record<string, number> {
...
export function calculateYuzde_rule_hesaplama(input: Yuzde_rule_hesaplamaInput): Yuzde_rule_hesaplamaOutput {
...
export interface Yuzde_rule_hesaplamaOutput {
...
export const Yuzde_rule_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "%",
