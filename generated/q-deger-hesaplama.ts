// Auto-generated from q-deger-hesaplama-schema.json
import * as z from 'zod';

export interface Q_deger_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Q_deger_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Q_deger_hesaplamaInput): Record<string, number> {
...
export function calculateQ_deger_hesaplama(input: Q_deger_hesaplamaInput): Q_deger_hesaplamaOutput {
...
export interface Q_deger_hesaplamaOutput {
...
export const Q_deger_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
