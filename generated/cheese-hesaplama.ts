// Auto-generated from cheese-hesaplama-schema.json
import * as z from 'zod';

export interface Cheese_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Cheese_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cheese_hesaplamaInput): Record<string, number> {
...
export function calculateCheese_hesaplama(input: Cheese_hesaplamaInput): Cheese_hesaplamaOutput {
...
export interface Cheese_hesaplamaOutput {
...
export const Cheese_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
