// Auto-generated from manova-hesaplama-schema.json
import * as z from 'zod';

export interface Manova_hesaplamaInput {
  sampleMean: number;
  standardDeviation: number;
  dataConfidence?: number;
}

export const Manova_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Manova_hesaplamaInput): Record<string, number> {
...
export function calculateManova_hesaplama(input: Manova_hesaplamaInput): Manova_hesaplamaOutput {
...
export interface Manova_hesaplamaOutput {
...
export const Manova_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
