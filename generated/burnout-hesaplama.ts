// Auto-generated from burnout-hesaplama-schema.json
import * as z from 'zod';

export interface Burnout_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Burnout_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Burnout_hesaplamaInput): Record<string, number> {
...
export function calculateBurnout_hesaplama(input: Burnout_hesaplamaInput): Burnout_hesaplamaOutput {
...
export interface Burnout_hesaplamaOutput {
...
export const Burnout_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
