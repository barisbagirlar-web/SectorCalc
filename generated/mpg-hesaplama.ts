// Auto-generated from mpg-hesaplama-schema.json
import * as z from 'zod';

export interface Mpg_hesaplamaInput {
  distanceTraveled: number;
  dataConfidence?: number;
}

export const Mpg_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Mpg_hesaplamaInput): Record<string, number> {
...
export function calculateMpg_hesaplama(input: Mpg_hesaplamaInput): Mpg_hesaplamaOutput {
...
export interface Mpg_hesaplamaOutput {
...
export const Mpg_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "km",
