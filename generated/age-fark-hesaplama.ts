// Auto-generated from age-fark-hesaplama-schema.json
import * as z from 'zod';

export interface Age_fark_hesaplamaInput {
  birthDate: number;
  referenceDate: number;
  dataConfidence?: number;
}

export const Age_fark_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Age_fark_hesaplamaInput): Record<string, number> {
...
export function calculateAge_fark_hesaplama(input: Age_fark_hesaplamaInput): Age_fark_hesaplamaOutput {
...
export interface Age_fark_hesaplamaOutput {
...
export const Age_fark_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "date",
