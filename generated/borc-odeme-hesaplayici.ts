// Auto-generated from borc-odeme-hesaplayici-schema.json
import * as z from 'zod';

export interface Borc_odeme_hesaplayiciInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Borc_odeme_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Borc_odeme_hesaplayiciInput): Record<string, number> {
...
export function calculateBorc_odeme_hesaplayici(input: Borc_odeme_hesaplayiciInput): Borc_odeme_hesaplayiciOutput {
...
export interface Borc_odeme_hesaplayiciOutput {
...
export const Borc_odeme_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "USD",
