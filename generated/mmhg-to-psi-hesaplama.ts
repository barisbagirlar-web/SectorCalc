// Auto-generated from mmhg-to-psi-hesaplama-schema.json
import * as z from 'zod';

export interface Mmhg_to_psi_hesaplamaInput {
  pressureValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Mmhg_to_psi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Mmhg_to_psi_hesaplamaInput): Record<string, number> {
...
export function calculateMmhg_to_psi_hesaplama(input: Mmhg_to_psi_hesaplamaInput): Mmhg_to_psi_hesaplamaOutput {
...
export interface Mmhg_to_psi_hesaplamaOutput {
...
export const Mmhg_to_psi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "Pa",
