// Auto-generated from caulk-hesaplama-schema.json
import * as z from 'zod';

export interface Caulk_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Caulk_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Caulk_hesaplamaInput): Record<string, number> {
...
export function calculateCaulk_hesaplama(input: Caulk_hesaplamaInput): Caulk_hesaplamaOutput {
...
export interface Caulk_hesaplamaOutput {
...
export const Caulk_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
