// Auto-generated from btu-to-joules-hesaplama-schema.json
import * as z from 'zod';

export interface Btu_to_joules_hesaplamaInput {
  powerValue: number;
  timeDuration: number;
  dataConfidence?: number;
}

export const Btu_to_joules_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Btu_to_joules_hesaplamaInput): Record<string, number> {
...
export function calculateBtu_to_joules_hesaplama(input: Btu_to_joules_hesaplamaInput): Btu_to_joules_hesaplamaOutput {
...
export interface Btu_to_joules_hesaplamaOutput {
...
export const Btu_to_joules_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "W",
