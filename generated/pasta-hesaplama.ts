// Auto-generated from pasta-hesaplama-schema.json
import * as z from 'zod';

export interface Pasta_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Pasta_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pasta_hesaplamaInput): Record<string, number> {
...
export function calculatePasta_hesaplama(input: Pasta_hesaplamaInput): Pasta_hesaplamaOutput {
...
export interface Pasta_hesaplamaOutput {
...
export const Pasta_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
