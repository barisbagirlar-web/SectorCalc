// Auto-generated from jet-lag-hesaplama-schema.json
import * as z from 'zod';

export interface Jet_lag_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Jet_lag_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Jet_lag_hesaplamaInput): Record<string, number> {
...
export function calculateJet_lag_hesaplama(input: Jet_lag_hesaplamaInput): Jet_lag_hesaplamaOutput {
...
export interface Jet_lag_hesaplamaOutput {
...
export const Jet_lag_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
