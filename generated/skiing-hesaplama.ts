// Auto-generated from skiing-hesaplama-schema.json
import * as z from 'zod';

export interface Skiing_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Skiing_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Skiing_hesaplamaInput): Record<string, number> {
...
export function calculateSkiing_hesaplama(input: Skiing_hesaplamaInput): Skiing_hesaplamaOutput {
...
export interface Skiing_hesaplamaOutput {
...
export const Skiing_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
