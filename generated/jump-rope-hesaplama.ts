// Auto-generated from jump-rope-hesaplama-schema.json
import * as z from 'zod';

export interface Jump_rope_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Jump_rope_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Jump_rope_hesaplamaInput): Record<string, number> {
...
export function calculateJump_rope_hesaplama(input: Jump_rope_hesaplamaInput): Jump_rope_hesaplamaOutput {
...
export interface Jump_rope_hesaplamaOutput {
...
export const Jump_rope_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
