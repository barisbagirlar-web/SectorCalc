// Auto-generated from m-to-inches-hesaplama-schema.json
import * as z from 'zod';

export interface M_to_inches_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const M_to_inches_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: M_to_inches_hesaplamaInput): Record<string, number> {
...
export function calculateM_to_inches_hesaplama(input: M_to_inches_hesaplamaInput): M_to_inches_hesaplamaOutput {
...
export interface M_to_inches_hesaplamaOutput {
...
export const M_to_inches_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
