// Auto-generated from dance-calorie-hesaplama-schema.json
import * as z from 'zod';

export interface Dance_calorie_hesaplamaInput {
  bodyWeight: number;
  activityLevel: number;
  dataConfidence?: number;
}

export const Dance_calorie_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Dance_calorie_hesaplamaInput): Record<string, number> {
...
export function calculateDance_calorie_hesaplama(input: Dance_calorie_hesaplamaInput): Dance_calorie_hesaplamaOutput {
...
export interface Dance_calorie_hesaplamaOutput {
...
export const Dance_calorie_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "kg",
