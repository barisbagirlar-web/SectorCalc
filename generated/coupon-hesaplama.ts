// Auto-generated from coupon-hesaplama-schema.json
import * as z from 'zod';

export interface Coupon_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Coupon_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Coupon_hesaplamaInput): Record<string, number> {
...
export function calculateCoupon_hesaplama(input: Coupon_hesaplamaInput): Coupon_hesaplamaOutput {
...
export interface Coupon_hesaplamaOutput {
...
export const Coupon_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
