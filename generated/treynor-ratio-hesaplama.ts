// Auto-generated from treynor-ratio-hesaplama-schema.json
import * as z from 'zod';

export interface Treynor_ratio_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Treynor_ratio_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Treynor_ratio_hesaplamaInput): Record<string, number> {
...
export function calculateTreynor_ratio_hesaplama(input: Treynor_ratio_hesaplamaInput): Treynor_ratio_hesaplamaOutput {
...
export interface Treynor_ratio_hesaplamaOutput {
...
export const Treynor_ratio_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
