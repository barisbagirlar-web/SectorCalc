// Auto-generated from tons-to-kg-hesaplama-schema.json
import * as z from 'zod';

export interface Tons_to_kg_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Tons_to_kg_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Tons_to_kg_hesaplamaInput): Record<string, number> {
...
export function calculateTons_to_kg_hesaplama(input: Tons_to_kg_hesaplamaInput): Tons_to_kg_hesaplamaOutput {
...
export interface Tons_to_kg_hesaplamaOutput {
...
export const Tons_to_kg_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
