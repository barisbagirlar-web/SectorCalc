// Auto-generated from hiit-calorie-hesaplama-schema.json
import * as z from 'zod';

export interface Hiit_calorie_hesaplamaInput {
  bodyWeight: number;
  activityLevel: number;
  dataConfidence?: number;
}

export const Hiit_calorie_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Hiit_calorie_hesaplamaInput): Record<string, number> {
...
export function calculateHiit_calorie_hesaplama(input: Hiit_calorie_hesaplamaInput): Hiit_calorie_hesaplamaOutput {
...
export interface Hiit_calorie_hesaplamaOutput {
...
export const Hiit_calorie_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "kg",
