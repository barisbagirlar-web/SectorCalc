// Auto-generated from radian-to-degree-hesaplama-schema.json
import * as z from 'zod';

export interface Radian_to_degree_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Radian_to_degree_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Radian_to_degree_hesaplamaInput): Record<string, number> {
...
export function calculateRadian_to_degree_hesaplama(input: Radian_to_degree_hesaplamaInput): Radian_to_degree_hesaplamaOutput {
...
export interface Radian_to_degree_hesaplamaOutput {
...
export const Radian_to_degree_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
