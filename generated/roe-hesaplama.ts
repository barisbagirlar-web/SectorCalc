// Auto-generated from roe-hesaplama-schema.json
import * as z from 'zod';

export interface Roe_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Roe_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Roe_hesaplamaInput): Record<string, number> {
...
export function calculateRoe_hesaplama(input: Roe_hesaplamaInput): Roe_hesaplamaOutput {
...
export interface Roe_hesaplamaOutput {
...
export const Roe_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
