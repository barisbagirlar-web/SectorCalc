// Auto-generated from t-test-hesaplama-schema.json
import * as z from 'zod';

export interface T_test_hesaplamaInput {
  sampleMean: number;
  standardDeviation: number;
  dataConfidence?: number;
}

export const T_test_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: T_test_hesaplamaInput): Record<string, number> {
...
export function calculateT_test_hesaplama(input: T_test_hesaplamaInput): T_test_hesaplamaOutput {
...
export interface T_test_hesaplamaOutput {
...
export const T_test_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
