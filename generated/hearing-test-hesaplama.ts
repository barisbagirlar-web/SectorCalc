// Auto-generated from hearing-test-hesaplama-schema.json
import * as z from 'zod';

export interface Hearing_test_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Hearing_test_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Hearing_test_hesaplamaInput): Record<string, number> {
...
export function calculateHearing_test_hesaplama(input: Hearing_test_hesaplamaInput): Hearing_test_hesaplamaOutput {
...
export interface Hearing_test_hesaplamaOutput {
...
export const Hearing_test_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
