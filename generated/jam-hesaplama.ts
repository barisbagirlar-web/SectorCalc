// Auto-generated from jam-hesaplama-schema.json
import * as z from 'zod';

export interface Jam_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Jam_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Jam_hesaplamaInput): Record<string, number> {
...
export function calculateJam_hesaplama(input: Jam_hesaplamaInput): Jam_hesaplamaOutput {
...
export interface Jam_hesaplamaOutput {
...
export const Jam_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
