// Auto-generated from gun-yil-hesaplama-schema.json
import * as z from 'zod';

export interface Gun_yil_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Gun_yil_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Gun_yil_hesaplamaInput): Record<string, number> {
...
export function calculateGun_yil_hesaplama(input: Gun_yil_hesaplamaInput): Gun_yil_hesaplamaOutput {
...
export interface Gun_yil_hesaplamaOutput {
...
export const Gun_yil_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
