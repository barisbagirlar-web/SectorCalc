// Auto-generated from k-fold-hesaplama-schema.json
import * as z from 'zod';

export interface K_fold_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const K_fold_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: K_fold_hesaplamaInput): Record<string, number> {
...
export function calculateK_fold_hesaplama(input: K_fold_hesaplamaInput): K_fold_hesaplamaOutput {
...
export interface K_fold_hesaplamaOutput {
...
export const K_fold_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
