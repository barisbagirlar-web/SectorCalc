// Auto-generated from baud-to-bps-hesaplama-schema.json
import * as z from 'zod';

export interface Baud_to_bps_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Baud_to_bps_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Baud_to_bps_hesaplamaInput): Record<string, number> {
...
export function calculateBaud_to_bps_hesaplama(input: Baud_to_bps_hesaplamaInput): Baud_to_bps_hesaplamaOutput {
...
export interface Baud_to_bps_hesaplamaOutput {
...
export const Baud_to_bps_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
