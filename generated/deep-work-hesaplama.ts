// Auto-generated from deep-work-hesaplama-schema.json
import * as z from 'zod';

export interface Deep_work_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Deep_work_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Deep_work_hesaplamaInput): Record<string, number> {
...
export function calculateDeep_work_hesaplama(input: Deep_work_hesaplamaInput): Deep_work_hesaplamaOutput {
...
export interface Deep_work_hesaplamaOutput {
...
export const Deep_work_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
