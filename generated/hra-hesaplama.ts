// Auto-generated from hra-hesaplama-schema.json
import * as z from 'zod';

export interface Hra_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Hra_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Hra_hesaplamaInput): Record<string, number> {
...
export function calculateHra_hesaplama(input: Hra_hesaplamaInput): Hra_hesaplamaOutput {
...
export interface Hra_hesaplamaOutput {
...
export const Hra_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
