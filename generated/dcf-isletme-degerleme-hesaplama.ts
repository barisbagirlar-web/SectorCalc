// Auto-generated from dcf-isletme-degerleme-hesaplama-schema.json
import * as z from 'zod';

export interface Dcf_isletme_degerleme_hesaplamaInput {
  fcf1: number;
  fcf2: number;
  fcf3: number;
  fcf4: number;
...
export const Dcf_isletme_degerleme_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Dcf_isletme_degerleme_hesaplamaInput): Record<string, number> {
...
export function calculateDcf_isletme_degerleme_hesaplama(input: Dcf_isletme_degerleme_hesaplamaInput): Dcf_isletme_degerleme_hesaplamaOutput {
...
export interface Dcf_isletme_degerleme_hesaplamaOutput {
...
export const Dcf_isletme_degerleme_hesaplamaOutputMeta = {
  primaryKey: "sonuc",
  unit: "TRY",
  breakdownKeys: ["sonuc"],
} as const;
