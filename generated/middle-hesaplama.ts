// Auto-generated from middle-hesaplama-schema.json
import * as z from 'zod';

export interface Middle_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Middle_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Middle_hesaplamaInput): Record<string, number> {
...
export function calculateMiddle_hesaplama(input: Middle_hesaplamaInput): Middle_hesaplamaOutput {
...
export interface Middle_hesaplamaOutput {
...
export const Middle_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
