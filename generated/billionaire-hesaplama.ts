// Auto-generated from billionaire-hesaplama-schema.json
import * as z from 'zod';

export interface Billionaire_hesaplamaInput {
  airTemperature: number;
  relativeHumidity: number;
  dataConfidence?: number;
}

export const Billionaire_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Billionaire_hesaplamaInput): Record<string, number> {
...
export function calculateBillionaire_hesaplama(input: Billionaire_hesaplamaInput): Billionaire_hesaplamaOutput {
...
export interface Billionaire_hesaplamaOutput {
...
export const Billionaire_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "°C",
