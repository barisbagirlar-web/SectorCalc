// Auto-generated from hair-growth-hesaplama-schema.json
import * as z from 'zod';

export interface Hair_growth_hesaplamaInput {
  airTemperature: number;
  relativeHumidity: number;
  dataConfidence?: number;
}

export const Hair_growth_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Hair_growth_hesaplamaInput): Record<string, number> {
...
export function calculateHair_growth_hesaplama(input: Hair_growth_hesaplamaInput): Hair_growth_hesaplamaOutput {
...
export interface Hair_growth_hesaplamaOutput {
...
export const Hair_growth_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "°C",
