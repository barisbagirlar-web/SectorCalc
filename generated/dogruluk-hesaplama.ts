// Auto-generated from dogruluk-hesaplama-schema.json
import * as z from 'zod';

export interface Dogruluk_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Dogruluk_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Dogruluk_hesaplamaInput): Record<string, number> {
...
export function calculateDogruluk_hesaplama(input: Dogruluk_hesaplamaInput): Dogruluk_hesaplamaOutput {
...
export interface Dogruluk_hesaplamaOutput {
...
export const Dogruluk_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
