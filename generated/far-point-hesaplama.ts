// Auto-generated from far-point-hesaplama-schema.json
import * as z from 'zod';

export interface Far_point_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Far_point_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Far_point_hesaplamaInput): Record<string, number> {
...
export function calculateFar_point_hesaplama(input: Far_point_hesaplamaInput): Far_point_hesaplamaOutput {
...
export interface Far_point_hesaplamaOutput {
...
export const Far_point_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
