// Auto-generated from work-study-hesaplama-schema.json
import * as z from 'zod';

export interface Work_study_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Work_study_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Work_study_hesaplamaInput): Record<string, number> {
...
export function calculateWork_study_hesaplama(input: Work_study_hesaplamaInput): Work_study_hesaplamaOutput {
...
export interface Work_study_hesaplamaOutput {
...
export const Work_study_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
