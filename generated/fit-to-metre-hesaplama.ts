// Auto-generated from fit-to-metre-hesaplama-schema.json
import * as z from 'zod';

export interface Fit_to_metre_hesaplamaInput {
  lengthValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Fit_to_metre_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Fit_to_metre_hesaplamaInput): Record<string, number> {
...
export function calculateFit_to_metre_hesaplama(input: Fit_to_metre_hesaplamaInput): Fit_to_metre_hesaplamaOutput {
...
export interface Fit_to_metre_hesaplamaOutput {
...
export const Fit_to_metre_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "m",
