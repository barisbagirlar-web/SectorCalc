// Auto-generated from 4-yuzde-rule-hesaplama-schema.json
import * as z from 'zod';

export interface _4_yuzde_rule_hesaplamaInput {
  totalValue: number;
  percentage: number;
  dataConfidence?: number;
}

export const _4_yuzde_rule_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: _4_yuzde_rule_hesaplamaInput): Record<string, number> {
...
export function calculate_4_yuzde_rule_hesaplama(input: _4_yuzde_rule_hesaplamaInput): _4_yuzde_rule_hesaplamaOutput {
...
export interface _4_yuzde_rule_hesaplamaOutput {
...
export const _4_yuzde_rule_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "%",
