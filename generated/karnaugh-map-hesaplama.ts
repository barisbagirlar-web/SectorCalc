// Auto-generated from karnaugh-map-hesaplama-schema.json
import * as z from 'zod';

export interface Karnaugh_map_hesaplamaInput {
  revenueAmount: number;
  costAmount: number;
  dataConfidence?: number;
}

export const Karnaugh_map_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Karnaugh_map_hesaplamaInput): Record<string, number> {
...
export function calculateKarnaugh_map_hesaplama(input: Karnaugh_map_hesaplamaInput): Karnaugh_map_hesaplamaOutput {
...
export interface Karnaugh_map_hesaplamaOutput {
...
export const Karnaugh_map_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
