// Auto-generated from anova-hesaplama-schema.json
import * as z from 'zod';

export interface Anova_hesaplamaInput {
  sampleMean: number;
  standardDeviation: number;
  dataConfidence?: number;
}

export const Anova_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Anova_hesaplamaInput): Record<string, number> {
...
export function calculateAnova_hesaplama(input: Anova_hesaplamaInput): Anova_hesaplamaOutput {
...
export interface Anova_hesaplamaOutput {
...
export const Anova_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
