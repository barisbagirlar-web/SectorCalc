// Auto-generated from prokisim-hesaplama-schema.json
import * as z from 'zod';

export interface Prokisim_hesaplamaInput {
  temperatureValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Prokisim_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Prokisim_hesaplamaInput): Record<string, number> {
...
export function calculateProkisim_hesaplama(input: Prokisim_hesaplamaInput): Prokisim_hesaplamaOutput {
...
export interface Prokisim_hesaplamaOutput {
...
export const Prokisim_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "°C",
