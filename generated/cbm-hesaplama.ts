// Auto-generated from cbm-hesaplama-schema.json
import * as z from 'zod';

export interface Cbm_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Cbm_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cbm_hesaplamaInput): Record<string, number> {
...
export function calculateCbm_hesaplama(input: Cbm_hesaplamaInput): Cbm_hesaplamaOutput {
...
export interface Cbm_hesaplamaOutput {
...
export const Cbm_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
