// Auto-generated from cagr-hesaplama-schema.json
import * as z from 'zod';

export interface Cagr_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Cagr_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cagr_hesaplamaInput): Record<string, number> {
...
export function calculateCagr_hesaplama(input: Cagr_hesaplamaInput): Cagr_hesaplamaOutput {
...
export interface Cagr_hesaplamaOutput {
...
export const Cagr_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
