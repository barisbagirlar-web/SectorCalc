// Auto-generated from taper-hesaplama-schema.json
import * as z from 'zod';

export interface Taper_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Taper_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Taper_hesaplamaInput): Record<string, number> {
...
export function calculateTaper_hesaplama(input: Taper_hesaplamaInput): Taper_hesaplamaOutput {
...
export interface Taper_hesaplamaOutput {
...
export const Taper_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
