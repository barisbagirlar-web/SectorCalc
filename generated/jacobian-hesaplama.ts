// Auto-generated from jacobian-hesaplama-schema.json
import * as z from 'zod';

export interface Jacobian_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Jacobian_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Jacobian_hesaplamaInput): Record<string, number> {
...
export function calculateJacobian_hesaplama(input: Jacobian_hesaplamaInput): Jacobian_hesaplamaOutput {
...
export interface Jacobian_hesaplamaOutput {
...
export const Jacobian_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
