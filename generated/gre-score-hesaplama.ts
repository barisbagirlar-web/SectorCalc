// Auto-generated from gre-score-hesaplama-schema.json
import * as z from 'zod';

export interface Gre_score_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Gre_score_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Gre_score_hesaplamaInput): Record<string, number> {
...
export function calculateGre_score_hesaplama(input: Gre_score_hesaplamaInput): Gre_score_hesaplamaOutput {
...
export interface Gre_score_hesaplamaOutput {
...
export const Gre_score_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
