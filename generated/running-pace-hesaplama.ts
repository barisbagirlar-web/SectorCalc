// Auto-generated from running-pace-hesaplama-schema.json
import * as z from 'zod';

export interface Running_pace_hesaplamaInput {
  distanceKm: number;
  durationMin: number;
  dataConfidence?: number;
}

export const Running_pace_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Running_pace_hesaplamaInput): Record<string, number> {
...
export function calculateRunning_pace_hesaplama(input: Running_pace_hesaplamaInput): Running_pace_hesaplamaOutput {
...
export interface Running_pace_hesaplamaOutput {
...
export const Running_pace_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "km",
