// Auto-generated from og-fg-hesaplama-schema.json
import * as z from 'zod';

export interface Og_fg_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Og_fg_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Og_fg_hesaplamaInput): Record<string, number> {
...
export function calculateOg_fg_hesaplama(input: Og_fg_hesaplamaInput): Og_fg_hesaplamaOutput {
...
export interface Og_fg_hesaplamaOutput {
...
export const Og_fg_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
