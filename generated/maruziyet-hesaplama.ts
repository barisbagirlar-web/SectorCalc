// Auto-generated from maruziyet-hesaplama-schema.json
import * as z from 'zod';

export interface Maruziyet_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Maruziyet_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Maruziyet_hesaplamaInput): Record<string, number> {
...
export function calculateMaruziyet_hesaplama(input: Maruziyet_hesaplamaInput): Maruziyet_hesaplamaOutput {
...
export interface Maruziyet_hesaplamaOutput {
...
export const Maruziyet_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
