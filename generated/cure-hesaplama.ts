// Auto-generated from cure-hesaplama-schema.json
import * as z from 'zod';

export interface Cure_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Cure_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cure_hesaplamaInput): Record<string, number> {
...
export function calculateCure_hesaplama(input: Cure_hesaplamaInput): Cure_hesaplamaOutput {
...
export interface Cure_hesaplamaOutput {
...
export const Cure_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
