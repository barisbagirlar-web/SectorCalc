// Auto-generated from aql-sampling-risk-cost-schema.json
import * as z from 'zod';

export interface Aql_sampling_risk_costInput {
  lot_size: number;
  aql_percent: number;
...
export const Aql_sampling_risk_costInputSchema = z.object({
...
export function calculateAql_sampling_risk_cost(input: Aql_sampling_risk_costInput): Aql_sampling_risk_costOutput {
...
export interface Aql_sampling_risk_costOutput {
