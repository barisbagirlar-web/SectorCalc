// Auto-generated from customs-hesaplama-schema.json
import * as z from 'zod';

export interface Customs_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Customs_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Customs_hesaplamaInput): Record<string, number> {
...
export function calculateCustoms_hesaplama(input: Customs_hesaplamaInput): Customs_hesaplamaOutput {
...
export interface Customs_hesaplamaOutput {
...
export const Customs_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
