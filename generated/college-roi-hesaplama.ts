// Auto-generated from college-roi-hesaplama-schema.json
import * as z from 'zod';

export interface College_roi_hesaplamaInput {
  principal: number;
  rate: number;
  periods: number;
...
export const College_roi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: College_roi_hesaplamaInput): Record<string, number> {
...
export function calculateCollege_roi_hesaplama(input: College_roi_hesaplamaInput): College_roi_hesaplamaOutput {
...
export interface College_roi_hesaplamaOutput {
...
export const College_roi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
