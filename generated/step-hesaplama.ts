// Auto-generated from step-hesaplama-schema.json
import * as z from 'zod';

export interface Step_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Step_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Step_hesaplamaInput): Record<string, number> {
...
export function calculateStep_hesaplama(input: Step_hesaplamaInput): Step_hesaplamaOutput {
...
export interface Step_hesaplamaOutput {
...
export const Step_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
