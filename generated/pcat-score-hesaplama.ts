// Auto-generated from pcat-score-hesaplama-schema.json
import * as z from 'zod';

export interface Pcat_score_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Pcat_score_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pcat_score_hesaplamaInput): Record<string, number> {
...
export function calculatePcat_score_hesaplama(input: Pcat_score_hesaplamaInput): Pcat_score_hesaplamaOutput {
...
export interface Pcat_score_hesaplamaOutput {
...
export const Pcat_score_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
