// Auto-generated from plant-spacing-hesaplama-schema.json
import * as z from 'zod';

export interface Plant_spacing_hesaplamaInput {
  skinTypeScore: number;
  treatmentIntensity: number;
  dataConfidence?: number;
}

export const Plant_spacing_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Plant_spacing_hesaplamaInput): Record<string, number> {
...
export function calculatePlant_spacing_hesaplama(input: Plant_spacing_hesaplamaInput): Plant_spacing_hesaplamaOutput {
...
export interface Plant_spacing_hesaplamaOutput {
...
export const Plant_spacing_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "points",
