// Auto-generated from cat-age-hesaplama-schema.json
import * as z from 'zod';

export interface Cat_age_hesaplamaInput {
  petAge: number;
  petWeight: number;
  dataConfidence?: number;
}

export const Cat_age_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cat_age_hesaplamaInput): Record<string, number> {
...
export function calculateCat_age_hesaplama(input: Cat_age_hesaplamaInput): Cat_age_hesaplamaOutput {
...
export interface Cat_age_hesaplamaOutput {
...
export const Cat_age_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "years",
