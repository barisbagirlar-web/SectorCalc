// Auto-generated from rockport-walk-test-hesaplama-schema.json
import * as z from 'zod';

export interface Rockport_walk_test_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Rockport_walk_test_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Rockport_walk_test_hesaplamaInput): Record<string, number> {
...
export function calculateRockport_walk_test_hesaplama(input: Rockport_walk_test_hesaplamaInput): Rockport_walk_test_hesaplamaOutput {
...
export interface Rockport_walk_test_hesaplamaOutput {
...
export const Rockport_walk_test_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
