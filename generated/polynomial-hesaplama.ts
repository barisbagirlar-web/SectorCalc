// Auto-generated from polynomial-hesaplama-schema.json
import * as z from 'zod';

export interface Polynomial_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Polynomial_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Polynomial_hesaplamaInput): Record<string, number> {
...
export function calculatePolynomial_hesaplama(input: Polynomial_hesaplamaInput): Polynomial_hesaplamaOutput {
...
export interface Polynomial_hesaplamaOutput {
...
export const Polynomial_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
