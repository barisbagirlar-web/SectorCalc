// Auto-generated from degisken-annuity-hesaplama-schema.json
import * as z from 'zod';

export interface Degisken_annuity_hesaplamaInput {
  currentAge: number;
  retirementAge: number;
  dataConfidence?: number;
}

export const Degisken_annuity_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Degisken_annuity_hesaplamaInput): Record<string, number> {
...
export function calculateDegisken_annuity_hesaplama(input: Degisken_annuity_hesaplamaInput): Degisken_annuity_hesaplamaOutput {
...
export interface Degisken_annuity_hesaplamaOutput {
...
export const Degisken_annuity_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "years",
