// Auto-generated from pixels-to-inches-hesaplama-schema.json
import * as z from 'zod';

export interface Pixels_to_inches_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Pixels_to_inches_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pixels_to_inches_hesaplamaInput): Record<string, number> {
...
export function calculatePixels_to_inches_hesaplama(input: Pixels_to_inches_hesaplamaInput): Pixels_to_inches_hesaplamaOutput {
...
export interface Pixels_to_inches_hesaplamaOutput {
...
export const Pixels_to_inches_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
