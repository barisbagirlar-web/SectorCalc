// Auto-generated from swimming-turn-hesaplama-schema.json
import * as z from 'zod';

export interface Swimming_turn_hesaplamaInput {
  heartRate: number;
  exerciseDuration: number;
  dataConfidence?: number;
}

export const Swimming_turn_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Swimming_turn_hesaplamaInput): Record<string, number> {
...
export function calculateSwimming_turn_hesaplama(input: Swimming_turn_hesaplamaInput): Swimming_turn_hesaplamaOutput {
...
export interface Swimming_turn_hesaplamaOutput {
...
export const Swimming_turn_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "bpm",
