// Auto-generated from student-kredi-hesaplama-schema.json
import * as z from 'zod';

export interface Student_kredi_hesaplamaInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Student_kredi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Student_kredi_hesaplamaInput): Record<string, number> {
...
export function calculateStudent_kredi_hesaplama(input: Student_kredi_hesaplamaInput): Student_kredi_hesaplamaOutput {
...
export interface Student_kredi_hesaplamaOutput {
...
export const Student_kredi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
