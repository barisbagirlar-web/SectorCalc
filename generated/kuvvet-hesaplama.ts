// Auto-generated from kuvvet-hesaplama-schema.json
import * as z from 'zod';

export interface Kuvvet_hesaplamaInput {
  maxWeight: number;
  repCount: number;
  dataConfidence?: number;
}

export const Kuvvet_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Kuvvet_hesaplamaInput): Record<string, number> {
...
export function calculateKuvvet_hesaplama(input: Kuvvet_hesaplamaInput): Kuvvet_hesaplamaOutput {
...
export interface Kuvvet_hesaplamaOutput {
...
export const Kuvvet_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "kg",
