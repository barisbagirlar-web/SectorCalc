// Auto-generated from mttr-hesaplama-schema.json
import * as z from 'zod';

export interface Mttr_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Mttr_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Mttr_hesaplamaInput): Record<string, number> {
...
export function calculateMttr_hesaplama(input: Mttr_hesaplamaInput): Mttr_hesaplamaOutput {
...
export interface Mttr_hesaplamaOutput {
...
export const Mttr_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
