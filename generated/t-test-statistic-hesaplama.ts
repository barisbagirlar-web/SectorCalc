// Auto-generated from t-test-statistic-hesaplama-schema.json
import * as z from 'zod';

export interface T_test_statistic_hesaplamaInput {
  sampleMean: number;
  standardDeviation: number;
  dataConfidence?: number;
}

export const T_test_statistic_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: T_test_statistic_hesaplamaInput): Record<string, number> {
...
export function calculateT_test_statistic_hesaplama(input: T_test_statistic_hesaplamaInput): T_test_statistic_hesaplamaOutput {
...
export interface T_test_statistic_hesaplamaOutput {
...
export const T_test_statistic_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
