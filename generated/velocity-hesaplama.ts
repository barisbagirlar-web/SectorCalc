// Auto-generated from velocity-hesaplama-schema.json
import * as z from 'zod';

export interface Velocity_hesaplamaInput {
  speedValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Velocity_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Velocity_hesaplamaInput): Record<string, number> {
...
export function calculateVelocity_hesaplama(input: Velocity_hesaplamaInput): Velocity_hesaplamaOutput {
...
export interface Velocity_hesaplamaOutput {
...
export const Velocity_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "km/h",
