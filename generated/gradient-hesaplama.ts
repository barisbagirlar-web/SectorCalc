// Auto-generated from gradient-hesaplama-schema.json
import * as z from 'zod';

export interface Gradient_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Gradient_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Gradient_hesaplamaInput): Record<string, number> {
...
export function calculateGradient_hesaplama(input: Gradient_hesaplamaInput): Gradient_hesaplamaOutput {
...
export interface Gradient_hesaplamaOutput {
...
export const Gradient_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
