// Auto-generated from dots-hesaplama-schema.json
import * as z from 'zod';

export interface Dots_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Dots_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Dots_hesaplamaInput): Record<string, number> {
...
export function calculateDots_hesaplama(input: Dots_hesaplamaInput): Dots_hesaplamaOutput {
...
export interface Dots_hesaplamaOutput {
...
export const Dots_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
