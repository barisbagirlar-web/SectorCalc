// Auto-generated from hrv-hesaplama-schema.json
import * as z from 'zod';

export interface Hrv_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Hrv_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Hrv_hesaplamaInput): Record<string, number> {
...
export function calculateHrv_hesaplama(input: Hrv_hesaplamaInput): Hrv_hesaplamaOutput {
...
export interface Hrv_hesaplamaOutput {
...
export const Hrv_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
