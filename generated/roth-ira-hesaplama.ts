// Auto-generated from roth-ira-hesaplama-schema.json
import * as z from 'zod';

export interface Roth_ira_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Roth_ira_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Roth_ira_hesaplamaInput): Record<string, number> {
...
export function calculateRoth_ira_hesaplama(input: Roth_ira_hesaplamaInput): Roth_ira_hesaplamaOutput {
...
export interface Roth_ira_hesaplamaOutput {
...
export const Roth_ira_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
