// Auto-generated from quintile-hesaplama-schema.json
import * as z from 'zod';

export interface Quintile_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Quintile_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Quintile_hesaplamaInput): Record<string, number> {
...
export function calculateQuintile_hesaplama(input: Quintile_hesaplamaInput): Quintile_hesaplamaOutput {
...
export interface Quintile_hesaplamaOutput {
...
export const Quintile_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
