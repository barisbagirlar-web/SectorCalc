// Auto-generated from centor-score-hesaplama-schema.json
import * as z from 'zod';

export interface Centor_score_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Centor_score_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Centor_score_hesaplamaInput): Record<string, number> {
...
export function calculateCentor_score_hesaplama(input: Centor_score_hesaplamaInput): Centor_score_hesaplamaOutput {
...
export interface Centor_score_hesaplamaOutput {
...
export const Centor_score_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
