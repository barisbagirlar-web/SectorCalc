// Auto-generated from options-hesaplama-schema.json
import * as z from 'zod';

export interface Options_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Options_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Options_hesaplamaInput): Record<string, number> {
...
export function calculateOptions_hesaplama(input: Options_hesaplamaInput): Options_hesaplamaOutput {
...
export interface Options_hesaplamaOutput {
...
export const Options_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
