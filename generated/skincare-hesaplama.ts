// Auto-generated from skincare-hesaplama-schema.json
import * as z from 'zod';

export interface Skincare_hesaplamaInput {
  skinTypeScore: number;
  treatmentIntensity: number;
  dataConfidence?: number;
}

export const Skincare_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Skincare_hesaplamaInput): Record<string, number> {
...
export function calculateSkincare_hesaplama(input: Skincare_hesaplamaInput): Skincare_hesaplamaOutput {
...
export interface Skincare_hesaplamaOutput {
...
export const Skincare_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "points",
