// Auto-generated from gradian-hesaplama-schema.json
import * as z from 'zod';

export interface Gradian_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Gradian_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Gradian_hesaplamaInput): Record<string, number> {
...
export function calculateGradian_hesaplama(input: Gradian_hesaplamaInput): Gradian_hesaplamaOutput {
...
export interface Gradian_hesaplamaOutput {
...
export const Gradian_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
