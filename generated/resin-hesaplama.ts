// Auto-generated from resin-hesaplama-schema.json
import * as z from 'zod';

export interface Resin_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Resin_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Resin_hesaplamaInput): Record<string, number> {
...
export function calculateResin_hesaplama(input: Resin_hesaplamaInput): Resin_hesaplamaOutput {
...
export interface Resin_hesaplamaOutput {
...
export const Resin_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
