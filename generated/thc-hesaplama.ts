// Auto-generated from thc-hesaplama-schema.json
import * as z from 'zod';

export interface Thc_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Thc_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Thc_hesaplamaInput): Record<string, number> {
...
export function calculateThc_hesaplama(input: Thc_hesaplamaInput): Thc_hesaplamaOutput {
...
export interface Thc_hesaplamaOutput {
...
export const Thc_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
