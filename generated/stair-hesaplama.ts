// Auto-generated from stair-hesaplama-schema.json
import * as z from 'zod';

export interface Stair_hesaplamaInput {
  airTemperature: number;
  relativeHumidity: number;
  dataConfidence?: number;
}

export const Stair_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Stair_hesaplamaInput): Record<string, number> {
...
export function calculateStair_hesaplama(input: Stair_hesaplamaInput): Stair_hesaplamaOutput {
...
export interface Stair_hesaplamaOutput {
...
export const Stair_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "°C",
