// Auto-generated from roman-numeral-donusturucu-schema.json
import * as z from 'zod';

export interface Roman_numeral_donusturucuInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Roman_numeral_donusturucuInputSchema = z.object({
...
function evaluateAllFormulas(input: Roman_numeral_donusturucuInput): Record<string, number> {
...
export function calculateRoman_numeral_donusturucu(input: Roman_numeral_donusturucuInput): Roman_numeral_donusturucuOutput {
...
export interface Roman_numeral_donusturucuOutput {
...
export const Roman_numeral_donusturucuOutputMeta = {
  primaryKey: "result",
  unit: "",
