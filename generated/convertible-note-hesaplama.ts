// Auto-generated from convertible-note-hesaplama-schema.json
import * as z from 'zod';

export interface Convertible_note_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Convertible_note_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Convertible_note_hesaplamaInput): Record<string, number> {
...
export function calculateConvertible_note_hesaplama(input: Convertible_note_hesaplamaInput): Convertible_note_hesaplamaOutput {
...
export interface Convertible_note_hesaplamaOutput {
...
export const Convertible_note_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
