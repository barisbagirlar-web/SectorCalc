// Auto-generated from sortino-ratio-hesaplama-schema.json
import * as z from 'zod';

export interface Sortino_ratio_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Sortino_ratio_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Sortino_ratio_hesaplamaInput): Record<string, number> {
...
export function calculateSortino_ratio_hesaplama(input: Sortino_ratio_hesaplamaInput): Sortino_ratio_hesaplamaOutput {
...
export interface Sortino_ratio_hesaplamaOutput {
...
export const Sortino_ratio_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
