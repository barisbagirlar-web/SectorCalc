// Auto-generated from stock-return-hesaplama-schema.json
import * as z from 'zod';

export interface Stock_return_hesaplamaInput {
  principal: number;
  rate: number;
  periods: number;
...
export const Stock_return_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Stock_return_hesaplamaInput): Record<string, number> {
...
export function calculateStock_return_hesaplama(input: Stock_return_hesaplamaInput): Stock_return_hesaplamaOutput {
...
export interface Stock_return_hesaplamaOutput {
...
export const Stock_return_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
