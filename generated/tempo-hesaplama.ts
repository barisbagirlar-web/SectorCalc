// Auto-generated from tempo-hesaplama-schema.json
import * as z from 'zod';

export interface Tempo_hesaplamaInput {
  distanceKm: number;
  dataConfidence?: number;
}

export const Tempo_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Tempo_hesaplamaInput): Record<string, number> {
...
export function calculateTempo_hesaplama(input: Tempo_hesaplamaInput): Tempo_hesaplamaOutput {
...
export interface Tempo_hesaplamaOutput {
...
export const Tempo_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "km",
