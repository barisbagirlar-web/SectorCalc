// Auto-generated from inverter-hesaplama-schema.json
import * as z from 'zod';

export interface Inverter_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Inverter_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Inverter_hesaplamaInput): Record<string, number> {
...
export function calculateInverter_hesaplama(input: Inverter_hesaplamaInput): Inverter_hesaplamaOutput {
...
export interface Inverter_hesaplamaOutput {
...
export const Inverter_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
