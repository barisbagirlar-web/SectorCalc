// Auto-generated from doms-hesaplama-schema.json
import * as z from 'zod';

export interface Doms_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Doms_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Doms_hesaplamaInput): Record<string, number> {
...
export function calculateDoms_hesaplama(input: Doms_hesaplamaInput): Doms_hesaplamaOutput {
...
export interface Doms_hesaplamaOutput {
...
export const Doms_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
