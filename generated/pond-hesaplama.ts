// Auto-generated from pond-hesaplama-schema.json
import * as z from 'zod';

export interface Pond_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Pond_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pond_hesaplamaInput): Record<string, number> {
...
export function calculatePond_hesaplama(input: Pond_hesaplamaInput): Pond_hesaplamaOutput {
...
export interface Pond_hesaplamaOutput {
...
export const Pond_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
