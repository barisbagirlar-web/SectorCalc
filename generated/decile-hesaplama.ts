// Auto-generated from decile-hesaplama-schema.json
import * as z from 'zod';

export interface Decile_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Decile_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Decile_hesaplamaInput): Record<string, number> {
...
export function calculateDecile_hesaplama(input: Decile_hesaplamaInput): Decile_hesaplamaOutput {
...
export interface Decile_hesaplamaOutput {
...
export const Decile_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
