// Auto-generated from coin-flip-hesaplama-schema.json
import * as z from 'zod';

export interface Coin_flip_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Coin_flip_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Coin_flip_hesaplamaInput): Record<string, number> {
...
export function calculateCoin_flip_hesaplama(input: Coin_flip_hesaplamaInput): Coin_flip_hesaplamaOutput {
...
export interface Coin_flip_hesaplamaOutput {
...
export const Coin_flip_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
