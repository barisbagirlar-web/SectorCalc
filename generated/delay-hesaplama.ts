// Auto-generated from delay-hesaplama-schema.json
import * as z from 'zod';

export interface Delay_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Delay_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Delay_hesaplamaInput): Record<string, number> {
...
export function calculateDelay_hesaplama(input: Delay_hesaplamaInput): Delay_hesaplamaOutput {
...
export interface Delay_hesaplamaOutput {
...
export const Delay_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
