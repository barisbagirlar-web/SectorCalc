// Auto-generated from electric-field-hesaplama-schema.json
import * as z from 'zod';

export interface Electric_field_hesaplamaInput {
  powerValue: number;
  timeDuration: number;
  dataConfidence?: number;
}

export const Electric_field_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Electric_field_hesaplamaInput): Record<string, number> {
...
export function calculateElectric_field_hesaplama(input: Electric_field_hesaplamaInput): Electric_field_hesaplamaOutput {
...
export interface Electric_field_hesaplamaOutput {
...
export const Electric_field_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "W",
