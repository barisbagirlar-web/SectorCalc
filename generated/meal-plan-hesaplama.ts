// Auto-generated from meal-plan-hesaplama-schema.json
import * as z from 'zod';

export interface Meal_plan_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Meal_plan_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Meal_plan_hesaplamaInput): Record<string, number> {
...
export function calculateMeal_plan_hesaplama(input: Meal_plan_hesaplamaInput): Meal_plan_hesaplamaOutput {
...
export interface Meal_plan_hesaplamaOutput {
...
export const Meal_plan_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
