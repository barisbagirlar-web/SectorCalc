// Auto-generated from mulch-hesaplama-schema.json
import * as z from 'zod';

export interface Mulch_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Mulch_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Mulch_hesaplamaInput): Record<string, number> {
...
export function calculateMulch_hesaplama(input: Mulch_hesaplamaInput): Mulch_hesaplamaOutput {
...
export interface Mulch_hesaplamaOutput {
...
export const Mulch_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
