// Auto-generated from debt-hizmet-kaplama-ratio-hesaplama-schema.json
import * as z from 'zod';

export interface Debt_hizmet_kaplama_ratio_hesaplamaInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Debt_hizmet_kaplama_ratio_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Debt_hizmet_kaplama_ratio_hesaplamaInput): Record<string, number> {
...
export function calculateDebt_hizmet_kaplama_ratio_hesaplama(input: Debt_hizmet_kaplama_ratio_hesaplamaInput): Debt_hizmet_kaplama_ratio_hesaplamaOutput {
...
export interface Debt_hizmet_kaplama_ratio_hesaplamaOutput {
...
export const Debt_hizmet_kaplama_ratio_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
