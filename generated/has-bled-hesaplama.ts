// Auto-generated from has-bled-hesaplama-schema.json
import * as z from 'zod';

export interface Has_bled_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Has_bled_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Has_bled_hesaplamaInput): Record<string, number> {
...
export function calculateHas_bled_hesaplama(input: Has_bled_hesaplamaInput): Has_bled_hesaplamaOutput {
...
export interface Has_bled_hesaplamaOutput {
...
export const Has_bled_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
