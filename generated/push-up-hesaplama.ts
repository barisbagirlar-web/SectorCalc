// Auto-generated from push-up-hesaplama-schema.json
import * as z from 'zod';

export interface Push_up_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Push_up_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Push_up_hesaplamaInput): Record<string, number> {
...
export function calculatePush_up_hesaplama(input: Push_up_hesaplamaInput): Push_up_hesaplamaOutput {
...
export interface Push_up_hesaplamaOutput {
...
export const Push_up_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
