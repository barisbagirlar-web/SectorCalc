// Auto-generated from box-boyut-hesaplama-schema.json
import * as z from 'zod';

export interface Box_boyut_hesaplamaInput {
  lengthValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Box_boyut_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Box_boyut_hesaplamaInput): Record<string, number> {
...
export function calculateBox_boyut_hesaplama(input: Box_boyut_hesaplamaInput): Box_boyut_hesaplamaOutput {
...
export interface Box_boyut_hesaplamaOutput {
...
export const Box_boyut_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "m",
