// Auto-generated from f-distribution-hesaplama-schema.json
import * as z from 'zod';

export interface F_distribution_hesaplamaInput {
  sampleMean: number;
  standardDeviation: number;
  dataConfidence?: number;
}

export const F_distribution_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: F_distribution_hesaplamaInput): Record<string, number> {
...
export function calculateF_distribution_hesaplama(input: F_distribution_hesaplamaInput): F_distribution_hesaplamaOutput {
...
export interface F_distribution_hesaplamaOutput {
...
export const F_distribution_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
