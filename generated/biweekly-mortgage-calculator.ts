...
function evaluateAllFormulas(input: Biweekly_mortgage_calculatorInput): Record<string, number | string> {
  ...
  try { const v = input.termYears * 12; results["numberOfMonths"] = typeof v === "number" ? (Number.isFinite(v) ? v : 0) : typeof v === "string" ? v : 0; } catch { results["numberOfMonths"] = 0; }
  return results;
}
