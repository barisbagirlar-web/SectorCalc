// Auto-generated from rv-kredi-hesaplama-schema.json
import * as z from 'zod';

export interface Rv_kredi_hesaplamaInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Rv_kredi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Rv_kredi_hesaplamaInput): Record<string, number> {
...
export function calculateRv_kredi_hesaplama(input: Rv_kredi_hesaplamaInput): Rv_kredi_hesaplamaOutput {
...
export interface Rv_kredi_hesaplamaOutput {
...
export const Rv_kredi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
