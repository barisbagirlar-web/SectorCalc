// Auto-generated from kpa-to-psi-hesaplama-schema.json
import * as z from 'zod';

export interface Kpa_to_psi_hesaplamaInput {
  pressureValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Kpa_to_psi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Kpa_to_psi_hesaplamaInput): Record<string, number> {
...
export function calculateKpa_to_psi_hesaplama(input: Kpa_to_psi_hesaplamaInput): Kpa_to_psi_hesaplamaOutput {
...
export interface Kpa_to_psi_hesaplamaOutput {
...
export const Kpa_to_psi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "Pa",
