// Auto-generated from rpe-hesaplama-schema.json
import * as z from 'zod';

export interface Rpe_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Rpe_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Rpe_hesaplamaInput): Record<string, number> {
...
export function calculateRpe_hesaplama(input: Rpe_hesaplamaInput): Rpe_hesaplamaOutput {
...
export interface Rpe_hesaplamaOutput {
...
export const Rpe_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
