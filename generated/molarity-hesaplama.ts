// Auto-generated from molarity-hesaplama-schema.json
import * as z from 'zod';

export interface Molarity_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Molarity_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Molarity_hesaplamaInput): Record<string, number> {
...
export function calculateMolarity_hesaplama(input: Molarity_hesaplamaInput): Molarity_hesaplamaOutput {
...
export interface Molarity_hesaplamaOutput {
...
export const Molarity_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
