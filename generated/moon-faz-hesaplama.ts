// Auto-generated from moon-faz-hesaplama-schema.json
import * as z from 'zod';

export interface Moon_faz_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Moon_faz_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Moon_faz_hesaplamaInput): Record<string, number> {
...
export function calculateMoon_faz_hesaplama(input: Moon_faz_hesaplamaInput): Moon_faz_hesaplamaOutput {
...
export interface Moon_faz_hesaplamaOutput {
...
export const Moon_faz_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
