// Auto-generated from grout-hesaplama-schema.json
import * as z from 'zod';

export interface Grout_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Grout_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Grout_hesaplamaInput): Record<string, number> {
...
export function calculateGrout_hesaplama(input: Grout_hesaplamaInput): Grout_hesaplamaOutput {
...
export interface Grout_hesaplamaOutput {
...
export const Grout_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
