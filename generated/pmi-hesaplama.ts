// Auto-generated from pmi-hesaplama-schema.json
import * as z from 'zod';

export interface Pmi_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Pmi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pmi_hesaplamaInput): Record<string, number> {
...
export function calculatePmi_hesaplama(input: Pmi_hesaplamaInput): Pmi_hesaplamaOutput {
...
export interface Pmi_hesaplamaOutput {
...
export const Pmi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
