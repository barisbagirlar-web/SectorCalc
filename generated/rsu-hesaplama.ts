// Auto-generated from rsu-hesaplama-schema.json
import * as z from 'zod';

export interface Rsu_hesaplamaInput {
  flowRate: number;
  pipeDiameter: number;
  dataConfidence?: number;
}

export const Rsu_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Rsu_hesaplamaInput): Record<string, number> {
...
export function calculateRsu_hesaplama(input: Rsu_hesaplamaInput): Rsu_hesaplamaOutput {
...
export interface Rsu_hesaplamaOutput {
...
export const Rsu_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "L/min",
