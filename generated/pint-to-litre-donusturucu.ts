// Auto-generated from pint-to-litre-donusturucu-schema.json
import * as z from 'zod';

export interface Pint_to_litre_donusturucuInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Pint_to_litre_donusturucuInputSchema = z.object({
...
function evaluateAllFormulas(input: Pint_to_litre_donusturucuInput): Record<string, number> {
...
export function calculatePint_to_litre_donusturucu(input: Pint_to_litre_donusturucuInput): Pint_to_litre_donusturucuOutput {
...
export interface Pint_to_litre_donusturucuOutput {
...
export const Pint_to_litre_donusturucuOutputMeta = {
  primaryKey: "result",
  unit: "",
