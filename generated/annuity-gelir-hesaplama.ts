// Auto-generated from annuity-gelir-hesaplama-schema.json
import * as z from 'zod';

export interface Annuity_gelir_hesaplamaInput {
  currentAge: number;
  retirementAge: number;
  dataConfidence?: number;
}

export const Annuity_gelir_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Annuity_gelir_hesaplamaInput): Record<string, number> {
...
export function calculateAnnuity_gelir_hesaplama(input: Annuity_gelir_hesaplamaInput): Annuity_gelir_hesaplamaOutput {
...
export interface Annuity_gelir_hesaplamaOutput {
...
export const Annuity_gelir_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "years",
