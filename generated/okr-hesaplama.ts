// Auto-generated from okr-hesaplama-schema.json
import * as z from 'zod';

export interface Okr_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Okr_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Okr_hesaplamaInput): Record<string, number> {
...
export function calculateOkr_hesaplama(input: Okr_hesaplamaInput): Okr_hesaplamaOutput {
...
export interface Okr_hesaplamaOutput {
...
export const Okr_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
