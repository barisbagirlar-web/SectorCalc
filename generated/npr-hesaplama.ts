// Auto-generated from npr-hesaplama-schema.json
import * as z from 'zod';

export interface Npr_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Npr_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Npr_hesaplamaInput): Record<string, number> {
...
export function calculateNpr_hesaplama(input: Npr_hesaplamaInput): Npr_hesaplamaOutput {
...
export interface Npr_hesaplamaOutput {
...
export const Npr_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
