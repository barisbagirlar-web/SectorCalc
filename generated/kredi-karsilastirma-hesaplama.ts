// Auto-generated from kredi-karsilastirma-hesaplama-schema.json
import * as z from 'zod';

export interface Kredi_karsilastirma_hesaplamaInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Kredi_karsilastirma_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Kredi_karsilastirma_hesaplamaInput): Record<string, number> {
...
export function calculateKredi_karsilastirma_hesaplama(input: Kredi_karsilastirma_hesaplamaInput): Kredi_karsilastirma_hesaplamaOutput {
...
export interface Kredi_karsilastirma_hesaplamaOutput {
...
export const Kredi_karsilastirma_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
