// Auto-generated from tree-hesaplama-schema.json
import * as z from 'zod';

export interface Tree_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Tree_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Tree_hesaplamaInput): Record<string, number> {
...
export function calculateTree_hesaplama(input: Tree_hesaplamaInput): Tree_hesaplamaOutput {
...
export interface Tree_hesaplamaOutput {
...
export const Tree_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
