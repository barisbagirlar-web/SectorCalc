// Auto-generated from orbit-hesaplama-schema.json
import * as z from 'zod';

export interface Orbit_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Orbit_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Orbit_hesaplamaInput): Record<string, number> {
...
export function calculateOrbit_hesaplama(input: Orbit_hesaplamaInput): Orbit_hesaplamaOutput {
...
export interface Orbit_hesaplamaOutput {
...
export const Orbit_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
