// Auto-generated from friedman-test-hesaplama-schema.json
import * as z from 'zod';

export interface Friedman_test_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Friedman_test_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Friedman_test_hesaplamaInput): Record<string, number> {
...
export function calculateFriedman_test_hesaplama(input: Friedman_test_hesaplamaInput): Friedman_test_hesaplamaOutput {
...
export interface Friedman_test_hesaplamaOutput {
...
export const Friedman_test_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
