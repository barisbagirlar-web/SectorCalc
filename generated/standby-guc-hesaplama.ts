// Auto-generated from standby-guc-hesaplama-schema.json
import * as z from 'zod';

export interface Standby_guc_hesaplamaInput {
  powerValue: number;
  timeDuration: number;
  dataConfidence?: number;
}

export const Standby_guc_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Standby_guc_hesaplamaInput): Record<string, number> {
...
export function calculateStandby_guc_hesaplama(input: Standby_guc_hesaplamaInput): Standby_guc_hesaplamaOutput {
...
export interface Standby_guc_hesaplamaOutput {
...
export const Standby_guc_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "W",
