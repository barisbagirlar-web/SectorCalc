// Auto-generated from anaerobic-esik-hesaplama-schema.json
import * as z from 'zod';

export interface Anaerobic_esik_hesaplamaInput {
  heartRate: number;
  exerciseDuration: number;
  dataConfidence?: number;
}

export const Anaerobic_esik_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Anaerobic_esik_hesaplamaInput): Record<string, number> {
...
export function calculateAnaerobic_esik_hesaplama(input: Anaerobic_esik_hesaplamaInput): Anaerobic_esik_hesaplamaOutput {
...
export interface Anaerobic_esik_hesaplamaOutput {
...
export const Anaerobic_esik_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "bpm",
