// Auto-generated from rule-72-hesaplama-schema.json
import * as z from 'zod';

export interface Rule_72_hesaplamaInput {
  totalValue: number;
  percentage: number;
  dataConfidence?: number;
}

export const Rule_72_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Rule_72_hesaplamaInput): Record<string, number> {
...
export function calculateRule_72_hesaplama(input: Rule_72_hesaplamaInput): Rule_72_hesaplamaOutput {
...
export interface Rule_72_hesaplamaOutput {
...
export const Rule_72_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "%",
