// Auto-generated from matrix-determinant-hesaplama-schema.json
import * as z from 'zod';

export interface Matrix_determinant_hesaplamaInput {
  matrixSize: number;
  matrixElement: number;
  dataConfidence?: number;
}

export const Matrix_determinant_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Matrix_determinant_hesaplamaInput): Record<string, number> {
...
export function calculateMatrix_determinant_hesaplama(input: Matrix_determinant_hesaplamaInput): Matrix_determinant_hesaplamaOutput {
...
export interface Matrix_determinant_hesaplamaOutput {
...
export const Matrix_determinant_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
