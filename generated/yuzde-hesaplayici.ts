// Auto-generated from yuzde-hesaplayici-schema.json
import * as z from 'zod';

export interface Yuzde_hesaplayiciInput {
  totalValue: number;
  percentage: number;
  dataConfidence?: number;
}

export const Yuzde_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Yuzde_hesaplayiciInput): Record<string, number> {
...
export function calculateYuzde_hesaplayici(input: Yuzde_hesaplayiciInput): Yuzde_hesaplayiciOutput {
...
export interface Yuzde_hesaplayiciOutput {
...
export const Yuzde_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "%",
