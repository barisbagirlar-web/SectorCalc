// Auto-generated from makro-besin-ihtiyaci-hesaplama-schema.json
import * as z from 'zod';

export interface Makro_besin_ihtiyaci_hesaplamaInput {
  tdee: number;
  protein: number;
  yag: number;
  karb: number;
...
export const Makro_besin_ihtiyaci_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Makro_besin_ihtiyaci_hesaplamaInput): Record<string, number> {
...
export function calculateMakro_besin_ihtiyaci_hesaplama(input: Makro_besin_ihtiyaci_hesaplamaInput): Makro_besin_ihtiyaci_hesaplamaOutput {
...
export interface Makro_besin_ihtiyaci_hesaplamaOutput {
...
export const Makro_besin_ihtiyaci_hesaplamaOutputMeta = {
  primaryKey: "sonuc",
  unit: "g",
