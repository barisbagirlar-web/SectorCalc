// Auto-generated from tork-hesaplama-schema.json
import * as z from 'zod';

export interface Tork_hesaplamaInput {
  powerOutput: number;
  dataConfidence?: number;
}

export const Tork_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Tork_hesaplamaInput): Record<string, number> {
...
export function calculateTork_hesaplama(input: Tork_hesaplamaInput): Tork_hesaplamaOutput {
...
export interface Tork_hesaplamaOutput {
...
export const Tork_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "hp",
