// Auto-generated from stress-hesaplama-schema.json
import * as z from 'zod';

export interface Stress_hesaplamaInput {
  stressScore: number;
  dataConfidence?: number;
}

export const Stress_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Stress_hesaplamaInput): Record<string, number> {
...
export function calculateStress_hesaplama(input: Stress_hesaplamaInput): Stress_hesaplamaOutput {
...
export interface Stress_hesaplamaOutput {
...
export const Stress_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "points",
