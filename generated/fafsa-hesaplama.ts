// Auto-generated from fafsa-hesaplama-schema.json
import * as z from 'zod';

export interface Fafsa_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Fafsa_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Fafsa_hesaplamaInput): Record<string, number> {
...
export function calculateFafsa_hesaplama(input: Fafsa_hesaplamaInput): Fafsa_hesaplamaOutput {
...
export interface Fafsa_hesaplamaOutput {
...
export const Fafsa_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
