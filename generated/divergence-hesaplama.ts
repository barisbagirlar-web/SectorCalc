// Auto-generated from divergence-hesaplama-schema.json
import * as z from 'zod';

export interface Divergence_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Divergence_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Divergence_hesaplamaInput): Record<string, number> {
...
export function calculateDivergence_hesaplama(input: Divergence_hesaplamaInput): Divergence_hesaplamaOutput {
...
export interface Divergence_hesaplamaOutput {
...
export const Divergence_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
