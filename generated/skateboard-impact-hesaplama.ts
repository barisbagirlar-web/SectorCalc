// Auto-generated from skateboard-impact-hesaplama-schema.json
import * as z from 'zod';

export interface Skateboard_impact_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Skateboard_impact_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Skateboard_impact_hesaplamaInput): Record<string, number> {
...
export function calculateSkateboard_impact_hesaplama(input: Skateboard_impact_hesaplamaInput): Skateboard_impact_hesaplamaOutput {
...
export interface Skateboard_impact_hesaplamaOutput {
...
export const Skateboard_impact_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
