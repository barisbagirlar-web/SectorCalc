// Auto-generated from gratuity-hesaplama-schema.json
import * as z from 'zod';

export interface Gratuity_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Gratuity_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Gratuity_hesaplamaInput): Record<string, number> {
...
export function calculateGratuity_hesaplama(input: Gratuity_hesaplamaInput): Gratuity_hesaplamaOutput {
...
export interface Gratuity_hesaplamaOutput {
...
export const Gratuity_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
