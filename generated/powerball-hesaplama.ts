// Auto-generated from powerball-hesaplama-schema.json
import * as z from 'zod';

export interface Powerball_hesaplamaInput {
  powerValue: number;
  timeDuration: number;
  dataConfidence?: number;
}

export const Powerball_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Powerball_hesaplamaInput): Record<string, number> {
...
export function calculatePowerball_hesaplama(input: Powerball_hesaplamaInput): Powerball_hesaplamaOutput {
...
export interface Powerball_hesaplamaOutput {
...
export const Powerball_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "W",
