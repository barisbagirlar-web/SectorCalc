// Auto-generated from refraction-hesaplama-schema.json
import * as z from 'zod';

export interface Refraction_hesaplamaInput {
  numerator: number;
  denominator: number;
  dataConfidence?: number;
}

export const Refraction_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Refraction_hesaplamaInput): Record<string, number> {
...
export function calculateRefraction_hesaplama(input: Refraction_hesaplamaInput): Refraction_hesaplamaOutput {
...
export interface Refraction_hesaplamaOutput {
...
export const Refraction_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
