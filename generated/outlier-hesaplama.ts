// Auto-generated from outlier-hesaplama-schema.json
import * as z from 'zod';

export interface Outlier_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Outlier_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Outlier_hesaplamaInput): Record<string, number> {
...
export function calculateOutlier_hesaplama(input: Outlier_hesaplamaInput): Outlier_hesaplamaOutput {
...
export interface Outlier_hesaplamaOutput {
...
export const Outlier_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
