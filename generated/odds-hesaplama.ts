// Auto-generated from odds-hesaplama-schema.json
import * as z from 'zod';

export interface Odds_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Odds_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Odds_hesaplamaInput): Record<string, number> {
...
export function calculateOdds_hesaplama(input: Odds_hesaplamaInput): Odds_hesaplamaOutput {
...
export interface Odds_hesaplamaOutput {
...
export const Odds_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
