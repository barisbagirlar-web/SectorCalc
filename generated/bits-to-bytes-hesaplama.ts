// Auto-generated from bits-to-bytes-hesaplama-schema.json
import * as z from 'zod';

export interface Bits_to_bytes_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Bits_to_bytes_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Bits_to_bytes_hesaplamaInput): Record<string, number> {
...
export function calculateBits_to_bytes_hesaplama(input: Bits_to_bytes_hesaplamaInput): Bits_to_bytes_hesaplamaOutput {
...
export interface Bits_to_bytes_hesaplamaOutput {
...
export const Bits_to_bytes_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
