// Auto-generated from perches-to-sqm-hesaplama-schema.json
import * as z from 'zod';

export interface Perches_to_sqm_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Perches_to_sqm_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Perches_to_sqm_hesaplamaInput): Record<string, number> {
...
export function calculatePerches_to_sqm_hesaplama(input: Perches_to_sqm_hesaplamaInput): Perches_to_sqm_hesaplamaOutput {
...
export interface Perches_to_sqm_hesaplamaOutput {
...
export const Perches_to_sqm_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
