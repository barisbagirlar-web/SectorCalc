// Auto-generated from kb-hesaplama-schema.json
import * as z from 'zod';

export interface Kb_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Kb_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Kb_hesaplamaInput): Record<string, number> {
...
export function calculateKb_hesaplama(input: Kb_hesaplamaInput): Kb_hesaplamaOutput {
...
export interface Kb_hesaplamaOutput {
...
export const Kb_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
