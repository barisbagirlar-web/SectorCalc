// Auto-generated from limit-hesaplama-schema.json
import * as z from 'zod';

export interface Limit_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Limit_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Limit_hesaplamaInput): Record<string, number> {
...
export function calculateLimit_hesaplama(input: Limit_hesaplamaInput): Limit_hesaplamaOutput {
...
export interface Limit_hesaplamaOutput {
...
export const Limit_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
