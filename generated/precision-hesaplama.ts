// Auto-generated from precision-hesaplama-schema.json
import * as z from 'zod';

export interface Precision_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Precision_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Precision_hesaplamaInput): Record<string, number> {
...
export function calculatePrecision_hesaplama(input: Precision_hesaplamaInput): Precision_hesaplamaOutput {
...
export interface Precision_hesaplamaOutput {
...
export const Precision_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
