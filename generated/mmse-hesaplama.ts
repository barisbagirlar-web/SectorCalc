// Auto-generated from mmse-hesaplama-schema.json
import * as z from 'zod';

export interface Mmse_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Mmse_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Mmse_hesaplamaInput): Record<string, number> {
...
export function calculateMmse_hesaplama(input: Mmse_hesaplamaInput): Mmse_hesaplamaOutput {
...
export interface Mmse_hesaplamaOutput {
...
export const Mmse_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
