// Auto-generated from peaking-hesaplama-schema.json
import * as z from 'zod';

export interface Peaking_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Peaking_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Peaking_hesaplamaInput): Record<string, number> {
...
export function calculatePeaking_hesaplama(input: Peaking_hesaplamaInput): Peaking_hesaplamaOutput {
...
export interface Peaking_hesaplamaOutput {
...
export const Peaking_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
