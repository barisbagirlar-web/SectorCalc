// Auto-generated from pixel-hesaplama-schema.json
import * as z from 'zod';

export interface Pixel_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Pixel_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pixel_hesaplamaInput): Record<string, number> {
...
export function calculatePixel_hesaplama(input: Pixel_hesaplamaInput): Pixel_hesaplamaOutput {
...
export interface Pixel_hesaplamaOutput {
...
export const Pixel_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
