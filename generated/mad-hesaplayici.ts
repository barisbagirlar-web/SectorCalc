// Auto-generated from mad-hesaplayici-schema.json
import * as z from 'zod';

export interface Mad_hesaplayiciInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Mad_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Mad_hesaplayiciInput): Record<string, number> {
...
export function calculateMad_hesaplayici(input: Mad_hesaplayiciInput): Mad_hesaplayiciOutput {
...
export interface Mad_hesaplayiciOutput {
...
export const Mad_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "",
