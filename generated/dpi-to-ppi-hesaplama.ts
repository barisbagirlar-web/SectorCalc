// Auto-generated from dpi-to-ppi-hesaplama-schema.json
import * as z from 'zod';

export interface Dpi_to_ppi_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Dpi_to_ppi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Dpi_to_ppi_hesaplamaInput): Record<string, number> {
...
export function calculateDpi_to_ppi_hesaplama(input: Dpi_to_ppi_hesaplamaInput): Dpi_to_ppi_hesaplamaOutput {
...
export interface Dpi_to_ppi_hesaplamaOutput {
...
export const Dpi_to_ppi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
