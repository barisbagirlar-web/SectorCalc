// Auto-generated from net-to-gross-hesaplama-schema.json
import * as z from 'zod';

export interface Net_to_gross_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Net_to_gross_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Net_to_gross_hesaplamaInput): Record<string, number> {
...
export function calculateNet_to_gross_hesaplama(input: Net_to_gross_hesaplamaInput): Net_to_gross_hesaplamaOutput {
...
export interface Net_to_gross_hesaplamaOutput {
...
export const Net_to_gross_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
