// Auto-generated from rmd-hesaplayici-schema.json
import * as z from 'zod';

export interface Rmd_hesaplayiciInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Rmd_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Rmd_hesaplayiciInput): Record<string, number> {
...
export function calculateRmd_hesaplayici(input: Rmd_hesaplayiciInput): Rmd_hesaplayiciOutput {
...
export interface Rmd_hesaplayiciOutput {
...
export const Rmd_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "",
