// Auto-generated from lazer-hesaplama-schema.json
import * as z from 'zod';

export interface Lazer_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Lazer_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Lazer_hesaplamaInput): Record<string, number> {
...
export function calculateLazer_hesaplama(input: Lazer_hesaplamaInput): Lazer_hesaplamaOutput {
...
export interface Lazer_hesaplamaOutput {
...
export const Lazer_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
