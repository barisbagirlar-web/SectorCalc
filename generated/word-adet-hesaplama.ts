// Auto-generated from word-adet-hesaplama-schema.json
import * as z from 'zod';

export interface Word_adet_hesaplamaInput {
  textInput: number;
  countValue: number;
  dataConfidence?: number;
}

export const Word_adet_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Word_adet_hesaplamaInput): Record<string, number> {
...
export function calculateWord_adet_hesaplama(input: Word_adet_hesaplamaInput): Word_adet_hesaplamaOutput {
...
export interface Word_adet_hesaplamaOutput {
...
export const Word_adet_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "text",
