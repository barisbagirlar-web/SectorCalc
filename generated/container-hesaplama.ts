// Auto-generated from container-hesaplama-schema.json
import * as z from 'zod';

export interface Container_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Container_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Container_hesaplamaInput): Record<string, number> {
...
export function calculateContainer_hesaplama(input: Container_hesaplamaInput): Container_hesaplamaOutput {
...
export interface Container_hesaplamaOutput {
...
export const Container_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
