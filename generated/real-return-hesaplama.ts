// Auto-generated from real-return-hesaplama-schema.json
import * as z from 'zod';

export interface Real_return_hesaplamaInput {
  principal: number;
  rate: number;
  periods: number;
...
export const Real_return_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Real_return_hesaplamaInput): Record<string, number> {
...
export function calculateReal_return_hesaplama(input: Real_return_hesaplamaInput): Real_return_hesaplamaOutput {
...
export interface Real_return_hesaplamaOutput {
...
export const Real_return_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
