// Auto-generated from hsa-hesaplama-schema.json
import * as z from 'zod';

export interface Hsa_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Hsa_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Hsa_hesaplamaInput): Record<string, number> {
...
export function calculateHsa_hesaplama(input: Hsa_hesaplamaInput): Hsa_hesaplamaOutput {
...
export interface Hsa_hesaplamaOutput {
...
export const Hsa_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
