// Auto-generated from uc-faz-hesaplama-schema.json
import * as z from 'zod';

export interface Uc_faz_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Uc_faz_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Uc_faz_hesaplamaInput): Record<string, number> {
...
export function calculateUc_faz_hesaplama(input: Uc_faz_hesaplamaInput): Uc_faz_hesaplamaOutput {
...
export interface Uc_faz_hesaplamaOutput {
...
export const Uc_faz_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
