// Auto-generated from formul-hesaplayici-schema.json
import * as z from 'zod';

export interface Formul_hesaplayiciInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Formul_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Formul_hesaplayiciInput): Record<string, number> {
...
export function calculateFormul_hesaplayici(input: Formul_hesaplayiciInput): Formul_hesaplayiciOutput {
...
export interface Formul_hesaplayiciOutput {
...
export const Formul_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "",
