// Auto-generated from accruals-ratio-hesaplama-schema.json
import * as z from 'zod';

export interface Accruals_ratio_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Accruals_ratio_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Accruals_ratio_hesaplamaInput): Record<string, number> {
...
export function calculateAccruals_ratio_hesaplama(input: Accruals_ratio_hesaplamaInput): Accruals_ratio_hesaplamaOutput {
...
export interface Accruals_ratio_hesaplamaOutput {
...
export const Accruals_ratio_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
