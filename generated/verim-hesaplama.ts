// Auto-generated from verim-hesaplama-schema.json
import * as z from 'zod';

export interface Verim_hesaplamaInput {
  fieldArea: number;
  yieldPerArea: number;
  dataConfidence?: number;
}

export const Verim_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Verim_hesaplamaInput): Record<string, number> {
...
export function calculateVerim_hesaplama(input: Verim_hesaplamaInput): Verim_hesaplamaOutput {
...
export interface Verim_hesaplamaOutput {
...
export const Verim_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "m²",
