// Auto-generated from reactance-hesaplama-schema.json
import * as z from 'zod';

export interface Reactance_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Reactance_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Reactance_hesaplamaInput): Record<string, number> {
...
export function calculateReactance_hesaplama(input: Reactance_hesaplamaInput): Reactance_hesaplamaOutput {
...
export interface Reactance_hesaplamaOutput {
...
export const Reactance_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
