// Auto-generated from quartile-hesaplama-schema.json
import * as z from 'zod';

export interface Quartile_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Quartile_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Quartile_hesaplamaInput): Record<string, number> {
...
export function calculateQuartile_hesaplama(input: Quartile_hesaplamaInput): Quartile_hesaplamaOutput {
...
export interface Quartile_hesaplamaOutput {
...
export const Quartile_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
