// Auto-generated from wilks-hesaplama-schema.json
import * as z from 'zod';

export interface Wilks_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Wilks_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Wilks_hesaplamaInput): Record<string, number> {
...
export function calculateWilks_hesaplama(input: Wilks_hesaplamaInput): Wilks_hesaplamaOutput {
...
export interface Wilks_hesaplamaOutput {
...
export const Wilks_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
