// Auto-generated from vaping-hesaplama-schema.json
import * as z from 'zod';

export interface Vaping_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Vaping_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Vaping_hesaplamaInput): Record<string, number> {
...
export function calculateVaping_hesaplama(input: Vaping_hesaplamaInput): Vaping_hesaplamaOutput {
...
export interface Vaping_hesaplamaOutput {
...
export const Vaping_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
