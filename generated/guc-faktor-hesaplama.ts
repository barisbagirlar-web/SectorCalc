// Auto-generated from guc-faktor-hesaplama-schema.json
import * as z from 'zod';

export interface Guc_faktor_hesaplamaInput {
  powerValue: number;
  timeDuration: number;
  dataConfidence?: number;
}

export const Guc_faktor_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Guc_faktor_hesaplamaInput): Record<string, number> {
...
export function calculateGuc_faktor_hesaplama(input: Guc_faktor_hesaplamaInput): Guc_faktor_hesaplamaOutput {
...
export interface Guc_faktor_hesaplamaOutput {
...
export const Guc_faktor_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "W",
