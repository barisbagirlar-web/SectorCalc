// Auto-generated from triple-test-hesaplama-schema.json
import * as z from 'zod';

export interface Triple_test_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Triple_test_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Triple_test_hesaplamaInput): Record<string, number> {
...
export function calculateTriple_test_hesaplama(input: Triple_test_hesaplamaInput): Triple_test_hesaplamaOutput {
...
export interface Triple_test_hesaplamaOutput {
...
export const Triple_test_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
