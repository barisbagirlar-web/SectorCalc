// Auto-generated from hedge-hesaplama-schema.json
import * as z from 'zod';

export interface Hedge_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Hedge_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Hedge_hesaplamaInput): Record<string, number> {
...
export function calculateHedge_hesaplama(input: Hedge_hesaplamaInput): Hedge_hesaplamaOutput {
...
export interface Hedge_hesaplamaOutput {
...
export const Hedge_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
