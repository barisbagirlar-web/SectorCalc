// Auto-generated from pool-hesaplama-schema.json
import * as z from 'zod';

export interface Pool_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Pool_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pool_hesaplamaInput): Record<string, number> {
...
export function calculatePool_hesaplama(input: Pool_hesaplamaInput): Pool_hesaplamaOutput {
...
export interface Pool_hesaplamaOutput {
...
export const Pool_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
