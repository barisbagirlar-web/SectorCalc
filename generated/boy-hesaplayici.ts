// Auto-generated from boy-hesaplayici-schema.json
import * as z from 'zod';

export interface Boy_hesaplayiciInput {
  lengthValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Boy_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Boy_hesaplayiciInput): Record<string, number> {
...
export function calculateBoy_hesaplayici(input: Boy_hesaplayiciInput): Boy_hesaplayiciOutput {
...
export interface Boy_hesaplayiciOutput {
...
export const Boy_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "m",
