// Auto-generated from yuzde-hata-hesaplama-schema.json
import * as z from 'zod';

export interface Yuzde_hata_hesaplamaInput {
  totalValue: number;
  percentage: number;
  dataConfidence?: number;
}

export const Yuzde_hata_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Yuzde_hata_hesaplamaInput): Record<string, number> {
...
export function calculateYuzde_hata_hesaplama(input: Yuzde_hata_hesaplamaInput): Yuzde_hata_hesaplamaOutput {
...
export interface Yuzde_hata_hesaplamaOutput {
...
export const Yuzde_hata_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "%",
