// Auto-generated from reverse-diet-hesaplama-schema.json
import * as z from 'zod';

export interface Reverse_diet_hesaplamaInput {
  dailyCalories: number;
  bodyMass: number;
  dataConfidence?: number;
}

export const Reverse_diet_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Reverse_diet_hesaplamaInput): Record<string, number> {
...
export function calculateReverse_diet_hesaplama(input: Reverse_diet_hesaplamaInput): Reverse_diet_hesaplamaOutput {
...
export interface Reverse_diet_hesaplamaOutput {
...
export const Reverse_diet_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "kcal",
