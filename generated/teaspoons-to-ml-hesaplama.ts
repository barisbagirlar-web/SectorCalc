// Auto-generated from teaspoons-to-ml-hesaplama-schema.json
import * as z from 'zod';

export interface Teaspoons_to_ml_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Teaspoons_to_ml_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Teaspoons_to_ml_hesaplamaInput): Record<string, number> {
...
export function calculateTeaspoons_to_ml_hesaplama(input: Teaspoons_to_ml_hesaplamaInput): Teaspoons_to_ml_hesaplamaOutput {
...
export interface Teaspoons_to_ml_hesaplamaOutput {
...
export const Teaspoons_to_ml_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
