// Auto-generated from pb-ratio-hesaplama-schema.json
import * as z from 'zod';

export interface Pb_ratio_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Pb_ratio_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pb_ratio_hesaplamaInput): Record<string, number> {
...
export function calculatePb_ratio_hesaplama(input: Pb_ratio_hesaplamaInput): Pb_ratio_hesaplamaOutput {
...
export interface Pb_ratio_hesaplamaOutput {
...
export const Pb_ratio_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
