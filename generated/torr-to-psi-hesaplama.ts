// Auto-generated from torr-to-psi-hesaplama-schema.json
import * as z from 'zod';

export interface Torr_to_psi_hesaplamaInput {
  pressureValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Torr_to_psi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Torr_to_psi_hesaplamaInput): Record<string, number> {
...
export function calculateTorr_to_psi_hesaplama(input: Torr_to_psi_hesaplamaInput): Torr_to_psi_hesaplamaOutput {
...
export interface Torr_to_psi_hesaplamaOutput {
...
export const Torr_to_psi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "Pa",
