// Auto-generated from recast-konut-kredisi-hesaplama-schema.json
import * as z from 'zod';

export interface Recast_konut_kredisi_hesaplamaInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Recast_konut_kredisi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Recast_konut_kredisi_hesaplamaInput): Record<string, number> {
...
export function calculateRecast_konut_kredisi_hesaplama(input: Recast_konut_kredisi_hesaplamaInput): Recast_konut_kredisi_hesaplamaOutput {
...
export interface Recast_konut_kredisi_hesaplamaOutput {
...
export const Recast_konut_kredisi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
