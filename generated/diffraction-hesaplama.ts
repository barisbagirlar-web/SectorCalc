// Auto-generated from diffraction-hesaplama-schema.json
import * as z from 'zod';

export interface Diffraction_hesaplamaInput {
  numerator: number;
  denominator: number;
  dataConfidence?: number;
}

export const Diffraction_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Diffraction_hesaplamaInput): Record<string, number> {
...
export function calculateDiffraction_hesaplama(input: Diffraction_hesaplamaInput): Diffraction_hesaplamaOutput {
...
export interface Diffraction_hesaplamaOutput {
...
export const Diffraction_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
