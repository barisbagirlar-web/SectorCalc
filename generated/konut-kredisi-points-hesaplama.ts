// Auto-generated from konut-kredisi-points-hesaplama-schema.json
import * as z from 'zod';

export interface Konut_kredisi_points_hesaplamaInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Konut_kredisi_points_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Konut_kredisi_points_hesaplamaInput): Record<string, number> {
...
export function calculateKonut_kredisi_points_hesaplama(input: Konut_kredisi_points_hesaplamaInput): Konut_kredisi_points_hesaplamaOutput {
...
export interface Konut_kredisi_points_hesaplamaOutput {
...
export const Konut_kredisi_points_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
