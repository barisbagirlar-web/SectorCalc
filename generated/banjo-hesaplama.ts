// Auto-generated from banjo-hesaplama-schema.json
import * as z from 'zod';

export interface Banjo_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Banjo_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Banjo_hesaplamaInput): Record<string, number> {
...
export function calculateBanjo_hesaplama(input: Banjo_hesaplamaInput): Banjo_hesaplamaOutput {
...
export interface Banjo_hesaplamaOutput {
...
export const Banjo_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
