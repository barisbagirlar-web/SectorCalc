// Auto-generated from cpi-hesaplama-schema.json
import * as z from 'zod';

export interface Cpi_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Cpi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cpi_hesaplamaInput): Record<string, number> {
...
export function calculateCpi_hesaplama(input: Cpi_hesaplamaInput): Cpi_hesaplamaOutput {
...
export interface Cpi_hesaplamaOutput {
...
export const Cpi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
