// Auto-generated from not-hesaplayici-schema.json
import * as z from 'zod';

export interface Not_hesaplayiciInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Not_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Not_hesaplayiciInput): Record<string, number> {
...
export function calculateNot_hesaplayici(input: Not_hesaplayiciInput): Not_hesaplayiciOutput {
...
export interface Not_hesaplayiciOutput {
...
export const Not_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "n",
