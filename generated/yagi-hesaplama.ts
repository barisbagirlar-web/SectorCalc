// Auto-generated from yagi-hesaplama-schema.json
import * as z from 'zod';

export interface Yagi_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Yagi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Yagi_hesaplamaInput): Record<string, number> {
...
export function calculateYagi_hesaplama(input: Yagi_hesaplamaInput): Yagi_hesaplamaOutput {
...
export interface Yagi_hesaplamaOutput {
...
export const Yagi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
