// Auto-generated from pack-yil-hesaplama-schema.json
import * as z from 'zod';

export interface Pack_yil_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Pack_yil_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pack_yil_hesaplamaInput): Record<string, number> {
...
export function calculatePack_yil_hesaplama(input: Pack_yil_hesaplamaInput): Pack_yil_hesaplamaOutput {
...
export interface Pack_yil_hesaplamaOutput {
...
export const Pack_yil_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
