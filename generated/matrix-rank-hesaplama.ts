// Auto-generated from matrix-rank-hesaplama-schema.json
import * as z from 'zod';

export interface Matrix_rank_hesaplamaInput {
  matrixSize: number;
  matrixElement: number;
  dataConfidence?: number;
}

export const Matrix_rank_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Matrix_rank_hesaplamaInput): Record<string, number> {
...
export function calculateMatrix_rank_hesaplama(input: Matrix_rank_hesaplamaInput): Matrix_rank_hesaplamaOutput {
...
export interface Matrix_rank_hesaplamaOutput {
...
export const Matrix_rank_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
