// Auto-generated from half-marathon-hesaplama-schema.json
import * as z from 'zod';

export interface Half_marathon_hesaplamaInput {
  distanceKm: number;
  durationMin: number;
  dataConfidence?: number;
}

export const Half_marathon_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Half_marathon_hesaplamaInput): Record<string, number> {
...
export function calculateHalf_marathon_hesaplama(input: Half_marathon_hesaplamaInput): Half_marathon_hesaplamaOutput {
...
export interface Half_marathon_hesaplamaOutput {
...
export const Half_marathon_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "km",
