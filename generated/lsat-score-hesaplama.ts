// Auto-generated from lsat-score-hesaplama-schema.json
import * as z from 'zod';

export interface Lsat_score_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Lsat_score_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Lsat_score_hesaplamaInput): Record<string, number> {
...
export function calculateLsat_score_hesaplama(input: Lsat_score_hesaplamaInput): Lsat_score_hesaplamaOutput {
...
export interface Lsat_score_hesaplamaOutput {
...
export const Lsat_score_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
