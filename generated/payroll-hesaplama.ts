// Auto-generated from payroll-hesaplama-schema.json
import * as z from 'zod';

export interface Payroll_hesaplamaInput {
  annualIncome: number;
  dataConfidence?: number;
}

export const Payroll_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Payroll_hesaplamaInput): Record<string, number> {
...
export function calculatePayroll_hesaplama(input: Payroll_hesaplamaInput): Payroll_hesaplamaOutput {
...
export interface Payroll_hesaplamaOutput {
...
export const Payroll_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
