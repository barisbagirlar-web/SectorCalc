// Auto-generated from keto-macro-hesaplama-schema.json
import * as z from 'zod';

export interface Keto_macro_hesaplamaInput {
  dailyCalories: number;
  bodyMass: number;
  dataConfidence?: number;
}

export const Keto_macro_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Keto_macro_hesaplamaInput): Record<string, number> {
...
export function calculateKeto_macro_hesaplama(input: Keto_macro_hesaplamaInput): Keto_macro_hesaplamaOutput {
...
export interface Keto_macro_hesaplamaOutput {
...
export const Keto_macro_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "kcal",
