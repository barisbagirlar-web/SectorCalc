// Auto-generated from gun-to-saat-hesaplama-schema.json
import * as z from 'zod';

export interface Gun_to_saat_hesaplamaInput {
  timeValue: number;
  frequency: number;
  dataConfidence?: number;
}

export const Gun_to_saat_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Gun_to_saat_hesaplamaInput): Record<string, number> {
...
export function calculateGun_to_saat_hesaplama(input: Gun_to_saat_hesaplamaInput): Gun_to_saat_hesaplamaOutput {
...
export interface Gun_to_saat_hesaplamaOutput {
...
export const Gun_to_saat_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "min",
