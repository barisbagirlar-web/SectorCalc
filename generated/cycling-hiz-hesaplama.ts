// Auto-generated from cycling-hiz-hesaplama-schema.json
import * as z from 'zod';

export interface Cycling_hiz_hesaplamaInput {
  heartRate: number;
  exerciseDuration: number;
  dataConfidence?: number;
}

export const Cycling_hiz_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cycling_hiz_hesaplamaInput): Record<string, number> {
...
export function calculateCycling_hiz_hesaplama(input: Cycling_hiz_hesaplamaInput): Cycling_hiz_hesaplamaOutput {
...
export interface Cycling_hiz_hesaplamaOutput {
...
export const Cycling_hiz_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "bpm",
