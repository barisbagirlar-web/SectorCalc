// Auto-generated from markdown-hesaplama-schema.json
import * as z from 'zod';

export interface Markdown_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Markdown_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Markdown_hesaplamaInput): Record<string, number> {
...
export function calculateMarkdown_hesaplama(input: Markdown_hesaplamaInput): Markdown_hesaplamaOutput {
...
export interface Markdown_hesaplamaOutput {
...
export const Markdown_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
