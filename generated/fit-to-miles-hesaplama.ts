// Auto-generated from fit-to-miles-hesaplama-schema.json
import * as z from 'zod';

export interface Fit_to_miles_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Fit_to_miles_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Fit_to_miles_hesaplamaInput): Record<string, number> {
...
export function calculateFit_to_miles_hesaplama(input: Fit_to_miles_hesaplamaInput): Fit_to_miles_hesaplamaOutput {
...
export interface Fit_to_miles_hesaplamaOutput {
...
export const Fit_to_miles_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
