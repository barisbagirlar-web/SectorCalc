// Auto-generated from growing-annuity-hesaplama-schema.json
import * as z from 'zod';

export interface Growing_annuity_hesaplamaInput {
  currentAge: number;
  retirementAge: number;
  dataConfidence?: number;
}

export const Growing_annuity_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Growing_annuity_hesaplamaInput): Record<string, number> {
...
export function calculateGrowing_annuity_hesaplama(input: Growing_annuity_hesaplamaInput): Growing_annuity_hesaplamaOutput {
...
export interface Growing_annuity_hesaplamaOutput {
...
export const Growing_annuity_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "years",
