// Auto-generated from regression-hesaplama-schema.json
import * as z from 'zod';

export interface Regression_hesaplamaInput {
  sampleMean: number;
  standardDeviation: number;
  dataConfidence?: number;
}

export const Regression_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Regression_hesaplamaInput): Record<string, number> {
...
export function calculateRegression_hesaplama(input: Regression_hesaplamaInput): Regression_hesaplamaOutput {
...
export interface Regression_hesaplamaOutput {
...
export const Regression_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
