// Auto-generated from yuzde-fark-hesaplama-schema.json
import * as z from 'zod';

export interface Yuzde_fark_hesaplamaInput {
  totalValue: number;
  percentage: number;
  dataConfidence?: number;
}

export const Yuzde_fark_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Yuzde_fark_hesaplamaInput): Record<string, number> {
...
export function calculateYuzde_fark_hesaplama(input: Yuzde_fark_hesaplamaInput): Yuzde_fark_hesaplamaOutput {
...
export interface Yuzde_fark_hesaplamaOutput {
...
export const Yuzde_fark_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "%",
