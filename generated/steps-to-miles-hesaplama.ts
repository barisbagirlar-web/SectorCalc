// Auto-generated from steps-to-miles-hesaplama-schema.json
import * as z from 'zod';

export interface Steps_to_miles_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Steps_to_miles_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Steps_to_miles_hesaplamaInput): Record<string, number> {
...
export function calculateSteps_to_miles_hesaplama(input: Steps_to_miles_hesaplamaInput): Steps_to_miles_hesaplamaOutput {
...
export interface Steps_to_miles_hesaplamaOutput {
...
export const Steps_to_miles_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
