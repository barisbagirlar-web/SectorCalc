// Auto-generated from cohens-d-hesaplama-schema.json
import * as z from 'zod';

export interface Cohens_d_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Cohens_d_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cohens_d_hesaplamaInput): Record<string, number> {
...
export function calculateCohens_d_hesaplama(input: Cohens_d_hesaplamaInput): Cohens_d_hesaplamaOutput {
...
export interface Cohens_d_hesaplamaOutput {
...
export const Cohens_d_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
