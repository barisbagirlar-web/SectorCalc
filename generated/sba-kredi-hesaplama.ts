// Auto-generated from sba-kredi-hesaplama-schema.json
import * as z from 'zod';

export interface Sba_kredi_hesaplamaInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Sba_kredi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Sba_kredi_hesaplamaInput): Record<string, number> {
...
export function calculateSba_kredi_hesaplama(input: Sba_kredi_hesaplamaInput): Sba_kredi_hesaplamaOutput {
...
export interface Sba_kredi_hesaplamaOutput {
...
export const Sba_kredi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
