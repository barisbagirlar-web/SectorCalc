// Auto-generated from ups-hesaplama-schema.json
import * as z from 'zod';

export interface Ups_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Ups_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ups_hesaplamaInput): Record<string, number> {
...
export function calculateUps_hesaplama(input: Ups_hesaplamaInput): Ups_hesaplamaOutput {
...
export interface Ups_hesaplamaOutput {
...
export const Ups_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
