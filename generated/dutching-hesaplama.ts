// Auto-generated from dutching-hesaplama-schema.json
import * as z from 'zod';

export interface Dutching_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Dutching_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Dutching_hesaplamaInput): Record<string, number> {
...
export function calculateDutching_hesaplama(input: Dutching_hesaplamaInput): Dutching_hesaplamaOutput {
...
export interface Dutching_hesaplamaOutput {
...
export const Dutching_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
