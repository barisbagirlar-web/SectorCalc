// Auto-generated from gauss-law-hesaplama-schema.json
import * as z from 'zod';

export interface Gauss_law_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Gauss_law_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Gauss_law_hesaplamaInput): Record<string, number> {
...
export function calculateGauss_law_hesaplama(input: Gauss_law_hesaplamaInput): Gauss_law_hesaplamaOutput {
...
export interface Gauss_law_hesaplamaOutput {
...
export const Gauss_law_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
