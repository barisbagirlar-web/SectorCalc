// Auto-generated from tanning-hesaplama-schema.json
import * as z from 'zod';

export interface Tanning_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Tanning_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Tanning_hesaplamaInput): Record<string, number> {
...
export function calculateTanning_hesaplama(input: Tanning_hesaplamaInput): Tanning_hesaplamaOutput {
...
export interface Tanning_hesaplamaOutput {
...
export const Tanning_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
