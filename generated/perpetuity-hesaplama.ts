// Auto-generated from perpetuity-hesaplama-schema.json
import * as z from 'zod';

export interface Perpetuity_hesaplamaInput {
  petAge: number;
  petWeight: number;
  dataConfidence?: number;
}

export const Perpetuity_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Perpetuity_hesaplamaInput): Record<string, number> {
...
export function calculatePerpetuity_hesaplama(input: Perpetuity_hesaplamaInput): Perpetuity_hesaplamaOutput {
...
export interface Perpetuity_hesaplamaOutput {
...
export const Perpetuity_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "years",
