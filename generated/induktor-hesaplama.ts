// Auto-generated from induktor-hesaplama-schema.json
import * as z from 'zod';

export interface Induktor_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Induktor_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Induktor_hesaplamaInput): Record<string, number> {
...
export function calculateInduktor_hesaplama(input: Induktor_hesaplamaInput): Induktor_hesaplamaOutput {
...
export interface Induktor_hesaplamaOutput {
...
export const Induktor_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
