// Auto-generated from chains-to-links-hesaplama-schema.json
import * as z from 'zod';

export interface Chains_to_links_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Chains_to_links_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Chains_to_links_hesaplamaInput): Record<string, number> {
...
export function calculateChains_to_links_hesaplama(input: Chains_to_links_hesaplamaInput): Chains_to_links_hesaplamaOutput {
...
export interface Chains_to_links_hesaplamaOutput {
...
export const Chains_to_links_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
