// Auto-generated from bar-to-atm-hesaplama-schema.json
import * as z from 'zod';

export interface Bar_to_atm_hesaplamaInput {
  pressureValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Bar_to_atm_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Bar_to_atm_hesaplamaInput): Record<string, number> {
...
export function calculateBar_to_atm_hesaplama(input: Bar_to_atm_hesaplamaInput): Bar_to_atm_hesaplamaOutput {
...
export interface Bar_to_atm_hesaplamaOutput {
...
export const Bar_to_atm_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "Pa",
