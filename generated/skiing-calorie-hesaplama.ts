// Auto-generated from skiing-calorie-hesaplama-schema.json
import * as z from 'zod';

export interface Skiing_calorie_hesaplamaInput {
  bodyWeight: number;
  activityLevel: number;
  dataConfidence?: number;
}

export const Skiing_calorie_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Skiing_calorie_hesaplamaInput): Record<string, number> {
...
export function calculateSkiing_calorie_hesaplama(input: Skiing_calorie_hesaplamaInput): Skiing_calorie_hesaplamaOutput {
...
export interface Skiing_calorie_hesaplamaOutput {
...
export const Skiing_calorie_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "kg",
