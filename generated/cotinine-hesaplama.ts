// Auto-generated from cotinine-hesaplama-schema.json
import * as z from 'zod';

export interface Cotinine_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Cotinine_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cotinine_hesaplamaInput): Record<string, number> {
...
export function calculateCotinine_hesaplama(input: Cotinine_hesaplamaInput): Cotinine_hesaplamaOutput {
...
export interface Cotinine_hesaplamaOutput {
...
export const Cotinine_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
