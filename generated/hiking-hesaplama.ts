// Auto-generated from hiking-hesaplama-schema.json
import * as z from 'zod';

export interface Hiking_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Hiking_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Hiking_hesaplamaInput): Record<string, number> {
...
export function calculateHiking_hesaplama(input: Hiking_hesaplamaInput): Hiking_hesaplamaOutput {
...
export interface Hiking_hesaplamaOutput {
...
export const Hiking_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
