// Auto-generated from cycling-atl-hesaplama-schema.json
import * as z from 'zod';

export interface Cycling_atl_hesaplamaInput {
  heartRate: number;
  exerciseDuration: number;
  dataConfidence?: number;
}

export const Cycling_atl_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cycling_atl_hesaplamaInput): Record<string, number> {
...
export function calculateCycling_atl_hesaplama(input: Cycling_atl_hesaplamaInput): Cycling_atl_hesaplamaOutput {
...
export interface Cycling_atl_hesaplamaOutput {
...
export const Cycling_atl_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "bpm",
