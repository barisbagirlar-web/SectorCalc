// Auto-generated from coffee-hesaplama-schema.json
import * as z from 'zod';

export interface Coffee_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Coffee_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Coffee_hesaplamaInput): Record<string, number> {
...
export function calculateCoffee_hesaplama(input: Coffee_hesaplamaInput): Coffee_hesaplamaOutput {
...
export interface Coffee_hesaplamaOutput {
...
export const Coffee_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
