// Auto-generated from deload-hesaplama-schema.json
import * as z from 'zod';

export interface Deload_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Deload_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Deload_hesaplamaInput): Record<string, number> {
...
export function calculateDeload_hesaplama(input: Deload_hesaplamaInput): Deload_hesaplamaOutput {
...
export interface Deload_hesaplamaOutput {
...
export const Deload_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
