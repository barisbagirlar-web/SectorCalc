// Auto-generated from round-to-nearest-hesaplama-schema.json
import * as z from 'zod';

export interface Round_to_nearest_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Round_to_nearest_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Round_to_nearest_hesaplamaInput): Record<string, number> {
...
export function calculateRound_to_nearest_hesaplama(input: Round_to_nearest_hesaplamaInput): Round_to_nearest_hesaplamaOutput {
...
export interface Round_to_nearest_hesaplamaOutput {
...
export const Round_to_nearest_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
