// Auto-generated from angle-hesaplama-schema.json
import * as z from 'zod';

export interface Angle_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Angle_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Angle_hesaplamaInput): Record<string, number> {
...
export function calculateAngle_hesaplama(input: Angle_hesaplamaInput): Angle_hesaplamaOutput {
...
export interface Angle_hesaplamaOutput {
...
export const Angle_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
