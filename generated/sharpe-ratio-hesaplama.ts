// Auto-generated from sharpe-ratio-hesaplama-schema.json
import * as z from 'zod';

export interface Sharpe_ratio_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Sharpe_ratio_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Sharpe_ratio_hesaplamaInput): Record<string, number> {
...
export function calculateSharpe_ratio_hesaplama(input: Sharpe_ratio_hesaplamaInput): Sharpe_ratio_hesaplamaOutput {
...
export interface Sharpe_ratio_hesaplamaOutput {
...
export const Sharpe_ratio_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
