// Auto-generated from ounces-to-pounds-hesaplama-schema.json
import * as z from 'zod';

export interface Ounces_to_pounds_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Ounces_to_pounds_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ounces_to_pounds_hesaplamaInput): Record<string, number> {
...
export function calculateOunces_to_pounds_hesaplama(input: Ounces_to_pounds_hesaplamaInput): Ounces_to_pounds_hesaplamaOutput {
...
export interface Ounces_to_pounds_hesaplamaOutput {
...
export const Ounces_to_pounds_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
