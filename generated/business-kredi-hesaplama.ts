// Auto-generated from business-kredi-hesaplama-schema.json
import * as z from 'zod';

export interface Business_kredi_hesaplamaInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Business_kredi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Business_kredi_hesaplamaInput): Record<string, number> {
...
export function calculateBusiness_kredi_hesaplama(input: Business_kredi_hesaplamaInput): Business_kredi_hesaplamaOutput {
...
export interface Business_kredi_hesaplamaOutput {
...
export const Business_kredi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
