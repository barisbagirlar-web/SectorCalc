// Auto-generated from amortisman-hesaplama-schema.json
import * as z from 'zod';

export interface Amortisman_hesaplamaInput {
  loanAmount: number;
  interestRate: number;
  dataConfidence?: number;
}

export const Amortisman_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Amortisman_hesaplamaInput): Record<string, number> {
...
export function calculateAmortisman_hesaplama(input: Amortisman_hesaplamaInput): Amortisman_hesaplamaOutput {
...
export interface Amortisman_hesaplamaOutput {
...
export const Amortisman_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
