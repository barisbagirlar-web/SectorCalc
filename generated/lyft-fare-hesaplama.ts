// Auto-generated from lyft-fare-hesaplama-schema.json
import * as z from 'zod';

export interface Lyft_fare_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Lyft_fare_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Lyft_fare_hesaplamaInput): Record<string, number> {
...
export function calculateLyft_fare_hesaplama(input: Lyft_fare_hesaplamaInput): Lyft_fare_hesaplamaOutput {
...
export interface Lyft_fare_hesaplamaOutput {
...
export const Lyft_fare_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
