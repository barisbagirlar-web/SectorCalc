// Auto-generated from cycling-ctl-hesaplama-schema.json
import * as z from 'zod';

export interface Cycling_ctl_hesaplamaInput {
  heartRate: number;
  exerciseDuration: number;
  dataConfidence?: number;
}

export const Cycling_ctl_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cycling_ctl_hesaplamaInput): Record<string, number> {
...
export function calculateCycling_ctl_hesaplama(input: Cycling_ctl_hesaplamaInput): Cycling_ctl_hesaplamaOutput {
...
export interface Cycling_ctl_hesaplamaOutput {
...
export const Cycling_ctl_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "bpm",
