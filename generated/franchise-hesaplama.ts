// Auto-generated from franchise-hesaplama-schema.json
import * as z from 'zod';

export interface Franchise_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Franchise_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Franchise_hesaplamaInput): Record<string, number> {
...
export function calculateFranchise_hesaplama(input: Franchise_hesaplamaInput): Franchise_hesaplamaOutput {
...
export interface Franchise_hesaplamaOutput {
...
export const Franchise_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
