// Auto-generated from rv-hesaplama-schema.json
import * as z from 'zod';

export interface Rv_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Rv_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Rv_hesaplamaInput): Record<string, number> {
...
export function calculateRv_hesaplama(input: Rv_hesaplamaInput): Rv_hesaplamaOutput {
...
export interface Rv_hesaplamaOutput {
...
export const Rv_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
