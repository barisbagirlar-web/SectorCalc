// Auto-generated from cbd-hesaplama-schema.json
import * as z from 'zod';

export interface Cbd_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Cbd_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cbd_hesaplamaInput): Record<string, number> {
...
export function calculateCbd_hesaplama(input: Cbd_hesaplamaInput): Cbd_hesaplamaOutput {
...
export interface Cbd_hesaplamaOutput {
...
export const Cbd_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
