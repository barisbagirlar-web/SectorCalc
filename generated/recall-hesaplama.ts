// Auto-generated from recall-hesaplama-schema.json
import * as z from 'zod';

export interface Recall_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Recall_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Recall_hesaplamaInput): Record<string, number> {
...
export function calculateRecall_hesaplama(input: Recall_hesaplamaInput): Recall_hesaplamaOutput {
...
export interface Recall_hesaplamaOutput {
...
export const Recall_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
