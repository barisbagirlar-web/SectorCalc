// Auto-generated from a-level-hesaplama-schema.json
import * as z from 'zod';

export interface A_level_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const A_level_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: A_level_hesaplamaInput): Record<string, number> {
...
export function calculateA_level_hesaplama(input: A_level_hesaplamaInput): A_level_hesaplamaOutput {
...
export interface A_level_hesaplamaOutput {
...
export const A_level_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
