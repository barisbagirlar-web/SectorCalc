// Auto-generated from pip-hesaplama-schema.json
import * as z from 'zod';

export interface Pip_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Pip_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pip_hesaplamaInput): Record<string, number> {
...
export function calculatePip_hesaplama(input: Pip_hesaplamaInput): Pip_hesaplamaOutput {
...
export interface Pip_hesaplamaOutput {
...
export const Pip_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
