// Auto-generated from interval-hesaplama-schema.json
import * as z from 'zod';

export interface Interval_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Interval_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Interval_hesaplamaInput): Record<string, number> {
...
export function calculateInterval_hesaplama(input: Interval_hesaplamaInput): Interval_hesaplamaOutput {
...
export interface Interval_hesaplamaOutput {
...
export const Interval_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
