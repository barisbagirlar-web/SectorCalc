// Auto-generated from beneish-m-score-hesaplama-schema.json
import * as z from 'zod';

export interface Beneish_m_score_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Beneish_m_score_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Beneish_m_score_hesaplamaInput): Record<string, number> {
...
export function calculateBeneish_m_score_hesaplama(input: Beneish_m_score_hesaplamaInput): Beneish_m_score_hesaplamaOutput {
...
export interface Beneish_m_score_hesaplamaOutput {
...
export const Beneish_m_score_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
