// Auto-generated from konut-kredisi-refinance-hesaplama-schema.json
import * as z from 'zod';

export interface Konut_kredisi_refinance_hesaplamaInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Konut_kredisi_refinance_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Konut_kredisi_refinance_hesaplamaInput): Record<string, number> {
...
export function calculateKonut_kredisi_refinance_hesaplama(input: Konut_kredisi_refinance_hesaplamaInput): Konut_kredisi_refinance_hesaplamaOutput {
...
export interface Konut_kredisi_refinance_hesaplamaOutput {
...
export const Konut_kredisi_refinance_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
