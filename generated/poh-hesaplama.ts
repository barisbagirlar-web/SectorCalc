// Auto-generated from poh-hesaplama-schema.json
import * as z from 'zod';

export interface Poh_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Poh_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Poh_hesaplamaInput): Record<string, number> {
...
export function calculatePoh_hesaplama(input: Poh_hesaplamaInput): Poh_hesaplamaOutput {
...
export interface Poh_hesaplamaOutput {
...
export const Poh_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
