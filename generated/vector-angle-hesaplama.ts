// Auto-generated from vector-angle-hesaplama-schema.json
import * as z from 'zod';

export interface Vector_angle_hesaplamaInput {
  matrixSize: number;
  matrixElement: number;
  dataConfidence?: number;
}

export const Vector_angle_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Vector_angle_hesaplamaInput): Record<string, number> {
...
export function calculateVector_angle_hesaplama(input: Vector_angle_hesaplamaInput): Vector_angle_hesaplamaOutput {
...
export interface Vector_angle_hesaplamaOutput {
...
export const Vector_angle_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
