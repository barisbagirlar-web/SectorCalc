// Auto-generated from lenzs-law-hesaplama-schema.json
import * as z from 'zod';

export interface Lenzs_law_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Lenzs_law_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Lenzs_law_hesaplamaInput): Record<string, number> {
...
export function calculateLenzs_law_hesaplama(input: Lenzs_law_hesaplamaInput): Lenzs_law_hesaplamaOutput {
...
export interface Lenzs_law_hesaplamaOutput {
...
export const Lenzs_law_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
