// Auto-generated from toefl-score-hesaplama-schema.json
import * as z from 'zod';

export interface Toefl_score_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Toefl_score_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Toefl_score_hesaplamaInput): Record<string, number> {
...
export function calculateToefl_score_hesaplama(input: Toefl_score_hesaplamaInput): Toefl_score_hesaplamaOutput {
...
export interface Toefl_score_hesaplamaOutput {
...
export const Toefl_score_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
