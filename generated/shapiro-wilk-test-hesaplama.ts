// Auto-generated from shapiro-wilk-test-hesaplama-schema.json
import * as z from 'zod';

export interface Shapiro_wilk_test_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Shapiro_wilk_test_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Shapiro_wilk_test_hesaplamaInput): Record<string, number> {
...
export function calculateShapiro_wilk_test_hesaplama(input: Shapiro_wilk_test_hesaplamaInput): Shapiro_wilk_test_hesaplamaOutput {
...
export interface Shapiro_wilk_test_hesaplamaOutput {
...
export const Shapiro_wilk_test_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
