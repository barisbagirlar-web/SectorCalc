// Auto-generated from met-hesaplama-schema.json
import * as z from 'zod';

export interface Met_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Met_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Met_hesaplamaInput): Record<string, number> {
...
export function calculateMet_hesaplama(input: Met_hesaplamaInput): Met_hesaplamaOutput {
...
export interface Met_hesaplamaOutput {
...
export const Met_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
