// Auto-generated from act-score-hesaplama-schema.json
import * as z from 'zod';

export interface Act_score_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Act_score_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Act_score_hesaplamaInput): Record<string, number> {
...
export function calculateAct_score_hesaplama(input: Act_score_hesaplamaInput): Act_score_hesaplamaOutput {
...
export interface Act_score_hesaplamaOutput {
...
export const Act_score_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
