// Auto-generated from forex-hesaplama-schema.json
import * as z from 'zod';

export interface Forex_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Forex_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Forex_hesaplamaInput): Record<string, number> {
...
export function calculateForex_hesaplama(input: Forex_hesaplamaInput): Forex_hesaplamaOutput {
...
export interface Forex_hesaplamaOutput {
...
export const Forex_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
