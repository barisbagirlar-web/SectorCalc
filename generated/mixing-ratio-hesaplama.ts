// Auto-generated from mixing-ratio-hesaplama-schema.json
import * as z from 'zod';

export interface Mixing_ratio_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Mixing_ratio_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Mixing_ratio_hesaplamaInput): Record<string, number> {
...
export function calculateMixing_ratio_hesaplama(input: Mixing_ratio_hesaplamaInput): Mixing_ratio_hesaplamaOutput {
...
export interface Mixing_ratio_hesaplamaOutput {
...
export const Mixing_ratio_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
