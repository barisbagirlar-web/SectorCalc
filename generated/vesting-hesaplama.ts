// Auto-generated from vesting-hesaplama-schema.json
import * as z from 'zod';

export interface Vesting_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Vesting_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Vesting_hesaplamaInput): Record<string, number> {
...
export function calculateVesting_hesaplama(input: Vesting_hesaplamaInput): Vesting_hesaplamaOutput {
...
export interface Vesting_hesaplamaOutput {
...
export const Vesting_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
