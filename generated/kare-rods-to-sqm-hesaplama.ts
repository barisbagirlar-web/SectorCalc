// Auto-generated from kare-rods-to-sqm-hesaplama-schema.json
import * as z from 'zod';

export interface Kare_rods_to_sqm_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Kare_rods_to_sqm_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Kare_rods_to_sqm_hesaplamaInput): Record<string, number> {
...
export function calculateKare_rods_to_sqm_hesaplama(input: Kare_rods_to_sqm_hesaplamaInput): Kare_rods_to_sqm_hesaplamaOutput {
...
export interface Kare_rods_to_sqm_hesaplamaOutput {
...
export const Kare_rods_to_sqm_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
