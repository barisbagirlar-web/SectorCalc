// Auto-generated from cycling-hesaplama-schema.json
import * as z from 'zod';

export interface Cycling_hesaplamaInput {
  heartRate: number;
  exerciseDuration: number;
  dataConfidence?: number;
}

export const Cycling_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cycling_hesaplamaInput): Record<string, number> {
...
export function calculateCycling_hesaplama(input: Cycling_hesaplamaInput): Cycling_hesaplamaOutput {
...
export interface Cycling_hesaplamaOutput {
...
export const Cycling_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "bpm",
