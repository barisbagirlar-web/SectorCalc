// Auto-generated from etf-hesaplama-schema.json
import * as z from 'zod';

export interface Etf_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Etf_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Etf_hesaplamaInput): Record<string, number> {
...
export function calculateEtf_hesaplama(input: Etf_hesaplamaInput): Etf_hesaplamaOutput {
...
export interface Etf_hesaplamaOutput {
...
export const Etf_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
