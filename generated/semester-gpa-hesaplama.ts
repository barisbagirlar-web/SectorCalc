// Auto-generated from semester-gpa-hesaplama-schema.json
import * as z from 'zod';

export interface Semester_gpa_hesaplamaInput {
  gradePoints: number;
  creditHours: number;
  dataConfidence?: number;
}

export const Semester_gpa_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Semester_gpa_hesaplamaInput): Record<string, number> {
...
export function calculateSemester_gpa_hesaplama(input: Semester_gpa_hesaplamaInput): Semester_gpa_hesaplamaOutput {
...
export interface Semester_gpa_hesaplamaOutput {
...
export const Semester_gpa_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "points",
