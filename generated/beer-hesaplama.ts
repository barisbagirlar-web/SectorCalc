// Auto-generated from beer-hesaplama-schema.json
import * as z from 'zod';

export interface Beer_hesaplamaInput {
  originalGravity: number;
  dataConfidence?: number;
}

export const Beer_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Beer_hesaplamaInput): Record<string, number> {
...
export function calculateBeer_hesaplama(input: Beer_hesaplamaInput): Beer_hesaplamaOutput {
...
export interface Beer_hesaplamaOutput {
...
export const Beer_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "SG",
