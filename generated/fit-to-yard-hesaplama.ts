// Auto-generated from fit-to-yard-hesaplama-schema.json
import * as z from 'zod';

export interface Fit_to_yard_hesaplamaInput {
  lengthValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Fit_to_yard_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Fit_to_yard_hesaplamaInput): Record<string, number> {
...
export function calculateFit_to_yard_hesaplama(input: Fit_to_yard_hesaplamaInput): Fit_to_yard_hesaplamaOutput {
...
export interface Fit_to_yard_hesaplamaOutput {
...
export const Fit_to_yard_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "m",
