// Auto-generated from akim-ratio-hesaplama-schema.json
import * as z from 'zod';

export interface Akim_ratio_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Akim_ratio_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Akim_ratio_hesaplamaInput): Record<string, number> {
...
export function calculateAkim_ratio_hesaplama(input: Akim_ratio_hesaplamaInput): Akim_ratio_hesaplamaOutput {
...
export interface Akim_ratio_hesaplamaOutput {
...
export const Akim_ratio_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
