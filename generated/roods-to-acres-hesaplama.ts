// Auto-generated from roods-to-acres-hesaplama-schema.json
import * as z from 'zod';

export interface Roods_to_acres_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Roods_to_acres_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Roods_to_acres_hesaplamaInput): Record<string, number> {
...
export function calculateRoods_to_acres_hesaplama(input: Roods_to_acres_hesaplamaInput): Roods_to_acres_hesaplamaOutput {
...
export interface Roods_to_acres_hesaplamaOutput {
...
export const Roods_to_acres_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
