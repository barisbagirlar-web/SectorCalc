// Auto-generated from apgar-score-hesaplama-schema.json
import * as z from 'zod';

export interface Apgar_score_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Apgar_score_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Apgar_score_hesaplamaInput): Record<string, number> {
...
export function calculateApgar_score_hesaplama(input: Apgar_score_hesaplamaInput): Apgar_score_hesaplamaOutput {
...
export interface Apgar_score_hesaplamaOutput {
...
export const Apgar_score_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
