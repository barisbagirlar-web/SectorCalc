// Auto-generated from ph-hesaplama-schema.json
import * as z from 'zod';

export interface Ph_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Ph_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ph_hesaplamaInput): Record<string, number> {
...
export function calculatePh_hesaplama(input: Ph_hesaplamaInput): Ph_hesaplamaOutput {
...
export interface Ph_hesaplamaOutput {
...
export const Ph_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
