// Auto-generated from dpi-hesaplama-schema.json
import * as z from 'zod';

export interface Dpi_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Dpi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Dpi_hesaplamaInput): Record<string, number> {
...
export function calculateDpi_hesaplama(input: Dpi_hesaplamaInput): Dpi_hesaplamaOutput {
...
export interface Dpi_hesaplamaOutput {
...
export const Dpi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
