// Auto-generated from dnd-stat-hesaplama-schema.json
import * as z from 'zod';

export interface Dnd_stat_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Dnd_stat_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Dnd_stat_hesaplamaInput): Record<string, number> {
...
export function calculateDnd_stat_hesaplama(input: Dnd_stat_hesaplamaInput): Dnd_stat_hesaplamaOutput {
...
export interface Dnd_stat_hesaplamaOutput {
...
export const Dnd_stat_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
