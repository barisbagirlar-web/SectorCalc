// Auto-generated from miles-to-fit-hesaplama-schema.json
import * as z from 'zod';

export interface Miles_to_fit_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Miles_to_fit_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Miles_to_fit_hesaplamaInput): Record<string, number> {
...
export function calculateMiles_to_fit_hesaplama(input: Miles_to_fit_hesaplamaInput): Miles_to_fit_hesaplamaOutput {
...
export interface Miles_to_fit_hesaplamaOutput {
...
export const Miles_to_fit_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
