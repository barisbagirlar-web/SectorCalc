// Auto-generated from guc-analysis-hesaplama-schema.json
import * as z from 'zod';

export interface Guc_analysis_hesaplamaInput {
  powerValue: number;
  timeDuration: number;
  dataConfidence?: number;
}

export const Guc_analysis_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Guc_analysis_hesaplamaInput): Record<string, number> {
...
export function calculateGuc_analysis_hesaplama(input: Guc_analysis_hesaplamaInput): Guc_analysis_hesaplamaOutput {
...
export interface Guc_analysis_hesaplamaOutput {
...
export const Guc_analysis_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "W",
