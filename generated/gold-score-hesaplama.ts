// Auto-generated from gold-score-hesaplama-schema.json
import * as z from 'zod';

export interface Gold_score_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Gold_score_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Gold_score_hesaplamaInput): Record<string, number> {
...
export function calculateGold_score_hesaplama(input: Gold_score_hesaplamaInput): Gold_score_hesaplamaOutput {
...
export interface Gold_score_hesaplamaOutput {
...
export const Gold_score_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
