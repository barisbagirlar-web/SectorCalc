// Auto-generated from molality-hesaplama-schema.json
import * as z from 'zod';

export interface Molality_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Molality_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Molality_hesaplamaInput): Record<string, number> {
...
export function calculateMolality_hesaplama(input: Molality_hesaplamaInput): Molality_hesaplamaOutput {
...
export interface Molality_hesaplamaOutput {
...
export const Molality_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
