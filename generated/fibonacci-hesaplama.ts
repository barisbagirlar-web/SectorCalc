// Auto-generated from fibonacci-hesaplama-schema.json
import * as z from 'zod';

export interface Fibonacci_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Fibonacci_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Fibonacci_hesaplamaInput): Record<string, number> {
...
export function calculateFibonacci_hesaplama(input: Fibonacci_hesaplamaInput): Fibonacci_hesaplamaOutput {
...
export interface Fibonacci_hesaplamaOutput {
...
export const Fibonacci_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
