// Auto-generated from one-sample-t-test-hesaplama-schema.json
import * as z from 'zod';

export interface One_sample_t_test_hesaplamaInput {
  sampleMean: number;
  standardDeviation: number;
  dataConfidence?: number;
}

export const One_sample_t_test_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: One_sample_t_test_hesaplamaInput): Record<string, number> {
...
export function calculateOne_sample_t_test_hesaplama(input: One_sample_t_test_hesaplamaInput): One_sample_t_test_hesaplamaOutput {
...
export interface One_sample_t_test_hesaplamaOutput {
...
export const One_sample_t_test_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
