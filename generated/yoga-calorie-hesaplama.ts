// Auto-generated from yoga-calorie-hesaplama-schema.json
import * as z from 'zod';

export interface Yoga_calorie_hesaplamaInput {
  bodyWeight: number;
  activityLevel: number;
  dataConfidence?: number;
}

export const Yoga_calorie_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Yoga_calorie_hesaplamaInput): Record<string, number> {
...
export function calculateYoga_calorie_hesaplama(input: Yoga_calorie_hesaplamaInput): Yoga_calorie_hesaplamaOutput {
...
export interface Yoga_calorie_hesaplamaOutput {
...
export const Yoga_calorie_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "kg",
