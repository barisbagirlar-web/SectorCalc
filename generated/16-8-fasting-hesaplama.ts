// Auto-generated from 16-8-fasting-hesaplama-schema.json
import * as z from 'zod';

export interface _16_8_fasting_hesaplamaInput {
  dailyCalories: number;
  bodyMass: number;
  dataConfidence?: number;
}

export const _16_8_fasting_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: _16_8_fasting_hesaplamaInput): Record<string, number> {
...
export function calculate_16_8_fasting_hesaplama(input: _16_8_fasting_hesaplamaInput): _16_8_fasting_hesaplamaOutput {
...
export interface _16_8_fasting_hesaplamaOutput {
...
export const _16_8_fasting_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "kcal",
