// Auto-generated from number-to-words-hesaplama-schema.json
import * as z from 'zod';

export interface Number_to_words_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Number_to_words_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Number_to_words_hesaplamaInput): Record<string, number> {
...
export function calculateNumber_to_words_hesaplama(input: Number_to_words_hesaplamaInput): Number_to_words_hesaplamaOutput {
...
export interface Number_to_words_hesaplamaOutput {
...
export const Number_to_words_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
