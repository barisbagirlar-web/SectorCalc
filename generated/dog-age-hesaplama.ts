// Auto-generated from dog-age-hesaplama-schema.json
import * as z from 'zod';

export interface Dog_age_hesaplamaInput {
  petAge: number;
  petWeight: number;
  dataConfidence?: number;
}

export const Dog_age_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Dog_age_hesaplamaInput): Record<string, number> {
...
export function calculateDog_age_hesaplama(input: Dog_age_hesaplamaInput): Dog_age_hesaplamaOutput {
...
export interface Dog_age_hesaplamaOutput {
...
export const Dog_age_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "years",
