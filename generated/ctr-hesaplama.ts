// Auto-generated from ctr-hesaplama-schema.json
import * as z from 'zod';

export interface Ctr_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Ctr_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ctr_hesaplamaInput): Record<string, number> {
...
export function calculateCtr_hesaplama(input: Ctr_hesaplamaInput): Ctr_hesaplamaOutput {
...
export interface Ctr_hesaplamaOutput {
...
export const Ctr_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
