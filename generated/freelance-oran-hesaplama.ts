// Auto-generated from freelance-oran-hesaplama-schema.json
import * as z from 'zod';

export interface Freelance_oran_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Freelance_oran_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Freelance_oran_hesaplamaInput): Record<string, number> {
...
export function calculateFreelance_oran_hesaplama(input: Freelance_oran_hesaplamaInput): Freelance_oran_hesaplamaOutput {
...
export interface Freelance_oran_hesaplamaOutput {
...
export const Freelance_oran_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
