// Auto-generated from odds-ratio-hesaplama-schema.json
import * as z from 'zod';

export interface Odds_ratio_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Odds_ratio_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Odds_ratio_hesaplamaInput): Record<string, number> {
...
export function calculateOdds_ratio_hesaplama(input: Odds_ratio_hesaplamaInput): Odds_ratio_hesaplamaOutput {
...
export interface Odds_ratio_hesaplamaOutput {
...
export const Odds_ratio_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
