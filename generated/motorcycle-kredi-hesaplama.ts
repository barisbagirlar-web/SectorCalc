// Auto-generated from motorcycle-kredi-hesaplama-schema.json
import * as z from 'zod';

export interface Motorcycle_kredi_hesaplamaInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Motorcycle_kredi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Motorcycle_kredi_hesaplamaInput): Record<string, number> {
...
export function calculateMotorcycle_kredi_hesaplama(input: Motorcycle_kredi_hesaplamaInput): Motorcycle_kredi_hesaplamaOutput {
...
export interface Motorcycle_kredi_hesaplamaOutput {
...
export const Motorcycle_kredi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
