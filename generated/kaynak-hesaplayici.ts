// Auto-generated from kaynak-hesaplayici-schema.json
import * as z from 'zod';

export interface Kaynak_hesaplayiciInput {
  materialStrength: number;
  dataConfidence?: number;
}

export const Kaynak_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Kaynak_hesaplayiciInput): Record<string, number> {
...
export function calculateKaynak_hesaplayici(input: Kaynak_hesaplayiciInput): Kaynak_hesaplayiciOutput {
...
export interface Kaynak_hesaplayiciOutput {
...
export const Kaynak_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "MPa",
