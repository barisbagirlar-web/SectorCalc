// Auto-generated from roic-hesaplama-schema.json
import * as z from 'zod';

export interface Roic_hesaplamaInput {
  principal: number;
  rate: number;
  periods: number;
...
export const Roic_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Roic_hesaplamaInput): Record<string, number> {
...
export function calculateRoic_hesaplama(input: Roic_hesaplamaInput): Roic_hesaplamaOutput {
...
export interface Roic_hesaplamaOutput {
...
export const Roic_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
