// Auto-generated from grm-hesaplayici-schema.json
import * as z from 'zod';

export interface Grm_hesaplayiciInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Grm_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Grm_hesaplayiciInput): Record<string, number> {
...
export function calculateGrm_hesaplayici(input: Grm_hesaplayiciInput): Grm_hesaplayiciOutput {
...
export interface Grm_hesaplayiciOutput {
...
export const Grm_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "",
