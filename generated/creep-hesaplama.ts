// Auto-generated from creep-hesaplama-schema.json
import * as z from 'zod';

export interface Creep_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Creep_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Creep_hesaplamaInput): Record<string, number> {
...
export function calculateCreep_hesaplama(input: Creep_hesaplamaInput): Creep_hesaplamaOutput {
...
export interface Creep_hesaplamaOutput {
...
export const Creep_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
