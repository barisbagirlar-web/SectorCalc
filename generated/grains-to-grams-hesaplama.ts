// Auto-generated from grains-to-grams-hesaplama-schema.json
import * as z from 'zod';

export interface Grains_to_grams_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Grains_to_grams_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Grains_to_grams_hesaplamaInput): Record<string, number> {
...
export function calculateGrains_to_grams_hesaplama(input: Grains_to_grams_hesaplamaInput): Grains_to_grams_hesaplamaOutput {
...
export interface Grains_to_grams_hesaplamaOutput {
...
export const Grains_to_grams_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
