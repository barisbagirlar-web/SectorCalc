// Auto-generated from net-carb-hesaplama-schema.json
import * as z from 'zod';

export interface Net_carb_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Net_carb_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Net_carb_hesaplamaInput): Record<string, number> {
...
export function calculateNet_carb_hesaplama(input: Net_carb_hesaplamaInput): Net_carb_hesaplamaOutput {
...
export interface Net_carb_hesaplamaOutput {
...
export const Net_carb_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
