// Auto-generated from blackjack-hesaplama-schema.json
import * as z from 'zod';

export interface Blackjack_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Blackjack_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Blackjack_hesaplamaInput): Record<string, number> {
...
export function calculateBlackjack_hesaplama(input: Blackjack_hesaplamaInput): Blackjack_hesaplamaOutput {
...
export interface Blackjack_hesaplamaOutput {
...
export const Blackjack_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
