// Auto-generated from mirr-hesaplama-schema.json
import * as z from 'zod';

export interface Mirr_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Mirr_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Mirr_hesaplamaInput): Record<string, number> {
...
export function calculateMirr_hesaplama(input: Mirr_hesaplamaInput): Mirr_hesaplamaOutput {
...
export interface Mirr_hesaplamaOutput {
...
export const Mirr_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
