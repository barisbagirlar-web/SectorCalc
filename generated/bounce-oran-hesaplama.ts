// Auto-generated from bounce-oran-hesaplama-schema.json
import * as z from 'zod';

export interface Bounce_oran_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Bounce_oran_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Bounce_oran_hesaplamaInput): Record<string, number> {
...
export function calculateBounce_oran_hesaplama(input: Bounce_oran_hesaplamaInput): Bounce_oran_hesaplamaOutput {
...
export interface Bounce_oran_hesaplamaOutput {
...
export const Bounce_oran_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
