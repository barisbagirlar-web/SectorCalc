// Auto-generated from buffet-hesaplama-schema.json
import * as z from 'zod';

export interface Buffet_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Buffet_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Buffet_hesaplamaInput): Record<string, number> {
...
export function calculateBuffet_hesaplama(input: Buffet_hesaplamaInput): Buffet_hesaplamaOutput {
...
export interface Buffet_hesaplamaOutput {
...
export const Buffet_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
