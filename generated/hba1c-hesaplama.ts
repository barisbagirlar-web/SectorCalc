// Auto-generated from hba1c-hesaplama-schema.json
import * as z from 'zod';

export interface Hba1c_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Hba1c_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Hba1c_hesaplamaInput): Record<string, number> {
...
export function calculateHba1c_hesaplama(input: Hba1c_hesaplamaInput): Hba1c_hesaplamaOutput {
...
export interface Hba1c_hesaplamaOutput {
...
export const Hba1c_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
