// Auto-generated from stain-hesaplama-schema.json
import * as z from 'zod';

export interface Stain_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Stain_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Stain_hesaplamaInput): Record<string, number> {
...
export function calculateStain_hesaplama(input: Stain_hesaplamaInput): Stain_hesaplamaOutput {
...
export interface Stain_hesaplamaOutput {
...
export const Stain_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
