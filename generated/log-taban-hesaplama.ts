// Auto-generated from log-taban-hesaplama-schema.json
import * as z from 'zod';

export interface Log_taban_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Log_taban_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Log_taban_hesaplamaInput): Record<string, number> {
...
export function calculateLog_taban_hesaplama(input: Log_taban_hesaplamaInput): Log_taban_hesaplamaOutput {
...
export interface Log_taban_hesaplamaOutput {
...
export const Log_taban_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
