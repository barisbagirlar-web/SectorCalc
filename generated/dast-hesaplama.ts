// Auto-generated from dast-hesaplama-schema.json
import * as z from 'zod';

export interface Dast_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Dast_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Dast_hesaplamaInput): Record<string, number> {
...
export function calculateDast_hesaplama(input: Dast_hesaplamaInput): Dast_hesaplamaOutput {
...
export interface Dast_hesaplamaOutput {
...
export const Dast_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
