// Auto-generated from net-bugunku-deger-npv-hesaplama-schema.json
import * as z from 'zod';

export interface Net_bugunku_deger_npv_hesaplamaInput {
  nakit1: number;
  nakit2: number;
  nakit3: number;
  nakit4: number;
...
export const Net_bugunku_deger_npv_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Net_bugunku_deger_npv_hesaplamaInput): Record<string, number> {
...
export function calculateNet_bugunku_deger_npv_hesaplama(input: Net_bugunku_deger_npv_hesaplamaInput): Net_bugunku_deger_npv_hesaplamaOutput {
...
export interface Net_bugunku_deger_npv_hesaplamaOutput {
...
export const Net_bugunku_deger_npv_hesaplamaOutputMeta = {
  primaryKey: "sonuc",
  unit: "TRY",
  breakdownKeys: ["sonuc"],
} as const;
