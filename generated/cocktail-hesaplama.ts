// Auto-generated from cocktail-hesaplama-schema.json
import * as z from 'zod';

export interface Cocktail_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Cocktail_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cocktail_hesaplamaInput): Record<string, number> {
...
export function calculateCocktail_hesaplama(input: Cocktail_hesaplamaInput): Cocktail_hesaplamaOutput {
...
export interface Cocktail_hesaplamaOutput {
...
export const Cocktail_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
