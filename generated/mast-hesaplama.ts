// Auto-generated from mast-hesaplama-schema.json
import * as z from 'zod';

export interface Mast_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Mast_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Mast_hesaplamaInput): Record<string, number> {
...
export function calculateMast_hesaplama(input: Mast_hesaplamaInput): Mast_hesaplamaOutput {
...
export interface Mast_hesaplamaOutput {
...
export const Mast_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
