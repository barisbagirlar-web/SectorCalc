// Auto-generated from absorbed-dose-donusturucu-schema.json
import * as z from 'zod';

export interface Absorbed_dose_donusturucuInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Absorbed_dose_donusturucuInputSchema = z.object({
...
function evaluateAllFormulas(input: Absorbed_dose_donusturucuInput): Record<string, number> {
...
export function calculateAbsorbed_dose_donusturucu(input: Absorbed_dose_donusturucuInput): Absorbed_dose_donusturucuOutput {
...
export interface Absorbed_dose_donusturucuOutput {
...
export const Absorbed_dose_donusturucuOutputMeta = {
  primaryKey: "result",
  unit: "",
