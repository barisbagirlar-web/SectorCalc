// Auto-generated from kredi-affordability-hesaplama-schema.json
import * as z from 'zod';

export interface Kredi_affordability_hesaplamaInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Kredi_affordability_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Kredi_affordability_hesaplamaInput): Record<string, number> {
...
export function calculateKredi_affordability_hesaplama(input: Kredi_affordability_hesaplamaInput): Kredi_affordability_hesaplamaOutput {
...
export interface Kredi_affordability_hesaplamaOutput {
...
export const Kredi_affordability_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
