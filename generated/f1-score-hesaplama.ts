// Auto-generated from f1-score-hesaplama-schema.json
import * as z from 'zod';

export interface F1_score_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const F1_score_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: F1_score_hesaplamaInput): Record<string, number> {
...
export function calculateF1_score_hesaplama(input: F1_score_hesaplamaInput): F1_score_hesaplamaOutput {
...
export interface F1_score_hesaplamaOutput {
...
export const F1_score_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
