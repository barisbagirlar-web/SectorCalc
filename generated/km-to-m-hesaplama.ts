// Auto-generated from km-to-m-hesaplama-schema.json
import * as z from 'zod';

export interface Km_to_m_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Km_to_m_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Km_to_m_hesaplamaInput): Record<string, number> {
...
export function calculateKm_to_m_hesaplama(input: Km_to_m_hesaplamaInput): Km_to_m_hesaplamaOutput {
...
export interface Km_to_m_hesaplamaOutput {
...
export const Km_to_m_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
