// Auto-generated from culvert-hesaplama-schema.json
import * as z from 'zod';

export interface Culvert_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Culvert_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Culvert_hesaplamaInput): Record<string, number> {
...
export function calculateCulvert_hesaplama(input: Culvert_hesaplamaInput): Culvert_hesaplamaOutput {
...
export interface Culvert_hesaplamaOutput {
...
export const Culvert_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
