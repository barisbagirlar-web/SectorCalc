// Auto-generated from spackle-hesaplama-schema.json
import * as z from 'zod';

export interface Spackle_hesaplamaInput {
  skinTypeScore: number;
  dataConfidence?: number;
}

export const Spackle_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Spackle_hesaplamaInput): Record<string, number> {
...
export function calculateSpackle_hesaplama(input: Spackle_hesaplamaInput): Spackle_hesaplamaOutput {
...
export interface Spackle_hesaplamaOutput {
...
export const Spackle_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "points",
