// Auto-generated from cap-table-hesaplama-schema.json
import * as z from 'zod';

export interface Cap_table_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Cap_table_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cap_table_hesaplamaInput): Record<string, number> {
...
export function calculateCap_table_hesaplama(input: Cap_table_hesaplamaInput): Cap_table_hesaplamaOutput {
...
export interface Cap_table_hesaplamaOutput {
...
export const Cap_table_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
