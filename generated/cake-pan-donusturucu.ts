// Auto-generated from cake-pan-donusturucu-schema.json
import * as z from 'zod';

export interface Cake_pan_donusturucuInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Cake_pan_donusturucuInputSchema = z.object({
...
function evaluateAllFormulas(input: Cake_pan_donusturucuInput): Record<string, number> {
...
export function calculateCake_pan_donusturucu(input: Cake_pan_donusturucuInput): Cake_pan_donusturucuOutput {
...
export interface Cake_pan_donusturucuOutput {
...
export const Cake_pan_donusturucuOutputMeta = {
  primaryKey: "result",
  unit: "",
