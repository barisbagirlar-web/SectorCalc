// Auto-generated from card-probability-hesaplama-schema.json
import * as z from 'zod';

export interface Card_probability_hesaplamaInput {
  sampleMean: number;
  standardDeviation: number;
  dataConfidence?: number;
}

export const Card_probability_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Card_probability_hesaplamaInput): Record<string, number> {
...
export function calculateCard_probability_hesaplama(input: Card_probability_hesaplamaInput): Card_probability_hesaplamaOutput {
...
export interface Card_probability_hesaplamaOutput {
...
export const Card_probability_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
