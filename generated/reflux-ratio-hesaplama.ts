// Auto-generated from reflux-ratio-hesaplama-schema.json
import * as z from 'zod';

export interface Reflux_ratio_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Reflux_ratio_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Reflux_ratio_hesaplamaInput): Record<string, number> {
...
export function calculateReflux_ratio_hesaplama(input: Reflux_ratio_hesaplamaInput): Reflux_ratio_hesaplamaOutput {
...
export interface Reflux_ratio_hesaplamaOutput {
...
export const Reflux_ratio_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
