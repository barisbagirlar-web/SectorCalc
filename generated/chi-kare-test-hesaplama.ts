// Auto-generated from chi-kare-test-hesaplama-schema.json
import * as z from 'zod';

export interface Chi_kare_test_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Chi_kare_test_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Chi_kare_test_hesaplamaInput): Record<string, number> {
...
export function calculateChi_kare_test_hesaplama(input: Chi_kare_test_hesaplamaInput): Chi_kare_test_hesaplamaOutput {
...
export interface Chi_kare_test_hesaplamaOutput {
...
export const Chi_kare_test_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
