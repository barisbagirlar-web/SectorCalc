// Auto-generated from cpa-hesaplama-schema.json
import * as z from 'zod';

export interface Cpa_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Cpa_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cpa_hesaplamaInput): Record<string, number> {
...
export function calculateCpa_hesaplama(input: Cpa_hesaplamaInput): Cpa_hesaplamaOutput {
...
export interface Cpa_hesaplamaOutput {
...
export const Cpa_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
