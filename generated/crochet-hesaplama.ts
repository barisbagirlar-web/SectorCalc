// Auto-generated from crochet-hesaplama-schema.json
import * as z from 'zod';

export interface Crochet_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Crochet_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Crochet_hesaplamaInput): Record<string, number> {
...
export function calculateCrochet_hesaplama(input: Crochet_hesaplamaInput): Crochet_hesaplamaOutput {
...
export interface Crochet_hesaplamaOutput {
...
export const Crochet_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
