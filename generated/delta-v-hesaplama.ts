// Auto-generated from delta-v-hesaplama-schema.json
import * as z from 'zod';

export interface Delta_v_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Delta_v_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Delta_v_hesaplamaInput): Record<string, number> {
...
export function calculateDelta_v_hesaplama(input: Delta_v_hesaplamaInput): Delta_v_hesaplamaOutput {
...
export interface Delta_v_hesaplamaOutput {
...
export const Delta_v_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
