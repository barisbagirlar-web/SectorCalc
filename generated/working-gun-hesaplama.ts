// Auto-generated from working-gun-hesaplama-schema.json
import * as z from 'zod';

export interface Working_gun_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Working_gun_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Working_gun_hesaplamaInput): Record<string, number> {
...
export function calculateWorking_gun_hesaplama(input: Working_gun_hesaplamaInput): Working_gun_hesaplamaOutput {
...
export interface Working_gun_hesaplamaOutput {
...
export const Working_gun_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
