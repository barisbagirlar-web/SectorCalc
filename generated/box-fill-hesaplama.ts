// Auto-generated from box-fill-hesaplama-schema.json
import * as z from 'zod';

export interface Box_fill_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Box_fill_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Box_fill_hesaplamaInput): Record<string, number> {
...
export function calculateBox_fill_hesaplama(input: Box_fill_hesaplamaInput): Box_fill_hesaplamaOutput {
...
export interface Box_fill_hesaplamaOutput {
...
export const Box_fill_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
