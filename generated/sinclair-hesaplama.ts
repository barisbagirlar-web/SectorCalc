// Auto-generated from sinclair-hesaplama-schema.json
import * as z from 'zod';

export interface Sinclair_hesaplamaInput {
  airTemperature: number;
  relativeHumidity: number;
  dataConfidence?: number;
}

export const Sinclair_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Sinclair_hesaplamaInput): Record<string, number> {
...
export function calculateSinclair_hesaplama(input: Sinclair_hesaplamaInput): Sinclair_hesaplamaOutput {
...
export interface Sinclair_hesaplamaOutput {
...
export const Sinclair_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "°C",
