// Auto-generated from bevel-gear-hesaplama-schema.json
import * as z from 'zod';

export interface Bevel_gear_hesaplamaInput {
  materialStrength: number;
  dataConfidence?: number;
}

export const Bevel_gear_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Bevel_gear_hesaplamaInput): Record<string, number> {
...
export function calculateBevel_gear_hesaplama(input: Bevel_gear_hesaplamaInput): Bevel_gear_hesaplamaOutput {
...
export interface Bevel_gear_hesaplamaOutput {
...
export const Bevel_gear_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "MPa",
