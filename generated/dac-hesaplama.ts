// Auto-generated from dac-hesaplama-schema.json
import * as z from 'zod';

export interface Dac_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Dac_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Dac_hesaplamaInput): Record<string, number> {
...
export function calculateDac_hesaplama(input: Dac_hesaplamaInput): Dac_hesaplamaOutput {
...
export interface Dac_hesaplamaOutput {
...
export const Dac_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
