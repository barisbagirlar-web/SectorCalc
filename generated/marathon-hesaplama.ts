// Auto-generated from marathon-hesaplama-schema.json
import * as z from 'zod';

export interface Marathon_hesaplamaInput {
  distanceKm: number;
  durationMin: number;
  dataConfidence?: number;
}

export const Marathon_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Marathon_hesaplamaInput): Record<string, number> {
...
export function calculateMarathon_hesaplama(input: Marathon_hesaplamaInput): Marathon_hesaplamaOutput {
...
export interface Marathon_hesaplamaOutput {
...
export const Marathon_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "km",
