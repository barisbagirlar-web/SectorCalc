// Auto-generated from bbq-hesaplama-schema.json
import * as z from 'zod';

export interface Bbq_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Bbq_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Bbq_hesaplamaInput): Record<string, number> {
...
export function calculateBbq_hesaplama(input: Bbq_hesaplamaInput): Bbq_hesaplamaOutput {
...
export interface Bbq_hesaplamaOutput {
...
export const Bbq_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
