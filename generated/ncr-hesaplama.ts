// Auto-generated from ncr-hesaplama-schema.json
import * as z from 'zod';

export interface Ncr_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Ncr_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ncr_hesaplamaInput): Record<string, number> {
...
export function calculateNcr_hesaplama(input: Ncr_hesaplamaInput): Ncr_hesaplamaOutput {
...
export interface Ncr_hesaplamaOutput {
...
export const Ncr_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
