// Auto-generated from yo-yo-diet-hesaplama-schema.json
import * as z from 'zod';

export interface Yo_yo_diet_hesaplamaInput {
  dailyCalories: number;
  bodyMass: number;
  dataConfidence?: number;
}

export const Yo_yo_diet_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Yo_yo_diet_hesaplamaInput): Record<string, number> {
...
export function calculateYo_yo_diet_hesaplama(input: Yo_yo_diet_hesaplamaInput): Yo_yo_diet_hesaplamaOutput {
...
export interface Yo_yo_diet_hesaplamaOutput {
...
export const Yo_yo_diet_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "kcal",
