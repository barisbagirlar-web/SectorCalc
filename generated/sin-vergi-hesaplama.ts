// Auto-generated from sin-vergi-hesaplama-schema.json
import * as z from 'zod';

export interface Sin_vergi_hesaplamaInput {
  income: number;
  deductions: number;
  taxRate: number;
...
export const Sin_vergi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Sin_vergi_hesaplamaInput): Record<string, number> {
...
export function calculateSin_vergi_hesaplama(input: Sin_vergi_hesaplamaInput): Sin_vergi_hesaplamaOutput {
...
export interface Sin_vergi_hesaplamaOutput {
...
export const Sin_vergi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
