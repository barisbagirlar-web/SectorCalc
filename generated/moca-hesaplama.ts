// Auto-generated from moca-hesaplama-schema.json
import * as z from 'zod';

export interface Moca_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Moca_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Moca_hesaplamaInput): Record<string, number> {
...
export function calculateMoca_hesaplama(input: Moca_hesaplamaInput): Moca_hesaplamaOutput {
...
export interface Moca_hesaplamaOutput {
...
export const Moca_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
