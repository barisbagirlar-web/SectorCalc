// Auto-generated from va-kredi-hesaplama-schema.json
import * as z from 'zod';

export interface Va_kredi_hesaplamaInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Va_kredi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Va_kredi_hesaplamaInput): Record<string, number> {
...
export function calculateVa_kredi_hesaplama(input: Va_kredi_hesaplamaInput): Va_kredi_hesaplamaOutput {
...
export interface Va_kredi_hesaplamaOutput {
...
export const Va_kredi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
