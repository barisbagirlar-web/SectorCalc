...
export function calculateHvac_size_calculator(input: Hvac_size_calculatorInput): Hvac_size_calculatorOutput {
  ...
  const totalWasteCost = values["required_cooling_capacity_kw"] ?? 0;
  const breakdown = {
