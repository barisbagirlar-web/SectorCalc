// Auto-generated from decimal-odds-hesaplama-schema.json
import * as z from 'zod';

export interface Decimal_odds_hesaplamaInput {
  numerator: number;
  denominator: number;
  dataConfidence?: number;
}

export const Decimal_odds_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Decimal_odds_hesaplamaInput): Record<string, number> {
...
export function calculateDecimal_odds_hesaplama(input: Decimal_odds_hesaplamaInput): Decimal_odds_hesaplamaOutput {
...
export interface Decimal_odds_hesaplamaOutput {
...
export const Decimal_odds_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
