// Auto-generated from tuition-hesaplama-schema.json
import * as z from 'zod';

export interface Tuition_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Tuition_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Tuition_hesaplamaInput): Record<string, number> {
...
export function calculateTuition_hesaplama(input: Tuition_hesaplamaInput): Tuition_hesaplamaOutput {
...
export interface Tuition_hesaplamaOutput {
...
export const Tuition_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
