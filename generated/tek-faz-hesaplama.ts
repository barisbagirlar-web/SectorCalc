// Auto-generated from tek-faz-hesaplama-schema.json
import * as z from 'zod';

export interface Tek_faz_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Tek_faz_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Tek_faz_hesaplamaInput): Record<string, number> {
...
export function calculateTek_faz_hesaplama(input: Tek_faz_hesaplamaInput): Tek_faz_hesaplamaOutput {
...
export interface Tek_faz_hesaplamaOutput {
...
export const Tek_faz_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
