// Auto-generated from dat-score-hesaplama-schema.json
import * as z from 'zod';

export interface Dat_score_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Dat_score_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Dat_score_hesaplamaInput): Record<string, number> {
...
export function calculateDat_score_hesaplama(input: Dat_score_hesaplamaInput): Dat_score_hesaplamaOutput {
...
export interface Dat_score_hesaplamaOutput {
...
export const Dat_score_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
