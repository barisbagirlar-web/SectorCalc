// Auto-generated from round-hesaplama-schema.json
import * as z from 'zod';

export interface Round_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Round_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Round_hesaplamaInput): Record<string, number> {
...
export function calculateRound_hesaplama(input: Round_hesaplamaInput): Round_hesaplamaOutput {
...
export interface Round_hesaplamaOutput {
...
export const Round_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
