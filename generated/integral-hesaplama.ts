// Auto-generated from integral-hesaplama-schema.json
import * as z from 'zod';

export interface Integral_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Integral_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Integral_hesaplamaInput): Record<string, number> {
...
export function calculateIntegral_hesaplama(input: Integral_hesaplamaInput): Integral_hesaplamaOutput {
...
export interface Integral_hesaplamaOutput {
...
export const Integral_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
