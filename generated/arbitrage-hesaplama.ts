// Auto-generated from arbitrage-hesaplama-schema.json
import * as z from 'zod';

export interface Arbitrage_hesaplamaInput {
  birthDate: number;
  referenceDate: number;
  dataConfidence?: number;
}

export const Arbitrage_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Arbitrage_hesaplamaInput): Record<string, number> {
...
export function calculateArbitrage_hesaplama(input: Arbitrage_hesaplamaInput): Arbitrage_hesaplamaOutput {
...
export interface Arbitrage_hesaplamaOutput {
...
export const Arbitrage_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "date",
