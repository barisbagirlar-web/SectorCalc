// Auto-generated from cfm-hesaplama-schema.json
import * as z from 'zod';

export interface Cfm_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Cfm_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cfm_hesaplamaInput): Record<string, number> {
...
export function calculateCfm_hesaplama(input: Cfm_hesaplamaInput): Cfm_hesaplamaOutput {
...
export interface Cfm_hesaplamaOutput {
...
export const Cfm_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
