// Auto-generated from ev-ebitda-hesaplama-schema.json
import * as z from 'zod';

export interface Ev_ebitda_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Ev_ebitda_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ev_ebitda_hesaplamaInput): Record<string, number> {
...
export function calculateEv_ebitda_hesaplama(input: Ev_ebitda_hesaplamaInput): Ev_ebitda_hesaplamaOutput {
...
export interface Ev_ebitda_hesaplamaOutput {
...
export const Ev_ebitda_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
