// Auto-generated from drink-hesaplama-schema.json
import * as z from 'zod';

export interface Drink_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Drink_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Drink_hesaplamaInput): Record<string, number> {
...
export function calculateDrink_hesaplama(input: Drink_hesaplamaInput): Drink_hesaplamaOutput {
...
export interface Drink_hesaplamaOutput {
...
export const Drink_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
