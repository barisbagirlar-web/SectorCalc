// Auto-generated from number-taban-donusturucu-schema.json
import * as z from 'zod';

export interface Number_taban_donusturucuInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Number_taban_donusturucuInputSchema = z.object({
...
function evaluateAllFormulas(input: Number_taban_donusturucuInput): Record<string, number> {
...
export function calculateNumber_taban_donusturucu(input: Number_taban_donusturucuInput): Number_taban_donusturucuOutput {
...
export interface Number_taban_donusturucuOutput {
...
export const Number_taban_donusturucuOutputMeta = {
  primaryKey: "result",
  unit: "",
