// Auto-generated from gcs-hesaplama-schema.json
import * as z from 'zod';

export interface Gcs_hesaplamaInput {
  assessmentScore: number;
  param2: number;
  dataConfidence?: number;
}

export const Gcs_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Gcs_hesaplamaInput): Record<string, number> {
...
export function calculateGcs_hesaplama(input: Gcs_hesaplamaInput): Gcs_hesaplamaOutput {
...
export interface Gcs_hesaplamaOutput {
...
export const Gcs_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "points",
