// Auto-generated from hindi-hesaplayici-schema.json
import * as z from 'zod';

export interface Hindi_hesaplayiciInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Hindi_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Hindi_hesaplayiciInput): Record<string, number> {
...
export function calculateHindi_hesaplayici(input: Hindi_hesaplayiciInput): Hindi_hesaplayiciOutput {
...
export interface Hindi_hesaplayiciOutput {
...
export const Hindi_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "",
