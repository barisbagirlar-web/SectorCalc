// Auto-generated from hat-boyut-hesaplama-schema.json
import * as z from 'zod';

export interface Hat_boyut_hesaplamaInput {
  lengthValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Hat_boyut_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Hat_boyut_hesaplamaInput): Record<string, number> {
...
export function calculateHat_boyut_hesaplama(input: Hat_boyut_hesaplamaInput): Hat_boyut_hesaplamaOutput {
...
export interface Hat_boyut_hesaplamaOutput {
...
export const Hat_boyut_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "m",
