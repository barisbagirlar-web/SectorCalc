// Auto-generated from skin-type-hesaplama-schema.json
import * as z from 'zod';

export interface Skin_type_hesaplamaInput {
  skinTypeScore: number;
  treatmentIntensity: number;
  dataConfidence?: number;
}

export const Skin_type_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Skin_type_hesaplamaInput): Record<string, number> {
...
export function calculateSkin_type_hesaplama(input: Skin_type_hesaplamaInput): Skin_type_hesaplamaOutput {
...
export interface Skin_type_hesaplamaOutput {
...
export const Skin_type_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "points",
