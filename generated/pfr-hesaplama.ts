// Auto-generated from pfr-hesaplama-schema.json
import * as z from 'zod';

export interface Pfr_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Pfr_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pfr_hesaplamaInput): Record<string, number> {
...
export function calculatePfr_hesaplama(input: Pfr_hesaplamaInput): Pfr_hesaplamaOutput {
...
export interface Pfr_hesaplamaOutput {
...
export const Pfr_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
