// Auto-generated from weekdays-hesaplama-schema.json
import * as z from 'zod';

export interface Weekdays_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Weekdays_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Weekdays_hesaplamaInput): Record<string, number> {
...
export function calculateWeekdays_hesaplama(input: Weekdays_hesaplamaInput): Weekdays_hesaplamaOutput {
...
export interface Weekdays_hesaplamaOutput {
...
export const Weekdays_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
