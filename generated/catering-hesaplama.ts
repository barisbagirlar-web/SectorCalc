// Auto-generated from catering-hesaplama-schema.json
import * as z from 'zod';

export interface Catering_hesaplamaInput {
  petAge: number;
  petWeight: number;
  dataConfidence?: number;
}

export const Catering_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Catering_hesaplamaInput): Record<string, number> {
...
export function calculateCatering_hesaplama(input: Catering_hesaplamaInput): Catering_hesaplamaOutput {
...
export interface Catering_hesaplamaOutput {
...
export const Catering_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "years",
