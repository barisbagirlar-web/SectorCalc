// Auto-generated from svd-hesaplama-schema.json
import * as z from 'zod';

export interface Svd_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Svd_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Svd_hesaplamaInput): Record<string, number> {
...
export function calculateSvd_hesaplama(input: Svd_hesaplamaInput): Svd_hesaplamaOutput {
...
export interface Svd_hesaplamaOutput {
...
export const Svd_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
