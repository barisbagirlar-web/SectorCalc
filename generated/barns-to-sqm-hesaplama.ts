// Auto-generated from barns-to-sqm-hesaplama-schema.json
import * as z from 'zod';

export interface Barns_to_sqm_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Barns_to_sqm_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Barns_to_sqm_hesaplamaInput): Record<string, number> {
...
export function calculateBarns_to_sqm_hesaplama(input: Barns_to_sqm_hesaplamaInput): Barns_to_sqm_hesaplamaOutput {
...
export interface Barns_to_sqm_hesaplamaOutput {
...
export const Barns_to_sqm_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
