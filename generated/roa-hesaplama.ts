// Auto-generated from roa-hesaplama-schema.json
import * as z from 'zod';

export interface Roa_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Roa_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Roa_hesaplamaInput): Record<string, number> {
...
export function calculateRoa_hesaplama(input: Roa_hesaplamaInput): Roa_hesaplamaOutput {
...
export interface Roa_hesaplamaOutput {
...
export const Roa_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
