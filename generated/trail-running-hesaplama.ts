// Auto-generated from trail-running-hesaplama-schema.json
import * as z from 'zod';

export interface Trail_running_hesaplamaInput {
  distanceKm: number;
  durationMin: number;
  dataConfidence?: number;
}

export const Trail_running_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Trail_running_hesaplamaInput): Record<string, number> {
...
export function calculateTrail_running_hesaplama(input: Trail_running_hesaplamaInput): Trail_running_hesaplamaOutput {
...
export interface Trail_running_hesaplamaOutput {
...
export const Trail_running_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "km",
