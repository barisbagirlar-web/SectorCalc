// Auto-generated from usda-kredi-hesaplama-schema.json
import * as z from 'zod';

export interface Usda_kredi_hesaplamaInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Usda_kredi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Usda_kredi_hesaplamaInput): Record<string, number> {
...
export function calculateUsda_kredi_hesaplama(input: Usda_kredi_hesaplamaInput): Usda_kredi_hesaplamaOutput {
...
export interface Usda_kredi_hesaplamaOutput {
...
export const Usda_kredi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
