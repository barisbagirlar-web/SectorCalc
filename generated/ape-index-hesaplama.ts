// Auto-generated from ape-index-hesaplama-schema.json
import * as z from 'zod';

export interface Ape_index_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Ape_index_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ape_index_hesaplamaInput): Record<string, number> {
...
export function calculateApe_index_hesaplama(input: Ape_index_hesaplamaInput): Ape_index_hesaplamaOutput {
...
export interface Ape_index_hesaplamaOutput {
...
export const Ape_index_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
