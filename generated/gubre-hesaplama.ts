// Auto-generated from gubre-hesaplama-schema.json
import * as z from 'zod';

export interface Gubre_hesaplamaInput {
  fieldArea: number;
  dataConfidence?: number;
}

export const Gubre_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Gubre_hesaplamaInput): Record<string, number> {
...
export function calculateGubre_hesaplama(input: Gubre_hesaplamaInput): Gubre_hesaplamaOutput {
...
export interface Gubre_hesaplamaOutput {
...
export const Gubre_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "m²",
