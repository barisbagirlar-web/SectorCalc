// Auto-generated from macro-hesaplama-schema.json
import * as z from 'zod';

export interface Macro_hesaplamaInput {
  dailyCalories: number;
  bodyMass: number;
  dataConfidence?: number;
}

export const Macro_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Macro_hesaplamaInput): Record<string, number> {
...
export function calculateMacro_hesaplama(input: Macro_hesaplamaInput): Macro_hesaplamaOutput {
...
export interface Macro_hesaplamaOutput {
...
export const Macro_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "kcal",
