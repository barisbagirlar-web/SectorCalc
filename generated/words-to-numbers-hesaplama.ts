// Auto-generated from words-to-numbers-hesaplama-schema.json
import * as z from 'zod';

export interface Words_to_numbers_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Words_to_numbers_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Words_to_numbers_hesaplamaInput): Record<string, number> {
...
export function calculateWords_to_numbers_hesaplama(input: Words_to_numbers_hesaplamaInput): Words_to_numbers_hesaplamaOutput {
...
export interface Words_to_numbers_hesaplamaOutput {
...
export const Words_to_numbers_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
