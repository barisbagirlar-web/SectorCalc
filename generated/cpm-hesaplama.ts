// Auto-generated from cpm-hesaplama-schema.json
import * as z from 'zod';

export interface Cpm_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Cpm_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cpm_hesaplamaInput): Record<string, number> {
...
export function calculateCpm_hesaplama(input: Cpm_hesaplamaInput): Cpm_hesaplamaOutput {
...
export interface Cpm_hesaplamaOutput {
...
export const Cpm_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
