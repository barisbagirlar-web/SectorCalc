// Auto-generated from sure-birim-donusturucu-schema.json
import * as z from 'zod';

export interface Sure_birim_donusturucuInput {
  timeValue: number;
  frequency: number;
  dataConfidence?: number;
}

export const Sure_birim_donusturucuInputSchema = z.object({
...
function evaluateAllFormulas(input: Sure_birim_donusturucuInput): Record<string, number> {
...
export function calculateSure_birim_donusturucu(input: Sure_birim_donusturucuInput): Sure_birim_donusturucuOutput {
...
export interface Sure_birim_donusturucuOutput {
...
export const Sure_birim_donusturucuOutputMeta = {
  primaryKey: "result",
  unit: "min",
