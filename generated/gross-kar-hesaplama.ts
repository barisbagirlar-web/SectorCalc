// Auto-generated from gross-kar-hesaplama-schema.json
import * as z from 'zod';

export interface Gross_kar_hesaplamaInput {
  revenueAmount: number;
  costAmount: number;
  dataConfidence?: number;
}

export const Gross_kar_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Gross_kar_hesaplamaInput): Record<string, number> {
...
export function calculateGross_kar_hesaplama(input: Gross_kar_hesaplamaInput): Gross_kar_hesaplamaOutput {
...
export interface Gross_kar_hesaplamaOutput {
...
export const Gross_kar_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
