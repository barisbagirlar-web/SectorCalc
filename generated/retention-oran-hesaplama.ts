// Auto-generated from retention-oran-hesaplama-schema.json
import * as z from 'zod';

export interface Retention_oran_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Retention_oran_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Retention_oran_hesaplamaInput): Record<string, number> {
...
export function calculateRetention_oran_hesaplama(input: Retention_oran_hesaplamaInput): Retention_oran_hesaplamaOutput {
...
export interface Retention_oran_hesaplamaOutput {
...
export const Retention_oran_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
