// Auto-generated from cooper-test-hesaplama-schema.json
import * as z from 'zod';

export interface Cooper_test_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Cooper_test_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cooper_test_hesaplamaInput): Record<string, number> {
...
export function calculateCooper_test_hesaplama(input: Cooper_test_hesaplamaInput): Cooper_test_hesaplamaOutput {
...
export interface Cooper_test_hesaplamaOutput {
...
export const Cooper_test_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
