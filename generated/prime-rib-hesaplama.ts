// Auto-generated from prime-rib-hesaplama-schema.json
import * as z from 'zod';

export interface Prime_rib_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Prime_rib_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Prime_rib_hesaplamaInput): Record<string, number> {
...
export function calculatePrime_rib_hesaplama(input: Prime_rib_hesaplamaInput): Prime_rib_hesaplamaOutput {
...
export interface Prime_rib_hesaplamaOutput {
...
export const Prime_rib_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
