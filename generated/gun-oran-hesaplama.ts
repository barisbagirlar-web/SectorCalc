// Auto-generated from gun-oran-hesaplama-schema.json
import * as z from 'zod';

export interface Gun_oran_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Gun_oran_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Gun_oran_hesaplamaInput): Record<string, number> {
...
export function calculateGun_oran_hesaplama(input: Gun_oran_hesaplamaInput): Gun_oran_hesaplamaOutput {
...
export interface Gun_oran_hesaplamaOutput {
...
export const Gun_oran_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
