// Auto-generated from inek-hesaplama-schema.json
import * as z from 'zod';

export interface Inek_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Inek_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Inek_hesaplamaInput): Record<string, number> {
...
export function calculateInek_hesaplama(input: Inek_hesaplamaInput): Inek_hesaplamaOutput {
...
export interface Inek_hesaplamaOutput {
...
export const Inek_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
