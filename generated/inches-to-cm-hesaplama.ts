// Auto-generated from inches-to-cm-hesaplama-schema.json
import * as z from 'zod';

export interface Inches_to_cm_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Inches_to_cm_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Inches_to_cm_hesaplamaInput): Record<string, number> {
...
export function calculateInches_to_cm_hesaplama(input: Inches_to_cm_hesaplamaInput): Inches_to_cm_hesaplamaOutput {
...
export interface Inches_to_cm_hesaplamaOutput {
...
export const Inches_to_cm_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
