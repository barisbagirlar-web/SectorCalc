// Auto-generated from araba-kredisi-hesaplama-schema.json
import * as z from 'zod';

export interface Araba_kredisi_hesaplamaInput {
  fiyat: number;
  pesin: number;
  faiz: number;
  vade: number;
...
export const Araba_kredisi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Araba_kredisi_hesaplamaInput): Record<string, number> {
...
export function calculateAraba_kredisi_hesaplama(input: Araba_kredisi_hesaplamaInput): Araba_kredisi_hesaplamaOutput {
...
export interface Araba_kredisi_hesaplamaOutput {
...
export const Araba_kredisi_hesaplamaOutputMeta = {
  primaryKey: "sonuc",
  unit: "TRY",
  breakdownKeys: ["sonuc"],
} as const;
