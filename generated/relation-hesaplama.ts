// Auto-generated from relation-hesaplama-schema.json
import * as z from 'zod';

export interface Relation_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Relation_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Relation_hesaplamaInput): Record<string, number> {
...
export function calculateRelation_hesaplama(input: Relation_hesaplamaInput): Relation_hesaplamaOutput {
...
export interface Relation_hesaplamaOutput {
...
export const Relation_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
