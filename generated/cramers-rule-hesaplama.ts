// Auto-generated from cramers-rule-hesaplama-schema.json
import * as z from 'zod';

export interface Cramers_rule_hesaplamaInput {
  totalValue: number;
  percentage: number;
  dataConfidence?: number;
}

export const Cramers_rule_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cramers_rule_hesaplamaInput): Record<string, number> {
...
export function calculateCramers_rule_hesaplama(input: Cramers_rule_hesaplamaInput): Cramers_rule_hesaplamaOutput {
...
export interface Cramers_rule_hesaplamaOutput {
...
export const Cramers_rule_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "%",
