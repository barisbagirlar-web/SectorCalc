// Auto-generated from duty-hesaplama-schema.json
import * as z from 'zod';

export interface Duty_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Duty_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Duty_hesaplamaInput): Record<string, number> {
...
export function calculateDuty_hesaplama(input: Duty_hesaplamaInput): Duty_hesaplamaOutput {
...
export interface Duty_hesaplamaOutput {
...
export const Duty_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
