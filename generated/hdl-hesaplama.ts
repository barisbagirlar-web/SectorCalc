// Auto-generated from hdl-hesaplama-schema.json
import * as z from 'zod';

export interface Hdl_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Hdl_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Hdl_hesaplamaInput): Record<string, number> {
...
export function calculateHdl_hesaplama(input: Hdl_hesaplamaInput): Hdl_hesaplamaOutput {
...
export interface Hdl_hesaplamaOutput {
...
export const Hdl_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
