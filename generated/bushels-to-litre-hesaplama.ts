// Auto-generated from bushels-to-litre-hesaplama-schema.json
import * as z from 'zod';

export interface Bushels_to_litre_hesaplamaInput {
  volumeValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Bushels_to_litre_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Bushels_to_litre_hesaplamaInput): Record<string, number> {
...
export function calculateBushels_to_litre_hesaplama(input: Bushels_to_litre_hesaplamaInput): Bushels_to_litre_hesaplamaOutput {
...
export interface Bushels_to_litre_hesaplamaOutput {
...
export const Bushels_to_litre_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "m³",
