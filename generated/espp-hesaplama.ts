// Auto-generated from espp-hesaplama-schema.json
import * as z from 'zod';

export interface Espp_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Espp_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Espp_hesaplamaInput): Record<string, number> {
...
export function calculateEspp_hesaplama(input: Espp_hesaplamaInput): Espp_hesaplamaOutput {
...
export interface Espp_hesaplamaOutput {
...
export const Espp_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
