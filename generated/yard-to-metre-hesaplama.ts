// Auto-generated from yard-to-metre-hesaplama-schema.json
import * as z from 'zod';

export interface Yard_to_metre_hesaplamaInput {
  lengthValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Yard_to_metre_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Yard_to_metre_hesaplamaInput): Record<string, number> {
...
export function calculateYard_to_metre_hesaplama(input: Yard_to_metre_hesaplamaInput): Yard_to_metre_hesaplamaOutput {
...
export interface Yard_to_metre_hesaplamaOutput {
...
export const Yard_to_metre_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "m",
