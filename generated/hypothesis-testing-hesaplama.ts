// Auto-generated from hypothesis-testing-hesaplama-schema.json
import * as z from 'zod';

export interface Hypothesis_testing_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Hypothesis_testing_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Hypothesis_testing_hesaplamaInput): Record<string, number> {
...
export function calculateHypothesis_testing_hesaplama(input: Hypothesis_testing_hesaplamaInput): Hypothesis_testing_hesaplamaOutput {
...
export interface Hypothesis_testing_hesaplamaOutput {
...
export const Hypothesis_testing_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
