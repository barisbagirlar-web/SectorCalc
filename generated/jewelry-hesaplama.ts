// Auto-generated from jewelry-hesaplama-schema.json
import * as z from 'zod';

export interface Jewelry_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Jewelry_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Jewelry_hesaplamaInput): Record<string, number> {
...
export function calculateJewelry_hesaplama(input: Jewelry_hesaplamaInput): Jewelry_hesaplamaOutput {
...
export interface Jewelry_hesaplamaOutput {
...
export const Jewelry_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
