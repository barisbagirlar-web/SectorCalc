// Auto-generated from chord-hesaplama-schema.json
import * as z from 'zod';

export interface Chord_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Chord_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Chord_hesaplamaInput): Record<string, number> {
...
export function calculateChord_hesaplama(input: Chord_hesaplamaInput): Chord_hesaplamaOutput {
...
export interface Chord_hesaplamaOutput {
...
export const Chord_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
