// Auto-generated from miles-to-km-hesaplama-schema.json
import * as z from 'zod';

export interface Miles_to_km_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Miles_to_km_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Miles_to_km_hesaplamaInput): Record<string, number> {
...
export function calculateMiles_to_km_hesaplama(input: Miles_to_km_hesaplamaInput): Miles_to_km_hesaplamaOutput {
...
export interface Miles_to_km_hesaplamaOutput {
...
export const Miles_to_km_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
