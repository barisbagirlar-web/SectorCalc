// Auto-generated from silhouette-score-hesaplama-schema.json
import * as z from 'zod';

export interface Silhouette_score_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Silhouette_score_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Silhouette_score_hesaplamaInput): Record<string, number> {
...
export function calculateSilhouette_score_hesaplama(input: Silhouette_score_hesaplamaInput): Silhouette_score_hesaplamaOutput {
...
export interface Silhouette_score_hesaplamaOutput {
...
export const Silhouette_score_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
