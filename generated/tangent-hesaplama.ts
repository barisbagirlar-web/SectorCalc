// Auto-generated from tangent-hesaplama-schema.json
import * as z from 'zod';

export interface Tangent_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Tangent_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Tangent_hesaplamaInput): Record<string, number> {
...
export function calculateTangent_hesaplama(input: Tangent_hesaplamaInput): Tangent_hesaplamaOutput {
...
export interface Tangent_hesaplamaOutput {
...
export const Tangent_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
