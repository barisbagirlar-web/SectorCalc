// Auto-generated from apr-hesaplama-schema.json
import * as z from 'zod';

export interface Apr_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Apr_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Apr_hesaplamaInput): Record<string, number> {
...
export function calculateApr_hesaplama(input: Apr_hesaplamaInput): Apr_hesaplamaOutput {
...
export interface Apr_hesaplamaOutput {
...
export const Apr_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
