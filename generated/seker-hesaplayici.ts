// Auto-generated from seker-hesaplayici-schema.json
import * as z from 'zod';

export interface Seker_hesaplayiciInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Seker_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Seker_hesaplayiciInput): Record<string, number> {
...
export function calculateSeker_hesaplayici(input: Seker_hesaplayiciInput): Seker_hesaplayiciOutput {
...
export interface Seker_hesaplayiciOutput {
...
export const Seker_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "",
