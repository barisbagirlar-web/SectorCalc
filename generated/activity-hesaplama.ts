// Auto-generated from activity-hesaplama-schema.json
import * as z from 'zod';

export interface Activity_hesaplamaInput {
  correctAnswers: number;
  dataConfidence?: number;
}

export const Activity_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Activity_hesaplamaInput): Record<string, number> {
...
export function calculateActivity_hesaplama(input: Activity_hesaplamaInput): Activity_hesaplamaOutput {
...
export interface Activity_hesaplamaOutput {
...
export const Activity_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
