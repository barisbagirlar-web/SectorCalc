// Auto-generated from omega-3-hesaplama-schema.json
import * as z from 'zod';

export interface Omega_3_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Omega_3_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Omega_3_hesaplamaInput): Record<string, number> {
...
export function calculateOmega_3_hesaplama(input: Omega_3_hesaplamaInput): Omega_3_hesaplamaOutput {
...
export interface Omega_3_hesaplamaOutput {
...
export const Omega_3_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
