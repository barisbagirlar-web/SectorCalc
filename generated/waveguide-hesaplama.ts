// Auto-generated from waveguide-hesaplama-schema.json
import * as z from 'zod';

export interface Waveguide_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Waveguide_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Waveguide_hesaplamaInput): Record<string, number> {
...
export function calculateWaveguide_hesaplama(input: Waveguide_hesaplamaInput): Waveguide_hesaplamaOutput {
...
export interface Waveguide_hesaplamaOutput {
...
export const Waveguide_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
