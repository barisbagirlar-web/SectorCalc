// Auto-generated from cycling-pace-hesaplama-schema.json
import * as z from 'zod';

export interface Cycling_pace_hesaplamaInput {
  heartRate: number;
  exerciseDuration: number;
  dataConfidence?: number;
}

export const Cycling_pace_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cycling_pace_hesaplamaInput): Record<string, number> {
...
export function calculateCycling_pace_hesaplama(input: Cycling_pace_hesaplamaInput): Cycling_pace_hesaplamaOutput {
...
export interface Cycling_pace_hesaplamaOutput {
...
export const Cycling_pace_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "bpm",
