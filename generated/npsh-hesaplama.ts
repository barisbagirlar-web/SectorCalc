// Auto-generated from npsh-hesaplama-schema.json
import * as z from 'zod';

export interface Npsh_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Npsh_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Npsh_hesaplamaInput): Record<string, number> {
...
export function calculateNpsh_hesaplama(input: Npsh_hesaplamaInput): Npsh_hesaplamaOutput {
...
export interface Npsh_hesaplamaOutput {
...
export const Npsh_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
