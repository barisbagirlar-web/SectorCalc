// Auto-generated from hsl-to-rgb-hesaplama-schema.json
import * as z from 'zod';

export interface Hsl_to_rgb_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Hsl_to_rgb_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Hsl_to_rgb_hesaplamaInput): Record<string, number> {
...
export function calculateHsl_to_rgb_hesaplama(input: Hsl_to_rgb_hesaplamaInput): Hsl_to_rgb_hesaplamaOutput {
...
export interface Hsl_to_rgb_hesaplamaOutput {
...
export const Hsl_to_rgb_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
