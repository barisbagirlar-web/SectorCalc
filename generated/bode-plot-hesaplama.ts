// Auto-generated from bode-plot-hesaplama-schema.json
import * as z from 'zod';

export interface Bode_plot_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Bode_plot_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Bode_plot_hesaplamaInput): Record<string, number> {
...
export function calculateBode_plot_hesaplama(input: Bode_plot_hesaplamaInput): Bode_plot_hesaplamaOutput {
...
export interface Bode_plot_hesaplamaOutput {
...
export const Bode_plot_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
