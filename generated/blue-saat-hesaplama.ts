// Auto-generated from blue-saat-hesaplama-schema.json
import * as z from 'zod';

export interface Blue_saat_hesaplamaInput {
  timeValue: number;
  frequency: number;
  dataConfidence?: number;
}

export const Blue_saat_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Blue_saat_hesaplamaInput): Record<string, number> {
...
export function calculateBlue_saat_hesaplama(input: Blue_saat_hesaplamaInput): Blue_saat_hesaplamaOutput {
...
export interface Blue_saat_hesaplamaOutput {
...
export const Blue_saat_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "min",
