// Auto-generated from gcf-hesaplama-schema.json
import * as z from 'zod';

export interface Gcf_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Gcf_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Gcf_hesaplamaInput): Record<string, number> {
...
export function calculateGcf_hesaplama(input: Gcf_hesaplamaInput): Gcf_hesaplamaOutput {
...
export interface Gcf_hesaplamaOutput {
...
export const Gcf_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
