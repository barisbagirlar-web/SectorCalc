// Auto-generated from pd-hesaplama-schema.json
import * as z from 'zod';

export interface Pd_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Pd_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pd_hesaplamaInput): Record<string, number> {
...
export function calculatePd_hesaplama(input: Pd_hesaplamaInput): Pd_hesaplamaOutput {
...
export interface Pd_hesaplamaOutput {
...
export const Pd_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
