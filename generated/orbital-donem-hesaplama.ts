// Auto-generated from orbital-donem-hesaplama-schema.json
import * as z from 'zod';

export interface Orbital_donem_hesaplamaInput {
  airTemperature: number;
  relativeHumidity: number;
  dataConfidence?: number;
}

export const Orbital_donem_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Orbital_donem_hesaplamaInput): Record<string, number> {
...
export function calculateOrbital_donem_hesaplama(input: Orbital_donem_hesaplamaInput): Orbital_donem_hesaplamaOutput {
...
export interface Orbital_donem_hesaplamaOutput {
...
export const Orbital_donem_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "°C",
