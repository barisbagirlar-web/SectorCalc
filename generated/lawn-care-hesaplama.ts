// Auto-generated from lawn-care-hesaplama-schema.json
import * as z from 'zod';

export interface Lawn_care_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Lawn_care_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Lawn_care_hesaplamaInput): Record<string, number> {
...
export function calculateLawn_care_hesaplama(input: Lawn_care_hesaplamaInput): Lawn_care_hesaplamaOutput {
...
export interface Lawn_care_hesaplamaOutput {
...
export const Lawn_care_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
