// Auto-generated from wim-hof-hesaplama-schema.json
import * as z from 'zod';

export interface Wim_hof_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Wim_hof_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Wim_hof_hesaplamaInput): Record<string, number> {
...
export function calculateWim_hof_hesaplama(input: Wim_hof_hesaplamaInput): Wim_hof_hesaplamaOutput {
...
export interface Wim_hof_hesaplamaOutput {
...
export const Wim_hof_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
