// Auto-generated from walking-pace-hesaplama-schema.json
import * as z from 'zod';

export interface Walking_pace_hesaplamaInput {
  distanceKm: number;
  durationMin: number;
  dataConfidence?: number;
}

export const Walking_pace_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Walking_pace_hesaplamaInput): Record<string, number> {
...
export function calculateWalking_pace_hesaplama(input: Walking_pace_hesaplamaInput): Walking_pace_hesaplamaOutput {
...
export interface Walking_pace_hesaplamaOutput {
...
export const Walking_pace_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "km",
