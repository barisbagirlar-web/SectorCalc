// Auto-generated from op-amp-hesaplama-schema.json
import * as z from 'zod';

export interface Op_amp_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Op_amp_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Op_amp_hesaplamaInput): Record<string, number> {
...
export function calculateOp_amp_hesaplama(input: Op_amp_hesaplamaInput): Op_amp_hesaplamaOutput {
...
export interface Op_amp_hesaplamaOutput {
...
export const Op_amp_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
