// Auto-generated from sourdough-hesaplama-schema.json
import * as z from 'zod';

export interface Sourdough_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Sourdough_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Sourdough_hesaplamaInput): Record<string, number> {
...
export function calculateSourdough_hesaplama(input: Sourdough_hesaplamaInput): Sourdough_hesaplamaOutput {
...
export interface Sourdough_hesaplamaOutput {
...
export const Sourdough_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
