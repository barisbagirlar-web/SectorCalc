// Auto-generated from pe-ratio-hesaplama-schema.json
import * as z from 'zod';

export interface Pe_ratio_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Pe_ratio_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pe_ratio_hesaplamaInput): Record<string, number> {
...
export function calculatePe_ratio_hesaplama(input: Pe_ratio_hesaplamaInput): Pe_ratio_hesaplamaOutput {
...
export interface Pe_ratio_hesaplamaOutput {
...
export const Pe_ratio_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
