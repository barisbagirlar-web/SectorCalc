// Auto-generated from set-operations-hesaplama-schema.json
import * as z from 'zod';

export interface Set_operations_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Set_operations_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Set_operations_hesaplamaInput): Record<string, number> {
...
export function calculateSet_operations_hesaplama(input: Set_operations_hesaplamaInput): Set_operations_hesaplamaOutput {
...
export interface Set_operations_hesaplamaOutput {
...
export const Set_operations_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
