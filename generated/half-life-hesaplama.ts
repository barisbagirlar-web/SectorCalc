// Auto-generated from half-life-hesaplama-schema.json
import * as z from 'zod';

export interface Half_life_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Half_life_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Half_life_hesaplamaInput): Record<string, number> {
...
export function calculateHalf_life_hesaplama(input: Half_life_hesaplamaInput): Half_life_hesaplamaOutput {
...
export interface Half_life_hesaplamaOutput {
...
export const Half_life_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
