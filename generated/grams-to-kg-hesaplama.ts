// Auto-generated from grams-to-kg-hesaplama-schema.json
import * as z from 'zod';

export interface Grams_to_kg_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Grams_to_kg_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Grams_to_kg_hesaplamaInput): Record<string, number> {
...
export function calculateGrams_to_kg_hesaplama(input: Grams_to_kg_hesaplamaInput): Grams_to_kg_hesaplamaOutput {
...
export interface Grams_to_kg_hesaplamaOutput {
...
export const Grams_to_kg_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
