// Auto-generated from inhg-to-psi-hesaplama-schema.json
import * as z from 'zod';

export interface Inhg_to_psi_hesaplamaInput {
  pressureValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Inhg_to_psi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Inhg_to_psi_hesaplamaInput): Record<string, number> {
...
export function calculateInhg_to_psi_hesaplama(input: Inhg_to_psi_hesaplamaInput): Inhg_to_psi_hesaplamaOutput {
...
export interface Inhg_to_psi_hesaplamaOutput {
...
export const Inhg_to_psi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "Pa",
