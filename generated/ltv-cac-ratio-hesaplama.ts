// Auto-generated from ltv-cac-ratio-hesaplama-schema.json
import * as z from 'zod';

export interface Ltv_cac_ratio_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Ltv_cac_ratio_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ltv_cac_ratio_hesaplamaInput): Record<string, number> {
...
export function calculateLtv_cac_ratio_hesaplama(input: Ltv_cac_ratio_hesaplamaInput): Ltv_cac_ratio_hesaplamaOutput {
...
export interface Ltv_cac_ratio_hesaplamaOutput {
...
export const Ltv_cac_ratio_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
