// Auto-generated from range-hesaplama-schema.json
import * as z from 'zod';

export interface Range_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Range_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Range_hesaplamaInput): Record<string, number> {
...
export function calculateRange_hesaplama(input: Range_hesaplamaInput): Range_hesaplamaOutput {
...
export interface Range_hesaplamaOutput {
...
export const Range_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
