// Auto-generated from mortgage-hesaplayici-schema.json
import * as z from 'zod';

export interface Mortgage_hesaplayiciInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Mortgage_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Mortgage_hesaplayiciInput): Record<string, number> {
...
export function calculateMortgage_hesaplayici(input: Mortgage_hesaplayiciInput): Mortgage_hesaplayiciOutput {
...
export interface Mortgage_hesaplayiciOutput {
...
export const Mortgage_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "USD",
