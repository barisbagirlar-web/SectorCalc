// Auto-generated from ice-cream-hesaplama-schema.json
import * as z from 'zod';

export interface Ice_cream_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Ice_cream_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ice_cream_hesaplamaInput): Record<string, number> {
...
export function calculateIce_cream_hesaplama(input: Ice_cream_hesaplamaInput): Ice_cream_hesaplamaOutput {
...
export interface Ice_cream_hesaplamaOutput {
...
export const Ice_cream_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
