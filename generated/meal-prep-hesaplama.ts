// Auto-generated from meal-prep-hesaplama-schema.json
import * as z from 'zod';

export interface Meal_prep_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Meal_prep_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Meal_prep_hesaplamaInput): Record<string, number> {
...
export function calculateMeal_prep_hesaplama(input: Meal_prep_hesaplamaInput): Meal_prep_hesaplamaOutput {
...
export interface Meal_prep_hesaplamaOutput {
...
export const Meal_prep_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
