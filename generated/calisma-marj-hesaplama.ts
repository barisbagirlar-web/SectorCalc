// Auto-generated from calisma-marj-hesaplama-schema.json
import * as z from 'zod';

export interface Calisma_marj_hesaplamaInput {
  revenueAmount: number;
  costAmount: number;
  dataConfidence?: number;
}

export const Calisma_marj_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Calisma_marj_hesaplamaInput): Record<string, number> {
...
export function calculateCalisma_marj_hesaplama(input: Calisma_marj_hesaplamaInput): Calisma_marj_hesaplamaOutput {
...
export interface Calisma_marj_hesaplamaOutput {
...
export const Calisma_marj_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
