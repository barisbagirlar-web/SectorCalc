// Auto-generated from merit-aid-hesaplama-schema.json
import * as z from 'zod';

export interface Merit_aid_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Merit_aid_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Merit_aid_hesaplamaInput): Record<string, number> {
...
export function calculateMerit_aid_hesaplama(input: Merit_aid_hesaplamaInput): Merit_aid_hesaplamaOutput {
...
export interface Merit_aid_hesaplamaOutput {
...
export const Merit_aid_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
