// Auto-generated from fishers-exact-test-hesaplama-schema.json
import * as z from 'zod';

export interface Fishers_exact_test_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Fishers_exact_test_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Fishers_exact_test_hesaplamaInput): Record<string, number> {
...
export function calculateFishers_exact_test_hesaplama(input: Fishers_exact_test_hesaplamaInput): Fishers_exact_test_hesaplamaOutput {
...
export interface Fishers_exact_test_hesaplamaOutput {
...
export const Fishers_exact_test_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
