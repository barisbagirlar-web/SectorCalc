// Auto-generated from kc-hesaplama-schema.json
import * as z from 'zod';

export interface Kc_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Kc_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Kc_hesaplamaInput): Record<string, number> {
...
export function calculateKc_hesaplama(input: Kc_hesaplamaInput): Kc_hesaplamaOutput {
...
export interface Kc_hesaplamaOutput {
...
export const Kc_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
