// Auto-generated from battery-hesaplama-schema.json
import * as z from 'zod';

export interface Battery_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Battery_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Battery_hesaplamaInput): Record<string, number> {
...
export function calculateBattery_hesaplama(input: Battery_hesaplamaInput): Battery_hesaplamaOutput {
...
export interface Battery_hesaplamaOutput {
...
export const Battery_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
