// Auto-generated from wrinkle-hesaplama-schema.json
import * as z from 'zod';

export interface Wrinkle_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Wrinkle_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Wrinkle_hesaplamaInput): Record<string, number> {
...
export function calculateWrinkle_hesaplama(input: Wrinkle_hesaplamaInput): Wrinkle_hesaplamaOutput {
...
export interface Wrinkle_hesaplamaOutput {
...
export const Wrinkle_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
