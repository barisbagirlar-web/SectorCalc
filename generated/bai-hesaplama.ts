// Auto-generated from bai-hesaplama-schema.json
import * as z from 'zod';

export interface Bai_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Bai_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Bai_hesaplamaInput): Record<string, number> {
...
export function calculateBai_hesaplama(input: Bai_hesaplamaInput): Bai_hesaplamaOutput {
...
export interface Bai_hesaplamaOutput {
...
export const Bai_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
