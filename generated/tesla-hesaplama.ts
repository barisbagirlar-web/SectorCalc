// Auto-generated from tesla-hesaplama-schema.json
import * as z from 'zod';

export interface Tesla_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Tesla_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Tesla_hesaplamaInput): Record<string, number> {
...
export function calculateTesla_hesaplama(input: Tesla_hesaplamaInput): Tesla_hesaplamaOutput {
...
export interface Tesla_hesaplamaOutput {
...
export const Tesla_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
