// Auto-generated from omad-hesaplama-schema.json
import * as z from 'zod';

export interface Omad_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Omad_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Omad_hesaplamaInput): Record<string, number> {
...
export function calculateOmad_hesaplama(input: Omad_hesaplamaInput): Omad_hesaplamaOutput {
...
export interface Omad_hesaplamaOutput {
...
export const Omad_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
