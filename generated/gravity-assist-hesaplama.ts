// Auto-generated from gravity-assist-hesaplama-schema.json
import * as z from 'zod';

export interface Gravity_assist_hesaplamaInput {
  massObject: number;
  gravitationalAccel: number;
  dataConfidence?: number;
}

export const Gravity_assist_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Gravity_assist_hesaplamaInput): Record<string, number> {
...
export function calculateGravity_assist_hesaplama(input: Gravity_assist_hesaplamaInput): Gravity_assist_hesaplamaOutput {
...
export interface Gravity_assist_hesaplamaOutput {
...
export const Gravity_assist_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "kg",
