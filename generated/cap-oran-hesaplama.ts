// Auto-generated from cap-oran-hesaplama-schema.json
import * as z from 'zod';

export interface Cap_oran_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Cap_oran_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cap_oran_hesaplamaInput): Record<string, number> {
...
export function calculateCap_oran_hesaplama(input: Cap_oran_hesaplamaInput): Cap_oran_hesaplamaOutput {
...
export interface Cap_oran_hesaplamaOutput {
...
export const Cap_oran_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
