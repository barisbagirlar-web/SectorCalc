// Auto-generated from easter-hesaplama-schema.json
import * as z from 'zod';

export interface Easter_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Easter_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Easter_hesaplamaInput): Record<string, number> {
...
export function calculateEaster_hesaplama(input: Easter_hesaplamaInput): Easter_hesaplamaOutput {
...
export interface Easter_hesaplamaOutput {
...
export const Easter_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
