// Auto-generated from swim-bike-run-hesaplama-schema.json
import * as z from 'zod';

export interface Swim_bike_run_hesaplamaInput {
  heartRate: number;
  exerciseDuration: number;
  dataConfidence?: number;
}

export const Swim_bike_run_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Swim_bike_run_hesaplamaInput): Record<string, number> {
...
export function calculateSwim_bike_run_hesaplama(input: Swim_bike_run_hesaplamaInput): Swim_bike_run_hesaplamaOutput {
...
export interface Swim_bike_run_hesaplamaOutput {
...
export const Swim_bike_run_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "bpm",
