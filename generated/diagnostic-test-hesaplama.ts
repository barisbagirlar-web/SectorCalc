// Auto-generated from diagnostic-test-hesaplama-schema.json
import * as z from 'zod';

export interface Diagnostic_test_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Diagnostic_test_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Diagnostic_test_hesaplamaInput): Record<string, number> {
...
export function calculateDiagnostic_test_hesaplama(input: Diagnostic_test_hesaplamaInput): Diagnostic_test_hesaplamaOutput {
...
export interface Diagnostic_test_hesaplamaOutput {
...
export const Diagnostic_test_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
