// Auto-generated from gun-week-hesaplama-schema.json
import * as z from 'zod';

export interface Gun_week_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Gun_week_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Gun_week_hesaplamaInput): Record<string, number> {
...
export function calculateGun_week_hesaplama(input: Gun_week_hesaplamaInput): Gun_week_hesaplamaOutput {
...
export interface Gun_week_hesaplamaOutput {
...
export const Gun_week_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
