// Auto-generated from skewness-hesaplama-schema.json
import * as z from 'zod';

export interface Skewness_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Skewness_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Skewness_hesaplamaInput): Record<string, number> {
...
export function calculateSkewness_hesaplama(input: Skewness_hesaplamaInput): Skewness_hesaplamaOutput {
...
export interface Skewness_hesaplamaOutput {
...
export const Skewness_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
