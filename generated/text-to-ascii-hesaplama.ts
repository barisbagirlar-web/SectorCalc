// Auto-generated from text-to-ascii-hesaplama-schema.json
import * as z from 'zod';

export interface Text_to_ascii_hesaplamaInput {
  textInput: number;
  countValue: number;
  dataConfidence?: number;
}

export const Text_to_ascii_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Text_to_ascii_hesaplamaInput): Record<string, number> {
...
export function calculateText_to_ascii_hesaplama(input: Text_to_ascii_hesaplamaInput): Text_to_ascii_hesaplamaOutput {
...
export interface Text_to_ascii_hesaplamaOutput {
...
export const Text_to_ascii_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "text",
