// Auto-generated from gift-vergi-hesaplama-schema.json
import * as z from 'zod';

export interface Gift_vergi_hesaplamaInput {
  income: number;
  deductions: number;
  taxRate: number;
...
export const Gift_vergi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Gift_vergi_hesaplamaInput): Record<string, number> {
...
export function calculateGift_vergi_hesaplama(input: Gift_vergi_hesaplamaInput): Gift_vergi_hesaplamaOutput {
...
export interface Gift_vergi_hesaplamaOutput {
...
export const Gift_vergi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
