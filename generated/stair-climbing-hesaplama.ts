// Auto-generated from stair-climbing-hesaplama-schema.json
import * as z from 'zod';

export interface Stair_climbing_hesaplamaInput {
  airTemperature: number;
  relativeHumidity: number;
  dataConfidence?: number;
}

export const Stair_climbing_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Stair_climbing_hesaplamaInput): Record<string, number> {
...
export function calculateStair_climbing_hesaplama(input: Stair_climbing_hesaplamaInput): Stair_climbing_hesaplamaOutput {
...
export interface Stair_climbing_hesaplamaOutput {
...
export const Stair_climbing_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "°C",
