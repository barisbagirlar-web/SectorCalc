// Auto-generated from countdown-hesaplama-schema.json
import * as z from 'zod';

export interface Countdown_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Countdown_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Countdown_hesaplamaInput): Record<string, number> {
...
export function calculateCountdown_hesaplama(input: Countdown_hesaplamaInput): Countdown_hesaplamaOutput {
...
export interface Countdown_hesaplamaOutput {
...
export const Countdown_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
