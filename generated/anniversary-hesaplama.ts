// Auto-generated from anniversary-hesaplama-schema.json
import * as z from 'zod';

export interface Anniversary_hesaplamaInput {
  birthDate: number;
  referenceDate: number;
  dataConfidence?: number;
}

export const Anniversary_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Anniversary_hesaplamaInput): Record<string, number> {
...
export function calculateAnniversary_hesaplama(input: Anniversary_hesaplamaInput): Anniversary_hesaplamaOutput {
...
export interface Anniversary_hesaplamaOutput {
...
export const Anniversary_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "date",
