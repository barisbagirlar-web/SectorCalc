// Auto-generated from video-bitrate-hesaplama-schema.json
import * as z from 'zod';

export interface Video_bitrate_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Video_bitrate_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Video_bitrate_hesaplamaInput): Record<string, number> {
...
export function calculateVideo_bitrate_hesaplama(input: Video_bitrate_hesaplamaInput): Video_bitrate_hesaplamaOutput {
...
export interface Video_bitrate_hesaplamaOutput {
...
export const Video_bitrate_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
