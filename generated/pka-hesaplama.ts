// Auto-generated from pka-hesaplama-schema.json
import * as z from 'zod';

export interface Pka_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Pka_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pka_hesaplamaInput): Record<string, number> {
...
export function calculatePka_hesaplama(input: Pka_hesaplamaInput): Pka_hesaplamaOutput {
...
export interface Pka_hesaplamaOutput {
...
export const Pka_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
