// Auto-generated from hasat-hesaplama-schema.json
import * as z from 'zod';

export interface Hasat_hesaplamaInput {
  fieldArea: number;
  dataConfidence?: number;
}

export const Hasat_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Hasat_hesaplamaInput): Record<string, number> {
...
export function calculateHasat_hesaplama(input: Hasat_hesaplamaInput): Hasat_hesaplamaOutput {
...
export interface Hasat_hesaplamaOutput {
...
export const Hasat_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "m²",
