// Auto-generated from vitamin-d-hesaplama-schema.json
import * as z from 'zod';

export interface Vitamin_d_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Vitamin_d_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Vitamin_d_hesaplamaInput): Record<string, number> {
...
export function calculateVitamin_d_hesaplama(input: Vitamin_d_hesaplamaInput): Vitamin_d_hesaplamaOutput {
...
export interface Vitamin_d_hesaplamaOutput {
...
export const Vitamin_d_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
