// Auto-generated from drop-oran-hesaplama-schema.json
import * as z from 'zod';

export interface Drop_oran_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Drop_oran_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Drop_oran_hesaplamaInput): Record<string, number> {
...
export function calculateDrop_oran_hesaplama(input: Drop_oran_hesaplamaInput): Drop_oran_hesaplamaOutput {
...
export interface Drop_oran_hesaplamaOutput {
...
export const Drop_oran_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
