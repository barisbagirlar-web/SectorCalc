// Auto-generated from mole-hesaplama-schema.json
import * as z from 'zod';

export interface Mole_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Mole_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Mole_hesaplamaInput): Record<string, number> {
...
export function calculateMole_hesaplama(input: Mole_hesaplamaInput): Mole_hesaplamaOutput {
...
export interface Mole_hesaplamaOutput {
...
export const Mole_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
