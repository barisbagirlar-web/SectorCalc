// Auto-generated from m-to-ft-hesaplama-schema.json
import * as z from 'zod';

export interface M_to_ft_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const M_to_ft_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: M_to_ft_hesaplamaInput): Record<string, number> {
...
export function calculateM_to_ft_hesaplama(input: M_to_ft_hesaplamaInput): M_to_ft_hesaplamaOutput {
...
export interface M_to_ft_hesaplamaOutput {
...
export const M_to_ft_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
