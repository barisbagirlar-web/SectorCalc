// Auto-generated from hasi-hesaplama-schema.json
import * as z from 'zod';

export interface Hasi_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Hasi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Hasi_hesaplamaInput): Record<string, number> {
...
export function calculateHasi_hesaplama(input: Hasi_hesaplamaInput): Hasi_hesaplamaOutput {
...
export interface Hasi_hesaplamaOutput {
...
export const Hasi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
