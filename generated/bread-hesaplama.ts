// Auto-generated from bread-hesaplama-schema.json
import * as z from 'zod';

export interface Bread_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Bread_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Bread_hesaplamaInput): Record<string, number> {
...
export function calculateBread_hesaplama(input: Bread_hesaplamaInput): Bread_hesaplamaOutput {
...
export interface Bread_hesaplamaOutput {
...
export const Bread_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
