// Auto-generated from recycling-hesaplama-schema.json
import * as z from 'zod';

export interface Recycling_hesaplamaInput {
  consumptionAmount: number;
  dataConfidence?: number;
}

export const Recycling_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Recycling_hesaplamaInput): Record<string, number> {
...
export function calculateRecycling_hesaplama(input: Recycling_hesaplamaInput): Recycling_hesaplamaOutput {
...
export interface Recycling_hesaplamaOutput {
...
export const Recycling_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "kWh",
