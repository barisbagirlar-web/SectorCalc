// Auto-generated from curb-65-hesaplama-schema.json
import * as z from 'zod';

export interface Curb_65_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Curb_65_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Curb_65_hesaplamaInput): Record<string, number> {
...
export function calculateCurb_65_hesaplama(input: Curb_65_hesaplamaInput): Curb_65_hesaplamaOutput {
...
export interface Curb_65_hesaplamaOutput {
...
export const Curb_65_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
