// Auto-generated from car-odeme-hesaplama-schema.json
import * as z from 'zod';

export interface Car_odeme_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Car_odeme_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Car_odeme_hesaplamaInput): Record<string, number> {
...
export function calculateCar_odeme_hesaplama(input: Car_odeme_hesaplamaInput): Car_odeme_hesaplamaOutput {
...
export interface Car_odeme_hesaplamaOutput {
...
export const Car_odeme_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
