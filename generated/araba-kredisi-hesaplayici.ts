// Auto-generated from araba-kredisi-hesaplayici-schema.json
import * as z from 'zod';

export interface Araba_kredisi_hesaplayiciInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Araba_kredisi_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Araba_kredisi_hesaplayiciInput): Record<string, number> {
...
export function calculateAraba_kredisi_hesaplayici(input: Araba_kredisi_hesaplayiciInput): Araba_kredisi_hesaplayiciOutput {
...
export interface Araba_kredisi_hesaplayiciOutput {
...
export const Araba_kredisi_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "USD",
