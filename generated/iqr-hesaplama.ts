// Auto-generated from iqr-hesaplama-schema.json
import * as z from 'zod';

export interface Iqr_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Iqr_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Iqr_hesaplamaInput): Record<string, number> {
...
export function calculateIqr_hesaplama(input: Iqr_hesaplamaInput): Iqr_hesaplamaOutput {
...
export interface Iqr_hesaplamaOutput {
...
export const Iqr_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
