// Auto-generated from diopter-hesaplama-schema.json
import * as z from 'zod';

export interface Diopter_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Diopter_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Diopter_hesaplamaInput): Record<string, number> {
...
export function calculateDiopter_hesaplama(input: Diopter_hesaplamaInput): Diopter_hesaplamaOutput {
...
export interface Diopter_hesaplamaOutput {
...
export const Diopter_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
