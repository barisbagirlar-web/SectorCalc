// Auto-generated from brine-hesaplama-schema.json
import * as z from 'zod';

export interface Brine_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Brine_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Brine_hesaplamaInput): Record<string, number> {
...
export function calculateBrine_hesaplama(input: Brine_hesaplamaInput): Brine_hesaplamaOutput {
...
export interface Brine_hesaplamaOutput {
...
export const Brine_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
