// Auto-generated from turns-to-degrees-hesaplama-schema.json
import * as z from 'zod';

export interface Turns_to_degrees_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Turns_to_degrees_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Turns_to_degrees_hesaplamaInput): Record<string, number> {
...
export function calculateTurns_to_degrees_hesaplama(input: Turns_to_degrees_hesaplamaInput): Turns_to_degrees_hesaplamaOutput {
...
export interface Turns_to_degrees_hesaplamaOutput {
...
export const Turns_to_degrees_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
