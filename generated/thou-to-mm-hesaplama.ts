// Auto-generated from thou-to-mm-hesaplama-schema.json
import * as z from 'zod';

export interface Thou_to_mm_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Thou_to_mm_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Thou_to_mm_hesaplamaInput): Record<string, number> {
...
export function calculateThou_to_mm_hesaplama(input: Thou_to_mm_hesaplamaInput): Thou_to_mm_hesaplamaOutput {
...
export interface Thou_to_mm_hesaplamaOutput {
...
export const Thou_to_mm_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
