// Auto-generated from box-plot-hesaplama-schema.json
import * as z from 'zod';

export interface Box_plot_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Box_plot_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Box_plot_hesaplamaInput): Record<string, number> {
...
export function calculateBox_plot_hesaplama(input: Box_plot_hesaplamaInput): Box_plot_hesaplamaOutput {
...
export interface Box_plot_hesaplamaOutput {
...
export const Box_plot_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
