// Auto-generated from yg-hesaplayici-schema.json
import * as z from 'zod';

export interface Yg_hesaplayiciInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Yg_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Yg_hesaplayiciInput): Record<string, number> {
...
export function calculateYg_hesaplayici(input: Yg_hesaplayiciInput): Yg_hesaplayiciOutput {
...
export interface Yg_hesaplayiciOutput {
...
export const Yg_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "",
