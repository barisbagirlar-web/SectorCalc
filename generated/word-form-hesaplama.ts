// Auto-generated from word-form-hesaplama-schema.json
import * as z from 'zod';

export interface Word_form_hesaplamaInput {
  textInput: number;
  countValue: number;
  dataConfidence?: number;
}

export const Word_form_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Word_form_hesaplamaInput): Record<string, number> {
...
export function calculateWord_form_hesaplama(input: Word_form_hesaplamaInput): Word_form_hesaplamaOutput {
...
export interface Word_form_hesaplamaOutput {
...
export const Word_form_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "text",
