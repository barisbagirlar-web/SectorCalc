// Auto-generated from ybocs-hesaplama-schema.json
import * as z from 'zod';

export interface Ybocs_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Ybocs_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ybocs_hesaplamaInput): Record<string, number> {
...
export function calculateYbocs_hesaplama(input: Ybocs_hesaplamaInput): Ybocs_hesaplamaOutput {
...
export interface Ybocs_hesaplamaOutput {
...
export const Ybocs_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
