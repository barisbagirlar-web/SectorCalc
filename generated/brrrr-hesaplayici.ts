// Auto-generated from brrrr-hesaplayici-schema.json
import * as z from 'zod';

export interface Brrrr_hesaplayiciInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Brrrr_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Brrrr_hesaplayiciInput): Record<string, number> {
...
export function calculateBrrrr_hesaplayici(input: Brrrr_hesaplayiciInput): Brrrr_hesaplayiciOutput {
...
export interface Brrrr_hesaplayiciOutput {
...
export const Brrrr_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "",
