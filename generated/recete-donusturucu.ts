// Auto-generated from recete-donusturucu-schema.json
import * as z from 'zod';

export interface Recete_donusturucuInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Recete_donusturucuInputSchema = z.object({
...
function evaluateAllFormulas(input: Recete_donusturucuInput): Record<string, number> {
...
export function calculateRecete_donusturucu(input: Recete_donusturucuInput): Recete_donusturucuOutput {
...
export interface Recete_donusturucuOutput {
...
export const Recete_donusturucuOutputMeta = {
  primaryKey: "result",
  unit: "",
