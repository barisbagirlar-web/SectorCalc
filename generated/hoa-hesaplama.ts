// Auto-generated from hoa-hesaplama-schema.json
import * as z from 'zod';

export interface Hoa_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Hoa_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Hoa_hesaplamaInput): Record<string, number> {
...
export function calculateHoa_hesaplama(input: Hoa_hesaplamaInput): Hoa_hesaplamaOutput {
...
export interface Hoa_hesaplamaOutput {
...
export const Hoa_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
