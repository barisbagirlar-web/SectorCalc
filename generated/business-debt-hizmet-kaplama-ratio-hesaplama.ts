// Auto-generated from business-debt-hizmet-kaplama-ratio-hesaplama-schema.json
import * as z from 'zod';

export interface Business_debt_hizmet_kaplama_ratio_hesaplamaInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Business_debt_hizmet_kaplama_ratio_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Business_debt_hizmet_kaplama_ratio_hesaplamaInput): Record<string, number> {
...
export function calculateBusiness_debt_hizmet_kaplama_ratio_hesaplama(input: Business_debt_hizmet_kaplama_ratio_hesaplamaInput): Business_debt_hizmet_kaplama_ratio_hesaplamaOutput {
...
export interface Business_debt_hizmet_kaplama_ratio_hesaplamaOutput {
...
export const Business_debt_hizmet_kaplama_ratio_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
