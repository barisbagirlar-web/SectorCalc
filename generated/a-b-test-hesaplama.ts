// Auto-generated from a-b-test-hesaplama-schema.json
import * as z from 'zod';

export interface A_b_test_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const A_b_test_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: A_b_test_hesaplamaInput): Record<string, number> {
...
export function calculateA_b_test_hesaplama(input: A_b_test_hesaplamaInput): A_b_test_hesaplamaOutput {
...
export interface A_b_test_hesaplamaOutput {
...
export const A_b_test_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
