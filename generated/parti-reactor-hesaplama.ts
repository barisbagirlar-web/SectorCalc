// Auto-generated from parti-reactor-hesaplama-schema.json
import * as z from 'zod';

export interface Parti_reactor_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Parti_reactor_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Parti_reactor_hesaplamaInput): Record<string, number> {
...
export function calculateParti_reactor_hesaplama(input: Parti_reactor_hesaplamaInput): Parti_reactor_hesaplamaOutput {
...
export interface Parti_reactor_hesaplamaOutput {
...
export const Parti_reactor_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
