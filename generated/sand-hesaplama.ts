// Auto-generated from sand-hesaplama-schema.json
import * as z from 'zod';

export interface Sand_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Sand_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Sand_hesaplamaInput): Record<string, number> {
...
export function calculateSand_hesaplama(input: Sand_hesaplamaInput): Sand_hesaplamaOutput {
...
export interface Sand_hesaplamaOutput {
...
export const Sand_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
