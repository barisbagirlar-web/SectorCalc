// Auto-generated from kw-to-hp-hesaplama-schema.json
import * as z from 'zod';

export interface Kw_to_hp_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Kw_to_hp_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Kw_to_hp_hesaplamaInput): Record<string, number> {
...
export function calculateKw_to_hp_hesaplama(input: Kw_to_hp_hesaplamaInput): Kw_to_hp_hesaplamaOutput {
...
export interface Kw_to_hp_hesaplamaOutput {
...
export const Kw_to_hp_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
