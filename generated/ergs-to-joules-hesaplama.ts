// Auto-generated from ergs-to-joules-hesaplama-schema.json
import * as z from 'zod';

export interface Ergs_to_joules_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Ergs_to_joules_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ergs_to_joules_hesaplamaInput): Record<string, number> {
...
export function calculateErgs_to_joules_hesaplama(input: Ergs_to_joules_hesaplamaInput): Ergs_to_joules_hesaplamaOutput {
...
export interface Ergs_to_joules_hesaplamaOutput {
...
export const Ergs_to_joules_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
