// Auto-generated from percentile-hesaplama-schema.json
import * as z from 'zod';

export interface Percentile_hesaplamaInput {
  dataSet: number;
  sampleSize: number;
  dataConfidence?: number;
}

export const Percentile_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Percentile_hesaplamaInput): Record<string, number> {
...
export function calculatePercentile_hesaplama(input: Percentile_hesaplamaInput): Percentile_hesaplamaOutput {
...
export interface Percentile_hesaplamaOutput {
...
export const Percentile_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
