// Auto-generated from i-bond-hesaplama-schema.json
import * as z from 'zod';

export interface I_bond_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const I_bond_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: I_bond_hesaplamaInput): Record<string, number> {
...
export function calculateI_bond_hesaplama(input: I_bond_hesaplamaInput): I_bond_hesaplamaOutput {
...
export interface I_bond_hesaplamaOutput {
...
export const I_bond_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
