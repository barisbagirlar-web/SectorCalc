// Auto-generated from reverb-hesaplama-schema.json
import * as z from 'zod';

export interface Reverb_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Reverb_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Reverb_hesaplamaInput): Record<string, number> {
...
export function calculateReverb_hesaplama(input: Reverb_hesaplamaInput): Reverb_hesaplamaOutput {
...
export interface Reverb_hesaplamaOutput {
...
export const Reverb_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
