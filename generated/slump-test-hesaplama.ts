// Auto-generated from slump-test-hesaplama-schema.json
import * as z from 'zod';

export interface Slump_test_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Slump_test_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Slump_test_hesaplamaInput): Record<string, number> {
...
export function calculateSlump_test_hesaplama(input: Slump_test_hesaplamaInput): Slump_test_hesaplamaOutput {
...
export interface Slump_test_hesaplamaOutput {
...
export const Slump_test_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
