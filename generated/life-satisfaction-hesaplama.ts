// Auto-generated from life-satisfaction-hesaplama-schema.json
import * as z from 'zod';

export interface Life_satisfaction_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Life_satisfaction_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Life_satisfaction_hesaplamaInput): Record<string, number> {
...
export function calculateLife_satisfaction_hesaplama(input: Life_satisfaction_hesaplamaInput): Life_satisfaction_hesaplamaOutput {
...
export interface Life_satisfaction_hesaplamaOutput {
...
export const Life_satisfaction_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
