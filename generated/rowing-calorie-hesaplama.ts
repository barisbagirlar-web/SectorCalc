// Auto-generated from rowing-calorie-hesaplama-schema.json
import * as z from 'zod';

export interface Rowing_calorie_hesaplamaInput {
  bodyWeight: number;
  activityLevel: number;
  dataConfidence?: number;
}

export const Rowing_calorie_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Rowing_calorie_hesaplamaInput): Record<string, number> {
...
export function calculateRowing_calorie_hesaplama(input: Rowing_calorie_hesaplamaInput): Rowing_calorie_hesaplamaOutput {
...
export interface Rowing_calorie_hesaplamaOutput {
...
export const Rowing_calorie_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "kg",
