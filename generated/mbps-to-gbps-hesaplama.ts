// Auto-generated from mbps-to-gbps-hesaplama-schema.json
import * as z from 'zod';

export interface Mbps_to_gbps_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Mbps_to_gbps_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Mbps_to_gbps_hesaplamaInput): Record<string, number> {
...
export function calculateMbps_to_gbps_hesaplama(input: Mbps_to_gbps_hesaplamaInput): Mbps_to_gbps_hesaplamaOutput {
...
export interface Mbps_to_gbps_hesaplamaOutput {
...
export const Mbps_to_gbps_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
