// Auto-generated from radical-hesaplama-schema.json
import * as z from 'zod';

export interface Radical_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Radical_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Radical_hesaplamaInput): Record<string, number> {
...
export function calculateRadical_hesaplama(input: Radical_hesaplamaInput): Radical_hesaplamaOutput {
...
export interface Radical_hesaplamaOutput {
...
export const Radical_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
