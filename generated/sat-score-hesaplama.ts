// Auto-generated from sat-score-hesaplama-schema.json
import * as z from 'zod';

export interface Sat_score_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Sat_score_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Sat_score_hesaplamaInput): Record<string, number> {
...
export function calculateSat_score_hesaplama(input: Sat_score_hesaplamaInput): Sat_score_hesaplamaOutput {
...
export interface Sat_score_hesaplamaOutput {
...
export const Sat_score_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
