// Auto-generated from fret-hesaplama-schema.json
import * as z from 'zod';

export interface Fret_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Fret_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Fret_hesaplamaInput): Record<string, number> {
...
export function calculateFret_hesaplama(input: Fret_hesaplamaInput): Fret_hesaplamaOutput {
...
export interface Fret_hesaplamaOutput {
...
export const Fret_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
