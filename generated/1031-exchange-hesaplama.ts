// Auto-generated from 1031-exchange-hesaplama-schema.json
import * as z from 'zod';

export interface _1031_exchange_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const _1031_exchange_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: _1031_exchange_hesaplamaInput): Record<string, number> {
...
export function calculate_1031_exchange_hesaplama(input: _1031_exchange_hesaplamaInput): _1031_exchange_hesaplamaOutput {
...
export interface _1031_exchange_hesaplamaOutput {
...
export const _1031_exchange_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
