// Auto-generated from 5x5-hesaplama-schema.json
import * as z from 'zod';

export interface _5x5_hesaplamaInput {
  maxWeight: number;
  repCount: number;
  dataConfidence?: number;
}

export const _5x5_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: _5x5_hesaplamaInput): Record<string, number> {
...
export function calculate_5x5_hesaplama(input: _5x5_hesaplamaInput): _5x5_hesaplamaOutput {
...
export interface _5x5_hesaplamaOutput {
...
export const _5x5_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "kg",
