// Auto-generated from quilt-hesaplama-schema.json
import * as z from 'zod';

export interface Quilt_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Quilt_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Quilt_hesaplamaInput): Record<string, number> {
...
export function calculateQuilt_hesaplama(input: Quilt_hesaplamaInput): Quilt_hesaplamaOutput {
...
export interface Quilt_hesaplamaOutput {
...
export const Quilt_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
