// Auto-generated from plaster-hesaplama-schema.json
import * as z from 'zod';

export interface Plaster_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Plaster_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Plaster_hesaplamaInput): Record<string, number> {
...
export function calculatePlaster_hesaplama(input: Plaster_hesaplamaInput): Plaster_hesaplamaOutput {
...
export interface Plaster_hesaplamaOutput {
...
export const Plaster_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
