// Auto-generated from timi-score-hesaplama-schema.json
import * as z from 'zod';

export interface Timi_score_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Timi_score_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Timi_score_hesaplamaInput): Record<string, number> {
...
export function calculateTimi_score_hesaplama(input: Timi_score_hesaplamaInput): Timi_score_hesaplamaOutput {
...
export interface Timi_score_hesaplamaOutput {
...
export const Timi_score_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
