// Auto-generated from pascal-to-psi-hesaplama-schema.json
import * as z from 'zod';

export interface Pascal_to_psi_hesaplamaInput {
  pressureValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Pascal_to_psi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pascal_to_psi_hesaplamaInput): Record<string, number> {
...
export function calculatePascal_to_psi_hesaplama(input: Pascal_to_psi_hesaplamaInput): Pascal_to_psi_hesaplamaOutput {
...
export interface Pascal_to_psi_hesaplamaOutput {
...
export const Pascal_to_psi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "Pa",
