// Auto-generated from cm-to-mm-hesaplama-schema.json
import * as z from 'zod';

export interface Cm_to_mm_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Cm_to_mm_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cm_to_mm_hesaplamaInput): Record<string, number> {
...
export function calculateCm_to_mm_hesaplama(input: Cm_to_mm_hesaplamaInput): Cm_to_mm_hesaplamaOutput {
...
export interface Cm_to_mm_hesaplamaOutput {
...
export const Cm_to_mm_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
