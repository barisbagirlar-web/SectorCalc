// Auto-generated from final-grade-hesaplama-schema.json
import * as z from 'zod';

export interface Final_grade_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Final_grade_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Final_grade_hesaplamaInput): Record<string, number> {
...
export function calculateFinal_grade_hesaplama(input: Final_grade_hesaplamaInput): Final_grade_hesaplamaOutput {
...
export interface Final_grade_hesaplamaOutput {
...
export const Final_grade_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
