// Auto-generated from churn-oran-hesaplama-schema.json
import * as z from 'zod';

export interface Churn_oran_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Churn_oran_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Churn_oran_hesaplamaInput): Record<string, number> {
...
export function calculateChurn_oran_hesaplama(input: Churn_oran_hesaplamaInput): Churn_oran_hesaplamaOutput {
...
export interface Churn_oran_hesaplamaOutput {
...
export const Churn_oran_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
