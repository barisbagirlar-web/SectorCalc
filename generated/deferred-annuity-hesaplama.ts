// Auto-generated from deferred-annuity-hesaplama-schema.json
import * as z from 'zod';

export interface Deferred_annuity_hesaplamaInput {
  currentAge: number;
  retirementAge: number;
  dataConfidence?: number;
}

export const Deferred_annuity_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Deferred_annuity_hesaplamaInput): Record<string, number> {
...
export function calculateDeferred_annuity_hesaplama(input: Deferred_annuity_hesaplamaInput): Deferred_annuity_hesaplamaOutput {
...
export interface Deferred_annuity_hesaplamaOutput {
...
export const Deferred_annuity_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "years",
