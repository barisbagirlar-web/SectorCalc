// Auto-generated from visual-acuity-hesaplama-schema.json
import * as z from 'zod';

export interface Visual_acuity_hesaplamaInput {
  flowRate: number;
  pipeDiameter: number;
  dataConfidence?: number;
}

export const Visual_acuity_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Visual_acuity_hesaplamaInput): Record<string, number> {
...
export function calculateVisual_acuity_hesaplama(input: Visual_acuity_hesaplamaInput): Visual_acuity_hesaplamaOutput {
...
export interface Visual_acuity_hesaplamaOutput {
...
export const Visual_acuity_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "L/min",
