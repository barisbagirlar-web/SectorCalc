// Auto-generated from bus-fare-hesaplama-schema.json
import * as z from 'zod';

export interface Bus_fare_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Bus_fare_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Bus_fare_hesaplamaInput): Record<string, number> {
...
export function calculateBus_fare_hesaplama(input: Bus_fare_hesaplamaInput): Bus_fare_hesaplamaOutput {
...
export interface Bus_fare_hesaplamaOutput {
...
export const Bus_fare_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
