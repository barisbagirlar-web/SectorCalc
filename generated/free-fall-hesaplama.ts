// Auto-generated from free-fall-hesaplama-schema.json
import * as z from 'zod';

export interface Free_fall_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Free_fall_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Free_fall_hesaplamaInput): Record<string, number> {
...
export function calculateFree_fall_hesaplama(input: Free_fall_hesaplamaInput): Free_fall_hesaplamaOutput {
...
export interface Free_fall_hesaplamaOutput {
...
export const Free_fall_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
