// Auto-generated from psi-to-atm-hesaplama-schema.json
import * as z from 'zod';

export interface Psi_to_atm_hesaplamaInput {
  pressureValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Psi_to_atm_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Psi_to_atm_hesaplamaInput): Record<string, number> {
...
export function calculatePsi_to_atm_hesaplama(input: Psi_to_atm_hesaplamaInput): Psi_to_atm_hesaplamaOutput {
...
export interface Psi_to_atm_hesaplamaOutput {
...
export const Psi_to_atm_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "Pa",
