// Auto-generated from grams-to-ounces-hesaplama-schema.json
import * as z from 'zod';

export interface Grams_to_ounces_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Grams_to_ounces_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Grams_to_ounces_hesaplamaInput): Record<string, number> {
...
export function calculateGrams_to_ounces_hesaplama(input: Grams_to_ounces_hesaplamaInput): Grams_to_ounces_hesaplamaOutput {
...
export interface Grams_to_ounces_hesaplamaOutput {
...
export const Grams_to_ounces_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
