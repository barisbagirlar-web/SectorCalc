// Auto-generated from pension-hesaplama-schema.json
import * as z from 'zod';

export interface Pension_hesaplamaInput {
  currentAge: number;
  retirementAge: number;
  dataConfidence?: number;
}

export const Pension_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pension_hesaplamaInput): Record<string, number> {
...
export function calculatePension_hesaplama(input: Pension_hesaplamaInput): Pension_hesaplamaOutput {
...
export interface Pension_hesaplamaOutput {
...
export const Pension_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "years",
