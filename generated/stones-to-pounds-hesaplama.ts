// Auto-generated from stones-to-pounds-hesaplama-schema.json
import * as z from 'zod';

export interface Stones_to_pounds_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Stones_to_pounds_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Stones_to_pounds_hesaplamaInput): Record<string, number> {
...
export function calculateStones_to_pounds_hesaplama(input: Stones_to_pounds_hesaplamaInput): Stones_to_pounds_hesaplamaOutput {
...
export interface Stones_to_pounds_hesaplamaOutput {
...
export const Stones_to_pounds_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
