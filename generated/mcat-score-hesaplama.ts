// Auto-generated from mcat-score-hesaplama-schema.json
import * as z from 'zod';

export interface Mcat_score_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Mcat_score_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Mcat_score_hesaplamaInput): Record<string, number> {
...
export function calculateMcat_score_hesaplama(input: Mcat_score_hesaplamaInput): Mcat_score_hesaplamaOutput {
...
export interface Mcat_score_hesaplamaOutput {
...
export const Mcat_score_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
