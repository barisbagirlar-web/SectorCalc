// Auto-generated from probability-gacha-hesaplama-schema.json
import * as z from 'zod';

export interface Probability_gacha_hesaplamaInput {
  sampleMean: number;
  standardDeviation: number;
  dataConfidence?: number;
}

export const Probability_gacha_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Probability_gacha_hesaplamaInput): Record<string, number> {
...
export function calculateProbability_gacha_hesaplama(input: Probability_gacha_hesaplamaInput): Probability_gacha_hesaplamaOutput {
...
export interface Probability_gacha_hesaplamaOutput {
...
export const Probability_gacha_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
