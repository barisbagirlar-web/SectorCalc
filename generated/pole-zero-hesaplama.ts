// Auto-generated from pole-zero-hesaplama-schema.json
import * as z from 'zod';

export interface Pole_zero_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Pole_zero_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pole_zero_hesaplamaInput): Record<string, number> {
...
export function calculatePole_zero_hesaplama(input: Pole_zero_hesaplamaInput): Pole_zero_hesaplamaOutput {
...
export interface Pole_zero_hesaplamaOutput {
...
export const Pole_zero_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
