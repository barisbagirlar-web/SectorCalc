// Auto-generated from fit-hesaplama-schema.json
import * as z from 'zod';

export interface Fit_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Fit_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Fit_hesaplamaInput): Record<string, number> {
...
export function calculateFit_hesaplama(input: Fit_hesaplamaInput): Fit_hesaplamaOutput {
...
export interface Fit_hesaplamaOutput {
...
export const Fit_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
