// Auto-generated from 529-plan-hesaplama-schema.json
import * as z from 'zod';

export interface _529_plan_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const _529_plan_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: _529_plan_hesaplamaInput): Record<string, number> {
...
export function calculate_529_plan_hesaplama(input: _529_plan_hesaplamaInput): _529_plan_hesaplamaOutput {
...
export interface _529_plan_hesaplamaOutput {
...
export const _529_plan_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
