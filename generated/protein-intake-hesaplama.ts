// Auto-generated from protein-intake-hesaplama-schema.json
import * as z from 'zod';

export interface Protein_intake_hesaplamaInput {
  dailyCalories: number;
  bodyMass: number;
  dataConfidence?: number;
}

export const Protein_intake_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Protein_intake_hesaplamaInput): Record<string, number> {
...
export function calculateProtein_intake_hesaplama(input: Protein_intake_hesaplamaInput): Protein_intake_hesaplamaOutput {
...
export interface Protein_intake_hesaplamaOutput {
...
export const Protein_intake_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "kcal",
