// Auto-generated from cstr-hesaplama-schema.json
import * as z from 'zod';

export interface Cstr_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Cstr_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cstr_hesaplamaInput): Record<string, number> {
...
export function calculateCstr_hesaplama(input: Cstr_hesaplamaInput): Cstr_hesaplamaOutput {
...
export interface Cstr_hesaplamaOutput {
...
export const Cstr_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
