// Auto-generated from kg-to-tons-hesaplama-schema.json
import * as z from 'zod';

export interface Kg_to_tons_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Kg_to_tons_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Kg_to_tons_hesaplamaInput): Record<string, number> {
...
export function calculateKg_to_tons_hesaplama(input: Kg_to_tons_hesaplamaInput): Kg_to_tons_hesaplamaOutput {
...
export interface Kg_to_tons_hesaplamaOutput {
...
export const Kg_to_tons_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
