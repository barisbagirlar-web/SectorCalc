// Auto-generated from smoothie-hesaplama-schema.json
import * as z from 'zod';

export interface Smoothie_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Smoothie_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Smoothie_hesaplamaInput): Record<string, number> {
...
export function calculateSmoothie_hesaplama(input: Smoothie_hesaplamaInput): Smoothie_hesaplamaOutput {
...
export interface Smoothie_hesaplamaOutput {
...
export const Smoothie_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
