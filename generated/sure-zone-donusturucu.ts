// Auto-generated from sure-zone-donusturucu-schema.json
import * as z from 'zod';

export interface Sure_zone_donusturucuInput {
  timeValue: number;
  frequency: number;
  dataConfidence?: number;
}

export const Sure_zone_donusturucuInputSchema = z.object({
...
function evaluateAllFormulas(input: Sure_zone_donusturucuInput): Record<string, number> {
...
export function calculateSure_zone_donusturucu(input: Sure_zone_donusturucuInput): Sure_zone_donusturucuOutput {
...
export interface Sure_zone_donusturucuOutput {
...
export const Sure_zone_donusturucuOutputMeta = {
  primaryKey: "result",
  unit: "min",
