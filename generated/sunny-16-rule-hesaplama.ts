// Auto-generated from sunny-16-rule-hesaplama-schema.json
import * as z from 'zod';

export interface Sunny_16_rule_hesaplamaInput {
  totalValue: number;
  percentage: number;
  dataConfidence?: number;
}

export const Sunny_16_rule_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Sunny_16_rule_hesaplamaInput): Record<string, number> {
...
export function calculateSunny_16_rule_hesaplama(input: Sunny_16_rule_hesaplamaInput): Sunny_16_rule_hesaplamaOutput {
...
export interface Sunny_16_rule_hesaplamaOutput {
...
export const Sunny_16_rule_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "%",
