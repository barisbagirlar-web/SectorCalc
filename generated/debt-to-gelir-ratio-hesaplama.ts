// Auto-generated from debt-to-gelir-ratio-hesaplama-schema.json
import * as z from 'zod';

export interface Debt_to_gelir_ratio_hesaplamaInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Debt_to_gelir_ratio_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Debt_to_gelir_ratio_hesaplamaInput): Record<string, number> {
...
export function calculateDebt_to_gelir_ratio_hesaplama(input: Debt_to_gelir_ratio_hesaplamaInput): Debt_to_gelir_ratio_hesaplamaOutput {
...
export interface Debt_to_gelir_ratio_hesaplamaOutput {
...
export const Debt_to_gelir_ratio_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
