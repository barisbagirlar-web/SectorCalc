// Auto-generated from ka-hesaplama-schema.json
import * as z from 'zod';

export interface Ka_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Ka_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ka_hesaplamaInput): Record<string, number> {
...
export function calculateKa_hesaplama(input: Ka_hesaplamaInput): Ka_hesaplamaOutput {
...
export interface Ka_hesaplamaOutput {
...
export const Ka_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
