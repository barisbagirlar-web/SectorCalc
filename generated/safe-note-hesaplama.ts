// Auto-generated from safe-note-hesaplama-schema.json
import * as z from 'zod';

export interface Safe_note_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Safe_note_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Safe_note_hesaplamaInput): Record<string, number> {
...
export function calculateSafe_note_hesaplama(input: Safe_note_hesaplamaInput): Safe_note_hesaplamaOutput {
...
export interface Safe_note_hesaplamaOutput {
...
export const Safe_note_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
