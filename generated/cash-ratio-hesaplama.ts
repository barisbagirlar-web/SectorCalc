// Auto-generated from cash-ratio-hesaplama-schema.json
import * as z from 'zod';

export interface Cash_ratio_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Cash_ratio_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cash_ratio_hesaplamaInput): Record<string, number> {
...
export function calculateCash_ratio_hesaplama(input: Cash_ratio_hesaplamaInput): Cash_ratio_hesaplamaOutput {
...
export interface Cash_ratio_hesaplamaOutput {
...
export const Cash_ratio_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
