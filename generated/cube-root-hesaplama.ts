// Auto-generated from cube-root-hesaplama-schema.json
import * as z from 'zod';

export interface Cube_root_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Cube_root_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cube_root_hesaplamaInput): Record<string, number> {
...
export function calculateCube_root_hesaplama(input: Cube_root_hesaplamaInput): Cube_root_hesaplamaOutput {
...
export interface Cube_root_hesaplamaOutput {
...
export const Cube_root_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
