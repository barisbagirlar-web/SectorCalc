// Auto-generated from drag-hesaplama-schema.json
import * as z from 'zod';

export interface Drag_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Drag_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Drag_hesaplamaInput): Record<string, number> {
...
export function calculateDrag_hesaplama(input: Drag_hesaplamaInput): Drag_hesaplamaOutput {
...
export interface Drag_hesaplamaOutput {
...
export const Drag_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
