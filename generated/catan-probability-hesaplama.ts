// Auto-generated from catan-probability-hesaplama-schema.json
import * as z from 'zod';

export interface Catan_probability_hesaplamaInput {
  sampleMean: number;
  standardDeviation: number;
  dataConfidence?: number;
}

export const Catan_probability_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Catan_probability_hesaplamaInput): Record<string, number> {
...
export function calculateCatan_probability_hesaplama(input: Catan_probability_hesaplamaInput): Catan_probability_hesaplamaOutput {
...
export interface Catan_probability_hesaplamaOutput {
...
export const Catan_probability_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
