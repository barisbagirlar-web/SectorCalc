// Auto-generated from ldl-hesaplama-schema.json
import * as z from 'zod';

export interface Ldl_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Ldl_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ldl_hesaplamaInput): Record<string, number> {
...
export function calculateLdl_hesaplama(input: Ldl_hesaplamaInput): Ldl_hesaplamaOutput {
...
export interface Ldl_hesaplamaOutput {
...
export const Ldl_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
