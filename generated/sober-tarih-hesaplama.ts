// Auto-generated from sober-tarih-hesaplama-schema.json
import * as z from 'zod';

export interface Sober_tarih_hesaplamaInput {
  birthDate: number;
  referenceDate: number;
  dataConfidence?: number;
}

export const Sober_tarih_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Sober_tarih_hesaplamaInput): Record<string, number> {
...
export function calculateSober_tarih_hesaplama(input: Sober_tarih_hesaplamaInput): Sober_tarih_hesaplamaOutput {
...
export interface Sober_tarih_hesaplamaOutput {
...
export const Sober_tarih_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "date",
