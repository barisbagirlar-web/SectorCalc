// Auto-generated from fft-hesaplama-schema.json
import * as z from 'zod';

export interface Fft_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Fft_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Fft_hesaplamaInput): Record<string, number> {
...
export function calculateFft_hesaplama(input: Fft_hesaplamaInput): Fft_hesaplamaOutput {
...
export interface Fft_hesaplamaOutput {
...
export const Fft_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
