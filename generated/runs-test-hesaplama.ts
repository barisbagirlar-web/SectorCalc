// Auto-generated from runs-test-hesaplama-schema.json
import * as z from 'zod';

export interface Runs_test_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Runs_test_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Runs_test_hesaplamaInput): Record<string, number> {
...
export function calculateRuns_test_hesaplama(input: Runs_test_hesaplamaInput): Runs_test_hesaplamaOutput {
...
export interface Runs_test_hesaplamaOutput {
...
export const Runs_test_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
