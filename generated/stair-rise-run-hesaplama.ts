// Auto-generated from stair-rise-run-hesaplama-schema.json
import * as z from 'zod';

export interface Stair_rise_run_hesaplamaInput {
  distanceKm: number;
  durationMin: number;
  dataConfidence?: number;
}

export const Stair_rise_run_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Stair_rise_run_hesaplamaInput): Record<string, number> {
...
export function calculateStair_rise_run_hesaplama(input: Stair_rise_run_hesaplamaInput): Stair_rise_run_hesaplamaOutput {
...
export interface Stair_rise_run_hesaplamaOutput {
...
export const Stair_rise_run_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "km",
