// Auto-generated from phq-9-hesaplama-schema.json
import * as z from 'zod';

export interface Phq_9_hesaplamaInput {
  stressScore: number;
  dataConfidence?: number;
}

export const Phq_9_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Phq_9_hesaplamaInput): Record<string, number> {
...
export function calculatePhq_9_hesaplama(input: Phq_9_hesaplamaInput): Phq_9_hesaplamaOutput {
...
export interface Phq_9_hesaplamaOutput {
...
export const Phq_9_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "points",
