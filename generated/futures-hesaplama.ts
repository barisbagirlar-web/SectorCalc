// Auto-generated from futures-hesaplama-schema.json
import * as z from 'zod';

export interface Futures_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Futures_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Futures_hesaplamaInput): Record<string, number> {
...
export function calculateFutures_hesaplama(input: Futures_hesaplamaInput): Futures_hesaplamaOutput {
...
export interface Futures_hesaplamaOutput {
...
export const Futures_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
