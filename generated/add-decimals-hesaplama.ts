// Auto-generated from add-decimals-hesaplama-schema.json
import * as z from 'zod';

export interface Add_decimals_hesaplamaInput {
  numerator: number;
  denominator: number;
  dataConfidence?: number;
}

export const Add_decimals_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Add_decimals_hesaplamaInput): Record<string, number> {
...
export function calculateAdd_decimals_hesaplama(input: Add_decimals_hesaplamaInput): Add_decimals_hesaplamaOutput {
...
export interface Add_decimals_hesaplamaOutput {
...
export const Add_decimals_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
