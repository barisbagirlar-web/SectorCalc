// Auto-generated from kurtosis-hesaplama-schema.json
import * as z from 'zod';

export interface Kurtosis_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Kurtosis_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Kurtosis_hesaplamaInput): Record<string, number> {
...
export function calculateKurtosis_hesaplama(input: Kurtosis_hesaplamaInput): Kurtosis_hesaplamaOutput {
...
export interface Kurtosis_hesaplamaOutput {
...
export const Kurtosis_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
