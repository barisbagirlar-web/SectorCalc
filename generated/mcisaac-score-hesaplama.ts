// Auto-generated from mcisaac-score-hesaplama-schema.json
import * as z from 'zod';

export interface Mcisaac_score_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Mcisaac_score_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Mcisaac_score_hesaplamaInput): Record<string, number> {
...
export function calculateMcisaac_score_hesaplama(input: Mcisaac_score_hesaplamaInput): Mcisaac_score_hesaplamaOutput {
...
export interface Mcisaac_score_hesaplamaOutput {
...
export const Mcisaac_score_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
