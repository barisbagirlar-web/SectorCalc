// Auto-generated from simpson-rule-hesaplama-schema.json
import * as z from 'zod';

export interface Simpson_rule_hesaplamaInput {
  totalValue: number;
  percentage: number;
  dataConfidence?: number;
}

export const Simpson_rule_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Simpson_rule_hesaplamaInput): Record<string, number> {
...
export function calculateSimpson_rule_hesaplama(input: Simpson_rule_hesaplamaInput): Simpson_rule_hesaplamaOutput {
...
export interface Simpson_rule_hesaplamaOutput {
...
export const Simpson_rule_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "%",
