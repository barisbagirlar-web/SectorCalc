// Auto-generated from graph-theory-hesaplama-schema.json
import * as z from 'zod';

export interface Graph_theory_hesaplamaInput {
  matrixSize: number;
  matrixElement: number;
  dataConfidence?: number;
}

export const Graph_theory_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Graph_theory_hesaplamaInput): Record<string, number> {
...
export function calculateGraph_theory_hesaplama(input: Graph_theory_hesaplamaInput): Graph_theory_hesaplamaOutput {
...
export interface Graph_theory_hesaplamaOutput {
...
export const Graph_theory_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
