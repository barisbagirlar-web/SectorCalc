// Auto-generated from gear-hesaplama-schema.json
import * as z from 'zod';

export interface Gear_hesaplamaInput {
  materialStrength: number;
  dataConfidence?: number;
}

export const Gear_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Gear_hesaplamaInput): Record<string, number> {
...
export function calculateGear_hesaplama(input: Gear_hesaplamaInput): Gear_hesaplamaOutput {
...
export interface Gear_hesaplamaOutput {
...
export const Gear_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "MPa",
