// Auto-generated from olasilik-hesaplayici-schema.json
import * as z from 'zod';

export interface Olasilik_hesaplayiciInput {
  sampleMean: number;
  standardDeviation: number;
  dataConfidence?: number;
}

export const Olasilik_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Olasilik_hesaplayiciInput): Record<string, number> {
...
export function calculateOlasilik_hesaplayici(input: Olasilik_hesaplayiciInput): Olasilik_hesaplayiciOutput {
...
export interface Olasilik_hesaplayiciOutput {
...
export const Olasilik_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "",
