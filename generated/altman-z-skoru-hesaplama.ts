// Auto-generated from altman-z-skoru-hesaplama-schema.json
import * as z from 'zod';

export interface Altman_z_skoru_hesaplamaInput {
  sampleMean: number;
  standardDeviation: number;
  dataConfidence?: number;
}

export const Altman_z_skoru_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Altman_z_skoru_hesaplamaInput): Record<string, number> {
...
export function calculateAltman_z_skoru_hesaplama(input: Altman_z_skoru_hesaplamaInput): Altman_z_skoru_hesaplamaOutput {
...
export interface Altman_z_skoru_hesaplamaOutput {
...
export const Altman_z_skoru_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
