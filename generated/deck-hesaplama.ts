// Auto-generated from deck-hesaplama-schema.json
import * as z from 'zod';

export interface Deck_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Deck_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Deck_hesaplamaInput): Record<string, number> {
...
export function calculateDeck_hesaplama(input: Deck_hesaplamaInput): Deck_hesaplamaOutput {
...
export interface Deck_hesaplamaOutput {
...
export const Deck_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
