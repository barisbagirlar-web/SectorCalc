// Auto-generated from snr-hesaplama-schema.json
import * as z from 'zod';

export interface Snr_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Snr_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Snr_hesaplamaInput): Record<string, number> {
...
export function calculateSnr_hesaplama(input: Snr_hesaplamaInput): Snr_hesaplamaOutput {
...
export interface Snr_hesaplamaOutput {
...
export const Snr_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
