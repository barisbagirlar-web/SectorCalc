// Auto-generated from makeup-hesaplama-schema.json
import * as z from 'zod';

export interface Makeup_hesaplamaInput {
  skinTypeScore: number;
  treatmentIntensity: number;
  dataConfidence?: number;
}

export const Makeup_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Makeup_hesaplamaInput): Record<string, number> {
...
export function calculateMakeup_hesaplama(input: Makeup_hesaplamaInput): Makeup_hesaplamaOutput {
...
export interface Makeup_hesaplamaOutput {
...
export const Makeup_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "points",
