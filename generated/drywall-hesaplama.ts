// Auto-generated from drywall-hesaplama-schema.json
import * as z from 'zod';

export interface Drywall_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Drywall_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Drywall_hesaplamaInput): Record<string, number> {
...
export function calculateDrywall_hesaplama(input: Drywall_hesaplamaInput): Drywall_hesaplamaOutput {
...
export interface Drywall_hesaplamaOutput {
...
export const Drywall_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
