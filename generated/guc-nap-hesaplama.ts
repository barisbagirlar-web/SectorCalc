// Auto-generated from guc-nap-hesaplama-schema.json
import * as z from 'zod';

export interface Guc_nap_hesaplamaInput {
  powerValue: number;
  timeDuration: number;
  dataConfidence?: number;
}

export const Guc_nap_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Guc_nap_hesaplamaInput): Record<string, number> {
...
export function calculateGuc_nap_hesaplama(input: Guc_nap_hesaplamaInput): Guc_nap_hesaplamaOutput {
...
export interface Guc_nap_hesaplamaOutput {
...
export const Guc_nap_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "W",
