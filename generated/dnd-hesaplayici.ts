// Auto-generated from dnd-hesaplayici-schema.json
import * as z from 'zod';

export interface Dnd_hesaplayiciInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Dnd_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Dnd_hesaplayiciInput): Record<string, number> {
...
export function calculateDnd_hesaplayici(input: Dnd_hesaplayiciInput): Dnd_hesaplayiciOutput {
...
export interface Dnd_hesaplayiciOutput {
...
export const Dnd_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "",
