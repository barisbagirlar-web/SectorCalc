// Auto-generated from poker-probability-hesaplama-schema.json
import * as z from 'zod';

export interface Poker_probability_hesaplamaInput {
  sampleMean: number;
  standardDeviation: number;
  dataConfidence?: number;
}

export const Poker_probability_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Poker_probability_hesaplamaInput): Record<string, number> {
...
export function calculatePoker_probability_hesaplama(input: Poker_probability_hesaplamaInput): Poker_probability_hesaplamaOutput {
...
export interface Poker_probability_hesaplamaOutput {
...
export const Poker_probability_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
