// Auto-generated from birim-vector-hesaplama-schema.json
import * as z from 'zod';

export interface Birim_vector_hesaplamaInput {
  matrixSize: number;
  matrixElement: number;
  dataConfidence?: number;
}

export const Birim_vector_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Birim_vector_hesaplamaInput): Record<string, number> {
...
export function calculateBirim_vector_hesaplama(input: Birim_vector_hesaplamaInput): Birim_vector_hesaplamaOutput {
...
export interface Birim_vector_hesaplamaOutput {
...
export const Birim_vector_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
