// Auto-generated from net-worth-hesaplama-schema.json
import * as z from 'zod';

export interface Net_worth_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Net_worth_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Net_worth_hesaplamaInput): Record<string, number> {
...
export function calculateNet_worth_hesaplama(input: Net_worth_hesaplamaInput): Net_worth_hesaplamaOutput {
...
export interface Net_worth_hesaplamaOutput {
...
export const Net_worth_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
