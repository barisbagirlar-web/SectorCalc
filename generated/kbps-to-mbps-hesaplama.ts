// Auto-generated from kbps-to-mbps-hesaplama-schema.json
import * as z from 'zod';

export interface Kbps_to_mbps_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Kbps_to_mbps_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Kbps_to_mbps_hesaplamaInput): Record<string, number> {
...
export function calculateKbps_to_mbps_hesaplama(input: Kbps_to_mbps_hesaplamaInput): Kbps_to_mbps_hesaplamaOutput {
...
export interface Kbps_to_mbps_hesaplamaOutput {
...
export const Kbps_to_mbps_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
