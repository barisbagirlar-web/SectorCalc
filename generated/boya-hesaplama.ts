// Auto-generated from boya-hesaplama-schema.json
import * as z from 'zod';

export interface Boya_hesaplamaInput {
  lengthValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Boya_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Boya_hesaplamaInput): Record<string, number> {
...
export function calculateBoya_hesaplama(input: Boya_hesaplamaInput): Boya_hesaplamaOutput {
...
export interface Boya_hesaplamaOutput {
...
export const Boya_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "m",
