// Auto-generated from oran-law-hesaplama-schema.json
import * as z from 'zod';

export interface Oran_law_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Oran_law_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Oran_law_hesaplamaInput): Record<string, number> {
...
export function calculateOran_law_hesaplama(input: Oran_law_hesaplamaInput): Oran_law_hesaplamaOutput {
...
export interface Oran_law_hesaplamaOutput {
...
export const Oran_law_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
