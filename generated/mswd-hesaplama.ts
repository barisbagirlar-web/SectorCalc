// Auto-generated from mswd-hesaplama-schema.json
import * as z from 'zod';

export interface Mswd_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Mswd_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Mswd_hesaplamaInput): Record<string, number> {
...
export function calculateMswd_hesaplama(input: Mswd_hesaplamaInput): Mswd_hesaplamaOutput {
...
export interface Mswd_hesaplamaOutput {
...
export const Mswd_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
