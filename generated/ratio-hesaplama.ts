// Auto-generated from ratio-hesaplama-schema.json
import * as z from 'zod';

export interface Ratio_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Ratio_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ratio_hesaplamaInput): Record<string, number> {
...
export function calculateRatio_hesaplama(input: Ratio_hesaplamaInput): Ratio_hesaplamaOutput {
...
export interface Ratio_hesaplamaOutput {
...
export const Ratio_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
