...
function evaluateAllFormulas(input: Vbac_success_calculatorInput): Record<string, number | string> {
  const results: Record<string, number | string> = {};
  try { const v = -3.5 + 0.05 * input.maternalAge + 0.1 * input.bmi - 1.2 * input.prevVaginalBirth + 1.5 * input.prevCSIndication + 0.2 * input.gestationalAge + 0.3 * input.cervicalDilation; results["_3_5___0_05___maternalAge___0_1___bmi___"] = typeof v === "number" ? (Number.isFinite(v) ? v : 0) : typeof v === "string" ? v : 0; } catch { results["_3_5___0_05___maternalAge___0_1___bmi___"] = 0; }
  try { const v = -3.5 + 0.05 * input.maternalAge + 0.1 * input.bmi - 1.2 * input.prevVaginalBirth + 1.5 * input.prevCSIndication + 0.2 * input.gestationalAge + 0.3 * input.cervicalDilation; results["_3_5___0_05___maternalAge___0_1___bmi____aux"] = typeof v === "number" ? (Number.isFinite(v) ? v : 0) : typeof v === "string" ? v : 0; } catch { results["_3_5___0_05___maternalAge___0_1___bmi____aux"] = 0; }
  return results;
}
