// Auto-generated from kredi-payoff-hesaplama-schema.json
import * as z from 'zod';

export interface Kredi_payoff_hesaplamaInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Kredi_payoff_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Kredi_payoff_hesaplamaInput): Record<string, number> {
...
export function calculateKredi_payoff_hesaplama(input: Kredi_payoff_hesaplamaInput): Kredi_payoff_hesaplamaOutput {
...
export interface Kredi_payoff_hesaplamaOutput {
...
export const Kredi_payoff_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
