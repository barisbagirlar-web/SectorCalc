// Auto-generated from concentration-hesaplama-schema.json
import * as z from 'zod';

export interface Concentration_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Concentration_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Concentration_hesaplamaInput): Record<string, number> {
...
export function calculateConcentration_hesaplama(input: Concentration_hesaplamaInput): Concentration_hesaplamaOutput {
...
export interface Concentration_hesaplamaOutput {
...
export const Concentration_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
