// Auto-generated from pecks-to-litre-hesaplama-schema.json
import * as z from 'zod';

export interface Pecks_to_litre_hesaplamaInput {
  volumeValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Pecks_to_litre_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pecks_to_litre_hesaplamaInput): Record<string, number> {
...
export function calculatePecks_to_litre_hesaplama(input: Pecks_to_litre_hesaplamaInput): Pecks_to_litre_hesaplamaOutput {
...
export interface Pecks_to_litre_hesaplamaOutput {
...
export const Pecks_to_litre_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "m³",
