// Auto-generated from dst-hesaplama-schema.json
import * as z from 'zod';

export interface Dst_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Dst_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Dst_hesaplamaInput): Record<string, number> {
...
export function calculateDst_hesaplama(input: Dst_hesaplamaInput): Dst_hesaplamaOutput {
...
export interface Dst_hesaplamaOutput {
...
export const Dst_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
