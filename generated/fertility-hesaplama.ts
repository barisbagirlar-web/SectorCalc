// Auto-generated from fertility-hesaplama-schema.json
import * as z from 'zod';

export interface Fertility_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Fertility_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Fertility_hesaplamaInput): Record<string, number> {
...
export function calculateFertility_hesaplama(input: Fertility_hesaplamaInput): Fertility_hesaplamaOutput {
...
export interface Fertility_hesaplamaOutput {
...
export const Fertility_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
