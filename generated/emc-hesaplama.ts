// Auto-generated from emc-hesaplama-schema.json
import * as z from 'zod';

export interface Emc_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Emc_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Emc_hesaplamaInput): Record<string, number> {
...
export function calculateEmc_hesaplama(input: Emc_hesaplamaInput): Emc_hesaplamaOutput {
...
export interface Emc_hesaplamaOutput {
...
export const Emc_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
