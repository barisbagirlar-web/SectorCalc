// Auto-generated from ari-hesaplama-schema.json
import * as z from 'zod';

export interface Ari_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Ari_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ari_hesaplamaInput): Record<string, number> {
...
export function calculateAri_hesaplama(input: Ari_hesaplamaInput): Ari_hesaplamaOutput {
...
export interface Ari_hesaplamaOutput {
...
export const Ari_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
