// Auto-generated from ivf-due-tarih-hesaplama-schema.json
import * as z from 'zod';

export interface Ivf_due_tarih_hesaplamaInput {
  birthDate: number;
  referenceDate: number;
  dataConfidence?: number;
}

export const Ivf_due_tarih_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ivf_due_tarih_hesaplamaInput): Record<string, number> {
...
export function calculateIvf_due_tarih_hesaplama(input: Ivf_due_tarih_hesaplamaInput): Ivf_due_tarih_hesaplamaOutput {
...
export interface Ivf_due_tarih_hesaplamaOutput {
...
export const Ivf_due_tarih_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "date",
