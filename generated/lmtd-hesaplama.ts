// Auto-generated from lmtd-hesaplama-schema.json
import * as z from 'zod';

export interface Lmtd_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Lmtd_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Lmtd_hesaplamaInput): Record<string, number> {
...
export function calculateLmtd_hesaplama(input: Lmtd_hesaplamaInput): Lmtd_hesaplamaOutput {
...
export interface Lmtd_hesaplamaOutput {
...
export const Lmtd_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
