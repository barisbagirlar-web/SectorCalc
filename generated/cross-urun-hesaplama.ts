// Auto-generated from cross-urun-hesaplama-schema.json
import * as z from 'zod';

export interface Cross_urun_hesaplamaInput {
  fieldArea: number;
  yieldPerArea: number;
  dataConfidence?: number;
}

export const Cross_urun_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cross_urun_hesaplamaInput): Record<string, number> {
...
export function calculateCross_urun_hesaplama(input: Cross_urun_hesaplamaInput): Cross_urun_hesaplamaOutput {
...
export interface Cross_urun_hesaplamaOutput {
...
export const Cross_urun_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "m²",
