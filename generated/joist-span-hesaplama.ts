// Auto-generated from joist-span-hesaplama-schema.json
import * as z from 'zod';

export interface Joist_span_hesaplamaInput {
  skinTypeScore: number;
  treatmentIntensity: number;
  dataConfidence?: number;
}

export const Joist_span_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Joist_span_hesaplamaInput): Record<string, number> {
...
export function calculateJoist_span_hesaplama(input: Joist_span_hesaplamaInput): Joist_span_hesaplamaOutput {
...
export interface Joist_span_hesaplamaOutput {
...
export const Joist_span_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "points",
