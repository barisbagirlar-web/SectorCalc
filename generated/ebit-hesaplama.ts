// Auto-generated from ebit-hesaplama-schema.json
import * as z from 'zod';

export interface Ebit_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Ebit_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ebit_hesaplamaInput): Record<string, number> {
...
export function calculateEbit_hesaplama(input: Ebit_hesaplamaInput): Ebit_hesaplamaOutput {
...
export interface Ebit_hesaplamaOutput {
...
export const Ebit_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
