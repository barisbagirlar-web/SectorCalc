// Auto-generated from cortisol-hesaplama-schema.json
import * as z from 'zod';

export interface Cortisol_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Cortisol_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cortisol_hesaplamaInput): Record<string, number> {
...
export function calculateCortisol_hesaplama(input: Cortisol_hesaplamaInput): Cortisol_hesaplamaOutput {
...
export interface Cortisol_hesaplamaOutput {
...
export const Cortisol_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
