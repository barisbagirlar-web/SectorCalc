// Auto-generated from gmat-score-hesaplama-schema.json
import * as z from 'zod';

export interface Gmat_score_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Gmat_score_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Gmat_score_hesaplamaInput): Record<string, number> {
...
export function calculateGmat_score_hesaplama(input: Gmat_score_hesaplamaInput): Gmat_score_hesaplamaOutput {
...
export interface Gmat_score_hesaplamaOutput {
...
export const Gmat_score_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
