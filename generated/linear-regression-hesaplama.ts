// Auto-generated from linear-regression-hesaplama-schema.json
import * as z from 'zod';

export interface Linear_regression_hesaplamaInput {
  sampleMean: number;
  standardDeviation: number;
  dataConfidence?: number;
}

export const Linear_regression_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Linear_regression_hesaplamaInput): Record<string, number> {
...
export function calculateLinear_regression_hesaplama(input: Linear_regression_hesaplamaInput): Linear_regression_hesaplamaOutput {
...
export interface Linear_regression_hesaplamaOutput {
...
export const Linear_regression_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
