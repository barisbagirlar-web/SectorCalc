// Auto-generated from noom-calorie-hesaplama-schema.json
import * as z from 'zod';

export interface Noom_calorie_hesaplamaInput {
  bodyWeight: number;
  activityLevel: number;
  dataConfidence?: number;
}

export const Noom_calorie_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Noom_calorie_hesaplamaInput): Record<string, number> {
...
export function calculateNoom_calorie_hesaplama(input: Noom_calorie_hesaplamaInput): Noom_calorie_hesaplamaOutput {
...
export interface Noom_calorie_hesaplamaOutput {
...
export const Noom_calorie_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "kg",
