// Auto-generated from julian-tarih-hesaplama-schema.json
import * as z from 'zod';

export interface Julian_tarih_hesaplamaInput {
  birthDate: number;
  referenceDate: number;
  dataConfidence?: number;
}

export const Julian_tarih_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Julian_tarih_hesaplamaInput): Record<string, number> {
...
export function calculateJulian_tarih_hesaplama(input: Julian_tarih_hesaplamaInput): Julian_tarih_hesaplamaOutput {
...
export interface Julian_tarih_hesaplamaOutput {
...
export const Julian_tarih_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "date",
