// Auto-generated from octal-hesaplama-schema.json
import * as z from 'zod';

export interface Octal_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Octal_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Octal_hesaplamaInput): Record<string, number> {
...
export function calculateOctal_hesaplama(input: Octal_hesaplamaInput): Octal_hesaplamaOutput {
...
export interface Octal_hesaplamaOutput {
...
export const Octal_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
