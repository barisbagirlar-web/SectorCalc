// Auto-generated from cumulative-gpa-hesaplama-schema.json
import * as z from 'zod';

export interface Cumulative_gpa_hesaplamaInput {
  gradePoints: number;
  creditHours: number;
  dataConfidence?: number;
}

export const Cumulative_gpa_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cumulative_gpa_hesaplamaInput): Record<string, number> {
...
export function calculateCumulative_gpa_hesaplama(input: Cumulative_gpa_hesaplamaInput): Cumulative_gpa_hesaplamaOutput {
...
export interface Cumulative_gpa_hesaplamaOutput {
...
export const Cumulative_gpa_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "points",
