// Auto-generated from dielectric-hesaplama-schema.json
import * as z from 'zod';

export interface Dielectric_hesaplamaInput {
  powerValue: number;
  timeDuration: number;
  dataConfidence?: number;
}

export const Dielectric_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Dielectric_hesaplamaInput): Record<string, number> {
...
export function calculateDielectric_hesaplama(input: Dielectric_hesaplamaInput): Dielectric_hesaplamaOutput {
...
export interface Dielectric_hesaplamaOutput {
...
export const Dielectric_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "W",
