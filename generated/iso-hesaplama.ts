// Auto-generated from iso-hesaplama-schema.json
import * as z from 'zod';

export interface Iso_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Iso_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Iso_hesaplamaInput): Record<string, number> {
...
export function calculateIso_hesaplama(input: Iso_hesaplamaInput): Iso_hesaplamaOutput {
...
export interface Iso_hesaplamaOutput {
...
export const Iso_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
