// Auto-generated from boat-kredi-hesaplama-schema.json
import * as z from 'zod';

export interface Boat_kredi_hesaplamaInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Boat_kredi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Boat_kredi_hesaplamaInput): Record<string, number> {
...
export function calculateBoat_kredi_hesaplama(input: Boat_kredi_hesaplamaInput): Boat_kredi_hesaplamaOutput {
...
export interface Boat_kredi_hesaplamaOutput {
...
export const Boat_kredi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
