// Auto-generated from thd-hesaplama-schema.json
import * as z from 'zod';

export interface Thd_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Thd_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Thd_hesaplamaInput): Record<string, number> {
...
export function calculateThd_hesaplama(input: Thd_hesaplamaInput): Thd_hesaplamaOutput {
...
export interface Thd_hesaplamaOutput {
...
export const Thd_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
