// Auto-generated from curl-hesaplama-schema.json
import * as z from 'zod';

export interface Curl_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Curl_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Curl_hesaplamaInput): Record<string, number> {
...
export function calculateCurl_hesaplama(input: Curl_hesaplamaInput): Curl_hesaplamaOutput {
...
export interface Curl_hesaplamaOutput {
...
export const Curl_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
