// Auto-generated from quick-ratio-hesaplama-schema.json
import * as z from 'zod';

export interface Quick_ratio_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Quick_ratio_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Quick_ratio_hesaplamaInput): Record<string, number> {
...
export function calculateQuick_ratio_hesaplama(input: Quick_ratio_hesaplamaInput): Quick_ratio_hesaplamaOutput {
...
export interface Quick_ratio_hesaplamaOutput {
...
export const Quick_ratio_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
