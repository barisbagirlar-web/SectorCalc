// Auto-generated from dot-urun-hesaplama-schema.json
import * as z from 'zod';

export interface Dot_urun_hesaplamaInput {
  fieldArea: number;
  yieldPerArea: number;
  dataConfidence?: number;
}

export const Dot_urun_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Dot_urun_hesaplamaInput): Record<string, number> {
...
export function calculateDot_urun_hesaplama(input: Dot_urun_hesaplamaInput): Dot_urun_hesaplamaOutput {
...
export interface Dot_urun_hesaplamaOutput {
...
export const Dot_urun_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "m²",
