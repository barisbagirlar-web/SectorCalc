// Auto-generated from toll-hesaplama-schema.json
import * as z from 'zod';

export interface Toll_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Toll_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Toll_hesaplamaInput): Record<string, number> {
...
export function calculateToll_hesaplama(input: Toll_hesaplamaInput): Toll_hesaplamaOutput {
...
export interface Toll_hesaplamaOutput {
...
export const Toll_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
