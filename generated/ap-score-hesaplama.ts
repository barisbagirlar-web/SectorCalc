// Auto-generated from ap-score-hesaplama-schema.json
import * as z from 'zod';

export interface Ap_score_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Ap_score_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ap_score_hesaplamaInput): Record<string, number> {
...
export function calculateAp_score_hesaplama(input: Ap_score_hesaplamaInput): Ap_score_hesaplamaOutput {
...
export interface Ap_score_hesaplamaOutput {
...
export const Ap_score_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
