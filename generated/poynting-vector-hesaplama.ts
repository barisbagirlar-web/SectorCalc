// Auto-generated from poynting-vector-hesaplama-schema.json
import * as z from 'zod';

export interface Poynting_vector_hesaplamaInput {
  matrixSize: number;
  matrixElement: number;
  dataConfidence?: number;
}

export const Poynting_vector_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Poynting_vector_hesaplamaInput): Record<string, number> {
...
export function calculatePoynting_vector_hesaplama(input: Poynting_vector_hesaplamaInput): Poynting_vector_hesaplamaOutput {
...
export interface Poynting_vector_hesaplamaOutput {
...
export const Poynting_vector_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
