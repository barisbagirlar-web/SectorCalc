// Auto-generated from fence-hesaplama-schema.json
import * as z from 'zod';

export interface Fence_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Fence_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Fence_hesaplamaInput): Record<string, number> {
...
export function calculateFence_hesaplama(input: Fence_hesaplamaInput): Fence_hesaplamaOutput {
...
export interface Fence_hesaplamaOutput {
...
export const Fence_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
