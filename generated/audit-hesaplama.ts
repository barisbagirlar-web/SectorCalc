// Auto-generated from audit-hesaplama-schema.json
import * as z from 'zod';

export interface Audit_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Audit_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Audit_hesaplamaInput): Record<string, number> {
...
export function calculateAudit_hesaplama(input: Audit_hesaplamaInput): Audit_hesaplamaOutput {
...
export interface Audit_hesaplamaOutput {
...
export const Audit_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
