// Auto-generated from ftp-hesaplama-schema.json
import * as z from 'zod';

export interface Ftp_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Ftp_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ftp_hesaplamaInput): Record<string, number> {
...
export function calculateFtp_hesaplama(input: Ftp_hesaplamaInput): Ftp_hesaplamaOutput {
...
export interface Ftp_hesaplamaOutput {
...
export const Ftp_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
