// Auto-generated from personal-kredi-hesaplama-schema.json
import * as z from 'zod';

export interface Personal_kredi_hesaplamaInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Personal_kredi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Personal_kredi_hesaplamaInput): Record<string, number> {
...
export function calculatePersonal_kredi_hesaplama(input: Personal_kredi_hesaplamaInput): Personal_kredi_hesaplamaOutput {
...
export interface Personal_kredi_hesaplamaOutput {
...
export const Personal_kredi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
