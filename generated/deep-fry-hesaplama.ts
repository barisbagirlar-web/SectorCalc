// Auto-generated from deep-fry-hesaplama-schema.json
import * as z from 'zod';

export interface Deep_fry_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Deep_fry_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Deep_fry_hesaplamaInput): Record<string, number> {
...
export function calculateDeep_fry_hesaplama(input: Deep_fry_hesaplamaInput): Deep_fry_hesaplamaOutput {
...
export interface Deep_fry_hesaplamaOutput {
...
export const Deep_fry_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
