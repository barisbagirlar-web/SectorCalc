// Auto-generated from hlb-hesaplama-schema.json
import * as z from 'zod';

export interface Hlb_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Hlb_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Hlb_hesaplamaInput): Record<string, number> {
...
export function calculateHlb_hesaplama(input: Hlb_hesaplamaInput): Hlb_hesaplamaOutput {
...
export interface Hlb_hesaplamaOutput {
...
export const Hlb_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
