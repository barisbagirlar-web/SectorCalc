// Auto-generated from carats-to-grams-hesaplama-schema.json
import * as z from 'zod';

export interface Carats_to_grams_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Carats_to_grams_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Carats_to_grams_hesaplamaInput): Record<string, number> {
...
export function calculateCarats_to_grams_hesaplama(input: Carats_to_grams_hesaplamaInput): Carats_to_grams_hesaplamaOutput {
...
export interface Carats_to_grams_hesaplamaOutput {
...
export const Carats_to_grams_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
