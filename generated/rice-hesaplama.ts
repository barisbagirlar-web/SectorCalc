// Auto-generated from rice-hesaplama-schema.json
import * as z from 'zod';

export interface Rice_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Rice_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Rice_hesaplamaInput): Record<string, number> {
...
export function calculateRice_hesaplama(input: Rice_hesaplamaInput): Rice_hesaplamaOutput {
...
export interface Rice_hesaplamaOutput {
...
export const Rice_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
