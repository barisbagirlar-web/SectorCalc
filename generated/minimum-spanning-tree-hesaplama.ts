// Auto-generated from minimum-spanning-tree-hesaplama-schema.json
import * as z from 'zod';

export interface Minimum_spanning_tree_hesaplamaInput {
  skinTypeScore: number;
  treatmentIntensity: number;
  dataConfidence?: number;
}

export const Minimum_spanning_tree_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Minimum_spanning_tree_hesaplamaInput): Record<string, number> {
...
export function calculateMinimum_spanning_tree_hesaplama(input: Minimum_spanning_tree_hesaplamaInput): Minimum_spanning_tree_hesaplamaOutput {
...
export interface Minimum_spanning_tree_hesaplamaOutput {
...
export const Minimum_spanning_tree_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "points",
