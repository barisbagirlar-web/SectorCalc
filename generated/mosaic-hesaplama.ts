// Auto-generated from mosaic-hesaplama-schema.json
import * as z from 'zod';

export interface Mosaic_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Mosaic_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Mosaic_hesaplamaInput): Record<string, number> {
...
export function calculateMosaic_hesaplama(input: Mosaic_hesaplamaInput): Mosaic_hesaplamaOutput {
...
export interface Mosaic_hesaplamaOutput {
...
export const Mosaic_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
