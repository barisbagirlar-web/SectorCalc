// Auto-generated from prokisim-test-hesaplama-schema.json
import * as z from 'zod';

export interface Prokisim_test_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Prokisim_test_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Prokisim_test_hesaplamaInput): Record<string, number> {
...
export function calculateProkisim_test_hesaplama(input: Prokisim_test_hesaplamaInput): Prokisim_test_hesaplamaOutput {
...
export interface Prokisim_test_hesaplamaOutput {
...
export const Prokisim_test_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
