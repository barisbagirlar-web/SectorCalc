// Auto-generated from ounce-to-gram-hesaplama-schema.json
import * as z from 'zod';

export interface Ounce_to_gram_hesaplamaInput {
  massValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Ounce_to_gram_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ounce_to_gram_hesaplamaInput): Record<string, number> {
...
export function calculateOunce_to_gram_hesaplama(input: Ounce_to_gram_hesaplamaInput): Ounce_to_gram_hesaplamaOutput {
...
export interface Ounce_to_gram_hesaplamaOutput {
...
export const Ounce_to_gram_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "kg",
