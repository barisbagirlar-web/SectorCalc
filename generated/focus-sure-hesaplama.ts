// Auto-generated from focus-sure-hesaplama-schema.json
import * as z from 'zod';

export interface Focus_sure_hesaplamaInput {
  timeValue: number;
  frequency: number;
  dataConfidence?: number;
}

export const Focus_sure_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Focus_sure_hesaplamaInput): Record<string, number> {
...
export function calculateFocus_sure_hesaplama(input: Focus_sure_hesaplamaInput): Focus_sure_hesaplamaOutput {
...
export interface Focus_sure_hesaplamaOutput {
...
export const Focus_sure_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "min",
