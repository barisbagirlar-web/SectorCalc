// Auto-generated from upload-sure-hesaplama-schema.json
import * as z from 'zod';

export interface Upload_sure_hesaplamaInput {
  dataSize: number;
  connectionSpeed: number;
  dataConfidence?: number;
}

export const Upload_sure_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Upload_sure_hesaplamaInput): Record<string, number> {
...
export function calculateUpload_sure_hesaplama(input: Upload_sure_hesaplamaInput): Upload_sure_hesaplamaOutput {
...
export interface Upload_sure_hesaplamaOutput {
...
export const Upload_sure_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "MB",
