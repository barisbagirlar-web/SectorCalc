// Auto-generated from fcfe-hesaplama-schema.json
import * as z from 'zod';

export interface Fcfe_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Fcfe_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Fcfe_hesaplamaInput): Record<string, number> {
...
export function calculateFcfe_hesaplama(input: Fcfe_hesaplamaInput): Fcfe_hesaplamaOutput {
...
export interface Fcfe_hesaplamaOutput {
...
export const Fcfe_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
