// Auto-generated from euler-yol-hesaplama-schema.json
import * as z from 'zod';

export interface Euler_yol_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Euler_yol_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Euler_yol_hesaplamaInput): Record<string, number> {
...
export function calculateEuler_yol_hesaplama(input: Euler_yol_hesaplamaInput): Euler_yol_hesaplamaOutput {
...
export interface Euler_yol_hesaplamaOutput {
...
export const Euler_yol_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
