// Auto-generated from garmin-calorie-hesaplama-schema.json
import * as z from 'zod';

export interface Garmin_calorie_hesaplamaInput {
  bodyWeight: number;
  activityLevel: number;
  dataConfidence?: number;
}

export const Garmin_calorie_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Garmin_calorie_hesaplamaInput): Record<string, number> {
...
export function calculateGarmin_calorie_hesaplama(input: Garmin_calorie_hesaplamaInput): Garmin_calorie_hesaplamaOutput {
...
export interface Garmin_calorie_hesaplamaOutput {
...
export const Garmin_calorie_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "kg",
