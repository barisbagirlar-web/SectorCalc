// Auto-generated from exponent-hesaplama-schema.json
import * as z from 'zod';

export interface Exponent_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Exponent_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Exponent_hesaplamaInput): Record<string, number> {
...
export function calculateExponent_hesaplama(input: Exponent_hesaplamaInput): Exponent_hesaplamaOutput {
...
export interface Exponent_hesaplamaOutput {
...
export const Exponent_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
