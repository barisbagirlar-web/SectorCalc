// Auto-generated from ethereum-donusturucu-schema.json
import * as z from 'zod';

export interface Ethereum_donusturucuInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Ethereum_donusturucuInputSchema = z.object({
...
function evaluateAllFormulas(input: Ethereum_donusturucuInput): Record<string, number> {
...
export function calculateEthereum_donusturucu(input: Ethereum_donusturucuInput): Ethereum_donusturucuOutput {
...
export interface Ethereum_donusturucuOutput {
...
export const Ethereum_donusturucuOutputMeta = {
  primaryKey: "result",
  unit: "",
