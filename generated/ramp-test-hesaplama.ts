// Auto-generated from ramp-test-hesaplama-schema.json
import * as z from 'zod';

export interface Ramp_test_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Ramp_test_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ramp_test_hesaplamaInput): Record<string, number> {
...
export function calculateRamp_test_hesaplama(input: Ramp_test_hesaplamaInput): Ramp_test_hesaplamaOutput {
...
export interface Ramp_test_hesaplamaOutput {
...
export const Ramp_test_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
