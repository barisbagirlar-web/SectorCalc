// Auto-generated from z-test-hesaplama-schema.json
import * as z from 'zod';

export interface Z_test_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Z_test_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Z_test_hesaplamaInput): Record<string, number> {
...
export function calculateZ_test_hesaplama(input: Z_test_hesaplamaInput): Z_test_hesaplamaOutput {
...
export interface Z_test_hesaplamaOutput {
...
export const Z_test_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
