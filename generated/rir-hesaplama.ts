// Auto-generated from rir-hesaplama-schema.json
import * as z from 'zod';

export interface Rir_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Rir_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Rir_hesaplamaInput): Record<string, number> {
...
export function calculateRir_hesaplama(input: Rir_hesaplamaInput): Rir_hesaplamaOutput {
...
export interface Rir_hesaplamaOutput {
...
export const Rir_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
