// Auto-generated from anti-aging-hesaplama-schema.json
import * as z from 'zod';

export interface Anti_aging_hesaplamaInput {
  skinTypeScore: number;
  dataConfidence?: number;
}

export const Anti_aging_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Anti_aging_hesaplamaInput): Record<string, number> {
...
export function calculateAnti_aging_hesaplama(input: Anti_aging_hesaplamaInput): Anti_aging_hesaplamaOutput {
...
export interface Anti_aging_hesaplamaOutput {
...
export const Anti_aging_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "points",
