// Auto-generated from balon-odemeli-kredi-hesaplama-schema.json
import * as z from 'zod';

export interface Balon_odemeli_kredi_hesaplamaInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Balon_odemeli_kredi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Balon_odemeli_kredi_hesaplamaInput): Record<string, number> {
...
export function calculateBalon_odemeli_kredi_hesaplama(input: Balon_odemeli_kredi_hesaplamaInput): Balon_odemeli_kredi_hesaplamaOutput {
...
export interface Balon_odemeli_kredi_hesaplamaOutput {
...
export const Balon_odemeli_kredi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
