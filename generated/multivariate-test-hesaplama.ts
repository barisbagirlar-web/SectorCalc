// Auto-generated from multivariate-test-hesaplama-schema.json
import * as z from 'zod';

export interface Multivariate_test_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Multivariate_test_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Multivariate_test_hesaplamaInput): Record<string, number> {
...
export function calculateMultivariate_test_hesaplama(input: Multivariate_test_hesaplamaInput): Multivariate_test_hesaplamaOutput {
...
export interface Multivariate_test_hesaplamaOutput {
...
export const Multivariate_test_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
