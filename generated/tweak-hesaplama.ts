// Auto-generated from tweak-hesaplama-schema.json
import * as z from 'zod';

export interface Tweak_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Tweak_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Tweak_hesaplamaInput): Record<string, number> {
...
export function calculateTweak_hesaplama(input: Tweak_hesaplamaInput): Tweak_hesaplamaOutput {
...
export interface Tweak_hesaplamaOutput {
...
export const Tweak_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
