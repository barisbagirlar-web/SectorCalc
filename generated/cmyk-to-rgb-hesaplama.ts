// Auto-generated from cmyk-to-rgb-hesaplama-schema.json
import * as z from 'zod';

export interface Cmyk_to_rgb_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Cmyk_to_rgb_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cmyk_to_rgb_hesaplamaInput): Record<string, number> {
...
export function calculateCmyk_to_rgb_hesaplama(input: Cmyk_to_rgb_hesaplamaInput): Cmyk_to_rgb_hesaplamaOutput {
...
export interface Cmyk_to_rgb_hesaplamaOutput {
...
export const Cmyk_to_rgb_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
