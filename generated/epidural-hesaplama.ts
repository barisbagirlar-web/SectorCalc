// Auto-generated from epidural-hesaplama-schema.json
import * as z from 'zod';

export interface Epidural_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Epidural_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Epidural_hesaplamaInput): Record<string, number> {
...
export function calculateEpidural_hesaplama(input: Epidural_hesaplamaInput): Epidural_hesaplamaOutput {
...
export interface Epidural_hesaplamaOutput {
...
export const Epidural_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
