// Auto-generated from decibel-hesaplama-schema.json
import * as z from 'zod';

export interface Decibel_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Decibel_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Decibel_hesaplamaInput): Record<string, number> {
...
export function calculateDecibel_hesaplama(input: Decibel_hesaplamaInput): Decibel_hesaplamaOutput {
...
export interface Decibel_hesaplamaOutput {
...
export const Decibel_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
