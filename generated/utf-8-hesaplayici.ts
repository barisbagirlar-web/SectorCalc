// Auto-generated from utf-8-hesaplayici-schema.json
import * as z from 'zod';

export interface Utf_8_hesaplayiciInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Utf_8_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Utf_8_hesaplayiciInput): Record<string, number> {
...
export function calculateUtf_8_hesaplayici(input: Utf_8_hesaplayiciInput): Utf_8_hesaplayiciOutput {
...
export interface Utf_8_hesaplayiciOutput {
...
export const Utf_8_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "",
