// Auto-generated from fsa-hesaplama-schema.json
import * as z from 'zod';

export interface Fsa_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Fsa_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Fsa_hesaplamaInput): Record<string, number> {
...
export function calculateFsa_hesaplama(input: Fsa_hesaplamaInput): Fsa_hesaplamaOutput {
...
export interface Fsa_hesaplamaOutput {
...
export const Fsa_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
