// Auto-generated from ecommerce-kar-hesaplama-schema.json
import * as z from 'zod';

export interface Ecommerce_kar_hesaplamaInput {
  revenueAmount: number;
  costAmount: number;
  dataConfidence?: number;
}

export const Ecommerce_kar_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ecommerce_kar_hesaplamaInput): Record<string, number> {
...
export function calculateEcommerce_kar_hesaplama(input: Ecommerce_kar_hesaplamaInput): Ecommerce_kar_hesaplamaOutput {
...
export interface Ecommerce_kar_hesaplamaOutput {
...
export const Ecommerce_kar_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
