// Auto-generated from bird-cage-hesaplama-schema.json
import * as z from 'zod';

export interface Bird_cage_hesaplamaInput {
  birthDate: number;
  referenceDate: number;
  dataConfidence?: number;
}

export const Bird_cage_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Bird_cage_hesaplamaInput): Record<string, number> {
...
export function calculateBird_cage_hesaplama(input: Bird_cage_hesaplamaInput): Bird_cage_hesaplamaOutput {
...
export interface Bird_cage_hesaplamaOutput {
...
export const Bird_cage_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "date",
