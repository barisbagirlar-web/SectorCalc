// Auto-generated from juice-hesaplama-schema.json
import * as z from 'zod';

export interface Juice_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Juice_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Juice_hesaplamaInput): Record<string, number> {
...
export function calculateJuice_hesaplama(input: Juice_hesaplamaInput): Juice_hesaplamaOutput {
...
export interface Juice_hesaplamaOutput {
...
export const Juice_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
