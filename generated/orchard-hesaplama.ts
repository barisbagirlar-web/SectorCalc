// Auto-generated from orchard-hesaplama-schema.json
import * as z from 'zod';

export interface Orchard_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Orchard_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Orchard_hesaplamaInput): Record<string, number> {
...
export function calculateOrchard_hesaplama(input: Orchard_hesaplamaInput): Orchard_hesaplamaOutput {
...
export interface Orchard_hesaplamaOutput {
...
export const Orchard_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
