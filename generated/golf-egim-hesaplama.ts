// Auto-generated from golf-egim-hesaplama-schema.json
import * as z from 'zod';

export interface Golf_egim_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Golf_egim_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Golf_egim_hesaplamaInput): Record<string, number> {
...
export function calculateGolf_egim_hesaplama(input: Golf_egim_hesaplamaInput): Golf_egim_hesaplamaOutput {
...
export interface Golf_egim_hesaplamaOutput {
...
export const Golf_egim_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
