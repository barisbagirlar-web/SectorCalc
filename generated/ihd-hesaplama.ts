// Auto-generated from ihd-hesaplama-schema.json
import * as z from 'zod';

export interface Ihd_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Ihd_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ihd_hesaplamaInput): Record<string, number> {
...
export function calculateIhd_hesaplama(input: Ihd_hesaplamaInput): Ihd_hesaplamaOutput {
...
export interface Ihd_hesaplamaOutput {
...
export const Ihd_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
