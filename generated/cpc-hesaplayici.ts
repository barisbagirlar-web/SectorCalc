// Auto-generated from cpc-hesaplayici-schema.json
import * as z from 'zod';

export interface Cpc_hesaplayiciInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Cpc_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Cpc_hesaplayiciInput): Record<string, number> {
...
export function calculateCpc_hesaplayici(input: Cpc_hesaplayiciInput): Cpc_hesaplayiciOutput {
...
export interface Cpc_hesaplayiciOutput {
...
export const Cpc_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "",
