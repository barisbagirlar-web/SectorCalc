// Auto-generated from citation-hesaplama-schema.json
import * as z from 'zod';

export interface Citation_hesaplamaInput {
  textInput: number;
  countValue: number;
  dataConfidence?: number;
}

export const Citation_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Citation_hesaplamaInput): Record<string, number> {
...
export function calculateCitation_hesaplama(input: Citation_hesaplamaInput): Citation_hesaplamaOutput {
...
export interface Citation_hesaplamaOutput {
...
export const Citation_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "text",
