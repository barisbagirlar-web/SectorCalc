// Auto-generated from perma-hesaplama-schema.json
import * as z from 'zod';

export interface Perma_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Perma_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Perma_hesaplamaInput): Record<string, number> {
...
export function calculatePerma_hesaplama(input: Perma_hesaplamaInput): Perma_hesaplamaOutput {
...
export interface Perma_hesaplamaOutput {
...
export const Perma_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
