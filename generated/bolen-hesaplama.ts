// Auto-generated from bolen-hesaplama-schema.json
import * as z from 'zod';

export interface Bolen_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Bolen_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Bolen_hesaplamaInput): Record<string, number> {
...
export function calculateBolen_hesaplama(input: Bolen_hesaplamaInput): Bolen_hesaplamaOutput {
...
export interface Bolen_hesaplamaOutput {
...
export const Bolen_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
