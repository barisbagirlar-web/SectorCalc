// Auto-generated from net-kar-hesaplama-schema.json
import * as z from 'zod';

export interface Net_kar_hesaplamaInput {
  revenueAmount: number;
  costAmount: number;
  dataConfidence?: number;
}

export const Net_kar_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Net_kar_hesaplamaInput): Record<string, number> {
...
export function calculateNet_kar_hesaplama(input: Net_kar_hesaplamaInput): Net_kar_hesaplamaOutput {
...
export interface Net_kar_hesaplamaOutput {
...
export const Net_kar_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
