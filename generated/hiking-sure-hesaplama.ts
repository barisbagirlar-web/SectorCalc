// Auto-generated from hiking-sure-hesaplama-schema.json
import * as z from 'zod';

export interface Hiking_sure_hesaplamaInput {
  timeValue: number;
  frequency: number;
  dataConfidence?: number;
}

export const Hiking_sure_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Hiking_sure_hesaplamaInput): Record<string, number> {
...
export function calculateHiking_sure_hesaplama(input: Hiking_sure_hesaplamaInput): Hiking_sure_hesaplamaOutput {
...
export interface Hiking_sure_hesaplamaOutput {
...
export const Hiking_sure_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "min",
