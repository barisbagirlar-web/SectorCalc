// Auto-generated from antilog-hesaplama-schema.json
import * as z from 'zod';

export interface Antilog_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Antilog_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Antilog_hesaplamaInput): Record<string, number> {
...
export function calculateAntilog_hesaplama(input: Antilog_hesaplamaInput): Antilog_hesaplamaOutput {
...
export interface Antilog_hesaplamaOutput {
...
export const Antilog_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
