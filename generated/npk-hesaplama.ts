// Auto-generated from npk-hesaplama-schema.json
import * as z from 'zod';

export interface Npk_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Npk_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Npk_hesaplamaInput): Record<string, number> {
...
export function calculateNpk_hesaplama(input: Npk_hesaplamaInput): Npk_hesaplamaOutput {
...
export interface Npk_hesaplamaOutput {
...
export const Npk_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
