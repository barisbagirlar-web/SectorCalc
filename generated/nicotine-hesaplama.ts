// Auto-generated from nicotine-hesaplama-schema.json
import * as z from 'zod';

export interface Nicotine_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Nicotine_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Nicotine_hesaplamaInput): Record<string, number> {
...
export function calculateNicotine_hesaplama(input: Nicotine_hesaplamaInput): Nicotine_hesaplamaOutput {
...
export interface Nicotine_hesaplamaOutput {
...
export const Nicotine_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
