// Auto-generated from apy-hesaplayici-schema.json
import * as z from 'zod';

export interface Apy_hesaplayiciInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Apy_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Apy_hesaplayiciInput): Record<string, number> {
...
export function calculateApy_hesaplayici(input: Apy_hesaplayiciInput): Apy_hesaplayiciOutput {
...
export interface Apy_hesaplayiciOutput {
...
export const Apy_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "",
