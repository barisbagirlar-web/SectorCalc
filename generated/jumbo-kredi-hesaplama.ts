// Auto-generated from jumbo-kredi-hesaplama-schema.json
import * as z from 'zod';

export interface Jumbo_kredi_hesaplamaInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Jumbo_kredi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Jumbo_kredi_hesaplamaInput): Record<string, number> {
...
export function calculateJumbo_kredi_hesaplama(input: Jumbo_kredi_hesaplamaInput): Jumbo_kredi_hesaplamaOutput {
...
export interface Jumbo_kredi_hesaplamaOutput {
...
export const Jumbo_kredi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
