// Auto-generated from medicaid-hesaplama-schema.json
import * as z from 'zod';

export interface Medicaid_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Medicaid_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Medicaid_hesaplamaInput): Record<string, number> {
...
export function calculateMedicaid_hesaplama(input: Medicaid_hesaplamaInput): Medicaid_hesaplamaOutput {
...
export interface Medicaid_hesaplamaOutput {
...
export const Medicaid_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
