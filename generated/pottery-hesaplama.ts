// Auto-generated from pottery-hesaplama-schema.json
import * as z from 'zod';

export interface Pottery_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Pottery_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pottery_hesaplamaInput): Record<string, number> {
...
export function calculatePottery_hesaplama(input: Pottery_hesaplamaInput): Pottery_hesaplamaOutput {
...
export interface Pottery_hesaplamaOutput {
...
export const Pottery_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
