// Auto-generated from pendulum-hesaplama-schema.json
import * as z from 'zod';

export interface Pendulum_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Pendulum_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pendulum_hesaplamaInput): Record<string, number> {
...
export function calculatePendulum_hesaplama(input: Pendulum_hesaplamaInput): Pendulum_hesaplamaOutput {
...
export interface Pendulum_hesaplamaOutput {
...
export const Pendulum_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
