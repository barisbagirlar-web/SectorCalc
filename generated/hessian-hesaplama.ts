// Auto-generated from hessian-hesaplama-schema.json
import * as z from 'zod';

export interface Hessian_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Hessian_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Hessian_hesaplamaInput): Record<string, number> {
...
export function calculateHessian_hesaplama(input: Hessian_hesaplamaInput): Hessian_hesaplamaOutput {
...
export interface Hessian_hesaplamaOutput {
...
export const Hessian_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
