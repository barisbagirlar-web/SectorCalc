// Auto-generated from golf-handicap-hesaplama-schema.json
import * as z from 'zod';

export interface Golf_handicap_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Golf_handicap_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Golf_handicap_hesaplamaInput): Record<string, number> {
...
export function calculateGolf_handicap_hesaplama(input: Golf_handicap_hesaplamaInput): Golf_handicap_hesaplamaOutput {
...
export interface Golf_handicap_hesaplamaOutput {
...
export const Golf_handicap_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
