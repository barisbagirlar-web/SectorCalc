// Auto-generated from cups-to-ml-hesaplama-schema.json
import * as z from 'zod';

export interface Cups_to_ml_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Cups_to_ml_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cups_to_ml_hesaplamaInput): Record<string, number> {
...
export function calculateCups_to_ml_hesaplama(input: Cups_to_ml_hesaplamaInput): Cups_to_ml_hesaplamaOutput {
...
export interface Cups_to_ml_hesaplamaOutput {
...
export const Cups_to_ml_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
