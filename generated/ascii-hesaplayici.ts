// Auto-generated from ascii-hesaplayici-schema.json
import * as z from 'zod';

export interface Ascii_hesaplayiciInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Ascii_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Ascii_hesaplayiciInput): Record<string, number> {
...
export function calculateAscii_hesaplayici(input: Ascii_hesaplayiciInput): Ascii_hesaplayiciOutput {
...
export interface Ascii_hesaplayiciOutput {
...
export const Ascii_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "",
