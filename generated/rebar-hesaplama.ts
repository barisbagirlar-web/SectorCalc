// Auto-generated from rebar-hesaplama-schema.json
import * as z from 'zod';

export interface Rebar_hesaplamaInput {
  pressureValue: number;
  dataConfidence?: number;
}

export const Rebar_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Rebar_hesaplamaInput): Record<string, number> {
...
export function calculateRebar_hesaplama(input: Rebar_hesaplamaInput): Rebar_hesaplamaOutput {
...
export interface Rebar_hesaplamaOutput {
...
export const Rebar_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "Pa",
