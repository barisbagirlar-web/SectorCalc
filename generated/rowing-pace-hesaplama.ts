// Auto-generated from rowing-pace-hesaplama-schema.json
import * as z from 'zod';

export interface Rowing_pace_hesaplamaInput {
  distanceKm: number;
  durationMin: number;
  dataConfidence?: number;
}

export const Rowing_pace_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Rowing_pace_hesaplamaInput): Record<string, number> {
...
export function calculateRowing_pace_hesaplama(input: Rowing_pace_hesaplamaInput): Rowing_pace_hesaplamaOutput {
...
export interface Rowing_pace_hesaplamaOutput {
...
export const Rowing_pace_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "km",
