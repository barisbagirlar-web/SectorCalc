// Auto-generated from tariff-hesaplama-schema.json
import * as z from 'zod';

export interface Tariff_hesaplamaInput {
  servingSize: number;
  ingredientAmount: number;
  dataConfidence?: number;
}

export const Tariff_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Tariff_hesaplamaInput): Record<string, number> {
...
export function calculateTariff_hesaplama(input: Tariff_hesaplamaInput): Tariff_hesaplamaOutput {
...
export interface Tariff_hesaplamaOutput {
...
export const Tariff_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "g",
