// Auto-generated from geleneksel-vs-roth-ira-hesaplama-schema.json
import * as z from 'zod';

export interface Geleneksel_vs_roth_ira_hesaplamaInput {
  katki: number;
  vergiOrani: number;
  buyumeOrani: number;
  yil: number;
...
export const Geleneksel_vs_roth_ira_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Geleneksel_vs_roth_ira_hesaplamaInput): Record<string, number> {
...
export function calculateGeleneksel_vs_roth_ira_hesaplama(input: Geleneksel_vs_roth_ira_hesaplamaInput): Geleneksel_vs_roth_ira_hesaplamaOutput {
...
export interface Geleneksel_vs_roth_ira_hesaplamaOutput {
...
export const Geleneksel_vs_roth_ira_hesaplamaOutputMeta = {
  primaryKey: "sonuc",
  unit: "TRY",
