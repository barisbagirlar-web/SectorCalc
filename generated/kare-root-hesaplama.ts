// Auto-generated from kare-root-hesaplama-schema.json
import * as z from 'zod';

export interface Kare_root_hesaplamaInput {
  revenueAmount: number;
  costAmount: number;
  dataConfidence?: number;
}

export const Kare_root_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Kare_root_hesaplamaInput): Record<string, number> {
...
export function calculateKare_root_hesaplama(input: Kare_root_hesaplamaInput): Kare_root_hesaplamaOutput {
...
export interface Kare_root_hesaplamaOutput {
...
export const Kare_root_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
