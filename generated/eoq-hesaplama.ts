// Auto-generated from eoq-hesaplama-schema.json
import * as z from 'zod';

export interface Eoq_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Eoq_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Eoq_hesaplamaInput): Record<string, number> {
...
export function calculateEoq_hesaplama(input: Eoq_hesaplamaInput): Eoq_hesaplamaOutput {
...
export interface Eoq_hesaplamaOutput {
...
export const Eoq_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
