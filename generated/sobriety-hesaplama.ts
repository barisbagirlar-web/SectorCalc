// Auto-generated from sobriety-hesaplama-schema.json
import * as z from 'zod';

export interface Sobriety_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Sobriety_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Sobriety_hesaplamaInput): Record<string, number> {
...
export function calculateSobriety_hesaplama(input: Sobriety_hesaplamaInput): Sobriety_hesaplamaOutput {
...
export interface Sobriety_hesaplamaOutput {
...
export const Sobriety_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
