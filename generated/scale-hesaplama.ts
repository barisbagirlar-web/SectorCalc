// Auto-generated from scale-hesaplama-schema.json
import * as z from 'zod';

export interface Scale_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Scale_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Scale_hesaplamaInput): Record<string, number> {
...
export function calculateScale_hesaplama(input: Scale_hesaplamaInput): Scale_hesaplamaOutput {
...
export interface Scale_hesaplamaOutput {
...
export const Scale_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
