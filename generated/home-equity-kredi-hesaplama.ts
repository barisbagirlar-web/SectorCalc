// Auto-generated from home-equity-kredi-hesaplama-schema.json
import * as z from 'zod';

export interface Home_equity_kredi_hesaplamaInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Home_equity_kredi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Home_equity_kredi_hesaplamaInput): Record<string, number> {
...
export function calculateHome_equity_kredi_hesaplama(input: Home_equity_kredi_hesaplamaInput): Home_equity_kredi_hesaplamaOutput {
...
export interface Home_equity_kredi_hesaplamaOutput {
...
export const Home_equity_kredi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
