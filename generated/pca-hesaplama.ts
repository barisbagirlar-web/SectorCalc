// Auto-generated from pca-hesaplama-schema.json
import * as z from 'zod';

export interface Pca_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Pca_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pca_hesaplamaInput): Record<string, number> {
...
export function calculatePca_hesaplama(input: Pca_hesaplamaInput): Pca_hesaplamaOutput {
...
export interface Pca_hesaplamaOutput {
...
export const Pca_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
