// Auto-generated from humidity-hesaplama-schema.json
import * as z from 'zod';

export interface Humidity_hesaplamaInput {
  airTemperature: number;
  relativeHumidity: number;
  dataConfidence?: number;
}

export const Humidity_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Humidity_hesaplamaInput): Record<string, number> {
...
export function calculateHumidity_hesaplama(input: Humidity_hesaplamaInput): Humidity_hesaplamaOutput {
...
export interface Humidity_hesaplamaOutput {
...
export const Humidity_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "°C",
