// Auto-generated from matrix-hesaplama-schema.json
import * as z from 'zod';

export interface Matrix_hesaplamaInput {
  matrixSize: number;
  matrixElement: number;
  dataConfidence?: number;
}

export const Matrix_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Matrix_hesaplamaInput): Record<string, number> {
...
export function calculateMatrix_hesaplama(input: Matrix_hesaplamaInput): Matrix_hesaplamaOutput {
...
export interface Matrix_hesaplamaOutput {
...
export const Matrix_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
