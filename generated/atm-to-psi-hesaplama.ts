// Auto-generated from atm-to-psi-hesaplama-schema.json
import * as z from 'zod';

export interface Atm_to_psi_hesaplamaInput {
  pressureValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Atm_to_psi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Atm_to_psi_hesaplamaInput): Record<string, number> {
...
export function calculateAtm_to_psi_hesaplama(input: Atm_to_psi_hesaplamaInput): Atm_to_psi_hesaplamaOutput {
...
export interface Atm_to_psi_hesaplamaOutput {
...
export const Atm_to_psi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "Pa",
