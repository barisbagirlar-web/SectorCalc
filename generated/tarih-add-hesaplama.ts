// Auto-generated from tarih-add-hesaplama-schema.json
import * as z from 'zod';

export interface Tarih_add_hesaplamaInput {
  birthDate: number;
  referenceDate: number;
  dataConfidence?: number;
}

export const Tarih_add_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Tarih_add_hesaplamaInput): Record<string, number> {
...
export function calculateTarih_add_hesaplama(input: Tarih_add_hesaplamaInput): Tarih_add_hesaplamaOutput {
...
export interface Tarih_add_hesaplamaOutput {
...
export const Tarih_add_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "date",
