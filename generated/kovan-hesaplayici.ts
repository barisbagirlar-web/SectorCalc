// Auto-generated from kovan-hesaplayici-schema.json
import * as z from 'zod';

export interface Kovan_hesaplayiciInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Kovan_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Kovan_hesaplayiciInput): Record<string, number> {
...
export function calculateKovan_hesaplayici(input: Kovan_hesaplayiciInput): Kovan_hesaplayiciOutput {
...
export interface Kovan_hesaplayiciOutput {
...
export const Kovan_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "",
