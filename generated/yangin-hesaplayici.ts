// Auto-generated from yangin-hesaplayici-schema.json
import * as z from 'zod';

export interface Yangin_hesaplayiciInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Yangin_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Yangin_hesaplayiciInput): Record<string, number> {
...
export function calculateYangin_hesaplayici(input: Yangin_hesaplayiciInput): Yangin_hesaplayiciOutput {
...
export interface Yangin_hesaplayiciOutput {
...
export const Yangin_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "",
