// Auto-generated from cobra-hesaplama-schema.json
import * as z from 'zod';

export interface Cobra_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Cobra_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cobra_hesaplamaInput): Record<string, number> {
...
export function calculateCobra_hesaplama(input: Cobra_hesaplamaInput): Cobra_hesaplamaOutput {
...
export interface Cobra_hesaplamaOutput {
...
export const Cobra_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
