// Auto-generated from sampling-oran-hesaplama-schema.json
import * as z from 'zod';

export interface Sampling_oran_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Sampling_oran_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Sampling_oran_hesaplamaInput): Record<string, number> {
...
export function calculateSampling_oran_hesaplama(input: Sampling_oran_hesaplamaInput): Sampling_oran_hesaplamaOutput {
...
export interface Sampling_oran_hesaplamaOutput {
...
export const Sampling_oran_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
