// Auto-generated from ogrenme-egrisi-hesaplama-schema.json
import * as z from 'zod';

export interface Ogrenme_egrisi_hesaplamaInput {
  ilkSure: number;
  ogrenmeOrani: number;
  uretilenAdet: number;
...
export const Ogrenme_egrisi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ogrenme_egrisi_hesaplamaInput): Record<string, number> {
...
export function calculateOgrenme_egrisi_hesaplama(input: Ogrenme_egrisi_hesaplamaInput): Ogrenme_egrisi_hesaplamaOutput {
...
export interface Ogrenme_egrisi_hesaplamaOutput {
...
export const Ogrenme_egrisi_hesaplamaOutputMeta = {
  primaryKey: "sonuc",
  unit: "min",
  breakdownKeys: ["sonuc"],
} as const;
