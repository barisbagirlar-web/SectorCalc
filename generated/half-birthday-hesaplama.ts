// Auto-generated from half-birthday-hesaplama-schema.json
import * as z from 'zod';

export interface Half_birthday_hesaplamaInput {
  birthDate: number;
  referenceDate: number;
  dataConfidence?: number;
}

export const Half_birthday_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Half_birthday_hesaplamaInput): Record<string, number> {
...
export function calculateHalf_birthday_hesaplama(input: Half_birthday_hesaplamaInput): Half_birthday_hesaplamaOutput {
...
export interface Half_birthday_hesaplamaOutput {
...
export const Half_birthday_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "date",
