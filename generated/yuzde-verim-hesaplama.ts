// Auto-generated from yuzde-verim-hesaplama-schema.json
import * as z from 'zod';

export interface Yuzde_verim_hesaplamaInput {
  totalValue: number;
  percentage: number;
  dataConfidence?: number;
}

export const Yuzde_verim_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Yuzde_verim_hesaplamaInput): Record<string, number> {
...
export function calculateYuzde_verim_hesaplama(input: Yuzde_verim_hesaplamaInput): Yuzde_verim_hesaplamaOutput {
...
export interface Yuzde_verim_hesaplamaOutput {
...
export const Yuzde_verim_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "%",
