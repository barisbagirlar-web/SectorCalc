// Auto-generated from roofing-hesaplama-schema.json
import * as z from 'zod';

export interface Roofing_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Roofing_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Roofing_hesaplamaInput): Record<string, number> {
...
export function calculateRoofing_hesaplama(input: Roofing_hesaplamaInput): Roofing_hesaplamaOutput {
...
export interface Roofing_hesaplamaOutput {
...
export const Roofing_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
