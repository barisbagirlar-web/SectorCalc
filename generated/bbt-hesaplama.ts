// Auto-generated from bbt-hesaplama-schema.json
import * as z from 'zod';

export interface Bbt_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Bbt_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Bbt_hesaplamaInput): Record<string, number> {
...
export function calculateBbt_hesaplama(input: Bbt_hesaplamaInput): Bbt_hesaplamaOutput {
...
export interface Bbt_hesaplamaOutput {
...
export const Bbt_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
