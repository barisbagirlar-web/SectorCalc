// Auto-generated from lift-hesaplama-schema.json
import * as z from 'zod';

export interface Lift_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Lift_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Lift_hesaplamaInput): Record<string, number> {
...
export function calculateLift_hesaplama(input: Lift_hesaplamaInput): Lift_hesaplamaOutput {
...
export interface Lift_hesaplamaOutput {
...
export const Lift_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
