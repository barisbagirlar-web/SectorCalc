// Auto-generated from titration-hesaplama-schema.json
import * as z from 'zod';

export interface Titration_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Titration_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Titration_hesaplamaInput): Record<string, number> {
...
export function calculateTitration_hesaplama(input: Titration_hesaplamaInput): Titration_hesaplamaOutput {
...
export interface Titration_hesaplamaOutput {
...
export const Titration_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
