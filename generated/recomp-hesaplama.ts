// Auto-generated from recomp-hesaplama-schema.json
import * as z from 'zod';

export interface Recomp_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Recomp_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Recomp_hesaplamaInput): Record<string, number> {
...
export function calculateRecomp_hesaplama(input: Recomp_hesaplamaInput): Recomp_hesaplamaOutput {
...
export interface Recomp_hesaplamaOutput {
...
export const Recomp_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
