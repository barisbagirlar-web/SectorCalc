// Auto-generated from add-fractions-hesaplama-schema.json
import * as z from 'zod';

export interface Add_fractions_hesaplamaInput {
  numerator: number;
  denominator: number;
  dataConfidence?: number;
}

export const Add_fractions_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Add_fractions_hesaplamaInput): Record<string, number> {
...
export function calculateAdd_fractions_hesaplama(input: Add_fractions_hesaplamaInput): Add_fractions_hesaplamaOutput {
...
export interface Add_fractions_hesaplamaOutput {
...
export const Add_fractions_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
