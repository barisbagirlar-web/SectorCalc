// Auto-generated from two-way-anova-hesaplama-schema.json
import * as z from 'zod';

export interface Two_way_anova_hesaplamaInput {
  sampleMean: number;
  standardDeviation: number;
  dataConfidence?: number;
}

export const Two_way_anova_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Two_way_anova_hesaplamaInput): Record<string, number> {
...
export function calculateTwo_way_anova_hesaplama(input: Two_way_anova_hesaplamaInput): Two_way_anova_hesaplamaOutput {
...
export interface Two_way_anova_hesaplamaOutput {
...
export const Two_way_anova_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
