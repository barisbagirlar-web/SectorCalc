// Auto-generated from shooting-hesaplama-schema.json
import * as z from 'zod';

export interface Shooting_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Shooting_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Shooting_hesaplamaInput): Record<string, number> {
...
export function calculateShooting_hesaplama(input: Shooting_hesaplamaInput): Shooting_hesaplamaOutput {
...
export interface Shooting_hesaplamaOutput {
...
export const Shooting_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
