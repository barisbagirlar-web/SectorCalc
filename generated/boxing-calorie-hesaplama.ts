// Auto-generated from boxing-calorie-hesaplama-schema.json
import * as z from 'zod';

export interface Boxing_calorie_hesaplamaInput {
  bodyWeight: number;
  activityLevel: number;
  dataConfidence?: number;
}

export const Boxing_calorie_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Boxing_calorie_hesaplamaInput): Record<string, number> {
...
export function calculateBoxing_calorie_hesaplama(input: Boxing_calorie_hesaplamaInput): Boxing_calorie_hesaplamaOutput {
...
export interface Boxing_calorie_hesaplamaOutput {
...
export const Boxing_calorie_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "kg",
