// Auto-generated from midpoint-hesaplama-schema.json
import * as z from 'zod';

export interface Midpoint_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Midpoint_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Midpoint_hesaplamaInput): Record<string, number> {
...
export function calculateMidpoint_hesaplama(input: Midpoint_hesaplamaInput): Midpoint_hesaplamaOutput {
...
export interface Midpoint_hesaplamaOutput {
...
export const Midpoint_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
