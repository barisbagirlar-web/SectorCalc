// Auto-generated from dcf-hesaplama-schema.json
import * as z from 'zod';

export interface Dcf_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Dcf_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Dcf_hesaplamaInput): Record<string, number> {
...
export function calculateDcf_hesaplama(input: Dcf_hesaplamaInput): Dcf_hesaplamaOutput {
...
export interface Dcf_hesaplamaOutput {
...
export const Dcf_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
