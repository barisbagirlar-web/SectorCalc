// Auto-generated from pipe-boyut-hesaplama-schema.json
import * as z from 'zod';

export interface Pipe_boyut_hesaplamaInput {
  innerPressure: number;
  dataConfidence?: number;
}

export const Pipe_boyut_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pipe_boyut_hesaplamaInput): Record<string, number> {
...
export function calculatePipe_boyut_hesaplama(input: Pipe_boyut_hesaplamaInput): Pipe_boyut_hesaplamaOutput {
...
export interface Pipe_boyut_hesaplamaOutput {
...
export const Pipe_boyut_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "Pa",
