// Auto-generated from ev-sermayesi-kredisi-hesaplayici-schema.json
import * as z from 'zod';

export interface Ev_sermayesi_kredisi_hesaplayiciInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Ev_sermayesi_kredisi_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Ev_sermayesi_kredisi_hesaplayiciInput): Record<string, number> {
...
export function calculateEv_sermayesi_kredisi_hesaplayici(input: Ev_sermayesi_kredisi_hesaplayiciInput): Ev_sermayesi_kredisi_hesaplayiciOutput {
...
export interface Ev_sermayesi_kredisi_hesaplayiciOutput {
...
export const Ev_sermayesi_kredisi_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "USD",
