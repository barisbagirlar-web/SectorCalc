// Auto-generated from dividend-hesaplama-schema.json
import * as z from 'zod';

export interface Dividend_hesaplamaInput {
  principal: number;
  annualRate: number;
  dataConfidence?: number;
}

export const Dividend_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Dividend_hesaplamaInput): Record<string, number> {
...
export function calculateDividend_hesaplama(input: Dividend_hesaplamaInput): Dividend_hesaplamaOutput {
...
export interface Dividend_hesaplamaOutput {
...
export const Dividend_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
