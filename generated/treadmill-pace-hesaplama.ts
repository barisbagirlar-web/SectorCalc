// Auto-generated from treadmill-pace-hesaplama-schema.json
import * as z from 'zod';

export interface Treadmill_pace_hesaplamaInput {
  distanceKm: number;
  durationMin: number;
  dataConfidence?: number;
}

export const Treadmill_pace_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Treadmill_pace_hesaplamaInput): Record<string, number> {
...
export function calculateTreadmill_pace_hesaplama(input: Treadmill_pace_hesaplamaInput): Treadmill_pace_hesaplamaOutput {
...
export interface Treadmill_pace_hesaplamaOutput {
...
export const Treadmill_pace_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "km",
