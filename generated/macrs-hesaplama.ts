// Auto-generated from macrs-hesaplama-schema.json
import * as z from 'zod';

export interface Macrs_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Macrs_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Macrs_hesaplamaInput): Record<string, number> {
...
export function calculateMacrs_hesaplama(input: Macrs_hesaplamaInput): Macrs_hesaplamaOutput {
...
export interface Macrs_hesaplamaOutput {
...
export const Macrs_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
