// Auto-generated from marj-hata-hesaplama-schema.json
import * as z from 'zod';

export interface Marj_hata_hesaplamaInput {
  revenueAmount: number;
  costAmount: number;
  dataConfidence?: number;
}

export const Marj_hata_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Marj_hata_hesaplamaInput): Record<string, number> {
...
export function calculateMarj_hata_hesaplama(input: Marj_hata_hesaplamaInput): Marj_hata_hesaplamaOutput {
...
export interface Marj_hata_hesaplamaOutput {
...
export const Marj_hata_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
