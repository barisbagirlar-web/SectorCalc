// Auto-generated from ear-hesaplama-schema.json
import * as z from 'zod';

export interface Ear_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Ear_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ear_hesaplamaInput): Record<string, number> {
...
export function calculateEar_hesaplama(input: Ear_hesaplamaInput): Ear_hesaplamaOutput {
...
export interface Ear_hesaplamaOutput {
...
export const Ear_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
