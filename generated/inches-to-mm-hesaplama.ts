// Auto-generated from inches-to-mm-hesaplama-schema.json
import * as z from 'zod';

export interface Inches_to_mm_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Inches_to_mm_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Inches_to_mm_hesaplamaInput): Record<string, number> {
...
export function calculateInches_to_mm_hesaplama(input: Inches_to_mm_hesaplamaInput): Inches_to_mm_hesaplamaOutput {
...
export interface Inches_to_mm_hesaplamaOutput {
...
export const Inches_to_mm_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
