// Auto-generated from hydration-hesaplama-schema.json
import * as z from 'zod';

export interface Hydration_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Hydration_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Hydration_hesaplamaInput): Record<string, number> {
...
export function calculateHydration_hesaplama(input: Hydration_hesaplamaInput): Hydration_hesaplamaOutput {
...
export interface Hydration_hesaplamaOutput {
...
export const Hydration_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
