// Auto-generated from arcsine-hesaplama-schema.json
import * as z from 'zod';

export interface Arcsine_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Arcsine_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Arcsine_hesaplamaInput): Record<string, number> {
...
export function calculateArcsine_hesaplama(input: Arcsine_hesaplamaInput): Arcsine_hesaplamaOutput {
...
export interface Arcsine_hesaplamaOutput {
...
export const Arcsine_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
