// Auto-generated from dog-yil-hesaplama-schema.json
import * as z from 'zod';

export interface Dog_yil_hesaplamaInput {
  petAge: number;
  petWeight: number;
  dataConfidence?: number;
}

export const Dog_yil_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Dog_yil_hesaplamaInput): Record<string, number> {
...
export function calculateDog_yil_hesaplama(input: Dog_yil_hesaplamaInput): Dog_yil_hesaplamaOutput {
...
export interface Dog_yil_hesaplamaOutput {
...
export const Dog_yil_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "years",
