// Auto-generated from reactor-design-hesaplama-schema.json
import * as z from 'zod';

export interface Reactor_design_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Reactor_design_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Reactor_design_hesaplamaInput): Record<string, number> {
...
export function calculateReactor_design_hesaplama(input: Reactor_design_hesaplamaInput): Reactor_design_hesaplamaOutput {
...
export interface Reactor_design_hesaplamaOutput {
...
export const Reactor_design_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
