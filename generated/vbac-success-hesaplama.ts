// Auto-generated from vbac-success-hesaplama-schema.json
import * as z from 'zod';

export interface Vbac_success_hesaplamaInput {
  flowRate: number;
  pipeDiameter: number;
  dataConfidence?: number;
}

export const Vbac_success_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Vbac_success_hesaplamaInput): Record<string, number> {
...
export function calculateVbac_success_hesaplama(input: Vbac_success_hesaplamaInput): Vbac_success_hesaplamaOutput {
...
export interface Vbac_success_hesaplamaOutput {
...
export const Vbac_success_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "L/min",
