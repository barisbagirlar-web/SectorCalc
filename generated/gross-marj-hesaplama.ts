// Auto-generated from gross-marj-hesaplama-schema.json
import * as z from 'zod';

export interface Gross_marj_hesaplamaInput {
  revenueAmount: number;
  costAmount: number;
  dataConfidence?: number;
}

export const Gross_marj_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Gross_marj_hesaplamaInput): Record<string, number> {
...
export function calculateGross_marj_hesaplama(input: Gross_marj_hesaplamaInput): Gross_marj_hesaplamaOutput {
...
export interface Gross_marj_hesaplamaOutput {
...
export const Gross_marj_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
