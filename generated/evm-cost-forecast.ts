// Auto-generated from evm-cost-forecast-schema.json
import * as z from 'zod';

export interface Evm_cost_forecastInput {
  bac: number;
  ev: number;
  ac: number;
  pv: number;
...
export const Evm_cost_forecastInputSchema = z.object({
...
export function calculateEvm_cost_forecast(input: Evm_cost_forecastInput): Evm_cost_forecastOutput {
...
export interface Evm_cost_forecastOutput {
