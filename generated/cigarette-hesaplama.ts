// Auto-generated from cigarette-hesaplama-schema.json
import * as z from 'zod';

export interface Cigarette_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Cigarette_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cigarette_hesaplamaInput): Record<string, number> {
...
export function calculateCigarette_hesaplama(input: Cigarette_hesaplamaInput): Cigarette_hesaplamaOutput {
...
export interface Cigarette_hesaplamaOutput {
...
export const Cigarette_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
