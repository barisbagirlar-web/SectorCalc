// Auto-generated from auc-hesaplama-schema.json
import * as z from 'zod';

export interface Auc_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Auc_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Auc_hesaplamaInput): Record<string, number> {
...
export function calculateAuc_hesaplama(input: Auc_hesaplamaInput): Auc_hesaplamaOutput {
...
export interface Auc_hesaplamaOutput {
...
export const Auc_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
