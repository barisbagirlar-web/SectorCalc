// Auto-generated from sukran-hesaplayici-schema.json
import * as z from 'zod';

export interface Sukran_hesaplayiciInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Sukran_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Sukran_hesaplayiciInput): Record<string, number> {
...
export function calculateSukran_hesaplayici(input: Sukran_hesaplayiciInput): Sukran_hesaplayiciOutput {
...
export interface Sukran_hesaplayiciOutput {
...
export const Sukran_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "",
