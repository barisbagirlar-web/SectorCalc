// Auto-generated from radioactive-decay-hesaplama-schema.json
import * as z from 'zod';

export interface Radioactive_decay_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Radioactive_decay_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Radioactive_decay_hesaplamaInput): Record<string, number> {
...
export function calculateRadioactive_decay_hesaplama(input: Radioactive_decay_hesaplamaInput): Radioactive_decay_hesaplamaOutput {
...
export interface Radioactive_decay_hesaplamaOutput {
...
export const Radioactive_decay_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
