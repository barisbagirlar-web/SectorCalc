// Auto-generated from afp-hesaplama-schema.json
import * as z from 'zod';

export interface Afp_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Afp_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Afp_hesaplamaInput): Record<string, number> {
...
export function calculateAfp_hesaplama(input: Afp_hesaplamaInput): Afp_hesaplamaOutput {
...
export interface Afp_hesaplamaOutput {
...
export const Afp_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
