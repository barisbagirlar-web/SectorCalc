// Auto-generated from biweekly-konut-kredisi-hesaplama-schema.json
import * as z from 'zod';

export interface Biweekly_konut_kredisi_hesaplamaInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Biweekly_konut_kredisi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Biweekly_konut_kredisi_hesaplamaInput): Record<string, number> {
...
export function calculateBiweekly_konut_kredisi_hesaplama(input: Biweekly_konut_kredisi_hesaplamaInput): Biweekly_konut_kredisi_hesaplamaOutput {
...
export interface Biweekly_konut_kredisi_hesaplamaOutput {
...
export const Biweekly_konut_kredisi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
