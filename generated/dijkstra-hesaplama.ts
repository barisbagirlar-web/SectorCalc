// Auto-generated from dijkstra-hesaplama-schema.json
import * as z from 'zod';

export interface Dijkstra_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Dijkstra_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Dijkstra_hesaplamaInput): Record<string, number> {
...
export function calculateDijkstra_hesaplama(input: Dijkstra_hesaplamaInput): Dijkstra_hesaplamaOutput {
...
export interface Dijkstra_hesaplamaOutput {
...
export const Dijkstra_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
