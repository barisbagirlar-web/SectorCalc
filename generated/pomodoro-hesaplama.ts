// Auto-generated from pomodoro-hesaplama-schema.json
import * as z from 'zod';

export interface Pomodoro_hesaplamaInput {
  dataSet: number;
  sampleSize: number;
  dataConfidence?: number;
}

export const Pomodoro_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pomodoro_hesaplamaInput): Record<string, number> {
...
export function calculatePomodoro_hesaplama(input: Pomodoro_hesaplamaInput): Pomodoro_hesaplamaOutput {
...
export interface Pomodoro_hesaplamaOutput {
...
export const Pomodoro_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
