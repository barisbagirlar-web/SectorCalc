// Auto-generated from sodium-hesaplama-schema.json
import * as z from 'zod';

export interface Sodium_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Sodium_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Sodium_hesaplamaInput): Record<string, number> {
...
export function calculateSodium_hesaplama(input: Sodium_hesaplamaInput): Sodium_hesaplamaOutput {
...
export interface Sodium_hesaplamaOutput {
...
export const Sodium_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
