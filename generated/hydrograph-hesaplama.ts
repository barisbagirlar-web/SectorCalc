// Auto-generated from hydrograph-hesaplama-schema.json
import * as z from 'zod';

export interface Hydrograph_hesaplamaInput {
  matrixSize: number;
  matrixElement: number;
  dataConfidence?: number;
}

export const Hydrograph_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Hydrograph_hesaplamaInput): Record<string, number> {
...
export function calculateHydrograph_hesaplama(input: Hydrograph_hesaplamaInput): Hydrograph_hesaplamaOutput {
...
export interface Hydrograph_hesaplamaOutput {
...
export const Hydrograph_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
