// Auto-generated from radian-hesaplama-schema.json
import * as z from 'zod';

export interface Radian_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Radian_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Radian_hesaplamaInput): Record<string, number> {
...
export function calculateRadian_hesaplama(input: Radian_hesaplamaInput): Radian_hesaplamaOutput {
...
export interface Radian_hesaplamaOutput {
...
export const Radian_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
