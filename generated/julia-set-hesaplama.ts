// Auto-generated from julia-set-hesaplama-schema.json
import * as z from 'zod';

export interface Julia_set_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Julia_set_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Julia_set_hesaplamaInput): Record<string, number> {
...
export function calculateJulia_set_hesaplama(input: Julia_set_hesaplamaInput): Julia_set_hesaplamaOutput {
...
export interface Julia_set_hesaplamaOutput {
...
export const Julia_set_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
