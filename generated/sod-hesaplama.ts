// Auto-generated from sod-hesaplama-schema.json
import * as z from 'zod';

export interface Sod_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Sod_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Sod_hesaplamaInput): Record<string, number> {
...
export function calculateSod_hesaplama(input: Sod_hesaplamaInput): Sod_hesaplamaOutput {
...
export interface Sod_hesaplamaOutput {
...
export const Sod_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
