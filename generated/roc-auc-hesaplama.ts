// Auto-generated from roc-auc-hesaplama-schema.json
import * as z from 'zod';

export interface Roc_auc_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Roc_auc_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Roc_auc_hesaplamaInput): Record<string, number> {
...
export function calculateRoc_auc_hesaplama(input: Roc_auc_hesaplamaInput): Roc_auc_hesaplamaOutput {
...
export interface Roc_auc_hesaplamaOutput {
...
export const Roc_auc_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
