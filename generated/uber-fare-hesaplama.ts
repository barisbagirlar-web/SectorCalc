// Auto-generated from uber-fare-hesaplama-schema.json
import * as z from 'zod';

export interface Uber_fare_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Uber_fare_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Uber_fare_hesaplamaInput): Record<string, number> {
...
export function calculateUber_fare_hesaplama(input: Uber_fare_hesaplamaInput): Uber_fare_hesaplamaOutput {
...
export interface Uber_fare_hesaplamaOutput {
...
export const Uber_fare_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
