// Auto-generated from roc-curve-hesaplama-schema.json
import * as z from 'zod';

export interface Roc_curve_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Roc_curve_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Roc_curve_hesaplamaInput): Record<string, number> {
...
export function calculateRoc_curve_hesaplama(input: Roc_curve_hesaplamaInput): Roc_curve_hesaplamaOutput {
...
export interface Roc_curve_hesaplamaOutput {
...
export const Roc_curve_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
