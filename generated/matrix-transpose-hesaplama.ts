// Auto-generated from matrix-transpose-hesaplama-schema.json
import * as z from 'zod';

export interface Matrix_transpose_hesaplamaInput {
  matrixSize: number;
  matrixElement: number;
  dataConfidence?: number;
}

export const Matrix_transpose_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Matrix_transpose_hesaplamaInput): Record<string, number> {
...
export function calculateMatrix_transpose_hesaplama(input: Matrix_transpose_hesaplamaInput): Matrix_transpose_hesaplamaOutput {
...
export interface Matrix_transpose_hesaplamaOutput {
...
export const Matrix_transpose_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
