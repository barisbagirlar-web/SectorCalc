// Auto-generated from crawl-space-hesaplama-schema.json
import * as z from 'zod';

export interface Crawl_space_hesaplamaInput {
  distanceKm: number;
  durationMin: number;
  dataConfidence?: number;
}

export const Crawl_space_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Crawl_space_hesaplamaInput): Record<string, number> {
...
export function calculateCrawl_space_hesaplama(input: Crawl_space_hesaplamaInput): Crawl_space_hesaplamaOutput {
...
export interface Crawl_space_hesaplamaOutput {
...
export const Crawl_space_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "km",
