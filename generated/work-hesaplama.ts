// Auto-generated from work-hesaplama-schema.json
import * as z from 'zod';

export interface Work_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Work_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Work_hesaplamaInput): Record<string, number> {
...
export function calculateWork_hesaplama(input: Work_hesaplamaInput): Work_hesaplamaOutput {
...
export interface Work_hesaplamaOutput {
...
export const Work_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
