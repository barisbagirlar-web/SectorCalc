// Auto-generated from lottery-hesaplama-schema.json
import * as z from 'zod';

export interface Lottery_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Lottery_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Lottery_hesaplamaInput): Record<string, number> {
...
export function calculateLottery_hesaplama(input: Lottery_hesaplamaInput): Lottery_hesaplamaOutput {
...
export interface Lottery_hesaplamaOutput {
...
export const Lottery_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
