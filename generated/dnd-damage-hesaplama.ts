// Auto-generated from dnd-damage-hesaplama-schema.json
import * as z from 'zod';

export interface Dnd_damage_hesaplamaInput {
  birthDate: number;
  referenceDate: number;
  dataConfidence?: number;
}

export const Dnd_damage_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Dnd_damage_hesaplamaInput): Record<string, number> {
...
export function calculateDnd_damage_hesaplama(input: Dnd_damage_hesaplamaInput): Dnd_damage_hesaplamaOutput {
...
export interface Dnd_damage_hesaplamaOutput {
...
export const Dnd_damage_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "date",
