// Auto-generated from vector-hesaplama-schema.json
import * as z from 'zod';

export interface Vector_hesaplamaInput {
  matrixSize: number;
  matrixElement: number;
  dataConfidence?: number;
}

export const Vector_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Vector_hesaplamaInput): Record<string, number> {
...
export function calculateVector_hesaplama(input: Vector_hesaplamaInput): Vector_hesaplamaOutput {
...
export interface Vector_hesaplamaOutput {
...
export const Vector_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
