// Auto-generated from gd-ve-t-hesaplama-schema.json
import * as z from 'zod';

export interface Gd_ve_t_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Gd_ve_t_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Gd_ve_t_hesaplamaInput): Record<string, number> {
...
export function calculateGd_ve_t_hesaplama(input: Gd_ve_t_hesaplamaInput): Gd_ve_t_hesaplamaOutput {
...
export interface Gd_ve_t_hesaplamaOutput {
...
export const Gd_ve_t_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
