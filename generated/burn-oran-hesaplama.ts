// Auto-generated from burn-oran-hesaplama-schema.json
import * as z from 'zod';

export interface Burn_oran_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Burn_oran_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Burn_oran_hesaplamaInput): Record<string, number> {
...
export function calculateBurn_oran_hesaplama(input: Burn_oran_hesaplamaInput): Burn_oran_hesaplamaOutput {
...
export interface Burn_oran_hesaplamaOutput {
...
export const Burn_oran_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
