// Auto-generated from savings-goal-hesaplama-schema.json
import * as z from 'zod';

export interface Savings_goal_hesaplamaInput {
  principal: number;
  annualRate: number;
  dataConfidence?: number;
}

export const Savings_goal_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Savings_goal_hesaplamaInput): Record<string, number> {
...
export function calculateSavings_goal_hesaplama(input: Savings_goal_hesaplamaInput): Savings_goal_hesaplamaOutput {
...
export interface Savings_goal_hesaplamaOutput {
...
export const Savings_goal_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
