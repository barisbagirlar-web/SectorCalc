// Auto-generated from heloc-hesaplayici-schema.json
import * as z from 'zod';

export interface Heloc_hesaplayiciInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Heloc_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Heloc_hesaplayiciInput): Record<string, number> {
...
export function calculateHeloc_hesaplayici(input: Heloc_hesaplayiciInput): Heloc_hesaplayiciOutput {
...
export interface Heloc_hesaplayiciOutput {
...
export const Heloc_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "",
