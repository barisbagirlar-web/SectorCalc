// Auto-generated from reverse-konut-kredisi-hesaplama-schema.json
import * as z from 'zod';

export interface Reverse_konut_kredisi_hesaplamaInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Reverse_konut_kredisi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Reverse_konut_kredisi_hesaplamaInput): Record<string, number> {
...
export function calculateReverse_konut_kredisi_hesaplama(input: Reverse_konut_kredisi_hesaplamaInput): Reverse_konut_kredisi_hesaplamaOutput {
...
export interface Reverse_konut_kredisi_hesaplamaOutput {
...
export const Reverse_konut_kredisi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
