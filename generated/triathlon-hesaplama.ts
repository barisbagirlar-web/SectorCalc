// Auto-generated from triathlon-hesaplama-schema.json
import * as z from 'zod';

export interface Triathlon_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Triathlon_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Triathlon_hesaplamaInput): Record<string, number> {
...
export function calculateTriathlon_hesaplama(input: Triathlon_hesaplamaInput): Triathlon_hesaplamaOutput {
...
export interface Triathlon_hesaplamaOutput {
...
export const Triathlon_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
