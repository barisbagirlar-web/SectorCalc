// Auto-generated from leed-hesaplama-schema.json
import * as z from 'zod';

export interface Leed_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Leed_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Leed_hesaplamaInput): Record<string, number> {
...
export function calculateLeed_hesaplama(input: Leed_hesaplamaInput): Leed_hesaplamaOutput {
...
export interface Leed_hesaplamaOutput {
...
export const Leed_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
