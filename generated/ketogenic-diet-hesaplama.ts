// Auto-generated from ketogenic-diet-hesaplama-schema.json
import * as z from 'zod';

export interface Ketogenic_diet_hesaplamaInput {
  dailyCalories: number;
  bodyMass: number;
  dataConfidence?: number;
}

export const Ketogenic_diet_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ketogenic_diet_hesaplamaInput): Record<string, number> {
...
export function calculateKetogenic_diet_hesaplama(input: Ketogenic_diet_hesaplamaInput): Ketogenic_diet_hesaplamaOutput {
...
export interface Ketogenic_diet_hesaplamaOutput {
...
export const Ketogenic_diet_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "kcal",
