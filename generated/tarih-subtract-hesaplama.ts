// Auto-generated from tarih-subtract-hesaplama-schema.json
import * as z from 'zod';

export interface Tarih_subtract_hesaplamaInput {
  birthDate: number;
  referenceDate: number;
  dataConfidence?: number;
}

export const Tarih_subtract_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Tarih_subtract_hesaplamaInput): Record<string, number> {
...
export function calculateTarih_subtract_hesaplama(input: Tarih_subtract_hesaplamaInput): Tarih_subtract_hesaplamaOutput {
...
export interface Tarih_subtract_hesaplamaOutput {
...
export const Tarih_subtract_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "date",
