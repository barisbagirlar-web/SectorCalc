// Auto-generated from cycling-ftp-hesaplama-schema.json
import * as z from 'zod';

export interface Cycling_ftp_hesaplamaInput {
  heartRate: number;
  exerciseDuration: number;
  dataConfidence?: number;
}

export const Cycling_ftp_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cycling_ftp_hesaplamaInput): Record<string, number> {
...
export function calculateCycling_ftp_hesaplama(input: Cycling_ftp_hesaplamaInput): Cycling_ftp_hesaplamaOutput {
...
export interface Cycling_ftp_hesaplamaOutput {
...
export const Cycling_ftp_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "bpm",
