// Auto-generated from ielts-score-hesaplama-schema.json
import * as z from 'zod';

export interface Ielts_score_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Ielts_score_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ielts_score_hesaplamaInput): Record<string, number> {
...
export function calculateIelts_score_hesaplama(input: Ielts_score_hesaplamaInput): Ielts_score_hesaplamaOutput {
...
export interface Ielts_score_hesaplamaOutput {
...
export const Ielts_score_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
