// Auto-generated from cashback-hesaplama-schema.json
import * as z from 'zod';

export interface Cashback_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Cashback_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cashback_hesaplamaInput): Record<string, number> {
...
export function calculateCashback_hesaplama(input: Cashback_hesaplamaInput): Cashback_hesaplamaOutput {
...
export interface Cashback_hesaplamaOutput {
...
export const Cashback_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
