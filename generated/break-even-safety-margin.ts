// Auto-generated from break-even-safety-margin-schema.json
import * as z from 'zod';

export interface Break_even_safety_marginInput {
  fixedCosts: number;
...
export const Break_even_safety_marginInputSchema = z.object({
...
export function calculateBreak_even_safety_margin(input: Break_even_safety_marginInput): Break_even_safety_marginOutput {
...
export interface Break_even_safety_marginOutput {
