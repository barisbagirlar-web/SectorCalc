// Auto-generated from swimming-pace-hesaplama-schema.json
import * as z from 'zod';

export interface Swimming_pace_hesaplamaInput {
  distanceKm: number;
  durationMin: number;
  dataConfidence?: number;
}

export const Swimming_pace_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Swimming_pace_hesaplamaInput): Record<string, number> {
...
export function calculateSwimming_pace_hesaplama(input: Swimming_pace_hesaplamaInput): Swimming_pace_hesaplamaOutput {
...
export interface Swimming_pace_hesaplamaOutput {
...
export const Swimming_pace_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "km",
