// Auto-generated from sofa-score-hesaplama-schema.json
import * as z from 'zod';

export interface Sofa_score_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Sofa_score_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Sofa_score_hesaplamaInput): Record<string, number> {
...
export function calculateSofa_score_hesaplama(input: Sofa_score_hesaplamaInput): Sofa_score_hesaplamaOutput {
...
export interface Sofa_score_hesaplamaOutput {
...
export const Sofa_score_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
