// Auto-generated from clv-hesaplama-schema.json
import * as z from 'zod';

export interface Clv_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Clv_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Clv_hesaplamaInput): Record<string, number> {
...
export function calculateClv_hesaplama(input: Clv_hesaplamaInput): Clv_hesaplamaOutput {
...
export interface Clv_hesaplamaOutput {
...
export const Clv_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
