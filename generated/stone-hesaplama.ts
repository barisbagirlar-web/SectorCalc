// Auto-generated from stone-hesaplama-schema.json
import * as z from 'zod';

export interface Stone_hesaplamaInput {
  massValue: number;
  dataConfidence?: number;
}

export const Stone_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Stone_hesaplamaInput): Record<string, number> {
...
export function calculateStone_hesaplama(input: Stone_hesaplamaInput): Stone_hesaplamaOutput {
...
export interface Stone_hesaplamaOutput {
...
export const Stone_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "kg",
