// Auto-generated from nd-filter-hesaplama-schema.json
import * as z from 'zod';

export interface Nd_filter_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Nd_filter_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Nd_filter_hesaplamaInput): Record<string, number> {
...
export function calculateNd_filter_hesaplama(input: Nd_filter_hesaplamaInput): Nd_filter_hesaplamaOutput {
...
export interface Nd_filter_hesaplamaOutput {
...
export const Nd_filter_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
