// Auto-generated from sugar-stages-hesaplama-schema.json
import * as z from 'zod';

export interface Sugar_stages_hesaplamaInput {
  birthDate: number;
  referenceDate: number;
  dataConfidence?: number;
}

export const Sugar_stages_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Sugar_stages_hesaplamaInput): Record<string, number> {
...
export function calculateSugar_stages_hesaplama(input: Sugar_stages_hesaplamaInput): Sugar_stages_hesaplamaOutput {
...
export interface Sugar_stages_hesaplamaOutput {
...
export const Sugar_stages_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "date",
