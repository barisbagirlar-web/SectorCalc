// Auto-generated from archery-hesaplama-schema.json
import * as z from 'zod';

export interface Archery_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Archery_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Archery_hesaplamaInput): Record<string, number> {
...
export function calculateArchery_hesaplama(input: Archery_hesaplamaInput): Archery_hesaplamaOutput {
...
export interface Archery_hesaplamaOutput {
...
export const Archery_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
