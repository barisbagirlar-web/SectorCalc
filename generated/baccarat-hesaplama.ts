// Auto-generated from baccarat-hesaplama-schema.json
import * as z from 'zod';

export interface Baccarat_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Baccarat_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Baccarat_hesaplamaInput): Record<string, number> {
...
export function calculateBaccarat_hesaplama(input: Baccarat_hesaplamaInput): Baccarat_hesaplamaOutput {
...
export interface Baccarat_hesaplamaOutput {
...
export const Baccarat_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
