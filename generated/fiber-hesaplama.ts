// Auto-generated from fiber-hesaplama-schema.json
import * as z from 'zod';

export interface Fiber_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Fiber_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Fiber_hesaplamaInput): Record<string, number> {
...
export function calculateFiber_hesaplama(input: Fiber_hesaplamaInput): Fiber_hesaplamaOutput {
...
export interface Fiber_hesaplamaOutput {
...
export const Fiber_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
