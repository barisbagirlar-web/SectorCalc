// Auto-generated from cd-hesaplayici-schema.json
import * as z from 'zod';

export interface Cd_hesaplayiciInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Cd_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Cd_hesaplayiciInput): Record<string, number> {
...
export function calculateCd_hesaplayici(input: Cd_hesaplayiciInput): Cd_hesaplayiciOutput {
...
export interface Cd_hesaplayiciOutput {
...
export const Cd_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "",
