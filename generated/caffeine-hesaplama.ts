// Auto-generated from caffeine-hesaplama-schema.json
import * as z from 'zod';

export interface Caffeine_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Caffeine_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Caffeine_hesaplamaInput): Record<string, number> {
...
export function calculateCaffeine_hesaplama(input: Caffeine_hesaplamaInput): Caffeine_hesaplamaOutput {
...
export interface Caffeine_hesaplamaOutput {
...
export const Caffeine_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
