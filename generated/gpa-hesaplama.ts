// Auto-generated from gpa-hesaplama-schema.json
import * as z from 'zod';

export interface Gpa_hesaplamaInput {
  gradePoints: number;
  creditHours: number;
  dataConfidence?: number;
}

export const Gpa_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Gpa_hesaplamaInput): Record<string, number> {
...
export function calculateGpa_hesaplama(input: Gpa_hesaplamaInput): Gpa_hesaplamaOutput {
...
export interface Gpa_hesaplamaOutput {
...
export const Gpa_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "points",
