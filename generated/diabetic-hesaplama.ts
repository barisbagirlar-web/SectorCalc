// Auto-generated from diabetic-hesaplama-schema.json
import * as z from 'zod';

export interface Diabetic_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Diabetic_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Diabetic_hesaplamaInput): Record<string, number> {
...
export function calculateDiabetic_hesaplama(input: Diabetic_hesaplamaInput): Diabetic_hesaplamaOutput {
...
export interface Diabetic_hesaplamaOutput {
...
export const Diabetic_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
