// Auto-generated from bilgi-orani-hesaplama-schema.json
import * as z from 'zod';

export interface Bilgi_orani_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Bilgi_orani_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Bilgi_orani_hesaplamaInput): Record<string, number> {
...
export function calculateBilgi_orani_hesaplama(input: Bilgi_orani_hesaplamaInput): Bilgi_orani_hesaplamaOutput {
...
export interface Bilgi_orani_hesaplamaOutput {
...
export const Bilgi_orani_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
