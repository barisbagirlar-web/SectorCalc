// Auto-generated from cheat-gun-hesaplama-schema.json
import * as z from 'zod';

export interface Cheat_gun_hesaplamaInput {
  temperatureValue: number;
  dataConfidence?: number;
}

export const Cheat_gun_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cheat_gun_hesaplamaInput): Record<string, number> {
...
export function calculateCheat_gun_hesaplama(input: Cheat_gun_hesaplamaInput): Cheat_gun_hesaplamaOutput {
...
export interface Cheat_gun_hesaplamaOutput {
...
export const Cheat_gun_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "°C",
