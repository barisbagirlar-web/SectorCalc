// Auto-generated from annuity-payout-hesaplama-schema.json
import * as z from 'zod';

export interface Annuity_payout_hesaplamaInput {
  currentAge: number;
  retirementAge: number;
  dataConfidence?: number;
}

export const Annuity_payout_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Annuity_payout_hesaplamaInput): Record<string, number> {
...
export function calculateAnnuity_payout_hesaplama(input: Annuity_payout_hesaplamaInput): Annuity_payout_hesaplamaOutput {
...
export interface Annuity_payout_hesaplamaOutput {
...
export const Annuity_payout_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "years",
