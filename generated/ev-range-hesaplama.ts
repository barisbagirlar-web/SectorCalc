// Auto-generated from ev-range-hesaplama-schema.json
import * as z from 'zod';

export interface Ev_range_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Ev_range_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ev_range_hesaplamaInput): Record<string, number> {
...
export function calculateEv_range_hesaplama(input: Ev_range_hesaplamaInput): Ev_range_hesaplamaOutput {
...
export interface Ev_range_hesaplamaOutput {
...
export const Ev_range_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
