// Auto-generated from homebrew-hesaplama-schema.json
import * as z from 'zod';

export interface Homebrew_hesaplamaInput {
  originalGravity: number;
  dataConfidence?: number;
}

export const Homebrew_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Homebrew_hesaplamaInput): Record<string, number> {
...
export function calculateHomebrew_hesaplama(input: Homebrew_hesaplamaInput): Homebrew_hesaplamaOutput {
...
export interface Homebrew_hesaplamaOutput {
...
export const Homebrew_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "SG",
