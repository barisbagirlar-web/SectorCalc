// Auto-generated from clat-hesaplama-schema.json
import * as z from 'zod';

export interface Clat_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Clat_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Clat_hesaplamaInput): Record<string, number> {
...
export function calculateClat_hesaplama(input: Clat_hesaplamaInput): Clat_hesaplamaOutput {
...
export interface Clat_hesaplamaOutput {
...
export const Clat_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
