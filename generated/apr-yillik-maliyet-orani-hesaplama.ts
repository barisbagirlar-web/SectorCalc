// Auto-generated from apr-yillik-maliyet-orani-hesaplama-schema.json
import * as z from 'zod';

export interface Apr_yillik_maliyet_orani_hesaplamaInput {
  kredi: number;
  faiz: number;
  vade: number;
  masraf: number;
...
export const Apr_yillik_maliyet_orani_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Apr_yillik_maliyet_orani_hesaplamaInput): Record<string, number> {
...
export function calculateApr_yillik_maliyet_orani_hesaplama(input: Apr_yillik_maliyet_orani_hesaplamaInput): Apr_yillik_maliyet_orani_hesaplamaOutput {
...
export interface Apr_yillik_maliyet_orani_hesaplamaOutput {
...
export const Apr_yillik_maliyet_orani_hesaplamaOutputMeta = {
  primaryKey: "sonuc",
  unit: "%",
