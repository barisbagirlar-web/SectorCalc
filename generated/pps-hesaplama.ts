// Auto-generated from pps-hesaplama-schema.json
import * as z from 'zod';

export interface Pps_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Pps_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pps_hesaplamaInput): Record<string, number> {
...
export function calculatePps_hesaplama(input: Pps_hesaplamaInput): Pps_hesaplamaOutput {
...
export interface Pps_hesaplamaOutput {
...
export const Pps_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
