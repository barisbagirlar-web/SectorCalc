// Auto-generated from protein-powder-hesaplama-schema.json
import * as z from 'zod';

export interface Protein_powder_hesaplamaInput {
  dailyCalories: number;
  bodyMass: number;
  dataConfidence?: number;
}

export const Protein_powder_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Protein_powder_hesaplamaInput): Record<string, number> {
...
export function calculateProtein_powder_hesaplama(input: Protein_powder_hesaplamaInput): Protein_powder_hesaplamaOutput {
...
export interface Protein_powder_hesaplamaOutput {
...
export const Protein_powder_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "kcal",
