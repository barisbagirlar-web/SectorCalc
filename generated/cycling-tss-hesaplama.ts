// Auto-generated from cycling-tss-hesaplama-schema.json
import * as z from 'zod';

export interface Cycling_tss_hesaplamaInput {
  heartRate: number;
  exerciseDuration: number;
  dataConfidence?: number;
}

export const Cycling_tss_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cycling_tss_hesaplamaInput): Record<string, number> {
...
export function calculateCycling_tss_hesaplama(input: Cycling_tss_hesaplamaInput): Cycling_tss_hesaplamaOutput {
...
export interface Cycling_tss_hesaplamaOutput {
...
export const Cycling_tss_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "bpm",
