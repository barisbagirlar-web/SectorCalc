// Auto-generated from biot-savart-manyetik-alan-hesaplama-schema.json
import * as z from 'zod';

export interface Biot_savart_manyetik_alan_hesaplamaInput {
  akim: number;
  uzunluk: number;
  mesafe: number;
  aci: number;
...
export const Biot_savart_manyetik_alan_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Biot_savart_manyetik_alan_hesaplamaInput): Record<string, number> {
...
export function calculateBiot_savart_manyetik_alan_hesaplama(input: Biot_savart_manyetik_alan_hesaplamaInput): Biot_savart_manyetik_alan_hesaplamaOutput {
...
export interface Biot_savart_manyetik_alan_hesaplamaOutput {
...
export const Biot_savart_manyetik_alan_hesaplamaOutputMeta = {
  primaryKey: "sonuc",
  unit: "T",
  breakdownKeys: ["sonuc"],
} as const;
