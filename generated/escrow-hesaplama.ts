// Auto-generated from escrow-hesaplama-schema.json
import * as z from 'zod';

export interface Escrow_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Escrow_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Escrow_hesaplamaInput): Record<string, number> {
...
export function calculateEscrow_hesaplama(input: Escrow_hesaplamaInput): Escrow_hesaplamaOutput {
...
export interface Escrow_hesaplamaOutput {
...
export const Escrow_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
