// Auto-generated from whitening-hesaplama-schema.json
import * as z from 'zod';

export interface Whitening_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Whitening_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Whitening_hesaplamaInput): Record<string, number> {
...
export function calculateWhitening_hesaplama(input: Whitening_hesaplamaInput): Whitening_hesaplamaOutput {
...
export interface Whitening_hesaplamaOutput {
...
export const Whitening_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
