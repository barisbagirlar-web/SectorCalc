// Auto-generated from cycling-wkg-hesaplama-schema.json
import * as z from 'zod';

export interface Cycling_wkg_hesaplamaInput {
  heartRate: number;
  exerciseDuration: number;
  dataConfidence?: number;
}

export const Cycling_wkg_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cycling_wkg_hesaplamaInput): Record<string, number> {
...
export function calculateCycling_wkg_hesaplama(input: Cycling_wkg_hesaplamaInput): Cycling_wkg_hesaplamaOutput {
...
export interface Cycling_wkg_hesaplamaOutput {
...
export const Cycling_wkg_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "bpm",
