// Auto-generated from subscription-hesaplama-schema.json
import * as z from 'zod';

export interface Subscription_hesaplamaInput {
  flowRate: number;
  pipeDiameter: number;
  dataConfidence?: number;
}

export const Subscription_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Subscription_hesaplamaInput): Record<string, number> {
...
export function calculateSubscription_hesaplama(input: Subscription_hesaplamaInput): Subscription_hesaplamaOutput {
...
export interface Subscription_hesaplamaOutput {
...
export const Subscription_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "L/min",
