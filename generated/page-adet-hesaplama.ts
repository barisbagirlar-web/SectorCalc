// Auto-generated from page-adet-hesaplama-schema.json
import * as z from 'zod';

export interface Page_adet_hesaplamaInput {
  birthDate: number;
  referenceDate: number;
  dataConfidence?: number;
}

export const Page_adet_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Page_adet_hesaplamaInput): Record<string, number> {
...
export function calculatePage_adet_hesaplama(input: Page_adet_hesaplamaInput): Page_adet_hesaplamaOutput {
...
export interface Page_adet_hesaplamaOutput {
...
export const Page_adet_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "date",
