// Auto-generated from carbohydrate-hesaplama-schema.json
import * as z from 'zod';

export interface Carbohydrate_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Carbohydrate_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Carbohydrate_hesaplamaInput): Record<string, number> {
...
export function calculateCarbohydrate_hesaplama(input: Carbohydrate_hesaplamaInput): Carbohydrate_hesaplamaOutput {
...
export interface Carbohydrate_hesaplamaOutput {
...
export const Carbohydrate_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
