// Auto-generated from madrs-hesaplama-schema.json
import * as z from 'zod';

export interface Madrs_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Madrs_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Madrs_hesaplamaInput): Record<string, number> {
...
export function calculateMadrs_hesaplama(input: Madrs_hesaplamaInput): Madrs_hesaplamaOutput {
...
export interface Madrs_hesaplamaOutput {
...
export const Madrs_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
