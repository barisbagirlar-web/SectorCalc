// Auto-generated from normality-hesaplama-schema.json
import * as z from 'zod';

export interface Normality_hesaplamaInput {
  sampleMean: number;
  standardDeviation: number;
  dataConfidence?: number;
}

export const Normality_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Normality_hesaplamaInput): Record<string, number> {
...
export function calculateNormality_hesaplama(input: Normality_hesaplamaInput): Normality_hesaplamaOutput {
...
export interface Normality_hesaplamaOutput {
...
export const Normality_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
