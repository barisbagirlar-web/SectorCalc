// Auto-generated from hcg-level-hesaplama-schema.json
import * as z from 'zod';

export interface Hcg_level_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Hcg_level_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Hcg_level_hesaplamaInput): Record<string, number> {
...
export function calculateHcg_level_hesaplama(input: Hcg_level_hesaplamaInput): Hcg_level_hesaplamaOutput {
...
export interface Hcg_level_hesaplamaOutput {
...
export const Hcg_level_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
