// Auto-generated from ml-to-cups-hesaplama-schema.json
import * as z from 'zod';

export interface Ml_to_cups_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Ml_to_cups_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ml_to_cups_hesaplamaInput): Record<string, number> {
...
export function calculateMl_to_cups_hesaplama(input: Ml_to_cups_hesaplamaInput): Ml_to_cups_hesaplamaOutput {
...
export interface Ml_to_cups_hesaplamaOutput {
...
export const Ml_to_cups_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
