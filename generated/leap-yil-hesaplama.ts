// Auto-generated from leap-yil-hesaplama-schema.json
import * as z from 'zod';

export interface Leap_yil_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Leap_yil_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Leap_yil_hesaplamaInput): Record<string, number> {
...
export function calculateLeap_yil_hesaplama(input: Leap_yil_hesaplamaInput): Leap_yil_hesaplamaOutput {
...
export interface Leap_yil_hesaplamaOutput {
...
export const Leap_yil_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
