// Auto-generated from pounds-to-stones-hesaplama-schema.json
import * as z from 'zod';

export interface Pounds_to_stones_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Pounds_to_stones_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pounds_to_stones_hesaplamaInput): Record<string, number> {
...
export function calculatePounds_to_stones_hesaplama(input: Pounds_to_stones_hesaplamaInput): Pounds_to_stones_hesaplamaOutput {
...
export interface Pounds_to_stones_hesaplamaOutput {
...
export const Pounds_to_stones_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
