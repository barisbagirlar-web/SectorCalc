// Auto-generated from marketing-roi-hesaplama-schema.json
import * as z from 'zod';

export interface Marketing_roi_hesaplamaInput {
  principal: number;
  rate: number;
  periods: number;
...
export const Marketing_roi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Marketing_roi_hesaplamaInput): Record<string, number> {
...
export function calculateMarketing_roi_hesaplama(input: Marketing_roi_hesaplamaInput): Marketing_roi_hesaplamaOutput {
...
export interface Marketing_roi_hesaplamaOutput {
...
export const Marketing_roi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
