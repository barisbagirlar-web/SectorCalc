// Auto-generated from ciwa-hesaplama-schema.json
import * as z from 'zod';

export interface Ciwa_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Ciwa_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ciwa_hesaplamaInput): Record<string, number> {
...
export function calculateCiwa_hesaplama(input: Ciwa_hesaplamaInput): Ciwa_hesaplamaOutput {
...
export interface Ciwa_hesaplamaOutput {
...
export const Ciwa_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
