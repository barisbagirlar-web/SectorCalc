// Auto-generated from cac-hesaplama-schema.json
import * as z from 'zod';

export interface Cac_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Cac_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cac_hesaplamaInput): Record<string, number> {
...
export function calculateCac_hesaplama(input: Cac_hesaplamaInput): Cac_hesaplamaOutput {
...
export interface Cac_hesaplamaOutput {
...
export const Cac_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
