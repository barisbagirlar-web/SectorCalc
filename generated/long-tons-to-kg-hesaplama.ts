// Auto-generated from long-tons-to-kg-hesaplama-schema.json
import * as z from 'zod';

export interface Long_tons_to_kg_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Long_tons_to_kg_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Long_tons_to_kg_hesaplamaInput): Record<string, number> {
...
export function calculateLong_tons_to_kg_hesaplama(input: Long_tons_to_kg_hesaplamaInput): Long_tons_to_kg_hesaplamaOutput {
...
export interface Long_tons_to_kg_hesaplamaOutput {
...
export const Long_tons_to_kg_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
