// Auto-generated from decimal-hesaplama-schema.json
import * as z from 'zod';

export interface Decimal_hesaplamaInput {
  numerator: number;
  denominator: number;
  dataConfidence?: number;
}

export const Decimal_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Decimal_hesaplamaInput): Record<string, number> {
...
export function calculateDecimal_hesaplama(input: Decimal_hesaplamaInput): Decimal_hesaplamaOutput {
...
export interface Decimal_hesaplamaOutput {
...
export const Decimal_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
