// Auto-generated from cycling-mesafe-hesaplama-schema.json
import * as z from 'zod';

export interface Cycling_mesafe_hesaplamaInput {
  heartRate: number;
  exerciseDuration: number;
  dataConfidence?: number;
}

export const Cycling_mesafe_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cycling_mesafe_hesaplamaInput): Record<string, number> {
...
export function calculateCycling_mesafe_hesaplama(input: Cycling_mesafe_hesaplamaInput): Cycling_mesafe_hesaplamaOutput {
...
export interface Cycling_mesafe_hesaplamaOutput {
...
export const Cycling_mesafe_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "bpm",
