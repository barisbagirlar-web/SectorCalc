// Auto-generated from epoxy-hesaplama-schema.json
import * as z from 'zod';

export interface Epoxy_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Epoxy_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Epoxy_hesaplamaInput): Record<string, number> {
...
export function calculateEpoxy_hesaplama(input: Epoxy_hesaplamaInput): Epoxy_hesaplamaOutput {
...
export interface Epoxy_hesaplamaOutput {
...
export const Epoxy_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
