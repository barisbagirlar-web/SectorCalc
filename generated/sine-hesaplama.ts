// Auto-generated from sine-hesaplama-schema.json
import * as z from 'zod';

export interface Sine_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Sine_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Sine_hesaplamaInput): Record<string, number> {
...
export function calculateSine_hesaplama(input: Sine_hesaplamaInput): Sine_hesaplamaOutput {
...
export interface Sine_hesaplamaOutput {
...
export const Sine_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
