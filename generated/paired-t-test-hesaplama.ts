// Auto-generated from paired-t-test-hesaplama-schema.json
import * as z from 'zod';

export interface Paired_t_test_hesaplamaInput {
  sampleMean: number;
  standardDeviation: number;
  dataConfidence?: number;
}

export const Paired_t_test_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Paired_t_test_hesaplamaInput): Record<string, number> {
...
export function calculatePaired_t_test_hesaplama(input: Paired_t_test_hesaplamaInput): Paired_t_test_hesaplamaOutput {
...
export interface Paired_t_test_hesaplamaOutput {
...
export const Paired_t_test_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
