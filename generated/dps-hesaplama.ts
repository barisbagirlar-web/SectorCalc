// Auto-generated from dps-hesaplama-schema.json
import * as z from 'zod';

export interface Dps_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Dps_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Dps_hesaplamaInput): Record<string, number> {
...
export function calculateDps_hesaplama(input: Dps_hesaplamaInput): Dps_hesaplamaOutput {
...
export interface Dps_hesaplamaOutput {
...
export const Dps_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
