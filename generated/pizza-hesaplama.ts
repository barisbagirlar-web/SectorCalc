// Auto-generated from pizza-hesaplama-schema.json
import * as z from 'zod';

export interface Pizza_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Pizza_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pizza_hesaplamaInput): Record<string, number> {
...
export function calculatePizza_hesaplama(input: Pizza_hesaplamaInput): Pizza_hesaplamaOutput {
...
export interface Pizza_hesaplamaOutput {
...
export const Pizza_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
