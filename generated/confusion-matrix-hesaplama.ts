// Auto-generated from confusion-matrix-hesaplama-schema.json
import * as z from 'zod';

export interface Confusion_matrix_hesaplamaInput {
  matrixSize: number;
  matrixElement: number;
  dataConfidence?: number;
}

export const Confusion_matrix_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Confusion_matrix_hesaplamaInput): Record<string, number> {
...
export function calculateConfusion_matrix_hesaplama(input: Confusion_matrix_hesaplamaInput): Confusion_matrix_hesaplamaOutput {
...
export interface Confusion_matrix_hesaplamaOutput {
...
export const Confusion_matrix_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
