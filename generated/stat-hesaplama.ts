// Auto-generated from stat-hesaplama-schema.json
import * as z from 'zod';

export interface Stat_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Stat_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Stat_hesaplamaInput): Record<string, number> {
...
export function calculateStat_hesaplama(input: Stat_hesaplamaInput): Stat_hesaplamaOutput {
...
export interface Stat_hesaplamaOutput {
...
export const Stat_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
