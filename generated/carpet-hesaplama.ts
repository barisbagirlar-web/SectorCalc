// Auto-generated from carpet-hesaplama-schema.json
import * as z from 'zod';

export interface Carpet_hesaplamaInput {
  petAge: number;
  petWeight: number;
  dataConfidence?: number;
}

export const Carpet_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Carpet_hesaplamaInput): Record<string, number> {
...
export function calculateCarpet_hesaplama(input: Carpet_hesaplamaInput): Carpet_hesaplamaOutput {
...
export interface Carpet_hesaplamaOutput {
...
export const Carpet_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "years",
