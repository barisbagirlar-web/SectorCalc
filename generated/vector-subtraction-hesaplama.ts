// Auto-generated from vector-subtraction-hesaplama-schema.json
import * as z from 'zod';

export interface Vector_subtraction_hesaplamaInput {
  matrixSize: number;
  matrixElement: number;
  dataConfidence?: number;
}

export const Vector_subtraction_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Vector_subtraction_hesaplamaInput): Record<string, number> {
...
export function calculateVector_subtraction_hesaplama(input: Vector_subtraction_hesaplamaInput): Vector_subtraction_hesaplamaOutput {
...
export interface Vector_subtraction_hesaplamaOutput {
...
export const Vector_subtraction_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
