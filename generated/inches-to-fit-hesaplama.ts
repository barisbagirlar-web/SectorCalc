// Auto-generated from inches-to-fit-hesaplama-schema.json
import * as z from 'zod';

export interface Inches_to_fit_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Inches_to_fit_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Inches_to_fit_hesaplamaInput): Record<string, number> {
...
export function calculateInches_to_fit_hesaplama(input: Inches_to_fit_hesaplamaInput): Inches_to_fit_hesaplamaOutput {
...
export interface Inches_to_fit_hesaplamaOutput {
...
export const Inches_to_fit_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
