// Auto-generated from pace-hesaplama-schema.json
import * as z from 'zod';

export interface Pace_hesaplamaInput {
  distanceKm: number;
  durationMin: number;
  dataConfidence?: number;
}

export const Pace_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pace_hesaplamaInput): Record<string, number> {
...
export function calculatePace_hesaplama(input: Pace_hesaplamaInput): Pace_hesaplamaOutput {
...
export interface Pace_hesaplamaOutput {
...
export const Pace_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "km",
