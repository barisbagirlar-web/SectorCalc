// Auto-generated from storage-hesaplama-schema.json
import * as z from 'zod';

export interface Storage_hesaplamaInput {
  birthDate: number;
  referenceDate: number;
  dataConfidence?: number;
}

export const Storage_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Storage_hesaplamaInput): Record<string, number> {
...
export function calculateStorage_hesaplama(input: Storage_hesaplamaInput): Storage_hesaplamaOutput {
...
export interface Storage_hesaplamaOutput {
...
export const Storage_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "date",
