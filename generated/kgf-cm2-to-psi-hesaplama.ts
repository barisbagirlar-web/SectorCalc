// Auto-generated from kgf-cm2-to-psi-hesaplama-schema.json
import * as z from 'zod';

export interface Kgf_cm2_to_psi_hesaplamaInput {
  pressureValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Kgf_cm2_to_psi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Kgf_cm2_to_psi_hesaplamaInput): Record<string, number> {
...
export function calculateKgf_cm2_to_psi_hesaplama(input: Kgf_cm2_to_psi_hesaplamaInput): Kgf_cm2_to_psi_hesaplamaOutput {
...
export interface Kgf_cm2_to_psi_hesaplamaOutput {
...
export const Kgf_cm2_to_psi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "Pa",
