// Auto-generated from mead-hesaplama-schema.json
import * as z from 'zod';

export interface Mead_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Mead_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Mead_hesaplamaInput): Record<string, number> {
...
export function calculateMead_hesaplama(input: Mead_hesaplamaInput): Mead_hesaplamaOutput {
...
export interface Mead_hesaplamaOutput {
...
export const Mead_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
