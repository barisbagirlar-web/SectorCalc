// Auto-generated from dbscan-hesaplama-schema.json
import * as z from 'zod';

export interface Dbscan_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Dbscan_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Dbscan_hesaplamaInput): Record<string, number> {
...
export function calculateDbscan_hesaplama(input: Dbscan_hesaplamaInput): Dbscan_hesaplamaOutput {
...
export interface Dbscan_hesaplamaOutput {
...
export const Dbscan_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
