...
function evaluateAllFormulas(input: Yahtzee_probability_calculatorInput): Record<string, number | string> {
  ...
  try { const v = input.diceCount * input.targetMatches * input.currentMatches; results["normalized_product"] = typeof v === "number" ? (Number.isFinite(v) ? v : 0) : typeof v === "string" ? v : 0; } catch { results["normalized_product"] = 0; }
