// Auto-generated from dental-age-hesaplama-schema.json
import * as z from 'zod';

export interface Dental_age_hesaplamaInput {
  birthDate: number;
  referenceDate: number;
  dataConfidence?: number;
}

export const Dental_age_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Dental_age_hesaplamaInput): Record<string, number> {
...
export function calculateDental_age_hesaplama(input: Dental_age_hesaplamaInput): Dental_age_hesaplamaOutput {
...
export interface Dental_age_hesaplamaOutput {
...
export const Dental_age_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "date",
