// Auto-generated from vector-projection-hesaplama-schema.json
import * as z from 'zod';

export interface Vector_projection_hesaplamaInput {
  matrixSize: number;
  matrixElement: number;
  dataConfidence?: number;
}

export const Vector_projection_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Vector_projection_hesaplamaInput): Record<string, number> {
...
export function calculateVector_projection_hesaplama(input: Vector_projection_hesaplamaInput): Vector_projection_hesaplamaOutput {
...
export interface Vector_projection_hesaplamaOutput {
...
export const Vector_projection_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
