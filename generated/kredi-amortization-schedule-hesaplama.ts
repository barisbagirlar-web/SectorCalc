// Auto-generated from kredi-amortization-schedule-hesaplama-schema.json
import * as z from 'zod';

export interface Kredi_amortization_schedule_hesaplamaInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Kredi_amortization_schedule_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Kredi_amortization_schedule_hesaplamaInput): Record<string, number> {
...
export function calculateKredi_amortization_schedule_hesaplama(input: Kredi_amortization_schedule_hesaplamaInput): Kredi_amortization_schedule_hesaplamaOutput {
...
export interface Kredi_amortization_schedule_hesaplamaOutput {
...
export const Kredi_amortization_schedule_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
