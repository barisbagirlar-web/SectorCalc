// Auto-generated from sign-test-hesaplama-schema.json
import * as z from 'zod';

export interface Sign_test_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Sign_test_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Sign_test_hesaplamaInput): Record<string, number> {
...
export function calculateSign_test_hesaplama(input: Sign_test_hesaplamaInput): Sign_test_hesaplamaOutput {
...
export interface Sign_test_hesaplamaOutput {
...
export const Sign_test_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
