// Auto-generated from sloan-ratio-hesaplama-schema.json
import * as z from 'zod';

export interface Sloan_ratio_hesaplamaInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Sloan_ratio_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Sloan_ratio_hesaplamaInput): Record<string, number> {
...
export function calculateSloan_ratio_hesaplama(input: Sloan_ratio_hesaplamaInput): Sloan_ratio_hesaplamaOutput {
...
export interface Sloan_ratio_hesaplamaOutput {
...
export const Sloan_ratio_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
