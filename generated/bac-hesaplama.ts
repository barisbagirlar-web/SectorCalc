// Auto-generated from bac-hesaplama-schema.json
import * as z from 'zod';

export interface Bac_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Bac_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Bac_hesaplamaInput): Record<string, number> {
...
export function calculateBac_hesaplama(input: Bac_hesaplamaInput): Bac_hesaplamaOutput {
...
export interface Bac_hesaplamaOutput {
...
export const Bac_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
