// Auto-generated from kp-hesaplama-schema.json
import * as z from 'zod';

export interface Kp_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Kp_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Kp_hesaplamaInput): Record<string, number> {
...
export function calculateKp_hesaplama(input: Kp_hesaplamaInput): Kp_hesaplamaOutput {
...
export interface Kp_hesaplamaOutput {
...
export const Kp_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
