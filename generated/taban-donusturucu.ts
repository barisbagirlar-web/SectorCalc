// Auto-generated from taban-donusturucu-schema.json
import * as z from 'zod';

export interface Taban_donusturucuInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Taban_donusturucuInputSchema = z.object({
...
function evaluateAllFormulas(input: Taban_donusturucuInput): Record<string, number> {
...
export function calculateTaban_donusturucu(input: Taban_donusturucuInput): Taban_donusturucuOutput {
...
export interface Taban_donusturucuOutput {
...
export const Taban_donusturucuOutputMeta = {
  primaryKey: "result",
  unit: "",
