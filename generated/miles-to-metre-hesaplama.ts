// Auto-generated from miles-to-metre-hesaplama-schema.json
import * as z from 'zod';

export interface Miles_to_metre_hesaplamaInput {
  lengthValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Miles_to_metre_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Miles_to_metre_hesaplamaInput): Record<string, number> {
...
export function calculateMiles_to_metre_hesaplama(input: Miles_to_metre_hesaplamaInput): Miles_to_metre_hesaplamaOutput {
...
export interface Miles_to_metre_hesaplamaOutput {
...
export const Miles_to_metre_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "m",
