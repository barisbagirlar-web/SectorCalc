// Auto-generated from fcff-hesaplama-schema.json
import * as z from 'zod';

export interface Fcff_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Fcff_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Fcff_hesaplamaInput): Record<string, number> {
...
export function calculateFcff_hesaplama(input: Fcff_hesaplamaInput): Fcff_hesaplamaOutput {
...
export interface Fcff_hesaplamaOutput {
...
export const Fcff_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
