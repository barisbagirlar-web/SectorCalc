// Auto-generated from fractal-hesaplama-schema.json
import * as z from 'zod';

export interface Fractal_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Fractal_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Fractal_hesaplamaInput): Record<string, number> {
...
export function calculateFractal_hesaplama(input: Fractal_hesaplamaInput): Fractal_hesaplamaOutput {
...
export interface Fractal_hesaplamaOutput {
...
export const Fractal_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
