// Auto-generated from age-hesaplama-schema.json
import * as z from 'zod';

export interface Age_hesaplamaInput {
  birthDate: number;
  referenceDate: number;
  dataConfidence?: number;
}

export const Age_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Age_hesaplamaInput): Record<string, number> {
...
export function calculateAge_hesaplama(input: Age_hesaplamaInput): Age_hesaplamaOutput {
...
export interface Age_hesaplamaOutput {
...
export const Age_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "date",
