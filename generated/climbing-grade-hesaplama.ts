// Auto-generated from climbing-grade-hesaplama-schema.json
import * as z from 'zod';

export interface Climbing_grade_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Climbing_grade_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Climbing_grade_hesaplamaInput): Record<string, number> {
...
export function calculateClimbing_grade_hesaplama(input: Climbing_grade_hesaplamaInput): Climbing_grade_hesaplamaOutput {
...
export interface Climbing_grade_hesaplamaOutput {
...
export const Climbing_grade_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
