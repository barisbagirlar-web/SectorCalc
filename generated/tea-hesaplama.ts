// Auto-generated from tea-hesaplama-schema.json
import * as z from 'zod';

export interface Tea_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Tea_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Tea_hesaplamaInput): Record<string, number> {
...
export function calculateTea_hesaplama(input: Tea_hesaplamaInput): Tea_hesaplamaOutput {
...
export interface Tea_hesaplamaOutput {
...
export const Tea_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
