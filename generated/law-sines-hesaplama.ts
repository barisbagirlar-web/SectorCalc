// Auto-generated from law-sines-hesaplama-schema.json
import * as z from 'zod';

export interface Law_sines_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Law_sines_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Law_sines_hesaplamaInput): Record<string, number> {
...
export function calculateLaw_sines_hesaplama(input: Law_sines_hesaplamaInput): Law_sines_hesaplamaOutput {
...
export interface Law_sines_hesaplamaOutput {
...
export const Law_sines_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
