// Auto-generated from ikili-hesaplayici-schema.json
import * as z from 'zod';

export interface Ikili_hesaplayiciInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Ikili_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Ikili_hesaplayiciInput): Record<string, number> {
...
export function calculateIkili_hesaplayici(input: Ikili_hesaplayiciInput): Ikili_hesaplayiciOutput {
...
export interface Ikili_hesaplayiciOutput {
...
export const Ikili_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "",
