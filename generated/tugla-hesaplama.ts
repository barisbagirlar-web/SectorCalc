// Auto-generated from tugla-hesaplama-schema.json
import * as z from 'zod';

export interface Tugla_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Tugla_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Tugla_hesaplamaInput): Record<string, number> {
...
export function calculateTugla_hesaplama(input: Tugla_hesaplamaInput): Tugla_hesaplamaOutput {
...
export interface Tugla_hesaplamaOutput {
...
export const Tugla_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
