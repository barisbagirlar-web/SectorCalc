// Auto-generated from top-hiz-hesaplama-schema.json
import * as z from 'zod';

export interface Top_hiz_hesaplamaInput {
  speedValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Top_hiz_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Top_hiz_hesaplamaInput): Record<string, number> {
...
export function calculateTop_hiz_hesaplama(input: Top_hiz_hesaplamaInput): Top_hiz_hesaplamaOutput {
...
export interface Top_hiz_hesaplamaOutput {
...
export const Top_hiz_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "km/h",
