// Auto-generated from risk-probability-hesaplama-schema.json
import * as z from 'zod';

export interface Risk_probability_hesaplamaInput {
  sampleMean: number;
  standardDeviation: number;
  dataConfidence?: number;
}

export const Risk_probability_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Risk_probability_hesaplamaInput): Record<string, number> {
...
export function calculateRisk_probability_hesaplama(input: Risk_probability_hesaplamaInput): Risk_probability_hesaplamaOutput {
...
export interface Risk_probability_hesaplamaOutput {
...
export const Risk_probability_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
