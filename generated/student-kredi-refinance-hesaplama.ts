// Auto-generated from student-kredi-refinance-hesaplama-schema.json
import * as z from 'zod';

export interface Student_kredi_refinance_hesaplamaInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Student_kredi_refinance_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Student_kredi_refinance_hesaplamaInput): Record<string, number> {
...
export function calculateStudent_kredi_refinance_hesaplama(input: Student_kredi_refinance_hesaplamaInput): Student_kredi_refinance_hesaplamaOutput {
...
export interface Student_kredi_refinance_hesaplamaOutput {
...
export const Student_kredi_refinance_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
