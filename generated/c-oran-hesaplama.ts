// Auto-generated from c-oran-hesaplama-schema.json
import * as z from 'zod';

export interface C_oran_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const C_oran_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: C_oran_hesaplamaInput): Record<string, number> {
...
export function calculateC_oran_hesaplama(input: C_oran_hesaplamaInput): C_oran_hesaplamaOutput {
...
export interface C_oran_hesaplamaOutput {
...
export const C_oran_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
