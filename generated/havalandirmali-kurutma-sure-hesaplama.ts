// Auto-generated from havalandirmali-kurutma-sure-hesaplama-schema.json
import * as z from 'zod';

export interface Havalandirmali_kurutma_sure_hesaplamaInput {
  urunKutlesi: number;
  baslangicNem: number;
  hedefNem: number;
  havaDebi: number;
...
export const Havalandirmali_kurutma_sure_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Havalandirmali_kurutma_sure_hesaplamaInput): Record<string, number> {
...
export function calculateHavalandirmali_kurutma_sure_hesaplama(input: Havalandirmali_kurutma_sure_hesaplamaInput): Havalandirmali_kurutma_sure_hesaplamaOutput {
...
export interface Havalandirmali_kurutma_sure_hesaplamaOutput {
...
export const Havalandirmali_kurutma_sure_hesaplamaOutputMeta = {
  primaryKey: "sonuc",
  unit: "s",
  breakdownKeys: ["sonuc"],
} as const;
