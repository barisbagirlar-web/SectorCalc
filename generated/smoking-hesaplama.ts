// Auto-generated from smoking-hesaplama-schema.json
import * as z from 'zod';

export interface Smoking_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Smoking_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Smoking_hesaplamaInput): Record<string, number> {
...
export function calculateSmoking_hesaplama(input: Smoking_hesaplamaInput): Smoking_hesaplamaOutput {
...
export interface Smoking_hesaplamaOutput {
...
export const Smoking_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
