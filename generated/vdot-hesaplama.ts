// Auto-generated from vdot-hesaplama-schema.json
import * as z from 'zod';

export interface Vdot_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Vdot_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Vdot_hesaplamaInput): Record<string, number> {
...
export function calculateVdot_hesaplama(input: Vdot_hesaplamaInput): Vdot_hesaplamaOutput {
...
export interface Vdot_hesaplamaOutput {
...
export const Vdot_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
