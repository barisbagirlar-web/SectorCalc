// Auto-generated from midrange-hesaplama-schema.json
import * as z from 'zod';

export interface Midrange_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Midrange_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Midrange_hesaplamaInput): Record<string, number> {
...
export function calculateMidrange_hesaplama(input: Midrange_hesaplamaInput): Midrange_hesaplamaOutput {
...
export interface Midrange_hesaplamaOutput {
...
export const Midrange_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
