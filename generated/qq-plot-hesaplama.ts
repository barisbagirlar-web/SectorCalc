// Auto-generated from qq-plot-hesaplama-schema.json
import * as z from 'zod';

export interface Qq_plot_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Qq_plot_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Qq_plot_hesaplamaInput): Record<string, number> {
...
export function calculateQq_plot_hesaplama(input: Qq_plot_hesaplamaInput): Qq_plot_hesaplamaOutput {
...
export interface Qq_plot_hesaplamaOutput {
...
export const Qq_plot_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
