// Auto-generated from nth-root-hesaplama-schema.json
import * as z from 'zod';

export interface Nth_root_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Nth_root_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Nth_root_hesaplamaInput): Record<string, number> {
...
export function calculateNth_root_hesaplama(input: Nth_root_hesaplamaInput): Nth_root_hesaplamaOutput {
...
export interface Nth_root_hesaplamaOutput {
...
export const Nth_root_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
