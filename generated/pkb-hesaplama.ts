// Auto-generated from pkb-hesaplama-schema.json
import * as z from 'zod';

export interface Pkb_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Pkb_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pkb_hesaplamaInput): Record<string, number> {
...
export function calculatePkb_hesaplama(input: Pkb_hesaplamaInput): Pkb_hesaplamaOutput {
...
export interface Pkb_hesaplamaOutput {
...
export const Pkb_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
