// Auto-generated from sabit-annuity-hesaplama-schema.json
import * as z from 'zod';

export interface Sabit_annuity_hesaplamaInput {
  currentAge: number;
  retirementAge: number;
  dataConfidence?: number;
}

export const Sabit_annuity_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Sabit_annuity_hesaplamaInput): Record<string, number> {
...
export function calculateSabit_annuity_hesaplama(input: Sabit_annuity_hesaplamaInput): Sabit_annuity_hesaplamaOutput {
...
export interface Sabit_annuity_hesaplamaOutput {
...
export const Sabit_annuity_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "years",
