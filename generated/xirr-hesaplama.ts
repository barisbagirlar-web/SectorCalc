// Auto-generated from xirr-hesaplama-schema.json
import * as z from 'zod';

export interface Xirr_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Xirr_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Xirr_hesaplamaInput): Record<string, number> {
...
export function calculateXirr_hesaplama(input: Xirr_hesaplamaInput): Xirr_hesaplamaOutput {
...
export interface Xirr_hesaplamaOutput {
...
export const Xirr_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
