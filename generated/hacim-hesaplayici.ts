// Auto-generated from hacim-hesaplayici-schema.json
import * as z from 'zod';

export interface Hacim_hesaplayiciInput {
  volumeValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Hacim_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Hacim_hesaplayiciInput): Record<string, number> {
...
export function calculateHacim_hesaplayici(input: Hacim_hesaplayiciInput): Hacim_hesaplayiciOutput {
...
export interface Hacim_hesaplayiciOutput {
...
export const Hacim_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "m³",
