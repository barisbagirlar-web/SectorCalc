// Auto-generated from bond-hesaplama-schema.json
import * as z from 'zod';

export interface Bond_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Bond_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Bond_hesaplamaInput): Record<string, number> {
...
export function calculateBond_hesaplama(input: Bond_hesaplamaInput): Bond_hesaplamaOutput {
...
export interface Bond_hesaplamaOutput {
...
export const Bond_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
