// Auto-generated from paver-hesaplama-schema.json
import * as z from 'zod';

export interface Paver_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Paver_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Paver_hesaplamaInput): Record<string, number> {
...
export function calculatePaver_hesaplama(input: Paver_hesaplamaInput): Paver_hesaplamaOutput {
...
export interface Paver_hesaplamaOutput {
...
export const Paver_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
