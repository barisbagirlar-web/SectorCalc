// Auto-generated from zumba-calorie-hesaplama-schema.json
import * as z from 'zod';

export interface Zumba_calorie_hesaplamaInput {
  bodyWeight: number;
  activityLevel: number;
  dataConfidence?: number;
}

export const Zumba_calorie_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Zumba_calorie_hesaplamaInput): Record<string, number> {
...
export function calculateZumba_calorie_hesaplama(input: Zumba_calorie_hesaplamaInput): Zumba_calorie_hesaplamaOutput {
...
export interface Zumba_calorie_hesaplamaOutput {
...
export const Zumba_calorie_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "kg",
