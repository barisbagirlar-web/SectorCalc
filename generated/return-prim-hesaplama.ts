// Auto-generated from return-prim-hesaplama-schema.json
import * as z from 'zod';

export interface Return_prim_hesaplamaInput {
  principal: number;
  rate: number;
  periods: number;
...
export const Return_prim_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Return_prim_hesaplamaInput): Record<string, number> {
...
export function calculateReturn_prim_hesaplama(input: Return_prim_hesaplamaInput): Return_prim_hesaplamaOutput {
...
export interface Return_prim_hesaplamaOutput {
...
export const Return_prim_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
