// Auto-generated from spur-gear-hesaplama-schema.json
import * as z from 'zod';

export interface Spur_gear_hesaplamaInput {
  materialStrength: number;
  dataConfidence?: number;
}

export const Spur_gear_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Spur_gear_hesaplamaInput): Record<string, number> {
...
export function calculateSpur_gear_hesaplama(input: Spur_gear_hesaplamaInput): Spur_gear_hesaplamaOutput {
...
export interface Spur_gear_hesaplamaOutput {
...
export const Spur_gear_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "MPa",
