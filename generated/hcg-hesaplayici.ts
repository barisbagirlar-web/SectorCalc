// Auto-generated from hcg-hesaplayici-schema.json
import * as z from 'zod';

export interface Hcg_hesaplayiciInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Hcg_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Hcg_hesaplayiciInput): Record<string, number> {
...
export function calculateHcg_hesaplayici(input: Hcg_hesaplayiciInput): Hcg_hesaplayiciOutput {
...
export interface Hcg_hesaplayiciOutput {
...
export const Hcg_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "",
