// Auto-generated from noi-hesaplayici-schema.json
import * as z from 'zod';

export interface Noi_hesaplayiciInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Noi_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Noi_hesaplayiciInput): Record<string, number> {
...
export function calculateNoi_hesaplayici(input: Noi_hesaplayiciInput): Noi_hesaplayiciOutput {
...
export interface Noi_hesaplayiciOutput {
...
export const Noi_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "",
