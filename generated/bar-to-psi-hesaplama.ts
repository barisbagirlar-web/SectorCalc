// Auto-generated from bar-to-psi-hesaplama-schema.json
import * as z from 'zod';

export interface Bar_to_psi_hesaplamaInput {
  pressureValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Bar_to_psi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Bar_to_psi_hesaplamaInput): Record<string, number> {
...
export function calculateBar_to_psi_hesaplama(input: Bar_to_psi_hesaplamaInput): Bar_to_psi_hesaplamaOutput {
...
export interface Bar_to_psi_hesaplamaOutput {
...
export const Bar_to_psi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "Pa",
