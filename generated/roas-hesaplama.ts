// Auto-generated from roas-hesaplama-schema.json
import * as z from 'zod';

export interface Roas_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Roas_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Roas_hesaplamaInput): Record<string, number> {
...
export function calculateRoas_hesaplama(input: Roas_hesaplamaInput): Roas_hesaplamaOutput {
...
export interface Roas_hesaplamaOutput {
...
export const Roas_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
