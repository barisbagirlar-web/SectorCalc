// Auto-generated from yogurt-hesaplama-schema.json
import * as z from 'zod';

export interface Yogurt_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Yogurt_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Yogurt_hesaplamaInput): Record<string, number> {
...
export function calculateYogurt_hesaplama(input: Yogurt_hesaplamaInput): Yogurt_hesaplamaOutput {
...
export interface Yogurt_hesaplamaOutput {
...
export const Yogurt_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
