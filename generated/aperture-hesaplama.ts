// Auto-generated from aperture-hesaplama-schema.json
import * as z from 'zod';

export interface Aperture_hesaplamaInput {
  focalLength: number;
  objectDistance: number;
  dataConfidence?: number;
}

export const Aperture_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Aperture_hesaplamaInput): Record<string, number> {
...
export function calculateAperture_hesaplama(input: Aperture_hesaplamaInput): Aperture_hesaplamaOutput {
...
export interface Aperture_hesaplamaOutput {
...
export const Aperture_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "mm",
