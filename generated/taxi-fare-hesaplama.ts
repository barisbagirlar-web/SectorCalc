// Auto-generated from taxi-fare-hesaplama-schema.json
import * as z from 'zod';

export interface Taxi_fare_hesaplamaInput {
  income: number;
  deductions: number;
  taxRate: number;
...
export const Taxi_fare_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Taxi_fare_hesaplamaInput): Record<string, number> {
...
export function calculateTaxi_fare_hesaplama(input: Taxi_fare_hesaplamaInput): Taxi_fare_hesaplamaOutput {
...
export interface Taxi_fare_hesaplamaOutput {
...
export const Taxi_fare_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
