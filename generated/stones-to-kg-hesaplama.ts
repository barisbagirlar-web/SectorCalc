// Auto-generated from stones-to-kg-hesaplama-schema.json
import * as z from 'zod';

export interface Stones_to_kg_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Stones_to_kg_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Stones_to_kg_hesaplamaInput): Record<string, number> {
...
export function calculateStones_to_kg_hesaplama(input: Stones_to_kg_hesaplamaInput): Stones_to_kg_hesaplamaOutput {
...
export interface Stones_to_kg_hesaplamaOutput {
...
export const Stones_to_kg_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
