// Auto-generated from dew-point-hesaplama-schema.json
import * as z from 'zod';

export interface Dew_point_hesaplamaInput {
  airTemperature: number;
  relativeHumidity: number;
  dataConfidence?: number;
}

export const Dew_point_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Dew_point_hesaplamaInput): Record<string, number> {
...
export function calculateDew_point_hesaplama(input: Dew_point_hesaplamaInput): Dew_point_hesaplamaOutput {
...
export interface Dew_point_hesaplamaOutput {
...
export const Dew_point_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "°C",
