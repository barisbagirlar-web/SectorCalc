// Auto-generated from actuarial-hesaplama-schema.json
import * as z from 'zod';

export interface Actuarial_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Actuarial_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Actuarial_hesaplamaInput): Record<string, number> {
...
export function calculateActuarial_hesaplama(input: Actuarial_hesaplamaInput): Actuarial_hesaplamaOutput {
...
export interface Actuarial_hesaplamaOutput {
...
export const Actuarial_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
