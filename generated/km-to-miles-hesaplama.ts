// Auto-generated from km-to-miles-hesaplama-schema.json
import * as z from 'zod';

export interface Km_to_miles_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Km_to_miles_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Km_to_miles_hesaplamaInput): Record<string, number> {
...
export function calculateKm_to_miles_hesaplama(input: Km_to_miles_hesaplamaInput): Km_to_miles_hesaplamaOutput {
...
export interface Km_to_miles_hesaplamaOutput {
...
export const Km_to_miles_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
