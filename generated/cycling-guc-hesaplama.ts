// Auto-generated from cycling-guc-hesaplama-schema.json
import * as z from 'zod';

export interface Cycling_guc_hesaplamaInput {
  heartRate: number;
  exerciseDuration: number;
  dataConfidence?: number;
}

export const Cycling_guc_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Cycling_guc_hesaplamaInput): Record<string, number> {
...
export function calculateCycling_guc_hesaplama(input: Cycling_guc_hesaplamaInput): Cycling_guc_hesaplamaOutput {
...
export interface Cycling_guc_hesaplamaOutput {
...
export const Cycling_guc_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "bpm",
