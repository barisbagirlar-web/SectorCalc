// Auto-generated from normality-test-hesaplama-schema.json
import * as z from 'zod';

export interface Normality_test_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Normality_test_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Normality_test_hesaplamaInput): Record<string, number> {
...
export function calculateNormality_test_hesaplama(input: Normality_test_hesaplamaInput): Normality_test_hesaplamaOutput {
...
export interface Normality_test_hesaplamaOutput {
...
export const Normality_test_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
