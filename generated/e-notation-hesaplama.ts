// Auto-generated from e-notation-hesaplama-schema.json
import * as z from 'zod';

export interface E_notation_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const E_notation_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: E_notation_hesaplamaInput): Record<string, number> {
...
export function calculateE_notation_hesaplama(input: E_notation_hesaplamaInput): E_notation_hesaplamaOutput {
...
export interface E_notation_hesaplamaOutput {
...
export const E_notation_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
