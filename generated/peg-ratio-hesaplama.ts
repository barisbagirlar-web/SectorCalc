// Auto-generated from peg-ratio-hesaplama-schema.json
import * as z from 'zod';

export interface Peg_ratio_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const Peg_ratio_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Peg_ratio_hesaplamaInput): Record<string, number> {
...
export function calculatePeg_ratio_hesaplama(input: Peg_ratio_hesaplamaInput): Peg_ratio_hesaplamaOutput {
...
export interface Peg_ratio_hesaplamaOutput {
...
export const Peg_ratio_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
