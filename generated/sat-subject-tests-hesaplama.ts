// Auto-generated from sat-subject-tests-hesaplama-schema.json
import * as z from 'zod';

export interface Sat_subject_tests_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Sat_subject_tests_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Sat_subject_tests_hesaplamaInput): Record<string, number> {
...
export function calculateSat_subject_tests_hesaplama(input: Sat_subject_tests_hesaplamaInput): Sat_subject_tests_hesaplamaOutput {
...
export interface Sat_subject_tests_hesaplamaOutput {
...
export const Sat_subject_tests_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
