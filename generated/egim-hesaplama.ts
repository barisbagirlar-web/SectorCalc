// Auto-generated from egim-hesaplama-schema.json
import * as z from 'zod';

export interface Egim_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Egim_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Egim_hesaplamaInput): Record<string, number> {
...
export function calculateEgim_hesaplama(input: Egim_hesaplamaInput): Egim_hesaplamaOutput {
...
export interface Egim_hesaplamaOutput {
...
export const Egim_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
