// Auto-generated from atm-to-bar-hesaplama-schema.json
import * as z from 'zod';

export interface Atm_to_bar_hesaplamaInput {
  pressureValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Atm_to_bar_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Atm_to_bar_hesaplamaInput): Record<string, number> {
...
export function calculateAtm_to_bar_hesaplama(input: Atm_to_bar_hesaplamaInput): Atm_to_bar_hesaplamaOutput {
...
export interface Atm_to_bar_hesaplamaOutput {
...
export const Atm_to_bar_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "Pa",
