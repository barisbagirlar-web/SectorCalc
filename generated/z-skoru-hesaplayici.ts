// Auto-generated from z-skoru-hesaplayici-schema.json
import * as z from 'zod';

export interface Z_skoru_hesaplayiciInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Z_skoru_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Z_skoru_hesaplayiciInput): Record<string, number> {
...
export function calculateZ_skoru_hesaplayici(input: Z_skoru_hesaplayiciInput): Z_skoru_hesaplayiciOutput {
...
export interface Z_skoru_hesaplayiciOutput {
...
export const Z_skoru_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "n",
