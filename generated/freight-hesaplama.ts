// Auto-generated from freight-hesaplama-schema.json
import * as z from 'zod';

export interface Freight_hesaplamaInput {
  shipmentWeight: number;
  dataConfidence?: number;
}

export const Freight_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Freight_hesaplamaInput): Record<string, number> {
...
export function calculateFreight_hesaplama(input: Freight_hesaplamaInput): Freight_hesaplamaOutput {
...
export interface Freight_hesaplamaOutput {
...
export const Freight_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "kg",
