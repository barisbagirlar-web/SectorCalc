// Auto-generated from nitrox-hesaplama-schema.json
import * as z from 'zod';

export interface Nitrox_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Nitrox_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Nitrox_hesaplamaInput): Record<string, number> {
...
export function calculateNitrox_hesaplama(input: Nitrox_hesaplamaInput): Nitrox_hesaplamaOutput {
...
export interface Nitrox_hesaplamaOutput {
...
export const Nitrox_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
