// Auto-generated from kg-to-lb-donusturucu-schema.json
import * as z from 'zod';

export interface Kg_to_lb_donusturucuInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Kg_to_lb_donusturucuInputSchema = z.object({
...
function evaluateAllFormulas(input: Kg_to_lb_donusturucuInput): Record<string, number> {
...
export function calculateKg_to_lb_donusturucu(input: Kg_to_lb_donusturucuInput): Kg_to_lb_donusturucuOutput {
...
export interface Kg_to_lb_donusturucuOutput {
...
export const Kg_to_lb_donusturucuOutputMeta = {
  primaryKey: "result",
  unit: "",
