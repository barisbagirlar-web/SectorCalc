// Auto-generated from ntu-hesaplama-schema.json
import * as z from 'zod';

export interface Ntu_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Ntu_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ntu_hesaplamaInput): Record<string, number> {
...
export function calculateNtu_hesaplama(input: Ntu_hesaplamaInput): Ntu_hesaplamaOutput {
...
export interface Ntu_hesaplamaOutput {
...
export const Ntu_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
