// Auto-generated from pr-auc-hesaplama-schema.json
import * as z from 'zod';

export interface Pr_auc_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Pr_auc_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pr_auc_hesaplamaInput): Record<string, number> {
...
export function calculatePr_auc_hesaplama(input: Pr_auc_hesaplamaInput): Pr_auc_hesaplamaOutput {
...
export interface Pr_auc_hesaplamaOutput {
...
export const Pr_auc_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
