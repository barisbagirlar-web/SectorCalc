// Auto-generated from perc-hesaplama-schema.json
import * as z from 'zod';

export interface Perc_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Perc_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Perc_hesaplamaInput): Record<string, number> {
...
export function calculatePerc_hesaplama(input: Perc_hesaplamaInput): Perc_hesaplamaOutput {
...
export interface Perc_hesaplamaOutput {
...
export const Perc_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
