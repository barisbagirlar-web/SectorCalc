// Auto-generated from mrs-hesaplama-schema.json
import * as z from 'zod';

export interface Mrs_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Mrs_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Mrs_hesaplamaInput): Record<string, number> {
...
export function calculateMrs_hesaplama(input: Mrs_hesaplamaInput): Mrs_hesaplamaOutput {
...
export interface Mrs_hesaplamaOutput {
...
export const Mrs_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
