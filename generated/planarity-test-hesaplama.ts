// Auto-generated from planarity-test-hesaplama-schema.json
import * as z from 'zod';

export interface Planarity_test_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Planarity_test_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Planarity_test_hesaplamaInput): Record<string, number> {
...
export function calculatePlanarity_test_hesaplama(input: Planarity_test_hesaplamaInput): Planarity_test_hesaplamaOutput {
...
export interface Planarity_test_hesaplamaOutput {
...
export const Planarity_test_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
