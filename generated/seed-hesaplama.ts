// Auto-generated from seed-hesaplama-schema.json
import * as z from 'zod';

export interface Seed_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Seed_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Seed_hesaplamaInput): Record<string, number> {
...
export function calculateSeed_hesaplama(input: Seed_hesaplamaInput): Seed_hesaplamaOutput {
...
export interface Seed_hesaplamaOutput {
...
export const Seed_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
