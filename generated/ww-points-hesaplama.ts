// Auto-generated from ww-points-hesaplama-schema.json
import * as z from 'zod';

export interface Ww_points_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Ww_points_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Ww_points_hesaplamaInput): Record<string, number> {
...
export function calculateWw_points_hesaplama(input: Ww_points_hesaplamaInput): Ww_points_hesaplamaOutput {
...
export interface Ww_points_hesaplamaOutput {
...
export const Ww_points_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
