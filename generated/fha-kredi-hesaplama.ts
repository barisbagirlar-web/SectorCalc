// Auto-generated from fha-kredi-hesaplama-schema.json
import * as z from 'zod';

export interface Fha_kredi_hesaplamaInput {
  loanAmount: number;
  interestRate: number;
  termYears: number;
...
export const Fha_kredi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Fha_kredi_hesaplamaInput): Record<string, number> {
...
export function calculateFha_kredi_hesaplama(input: Fha_kredi_hesaplamaInput): Fha_kredi_hesaplamaOutput {
...
export interface Fha_kredi_hesaplamaOutput {
...
export const Fha_kredi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "USD",
