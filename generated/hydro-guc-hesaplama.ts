// Auto-generated from hydro-guc-hesaplama-schema.json
import * as z from 'zod';

export interface Hydro_guc_hesaplamaInput {
  powerValue: number;
  timeDuration: number;
  dataConfidence?: number;
}

export const Hydro_guc_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Hydro_guc_hesaplamaInput): Record<string, number> {
...
export function calculateHydro_guc_hesaplama(input: Hydro_guc_hesaplamaInput): Hydro_guc_hesaplamaOutput {
...
export interface Hydro_guc_hesaplamaOutput {
...
export const Hydro_guc_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "W",
