// Auto-generated from k-d-ratio-hesaplama-schema.json
import * as z from 'zod';

export interface K_d_ratio_hesaplamaInput {
  baseAmount: number;
  exchangeRate: number;
  dataConfidence?: number;
}

export const K_d_ratio_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: K_d_ratio_hesaplamaInput): Record<string, number> {
...
export function calculateK_d_ratio_hesaplama(input: K_d_ratio_hesaplamaInput): K_d_ratio_hesaplamaOutput {
...
export interface K_d_ratio_hesaplamaOutput {
...
export const K_d_ratio_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
