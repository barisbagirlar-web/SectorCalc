// Auto-generated from golden-saat-hesaplama-schema.json
import * as z from 'zod';

export interface Golden_saat_hesaplamaInput {
  timeValue: number;
  frequency: number;
  dataConfidence?: number;
}

export const Golden_saat_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Golden_saat_hesaplamaInput): Record<string, number> {
...
export function calculateGolden_saat_hesaplama(input: Golden_saat_hesaplamaInput): Golden_saat_hesaplamaOutput {
...
export interface Golden_saat_hesaplamaOutput {
...
export const Golden_saat_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "min",
