// Auto-generated from nihss-hesaplama-schema.json
import * as z from 'zod';

export interface Nihss_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Nihss_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Nihss_hesaplamaInput): Record<string, number> {
...
export function calculateNihss_hesaplama(input: Nihss_hesaplamaInput): Nihss_hesaplamaOutput {
...
export interface Nihss_hesaplamaOutput {
...
export const Nihss_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
