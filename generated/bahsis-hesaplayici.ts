// Auto-generated from bahsis-hesaplayici-schema.json
import * as z from 'zod';

export interface Bahsis_hesaplayiciInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Bahsis_hesaplayiciInputSchema = z.object({
...
function evaluateAllFormulas(input: Bahsis_hesaplayiciInput): Record<string, number> {
...
export function calculateBahsis_hesaplayici(input: Bahsis_hesaplayiciInput): Bahsis_hesaplayiciOutput {
...
export interface Bahsis_hesaplayiciOutput {
...
export const Bahsis_hesaplayiciOutputMeta = {
  primaryKey: "result",
  unit: "",
