// Auto-generated from yuzde-off-hesaplama-schema.json
import * as z from 'zod';

export interface Yuzde_off_hesaplamaInput {
  totalValue: number;
  percentage: number;
  dataConfidence?: number;
}

export const Yuzde_off_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Yuzde_off_hesaplamaInput): Record<string, number> {
...
export function calculateYuzde_off_hesaplama(input: Yuzde_off_hesaplamaInput): Yuzde_off_hesaplamaOutput {
...
export interface Yuzde_off_hesaplamaOutput {
...
export const Yuzde_off_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "%",
