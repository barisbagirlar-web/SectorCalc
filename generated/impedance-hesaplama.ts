// Auto-generated from impedance-hesaplama-schema.json
import * as z from 'zod';

export interface Impedance_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Impedance_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Impedance_hesaplamaInput): Record<string, number> {
...
export function calculateImpedance_hesaplama(input: Impedance_hesaplamaInput): Impedance_hesaplamaOutput {
...
export interface Impedance_hesaplamaOutput {
...
export const Impedance_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
