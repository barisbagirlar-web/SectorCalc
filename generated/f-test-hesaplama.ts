// Auto-generated from f-test-hesaplama-schema.json
import * as z from 'zod';

export interface F_test_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const F_test_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: F_test_hesaplamaInput): Record<string, number> {
...
export function calculateF_test_hesaplama(input: F_test_hesaplamaInput): F_test_hesaplamaOutput {
...
export interface F_test_hesaplamaOutput {
...
export const F_test_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
