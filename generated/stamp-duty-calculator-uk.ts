...
function evaluateAllFormulas(input: Stamp_duty_calculator_ukInput): Record<string, number> {
  ...
  results["_calculateBreakdown_0__"] = 0;
  results["_calculateBreakdown_1__"] = 0;
  results["_calculateBreakdown_2__"] = 0;
  results["_calculateBreakdown_3__"] = 0;
  results["_calculateBreakdown_4__"] = 0;
  results["_calculateBreakdown_5__"] = 0;
  results["_calculateBreakdown_6__"] = 0;
  results["result"] = 0;
  return results;
}
