// Auto-generated from trench-hesaplama-schema.json
import * as z from 'zod';

export interface Trench_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Trench_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Trench_hesaplamaInput): Record<string, number> {
...
export function calculateTrench_hesaplama(input: Trench_hesaplamaInput): Trench_hesaplamaOutput {
...
export interface Trench_hesaplamaOutput {
...
export const Trench_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
