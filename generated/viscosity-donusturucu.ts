// Auto-generated from viscosity-donusturucu-schema.json
import * as z from 'zod';

export interface Viscosity_donusturucuInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Viscosity_donusturucuInputSchema = z.object({
...
function evaluateAllFormulas(input: Viscosity_donusturucuInput): Record<string, number> {
...
export function calculateViscosity_donusturucu(input: Viscosity_donusturucuInput): Viscosity_donusturucuOutput {
...
export interface Viscosity_donusturucuOutput {
...
export const Viscosity_donusturucuOutputMeta = {
  primaryKey: "result",
  unit: "",
