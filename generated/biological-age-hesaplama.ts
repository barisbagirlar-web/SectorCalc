// Auto-generated from biological-age-hesaplama-schema.json
import * as z from 'zod';

export interface Biological_age_hesaplamaInput {
  birthDate: number;
  referenceDate: number;
  dataConfidence?: number;
}

export const Biological_age_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Biological_age_hesaplamaInput): Record<string, number> {
...
export function calculateBiological_age_hesaplama(input: Biological_age_hesaplamaInput): Biological_age_hesaplamaOutput {
...
export interface Biological_age_hesaplamaOutput {
...
export const Biological_age_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "date",
