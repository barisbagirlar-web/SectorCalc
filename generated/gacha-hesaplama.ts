// Auto-generated from gacha-hesaplama-schema.json
import * as z from 'zod';

export interface Gacha_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Gacha_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Gacha_hesaplamaInput): Record<string, number> {
...
export function calculateGacha_hesaplama(input: Gacha_hesaplamaInput): Gacha_hesaplamaOutput {
...
export interface Gacha_hesaplamaOutput {
...
export const Gacha_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
