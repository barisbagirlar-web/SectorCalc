// Auto-generated from worm-gear-hesaplama-schema.json
import * as z from 'zod';

export interface Worm_gear_hesaplamaInput {
  materialStrength: number;
  dataConfidence?: number;
}

export const Worm_gear_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Worm_gear_hesaplamaInput): Record<string, number> {
...
export function calculateWorm_gear_hesaplama(input: Worm_gear_hesaplamaInput): Worm_gear_hesaplamaOutput {
...
export interface Worm_gear_hesaplamaOutput {
...
export const Worm_gear_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "MPa",
