// Auto-generated from purchasing-guc-hesaplama-schema.json
import * as z from 'zod';

export interface Purchasing_guc_hesaplamaInput {
  powerValue: number;
  timeDuration: number;
  dataConfidence?: number;
}

export const Purchasing_guc_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Purchasing_guc_hesaplamaInput): Record<string, number> {
...
export function calculatePurchasing_guc_hesaplama(input: Purchasing_guc_hesaplamaInput): Purchasing_guc_hesaplamaOutput {
...
export interface Purchasing_guc_hesaplamaOutput {
...
export const Purchasing_guc_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "W",
