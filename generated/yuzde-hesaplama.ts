// Auto-generated from yuzde-hesaplama-schema.json
import * as z from 'zod';

export interface Yuzde_hesaplamaInput {
  totalValue: number;
  percentage: number;
  dataConfidence?: number;
}

export const Yuzde_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Yuzde_hesaplamaInput): Record<string, number> {
...
export function calculateYuzde_hesaplama(input: Yuzde_hesaplamaInput): Yuzde_hesaplamaOutput {
...
export interface Yuzde_hesaplamaOutput {
...
export const Yuzde_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "%",
