// Auto-generated from excel-tarih-hesaplama-schema.json
import * as z from 'zod';

export interface Excel_tarih_hesaplamaInput {
  birthDate: number;
  referenceDate: number;
  dataConfidence?: number;
}

export const Excel_tarih_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Excel_tarih_hesaplamaInput): Record<string, number> {
...
export function calculateExcel_tarih_hesaplama(input: Excel_tarih_hesaplamaInput): Excel_tarih_hesaplamaOutput {
...
export interface Excel_tarih_hesaplamaOutput {
...
export const Excel_tarih_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "date",
