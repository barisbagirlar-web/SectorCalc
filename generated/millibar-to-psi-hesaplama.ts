// Auto-generated from millibar-to-psi-hesaplama-schema.json
import * as z from 'zod';

export interface Millibar_to_psi_hesaplamaInput {
  pressureValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Millibar_to_psi_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Millibar_to_psi_hesaplamaInput): Record<string, number> {
...
export function calculateMillibar_to_psi_hesaplama(input: Millibar_to_psi_hesaplamaInput): Millibar_to_psi_hesaplamaOutput {
...
export interface Millibar_to_psi_hesaplamaOutput {
...
export const Millibar_to_psi_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "Pa",
