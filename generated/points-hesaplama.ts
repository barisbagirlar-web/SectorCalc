// Auto-generated from points-hesaplama-schema.json
import * as z from 'zod';

export interface Points_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Points_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Points_hesaplamaInput): Record<string, number> {
...
export function calculatePoints_hesaplama(input: Points_hesaplamaInput): Points_hesaplamaOutput {
...
export interface Points_hesaplamaOutput {
...
export const Points_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
