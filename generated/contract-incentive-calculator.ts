...
export function calculateContract_incentive_calculator(input: Contract_incentive_calculatorInput): Contract_incentive_calculatorOutput {
  ...
  const breakdown = {
    ...
    factor_target_throughput: toNumericFormulaValue(values["factor_target_throughput"])
  };
...
export interface Contract_incentive_calculatorOutput {
  ...
  unit: string;
  breakdown: { base_cost: number; adjusted_cost: number; factor_target_throughput: number };
...
export const Contract_incentive_calculatorOutputMeta = {
  primaryKey: "result",
  unit: "USD",
  breakdownKeys: ["base_cost","adjusted_cost","factor_target_throughput"],
} as const;
