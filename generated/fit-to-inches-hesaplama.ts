// Auto-generated from fit-to-inches-hesaplama-schema.json
import * as z from 'zod';

export interface Fit_to_inches_hesaplamaInput {
  inputValue: number;
  param2: number;
  dataConfidence?: number;
}

export const Fit_to_inches_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Fit_to_inches_hesaplamaInput): Record<string, number> {
...
export function calculateFit_to_inches_hesaplama(input: Fit_to_inches_hesaplamaInput): Fit_to_inches_hesaplamaOutput {
...
export interface Fit_to_inches_hesaplamaOutput {
...
export const Fit_to_inches_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
