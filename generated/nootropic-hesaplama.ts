// Auto-generated from nootropic-hesaplama-schema.json
import * as z from 'zod';

export interface Nootropic_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Nootropic_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Nootropic_hesaplamaInput): Record<string, number> {
...
export function calculateNootropic_hesaplama(input: Nootropic_hesaplamaInput): Nootropic_hesaplamaOutput {
...
export interface Nootropic_hesaplamaOutput {
...
export const Nootropic_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
