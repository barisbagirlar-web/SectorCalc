// Auto-generated from t-score-hesaplama-schema.json
import * as z from 'zod';

export interface T_score_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const T_score_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: T_score_hesaplamaInput): Record<string, number> {
...
export function calculateT_score_hesaplama(input: T_score_hesaplamaInput): T_score_hesaplamaOutput {
...
export interface T_score_hesaplamaOutput {
...
export const T_score_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
