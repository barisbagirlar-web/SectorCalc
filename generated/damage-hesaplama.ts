// Auto-generated from damage-hesaplama-schema.json
import * as z from 'zod';

export interface Damage_hesaplamaInput {
  birthDate: number;
  referenceDate: number;
  dataConfidence?: number;
}

export const Damage_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Damage_hesaplamaInput): Record<string, number> {
...
export function calculateDamage_hesaplama(input: Damage_hesaplamaInput): Damage_hesaplamaOutput {
...
export interface Damage_hesaplamaOutput {
...
export const Damage_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "date",
