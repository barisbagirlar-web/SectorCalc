// Auto-generated from pss-hesaplama-schema.json
import * as z from 'zod';

export interface Pss_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Pss_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Pss_hesaplamaInput): Record<string, number> {
...
export function calculatePss_hesaplama(input: Pss_hesaplamaInput): Pss_hesaplamaOutput {
...
export interface Pss_hesaplamaOutput {
...
export const Pss_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
