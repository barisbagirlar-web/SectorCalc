// Auto-generated from nyquist-hesaplama-schema.json
import * as z from 'zod';

export interface Nyquist_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Nyquist_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Nyquist_hesaplamaInput): Record<string, number> {
...
export function calculateNyquist_hesaplama(input: Nyquist_hesaplamaInput): Nyquist_hesaplamaOutput {
...
export interface Nyquist_hesaplamaOutput {
...
export const Nyquist_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
