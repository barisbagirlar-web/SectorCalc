// Auto-generated from chronotype-hesaplama-schema.json
import * as z from 'zod';

export interface Chronotype_hesaplamaInput {
  correctAnswers: number;
  totalQuestions: number;
  dataConfidence?: number;
}

export const Chronotype_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Chronotype_hesaplamaInput): Record<string, number> {
...
export function calculateChronotype_hesaplama(input: Chronotype_hesaplamaInput): Chronotype_hesaplamaOutput {
...
export interface Chronotype_hesaplamaOutput {
...
export const Chronotype_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "n",
