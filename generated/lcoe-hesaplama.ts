// Auto-generated from lcoe-hesaplama-schema.json
import * as z from 'zod';

export interface Lcoe_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Lcoe_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Lcoe_hesaplamaInput): Record<string, number> {
...
export function calculateLcoe_hesaplama(input: Lcoe_hesaplamaInput): Lcoe_hesaplamaOutput {
...
export interface Lcoe_hesaplamaOutput {
...
export const Lcoe_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
