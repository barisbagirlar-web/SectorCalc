// Auto-generated from warehouse-hesaplama-schema.json
import * as z from 'zod';

export interface Warehouse_hesaplamaInput {
  warehouseArea: number;
  dataConfidence?: number;
}

export const Warehouse_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Warehouse_hesaplamaInput): Record<string, number> {
...
export function calculateWarehouse_hesaplama(input: Warehouse_hesaplamaInput): Warehouse_hesaplamaOutput {
...
export interface Warehouse_hesaplamaOutput {
...
export const Warehouse_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "m²",
