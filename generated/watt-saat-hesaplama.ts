// Auto-generated from watt-saat-hesaplama-schema.json
import * as z from 'zod';

export interface Watt_saat_hesaplamaInput {
  timeValue: number;
  frequency: number;
  dataConfidence?: number;
}

export const Watt_saat_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Watt_saat_hesaplamaInput): Record<string, number> {
...
export function calculateWatt_saat_hesaplama(input: Watt_saat_hesaplamaInput): Watt_saat_hesaplamaOutput {
...
export interface Watt_saat_hesaplamaOutput {
...
export const Watt_saat_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "min",
