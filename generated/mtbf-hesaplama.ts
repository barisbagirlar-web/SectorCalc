// Auto-generated from mtbf-hesaplama-schema.json
import * as z from 'zod';

export interface Mtbf_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Mtbf_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Mtbf_hesaplamaInput): Record<string, number> {
...
export function calculateMtbf_hesaplama(input: Mtbf_hesaplamaInput): Mtbf_hesaplamaOutput {
...
export interface Mtbf_hesaplamaOutput {
...
export const Mtbf_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
