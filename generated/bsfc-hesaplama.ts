// Auto-generated from bsfc-hesaplama-schema.json
import * as z from 'zod';

export interface Bsfc_hesaplamaInput {
  inputValue: number;
  dataConfidence?: number;
}

export const Bsfc_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Bsfc_hesaplamaInput): Record<string, number> {
...
export function calculateBsfc_hesaplama(input: Bsfc_hesaplamaInput): Bsfc_hesaplamaOutput {
...
export interface Bsfc_hesaplamaOutput {
...
export const Bsfc_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
