// Auto-generated from savings-hesaplama-schema.json
import * as z from 'zod';

export interface Savings_hesaplamaInput {
  principal: number;
  annualRate: number;
  dataConfidence?: number;
}

export const Savings_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Savings_hesaplamaInput): Record<string, number> {
...
export function calculateSavings_hesaplama(input: Savings_hesaplamaInput): Savings_hesaplamaOutput {
...
export interface Savings_hesaplamaOutput {
...
export const Savings_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "currency",
