// Auto-generated from parlay-hesaplama-schema.json
import * as z from 'zod';

export interface Parlay_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Parlay_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Parlay_hesaplamaInput): Record<string, number> {
...
export function calculateParlay_hesaplama(input: Parlay_hesaplamaInput): Parlay_hesaplamaOutput {
...
export interface Parlay_hesaplamaOutput {
...
export const Parlay_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
