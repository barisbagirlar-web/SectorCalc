// Auto-generated from collision-hesaplama-schema.json
import * as z from 'zod';

export interface Collision_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Collision_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Collision_hesaplamaInput): Record<string, number> {
...
export function calculateCollision_hesaplama(input: Collision_hesaplamaInput): Collision_hesaplamaOutput {
...
export interface Collision_hesaplamaOutput {
...
export const Collision_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
