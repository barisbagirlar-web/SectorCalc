// Auto-generated from hexadecimal-hesaplama-schema.json
import * as z from 'zod';

export interface Hexadecimal_hesaplamaInput {
  numerator: number;
  denominator: number;
  dataConfidence?: number;
}

export const Hexadecimal_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Hexadecimal_hesaplamaInput): Record<string, number> {
...
export function calculateHexadecimal_hesaplama(input: Hexadecimal_hesaplamaInput): Hexadecimal_hesaplamaOutput {
...
export interface Hexadecimal_hesaplamaOutput {
...
export const Hexadecimal_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
