// Auto-generated from tolac-hesaplama-schema.json
import * as z from 'zod';

export interface Tolac_hesaplamaInput {
  inputA: number;
  inputB: number;
  dataConfidence?: number;
}

export const Tolac_hesaplamaInputSchema = z.object({
...
function evaluateAllFormulas(input: Tolac_hesaplamaInput): Record<string, number> {
...
export function calculateTolac_hesaplama(input: Tolac_hesaplamaInput): Tolac_hesaplamaOutput {
...
export interface Tolac_hesaplamaOutput {
...
export const Tolac_hesaplamaOutputMeta = {
  primaryKey: "result",
  unit: "",
