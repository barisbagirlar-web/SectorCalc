...
function createMinimalRow(overrides: Partial<BomRow> & { itemNumber: number }): BomRow {
  return {
    ...
    hierarchyLevel: overrides.hierarchyLevel ?? null,
    hierarchyPath: overrides.hierarchyPath ?? null,
    hierarchyEvidence: overrides.hierarchyEvidence ?? null,
    extractionPass: overrides.extractionPass ?? null,
    ...
    quantityRaw: overrides.quantityRaw ?? null,
    quantityParseStatus: overrides.quantityParseStatus ?? null,
    unitRaw: overrides.unitRaw ?? null,
    unitNormalized: overrides.unitNormalized ?? null,
    manufacturerRaw: overrides.manufacturerRaw ?? null,
    manufacturerNormalized: overrides.manufacturerNormalized ?? null,
    manufacturerPartNumberRaw: overrides.manufacturerPartNumberRaw ?? null,
    manufacturerPartNumberNormalized: overrides.manufacturerPartNumberNormalized ?? null,
    descriptionRawFull: overrides.descriptionRawFull ?? null,
