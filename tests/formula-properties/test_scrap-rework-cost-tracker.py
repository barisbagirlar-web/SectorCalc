"""
formula-properties: scrap-rework-cost-tracker

Auto-generated property-based test suite.
Source: src/sectorcalc/formulas/pro-v531/scrap-rework-cost-tracker.formula.ts

Input keys: "n_total_produced", "n_scrap_quantity", "n_rework_quantity", "n_unit_material_cost", "n_unit_labor_cost", "n_rework_labor_rate", "n_rework_time_per_unit", "n_defect_rate_target_pct", "n_monthly_volume", "n_source_confidence_ratio"
...
class FormulaValidator:
    """Decimal-precision validation layer for scrap-rework-cost-tracker. All monetary
    ...
    def validate(cls, inputs: dict) -> dict:
        ...
        input_keys = ['n_total_produced', 'n_scrap_quantity', 'n_rework_quantity', 'n_unit_material_cost', 'n_unit_labor_cost', 'n_rework_labor_rate', 'n_rework_time_per_unit', 'n_defect_rate_target_pct', 'n_monthly_volume', 'n_source_confidence_ratio']
        parsed = {}
        for k in input_keys:
            v = inputs.get(k)
            if v is None:
...
class TestInputValidation:
    ...
    def test_rejects_non_numeric(self):
        with pytest.raises(ValueError, match="Invalid numeric input"):
            FormulaValidator.validate({k: "abc" for k in ['n_total_produced', 'n_scrap_quantity', 'n_rework_quantity', 'n_unit_material_cost', 'n_unit_labor_cost', 'n_rework_labor_rate', 'n_rework_time_per_unit', 'n_defect_rate_target_pct', 'n_monthly_volume', 'n_source_confidence_ratio']})
    ...
    def test_scr_above_1_clamped(self):
        inputs = {k: Decimal("0") for k in ['n_total_produced', 'n_scrap_quantity', 'n_rework_quantity', 'n_unit_material_cost', 'n_unit_labor_cost', 'n_rework_labor_rate', 'n_rework_time_per_unit', 'n_defect_rate_target_pct', 'n_monthly_volume', 'n_source_confidence_ratio']}
...
class TestEdgeCases:
    ...
    def test_max_boundary(self):
        ...
        inputs = {
    "n_total_produced": Decimal("1000000"),
    "n_scrap_quantity": Decimal("1000000"),
    "n_rework_quantity": Decimal("1000000"),
    "n_unit_material_cost": Decimal("10000000"),
    "n_unit_labor_cost": Decimal("10000000"),
    "n_rework_labor_rate": Decimal("50"),
    "n_rework_time_per_unit": Decimal("8760"),
    "n_defect_rate_target_pct": Decimal("50"),
    "n_monthly_volume": Decimal("1000000"),
...
class TestOverflowPrecision:
    ...
    def test_large_scale_inputs(self, scale):
        ...
        for k in ['n_total_produced', 'n_scrap_quantity', 'n_rework_quantity', 'n_unit_material_cost', 'n_unit_labor_cost', 'n_rework_labor_rate', 'n_rework_time_per_unit', 'n_defect_rate_target_pct', 'n_monthly_volume', 'n_source_confidence_ratio']:
            if k == "n_source_confidence_ratio":
                continue
            base = {kk: Decimal("1") for kk in ['n_total_produced', 'n_scrap_quantity', 'n_rework_quantity', 'n_unit_material_cost', 'n_unit_labor_cost', 'n_rework_labor_rate', 'n_rework_time_per_unit', 'n_defect_rate_target_pct', 'n_monthly_volume', 'n_source_confidence_ratio']}
...
class TestInvariants:
    ...
    @given(
            n_total_produced=st.decimals(min_value=0, max_value=1_000_000, places=0),
            n_scrap_quantity=st.decimals(min_value=0, max_value=1_000_000, places=0),
            n_rework_quantity=st.decimals(min_value=0, max_value=1_000_000, places=0),
            ...
            n_rework_labor_rate=st.decimals(min_value=0, max_value=100, places=2),
            n_rework_time_per_unit=st.decimals(min_value=0, max_value=100_000, places=2),
            n_defect_rate_target_pct=st.decimals(min_value=0, max_value=100, places=2),
            n_monthly_volume=st.decimals(min_value=0, max_value=1_000_000, places=0),
            n_source_confidence_ratio=st.decimals(min_value=0, max_value=1, places=2)
    )
    @settings(max_examples=100)
    def test_inputs_parse_to_decimal(self, n_total_produced, n_scrap_quantity, n_rework_quantity, n_unit_material_cost, n_unit_labor_cost, n_rework_labor_rate, n_rework_time_per_unit, n_defect_rate_target_pct, n_monthly_volume, n_source_confidence_ratio):
        """All inputs parse to Decimal without loss."""
        inputs = {
    "n_total_produced": n_total_produced,
    "n_scrap_quantity": n_scrap_quantity,
    "n_rework_quantity": n_rework_quantity,
    "n_unit_material_cost": n_unit_material_cost,
    "n_unit_labor_cost": n_unit_labor_cost,
    "n_rework_labor_rate": n_rework_labor_rate,
    "n_rework_time_per_unit": n_rework_time_per_unit,
    "n_defect_rate_target_pct": n_defect_rate_target_pct,
    "n_monthly_volume": n_monthly_volume,
    ...
    @settings(max_examples=100)
    def test_scr_invariant(self, n_total_produced, n_scrap_quantity, n_rework_quantity, n_unit_material_cost, n_unit_labor_cost, n_rework_labor_rate, n_rework_time_per_unit, n_defect_rate_target_pct, n_monthly_volume, n_source_confidence_ratio):
...
class TestDecisionBoundaries:
    ...
    def test_decision_is_integer(self):
        ...
        inputs = {k: Decimal("1") for k in ['n_total_produced', 'n_scrap_quantity', 'n_rework_quantity', 'n_unit_material_cost', 'n_unit_labor_cost', 'n_rework_labor_rate', 'n_rework_time_per_unit', 'n_defect_rate_target_pct', 'n_monthly_volume', 'n_source_confidence_ratio']}
        if "n_source_confidence_ratio" in inputs:
