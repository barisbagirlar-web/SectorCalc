"""
formula-properties: true-employee-cost-statement

Auto-generated property-based test suite.
Source: src/sectorcalc/formulas/pro-v531/true-employee-cost-statement.formula.ts

Input keys: "n_gross_salary", "n_employer_tax_pct", "n_benefits_cost", "n_training_cost", "n_overhead_pct", "n_annual_work_hours", "n_utilization_pct", "n_burden_rate", "n_agency_fee_pct", "n_source_confidence_ratio"
...
class FormulaValidator:
    """Decimal-precision validation layer for true-employee-cost-statement. All monetary
    ...
    def validate(cls, inputs: dict) -> dict:
        ...
        input_keys = ['n_gross_salary', 'n_employer_tax_pct', 'n_benefits_cost', 'n_training_cost', 'n_overhead_pct', 'n_annual_work_hours', 'n_utilization_pct', 'n_burden_rate', 'n_agency_fee_pct', 'n_source_confidence_ratio']
        parsed = {}
        for k in input_keys:
            v = inputs.get(k)
            if v is None:
...
class TestInputValidation:
    ...
    def test_rejects_non_numeric(self):
        with pytest.raises(ValueError, match="Invalid numeric input"):
            FormulaValidator.validate({k: "abc" for k in ['n_gross_salary', 'n_employer_tax_pct', 'n_benefits_cost', 'n_training_cost', 'n_overhead_pct', 'n_annual_work_hours', 'n_utilization_pct', 'n_burden_rate', 'n_agency_fee_pct', 'n_source_confidence_ratio']})
    ...
    def test_scr_above_1_clamped(self):
        inputs = {k: Decimal("0") for k in ['n_gross_salary', 'n_employer_tax_pct', 'n_benefits_cost', 'n_training_cost', 'n_overhead_pct', 'n_annual_work_hours', 'n_utilization_pct', 'n_burden_rate', 'n_agency_fee_pct', 'n_source_confidence_ratio']}
...
class TestEdgeCases:
    ...
    def test_max_boundary(self):
        ...
        inputs = {
    "n_gross_salary": Decimal("10000000"),
    "n_employer_tax_pct": Decimal("50"),
    "n_benefits_cost": Decimal("10000000"),
    "n_training_cost": Decimal("10000000"),
    "n_overhead_pct": Decimal("50"),
    "n_annual_work_hours": Decimal("8760"),
    "n_utilization_pct": Decimal("50"),
    "n_burden_rate": Decimal("50"),
    "n_agency_fee_pct": Decimal("50"),
...
class TestOverflowPrecision:
    ...
    def test_large_scale_inputs(self, scale):
        ...
        for k in ['n_gross_salary', 'n_employer_tax_pct', 'n_benefits_cost', 'n_training_cost', 'n_overhead_pct', 'n_annual_work_hours', 'n_utilization_pct', 'n_burden_rate', 'n_agency_fee_pct', 'n_source_confidence_ratio']:
            if k == "n_source_confidence_ratio":
                continue
            base = {kk: Decimal("1") for kk in ['n_gross_salary', 'n_employer_tax_pct', 'n_benefits_cost', 'n_training_cost', 'n_overhead_pct', 'n_annual_work_hours', 'n_utilization_pct', 'n_burden_rate', 'n_agency_fee_pct', 'n_source_confidence_ratio']}
...
class TestInvariants:
    ...
    @given(
            n_gross_salary=st.decimals(min_value=0, max_value=10_000_000, places=2),
            n_employer_tax_pct=st.decimals(min_value=0, max_value=100, places=2),
            n_benefits_cost=st.decimals(min_value=0, max_value=10_000_000, places=2),
            n_training_cost=st.decimals(min_value=0, max_value=10_000_000, places=2),
            n_overhead_pct=st.decimals(min_value=0, max_value=100, places=2),
            n_annual_work_hours=st.decimals(min_value=0, max_value=100_000, places=2),
            n_utilization_pct=st.decimals(min_value=0, max_value=100, places=2),
            n_burden_rate=st.decimals(min_value=0, max_value=100, places=2),
            n_agency_fee_pct=st.decimals(min_value=0, max_value=100, places=2),
            n_source_confidence_ratio=st.decimals(min_value=0, max_value=1, places=2)
    )
    @settings(max_examples=100)
    def test_inputs_parse_to_decimal(self, n_gross_salary, n_employer_tax_pct, n_benefits_cost, n_training_cost, n_overhead_pct, n_annual_work_hours, n_utilization_pct, n_burden_rate, n_agency_fee_pct, n_source_confidence_ratio):
        """All inputs parse to Decimal without loss."""
        inputs = {
    "n_gross_salary": n_gross_salary,
    "n_employer_tax_pct": n_employer_tax_pct,
    "n_benefits_cost": n_benefits_cost,
    "n_training_cost": n_training_cost,
    "n_overhead_pct": n_overhead_pct,
    "n_annual_work_hours": n_annual_work_hours,
    "n_utilization_pct": n_utilization_pct,
    "n_burden_rate": n_burden_rate,
    "n_agency_fee_pct": n_agency_fee_pct,
    ...
    @settings(max_examples=100)
    def test_scr_invariant(self, n_gross_salary, n_employer_tax_pct, n_benefits_cost, n_training_cost, n_overhead_pct, n_annual_work_hours, n_utilization_pct, n_burden_rate, n_agency_fee_pct, n_source_confidence_ratio):
...
class TestDecisionBoundaries:
    ...
    def test_decision_is_integer(self):
        ...
        inputs = {k: Decimal("1") for k in ['n_gross_salary', 'n_employer_tax_pct', 'n_benefits_cost', 'n_training_cost', 'n_overhead_pct', 'n_annual_work_hours', 'n_utilization_pct', 'n_burden_rate', 'n_agency_fee_pct', 'n_source_confidence_ratio']}
        if "n_source_confidence_ratio" in inputs:
