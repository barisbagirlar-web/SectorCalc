"""
formula-properties: machine-hourly-rate-proof-report

Auto-generated property-based test suite.
Source: src/sectorcalc/formulas/pro-v531/machine-hourly-rate-proof-report.formula.ts

Input keys: "n_machine_purchase_cost", "n_equipment_life_years", "n_annual_operating_hours", "n_maintenance_cost_per_year", "n_energy_consumption_kw", "n_energy_cost_per_kwh", "n_floor_space_cost_per_year", "n_labor_cost_per_hour", "n_overhead_rate_pct", "n_source_confidence_ratio"
...
class FormulaValidator:
    """Decimal-precision validation layer for machine-hourly-rate-proof-report. All monetary
    ...
    def validate(cls, inputs: dict) -> dict:
        ...
        input_keys = ['n_machine_purchase_cost', 'n_equipment_life_years', 'n_annual_operating_hours', 'n_maintenance_cost_per_year', 'n_energy_consumption_kw', 'n_energy_cost_per_kwh', 'n_floor_space_cost_per_year', 'n_labor_cost_per_hour', 'n_overhead_rate_pct', 'n_source_confidence_ratio']
        parsed = {}
        for k in input_keys:
            v = inputs.get(k)
            if v is None:
...
class TestInputValidation:
    ...
    def test_rejects_non_numeric(self):
        with pytest.raises(ValueError, match="Invalid numeric input"):
            FormulaValidator.validate({k: "abc" for k in ['n_machine_purchase_cost', 'n_equipment_life_years', 'n_annual_operating_hours', 'n_maintenance_cost_per_year', 'n_energy_consumption_kw', 'n_energy_cost_per_kwh', 'n_floor_space_cost_per_year', 'n_labor_cost_per_hour', 'n_overhead_rate_pct', 'n_source_confidence_ratio']})
    ...
    def test_scr_above_1_clamped(self):
        inputs = {k: Decimal("0") for k in ['n_machine_purchase_cost', 'n_equipment_life_years', 'n_annual_operating_hours', 'n_maintenance_cost_per_year', 'n_energy_consumption_kw', 'n_energy_cost_per_kwh', 'n_floor_space_cost_per_year', 'n_labor_cost_per_hour', 'n_overhead_rate_pct', 'n_source_confidence_ratio']}
...
class TestEdgeCases:
    ...
    def test_max_boundary(self):
        ...
        inputs = {
    "n_machine_purchase_cost": Decimal("10000000"),
    "n_equipment_life_years": Decimal("100000"),
    "n_annual_operating_hours": Decimal("8760"),
    "n_maintenance_cost_per_year": Decimal("10000000"),
    "n_energy_consumption_kw": Decimal("500"),
    "n_energy_cost_per_kwh": Decimal("10000000"),
    "n_floor_space_cost_per_year": Decimal("10000000"),
    "n_labor_cost_per_hour": Decimal("10000000"),
...
class TestOverflowPrecision:
    ...
    def test_large_scale_inputs(self, scale):
        ...
        for k in ['n_machine_purchase_cost', 'n_equipment_life_years', 'n_annual_operating_hours', 'n_maintenance_cost_per_year', 'n_energy_consumption_kw', 'n_energy_cost_per_kwh', 'n_floor_space_cost_per_year', 'n_labor_cost_per_hour', 'n_overhead_rate_pct', 'n_source_confidence_ratio']:
            if k == "n_source_confidence_ratio":
                continue
            base = {kk: Decimal("1") for kk in ['n_machine_purchase_cost', 'n_equipment_life_years', 'n_annual_operating_hours', 'n_maintenance_cost_per_year', 'n_energy_consumption_kw', 'n_energy_cost_per_kwh', 'n_floor_space_cost_per_year', 'n_labor_cost_per_hour', 'n_overhead_rate_pct', 'n_source_confidence_ratio']}
...
class TestInvariants:
    ...
    @given(
            n_machine_purchase_cost=st.decimals(min_value=0, max_value=10_000_000, places=2),
            n_equipment_life_years=st.decimals(min_value=0, max_value=100_000, places=2),
            n_annual_operating_hours=st.decimals(min_value=0, max_value=100_000, places=2),
            n_maintenance_cost_per_year=st.decimals(min_value=0, max_value=10_000_000, places=2),
            n_energy_consumption_kw=st.decimals(min_value=0, max_value=10_000, places=2),
            n_energy_cost_per_kwh=st.decimals(min_value=0, max_value=10_000_000, places=2),
            n_floor_space_cost_per_year=st.decimals(min_value=0, max_value=10_000_000, places=2),
            n_labor_cost_per_hour=st.decimals(min_value=0, max_value=10_000_000, places=2),
    ...
    def test_inputs_parse_to_decimal(self, n_machine_purchase_cost, n_equipment_life_years, n_annual_operating_hours, n_maintenance_cost_per_year, n_energy_consumption_kw, n_energy_cost_per_kwh, n_floor_space_cost_per_year, n_labor_cost_per_hour, n_overhead_rate_pct, n_source_confidence_ratio):
        """All inputs parse to Decimal without loss."""
        inputs = {
    "n_machine_purchase_cost": n_machine_purchase_cost,
    "n_equipment_life_years": n_equipment_life_years,
    "n_annual_operating_hours": n_annual_operating_hours,
    "n_maintenance_cost_per_year": n_maintenance_cost_per_year,
    "n_energy_consumption_kw": n_energy_consumption_kw,
    "n_energy_cost_per_kwh": n_energy_cost_per_kwh,
    "n_floor_space_cost_per_year": n_floor_space_cost_per_year,
    "n_labor_cost_per_hour": n_labor_cost_per_hour,
    ...
    @settings(max_examples=100)
    def test_scr_invariant(self, n_machine_purchase_cost, n_equipment_life_years, n_annual_operating_hours, n_maintenance_cost_per_year, n_energy_consumption_kw, n_energy_cost_per_kwh, n_floor_space_cost_per_year, n_labor_cost_per_hour, n_overhead_rate_pct, n_source_confidence_ratio):
...
class TestDecisionBoundaries:
    ...
    def test_decision_is_integer(self):
        ...
        inputs = {k: Decimal("1") for k in ['n_machine_purchase_cost', 'n_equipment_life_years', 'n_annual_operating_hours', 'n_maintenance_cost_per_year', 'n_energy_consumption_kw', 'n_energy_cost_per_kwh', 'n_floor_space_cost_per_year', 'n_labor_cost_per_hour', 'n_overhead_rate_pct', 'n_source_confidence_ratio']}
        if "n_source_confidence_ratio" in inputs:
