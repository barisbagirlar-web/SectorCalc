"""
formula-properties: loss-making-job-detector

Auto-generated property-based test suite.
Source: src/sectorcalc/formulas/pro-v531/loss-making-job-detector.formula.ts

Input keys: "n_job_revenue", "n_material_cost", "n_labor_hours", "n_labor_rate", "n_overhead_rate_pct", "n_allocated_fixed_cost", "n_job_margin_target_pct", "n_penalty_rate", "n_penalty_hours", "n_source_confidence_ratio"
...
class FormulaValidator:
    """Decimal-precision validation layer for loss-making-job-detector. All monetary
    ...
    def validate(cls, inputs: dict) -> dict:
        ...
        input_keys = ['n_job_revenue', 'n_material_cost', 'n_labor_hours', 'n_labor_rate', 'n_overhead_rate_pct', 'n_allocated_fixed_cost', 'n_job_margin_target_pct', 'n_penalty_rate', 'n_penalty_hours', 'n_source_confidence_ratio']
        parsed = {}
        for k in input_keys:
            v = inputs.get(k)
            if v is None:
...
class TestInputValidation:
    ...
    def test_rejects_non_numeric(self):
        with pytest.raises(ValueError, match="Invalid numeric input"):
            FormulaValidator.validate({k: "abc" for k in ['n_job_revenue', 'n_material_cost', 'n_labor_hours', 'n_labor_rate', 'n_overhead_rate_pct', 'n_allocated_fixed_cost', 'n_job_margin_target_pct', 'n_penalty_rate', 'n_penalty_hours', 'n_source_confidence_ratio']})
    ...
    def test_scr_above_1_clamped(self):
        inputs = {k: Decimal("0") for k in ['n_job_revenue', 'n_material_cost', 'n_labor_hours', 'n_labor_rate', 'n_overhead_rate_pct', 'n_allocated_fixed_cost', 'n_job_margin_target_pct', 'n_penalty_rate', 'n_penalty_hours', 'n_source_confidence_ratio']}
...
class TestEdgeCases:
    ...
    def test_max_boundary(self):
        ...
        inputs = {
    "n_job_revenue": Decimal("10000000"),
    "n_material_cost": Decimal("10000000"),
    "n_labor_hours": Decimal("8760"),
    "n_labor_rate": Decimal("50"),
    "n_overhead_rate_pct": Decimal("50"),
    "n_allocated_fixed_cost": Decimal("10000000"),
    "n_job_margin_target_pct": Decimal("50"),
    "n_penalty_rate": Decimal("50"),
    "n_penalty_hours": Decimal("8760"),
...
class TestOverflowPrecision:
    ...
    def test_large_scale_inputs(self, scale):
        ...
        for k in ['n_job_revenue', 'n_material_cost', 'n_labor_hours', 'n_labor_rate', 'n_overhead_rate_pct', 'n_allocated_fixed_cost', 'n_job_margin_target_pct', 'n_penalty_rate', 'n_penalty_hours', 'n_source_confidence_ratio']:
            if k == "n_source_confidence_ratio":
                continue
            base = {kk: Decimal("1") for kk in ['n_job_revenue', 'n_material_cost', 'n_labor_hours', 'n_labor_rate', 'n_overhead_rate_pct', 'n_allocated_fixed_cost', 'n_job_margin_target_pct', 'n_penalty_rate', 'n_penalty_hours', 'n_source_confidence_ratio']}
...
class TestInvariants:
    ...
    @given(
            n_job_revenue=st.decimals(min_value=0, max_value=10_000_000, places=2),
            n_material_cost=st.decimals(min_value=0, max_value=10_000_000, places=2),
            n_labor_hours=st.decimals(min_value=0, max_value=100_000, places=2),
            n_labor_rate=st.decimals(min_value=0, max_value=100, places=2),
            n_overhead_rate_pct=st.decimals(min_value=0, max_value=100, places=2),
            n_allocated_fixed_cost=st.decimals(min_value=0, max_value=10_000_000, places=2),
            n_job_margin_target_pct=st.decimals(min_value=0, max_value=100, places=2),
            n_penalty_rate=st.decimals(min_value=0, max_value=100, places=2),
            n_penalty_hours=st.decimals(min_value=0, max_value=100_000, places=2),
            n_source_confidence_ratio=st.decimals(min_value=0, max_value=1, places=2)
    )
    @settings(max_examples=100)
    def test_inputs_parse_to_decimal(self, n_job_revenue, n_material_cost, n_labor_hours, n_labor_rate, n_overhead_rate_pct, n_allocated_fixed_cost, n_job_margin_target_pct, n_penalty_rate, n_penalty_hours, n_source_confidence_ratio):
        """All inputs parse to Decimal without loss."""
        inputs = {
    "n_job_revenue": n_job_revenue,
    "n_material_cost": n_material_cost,
    "n_labor_hours": n_labor_hours,
    "n_labor_rate": n_labor_rate,
    "n_overhead_rate_pct": n_overhead_rate_pct,
    "n_allocated_fixed_cost": n_allocated_fixed_cost,
    "n_job_margin_target_pct": n_job_margin_target_pct,
    "n_penalty_rate": n_penalty_rate,
    "n_penalty_hours": n_penalty_hours,
    ...
    @settings(max_examples=100)
    def test_scr_invariant(self, n_job_revenue, n_material_cost, n_labor_hours, n_labor_rate, n_overhead_rate_pct, n_allocated_fixed_cost, n_job_margin_target_pct, n_penalty_rate, n_penalty_hours, n_source_confidence_ratio):
...
class TestDecisionBoundaries:
    ...
    def test_decision_is_integer(self):
        ...
        inputs = {k: Decimal("1") for k in ['n_job_revenue', 'n_material_cost', 'n_labor_hours', 'n_labor_rate', 'n_overhead_rate_pct', 'n_allocated_fixed_cost', 'n_job_margin_target_pct', 'n_penalty_rate', 'n_penalty_hours', 'n_source_confidence_ratio']}
        if "n_source_confidence_ratio" in inputs:
