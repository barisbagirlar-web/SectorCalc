"""
formula-properties: machine-investment-feasibility-buy-lease-keep

Auto-generated property-based test suite.
Source: src/sectorcalc/formulas/pro-v531/machine-investment-feasibility-buy-lease-keep.formula.ts

Input keys: "n_purchase_price", "n_lease_annual_payment", "n_annual_maintenance_cost", "n_annual_energy_cost", "n_annual_revenue_generated", "n_equipment_life_years", "n_residual_value", "n_interest_rate_pct", "n_tax_rate_pct", "n_source_confidence_ratio"
...
class FormulaValidator:
    """Decimal-precision validation layer for machine-investment-feasibility-buy-lease-keep. All monetary
    ...
    def validate(cls, inputs: dict) -> dict:
        ...
        input_keys = ['n_purchase_price', 'n_lease_annual_payment', 'n_annual_maintenance_cost', 'n_annual_energy_cost', 'n_annual_revenue_generated', 'n_equipment_life_years', 'n_residual_value', 'n_interest_rate_pct', 'n_tax_rate_pct', 'n_source_confidence_ratio']
        parsed = {}
        for k in input_keys:
            v = inputs.get(k)
            if v is None:
...
class TestInputValidation:
    ...
    def test_rejects_non_numeric(self):
        with pytest.raises(ValueError, match="Invalid numeric input"):
            FormulaValidator.validate({k: "abc" for k in ['n_purchase_price', 'n_lease_annual_payment', 'n_annual_maintenance_cost', 'n_annual_energy_cost', 'n_annual_revenue_generated', 'n_equipment_life_years', 'n_residual_value', 'n_interest_rate_pct', 'n_tax_rate_pct', 'n_source_confidence_ratio']})
    ...
    def test_scr_above_1_clamped(self):
        inputs = {k: Decimal("0") for k in ['n_purchase_price', 'n_lease_annual_payment', 'n_annual_maintenance_cost', 'n_annual_energy_cost', 'n_annual_revenue_generated', 'n_equipment_life_years', 'n_residual_value', 'n_interest_rate_pct', 'n_tax_rate_pct', 'n_source_confidence_ratio']}
...
class TestEdgeCases:
    ...
    def test_max_boundary(self):
        ...
        inputs = {
    "n_purchase_price": Decimal("10000000"),
    "n_lease_annual_payment": Decimal("10000000"),
    "n_annual_maintenance_cost": Decimal("10000000"),
    "n_annual_energy_cost": Decimal("10000000"),
    "n_annual_revenue_generated": Decimal("50"),
    "n_equipment_life_years": Decimal("100000"),
    "n_residual_value": Decimal("10000000"),
    "n_interest_rate_pct": Decimal("50"),
...
class TestOverflowPrecision:
    ...
    def test_large_scale_inputs(self, scale):
        ...
        for k in ['n_purchase_price', 'n_lease_annual_payment', 'n_annual_maintenance_cost', 'n_annual_energy_cost', 'n_annual_revenue_generated', 'n_equipment_life_years', 'n_residual_value', 'n_interest_rate_pct', 'n_tax_rate_pct', 'n_source_confidence_ratio']:
            if k == "n_source_confidence_ratio":
                continue
            base = {kk: Decimal("1") for kk in ['n_purchase_price', 'n_lease_annual_payment', 'n_annual_maintenance_cost', 'n_annual_energy_cost', 'n_annual_revenue_generated', 'n_equipment_life_years', 'n_residual_value', 'n_interest_rate_pct', 'n_tax_rate_pct', 'n_source_confidence_ratio']}
...
class TestInvariants:
    ...
    @given(
            n_purchase_price=st.decimals(min_value=0, max_value=10_000_000, places=2),
            n_lease_annual_payment=st.decimals(min_value=0, max_value=10_000_000, places=2),
            n_annual_maintenance_cost=st.decimals(min_value=0, max_value=10_000_000, places=2),
            n_annual_energy_cost=st.decimals(min_value=0, max_value=10_000_000, places=2),
            n_annual_revenue_generated=st.decimals(min_value=0, max_value=100, places=2),
            n_equipment_life_years=st.decimals(min_value=0, max_value=100_000, places=2),
            n_residual_value=st.decimals(min_value=0, max_value=10_000_000, places=2),
            n_interest_rate_pct=st.decimals(min_value=0, max_value=100, places=2),
    ...
    def test_inputs_parse_to_decimal(self, n_purchase_price, n_lease_annual_payment, n_annual_maintenance_cost, n_annual_energy_cost, n_annual_revenue_generated, n_equipment_life_years, n_residual_value, n_interest_rate_pct, n_tax_rate_pct, n_source_confidence_ratio):
        """All inputs parse to Decimal without loss."""
        inputs = {
    "n_purchase_price": n_purchase_price,
    "n_lease_annual_payment": n_lease_annual_payment,
    "n_annual_maintenance_cost": n_annual_maintenance_cost,
    "n_annual_energy_cost": n_annual_energy_cost,
    "n_annual_revenue_generated": n_annual_revenue_generated,
    "n_equipment_life_years": n_equipment_life_years,
    "n_residual_value": n_residual_value,
    "n_interest_rate_pct": n_interest_rate_pct,
    ...
    @settings(max_examples=100)
    def test_scr_invariant(self, n_purchase_price, n_lease_annual_payment, n_annual_maintenance_cost, n_annual_energy_cost, n_annual_revenue_generated, n_equipment_life_years, n_residual_value, n_interest_rate_pct, n_tax_rate_pct, n_source_confidence_ratio):
...
class TestDecisionBoundaries:
    ...
    def test_decision_is_integer(self):
        ...
        inputs = {k: Decimal("1") for k in ['n_purchase_price', 'n_lease_annual_payment', 'n_annual_maintenance_cost', 'n_annual_energy_cost', 'n_annual_revenue_generated', 'n_equipment_life_years', 'n_residual_value', 'n_interest_rate_pct', 'n_tax_rate_pct', 'n_source_confidence_ratio']}
        if "n_source_confidence_ratio" in inputs:
